...
- bgfx: Updated to API version 133 (up from 129)
- FMOD: Updated to 2.03.10 (up from 2.03.04)
- freetype: Updated to 2.14.1 (up from 2.13.3)
- harfbuzz: Updated to 12.2.0 (up from 10.1.0)
...
- Nuklear: Updated to 4.12.8 (up from 4.12.3)
- OpenAL Soft: Updated to 1.24.3 (up from 1.24.1)
  * Added `AL_SOFT_bformat_hoa` extension.
- OpenXR: Updated to 1.1.53 (up from 1.1.43)
...
- Vulkan: Updated to 1.4.332 (up from 1.4.304)
