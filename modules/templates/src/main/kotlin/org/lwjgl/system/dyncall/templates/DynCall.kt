...
val DynCall = "DynCall".nativeClass(DYNCALL_PACKAGE, prefix = "DC") {
	...
	val CallingConventions = IntConstant(
		...
		"CALL_C_PPC32_OSX".expr("DC_CALL_C_PPC32_DARWIN"),
		"CALL_C_ARM_ARM_EABI"..10,
		"CALL_C_ARM_THUMB_EABI"..11,
		"CALL_C_ARM_ARMHF"..30,
		"CALL_C_MIPS32_EABI"..12,
		"CALL_C_PPC32_SYSV"..13,
		"CALL_C_PPC32_LINUX".expr("DC_CALL_C_PPC32_SYSV"),
		"CALL_C_ARM_ARM"..14,
		"CALL_C_ARM_THUMB"..15,
		...
		"CALL_C_ARM64"..22,
		"CALL_C_PPC64"..23,
		"CALL_C_PPC64_LINUX".expr("DC_CALL_C_PPC64"),
