...
val nanovg_gles3 = "NanoVGGLES3".dependsOn(Binding.OPENGLES)?.nativeClass(packageName = NANOVG_PACKAGE, prefix = "NVG", library = NANOVG_LIBRARY) {
    nativeDirective(
        """#ifdef LWJGL_WINDOWS
...
#include "nanovg_gl_utils.h"""")
    ...
    NativeName("nvgCreateGLES3")..NVGcontext_p(
        "Create",
        """
    ...
    NativeName("nvgluCreateFramebufferGLES3")..NVGLUframebuffer_p(
        "luCreateFramebuffer",
