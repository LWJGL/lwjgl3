...
val EXT_pvrtc_sRGB = "EXTPVRTCSRGB".nativeClassGLES("EXT_pvrtc_sRGB", postfix = EXT) {
	...
	IntConstant(
		...
		"COMPRESSED_SRGB_PVRTC_2BPPV1_EXT" _ 0x8A54,
		"COMPRESSED_SRGB_PVRTC_4BPPV1_EXT" _ 0x8A55,
		"COMPRESSED_SRGB_ALPHA_PVRTC_2BPPV1_EXT" _ 0x8A56,
		"COMPRESSED_SRGB_ALPHA_PVRTC_4BPPV1_EXT" _ 0x8A57
	)
}