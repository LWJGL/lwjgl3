...
val INTEL_framebuffer_CMAA = "INTELFramebufferCMAA".nativeClassGLES("INTEL_framebuffer_CMAA", postfix = INTEL) {
	documentation =
		...
		For more information on CMAA refer to <a href="http://software.intel.com">http://software.intel.com</a>.
		"""

	void(
		"ApplyFramebufferAttachmentCMAAINTEL",
		"""
		Requests the post processing of current draw buffers pertaining to the framebuffer bound to the GLES30#DRAW_FRAMEBUFFER target according to the
