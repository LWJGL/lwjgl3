...
val EXT_texture_border_clamp = "EXTTextureBorderClamp".nativeClassGLES("EXT_texture_border_clamp", postfix = EXT) {
	...
	IntConstant(
		...
		"TEXTURE_BORDER_COLOR_EXT" _ 0x1004
	)
	...
	void(
		...
		GLenum.IN("target", ""),
		GLenum.IN("pname", ""),
		Check(1) _ const _ GLuint_p.IN("params", "")
	)
	...
	void(
		...
		GLuint.IN("sampler", ""),
		GLenum.IN("pname", ""),
		Check(1) _ const _ GLint_p.IN("param", "")
	)
	...
	void(
		...
		GLuint.IN("sampler", ""),
		GLenum.IN("pname", ""),
		Check(1) _ const _ GLuint_p.IN("param", "")
	)
