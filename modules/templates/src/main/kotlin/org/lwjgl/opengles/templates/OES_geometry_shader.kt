...
val OES_geometry_shader = "OESGeometryShader".nativeClassGLES("OES_geometry_shader", postfix = OES) {
	...
	IntConstant(
		...
		"GEOMETRY_SHADER_OES" _ 0x8DD9
	)

	IntConstant(
		"Accepted by the {@code stages} parameter of UseProgramStages.",

		"GEOMETRY_SHADER_BIT_OES" _ 0x00000004
	)

	IntConstant(
		"Accepted by the {@code pname} parameter of GetProgramiv.",

		"GEOMETRY_LINKED_VERTICES_OUT_OES" _ 0x8916,
		"GEOMETRY_LINKED_INPUT_TYPE_OES" _ 0x8917,
		"GEOMETRY_LINKED_OUTPUT_TYPE_OES" _ 0x8918,
		"GEOMETRY_SHADER_INVOCATIONS_OES" _ 0x887F
	)

	IntConstant(
		"Accepted by the {@code pname} parameter of GetBooleanv, GetIntegerv, GetFloatv, and GetInteger64v.",

		"LAYER_PROVOKING_VERTEX_OES" _ 0x825E,
		"MAX_GEOMETRY_UNIFORM_COMPONENTS_OES" _ 0x8DDF,
		"MAX_GEOMETRY_UNIFORM_BLOCKS_OES" _ 0x8A2C,
		"MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS_OES" _ 0x8A32,
		"MAX_GEOMETRY_INPUT_COMPONENTS_OES" _ 0x9123,
		"MAX_GEOMETRY_OUTPUT_COMPONENTS_OES" _ 0x9124,
		"MAX_GEOMETRY_OUTPUT_VERTICES_OES" _ 0x8DE0,
		"MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS_OES" _ 0x8DE1,
		"MAX_GEOMETRY_SHADER_INVOCATIONS_OES" _ 0x8E5A,
		"MAX_GEOMETRY_TEXTURE_IMAGE_UNITS_OES" _ 0x8C29,
		"MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS_OES" _ 0x92CF,
		"MAX_GEOMETRY_ATOMIC_COUNTERS_OES" _ 0x92D5,
		"MAX_GEOMETRY_IMAGE_UNIFORMS_OES" _ 0x90CD,
		"MAX_GEOMETRY_SHADER_STORAGE_BLOCKS_OES" _ 0x90D7
	)

	IntConstant(
		"Returned in the {@code data} parameter from a Get query with a {@code pname} of LAYER_PROVOKING_VERTEX_OES.",

		"FIRST_VERTEX_CONVENTION_OES" _ 0x8E4D,
		"LAST_VERTEX_CONVENTION_OES" _ 0x8E4E,
		"UNDEFINED_VERTEX_OES" _ 0x8260
	)

	IntConstant(
		"Accepted by the {@code target} parameter of BeginQuery, EndQuery, GetQueryiv, and GetQueryObjectuiv.",

		"PRIMITIVES_GENERATED_OES" _ 0x8C87
	)

	IntConstant(
		"Accepted by the {@code mode} parameter of DrawArrays, DrawElements, and other commands which draw primitives.",

		"LINES_ADJACENCY_OES" _ 0xA,
		"LINE_STRIP_ADJACENCY_OES" _ 0xB,
		"TRIANGLES_ADJACENCY_OES" _ 0xC,
		"TRIANGLE_STRIP_ADJACENCY_OES" _ 0xD
	)

	IntConstant(
		"Accepted by the {@code pname} parameter of FramebufferParameteri, and GetFramebufferParameteriv.",

		"FRAMEBUFFER_DEFAULT_LAYERS_OES" _ 0x9312
	)

	IntConstant(
		"Accepted by the {@code pname} parameter of GetIntegerv, GetBooleanv, GetInteger64v, and GetFloatv.",

		"MAX_FRAMEBUFFER_LAYERS_OES" _ 0x9317
	)

	IntConstant(
		"Returned by CheckFramebufferStatus.",

		"FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS_OES" _ 0x8DA8
	)

	IntConstant(
		"Accepted by the {@code pname} parameter of GetFramebufferAttachmentParameteriv.",

		"FRAMEBUFFER_ATTACHMENT_LAYERED_OES" _ 0x8DA7
	)

	IntConstant(
		"Accepted by the {@code props} parameter of GetProgramResourceiv.",

		"REFERENCED_BY_GEOMETRY_SHADER_OES" _ 0x9309
	)
