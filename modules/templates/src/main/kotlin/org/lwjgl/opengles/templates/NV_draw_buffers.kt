...
val NV_draw_buffers = "NVDrawBuffers".nativeClassGLES("NV_draw_buffers", postfix = NV) {
	...
	IntConstant(
		...
		"MAX_DRAW_BUFFERS_NV" _ 0x8824,
		"DRAW_BUFFER0_NV" _ 0x8825,
		"DRAW_BUFFER1_NV" _ 0x8826,
		"DRAW_BUFFER2_NV" _ 0x8827,
		"DRAW_BUFFER3_NV" _ 0x8828,
		"DRAW_BUFFER4_NV" _ 0x8829,
		"DRAW_BUFFER5_NV" _ 0x882A,
		"DRAW_BUFFER6_NV" _ 0x882B,
		"DRAW_BUFFER7_NV" _ 0x882C,
		"DRAW_BUFFER8_NV" _ 0x882D,
		"DRAW_BUFFER9_NV" _ 0x882E,
		"DRAW_BUFFER10_NV" _ 0x882F,
		"DRAW_BUFFER11_NV" _ 0x8830,
		"DRAW_BUFFER12_NV" _ 0x8831,
		"DRAW_BUFFER13_NV" _ 0x8832,
		"DRAW_BUFFER14_NV" _ 0x8833,
		"DRAW_BUFFER15_NV" _ 0x8834
	)
