...
val EXT_draw_buffers = "EXTDrawBuffers".nativeClassGLES("EXT_draw_buffers", postfix = EXT) {
	...
	IntConstant(
		...
		"MAX_DRAW_BUFFERS_EXT" _ 0x8824,
		"DRAW_BUFFER0_EXT" _ 0x8825,
		"DRAW_BUFFER1_EXT" _ 0x8826,
		"DRAW_BUFFER2_EXT" _ 0x8827,
		"DRAW_BUFFER3_EXT" _ 0x8828,
		"DRAW_BUFFER4_EXT" _ 0x8829,
		"DRAW_BUFFER5_EXT" _ 0x882A,
		"DRAW_BUFFER6_EXT" _ 0x882B,
		"DRAW_BUFFER7_EXT" _ 0x882C,
		"DRAW_BUFFER8_EXT" _ 0x882D,
		"DRAW_BUFFER9_EXT" _ 0x882E,
		"DRAW_BUFFER10_EXT" _ 0x882F,
		"DRAW_BUFFER11_EXT" _ 0x8830,
		"DRAW_BUFFER12_EXT" _ 0x8831,
		"DRAW_BUFFER13_EXT" _ 0x8832,
		"DRAW_BUFFER14_EXT" _ 0x8833,
		"DRAW_BUFFER15_EXT" _ 0x8834
	)
