...
val EXT_geometry_shader = "EXTGeometryShader".nativeClassGLES("EXT_geometry_shader", postfix = EXT) {
	...
	IntConstant(
		...
		"GEOMETRY_SHADER_EXT" _ 0x8DD9
	)

	IntConstant(
		"Accepted by the {@code stages} parameter of UseProgramStages.",

		"GEOMETRY_SHADER_BIT_EXT" _ 0x00000004
	)

	IntConstant(
		"Accepted by the {@code pname} parameter of GetProgramiv.",

		"GEOMETRY_LINKED_VERTICES_OUT_EXT" _ 0x8916,
		"GEOMETRY_LINKED_INPUT_TYPE_EXT" _ 0x8917,
		"GEOMETRY_LINKED_OUTPUT_TYPE_EXT" _ 0x8918,
		"GEOMETRY_SHADER_INVOCATIONS_EXT" _ 0x887F
	)

	IntConstant(
		"Accepted by the {@code pname} parameter of GetBooleanv, GetIntegerv, GetFloatv, and GetInteger64v.",

		"LAYER_PROVOKING_VERTEX_EXT" _ 0x825E,
		"MAX_GEOMETRY_UNIFORM_COMPONENTS_EXT" _ 0x8DDF,
		"MAX_GEOMETRY_UNIFORM_BLOCKS_EXT" _ 0x8A2C,
		"MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS_EXT" _ 0x8A32,
		"MAX_GEOMETRY_INPUT_COMPONENTS_EXT" _ 0x9123,
		"MAX_GEOMETRY_OUTPUT_COMPONENTS_EXT" _ 0x9124,
		"MAX_GEOMETRY_OUTPUT_VERTICES_EXT" _ 0x8DE0,
		"MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS_EXT" _ 0x8DE1,
		"MAX_GEOMETRY_SHADER_INVOCATIONS_EXT" _ 0x8E5A,
		"MAX_GEOMETRY_TEXTURE_IMAGE_UNITS_EXT" _ 0x8C29,
		"MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS_EXT" _ 0x92CF,
		"MAX_GEOMETRY_ATOMIC_COUNTERS_EXT" _ 0x92D5,
		"MAX_GEOMETRY_IMAGE_UNIFORMS_EXT" _ 0x90CD,
		"MAX_GEOMETRY_SHADER_STORAGE_BLOCKS_EXT" _ 0x90D7
	)
	...
	IntConstant(
		...
		"LINES_ADJACENCY_EXT" _ 0xA,
		"LINE_STRIP_ADJACENCY_EXT" _ 0xB,
		"TRIANGLES_ADJACENCY_EXT" _ 0xC,
		"TRIANGLE_STRIP_ADJACENCY_EXT" _ 0xD
	)

	IntConstant(
		"Accepted by the {@code pname} parameter of FramebufferParameteri, and GetFramebufferParameteriv.",

		"FRAMEBUFFER_DEFAULT_LAYERS_EXT" _ 0x9312
	)

	IntConstant(
		"Accepted by the {@code pname} parameter of GetIntegerv, GetBooleanv, GetInteger64v, and GetFloatv.",

		"MAX_FRAMEBUFFER_LAYERS_EXT" _ 0x9317
	)

	IntConstant(
		"Returned by CheckFramebufferStatus.",

		"FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS_EXT" _ 0x8DA8
	)

	IntConstant(
		"Accepted by the {@code pname} parameter of GetFramebufferAttachmentParameteriv.",

		"FRAMEBUFFER_ATTACHMENT_LAYERED_EXT" _ 0x8DA7
	)

	IntConstant(
		"Accepted by the {@code props} parameter of GetProgramResourceiv.",

		"REFERENCED_BY_GEOMETRY_SHADER_EXT" _ 0x9309
	)
