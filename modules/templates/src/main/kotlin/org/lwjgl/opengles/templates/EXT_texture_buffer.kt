...
val EXT_texture_buffer = "EXTTextureBuffer".nativeClassGLES("EXT_texture_buffer", postfix = EXT) {
	...
	IntConstant(
		...
		"TEXTURE_BUFFER_EXT" _ 0x8C2A
	)

	IntConstant(
		"Accepted by the {@code pname} parameters of GetBooleanv, GetFloatv, and GetIntegerv.",

		"TEXTURE_BUFFER_BINDING_EXT" _ 0x8C2A,
		"MAX_TEXTURE_BUFFER_SIZE_EXT" _ 0x8C2B,
		"TEXTURE_BINDING_BUFFER_EXT" _ 0x8C2C,
		"TEXTURE_BUFFER_OFFSET_ALIGNMENT_EXT" _ 0x919F
	)
	...
	IntConstant(
		...
		"TEXTURE_BUFFER_DATA_STORE_BINDING_EXT" _ 0x8C2D,
		"TEXTURE_BUFFER_OFFSET_EXT" _ 0x919D,
		"TEXTURE_BUFFER_SIZE_EXT" _ 0x919E
	)
