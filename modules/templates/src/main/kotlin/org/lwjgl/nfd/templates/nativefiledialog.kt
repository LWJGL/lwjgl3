...
val nativefiledialog = "NativeFileDialog".nativeClass(packageName = NFD_PACKAGE, prefix = "NFD_", prefixMethod = "NFD_") {
	...
	documentation =
		...
		<h3>Usage</h3>
		${ul(
			"<a href=\"https://github.com/LWJGL/lwjgl3/blob/master/modules/core/src/test/java/org/lwjgl/demo/nfd/OpenSingle.java\">Single file open dialog</a>",
			"<a href=\"https://github.com/LWJGL/lwjgl3/blob/master/modules/core/src/test/java/org/lwjgl/demo/nfd/OpenMulti.java\">Multiple file open dialog</a>",
			"<a href=\"https://github.com/LWJGL/lwjgl3/blob/master/modules/core/src/test/java/org/lwjgl/demo/nfd/Save.java\">Save dialog</a>"
		)}
