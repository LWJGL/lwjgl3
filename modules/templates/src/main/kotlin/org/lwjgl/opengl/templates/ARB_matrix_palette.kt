...
val ARB_matrix_palette = "ARBMatrixPalette".nativeClassGL("ARB_matrix_palette", postfix = ARB) {
	...
	val size = AutoSize("indices")..GLint.IN("size", "the number of index values to set. Must be a value between 1 and ARBVertexBlend#MAX_VERTEX_UNITS_ARB.")
	...
	void(
		...
		ARRAY_BUFFER..void_p.IN("pointer", "the matrix index data")
	)
