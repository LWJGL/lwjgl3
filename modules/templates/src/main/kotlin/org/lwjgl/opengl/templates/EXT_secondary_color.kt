...
val EXT_secondary_color = "EXTSecondaryColor".nativeClassGL("EXT_secondary_color", postfix = EXT) {
	...
	void("SecondaryColor3bvEXT", "Byte pointer version of #SecondaryColor3bEXT().", const _ Check(3) _ GLbyte_p.IN("v", colorBuffer))
	void("SecondaryColor3svEXT", "Pointer version of #SecondaryColor3sEXT().", const _ Check(3) _ GLshort_p.IN("v", colorBuffer))
	void("SecondaryColor3ivEXT", "Pointer version of #SecondaryColor3iEXT().", const _ Check(3) _ GLint_p.IN("v", colorBuffer))
	void("SecondaryColor3fvEXT", "Pointer version of #SecondaryColor3fEXT().", const _ Check(3) _ GLfloat_p.IN("v", colorBuffer))
	void("SecondaryColor3dvEXT", "Pointer version of #SecondaryColor3dEXT().", const _ Check(3) _ GLdouble_p.IN("v", colorBuffer))
	void("SecondaryColor3ubvEXT", "Pointer version of #SecondaryColor3ubEXT().", const _ Check(3) _ GLubyte_p.IN("v", colorBuffer))
	void("SecondaryColor3usvEXT", "Pointer version of #SecondaryColor3usEXT().", const _ Check(3) _ GLushort_p.IN("v", colorBuffer))
	void("SecondaryColor3uivEXT", "Pointer version of #SecondaryColor3uiEXT().", const _ Check(3) _ GLuint_p.IN("v", colorBuffer))
