...
val ARB_window_pos = "ARBWindowPos".nativeClassGL("ARB_window_pos", postfix = ARB) {
	...
	void("WindowPos2ivARB", "Pointer version of #WindowPos2iARB().", Check(2) _ const _ GLint_p.IN("p", "the position value"))
	void("WindowPos2svARB", "Pointer version of #WindowPos2sARB().", Check(2) _ const _ GLshort_p.IN("p", "the position value"))
	void("WindowPos2fvARB", "Pointer version of #WindowPos2fARB().", Check(2) _ const _ GLfloat_p.IN("p", "the position value"))
	void("WindowPos2dvARB", "Pointer version of #WindowPos2dARB().", Check(2) _ const _ GLdouble_p.IN("p", "the position value"))
	...
	void("WindowPos3ivARB", "Pointer version of #WindowPos3iARB().", Check(3) _ const _ GLint_p.IN("p", "the position value"))
	void("WindowPos3svARB", "Pointer version of #WindowPos3sARB().", Check(3) _ const _ GLshort_p.IN("p", "the position value"))
	void("WindowPos3fvARB", "Pointer version of #WindowPos3fARB().", Check(3) _ const _ GLfloat_p.IN("p", "the position value"))
	void("WindowPos3dvARB", "Pointer version of #WindowPos3dARB().", Check(3) _ const _ GLdouble_p.IN("p", "the position value"))
}