...
val AL_SOFT_source_length = "SOFTSourceLength".nativeClassAL("SOFT_source_length") {
	documentation = """
		...
		${AL_SOFT_buffer_samples.link} extension allows an application to query a buffer for its length in bytes, samples, and seconds, but
	...
	IntConstant(
		"Accepted by the {@code paramName} parameter of AL10#GetSourcei() and AL10#GetSourceiv() (these are the same as in AL_SOFT_buffer_samples).",
	...
	IntConstant(
		"Accepted by the {@code paramName} parameter of AL10#GetSourcef() and AL10#GetSourcefv() (these are the same as in AL_SOFT_buffer_samples).",
