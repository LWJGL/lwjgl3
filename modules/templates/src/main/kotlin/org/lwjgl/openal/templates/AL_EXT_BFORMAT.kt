...
val AL_EXT_BFORMAT = "EXTBFormat".nativeClassAL("EXT_BFORMAT") {
	documentation =
		...
		Ambisonics). Use of these formats indicate that sources are Ambisonic sources. Such sources can be oriented via AL10#Sourcefv() using the
		AL10#ORIENTATION tag, which takes the same parameters as {@code alListenerfv(AL_ORIENTATION,...)}. Such sources DO support AL10#SOURCE_RELATIVE and the
