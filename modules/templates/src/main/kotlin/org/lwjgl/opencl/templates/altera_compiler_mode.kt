...
val altera_compiler_mode = "ALTERACompilerMode".nativeClassCL("altera_compiler_mode", ALTERA) {
	...
	IntConstant(
		...
		"CONTEXT_COMPILER_MODE_OFFLINE_ALTERA" expr "0",
		"CONTEXT_COMPILER_MODE_OFFLINE_CREATE_EXE_LIBRARY_ALTERA" expr "1",
		"CONTEXT_COMPILER_MODE_OFFLINE_USE_EXE_LIBRARY_ALTERA" expr "2",
		"CONTEXT_COMPILER_MODE_PRELOADED_BINARY_ONLY_ALTERA" expr "3"
	)
}