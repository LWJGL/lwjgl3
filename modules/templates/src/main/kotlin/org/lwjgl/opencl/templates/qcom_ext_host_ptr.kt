...
val qcom_ext_host_ptr = "QCOMEXTHostPtr".nativeClassCL("qcom_ext_host_ptr", QCOM) {
	documentation =
		...
		This extension extends the functionality provided by CL10#CreateBuffer(), CL10#CreateImage2D(), CL10#CreateImage3D(). It allows applications to specify
	...
	cl_int(
		...
		cl_image_pitch_info_qcom.IN("param_name", "the parameter to query", "CL10#IMAGE_ROW_PITCH CL10#IMAGE_SLICE_PITCH $image_pitch_infos"),
		PARAM_VALUE_SIZE,
		MultiType(
