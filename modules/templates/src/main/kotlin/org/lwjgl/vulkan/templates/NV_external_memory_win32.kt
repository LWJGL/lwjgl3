...
￿    vkGetMemoryWin32HandleNV(device, memory, &memoryHnd);</pre></code>
        ...
        <dl>
            ...
            <dd><ul>
                ...
                <li>Requires <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html\#VK_NV_external_memory">{@code VK_NV_external_memory}</a></li>
            </ul></dd>
