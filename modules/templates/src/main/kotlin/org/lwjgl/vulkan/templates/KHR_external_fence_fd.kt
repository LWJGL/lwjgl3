...
val KHR_external_fence_fd = "KHRExternalFenceFd".nativeClassVK("KHR_external_fence_fd", type = "device", postfix = KHR) {
    documentation =
        ...
        <dl>
            ...
            <dd>VK_KHR_external_fence_fd</dd>
            ...
            <dd><ul>
                ...
                <li>Contributors to <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/xhtml/vkspec.html\#VK_KHR_external_semaphore_fd">VK_KHR_external_semaphore_fd</a></li>
            </ul></dd>
...
￿    const VkImportFenceFdInfoKHR*               pImportFenceFdInfo);</pre></code>
        ...
        <ul>
            ...
            <li>{@code pImportFenceFdInfo} <b>must</b> be a pointer to a valid ##VkImportFenceFdInfoKHR structure</li>
        </ul>
...
￿    int*                                        pFd);</pre></code>
        ...
        If {@code pGetFdInfo}{@code ::handleType} is #EXTERNAL_FENCE_HANDLE_TYPE_SYNC_FD_BIT_KHR and the fence is signaled at the time {@code vkGetFenceFdKHR} is called, {@code pFd} <b>may</b> return the value {@code -1} instead of a valid file descriptor.
        ...
        Exporting a file descriptor from a fence <b>may</b> have side effects depending on the transference of the specified handle type, as described in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/xhtml/vkspec.html\#synchronization-fences-importing">Importing Fence State</a>.

        <h5>Valid Usage (Implicit)</h5>
        <ul>
            <li>{@code device} <b>must</b> be a valid {@code VkDevice} handle</li>
            <li>{@code pGetFdInfo} <b>must</b> be a pointer to a valid ##VkFenceGetFdInfoKHR structure</li>
