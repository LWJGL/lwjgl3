...
￿    vkQueueSubmit(queue, 1, &submit_info, VK_NULL_HANDLE);</pre></code>
        ...
        <dl>
            ...
            <dd><ul>
                ...
                <li>Requires <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html\#VK_NV_external_memory_win32">VK_NV_external_memory_win32</a></li>
            </ul></dd>
