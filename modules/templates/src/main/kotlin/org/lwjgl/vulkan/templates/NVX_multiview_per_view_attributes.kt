	...
	documentation =
		...
		<dl>
			...
			<dd><ul>
				...
				<li>This extension requires the <a href="https://www.khronos.org/registry/spir-v/extensions/NVX/SPV_NVX_multiview_per_view_attributes.html">SPV_NVX_multiview_per_view_attributes</a> SPIR-V extension.</li>
				<li>This extension requires the GL_NVX_multiview_per_view_attributes extension for GLSL source languages.</li>
				<li>Requires <a href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/xhtml/vkspec.html\#VK_KHR_get_physical_device_properties2">VK_KHR_get_physical_device_properties2</a> and <a href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/xhtml/vkspec.html\#VK_KHX_multiview">VK_KHX_multiview</a>.</li>
				<li>This extension interacts with <a href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/xhtml/vkspec.html\#VK_NV_viewport_array2">VK_NV_viewport_array2</a>.</li>
			</ul></dd>
			...
			If {@code VK_NV_viewport_array2} is not also supported and enabled, the per-view viewport mask <b>must</b> not be used.</dd>
		</dl>
