...
val AMD_draw_indirect_count = "AMDDrawIndirectCount".nativeClassVK("AMD_draw_indirect_count", postfix = AMD) {
	documentation =
		"""
	...
	void(
		...
		<pre><code>void vkCmdDrawIndirectCountAMD(
...
￿    uint32_t                                    stride);</code></pre>
	...
	void(
		...
		<pre><code>void vkCmdDrawIndexedIndirectCountAMD(
￿    VkCommandBuffer                             commandBuffer,
￿    VkBuffer                                    buffer,
￿    VkDeviceSize                                offset,
￿    VkBuffer                                    countBuffer,
