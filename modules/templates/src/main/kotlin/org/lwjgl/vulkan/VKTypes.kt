...
val VkInstance = "VkInstance".opaque_p
val VkPhysicalDevice = "VkPhysicalDevice".opaque_p
val VkDevice = "VkDevice".opaque_p
val VkQueue = "VkQueue".opaque_p
val VkSemaphore = "VkSemaphore".opaque_p
val VkCommandBuffer = "VkCommandBuffer".opaque_p
val VkFence = "VkFence".opaque_p
val VkDeviceMemory = "VkDeviceMemory".opaque_p
val VkBuffer = "VkBuffer".opaque_p
val VkImage = "VkImage".opaque_p
val VkEvent = "VkEvent".opaque_p
val VkQueryPool = "VkQueryPool".opaque_p
val VkBufferView = "VkBufferView".opaque_p
val VkImageView = "VkImageView".opaque_p
val VkShaderModule = "VkShaderModule".opaque_p
val VkPipelineCache = "VkPipelineCache".opaque_p
val VkPipelineLayout = "VkPipelineLayout".opaque_p
val VkRenderPass = "VkRenderPass".opaque_p
val VkPipeline = "VkPipeline".opaque_p
val VkDescriptorSetLayout = "VkDescriptorSetLayout".opaque_p
val VkSampler = "VkSampler".opaque_p
val VkDescriptorPool = "VkDescriptorPool".opaque_p
val VkDescriptorSet = "VkDescriptorSet".opaque_p
val VkFramebuffer = "VkFramebuffer".opaque_p
val VkCommandPool = "VkCommandPool".opaque_p
...
val VkApplicationInfo = struct(VULKAN_PACKAGE, "VkApplicationInfo") {
	...
	const_charUTF8_p.member("pApplicationName", "")
	uint32_t.member("applicationVersion", "")
	const_charUTF8_p.member("pEngineName", "")
	uint32_t.member("engineVersion", "")
...
val VkAllocationCallbacks_p = struct_p(VULKAN_PACKAGE, "VkAllocationCallbacks") {
	...
	PFN_vkInternalAllocationNotification.member("pfnInternalAllocation", "")
...
val VkShaderModuleCreateInfo_p = struct_p(VULKAN_PACKAGE, "VkShaderModuleCreateInfo") {
	...
	size_t.member("codeSize", "")
	uint32_t.const_p.member("pCode", "")
}
...
val VkPipelineShaderStageCreateInfo = struct(VULKAN_PACKAGE, "VkPipelineShaderStageCreateInfo") {
	...
	VkSpecializationInfo.const_p.member("pSpecializationInfo", "")
}.nativeType
...
val VkGraphicsPipelineCreateInfo_p = struct_p(VULKAN_PACKAGE, "VkGraphicsPipelineCreateInfo") {
	...
	VkPipelineViewportStateCreateInfo.const_p.member("pViewportState", "")
	VkPipelineRasterizationStateCreateInfo.const_p.member("pRasterizationState", "")
	VkPipelineMultisampleStateCreateInfo.const_p.member("pMultisampleState", "")
	VkPipelineDepthStencilStateCreateInfo.const_p.member("pDepthStencilState", "")
	VkPipelineColorBlendStateCreateInfo.const_p.member("pColorBlendState", "")
	VkPipelineDynamicStateCreateInfo.const_p.member("pDynamicState", "")
...
val VkDescriptorSetLayoutBinding = struct(VULKAN_PACKAGE, "VkDescriptorSetLayoutBinding") {
	...
	VkShaderStageFlags.member("stageFlags", "")
	VkSampler.const_p.member("pImmutableSamplers", "")
}.nativeType
