...
val EXT_display_surface_counter = "EXTDisplaySurfaceCounter".nativeClassVK("EXT_display_surface_counter", postfix = EXT) {
	documentation =
		"""
		<dl>
		...
		This is extension defines a vertical blanking period counter associated with display surfaces. It provides a mechanism to query support for such a counter from a {@code VkSurface} object.
		"""
...
￿    VkSurfaceCapabilities2EXT*                  pSurfaceCapabilities);</code></pre>
		...
		<h5>Description</h5>
		#GetPhysicalDeviceSurfaceCapabilities2EXT() behaves similarly to #GetPhysicalDeviceSurfaceCapabilitiesKHR(), with the ability to return extended information via chained output structures.
