...
public class DBDATETIM4 extends Struct implements NativeResource {
    ...
    /** Returns a new {@code DBDATETIM4} instance allocated on the thread-local {@link MemoryStack}. */
    public static DBDATETIM4 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code DBDATETIM4} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
