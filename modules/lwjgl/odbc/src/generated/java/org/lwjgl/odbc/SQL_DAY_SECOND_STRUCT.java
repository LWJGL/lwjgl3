...
public class SQL_DAY_SECOND_STRUCT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code SQL_DAY_SECOND_STRUCT} instance allocated on the thread-local {@link MemoryStack}. */
    public static SQL_DAY_SECOND_STRUCT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code SQL_DAY_SECOND_STRUCT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
