...
public class SQL_TIMESTAMP_STRUCT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code SQL_TIMESTAMP_STRUCT} instance allocated on the thread-local {@link MemoryStack}. */
    public static SQL_TIMESTAMP_STRUCT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code SQL_TIMESTAMP_STRUCT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
