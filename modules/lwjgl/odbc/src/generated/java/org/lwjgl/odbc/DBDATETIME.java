...
public class DBDATETIME extends Struct implements NativeResource {
    ...
    /** Returns a new {@code DBDATETIME} instance allocated on the thread-local {@link MemoryStack}. */
    public static DBDATETIME mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code DBDATETIME} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
