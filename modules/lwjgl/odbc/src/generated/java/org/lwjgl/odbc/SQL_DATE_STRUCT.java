...
public class SQL_DATE_STRUCT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code SQL_DATE_STRUCT} instance allocated on the thread-local {@link MemoryStack}. */
    public static SQL_DATE_STRUCT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code SQL_DATE_STRUCT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     * @param capacity the buffer capacity
     */
    public static SQL_DATE_STRUCT.Buffer mallocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static SQL_DATE_STRUCT.Buffer callocStack(int capacity) {
