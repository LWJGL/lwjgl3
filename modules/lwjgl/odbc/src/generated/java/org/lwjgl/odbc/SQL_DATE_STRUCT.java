...
public class SQL_DATE_STRUCT extends Struct<SQL_DATE_STRUCT> implements NativeResource {
    ...
    public static SQL_DATE_STRUCT malloc() {
        return new SQL_DATE_STRUCT(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static SQL_DATE_STRUCT calloc() {
        return new SQL_DATE_STRUCT(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static SQL_DATE_STRUCT create() {
        ...
        return new SQL_DATE_STRUCT(memAddress(container), container);
    }
    ...
    public static SQL_DATE_STRUCT malloc(MemoryStack stack) {
        return new SQL_DATE_STRUCT(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static SQL_DATE_STRUCT calloc(MemoryStack stack) {
        return new SQL_DATE_STRUCT(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<SQL_DATE_STRUCT, Buffer> implements NativeResource {
         ...
         * by {@link SQL_DATE_STRUCT#SIZEOF}, and its mark will be undefined.</p>
         *
