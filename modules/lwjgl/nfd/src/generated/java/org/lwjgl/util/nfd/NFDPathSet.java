...
public class NFDPathSet extends Struct implements NativeResource {
    ...
    /** Returns a new {@code NFDPathSet} instance allocated on the thread-local {@link MemoryStack}. */
    public static NFDPathSet mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code NFDPathSet} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
