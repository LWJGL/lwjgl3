...
public class NFDFilterItem extends Struct implements NativeResource {
    ...
    public static NFDFilterItem malloc() {
        return wrap(NFDFilterItem.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static NFDFilterItem calloc() {
        return wrap(NFDFilterItem.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@code NFDFilterItem} instance allocated with {@link BufferUtils}. */
    public static NFDFilterItem create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(NFDFilterItem.class, memAddress(container), container);
    }
    ...
    public static NFDFilterItem create(long address) {
        return wrap(NFDFilterItem.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static NFDFilterItem createSafe(long address) {
        return address == NULL ? null : wrap(NFDFilterItem.class, address);
    }
    ...
    public static NFDFilterItem malloc(MemoryStack stack) {
        return wrap(NFDFilterItem.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static NFDFilterItem calloc(MemoryStack stack) {
        return wrap(NFDFilterItem.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<NFDFilterItem, Buffer> implements NativeResource {
         ...
         * by {@link NFDFilterItem#SIZEOF}, and its mark will be undefined.
         *
