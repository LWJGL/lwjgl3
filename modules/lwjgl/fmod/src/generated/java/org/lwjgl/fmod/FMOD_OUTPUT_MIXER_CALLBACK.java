...
public abstract class FMOD_OUTPUT_MIXER_CALLBACK extends Callback implements FMOD_OUTPUT_MIXER_CALLBACKI {
     ...
     */
    public static FMOD_OUTPUT_MIXER_CALLBACK create(long functionPointer) {
        FMOD_OUTPUT_MIXER_CALLBACKI instance = Callback.get(functionPointer);
    ...
    public static @Nullable FMOD_OUTPUT_MIXER_CALLBACK createSafe(long functionPointer) {
    ...
    public static FMOD_OUTPUT_MIXER_CALLBACK create(FMOD_OUTPUT_MIXER_CALLBACKI instance) {
        return instance instanceof FMOD_OUTPUT_MIXER_CALLBACK
            ? (FMOD_OUTPUT_MIXER_CALLBACK)instance
    ...
    private static final class Container extends FMOD_OUTPUT_MIXER_CALLBACK {

        private final FMOD_OUTPUT_MIXER_CALLBACKI delegate;

        Container(long functionPointer, FMOD_OUTPUT_MIXER_CALLBACKI delegate) {
            super(functionPointer);
