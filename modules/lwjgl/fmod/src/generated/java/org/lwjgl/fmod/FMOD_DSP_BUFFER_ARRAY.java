...
public class FMOD_DSP_BUFFER_ARRAY extends Struct implements NativeResource {
    ...
    public static FMOD_DSP_BUFFER_ARRAY malloc() {
        return wrap(FMOD_DSP_BUFFER_ARRAY.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_DSP_BUFFER_ARRAY calloc() {
        return wrap(FMOD_DSP_BUFFER_ARRAY.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_DSP_BUFFER_ARRAY create() {
        ...
        return wrap(FMOD_DSP_BUFFER_ARRAY.class, memAddress(container), container);
    }
    ...
    public static FMOD_DSP_BUFFER_ARRAY create(long address) {
        return wrap(FMOD_DSP_BUFFER_ARRAY.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_DSP_BUFFER_ARRAY createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_DSP_BUFFER_ARRAY.class, address);
    }
    ...
    public static FMOD_DSP_BUFFER_ARRAY malloc(MemoryStack stack) {
        return wrap(FMOD_DSP_BUFFER_ARRAY.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_DSP_BUFFER_ARRAY calloc(MemoryStack stack) {
        return wrap(FMOD_DSP_BUFFER_ARRAY.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_DSP_BUFFER_ARRAY, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_DSP_BUFFER_ARRAY#SIZEOF}, and its mark will be undefined.
         *
