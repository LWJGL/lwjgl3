 ...
 * }</code></pre>
 */
public class FMOD_DSP_PARAMETER_ATTENUATION_RANGE extends Struct implements NativeResource {
    ...
    public static FMOD_DSP_PARAMETER_ATTENUATION_RANGE malloc() {
        return wrap(FMOD_DSP_PARAMETER_ATTENUATION_RANGE.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_ATTENUATION_RANGE calloc() {
        return wrap(FMOD_DSP_PARAMETER_ATTENUATION_RANGE.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_ATTENUATION_RANGE create() {
        ...
        return wrap(FMOD_DSP_PARAMETER_ATTENUATION_RANGE.class, memAddress(container), container);
    }
    ...
    public static FMOD_DSP_PARAMETER_ATTENUATION_RANGE create(long address) {
        return wrap(FMOD_DSP_PARAMETER_ATTENUATION_RANGE.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_DSP_PARAMETER_ATTENUATION_RANGE createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_DSP_PARAMETER_ATTENUATION_RANGE.class, address);
    }
    ...
    public static FMOD_DSP_PARAMETER_ATTENUATION_RANGE malloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_ATTENUATION_RANGE.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_ATTENUATION_RANGE calloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_ATTENUATION_RANGE.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_DSP_PARAMETER_ATTENUATION_RANGE, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_DSP_PARAMETER_ATTENUATION_RANGE#SIZEOF}, and its mark will be undefined.
         *
