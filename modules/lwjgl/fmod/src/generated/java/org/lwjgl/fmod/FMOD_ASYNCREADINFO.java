...
public class FMOD_ASYNCREADINFO extends Struct implements NativeResource {
    ...
    public static FMOD_ASYNCREADINFO malloc() {
        return wrap(FMOD_ASYNCREADINFO.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_ASYNCREADINFO calloc() {
        return wrap(FMOD_ASYNCREADINFO.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_ASYNCREADINFO create() {
        ...
        return wrap(FMOD_ASYNCREADINFO.class, memAddress(container), container);
    }
    ...
    public static FMOD_ASYNCREADINFO create(long address) {
        return wrap(FMOD_ASYNCREADINFO.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_ASYNCREADINFO createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_ASYNCREADINFO.class, address);
    }
    ...
    public static FMOD_ASYNCREADINFO malloc(MemoryStack stack) {
        return wrap(FMOD_ASYNCREADINFO.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_ASYNCREADINFO calloc(MemoryStack stack) {
        return wrap(FMOD_ASYNCREADINFO.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_ASYNCREADINFO, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_ASYNCREADINFO#SIZEOF}, and its mark will be undefined.
         *
