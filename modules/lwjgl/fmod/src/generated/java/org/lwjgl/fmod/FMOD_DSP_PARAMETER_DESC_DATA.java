 ...
 * }</code></pre>
 */
public class FMOD_DSP_PARAMETER_DESC_DATA extends Struct implements NativeResource {
    ...
    public static FMOD_DSP_PARAMETER_DESC_DATA malloc() {
        return wrap(FMOD_DSP_PARAMETER_DESC_DATA.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_DATA calloc() {
        return wrap(FMOD_DSP_PARAMETER_DESC_DATA.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_DATA create() {
        ...
        return wrap(FMOD_DSP_PARAMETER_DESC_DATA.class, memAddress(container), container);
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_DATA create(long address) {
        return wrap(FMOD_DSP_PARAMETER_DESC_DATA.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_DSP_PARAMETER_DESC_DATA createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_DSP_PARAMETER_DESC_DATA.class, address);
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_DATA malloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_DESC_DATA.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_DATA calloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_DESC_DATA.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_DSP_PARAMETER_DESC_DATA, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_DSP_PARAMETER_DESC_DATA#SIZEOF}, and its mark will be undefined.
         *
