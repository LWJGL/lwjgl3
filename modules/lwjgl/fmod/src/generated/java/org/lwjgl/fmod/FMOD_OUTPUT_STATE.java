...
public class FMOD_OUTPUT_STATE extends Struct implements NativeResource {
    ...
    public static FMOD_OUTPUT_STATE malloc() {
        return wrap(FMOD_OUTPUT_STATE.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_OUTPUT_STATE calloc() {
        return wrap(FMOD_OUTPUT_STATE.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_OUTPUT_STATE create() {
        ...
        return wrap(FMOD_OUTPUT_STATE.class, memAddress(container), container);
    }
    ...
    public static FMOD_OUTPUT_STATE create(long address) {
        return wrap(FMOD_OUTPUT_STATE.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_OUTPUT_STATE createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_OUTPUT_STATE.class, address);
    }
    ...
    public static FMOD_OUTPUT_STATE malloc(MemoryStack stack) {
        return wrap(FMOD_OUTPUT_STATE.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_OUTPUT_STATE calloc(MemoryStack stack) {
        return wrap(FMOD_OUTPUT_STATE.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_OUTPUT_STATE, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_OUTPUT_STATE#SIZEOF}, and its mark will be undefined.
         *
