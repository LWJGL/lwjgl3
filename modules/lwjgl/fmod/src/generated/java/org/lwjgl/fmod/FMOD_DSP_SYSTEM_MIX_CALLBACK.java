...
public abstract class FMOD_DSP_SYSTEM_MIX_CALLBACK extends Callback implements FMOD_DSP_SYSTEM_MIX_CALLBACKI {
     ...
     */
    public static FMOD_DSP_SYSTEM_MIX_CALLBACK create(long functionPointer) {
        FMOD_DSP_SYSTEM_MIX_CALLBACKI instance = Callback.get(functionPointer);
    ...
    public static @Nullable FMOD_DSP_SYSTEM_MIX_CALLBACK createSafe(long functionPointer) {
    ...
    public static FMOD_DSP_SYSTEM_MIX_CALLBACK create(FMOD_DSP_SYSTEM_MIX_CALLBACKI instance) {
        return instance instanceof FMOD_DSP_SYSTEM_MIX_CALLBACK
            ? (FMOD_DSP_SYSTEM_MIX_CALLBACK)instance
    ...
    private static final class Container extends FMOD_DSP_SYSTEM_MIX_CALLBACK {

        private final FMOD_DSP_SYSTEM_MIX_CALLBACKI delegate;

        Container(long functionPointer, FMOD_DSP_SYSTEM_MIX_CALLBACKI delegate) {
            super(functionPointer);
            this.delegate = delegate;
        }

        @Override
        public int invoke(long dsp_state, int stage) {
            return delegate.invoke(dsp_state, stage);
        }
