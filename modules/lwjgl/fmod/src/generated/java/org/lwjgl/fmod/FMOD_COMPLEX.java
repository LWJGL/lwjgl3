...
public class FMOD_COMPLEX extends Struct implements NativeResource {
    ...
    public static FMOD_COMPLEX malloc() {
        return wrap(FMOD_COMPLEX.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_COMPLEX malloc(MemoryStack stack) {
        return wrap(FMOD_COMPLEX.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_COMPLEX calloc(MemoryStack stack) {
        return wrap(FMOD_COMPLEX.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_COMPLEX, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_COMPLEX#SIZEOF}, and its mark will be undefined.
         *
