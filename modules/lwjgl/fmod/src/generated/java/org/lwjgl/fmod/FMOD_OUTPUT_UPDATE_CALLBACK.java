...
/** Callback function: {@link #invoke FMOD_OUTPUT_UPDATE_CALLBACK} */
public abstract class FMOD_OUTPUT_UPDATE_CALLBACK extends Callback implements FMOD_OUTPUT_UPDATE_CALLBACKI {
     ...
     */
    public static FMOD_OUTPUT_UPDATE_CALLBACK create(long functionPointer) { return create(Callback.get(functionPointer), functionPointer); }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code functionPointer} is {@code NULL}. */
    public static @Nullable FMOD_OUTPUT_UPDATE_CALLBACK createSafe(long functionPointer) { return functionPointer == NULL ? null : create(functionPointer); }
    ...
    public static FMOD_OUTPUT_UPDATE_CALLBACK create(FMOD_OUTPUT_UPDATE_CALLBACKI instance) { return create(instance, instance.address()); }

    private static FMOD_OUTPUT_UPDATE_CALLBACK create(FMOD_OUTPUT_UPDATE_CALLBACKI instance, long functionPointer) {
        return instance instanceof FMOD_OUTPUT_UPDATE_CALLBACK
            ? (FMOD_OUTPUT_UPDATE_CALLBACK)instance
            : new FMOD_OUTPUT_UPDATE_CALLBACK(functionPointer) {
