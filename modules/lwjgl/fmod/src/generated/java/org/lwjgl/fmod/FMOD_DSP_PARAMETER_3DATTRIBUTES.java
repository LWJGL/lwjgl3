...
public class FMOD_DSP_PARAMETER_3DATTRIBUTES extends Struct implements NativeResource {
    ...
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES malloc() {
        return wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES calloc() {
        return wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES create() {
        ...
        return wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES.class, memAddress(container), container);
    }
    ...
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES create(long address) {
        return wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES.class, address);
    }
    ...
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES malloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES calloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_DSP_PARAMETER_3DATTRIBUTES, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_DSP_PARAMETER_3DATTRIBUTES#SIZEOF}, and its mark will be undefined.
         *
