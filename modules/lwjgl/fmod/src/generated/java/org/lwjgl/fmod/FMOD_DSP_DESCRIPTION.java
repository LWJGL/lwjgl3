...
public class FMOD_DSP_DESCRIPTION extends Struct implements NativeResource {
    ...
    public static FMOD_DSP_DESCRIPTION malloc() {
        return wrap(FMOD_DSP_DESCRIPTION.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_DSP_DESCRIPTION calloc() {
        return wrap(FMOD_DSP_DESCRIPTION.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_DSP_DESCRIPTION create() {
        ...
        return wrap(FMOD_DSP_DESCRIPTION.class, memAddress(container), container);
    }
    ...
    public static FMOD_DSP_DESCRIPTION create(long address) {
        return wrap(FMOD_DSP_DESCRIPTION.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_DSP_DESCRIPTION createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_DSP_DESCRIPTION.class, address);
    }
    ...
    public static FMOD_DSP_DESCRIPTION malloc(MemoryStack stack) {
        return wrap(FMOD_DSP_DESCRIPTION.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_DSP_DESCRIPTION calloc(MemoryStack stack) {
        return wrap(FMOD_DSP_DESCRIPTION.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_DSP_DESCRIPTION, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_DSP_DESCRIPTION#SIZEOF}, and its mark will be undefined.
         *
