 ...
 * }</code></pre>
 */
public class FSBANK_STATEDATA_WARNING extends Struct implements NativeResource {
    ...
    public static FSBANK_STATEDATA_WARNING malloc() {
        return wrap(FSBANK_STATEDATA_WARNING.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FSBANK_STATEDATA_WARNING calloc() {
        return wrap(FSBANK_STATEDATA_WARNING.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FSBANK_STATEDATA_WARNING create() {
        ...
        return wrap(FSBANK_STATEDATA_WARNING.class, memAddress(container), container);
    }
    ...
    public static FSBANK_STATEDATA_WARNING create(long address) {
        return wrap(FSBANK_STATEDATA_WARNING.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FSBANK_STATEDATA_WARNING createSafe(long address) {
        return address == NULL ? null : wrap(FSBANK_STATEDATA_WARNING.class, address);
    }
    ...
    public static FSBANK_STATEDATA_WARNING malloc(MemoryStack stack) {
        return wrap(FSBANK_STATEDATA_WARNING.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FSBANK_STATEDATA_WARNING calloc(MemoryStack stack) {
        return wrap(FSBANK_STATEDATA_WARNING.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FSBANK_STATEDATA_WARNING, Buffer> implements NativeResource {
         ...
         * by {@link FSBANK_STATEDATA_WARNING#SIZEOF}, and its mark will be undefined.
         *
