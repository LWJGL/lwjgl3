 ...
 * }</code></pre>
 */
public class FMOD_DSP_STATE_FUNCTIONS extends Struct implements NativeResource {
    ...
    public static FMOD_DSP_STATE_FUNCTIONS malloc() {
        return wrap(FMOD_DSP_STATE_FUNCTIONS.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_DSP_STATE_FUNCTIONS calloc() {
        return wrap(FMOD_DSP_STATE_FUNCTIONS.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_DSP_STATE_FUNCTIONS create() {
        ...
        return wrap(FMOD_DSP_STATE_FUNCTIONS.class, memAddress(container), container);
    }
    ...
    public static FMOD_DSP_STATE_FUNCTIONS create(long address) {
        return wrap(FMOD_DSP_STATE_FUNCTIONS.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_DSP_STATE_FUNCTIONS createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_DSP_STATE_FUNCTIONS.class, address);
    }
    ...
    public static FMOD_DSP_STATE_FUNCTIONS malloc(MemoryStack stack) {
        return wrap(FMOD_DSP_STATE_FUNCTIONS.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_DSP_STATE_FUNCTIONS calloc(MemoryStack stack) {
        return wrap(FMOD_DSP_STATE_FUNCTIONS.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_DSP_STATE_FUNCTIONS, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_DSP_STATE_FUNCTIONS#SIZEOF}, and its mark will be undefined.
         *
