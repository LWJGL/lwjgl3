 ...
 * }</code></pre>
 */
public class FSBANK_PROGRESSITEM extends Struct implements NativeResource {
    ...
    public static FSBANK_PROGRESSITEM malloc() {
        return wrap(FSBANK_PROGRESSITEM.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FSBANK_PROGRESSITEM calloc() {
        return wrap(FSBANK_PROGRESSITEM.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FSBANK_PROGRESSITEM create() {
        ...
        return wrap(FSBANK_PROGRESSITEM.class, memAddress(container), container);
    }
    ...
    public static FSBANK_PROGRESSITEM create(long address) {
        return wrap(FSBANK_PROGRESSITEM.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FSBANK_PROGRESSITEM createSafe(long address) {
        return address == NULL ? null : wrap(FSBANK_PROGRESSITEM.class, address);
    }
    ...
    public static FSBANK_PROGRESSITEM malloc(MemoryStack stack) {
        return wrap(FSBANK_PROGRESSITEM.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FSBANK_PROGRESSITEM calloc(MemoryStack stack) {
        return wrap(FSBANK_PROGRESSITEM.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FSBANK_PROGRESSITEM, Buffer> implements NativeResource {
         ...
         * by {@link FSBANK_PROGRESSITEM#SIZEOF}, and its mark will be undefined.
         *
