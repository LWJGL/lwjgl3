 ...
 * }</code></pre>
 */
public class FMOD_DSP_PARAMETER_DESC_INT extends Struct implements NativeResource {
    ...
    public static FMOD_DSP_PARAMETER_DESC_INT malloc() {
        return wrap(FMOD_DSP_PARAMETER_DESC_INT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_INT calloc() {
        return wrap(FMOD_DSP_PARAMETER_DESC_INT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_INT create() {
        ...
        return wrap(FMOD_DSP_PARAMETER_DESC_INT.class, memAddress(container), container);
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_INT create(long address) {
        return wrap(FMOD_DSP_PARAMETER_DESC_INT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_DSP_PARAMETER_DESC_INT createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_DSP_PARAMETER_DESC_INT.class, address);
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_INT malloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_DESC_INT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_INT calloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_DESC_INT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_DSP_PARAMETER_DESC_INT, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_DSP_PARAMETER_DESC_INT#SIZEOF}, and its mark will be undefined.
         *
