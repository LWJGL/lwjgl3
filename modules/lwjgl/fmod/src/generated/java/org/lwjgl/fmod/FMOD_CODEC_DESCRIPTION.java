...
public class FMOD_CODEC_DESCRIPTION extends Struct implements NativeResource {
    ...
    public static FMOD_CODEC_DESCRIPTION malloc() {
        return wrap(FMOD_CODEC_DESCRIPTION.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_CODEC_DESCRIPTION calloc() {
        return wrap(FMOD_CODEC_DESCRIPTION.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_CODEC_DESCRIPTION create() {
        ...
        return wrap(FMOD_CODEC_DESCRIPTION.class, memAddress(container), container);
    }
    ...
    public static FMOD_CODEC_DESCRIPTION create(long address) {
        return wrap(FMOD_CODEC_DESCRIPTION.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_CODEC_DESCRIPTION createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_CODEC_DESCRIPTION.class, address);
    }
    ...
    public static FMOD_CODEC_DESCRIPTION malloc(MemoryStack stack) {
        return wrap(FMOD_CODEC_DESCRIPTION.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_CODEC_DESCRIPTION calloc(MemoryStack stack) {
        return wrap(FMOD_CODEC_DESCRIPTION.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_CODEC_DESCRIPTION, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_CODEC_DESCRIPTION#SIZEOF}, and its mark will be undefined.
         *
