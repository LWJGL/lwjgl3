 ...
 * }</code></pre>
 */
public class FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI extends Struct implements NativeResource {
    ...
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI malloc() {
        return wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI calloc() {
        return wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI create() {
        ...
        return wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI.class, memAddress(container), container);
    }
    ...
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI create(long address) {
        return wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI.class, address);
    }
    ...
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI malloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI calloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_DSP_PARAMETER_3DATTRIBUTES_MULTI#SIZEOF}, and its mark will be undefined.
         *
