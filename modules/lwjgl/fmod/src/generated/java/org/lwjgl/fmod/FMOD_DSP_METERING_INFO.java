 ...
 * }</code></pre>
 */
public class FMOD_DSP_METERING_INFO extends Struct implements NativeResource {
    ...
    public static FMOD_DSP_METERING_INFO malloc() {
        return wrap(FMOD_DSP_METERING_INFO.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_DSP_METERING_INFO calloc() {
        return wrap(FMOD_DSP_METERING_INFO.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_DSP_METERING_INFO create() {
        ...
        return wrap(FMOD_DSP_METERING_INFO.class, memAddress(container), container);
    }
    ...
    public static FMOD_DSP_METERING_INFO create(long address) {
        return wrap(FMOD_DSP_METERING_INFO.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_DSP_METERING_INFO createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_DSP_METERING_INFO.class, address);
    }
    ...
    public static FMOD_DSP_METERING_INFO malloc(MemoryStack stack) {
        return wrap(FMOD_DSP_METERING_INFO.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_DSP_METERING_INFO calloc(MemoryStack stack) {
        return wrap(FMOD_DSP_METERING_INFO.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_DSP_METERING_INFO, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_DSP_METERING_INFO#SIZEOF}, and its mark will be undefined.
         *
