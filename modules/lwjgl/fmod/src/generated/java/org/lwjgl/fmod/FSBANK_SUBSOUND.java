 ...
 * }</code></pre>
 */
public class FSBANK_SUBSOUND extends Struct implements NativeResource {
    ...
    public static FSBANK_SUBSOUND malloc() {
        return wrap(FSBANK_SUBSOUND.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FSBANK_SUBSOUND calloc() {
        return wrap(FSBANK_SUBSOUND.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FSBANK_SUBSOUND create() {
        ...
        return wrap(FSBANK_SUBSOUND.class, memAddress(container), container);
    }
    ...
    public static FSBANK_SUBSOUND create(long address) {
        return wrap(FSBANK_SUBSOUND.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FSBANK_SUBSOUND createSafe(long address) {
        return address == NULL ? null : wrap(FSBANK_SUBSOUND.class, address);
    }
    ...
    public static FSBANK_SUBSOUND malloc(MemoryStack stack) {
        return wrap(FSBANK_SUBSOUND.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FSBANK_SUBSOUND calloc(MemoryStack stack) {
        return wrap(FSBANK_SUBSOUND.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FSBANK_SUBSOUND, Buffer> implements NativeResource {
         ...
         * by {@link FSBANK_SUBSOUND#SIZEOF}, and its mark will be undefined.
         *
