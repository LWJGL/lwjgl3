 ...
 * }</code></pre>
 */
public class FMOD_STUDIO_USER_PROPERTY extends Struct implements NativeResource {
    ...
    public static FMOD_STUDIO_USER_PROPERTY malloc() {
        return wrap(FMOD_STUDIO_USER_PROPERTY.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_STUDIO_USER_PROPERTY calloc() {
        return wrap(FMOD_STUDIO_USER_PROPERTY.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_STUDIO_USER_PROPERTY create() {
        ...
        return wrap(FMOD_STUDIO_USER_PROPERTY.class, memAddress(container), container);
    }
    ...
    public static FMOD_STUDIO_USER_PROPERTY create(long address) {
        return wrap(FMOD_STUDIO_USER_PROPERTY.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_STUDIO_USER_PROPERTY createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_STUDIO_USER_PROPERTY.class, address);
    }
    ...
    public static FMOD_STUDIO_USER_PROPERTY malloc(MemoryStack stack) {
        return wrap(FMOD_STUDIO_USER_PROPERTY.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_STUDIO_USER_PROPERTY calloc(MemoryStack stack) {
        return wrap(FMOD_STUDIO_USER_PROPERTY.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_STUDIO_USER_PROPERTY, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_STUDIO_USER_PROPERTY#SIZEOF}, and its mark will be undefined.
         *
