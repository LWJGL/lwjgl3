 ...
 * }</code></pre>
 */
public class FMOD_DSP_PARAMETER_DESC_FLOAT extends Struct implements NativeResource {
    ...
    public static FMOD_DSP_PARAMETER_DESC_FLOAT malloc() {
        return wrap(FMOD_DSP_PARAMETER_DESC_FLOAT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_FLOAT calloc() {
        return wrap(FMOD_DSP_PARAMETER_DESC_FLOAT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_FLOAT create() {
        ...
        return wrap(FMOD_DSP_PARAMETER_DESC_FLOAT.class, memAddress(container), container);
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_FLOAT create(long address) {
        return wrap(FMOD_DSP_PARAMETER_DESC_FLOAT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_DSP_PARAMETER_DESC_FLOAT createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_DSP_PARAMETER_DESC_FLOAT.class, address);
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_FLOAT malloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_DESC_FLOAT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_DESC_FLOAT calloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_DESC_FLOAT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_DSP_PARAMETER_DESC_FLOAT, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_DSP_PARAMETER_DESC_FLOAT#SIZEOF}, and its mark will be undefined.
         *
