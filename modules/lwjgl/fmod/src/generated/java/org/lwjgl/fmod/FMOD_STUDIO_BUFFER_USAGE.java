 ...
 * }</code></pre>
 */
public class FMOD_STUDIO_BUFFER_USAGE extends Struct implements NativeResource {
    ...
    public static FMOD_STUDIO_BUFFER_USAGE malloc() {
        return wrap(FMOD_STUDIO_BUFFER_USAGE.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_STUDIO_BUFFER_USAGE calloc() {
        return wrap(FMOD_STUDIO_BUFFER_USAGE.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_STUDIO_BUFFER_USAGE create() {
        ...
        return wrap(FMOD_STUDIO_BUFFER_USAGE.class, memAddress(container), container);
    }
    ...
    public static FMOD_STUDIO_BUFFER_USAGE create(long address) {
        return wrap(FMOD_STUDIO_BUFFER_USAGE.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_STUDIO_BUFFER_USAGE createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_STUDIO_BUFFER_USAGE.class, address);
    }
    ...
    public static FMOD_STUDIO_BUFFER_USAGE malloc(MemoryStack stack) {
        return wrap(FMOD_STUDIO_BUFFER_USAGE.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_STUDIO_BUFFER_USAGE calloc(MemoryStack stack) {
        return wrap(FMOD_STUDIO_BUFFER_USAGE.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_STUDIO_BUFFER_USAGE, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_STUDIO_BUFFER_USAGE#SIZEOF}, and its mark will be undefined.
         *
