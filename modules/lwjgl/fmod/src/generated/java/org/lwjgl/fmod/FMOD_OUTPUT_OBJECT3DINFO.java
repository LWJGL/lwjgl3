...
public class FMOD_OUTPUT_OBJECT3DINFO extends Struct implements NativeResource {
    ...
    public static FMOD_OUTPUT_OBJECT3DINFO malloc() {
        return wrap(FMOD_OUTPUT_OBJECT3DINFO.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_OUTPUT_OBJECT3DINFO calloc() {
        return wrap(FMOD_OUTPUT_OBJECT3DINFO.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_OUTPUT_OBJECT3DINFO create() {
        ...
        return wrap(FMOD_OUTPUT_OBJECT3DINFO.class, memAddress(container), container);
    }
    ...
    public static FMOD_OUTPUT_OBJECT3DINFO create(long address) {
        return wrap(FMOD_OUTPUT_OBJECT3DINFO.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_OUTPUT_OBJECT3DINFO createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_OUTPUT_OBJECT3DINFO.class, address);
    }
    ...
    public static FMOD_OUTPUT_OBJECT3DINFO malloc(MemoryStack stack) {
        return wrap(FMOD_OUTPUT_OBJECT3DINFO.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_OUTPUT_OBJECT3DINFO calloc(MemoryStack stack) {
        return wrap(FMOD_OUTPUT_OBJECT3DINFO.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_OUTPUT_OBJECT3DINFO, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_OUTPUT_OBJECT3DINFO#SIZEOF}, and its mark will be undefined.
         *
