...
public abstract class FMOD_CODEC_FILE_SEEK_FUNC extends Callback implements FMOD_CODEC_FILE_SEEK_FUNCI {
     ...
     */
    public static FMOD_CODEC_FILE_SEEK_FUNC create(long functionPointer) {
        FMOD_CODEC_FILE_SEEK_FUNCI instance = Callback.get(functionPointer);
    ...
    public static @Nullable FMOD_CODEC_FILE_SEEK_FUNC createSafe(long functionPointer) {
    ...
    public static FMOD_CODEC_FILE_SEEK_FUNC create(FMOD_CODEC_FILE_SEEK_FUNCI instance) {
        return instance instanceof FMOD_CODEC_FILE_SEEK_FUNC
            ? (FMOD_CODEC_FILE_SEEK_FUNC)instance
    ...
    private static final class Container extends FMOD_CODEC_FILE_SEEK_FUNC {

        private final FMOD_CODEC_FILE_SEEK_FUNCI delegate;

        Container(long functionPointer, FMOD_CODEC_FILE_SEEK_FUNCI delegate) {
            super(functionPointer);
            this.delegate = delegate;
        }

        @Override
        public int invoke(long codec_state, int pos, int method) {
            return delegate.invoke(codec_state, pos, method);
        }
