...
public class FMOD_3D_ATTRIBUTES extends Struct implements NativeResource {
    ...
    public static FMOD_3D_ATTRIBUTES malloc() {
        return wrap(FMOD_3D_ATTRIBUTES.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_3D_ATTRIBUTES calloc() {
        return wrap(FMOD_3D_ATTRIBUTES.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_3D_ATTRIBUTES create() {
        ...
        return wrap(FMOD_3D_ATTRIBUTES.class, memAddress(container), container);
    }
    ...
    public static FMOD_3D_ATTRIBUTES create(long address) {
        return wrap(FMOD_3D_ATTRIBUTES.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_3D_ATTRIBUTES createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_3D_ATTRIBUTES.class, address);
    }
    ...
    public static FMOD_3D_ATTRIBUTES malloc(MemoryStack stack) {
        return wrap(FMOD_3D_ATTRIBUTES.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_3D_ATTRIBUTES calloc(MemoryStack stack) {
        return wrap(FMOD_3D_ATTRIBUTES.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_3D_ATTRIBUTES, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_3D_ATTRIBUTES#SIZEOF}, and its mark will be undefined.
         *
