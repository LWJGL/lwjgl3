 ...
 * }</code></pre>
 */
public class FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR extends Struct implements NativeResource {
    ...
    public static FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR malloc() {
        return wrap(FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR calloc() {
        return wrap(FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR create() {
        ...
        return wrap(FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR.class, memAddress(container), container);
    }
    ...
    public static FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR create(long address) {
        return wrap(FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR.class, address);
    }
    ...
    public static FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR malloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR calloc(MemoryStack stack) {
        return wrap(FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_DSP_PARAMETER_FLOAT_MAPPING_PIECEWISE_LINEAR#SIZEOF}, and its mark will be undefined.
         *
