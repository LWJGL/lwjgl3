...
public class FMOD_CODEC_WAVEFORMAT extends Struct implements NativeResource {
    ...
    public static FMOD_CODEC_WAVEFORMAT malloc() {
        return wrap(FMOD_CODEC_WAVEFORMAT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_CODEC_WAVEFORMAT calloc() {
        return wrap(FMOD_CODEC_WAVEFORMAT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_CODEC_WAVEFORMAT create() {
        ...
        return wrap(FMOD_CODEC_WAVEFORMAT.class, memAddress(container), container);
    }
    ...
    public static FMOD_CODEC_WAVEFORMAT create(long address) {
        return wrap(FMOD_CODEC_WAVEFORMAT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_CODEC_WAVEFORMAT createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_CODEC_WAVEFORMAT.class, address);
    }
    ...
    public static FMOD_CODEC_WAVEFORMAT malloc(MemoryStack stack) {
        return wrap(FMOD_CODEC_WAVEFORMAT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_CODEC_WAVEFORMAT calloc(MemoryStack stack) {
        return wrap(FMOD_CODEC_WAVEFORMAT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_CODEC_WAVEFORMAT, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_CODEC_WAVEFORMAT#SIZEOF}, and its mark will be undefined.
         *
