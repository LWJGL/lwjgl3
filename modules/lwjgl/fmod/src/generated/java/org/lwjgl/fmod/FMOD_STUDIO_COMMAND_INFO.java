...
public class FMOD_STUDIO_COMMAND_INFO extends Struct implements NativeResource {
    ...
    public static FMOD_STUDIO_COMMAND_INFO malloc() {
        return wrap(FMOD_STUDIO_COMMAND_INFO.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_STUDIO_COMMAND_INFO calloc() {
        return wrap(FMOD_STUDIO_COMMAND_INFO.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_STUDIO_COMMAND_INFO create() {
        ...
        return wrap(FMOD_STUDIO_COMMAND_INFO.class, memAddress(container), container);
    }
    ...
    public static FMOD_STUDIO_COMMAND_INFO create(long address) {
        return wrap(FMOD_STUDIO_COMMAND_INFO.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_STUDIO_COMMAND_INFO createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_STUDIO_COMMAND_INFO.class, address);
    }
    ...
    public static FMOD_STUDIO_COMMAND_INFO malloc(MemoryStack stack) {
        return wrap(FMOD_STUDIO_COMMAND_INFO.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_STUDIO_COMMAND_INFO calloc(MemoryStack stack) {
        return wrap(FMOD_STUDIO_COMMAND_INFO.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_STUDIO_COMMAND_INFO, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_STUDIO_COMMAND_INFO#SIZEOF}, and its mark will be undefined.
         *
