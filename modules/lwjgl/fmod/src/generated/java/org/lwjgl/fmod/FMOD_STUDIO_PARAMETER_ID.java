 ...
 * }</code></pre>
 */
public class FMOD_STUDIO_PARAMETER_ID extends Struct implements NativeResource {
    ...
    public static FMOD_STUDIO_PARAMETER_ID malloc() {
        return wrap(FMOD_STUDIO_PARAMETER_ID.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_STUDIO_PARAMETER_ID calloc() {
        return wrap(FMOD_STUDIO_PARAMETER_ID.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_STUDIO_PARAMETER_ID create() {
        ...
        return wrap(FMOD_STUDIO_PARAMETER_ID.class, memAddress(container), container);
    }
    ...
    public static FMOD_STUDIO_PARAMETER_ID create(long address) {
        return wrap(FMOD_STUDIO_PARAMETER_ID.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_STUDIO_PARAMETER_ID createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_STUDIO_PARAMETER_ID.class, address);
    }
    ...
    public static FMOD_STUDIO_PARAMETER_ID malloc(MemoryStack stack) {
        return wrap(FMOD_STUDIO_PARAMETER_ID.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_STUDIO_PARAMETER_ID calloc(MemoryStack stack) {
        return wrap(FMOD_STUDIO_PARAMETER_ID.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_STUDIO_PARAMETER_ID, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_STUDIO_PARAMETER_ID#SIZEOF}, and its mark will be undefined.
         *
