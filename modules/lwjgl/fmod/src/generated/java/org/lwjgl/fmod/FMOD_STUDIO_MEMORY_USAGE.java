 ...
 * }</code></pre>
 */
public class FMOD_STUDIO_MEMORY_USAGE extends Struct implements NativeResource {
    ...
    public static FMOD_STUDIO_MEMORY_USAGE malloc() {
        return wrap(FMOD_STUDIO_MEMORY_USAGE.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FMOD_STUDIO_MEMORY_USAGE calloc() {
        return wrap(FMOD_STUDIO_MEMORY_USAGE.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FMOD_STUDIO_MEMORY_USAGE create() {
        ...
        return wrap(FMOD_STUDIO_MEMORY_USAGE.class, memAddress(container), container);
    }
    ...
    public static FMOD_STUDIO_MEMORY_USAGE create(long address) {
        return wrap(FMOD_STUDIO_MEMORY_USAGE.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FMOD_STUDIO_MEMORY_USAGE createSafe(long address) {
        return address == NULL ? null : wrap(FMOD_STUDIO_MEMORY_USAGE.class, address);
    }
    ...
    public static FMOD_STUDIO_MEMORY_USAGE malloc(MemoryStack stack) {
        return wrap(FMOD_STUDIO_MEMORY_USAGE.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FMOD_STUDIO_MEMORY_USAGE calloc(MemoryStack stack) {
        return wrap(FMOD_STUDIO_MEMORY_USAGE.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FMOD_STUDIO_MEMORY_USAGE, Buffer> implements NativeResource {
         ...
         * by {@link FMOD_STUDIO_MEMORY_USAGE#SIZEOF}, and its mark will be undefined.
         *
