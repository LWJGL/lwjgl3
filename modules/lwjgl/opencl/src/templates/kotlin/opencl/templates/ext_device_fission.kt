...
val ext_device_fission = "EXTDeviceFission".nativeClassCL("ext_device_fission", EXT) {
    ...
    LongConstant(
        "DEVICE_PARTITION_EQUALLY_EXT"..0x4050L,
        "DEVICE_PARTITION_BY_COUNTS_EXT"..0x4051L,
        "DEVICE_PARTITION_BY_NAMES_EXT"..0x4052L,
        "DEVICE_PARTITION_BY_AFFINITY_DOMAIN_EXT"..0x4053L
    )

    LongConstant(
        "AFFINITY_DOMAIN_L1_CACHE_EXT"..0x1L,
        "AFFINITY_DOMAIN_L2_CACHE_EXT"..0x2L,
        "AFFINITY_DOMAIN_L3_CACHE_EXT"..0x3L,
        "AFFINITY_DOMAIN_L4_CACHE_EXT"..0x4L,
        "AFFINITY_DOMAIN_NUMA_EXT"..0x10L,
        "AFFINITY_DOMAIN_NEXT_FISSIONABLE_EXT"..0x100L
    )
