...
public final class ARMSchedulingControls {
    ...
    public static final long
        CL_DEVICE_SCHEDULING_KERNEL_BATCHING_ARM               = (1L << 0),
        CL_DEVICE_SCHEDULING_WORKGROUP_BATCH_SIZE_ARM          = (1L << 1),
        CL_DEVICE_SCHEDULING_WORKGROUP_BATCH_SIZE_MODIFIER_ARM = (1L << 2),
        CL_DEVICE_SCHEDULING_DEFERRED_FLUSH_ARM                = (1L << 3),
        CL_DEVICE_SCHEDULING_REGISTER_ALLOCATION_ARM           = (1L << 4),
        CL_DEVICE_SCHEDULING_WARP_THROTTLING_ARM               = (1L << 5),
        CL_DEVICE_SCHEDULING_COMPUTE_UNIT_BATCH_QUEUE_SIZE_ARM = (1L << 6),
        CL_DEVICE_SCHEDULING_COMPUTE_UNIT_LIMIT_ARM            = (1L << 7);
    ...
    public static final long
        CL_QUEUE_KERNEL_BATCHING_ARM     = 0x41E7L,
        CL_QUEUE_DEFERRED_FLUSH_ARM      = 0x41ECL,
        CL_QUEUE_COMPUTE_UNIT_LIMIT_ARM  = 0x41F3L;
