...
public class CLNameVersion extends Struct implements NativeResource {
    ...
    /** Returns a new {@code CLNameVersion} instance allocated on the thread-local {@link MemoryStack}. */
    public static CLNameVersion mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code CLNameVersion} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CLNameVersion callocStack() {
     ...
     */
    public static CLNameVersion mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static CLNameVersion callocStack(MemoryStack stack) {
        return wrap(CLNameVersion.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link CLNameVersion.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static CLNameVersion.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link CLNameVersion.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static CLNameVersion.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static CLNameVersion.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static CLNameVersion.Buffer callocStack(int capacity, MemoryStack stack) {
