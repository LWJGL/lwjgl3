...
public class CLBusAddressAMD extends Struct<CLBusAddressAMD> implements NativeResource {
    ...
    /** @return the value of the {@code surfbusaddress} field. */
    @NativeType("cl_long")
    public long surfbusaddress() { return nsurfbusaddress(address()); }
    /** @return the value of the {@code signalbusaddress} field. */
    @NativeType("cl_long")
    ...
    public static CLBusAddressAMD malloc() {
        return new CLBusAddressAMD(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static CLBusAddressAMD calloc() {
        return new CLBusAddressAMD(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static CLBusAddressAMD create() {
        ...
        return new CLBusAddressAMD(memAddress(container), container);
    }
    ...
    public static CLBusAddressAMD malloc(MemoryStack stack) {
        return new CLBusAddressAMD(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static CLBusAddressAMD calloc(MemoryStack stack) {
        return new CLBusAddressAMD(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<CLBusAddressAMD, Buffer> implements NativeResource {
         ...
         * by {@link CLBusAddressAMD#SIZEOF}, and its mark will be undefined.</p>
         *
