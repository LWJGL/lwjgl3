...
public class CLBufferRegion extends Struct implements NativeResource {
    ...
    /** Returns a new {@code CLBufferRegion} instance allocated on the thread-local {@link MemoryStack}. */
    public static CLBufferRegion mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code CLBufferRegion} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
