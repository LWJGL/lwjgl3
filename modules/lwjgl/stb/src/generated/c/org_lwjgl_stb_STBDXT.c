...
JNIEXPORT void JNICALL JavaCritical_org_lwjgl_stb_STBDXT_nstb_1compress_1dxt_1block(jlong destAddress, jlong src_rgba_four_bytes_per_pixelAddress, jint alpha, jint mode) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_stb_STBDXT_nstb_1compress_1dxt_1block(JNIEnv *__env, jclass clazz, jlong destAddress, jlong src_rgba_four_bytes_per_pixelAddress, jint alpha, jint mode) {
    ...
    JavaCritical_org_lwjgl_stb_STBDXT_nstb_1compress_1dxt_1block(destAddress, src_rgba_four_bytes_per_pixelAddress, alpha, mode);
}

JNIEXPORT void JNICALL JavaCritical_org_lwjgl_stb_STBDXT_nstb_1compress_1bc4_1block(jlong destAddress, jlong src_r_one_byte_per_pixelAddress) {
    unsigned char *dest = (unsigned char *)(intptr_t)destAddress;
...
JNIEXPORT void JNICALL Java_org_lwjgl_stb_STBDXT_nstb_1compress_1bc4_1block(JNIEnv *__env, jclass clazz, jlong destAddress, jlong src_r_one_byte_per_pixelAddress) {
    UNUSED_PARAMS(__env, clazz)
    JavaCritical_org_lwjgl_stb_STBDXT_nstb_1compress_1bc4_1block(destAddress, src_r_one_byte_per_pixelAddress);
}

JNIEXPORT void JNICALL JavaCritical_org_lwjgl_stb_STBDXT_nstb_1compress_1bc5_1block(jlong destAddress, jlong src_rg_two_byte_per_pixelAddress) {
    unsigned char *dest = (unsigned char *)(intptr_t)destAddress;
...
JNIEXPORT void JNICALL Java_org_lwjgl_stb_STBDXT_nstb_1compress_1bc5_1block(JNIEnv *__env, jclass clazz, jlong destAddress, jlong src_rg_two_byte_per_pixelAddress) {
    UNUSED_PARAMS(__env, clazz)
    JavaCritical_org_lwjgl_stb_STBDXT_nstb_1compress_1bc5_1block(destAddress, src_rg_two_byte_per_pixelAddress);
}
