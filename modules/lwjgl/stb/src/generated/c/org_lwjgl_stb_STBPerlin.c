...
JNIEXPORT jfloat JNICALL JavaCritical_org_lwjgl_stb_STBPerlin_stb_1perlin_1noise3_1seed(jfloat x, jfloat y, jfloat z, jint x_wrap, jint y_wrap, jint z_wrap, jint seed) {
...
JNIEXPORT jfloat JNICALL Java_org_lwjgl_stb_STBPerlin_stb_1perlin_1noise3_1seed(JNIEnv *__env, jclass clazz, jfloat x, jfloat y, jfloat z, jint x_wrap, jint y_wrap, jint z_wrap, jint seed) {
    UNUSED_PARAMS(__env, clazz)
    return JavaCritical_org_lwjgl_stb_STBPerlin_stb_1perlin_1noise3_1seed(x, y, z, x_wrap, y_wrap, z_wrap, seed);
}

JNIEXPORT jfloat JNICALL JavaCritical_org_lwjgl_stb_STBPerlin_stb_1perlin_1ridge_1noise3(jfloat x, jfloat y, jfloat z, jfloat lacunarity, jfloat gain, jfloat offset, jint octaves) {
...
JNIEXPORT jfloat JNICALL Java_org_lwjgl_stb_STBPerlin_stb_1perlin_1ridge_1noise3(JNIEnv *__env, jclass clazz, jfloat x, jfloat y, jfloat z, jfloat lacunarity, jfloat gain, jfloat offset, jint octaves) {
    UNUSED_PARAMS(__env, clazz)
    return JavaCritical_org_lwjgl_stb_STBPerlin_stb_1perlin_1ridge_1noise3(x, y, z, lacunarity, gain, offset, octaves);
}

JNIEXPORT jfloat JNICALL JavaCritical_org_lwjgl_stb_STBPerlin_stb_1perlin_1fbm_1noise3(jfloat x, jfloat y, jfloat z, jfloat lacunarity, jfloat gain, jint octaves) {
...
JNIEXPORT jfloat JNICALL Java_org_lwjgl_stb_STBPerlin_stb_1perlin_1fbm_1noise3(JNIEnv *__env, jclass clazz, jfloat x, jfloat y, jfloat z, jfloat lacunarity, jfloat gain, jint octaves) {
    UNUSED_PARAMS(__env, clazz)
    return JavaCritical_org_lwjgl_stb_STBPerlin_stb_1perlin_1fbm_1noise3(x, y, z, lacunarity, gain, octaves);
}

JNIEXPORT jfloat JNICALL JavaCritical_org_lwjgl_stb_STBPerlin_stb_1perlin_1turbulence_1noise3(jfloat x, jfloat y, jfloat z, jfloat lacunarity, jfloat gain, jint octaves) {
