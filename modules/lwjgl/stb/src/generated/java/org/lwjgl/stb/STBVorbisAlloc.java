...
public class STBVorbisAlloc extends Struct implements NativeResource {
    ...
    STBVorbisAlloc(long address, @Nullable ByteBuffer container) {
    ...
    /** Returns a new {@link STBVorbisAlloc} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static STBVorbisAlloc malloc() {
        return create(nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link STBVorbisAlloc} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    ...
    /** Returns a new {@link STBVorbisAlloc} instance for the specified memory address. */
    ...
    /** Returns a new {@link STBVorbisAlloc} instance allocated on the thread-local {@link MemoryStack}. */
    public static STBVorbisAlloc mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link STBVorbisAlloc} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static STBVorbisAlloc callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link STBVorbisAlloc} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link STBVorbisAlloc} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
