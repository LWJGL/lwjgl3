...
public class STBTTKerningentry extends Struct implements NativeResource {
    ...
    /** Returns a new {@code STBTTKerningentry} instance allocated on the thread-local {@link MemoryStack}. */
    public static STBTTKerningentry mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code STBTTKerningentry} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static STBTTKerningentry callocStack() {
     ...
     */
    public static STBTTKerningentry mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static STBTTKerningentry callocStack(MemoryStack stack) {
        return wrap(STBTTKerningentry.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link STBTTKerningentry.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static STBTTKerningentry.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link STBTTKerningentry.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static STBTTKerningentry.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static STBTTKerningentry.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static STBTTKerningentry.Buffer callocStack(int capacity, MemoryStack stack) {
