...
public class BGFXTransform extends Struct implements NativeResource {
    ...
    /** Returns a new {@code BGFXTransform} instance allocated on the thread-local {@link MemoryStack}. */
    public static BGFXTransform mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code BGFXTransform} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
