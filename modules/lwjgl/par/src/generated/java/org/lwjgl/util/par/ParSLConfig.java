...
public class ParSLConfig extends Struct implements NativeResource {
    ...
    /** Returns a new {@code ParSLConfig} instance allocated on the thread-local {@link MemoryStack}. */
    public static ParSLConfig mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code ParSLConfig} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    ...
    /**
     * Returns a new {@link ParSLConfig.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link ParSLConfig.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static ParSLConfig.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static ParSLConfig.Buffer callocStack(int capacity, MemoryStack stack) {
