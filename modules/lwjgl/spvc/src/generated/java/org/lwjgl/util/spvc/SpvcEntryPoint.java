...
public class SpvcEntryPoint extends Struct implements NativeResource {
    ...
    /** Returns a new {@code SpvcEntryPoint} instance allocated on the thread-local {@link MemoryStack}. */
    public static SpvcEntryPoint mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code SpvcEntryPoint} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static SpvcEntryPoint callocStack() {
     ...
     */
    public static SpvcEntryPoint mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static SpvcEntryPoint callocStack(MemoryStack stack) {
        return wrap(SpvcEntryPoint.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link SpvcEntryPoint.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static SpvcEntryPoint.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link SpvcEntryPoint.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static SpvcEntryPoint.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static SpvcEntryPoint.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static SpvcEntryPoint.Buffer callocStack(int capacity, MemoryStack stack) {
