...
public class SpvcReflectedBuiltinResource extends Struct implements NativeResource {
    ...
    /** Returns a new {@code SpvcReflectedBuiltinResource} instance allocated on the thread-local {@link MemoryStack}. */
    public static SpvcReflectedBuiltinResource mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code SpvcReflectedBuiltinResource} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static SpvcReflectedBuiltinResource callocStack() {
     ...
     */
    public static SpvcReflectedBuiltinResource mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static SpvcReflectedBuiltinResource callocStack(MemoryStack stack) {
        return wrap(SpvcReflectedBuiltinResource.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link SpvcReflectedBuiltinResource.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static SpvcReflectedBuiltinResource.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link SpvcReflectedBuiltinResource.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static SpvcReflectedBuiltinResource.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static SpvcReflectedBuiltinResource.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static SpvcReflectedBuiltinResource.Buffer callocStack(int capacity, MemoryStack stack) {
