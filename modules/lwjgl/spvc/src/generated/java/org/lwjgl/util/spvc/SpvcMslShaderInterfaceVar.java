...
public class SpvcMslShaderInterfaceVar extends Struct implements NativeResource {
    ...
    public static SpvcMslShaderInterfaceVar malloc() {
        return wrap(SpvcMslShaderInterfaceVar.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static SpvcMslShaderInterfaceVar calloc() {
        return wrap(SpvcMslShaderInterfaceVar.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static SpvcMslShaderInterfaceVar create() {
        ...
        return wrap(SpvcMslShaderInterfaceVar.class, memAddress(container), container);
    }
    ...
    public static SpvcMslShaderInterfaceVar create(long address) {
        return wrap(SpvcMslShaderInterfaceVar.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static SpvcMslShaderInterfaceVar createSafe(long address) {
        return address == NULL ? null : wrap(SpvcMslShaderInterfaceVar.class, address);
    }
    ...
    public static SpvcMslShaderInterfaceVar malloc(MemoryStack stack) {
        return wrap(SpvcMslShaderInterfaceVar.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static SpvcMslShaderInterfaceVar calloc(MemoryStack stack) {
        return wrap(SpvcMslShaderInterfaceVar.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<SpvcMslShaderInterfaceVar, Buffer> implements NativeResource {
         ...
         * by {@link SpvcMslShaderInterfaceVar#SIZEOF}, and its mark will be undefined.
         *
