...
public class SpvcMslShaderInterfaceVar2 extends Struct implements NativeResource {
    ...
    public static SpvcMslShaderInterfaceVar2 malloc() {
        return wrap(SpvcMslShaderInterfaceVar2.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static SpvcMslShaderInterfaceVar2 calloc() {
        return wrap(SpvcMslShaderInterfaceVar2.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static SpvcMslShaderInterfaceVar2 create() {
        ...
        return wrap(SpvcMslShaderInterfaceVar2.class, memAddress(container), container);
    }
    ...
    public static SpvcMslShaderInterfaceVar2 create(long address) {
        return wrap(SpvcMslShaderInterfaceVar2.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static SpvcMslShaderInterfaceVar2 createSafe(long address) {
        return address == NULL ? null : wrap(SpvcMslShaderInterfaceVar2.class, address);
    }
    ...
    public static SpvcMslShaderInterfaceVar2 malloc(MemoryStack stack) {
        return wrap(SpvcMslShaderInterfaceVar2.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static SpvcMslShaderInterfaceVar2 calloc(MemoryStack stack) {
        return wrap(SpvcMslShaderInterfaceVar2.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<SpvcMslShaderInterfaceVar2, Buffer> implements NativeResource {
         ...
         * by {@link SpvcMslShaderInterfaceVar2#SIZEOF}, and its mark will be undefined.
         *
