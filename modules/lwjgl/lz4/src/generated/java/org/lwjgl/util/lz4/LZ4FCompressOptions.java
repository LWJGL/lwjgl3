...
public class LZ4FCompressOptions extends Struct implements NativeResource {
    ...
    /** Returns a new {@code LZ4FCompressOptions} instance allocated on the thread-local {@link MemoryStack}. */
    public static LZ4FCompressOptions mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code LZ4FCompressOptions} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
