...
public class MeowHash extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link MeowHash} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link MeowHash} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static MeowHash malloc() {
        return wrap(MeowHash.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link MeowHash} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static MeowHash calloc() {
        return wrap(MeowHash.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link MeowHash} instance allocated with {@link BufferUtils}. */
    public static MeowHash create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(MeowHash.class, memAddress(container), container);
    }

    /** Returns a new {@link MeowHash} instance for the specified memory address. */
    ...
    /** Returns a new {@link MeowHash} instance allocated on the thread-local {@link MemoryStack}. */
    public static MeowHash mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link MeowHash} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static MeowHash callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link MeowHash} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link MeowHash} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link MeowHash.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link MeowHash.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static MeowHash.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static MeowHash.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<MeowHash, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link MeowHash.Buffer} instance backed by the specified container.
         *
