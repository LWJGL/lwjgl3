...
public class MeowHash extends Struct implements NativeResource {
    ...
    /** Returns a new {@code MeowHash} instance allocated on the thread-local {@link MemoryStack}. */
    public static MeowHash mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code MeowHash} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
