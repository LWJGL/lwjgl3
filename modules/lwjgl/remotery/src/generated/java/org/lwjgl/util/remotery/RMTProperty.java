...
public class RMTProperty extends Struct implements NativeResource {
    ...
    public static RMTProperty malloc() {
        return wrap(RMTProperty.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static RMTProperty malloc(MemoryStack stack) {
        return wrap(RMTProperty.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static RMTProperty calloc(MemoryStack stack) {
        return wrap(RMTProperty.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<RMTProperty, Buffer> implements NativeResource {
         ...
         * by {@link RMTProperty#SIZEOF}, and its mark will be undefined.
         *
