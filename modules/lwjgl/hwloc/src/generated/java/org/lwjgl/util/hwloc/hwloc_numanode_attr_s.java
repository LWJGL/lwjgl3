 ...
 * }</code></pre>
 */
public class hwloc_numanode_attr_s extends Struct {
    ...
    public static hwloc_numanode_attr_s create(long address) {
        return wrap(hwloc_numanode_attr_s.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static hwloc_numanode_attr_s createSafe(long address) {
        return address == NULL ? null : wrap(hwloc_numanode_attr_s.class, address);
    }
    ...
    public static class Buffer extends StructBuffer<hwloc_numanode_attr_s, Buffer> {
         ...
         * by {@link hwloc_numanode_attr_s#SIZEOF}, and its mark will be undefined.
         *
