...
public class hwloc_topology_diff_u extends Struct {
    ...
    public static hwloc_topology_diff_u create(long address) {
        return wrap(hwloc_topology_diff_u.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static hwloc_topology_diff_u createSafe(long address) {
        return address == NULL ? null : wrap(hwloc_topology_diff_u.class, address);
    }
    ...
    public static class Buffer extends StructBuffer<hwloc_topology_diff_u, Buffer> {
         ...
         * by {@link hwloc_topology_diff_u#SIZEOF}, and its mark will be undefined.
         *
