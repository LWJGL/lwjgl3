...
public class hwloc_distances_s extends Struct implements NativeResource {
    ...
    public static hwloc_distances_s malloc() {
        return wrap(hwloc_distances_s.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static hwloc_distances_s calloc() {
        return wrap(hwloc_distances_s.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static hwloc_distances_s create() {
        ...
        return wrap(hwloc_distances_s.class, memAddress(container), container);
    }
    ...
    public static hwloc_distances_s create(long address) {
        return wrap(hwloc_distances_s.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static hwloc_distances_s createSafe(long address) {
        return address == NULL ? null : wrap(hwloc_distances_s.class, address);
    }
    ...
    public static hwloc_distances_s malloc(MemoryStack stack) {
        return wrap(hwloc_distances_s.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static hwloc_distances_s calloc(MemoryStack stack) {
        return wrap(hwloc_distances_s.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<hwloc_distances_s, Buffer> implements NativeResource {
         ...
         * by {@link hwloc_distances_s#SIZEOF}, and its mark will be undefined.
         *
