...
public class hwloc_location extends Struct implements NativeResource {
    ...
    public static hwloc_location malloc() {
        return wrap(hwloc_location.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static hwloc_location calloc() {
        return wrap(hwloc_location.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@code hwloc_location} instance allocated with {@link BufferUtils}. */
    public static hwloc_location create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(hwloc_location.class, memAddress(container), container);
    }
    ...
    public static hwloc_location create(long address) {
        return wrap(hwloc_location.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static hwloc_location createSafe(long address) {
        return address == NULL ? null : wrap(hwloc_location.class, address);
    }
    ...
    public static hwloc_location malloc(MemoryStack stack) {
        return wrap(hwloc_location.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static hwloc_location calloc(MemoryStack stack) {
        return wrap(hwloc_location.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<hwloc_location, Buffer> implements NativeResource {
         ...
         * by {@link hwloc_location#SIZEOF}, and its mark will be undefined.
         *
