 ...
 * }</code></pre>
 */
public class hwloc_location_u extends Struct {
    ...
    public static hwloc_location_u create(long address) {
        return wrap(hwloc_location_u.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static hwloc_location_u createSafe(long address) {
        return address == NULL ? null : wrap(hwloc_location_u.class, address);
    }
    ...
    public static class Buffer extends StructBuffer<hwloc_location_u, Buffer> {
         ...
         * by {@link hwloc_location_u#SIZEOF}, and its mark will be undefined.
         *
