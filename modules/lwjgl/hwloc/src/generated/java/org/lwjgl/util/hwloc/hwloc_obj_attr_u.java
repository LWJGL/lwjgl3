...
public class hwloc_obj_attr_u extends Struct implements NativeResource {
    ...
    public static hwloc_obj_attr_u malloc() {
        return wrap(hwloc_obj_attr_u.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static hwloc_obj_attr_u calloc() {
        return wrap(hwloc_obj_attr_u.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static hwloc_obj_attr_u create() {
        ...
        return wrap(hwloc_obj_attr_u.class, memAddress(container), container);
    }
    ...
    public static hwloc_obj_attr_u create(long address) {
        return wrap(hwloc_obj_attr_u.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static hwloc_obj_attr_u createSafe(long address) {
        return address == NULL ? null : wrap(hwloc_obj_attr_u.class, address);
    }
    ...
    public static hwloc_obj_attr_u malloc(MemoryStack stack) {
        return wrap(hwloc_obj_attr_u.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static hwloc_obj_attr_u calloc(MemoryStack stack) {
        return wrap(hwloc_obj_attr_u.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<hwloc_obj_attr_u, Buffer> implements NativeResource {
         ...
         * by {@link hwloc_obj_attr_u#SIZEOF}, and its mark will be undefined.
         *
