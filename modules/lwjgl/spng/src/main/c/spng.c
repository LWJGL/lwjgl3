    ...
    while( !(ret = read_header(ctx)))
    {
        ...
        else /* Arbitrary-length chunk */
        {
            ...
            {/* TODO: add test file with color profile */
                ...
                const unsigned char *keyword_nul = memchr(ctx->data, '\0', peek_bytes);
...
spng_ctx *spng_ctx_new(int flags)
{
    struct spng_alloc alloc =
    {
        .malloc_fn = org_lwjgl_malloc,
        .realloc_fn = org_lwjgl_realloc,
        .calloc_fn = org_lwjgl_calloc,
        .free_fn = org_lwjgl_free
    };
