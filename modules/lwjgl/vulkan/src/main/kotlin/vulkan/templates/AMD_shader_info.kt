...
￿    void*                                       pInfo);</pre></code>
        ...
        AutoSize("pInfo")..Check(1)..size_t_p.INOUT("pInfoSize", "a pointer to a value related to the amount of data the query returns, as described below."),
        nullable..void_p.OUT("pInfo", "either NULL or a pointer to a buffer.")
    )
}