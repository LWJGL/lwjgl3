...
val VkRenderPassBeginInfo = struct(Module.VULKAN, "VkRenderPassBeginInfo") {
    documentation =
        ...
        <ul>
            ...
            <li>If the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html\#features-imagelessFramebuffer">imageless framebuffer</a> feature is not enabled, and the {@code pNext} chain includes an instance of ##VkRenderPassAttachmentBeginInfoKHR, its {@code attachmentCount} <b>must</b> be zero</li>
            ...
            <li>If {@code framebuffer} was created with a ##VkFramebufferCreateInfo{@code ::flags} value that included #FRAMEBUFFER_CREATE_IMAGELESS_BIT_KHR, each element of the {@code attachments} member of an instance of ##VkRenderPassAttachmentBeginInfoKHR included in the {@code pNext} chain <b>must</b> be a {@code VkImageView} of an image created with a value of ##VkImageCreateInfo{@code ::flags} equal to the {@code flags} member of the corresponding element of ##VkFramebufferAttachmentsCreateInfoKHR{@code ::pAttachments} used to create {@code framebuffer}</li>
