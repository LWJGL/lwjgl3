...
val VkBufferViewCreateInfo = struct(Module.VULKAN, "VkBufferViewCreateInfo") {
    documentation =
        ...
        <ul>
            ...
            <li>If the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html\#features-features-texelBufferAlignment">texelBufferAlignment</a> feature is not enabled, {@code offset} <b>must</b> be a multiple of ##VkPhysicalDeviceLimits{@code ::minTexelBufferOffsetAlignment}</li>
...
val VkGraphicsPipelineCreateInfo = struct(Module.VULKAN, "VkGraphicsPipelineCreateInfo") {
    documentation =
        ...
        <ul>
            ...
            <li>Each {@code pNext} member of any structure (including this one) in the {@code pNext} chain <b>must</b> be either {@code NULL} or a pointer to a valid instance of ##VkPipelineCreationFeedbackCreateInfoEXT, ##VkPipelineDiscardRectangleStateCreateInfoEXT, or ##VkPipelineRepresentativeFragmentTestStateCreateInfoNV</li>
            <li>Each {@code sType} member in the {@code pNext} chain <b>must</b> be unique</li>
...
val VkDescriptorPoolSize = struct(Module.VULKAN, "VkDescriptorPoolSize") {
    documentation =
        ...
        <h5>Description</h5>
        Each combined image sampler descriptor for a multi-planar format <b>may</b> consume multiple descriptors from the pool, as indicated by ##VkSamplerYcbcrConversionImageFormatProperties{@code ::maxCombinedImageSamplerDescriptorCount}. The {@code descriptorCount} for pools that will contain such descriptors <b>must</b> be expanded to allow for this.

        <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
        For example, consider a descriptor set layout binding with two descriptors and immutable samplers for multi-planar formats that have ##VkSamplerYcbcrConversionImageFormatProperties{@code ::combinedImageSamplerDescriptorCount} values of 2 and 3 respectively. There are two descriptors in the binding and the maximum {@code combinedImageSamplerDescriptorCount} is 3, so descriptor sets with this layout consume 6 descriptors from the descriptor pool. To create a descriptor pool that allows allocating four descriptor sets with this layout, {@code descriptorCount} must be at least 24.
        </div>
