...
val VkFormatProperties2 = struct(Module.VULKAN, "VkFormatProperties2", mutable = false) {
    ...
    PointerSetter(
        "VkDrmFormatModifierPropertiesList2EXT", "VkDrmFormatModifierPropertiesListEXT", "VkFormatProperties3", "VkFormatProperties3KHR", "VkFormatProperties4KHR", "VkSubpassResolvePerformanceQueryEXT", "VkTensorFormatPropertiesARM",
        prepend = true
    )..nullable..opaque_p("pNext").mutable()
