...
val VkRenderPassCreateInfo2 = struct(Module.VULKAN, "VkRenderPassCreateInfo2") {
    ...
    PointerSetter(
        "VkRenderPassCreationControlEXT", "VkRenderPassCreationFeedbackCreateInfoEXT", "VkRenderPassFragmentDensityMapCreateInfoEXT",
        prepend = true
    )..nullable..opaque_const_p("pNext")
    VkRenderPassCreateFlags("flags")
    AutoSize("pAttachments", optional = true)..uint32_t("attachmentCount")
...
val VkRenderingInfo = struct(Module.VULKAN, "VkRenderingInfo") {
    ...
    PointerSetter(
        "VkDeviceGroupRenderPassBeginInfo", "VkDeviceGroupRenderPassBeginInfoKHR", "VkMultisampledRenderToSingleSampledInfoEXT", "VkMultiviewPerViewAttributesInfoNVX", "VkMultiviewPerViewRenderAreasRenderPassBeginInfoQCOM", "VkRenderPassStripeBeginInfoARM", "VkRenderingFragmentDensityMapAttachmentInfoEXT", "VkRenderingFragmentShadingRateAttachmentInfoKHR",
        prepend = true
    )..nullable..opaque_const_p("pNext")
