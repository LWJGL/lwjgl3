...
val VkWriteDescriptorSet = struct(Module.VULKAN, "VkWriteDescriptorSet") {
    ...
    PointerSetter(
        "VkWriteDescriptorSetAccelerationStructureKHR", "VkWriteDescriptorSetAccelerationStructureNV", "VkWriteDescriptorSetInlineUniformBlock", "VkWriteDescriptorSetInlineUniformBlockEXT", "VkWriteDescriptorSetPartitionedAccelerationStructureNV",
        prepend = true
    )..nullable..opaque_const_p("pNext")
    VkDescriptorSet("dstSet")
    uint32_t("dstBinding")
...
val VkFormatProperties2 = struct(Module.VULKAN, "VkFormatProperties2", mutable = false) {
    ...
    PointerSetter(
        "VkDrmFormatModifierPropertiesList2EXT", "VkDrmFormatModifierPropertiesListEXT", "VkFormatProperties3", "VkFormatProperties3KHR", "VkSubpassResolvePerformanceQueryEXT",
        prepend = true
    )..nullable..opaque_p("pNext").mutable()
...
val VkQueueFamilyProperties2 = struct(Module.VULKAN, "VkQueueFamilyProperties2", mutable = false) {
    ...
    PointerSetter(
        "VkQueueFamilyCheckpointProperties2NV", "VkQueueFamilyCheckpointPropertiesNV", "VkQueueFamilyGlobalPriorityProperties", "VkQueueFamilyGlobalPriorityPropertiesEXT", "VkQueueFamilyGlobalPriorityPropertiesKHR", "VkQueueFamilyQueryResultStatusPropertiesKHR", "VkQueueFamilyVideoPropertiesKHR",
        prepend = true
    )..nullable..opaque_p("pNext").mutable()
...
val VkSubmitInfo2 = struct(Module.VULKAN, "VkSubmitInfo2") {
    ...
    PointerSetter(
        "VkFrameBoundaryEXT", "VkLatencySubmissionPresentIdNV", "VkPerformanceQuerySubmitInfoKHR", "VkWin32KeyedMutexAcquireReleaseInfoKHR", "VkWin32KeyedMutexAcquireReleaseInfoNV",
        prepend = true
    )..nullable..opaque_const_p("pNext")
    VkSubmitFlags("flags")
