...
val QCOM_render_pass_shader_resolve = "QCOMRenderPassShaderResolve".nativeClassVK("QCOM_render_pass_shader_resolve", type = "device", postfix = QCOM) {
    documentation =
        ...
        <dl>
            ...
            <dt><b>Contact</b></dt>
            <dd><ul>
                <li>Bill Licea-Kane <a target="_blank" href="https://github.com/KhronosGroup/Vulkan-Docs/issues/new?title=VK_QCOM_render_pass_shader_resolve:%20&amp;body=@wwlk%20">wwlk</a></li>
            </ul></dd>
        </dl>
