...
￿    uint32_t                                    stride);</code></pre>
        ...
        <ul>
            ...
            <li>If <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#features-drawIndirectCount">{@code drawIndirectCount}</a> is not enabled this function <b>must</b> not be used</li>
...
￿    uint32_t                                    stride);</code></pre>
        ...
        <ul>
            <li>If <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#features-maintenance6">{@code maintenance6}</a> is not enabled, a valid index buffer <b>must</b> be bound</li>
