...
val EXT_attachment_feedback_loop_dynamic_state = "EXTAttachmentFeedbackLoopDynamicState".nativeClassVK("EXT_attachment_feedback_loop_dynamic_state", type = "device", postfix = "EXT") {
    ...
    void(
        ...
        To <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#pipelines-dynamic-state">dynamically set</a> whether attachment feedback loops are enabled, call:
...
￿    VkImageAspectFlags                          aspectMask);</code></pre>
        ...
        <ul>
            ...
            <li>If the <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#features-attachmentFeedbackLoopLayout">{@code attachmentFeedbackLoopLayout}</a> feature is not enabled, {@code aspectMask} <b>must</b> be #IMAGE_ASPECT_NONE</li>
        </ul>
