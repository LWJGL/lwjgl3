...
val KHR_video_encode_h264 = "KHRVideoEncodeH264".nativeClassVK("KHR_video_encode_h264", type = "device", postfix = "KHR") {
    ...
    EnumConstant(
        ...
        <ul>
            ...
            <li>#VIDEO_ENCODE_H264_CAPABILITY_B_FRAME_IN_L0_LIST_BIT_KHR indicates support for using a <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#encode-h264-b-pic">B frame</a> as L0 reference, as specified in {@code StdVideoEncodeH264ReferenceListsInfo}{@code ::RefPicList0} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#encode-h264-picture-info">H.264 picture information</a>.</li>
            <li>#VIDEO_ENCODE_H264_CAPABILITY_B_FRAME_IN_L1_LIST_BIT_KHR indicates support for using a <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#encode-h264-b-pic">B frame</a> as L1 reference, as specified in {@code StdVideoEncodeH264ReferenceListsInfo}{@code ::RefPicList1} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#encode-h264-picture-info">H.264 picture information</a>.</li>
    ...
    EnumConstant(
        ...
        <ul>
            ...
            <li>#VIDEO_ENCODE_H264_STD_PIC_INIT_QP_MINUS26_BIT_KHR indicates whether the implementation supports using the application-provided value for {@code StdVideoH264PictureParameterSet}{@code ::pic_init_qp_minus26} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#encode-h264-pps">PPS</a> when that value is non-zero.</li>
            ...
            <li>#VIDEO_ENCODE_H264_STD_ENTROPY_CODING_MODE_FLAG_UNSET_BIT_KHR indicates whether the implementation supports CAVLC entropy coding, as defined in section 9.2 of the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#itu-t-h264">ITU-T H.264 Specification</a>, and thus supports using the application-provided value for {@code StdVideoH264PpsFlags}{@code ::entropy_coding_mode_flag} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#encode-h264-pps">PPS</a> when that value is 0.</li>
            <li>#VIDEO_ENCODE_H264_STD_ENTROPY_CODING_MODE_FLAG_SET_BIT_KHR indicates whether the implementation supports CABAC entropy coding, as defined in section 9.3 of the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#itu-t-h264">ITU-T H.264 Specification</a>, and thus supports using the application-provided value for {@code StdVideoH264PpsFlags}{@code ::entropy_coding_mode_flag} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#encode-h264-pps">PPS</a> when that value is 1.</li>
