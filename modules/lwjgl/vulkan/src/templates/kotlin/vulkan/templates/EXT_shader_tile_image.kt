...
val EXT_shader_tile_image = "EXTShaderTileImage".nativeClassVK("EXT_shader_tile_image", type = "device", postfix = "EXT") {
    documentation =
        ...
        See <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#fragops-shader-tileimage-reads">fragment shader tile image reads</a> for more information.
