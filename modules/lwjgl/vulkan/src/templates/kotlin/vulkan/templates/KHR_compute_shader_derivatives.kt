...
val KHR_compute_shader_derivatives = "KHRComputeShaderDerivatives".nativeClassVK("KHR_compute_shader_derivatives", type = "device", postfix = "KHR") {
    documentation =
        ...
        The new execution modes are supported in compute shaders and optionally (see <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#limits-meshAndTaskShaderDerivatives">meshAndTaskShaderDerivatives</a>) in mesh and task shaders.
