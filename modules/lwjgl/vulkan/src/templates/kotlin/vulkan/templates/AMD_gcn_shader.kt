...
val AMD_gcn_shader = "AMDGCNShader".nativeClassVK("AMD_gcn_shader", type = "device", postfix = "AMD") {
    documentation =
        ...
        <dl>
            ...
            <dt><b>Contact</b></dt>
            <dd><ul>
                <li>Dominik Witczak <a target="_blank" href="https://github.com/KhronosGroup/Vulkan-Docs/issues/new?body=[VK_AMD_gcn_shader]%20@dominikwitczakamd%250A*Here%20describe%20the%20issue%20or%20question%20you%20have%20about%20the%20VK_AMD_gcn_shader%20extension*">dominikwitczakamd</a></li>
            </ul></dd>
        </dl>
        ...
        <dl>
            ...
            <dd><ul>
                ...
                <li>This extension provides API support for <a target="_blank" href="https://registry.khronos.org/OpenGL/extensions/AMD/AMD_gcn_shader.txt">{@code GL_AMD_gcn_shader}</a></li>
            </ul></dd>
