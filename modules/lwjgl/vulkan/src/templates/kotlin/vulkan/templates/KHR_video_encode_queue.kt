...
val KHR_video_encode_queue = "KHRVideoEncodeQueue".nativeClassVK("KHR_video_encode_queue", type = "device", postfix = "KHR") {
    ...
    EnumConstant(
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    <li>When using an <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#encode-h264-profile">H.264 encode profile</a>, implementations will use the QP value specified in ##VkVideoEncodeH264NaluSliceInfoKHR{@code ::constantQp} to control the quality of the encoded picture.</li>
                    <li>When using an <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#encode-h265-profile">H.265 encode profile</a>, implementations will use the QP value specified in ##VkVideoEncodeH265NaluSliceSegmentInfoKHR{@code ::constantQp} to control the quality of the encoded picture.</li>
                </ul>
            </li>
    ...
    EnumConstant(
        ...
        <ul>
            ...
            <li>#VIDEO_ENCODE_FEEDBACK_BITSTREAM_HAS_OVERRIDES_BIT_KHR specifies that queries managed by the pool will capture a boolean value indicating that the data written to the bitstream buffer specified in ##VkVideoEncodeInfoKHR{@code ::dstBuffer} contains <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#encode-overrides">overridden parameters</a>.</li>
        </ul>
        ...
        <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
        Thus it is recommended that applications always specify #QUERY_RESULT_WITH_STATUS_BIT_KHR when retrieving the results of video encode feedback queries and ignore such undefined video encode feedback values for any <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#encode-unsuccessful">unsuccessfully</a> completed video encode operations.
        </div>
        """,
...
￿    void*                                       pData);</code></pre>
        ...
        <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
        This includes the cases when {@code pData} is {@code NULL} or when #INCOMPLETE is returned by the command, and enables the application to determine whether the implementation <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#encode-overrides">overrode</a> any of the requested video session parameters without actually needing to retrieve the encoded parameter data itself.
        </div>
...
￿    const VkVideoEncodeInfoKHR*                 pEncodeInfo);</code></pre>
        ...
        If reconstructed picture information is specified, but reference picture setup is not requested, according to the codec-specific semantics, the contents of the <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#video-picture-resources">video picture resource</a> corresponding to the reconstructed picture will be undefined after the video encode operation.
        ...
        <ul>
            ...
            <li>
                If the bound video session object was created with an <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#encode-h264-profile">H.264 encode profile</a>, then:
                <ul>
            ...
            <li>
                If the bound video session object was created with an <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#encode-h264-profile">H.265 encode profile</a>, then:
                <ul>
        ...
        <ul>
            ...
            <li>If the bound video session was created with the video codec operation #VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_KHR and the current <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#encode-rate-control-modes">rate control mode</a> is not #VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR, then ##VkVideoEncodeH264NaluSliceInfoKHR{@code ::constantQp} <b>must</b> be zero for each element of the {@code pNaluSliceEntries} member of the ##VkVideoEncodeH264PictureInfoKHR structure included in the {@code pNext} chain of {@code pEncodeInfo}</li>
            <li>If the bound video session was created with the video codec operation #VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_KHR and the current <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#encode-rate-control-modes">rate control mode</a> is #VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR, then ##VkVideoEncodeH264NaluSliceInfoKHR{@code ::constantQp} <b>must</b> be between ##VkVideoEncodeH264CapabilitiesKHR{@code ::minQp} and ##VkVideoEncodeH264CapabilitiesKHR{@code ::maxQp}, as returned by #GetPhysicalDeviceVideoCapabilitiesKHR() for the video profile the bound video session was created with, for each element of the {@code pNaluSliceEntries} member of the ##VkVideoEncodeH264PictureInfoKHR structure included in the {@code pNext} chain of {@code pEncodeInfo}</li>
            ...
            <li>If the bound video session was created with the video codec operation #VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_KHR and the current <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#encode-rate-control-modes">rate control mode</a> is not #VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR, then ##VkVideoEncodeH265NaluSliceSegmentInfoKHR{@code ::constantQp} <b>must</b> be zero for each element of the {@code pNaluSliceSegmentEntries} member of the ##VkVideoEncodeH265PictureInfoKHR structure included in the {@code pNext} chain of {@code pEncodeInfo}</li>
            <li>If the bound video session was created with the video codec operation #VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_KHR and the current <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#encode-rate-control-modes">rate control mode</a> is #VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR, then ##VkVideoEncodeH265NaluSliceSegmentInfoKHR{@code ::constantQp} <b>must</b> be between ##VkVideoEncodeH265CapabilitiesKHR{@code ::minQp} and ##VkVideoEncodeH265CapabilitiesKHR{@code ::maxQp}, as returned by #GetPhysicalDeviceVideoCapabilitiesKHR() for the video profile the bound video session was created with, for each element of the {@code pNaluSliceSegmentEntries} member of the ##VkVideoEncodeH265PictureInfoKHR structure included in the {@code pNext} chain of {@code pEncodeInfo}</li>
