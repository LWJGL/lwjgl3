...
val KHR_maintenance5 = "KHRMaintenance5".nativeClassVK("KHR_maintenance5", type = "device", postfix = "KHR") {
    ...
    EnumConstantLong(
        ...
        <h5>Description</h5>
        <ul>
            <li>#BUFFER_USAGE_2_TRANSFER_SRC_BIT_KHR specifies that the buffer <b>can</b> be used as the source of a <em>transfer command</em> (see the definition of <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#synchronization-pipeline-stages-transfer">#PIPELINE_STAGE_TRANSFER_BIT</a>).</li>
...
￿    VkIndexType                                 indexType);</code></pre>
        ...
        <ul>
            ...
            <li>If {@code indexType} is #INDEX_TYPE_UINT8_KHR, the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#features-indexTypeUint8">{@code indexTypeUint8}</a> feature <b>must</b> be enabled</li>
            <li>If <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#features-maintenance6">{@code maintenance6}</a> is not enabled, {@code buffer} <b>must</b> not be #NULL_HANDLE</li>
