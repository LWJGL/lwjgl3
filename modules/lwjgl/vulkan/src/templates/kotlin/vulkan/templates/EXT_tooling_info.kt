...
￿}</code></pre>
    ...
    EnumConstant(
        ...
        <ul>
            ...
            <li>#TOOL_PURPOSE_DEBUG_MARKERS_BIT_EXT specifies that the tool consumes <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html\#debugging-debug-markers">debug markers</a> or <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html\#debugging-object-debug-annotation">object debug annotation</a>, <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html\#debugging-queue-labels">queue labels</a>, or <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html\#debugging-command-buffer-labels">command buffer labels</a></li>
        </ul>
