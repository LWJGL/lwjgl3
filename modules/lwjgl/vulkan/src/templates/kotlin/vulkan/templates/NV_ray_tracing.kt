...
￿    VkDeviceSize                                scratchOffset);</code></pre>
        ...
        <ul>
            ...
            <li>If {@code update} is #TRUE, then objects that were previously active <b>must</b> not be made inactive as per <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#acceleration-structure-inactive-prims">Inactive Primitives and Instances</a></li>
            <li>If {@code update} is #TRUE, then objects that were previously inactive <b>must</b> not be made active as per <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#acceleration-structure-inactive-prims">Inactive Primitives and Instances</a></li>
            <li>If {@code update} is #TRUE, the {@code src} and {@code dst} objects <b>must</b> either be the same object or not have any <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#resources-memory-aliasing">memory aliasing</a></li>
