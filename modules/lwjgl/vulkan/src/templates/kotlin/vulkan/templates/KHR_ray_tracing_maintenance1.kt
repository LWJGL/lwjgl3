    ...
    documentation =
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    <li>#PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_COPY_BIT_KHR to specify execution of <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#acceleration-structure-copying">acceleration structure copy commands</a></li>
                    <li>#ACCESS_2_SHADER_BINDING_TABLE_READ_BIT_KHR to specify read access to a <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#shader-binding-table">shader binding table</a> in any shader pipeline stage</li>
                </ul>
            </li>
            <li>
            ...
            <li>Adds an optional new indirect ray tracing dispatch command, #CmdTraceRaysIndirect2KHR(), which sources the shader binding table parameters as well as the dispatch dimensions from the device. The <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#features-rayTracingPipelineTraceRaysIndirect2">{@code rayTracingPipelineTraceRaysIndirect2}</a> feature indicates whether this functionality is supported.</li>
        </ul>
