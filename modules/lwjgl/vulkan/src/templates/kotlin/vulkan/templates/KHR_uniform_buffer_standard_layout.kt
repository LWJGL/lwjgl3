...
val KHR_uniform_buffer_standard_layout = "KHRUniformBufferStandardLayout".nativeClassVK("KHR_uniform_buffer_standard_layout", type = "device", postfix = "KHR") {
    documentation =
        ...
        It modifies the alignment rules for uniform buffers, allowing for tighter packing of arrays and structures. This allows, for example, the std430 layout, as defined in <a target="_blank" href="https://registry.khronos.org/OpenGL/specs/gl/GLSLangSpec.4.60.pdf">GLSL</a> to be supported in uniform buffers.
