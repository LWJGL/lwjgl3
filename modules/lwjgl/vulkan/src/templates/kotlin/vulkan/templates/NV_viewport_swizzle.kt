...
val NV_viewport_swizzle = "NVViewportSwizzle".nativeClassVK("NV_viewport_swizzle", type = "device", postfix = "NV") {
    ...
    EnumConstant(
        ...
        <h5>Description</h5>
        These values are described in detail in <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#vertexpostproc-viewport-swizzle">Viewport Swizzle</a>.
