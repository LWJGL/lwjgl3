...
val EXT_image_drm_format_modifier = "EXTImageDrmFormatModifier".nativeClassVK("EXT_image_drm_format_modifier", type = "device", postfix = "EXT") {
    documentation =
        ...
        <h5>Prior Art</h5>
        Extension {@code EGL_EXT_image_dma_buf_import}<sup><a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#VK_EXT_image_drm_format_modifier-fn1">1</a></sup> introduced the ability to create an {@code EGLImage} by importing for each plane a dma_buf, offset, and row pitch.

        Later, extension {@code EGL_EXT_image_dma_buf_import_modifiers}<sup><a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#VK_EXT_image_drm_format_modifier-fn2">2</a></sup> introduced the ability to query which combination of formats and <em>modifiers</em> the implementation supports and to specify <em>modifiers</em> during creation of the {@code EGLImage}.

        Extension {@code EGL_MESA_image_dma_buf_export}<sup><a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#VK_EXT_image_drm_format_modifier-fn3">3</a></sup> is the inverse of {@code EGL_EXT_image_dma_buf_import_modifiers}.
    ...
    VkResult(
        ...
        If an image was created with #IMAGE_TILING_DRM_FORMAT_MODIFIER_EXT, then the image has a <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#glossary-drm-format-modifier">Linux DRM format modifier</a>. To query the <em>modifier</em>, call:
