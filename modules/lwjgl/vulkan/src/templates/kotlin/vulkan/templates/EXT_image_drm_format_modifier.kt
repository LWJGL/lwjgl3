...
val EXT_image_drm_format_modifier = "EXTImageDrmFormatModifier".nativeClassVK("EXT_image_drm_format_modifier", type = "device", postfix = "EXT") {
    documentation =
        ...
        <h5>Prior Art</h5>
        Extension {@code EGL_EXT_image_dma_buf_import}<sup><a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#VK_EXT_image_drm_format_modifier-fn1">1</a></sup> introduced the ability to create an {@code EGLImage} by importing for each plane a dma_buf, offset, and row pitch.

        Later, extension {@code EGL_EXT_image_dma_buf_import_modifiers}<sup><a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#VK_EXT_image_drm_format_modifier-fn2">2</a></sup> introduced the ability to query which combination of formats and <em>modifiers</em> the implementation supports and to specify <em>modifiers</em> during creation of the {@code EGLImage}.

        Extension {@code EGL_MESA_image_dma_buf_export}<sup><a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#VK_EXT_image_drm_format_modifier-fn3">3</a></sup> is the inverse of {@code EGL_EXT_image_dma_buf_import_modifiers}.

        The Linux kernel modesetting API (KMS), when configuring the display’s framebuffer with {@code struct drm_mode_fb_cmd2}<sup><a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#VK_EXT_image_drm_format_modifier-fn4">4</a></sup>, allows one to specify the framebuffer’s <em>modifier</em> as well as a per-plane memory handle, offset, and row pitch.
        ...
        <dl>
            ...
            <dt><b>Contact</b></dt>
            <dd><ul>
                <li>Lina Versace <a href="https://github.com/KhronosGroup/Vulkan-Docs/issues/new?body=[VK_EXT_image_drm_format_modifier]%20@linyaa-kiwi%250A*Here%20describe%20the%20issue%20or%20question%20you%20have%20about%20the%20VK_EXT_image_drm_format_modifier%20extension*">linyaa-kiwi</a></li>
            </ul></dd>
        </dl>
    ...
    VkResult(
        ...
        If an image was created with #IMAGE_TILING_DRM_FORMAT_MODIFIER_EXT, then the image has a <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#glossary-drm-format-modifier">Linux DRM format modifier</a>. To query the <em>modifier</em>, call:
