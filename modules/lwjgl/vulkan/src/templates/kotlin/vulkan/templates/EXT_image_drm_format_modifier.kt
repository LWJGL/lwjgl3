...
val EXT_image_drm_format_modifier = "EXTImageDrmFormatModifier".nativeClassVK("EXT_image_drm_format_modifier", type = "device", postfix = EXT) {
    ...
    VkResult(
        ...
        If an image was created with #IMAGE_TILING_DRM_FORMAT_MODIFIER_EXT, then the image has a <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html\#glossary-drm-format-modifier">Linux DRM format modifier</a>. To query the <em>modifier</em>, call:
...
￿    VkImageDrmFormatModifierPropertiesEXT*      pProperties);</code></pre>
        ...
        <h5>Valid Usage</h5>
        <ul>
            <li>{@code image} <b>must</b> have been created with <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html\#VkImageCreateInfo">{@code tiling}</a> equal to #IMAGE_TILING_DRM_FORMAT_MODIFIER_EXT.</li>
        </ul>
        ...
        VkImage.IN("image", "the queried image."),
