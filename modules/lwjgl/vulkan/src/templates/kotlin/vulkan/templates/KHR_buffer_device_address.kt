...
val KHR_buffer_device_address = "KHRBufferDeviceAddress".nativeClassVK("KHR_buffer_device_address", type = "device", postfix = KHR) {
    documentation =
        ...
        Another way to describe this extension is that it adds "pointers to buffer memory in shaders". By calling #GetBufferDeviceAddress() with a {@code VkBuffer}, it will return a {@code VkDeviceAddress} value which represents the address of the start of the buffer.
