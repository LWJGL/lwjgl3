...
￿    const VkBool32*                             pExclusiveScissorEnables);</code></pre>
    ...
    void(
        ...
        <h5>C Specification</h5>
        To <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#pipelines-dynamic-state">dynamically set</a> the exclusive scissor rectangles, call:
