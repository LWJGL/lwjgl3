...
val KHR_extended_flags = "KHRExtendedFlags".nativeClassVK("KHR_extended_flags", type = "device", postfix = "KHR") {
    IntConstant(
    ...
    EnumConstant(
        ...
        "STRUCTURE_TYPE_FORMAT_PROPERTIES_4_KHR".."1000668000",
        "STRUCTURE_TYPE_IMAGE_CREATE_FLAGS_2_CREATE_INFO_KHR".."1000668001",
        "STRUCTURE_TYPE_IMAGE_USAGE_FLAGS_2_CREATE_INFO_KHR".."1000668002",
        "STRUCTURE_TYPE_IMAGE_VIEW_USAGE_2_CREATE_INFO_KHR".."1000668003",
        "STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_FLAGS_FEATURES_KHR".."1000668004",
        "STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_2_CREATE_INFO_KHR".."1000668005",
        "STRUCTURE_TYPE_SHARED_PRESENT_SURFACE_CAPABILITIES_2_KHR".."1000668006"
    )

    EnumConstantLong(
        "IMAGE_CREATE_2_SPARSE_BINDING_BIT_KHR".enum(0x00000001L),
        "IMAGE_CREATE_2_SPARSE_RESIDENCY_BIT_KHR".enum(0x00000002L),
        "IMAGE_CREATE_2_SPARSE_ALIASED_BIT_KHR".enum(0x00000004L),
        "IMAGE_CREATE_2_MUTABLE_FORMAT_BIT_KHR".enum(0x00000008L),
        "IMAGE_CREATE_2_CUBE_COMPATIBLE_BIT_KHR".enum(0x00000010L),
        "IMAGE_CREATE_2_2D_ARRAY_COMPATIBLE_BIT_KHR".enum(0x00000020L),
        "IMAGE_CREATE_2_SPLIT_INSTANCE_BIND_REGIONS_BIT_KHR".enum(0x00000040L),
        "IMAGE_CREATE_2_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT_KHR".enum(0x00000080L),
        "IMAGE_CREATE_2_EXTENDED_USAGE_BIT_KHR".enum(0x00000100L),
        "IMAGE_CREATE_2_DISJOINT_BIT_KHR".enum(0x00000200L),
        "IMAGE_CREATE_2_ALIAS_BIT_KHR".enum(0x00000400L),
        "IMAGE_CREATE_2_PROTECTED_BIT_KHR".enum(0x00000800L),
        "IMAGE_CREATE_2_SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_BIT_EXT".enum(0x00001000L),
        "IMAGE_CREATE_2_CORNER_SAMPLED_BIT_NV".enum(0x00002000L),
        "IMAGE_CREATE_2_SUBSAMPLED_BIT_EXT".enum(0x00004000L),
        "IMAGE_CREATE_2_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT".enum(0x00008000L),
        "IMAGE_CREATE_2_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT".enum(0x00010000L),
        "IMAGE_CREATE_2_2D_VIEW_COMPATIBLE_BIT_EXT".enum(0x00020000L),
        "IMAGE_CREATE_2_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT".enum(0x00040000L),
        "IMAGE_CREATE_2_VIDEO_PROFILE_INDEPENDENT_BIT_KHR".enum(0x00100000L)
    )

    EnumConstantLong(
        "IMAGE_USAGE_2_TRANSFER_SRC_BIT_KHR".enum(0x00000001L),
        "IMAGE_USAGE_2_TRANSFER_DST_BIT_KHR".enum(0x00000002L),
        "IMAGE_USAGE_2_SAMPLED_BIT_KHR".enum(0x00000004L),
        "IMAGE_USAGE_2_STORAGE_BIT_KHR".enum(0x00000008L),
        "IMAGE_USAGE_2_COLOR_ATTACHMENT_BIT_KHR".enum(0x00000010L),
        "IMAGE_USAGE_2_DEPTH_STENCIL_ATTACHMENT_BIT_KHR".enum(0x00000020L),
        "IMAGE_USAGE_2_TRANSIENT_ATTACHMENT_BIT_KHR".enum(0x00000040L),
        "IMAGE_USAGE_2_INPUT_ATTACHMENT_BIT_KHR".enum(0x00000080L),
        "IMAGE_USAGE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR".enum(0x00000100L),
        "IMAGE_USAGE_2_FRAGMENT_DENSITY_MAP_BIT_EXT".enum(0x00000200L),
        "IMAGE_USAGE_2_VIDEO_DECODE_DST_BIT_KHR".enum(0x00000400L),
        "IMAGE_USAGE_2_VIDEO_DECODE_SRC_BIT_KHR".enum(0x00000800L),
        "IMAGE_USAGE_2_VIDEO_DECODE_DPB_BIT_KHR".enum(0x00001000L),
        "IMAGE_USAGE_2_VIDEO_ENCODE_DST_BIT_KHR".enum(0x00002000L),
        "IMAGE_USAGE_2_VIDEO_ENCODE_SRC_BIT_KHR".enum(0x00004000L),
        "IMAGE_USAGE_2_VIDEO_ENCODE_DPB_BIT_KHR".enum(0x00008000L),
        "IMAGE_USAGE_2_INVOCATION_MASK_BIT_HUAWEI".enum(0x00040000L),
        "IMAGE_USAGE_2_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT".enum(0x00080000L),
        "IMAGE_USAGE_2_SAMPLE_WEIGHT_BIT_QCOM".enum(0x00100000L),
        "IMAGE_USAGE_2_SAMPLE_BLOCK_MATCH_BIT_QCOM".enum(0x00200000L),
        "IMAGE_USAGE_2_HOST_TRANSFER_BIT_KHR".enum(0x00400000L),
        "IMAGE_USAGE_2_TENSOR_ALIASING_BIT_ARM".enum(0x00800000L),
        "IMAGE_USAGE_2_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR".enum(0x02000000L),
        "IMAGE_USAGE_2_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR".enum(0x04000000L),
        "IMAGE_USAGE_2_TILE_MEMORY_BIT_QCOM".enum(0x08000000L)
    )
