...
val EXT_pipeline_creation_cache_control = "EXTPipelineCreationCacheControl".nativeClassVK("EXT_pipeline_creation_cache_control", type = "device", postfix = "EXT") {
    documentation =
        ...
        Hidden locks also add to the unpredictability of the cost of pipeline creation. The most common case of locks inside the stext:vkCreate*Pipelines is internal synchronization of the {@code VkPipelineCache} object. #PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_BIT_EXT can be set when calling #CreatePipelineCache() to state the cache is <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#fundamentals-threadingbehavior">externally synchronized</a>.
