...
val VK13 = "VK13".nativeClass(Module.VULKAN, "VK13", prefix = "VK", binding = VK_BINDING_INSTANCE) {
    ...
    EnumConstantLong(
        ...
        <ul>
            ...
            <li>#ACCESS_2_INDEX_READ_BIT specifies read access to an index buffer as part of an indexed drawing command, bound by #CmdBindIndexBuffer2KHR() and #CmdBindIndexBuffer(). Such access occurs in the #PIPELINE_STAGE_2_INDEX_INPUT_BIT pipeline stage.</li>
    ...
    EnumConstantLong(
        ...
        <ul>
            ...
            <li>#FORMAT_FEATURE_2_HOST_IMAGE_TRANSFER_BIT_EXT specifies that an image <b>can</b> be created with #IMAGE_USAGE_HOST_TRANSFER_BIT_EXT.</li>
        </ul>
...
￿    VkPipelineStageFlags2                       stageMask);</code></pre>
        ...
        <ul>
            ...
            <li>If neither the {@link NVRayTracing VK_NV_ray_tracing} extension or <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#features-rayTracingPipeline">{@code rayTracingPipeline} feature</a> are enabled, {@code stageMask} <b>must</b> not contain #PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHR</li>
            <li>The <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#features-synchronization2">{@code synchronization2}</a> feature <b>must</b> be enabled</li>
...
￿    uint32_t                                    query);</code></pre>
        ...
        <ul>
            ...
            <li>If neither the {@link NVRayTracing VK_NV_ray_tracing} extension or <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#features-rayTracingPipeline">{@code rayTracingPipeline} feature</a> are enabled, {@code stage} <b>must</b> not contain #PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHR</li>
            <li>The <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#features-synchronization2">{@code synchronization2}</a> feature <b>must</b> be enabled</li>
