...
val VK13 = "VK13".nativeClass(Module.VULKAN, "VK13", prefix = "VK", binding = VK_BINDING_INSTANCE) {
    ...
    EnumConstantLong(
        ...
        <ul>
            ...
            <li>#ACCESS_2_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT specifies write <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#fragops-ds-state">depth or stencil operations</a> in the #PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT_KHR or #PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT_KHR pipeline stages or via certain <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#renderpass-load-store-ops">subpass load operations</a> or <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#fragops-shader-tileimage-reads">fragment shader tile image reads</a> in the #PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT_KHR pipeline stage.</li>
            <li>#ACCESS_2_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT_KHR specifies write access to a <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#renderpass">depth/stencil attachment</a>, via <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#fragops-ds-state">depth or stencil operations</a> or certain <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#renderpass-load-store-ops">subpass load and store operations</a>. Such access occurs in the #PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT or #PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT pipeline stages.</li>
...
￿    VkPipelineStageFlags2                       stageMask);</code></pre>
        ...
        <ul>
            ...
            <li>If the <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#features-subpassShading">{@code subpassShading}</a> feature is not enabled, {@code stageMask} <b>must</b> not contain #PIPELINE_STAGE_2_SUBPASS_SHADING_BIT_HUAWEI</li>
...
￿    uint32_t                                    query);</code></pre>
        ...
        <ul>
            ...
            <li>If the <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#features-subpassShading">{@code subpassShading}</a> feature is not enabled, {@code stage} <b>must</b> not contain #PIPELINE_STAGE_2_SUBPASS_SHADING_BIT_HUAWEI</li>
