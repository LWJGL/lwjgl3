...
val VK13 = "VK13".nativeClass(Module.VULKAN, "VK13", prefix = "VK", binding = VK_BINDING_INSTANCE) {
    ...
    EnumConstantLong(
        ...
        <ul>
            ...
            <li>#PIPELINE_STAGE_2_VIDEO_DECODE_BIT_KHR specifies the stage of the pipeline where <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#video-decode-operations">video decode operation</a> are performed.</li>
            <li>#PIPELINE_STAGE_2_VIDEO_ENCODE_BIT_KHR specifies the stage of the pipeline where <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#video-encode-operations">video encode operation</a> are performed.</li>
    ...
    EnumConstantLong(
        ...
        <ul>
            ...
            <li>#ACCESS_2_VIDEO_DECODE_READ_BIT_KHR specifies read access to an image or buffer resource as part of a <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#video-decode-operations">video decode operation</a>. Such access occurs in the #PIPELINE_STAGE_2_VIDEO_DECODE_BIT_KHR pipeline stage.</li>
            <li>#ACCESS_2_VIDEO_DECODE_WRITE_BIT_KHR specifies write access to an image or buffer resource as part of a <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#video-decode-operations">video decode operation</a>. Such access occurs in the #PIPELINE_STAGE_2_VIDEO_DECODE_BIT_KHR pipeline stage.</li>
            <li>#ACCESS_2_VIDEO_ENCODE_READ_BIT_KHR specifies read access to an image or buffer resource as part of a <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#video-encode-operations">video encode operation</a>. Such access occurs in the #PIPELINE_STAGE_2_VIDEO_ENCODE_BIT_KHR pipeline stage.</li>
    ...
    EnumConstantLong(
        ...
        <ul>
            ...
            <li>#FORMAT_FEATURE_2_VIDEO_DECODE_OUTPUT_BIT_KHR specifies that an image view with this format <b>can</b> be used as an output for <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#video-decode-operations">video decode operations</a></li>
            <li>#FORMAT_FEATURE_2_VIDEO_DECODE_DPB_BIT_KHR specifies that an image view with this format <b>can</b> be used as a DPB for <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#video-decode-operations">video decode operations</a></li>
            <li>#FORMAT_FEATURE_2_VIDEO_ENCODE_INPUT_BIT_KHR specifies that an image view with this format <b>can</b> be used as an input to <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#video-encode-operations">video encode operations</a></li>
            <li>
                #FORMAT_FEATURE_2_VIDEO_ENCODE_DPB_BIT_KHR specifies that an image view with this format <b>can</b> be used as a DPB for <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#video-encode-operations">video encode operations</a>
                <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
        Specific video profiles <b>may</b> have additional restrictions on the format and other image creation parameters corresponding to image views used by video coding operations that <b>can</b> be enumerated using the #GetPhysicalDeviceVideoFormatPropertiesKHR() command, as described in <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#supported-video-input-output-dpb-formats-enumeration">Enumeration of Supported Video Output, Input and DPB Formats</a>.
                </div>
            </li>
