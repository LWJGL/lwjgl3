...
￿    VkImageLayout                               imageLayout);</code></pre>
        ...
        VkImageView("imageView", "an image view handle that specifies the invocation mask image {@code imageView} <b>may</b> be set to #NULL_HANDLE, which is equivalent to specifying a view of an image filled with ones value."),
