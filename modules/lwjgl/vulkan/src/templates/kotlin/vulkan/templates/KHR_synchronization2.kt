...
val KHR_synchronization2 = "KHRSynchronization2".nativeClassVK("KHR_synchronization2", type = "device", postfix = KHR) {
    ...
    EnumConstant(
        ...
        <ul>
            ...
            <li>
                #PIPELINE_STAGE_2_PRE_RASTERIZATION_SHADERS_BIT_KHR is equivalent to specifying all supported stages from:
                <ul>
        ...
        <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
        The tname:VkPipelineStageFlags2KHR bitmask goes beyond the 31 individual bit flags allowable within a C99 enum, which is how {@code VkPipelineStageFlagBits} is defined. The first 31 values are common to both, and are interchangeable.
        </div>
    ...
    EnumConstant(
        ...
        <ul>
            ...
            <li>#ACCESS_2_INDIRECT_COMMAND_READ_BIT_KHR specifies read access to indirect buffers in the #PIPELINE_STAGE_2_DRAW_INDIRECT_BIT_KHR pipeline stage.</li>
            <li>#ACCESS_2_INDEX_READ_BIT_KHR specifies read access to an index buffer in the #PIPELINE_STAGE_2_INDEX_INPUT_BIT_KHR pipeline stage.</li>
            <li>#ACCESS_2_VERTEX_ATTRIBUTE_READ_BIT_KHR specifies read access to a vertex buffer in the #PIPELINE_STAGE_2_VERTEX_ATTRIBUTE_INPUT_BIT_KHR pipeline stage.</li>
            ...
            <li>#ACCESS_2_INPUT_ATTACHMENT_READ_BIT_KHR specifies read access to an <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#renderpass">input attachment</a> in the #PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT_KHR pipeline stage.</li>
            ...
            <li>#ACCESS_2_COLOR_ATTACHMENT_READ_BIT_KHR specifies read access to a <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#renderpass">color attachment</a> (excluding <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#framebuffer-blend-advanced">advanced blend operations</a>) in the #PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT_KHR pipeline stage.</li>
            <li>#ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT_KHR specifies write access to a <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#renderpass">color or resolve attachment</a> in the #PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT_KHR pipeline stage.</li>
            <li>#ACCESS_2_DEPTH_STENCIL_ATTACHMENT_READ_BIT_KHR specifies read access to a <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#renderpass">depth/stencil attachment</a> in the #PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT_KHR or #PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT_KHR pipeline stages.</li>
            ...
            <li>#ACCESS_2_TRANSFER_READ_BIT_KHR specifies read access to an image or buffer in the #PIPELINE_STAGE_2_COPY_BIT_KHR, #PIPELINE_STAGE_2_BLIT_BIT_KHR, or #PIPELINE_STAGE_2_RESOLVE_BIT_KHR pipeline stages.</li>
            <li>#ACCESS_2_TRANSFER_WRITE_BIT_KHR specifies write access to an image or buffer in the #PIPELINE_STAGE_2_COPY_BIT_KHR, #PIPELINE_STAGE_2_BLIT_BIT_KHR, #PIPELINE_STAGE_2_CLEAR_BIT_KHR, or #PIPELINE_STAGE_2_RESOLVE_BIT_KHR pipeline stages.</li>
            <li>#ACCESS_2_HOST_READ_BIT_KHR specifies read access to memory in the #PIPELINE_STAGE_2_HOST_BIT_KHR pipeline stage.</li>
            <li>#ACCESS_2_HOST_WRITE_BIT_KHR specifies write access to memory in the #PIPELINE_STAGE_2_HOST_BIT_KHR pipeline stage.</li>
            <li>#ACCESS_2_CONDITIONAL_RENDERING_READ_BIT_EXT specifies read access to a predicate in the #PIPELINE_STAGE_2_CONDITIONAL_RENDERING_BIT_EXT pipeline stage.</li>
            <li>#ACCESS_2_TRANSFORM_FEEDBACK_WRITE_BIT_EXT specifies write access to a transform feedback buffer in the #PIPELINE_STAGE_2_TRANSFORM_FEEDBACK_BIT_EXT pipeline stage.</li>
            <li>#ACCESS_2_TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT specifies read access to a transform feedback counter buffer in the #PIPELINE_STAGE_2_TRANSFORM_FEEDBACK_BIT_EXT pipeline stage.</li>
            <li>#ACCESS_2_TRANSFORM_FEEDBACK_COUNTER_WRITE_BIT_EXT specifies write access to a transform feedback counter buffer in the #PIPELINE_STAGE_2_TRANSFORM_FEEDBACK_BIT_EXT pipeline stage.</li>
            <li>#ACCESS_2_COMMAND_PREPROCESS_READ_BIT_NV specifies reads from {@code VkBuffer} inputs to #CmdPreprocessGeneratedCommandsNV() in the #PIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_NV pipeline stage.</li>
            <li>#ACCESS_2_COMMAND_PREPROCESS_WRITE_BIT_NV specifies writes to the target command buffer in the #PIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_NV pipeline stage.</li>
            <li>#ACCESS_2_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT specifies read access to <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#renderpass">color attachments</a>, including <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#framebuffer-blend-advanced">advanced blend operations</a>, in the #PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT_KHR pipeline stage.</li>
            <li>#ACCESS_2_SHADING_RATE_IMAGE_READ_BIT_NV specifies read access to a shading rate image in the #PIPELINE_STAGE_2_SHADING_RATE_IMAGE_BIT_NV pipeline stage.</li>
            <li>#ACCESS_2_ACCELERATION_STRUCTURE_READ_BIT_KHR specifies read access to an acceleration structure in the #PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_KHR or #PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHR pipeline stages.</li>
            <li>#ACCESS_2_ACCELERATION_STRUCTURE_WRITE_BIT_KHR specifies write access to an acceleration structure in the #PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_KHR pipeline stage.</li>
            <li>#ACCESS_2_FRAGMENT_DENSITY_MAP_READ_BIT_EXT specifies read access to a <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#renderpass-fragmentdensitymapattachment">fragment density map attachment</a> in the #PIPELINE_STAGE_2_FRAGMENT_DENSITY_PROCESS_BIT_EXT pipeline stage.</li>
        </ul>
        ...
        <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
        The tname:VkAccessFlags2KHR bitmask goes beyond the 31 individual bit flags allowable within a C99 enum, which is how {@code VkAccessFlagBits} is defined. The first 31 values are common to both, and are interchangeable.
        </div>
...
￿    VkPipelineStageFlags2KHR                    stageMask);</code></pre>
        ...
        VkPipelineStageFlags2KHR("stageMask", "a is a {@code VkPipelineStageFlags2KHR} mask of pipeline stages used to determine the first <a target=\"_blank\" href=\"https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\\#synchronization-dependencies-scopes\">synchronization scope</a>.")
    )
...
￿    const VkDependencyInfoKHR*                  pDependencyInfos);</code></pre>
        ...
        The first <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-dependencies-scopes">synchronization scope</a> and <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-dependencies-access-scopes">access scope</a> of each memory dependency defined by any element <code>i</code> of {@code pDependencyInfos} are applied to operations commands that occurred earlier in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-submission-order">submission order</a> than the last event signal operation on element <code>i</code> of {@code pEvents}.
        ...
        The second <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-dependencies-scopes">synchronization scope</a> and <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-dependencies-access-scopes">access scope</a> of each memory dependency defined by any element <code>i</code> of {@code pDependencyInfos} are applied to operations commands that occurred later in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-submission-order">submission order</a> than {@code vkCmdWaitEvents2KHR}.
        ...
        <ul>
            ...
            <li>For any element <code>i</code> of {@code pEvents}, if barriers in the <code>i</code>th element of {@code pDependencyInfos} do not include host operations, the <code>i</code>th element of {@code pEvents} <b>must</b> be by a corresponding #CmdSetEvent2KHR() that occurred earlier in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-submission-order">submission order</a></li>
        ...
        VkEvent.const.p("pEvents", "an array of events to wait on."),
        VkDependencyInfoKHR.const.p("pDependencyInfos", "an array of ##VkDependencyInfoKHR structures, defining the second <a target=\"_blank\" href=\"https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\\#synchronization-dependencies-scopes\">synchronization scope</a>.")
    )
...
￿    const VkDependencyInfoKHR*                  pDependencyInfo);</code></pre>
        ...
        The first <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-dependencies-scopes">synchronization scope</a> and <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-dependencies-access-scopes">access scope</a> of each memory dependency defined by any element <code>i</code> of {@code pDependencyInfos} are applied to operations commands that occurred earlier in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-submission-order">submission order</a>.

        The second <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-dependencies-scopes">synchronization scope</a> and <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-dependencies-access-scopes">access scope</a> of each memory dependency defined by any element <code>i</code> of {@code pDependencyInfos} are applied to operations commands that occurred later in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-submission-order">submission order</a>.
...
￿    uint32_t                                    query);</code></pre>
        ...
        The first <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-dependencies-scopes">synchronization scope</a> includes all commands that occur earlier in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#synchronization-submission-order">submission order</a>. The synchronization scope is limited to operations on the pipeline stage specified by {@code pipelineStage}.
...
￿    uint32_t                                    marker);</code></pre>
        ...
        <h5>Description</h5>
        The command will write the 32-bit marker value into the buffer only after all preceding commands have finished executing up to at least the specified pipeline stage. This includes the completion of other preceding {@code vkCmdWriteBufferMarker2AMD} commands so long as their specified pipeline stages occur either at the same time or earlier than this command's specified {@code pipelineStage}.
