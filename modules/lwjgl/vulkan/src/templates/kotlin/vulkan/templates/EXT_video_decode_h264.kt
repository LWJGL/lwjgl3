...
val EXT_video_decode_h264 = "EXTVideoDecodeH264".nativeClassVK("EXT_video_decode_h264", type = "device", postfix = EXT) {
    ...
    EnumConstant(
        ...
        <h5>See Also</h5>
        {@code VkVideoDecodeH264PictureLayoutFlagsEXT}
        """,
