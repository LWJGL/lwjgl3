...
￿    uint32_t                                    index);</code></pre>
        ...
        <ul>
            ...
            <li>If the {@code queryType} used to create {@code queryPool} was #QUERY_TYPE_VIDEO_ENCODE_BITSTREAM_BUFFER_RANGE_KHR, then the {@code VkCommandPool} that {@code commandBuffer} was allocated from <b>must</b> support <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#video-encode-operations">video encode operations</a></li>
            <li>If the {@code queryType} used to create {@code queryPool} was #QUERY_TYPE_VIDEO_ENCODE_BITSTREAM_BUFFER_RANGE_KHR, then there <b>must</b> be a bound video session</li>
            <li>If the {@code queryType} used to create {@code queryPool} was #QUERY_TYPE_VIDEO_ENCODE_BITSTREAM_BUFFER_RANGE_KHR and there is a bound video session, then {@code queryPool} <b>must</b> have been created with a ##VkVideoProfileInfoKHR structure included in the {@code pNext} chain of ##VkQueryPoolCreateInfo identical to the one specified in ##VkVideoSessionCreateInfoKHR{@code ::pVideoProfile} the bound video session was created with</li>
            <li>If the {@code queryType} used to create {@code queryPool} was not #QUERY_TYPE_RESULT_STATUS_ONLY_KHR or #QUERY_TYPE_VIDEO_ENCODE_BITSTREAM_BUFFER_RANGE_KHR, then there <b>must</b> be no bound video session</li>
