...
￿    uint32_t                                    marker);</code></pre>
        ...
        <ul>
            ...
            <li>If neither the {@link NVRayTracing VK_NV_ray_tracing} extension or <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#features-rayTracingPipeline">{@code rayTracingPipeline} feature</a> are enabled, {@code pipelineStage} <b>must</b> not be #PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR</li>
