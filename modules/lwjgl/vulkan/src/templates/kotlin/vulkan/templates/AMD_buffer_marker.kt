...
￿    uint32_t                                    marker);</code></pre>
        ...
        <ul>
            ...
            <li>If the <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#features-taskShader">task shaders</a> feature is not enabled, {@code pipelineStage} <b>must</b> not be #PIPELINE_STAGE_TASK_SHADER_BIT_EXT</li>
