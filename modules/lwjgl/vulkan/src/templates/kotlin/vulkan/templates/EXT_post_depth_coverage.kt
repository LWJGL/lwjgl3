...
val EXT_post_depth_coverage = "EXTPostDepthCoverage".nativeClassVK("EXT_post_depth_coverage", type = "device", postfix = "EXT") {
    documentation =
        ...
        which allows the fragment shader to control whether values in the {@code SampleMask} built-in input variable reflect the coverage after early <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#fragops-depth">depth</a> and <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#fragops-stencil">stencil</a> tests are applied.
