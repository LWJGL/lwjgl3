...
val NV_device_generated_commands = "NVDeviceGeneratedCommands".nativeClassVK("NV_device_generated_commands", type = "device", postfix = NV) {
    ...
    EnumConstant(
        ...
        <h5>See Also</h5>
        {@code VkIndirectCommandsLayoutUsageFlagsNV}
        """,
...
￿    VkMemoryRequirements2*                      pMemoryRequirements);</code></pre>
        ...
        VkGeneratedCommandsMemoryRequirementsInfoNV.const.p("pInfo", "a pointer to an instance of the ##VkGeneratedCommandsMemoryRequirementsInfoNV structure containing parameters required for the memory requirements query."),
...
￿    const VkGeneratedCommandsInfoNV*            pGeneratedCommandsInfo);</code></pre>
        ...
        VkGeneratedCommandsInfoNV.const.p("pGeneratedCommandsInfo", "a pointer to an instance of the ##VkGeneratedCommandsInfoNV structure containing parameters affecting the preprocessing step.")
    )
...
￿    const VkGeneratedCommandsInfoNV*            pGeneratedCommandsInfo);</code></pre>
        ...
        VkGeneratedCommandsInfoNV.const.p("pGeneratedCommandsInfo", "a pointer to an instance of the ##VkGeneratedCommandsInfoNV structure containing parameters affecting the generation of commands.")
    )
...
￿    VkIndirectCommandsLayoutNV*                 pIndirectCommandsLayout);</code></pre>
        ...
        VkIndirectCommandsLayoutCreateInfoNV.const.p("pCreateInfo", "a pointer to an instance of the ##VkIndirectCommandsLayoutCreateInfoNV structure containing parameters affecting creation of the indirect command layout."),
        ...
        Check(1)..VkIndirectCommandsLayoutNV.p("pIndirectCommandsLayout", "points to a {@code VkIndirectCommandsLayoutNV} handle in which the resulting indirect command layout is returned.")
    )
