...
val VK11 = "VK11".nativeClass(Module.VULKAN, "VK11", prefix = "VK", binding = VK_BINDING_INSTANCE) {
    ...
    EnumConstant(
        ...
        The peer memory features of a memory heap also apply to any accesses that <b>may</b> be performed during <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html\#synchronization-image-layout-transitions">image layout transitions</a>.
        </div>
    ...
    EnumConstant(
        ...
        <ul>
            <li>#SEMAPHORE_IMPORT_TEMPORARY_BIT specifies that the semaphore payload will be imported only temporarily, as described in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html\#synchronization-semaphores-importing">Importing Semaphore Payloads</a>, regardless of the permanence of {@code handleType}.</li>
        </ul>
        """,
...
￿    uint32_t*                                   pApiVersion);</code></pre>
        ...
        Check(1)..uint32_t.p("pApiVersion", "a pointer to a {@code uint32_t}, which is the version of Vulkan supported by instance-level functionality, encoded as described in <a target=\"_blank\" href=\"https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html\\#extendingvulkan-coreversions-versionnumbers\">Version Numbers</a>.")
    )
...
￿    uint32_t                                    groupCountZ);</code></pre>
        ...
        <ul>
            ...
            <li>If any of the shader stages of the {@code VkPipeline} bound to the pipeline bind point used by this command uses the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html\#spirvenv-capabilities-table-RayQueryKHR">{@code RayQueryKHR}</a> capability, then {@code commandBuffer} <b>must</b> not be a protected command buffer</li>
...
￿    VkImageFormatProperties2*                   pImageFormatProperties);</code></pre>
        ...
        If the {@code pNext} chain of {@code pImageFormatInfo} includes a ##VkVideoProfilesKHR structure with a {@code profileCount} member greater than 0, then {@code vkGetPhysicalDeviceImageFormatProperties2} returns format capabilities specific to image types used in conjunction with the specified video codec operations and corresponding video profiles. In this case {@code vkGetPhysicalDeviceImageFormatProperties2} returns one of the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html\#video-profile-error-codes">video-profile-specific error codes</a> if any of the profiles specified via ##VkVideoProfilesKHR{@code ::pProfiles} are not supported. Furthermore, if ##VkPhysicalDeviceImageFormatInfo2{@code ::usage} includes any image usage flags not supported by the specified video profiles then {@code vkGetPhysicalDeviceImageFormatProperties2} returns #ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR.
...
￿    VkSamplerYcbcrConversion*                   pYcbcrConversion);</code></pre>
        ...
        <h5>Description</h5>
        The interpretation of the configured sampler Y′C<sub>B</sub>C<sub>R</sub> conversion is described in more detail in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html\#textures-sampler-YCbCr-conversion">the description of sampler Y′C<sub>B</sub>C<sub>R</sub> conversion</a> in the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html\#textures">Image Operations</a> chapter.

        <h5>Valid Usage</h5>
        <ul>
            <li>The <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html\#features-samplerYcbcrConversion">{@code samplerYcbcrConversion}</a> feature <b>must</b> be enabled</li>
        </ul>
...
￿    VkExternalBufferProperties*                 pExternalBufferProperties);</code></pre>
    ...
    void(
        ...
        <h5>C Specification</h5>
        Fences <b>may</b> support import and export of their <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html\#synchronization-fences-payloads">payload</a> to external handles. To query the external handle types supported by fences, call:
...
￿    VkExternalFenceProperties*                  pExternalFenceProperties);</code></pre>
    ...
    void(
        ...
        <h5>C Specification</h5>
        Semaphores <b>may</b> support import and export of their <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html\#synchronization-semaphores-payloads">payload</a> to external handles. To query the external handle types supported by semaphores, call:
