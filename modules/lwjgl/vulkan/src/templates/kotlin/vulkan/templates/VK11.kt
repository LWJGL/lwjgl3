...
val VK11 = "VK11".nativeClass(Module.VULKAN, "VK11", prefix = "VK", binding = VK_BINDING_INSTANCE) {
    ...
    EnumConstant(
        ...
        The peer memory features of a memory heap also apply to any accesses that <b>may</b> be performed during <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#synchronization-image-layout-transitions">image layout transitions</a>.
        </div>
    ...
    EnumConstant(
        ...
        <h5>Description</h5>
        <ul>
            <li>#TESSELLATION_DOMAIN_ORIGIN_UPPER_LEFT specifies that the origin of the domain space is in the upper left corner, as shown in figure <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#img-tessellation-topology-ul">Domain parameterization for tessellation primitive modes (upper-left origin)</a>.</li>
            <li>#TESSELLATION_DOMAIN_ORIGIN_LOWER_LEFT specifies that the origin of the domain space is in the lower left corner, as shown in figure <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#img-tessellation-topology-ll">Domain parameterization for tessellation primitive modes (lower-left origin)</a>.</li>
        </ul>
    ...
    EnumConstant(
        ...
        The formulae for these conversions is described in the <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#textures-sampler-YCbCr-conversion-rangeexpand">Sampler Y′C<sub>B</sub>C<sub>R</sub> Range Expansion</a> section of the <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#textures">Image Operations</a> chapter.
    ...
    EnumConstant(
        ...
        <h5>Description</h5>
        <ul>
            <li>#FENCE_IMPORT_TEMPORARY_BIT specifies that the fence payload will be imported only temporarily, as described in <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#synchronization-fences-importing">Importing Fence Payloads</a>, regardless of the permanence of {@code handleType}.</li>
        </ul>
        """,
    ...
    EnumConstant(
        ...
        <ul>
            <li>#SEMAPHORE_IMPORT_TEMPORARY_BIT specifies that the semaphore payload will be imported only temporarily, as described in <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#synchronization-semaphores-importing">Importing Semaphore Payloads</a>, regardless of the permanence of {@code handleType}.</li>
        </ul>
        """,
...
￿    uint32_t*                                   pApiVersion);</code></pre>
        ...
        <h5>Description</h5>
        <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
        The intended behaviour of #EnumerateInstanceVersion() is that an implementation <b>should</b> not need to perform memory allocations and <b>should</b> unconditionally return #SUCCESS. The loader, and any enabled layers, <b>may</b> return #ERROR_OUT_OF_HOST_MEMORY in the case of a failed memory allocation.
        </div>
        ...
        Check(1)..uint32_t.p("pApiVersion", "a pointer to a {@code uint32_t}, which is the version of Vulkan supported by instance-level functionality, encoded as described in <a target=\"_blank\" href=\"https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\\#extendingvulkan-coreversions-versionnumbers\">Version Numbers</a>.")
    )
...
￿    const VkBindBufferMemoryInfo*               pBindInfos);</code></pre>
        ...
        <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
        If {@code vkBindBufferMemory2} fails, and {@code bindInfoCount} was greater than one, then the buffers referenced by {@code pBindInfos} will be in an indeterminate state, and must not be used. Applications should destroy these buffers.
        </div>
...
￿    const VkBindImageMemoryInfo*                pBindInfos);</code></pre>
        ...
        <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
        If {@code vkBindImageMemory2} fails, and {@code bindInfoCount} was greater than one, then the images referenced by {@code pBindInfos} will be in an indeterminate state, and must not be used. Applications should destroy these images.
        </div>
...
￿    uint32_t                                    groupCountZ);</code></pre>
        ...
        <ul>
            ...
            <li>If any of the shader stages of the {@code VkPipeline} bound to the pipeline bind point used by this command uses the <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#spirvenv-capabilities-table-RayQueryKHR">{@code RayQueryKHR}</a> capability, then {@code commandBuffer} <b>must</b> not be a protected command buffer</li>
...
￿    VkSamplerYcbcrConversion*                   pYcbcrConversion);</code></pre>
        ...
        <h5>Description</h5>
        The interpretation of the configured sampler Y′C<sub>B</sub>C<sub>R</sub> conversion is described in more detail in <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#textures-sampler-YCbCr-conversion">the description of sampler Y′C<sub>B</sub>C<sub>R</sub> conversion</a> in the <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#textures">Image Operations</a> chapter.

        <h5>Valid Usage</h5>
        <ul>
            <li>The <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#features-samplerYcbcrConversion">{@code samplerYcbcrConversion}</a> feature <b>must</b> be enabled</li>
        </ul>
...
￿    const void*                                 pData);</code></pre>
        ...
        <ul>
            ...
            <li>Host access to {@code descriptorSet} <b>must</b> be <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#fundamentals-threadingbehavior">externally synchronized</a> unless explicitly denoted otherwise for specific flags</li>
        </ul>
...
￿    VkExternalBufferProperties*                 pExternalBufferProperties);</code></pre>
    ...
    void(
        ...
        <h5>C Specification</h5>
        Fences <b>may</b> support import and export of their <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#synchronization-fences-payloads">payload</a> to external handles. To query the external handle types supported by fences, call:
...
￿    VkExternalFenceProperties*                  pExternalFenceProperties);</code></pre>
    ...
    void(
        ...
        <h5>C Specification</h5>
        Semaphores <b>may</b> support import and export of their <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#synchronization-semaphores-payloads">payload</a> to external handles. To query the external handle types supported by semaphores, call:
