...
val HUAWEI_subpass_shading = "HUAWEISubpassShading".nativeClassVK("HUAWEI_subpass_shading", type = "device", postfix = "HUAWEI") {
    documentation =
        ...
        The {@code GlobalInvocationId.xy} of a subpass shading pipeline is equal to the {@code FragCoord.xy} of a graphic pipeline in the same render pass subtracted the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#VkRect2D">{@code offset}</a> of the ##VkRenderPassBeginInfo{@code ::renderArea}. {@code GlobalInvocationId.z} is mapped to the Layer if {@link EXTShaderViewportIndexLayer VK_EXT_shader_viewport_index_layer} is supported. The {@code GlobalInvocationId.xy} is equal to the index of the local workgroup multiplied by the size of the local workgroup plus the {@code LocalInvocationId} and the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#VkRect2D">{@code offset}</a> of the ##VkRenderPassBeginInfo{@code ::renderArea}.
...
￿vkCreateComputePipelines(device, pipelineCache, 1, &amp;subpassShadingComputePipelineCreateInfo, NULL, &amp;pipeline);</code></pre>
        ...
        <dl>
            ...
            <dd>{@link KHRCreateRenderpass2 VK_KHR_create_renderpass2} or <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#versions-1.2">Version 1.2</a> and {@link KHRSynchronization2 VK_KHR_synchronization2} or <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#versions-1.3">Version 1.3</a></dd>

            <dt><b>SPIR-V Dependencies</b></dt>
            <dd><ul>
                <li><a href="https://htmlpreview.github.io/?https://github.com/KhronosGroup/SPIRV-Registry/blob/master/extensions/HUAWEI/SPV_HUAWEI_subpass_shading.html">SPV_HUAWEI_subpass_shading</a></li>
            </ul></dd>

            <dt><b>Contact</b></dt>
            <dd><ul>
                <li>Pan Gao <a href="https://github.com/KhronosGroup/Vulkan-Docs/issues/new?body=[VK_HUAWEI_subpass_shading]%20@PanGao-h%250A*Here%20describe%20the%20issue%20or%20question%20you%20have%20about%20the%20VK_HUAWEI_subpass_shading%20extension*">PanGao-h</a></li>
            </ul></dd>
        </dl>
        ...
        <dl>
            ...
            <dd><ul>
                <li>This extension provides API support for <a href="https://github.com/KhronosGroup/GLSL/blob/main/extensions/huawei/GLSL_HUAWEI_subpass_shading.txt">{@code GL_HUAWEI_subpass_shading}</a>.</li>
            </ul></dd>
...
￿    VkExtent2D*                                 pMaxWorkgroupSize);</code></pre>
        ...
        <ul>
            ...
            <li>{@code pMaxWorkgroupSize} <b>must</b> be a valid pointer to ##VkExtent2D structures</li>
    ...
    void(
        ...
        <h5>C Specification</h5>
        A subpass shading dispatches a compute pipeline work with the work dimension of render area of the calling subpass and work groups are partitioned by specified work group size. Subpass operations like {@code subpassLoad} are allowed to be used.
...
￿    VkCommandBuffer                             commandBuffer);</code></pre>
        ...
        <ul>
            ...
            <li>This command <b>must</b> be called in a subpass with bind point #PIPELINE_BIND_POINT_SUBPASS_SHADING_HUAWEI. No draw commands can be called in the same subpass. Only one #CmdSubpassShadingHUAWEI() command can be called in a subpass</li>
        </ul>
