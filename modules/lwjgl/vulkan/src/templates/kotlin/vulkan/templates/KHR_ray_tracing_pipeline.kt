...
￿}</code></pre>
    ...
    EnumConstant(
        ...
        <h5>Description</h5>
        <ul>
            <li>#RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_KHR specifies that a shader group with a single #SHADER_STAGE_RAYGEN_BIT_KHR, #SHADER_STAGE_MISS_BIT_KHR, or #SHADER_STAGE_CALLABLE_BIT_KHR shader in it.</li>
            <li>#RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_KHR specifies that a shader group that only hits triangles and <b>must</b> not contain an intersection shader, only closest hit and any-hit shaders.</li>
            <li>#RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_KHR specifies that a shader group that only intersects with custom geometry and <b>must</b> contain an intersection shader and <b>may</b> contain closest hit and any-hit shaders.</li>
        </ul>
...
￿    uint32_t                                    depth);</code></pre>
        ...
        <ul>
            ...
            <li>{@code pMissShaderBindingTable}-&gt;stride <b>must</b> be a multiple of ##VkPhysicalDeviceRayTracingPipelinePropertiesKHR{@code ::shaderGroupHandleAlignment}</li>
            <li>{@code pMissShaderBindingTable}-&gt;stride <b>must</b> be less than or equal to ##VkPhysicalDeviceRayTracingPipelinePropertiesKHR{@code ::maxShaderGroupStride}</li>
            ...
            <li>{@code pHitShaderBindingTable}-&gt;stride <b>must</b> be a multiple of ##VkPhysicalDeviceRayTracingPipelinePropertiesKHR{@code ::shaderGroupHandleAlignment}</li>
            <li>{@code pHitShaderBindingTable}-&gt;stride <b>must</b> be less than or equal to ##VkPhysicalDeviceRayTracingPipelinePropertiesKHR{@code ::maxShaderGroupStride}</li>
            ...
            <li>{@code pCallableShaderBindingTable}-&gt;stride <b>must</b> be a multiple of ##VkPhysicalDeviceRayTracingPipelinePropertiesKHR{@code ::shaderGroupHandleAlignment}</li>
            <li>{@code pCallableShaderBindingTable}-&gt;stride <b>must</b> be less than or equal to ##VkPhysicalDeviceRayTracingPipelinePropertiesKHR{@code ::maxShaderGroupStride}</li>
            <li>If the bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR, {@code pHitShaderBindingTable}-&gt;deviceAddress <b>must</b> not be zero</li>
            <li>If the bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR, {@code pHitShaderBindingTable}-&gt;deviceAddress <b>must</b> not be zero</li>
            <li>If the bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR, the shader group handle identified by {@code pMissShaderBindingTable}-&gt;deviceAddress <b>must</b> not be zero</li>
            <li>If the bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR, entries in the table identified by {@code pHitShaderBindingTable}-&gt;deviceAddress accessed as a result of this command in order to execute an any-hit shader <b>must</b> not be zero</li>
            <li>If the bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR, entries in the table identified by {@code pHitShaderBindingTable}-&gt;deviceAddress accessed as a result of this command in order to execute a closest hit shader <b>must</b> not be zero</li>
            <li>If the bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR, entries in the table identified by {@code pHitShaderBindingTable}-&gt;deviceAddress accessed as a result of this command in order to execute an intersection shader <b>must</b> not be zero</li>
            <li>Any non-zero hit shader group entries in the table identified by {@code pHitShaderBindingTable}-&gt;deviceAddress accessed by this call from a geometry with a {@code geometryType} of #GEOMETRY_TYPE_TRIANGLES_KHR <b>must</b> have been created with #RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_KHR</li>
            <li>Any non-zero hit shader group entries in the table identified by {@code pHitShaderBindingTable}-&gt;deviceAddress accessed by this call from a geometry with a {@code geometryType} of #GEOMETRY_TYPE_AABBS_KHR <b>must</b> have been created with #RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_KHR</li>
        </ul>
...
￿    VkPipeline*                                 pPipelines);</code></pre>
        ...
        <h5>Description</h5>
        The #ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS error is returned if the implementation is unable to reuse the shader group handles provided in ##VkRayTracingShaderGroupCreateInfoKHR{@code ::pShaderGroupCaptureReplayHandle} when ##VkPhysicalDeviceRayTracingPipelineFeaturesKHR{@code ::rayTracingPipelineShaderGroupHandleCaptureReplay} is enabled.

        Pipelines are created and returned as described for <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#pipelines-multiple">Multiple Pipeline Creation</a>.

        <h5>Valid Usage</h5>
        <ul>
            <li>{@code device} <b>must</b> support at least one queue family with the #QUEUE_COMPUTE_BIT capability</li>
            ...
            <li>If {@code pipelineCache} was created with #PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_BIT, host access to {@code pipelineCache} <b>must</b> be <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#fundamentals-threadingbehavior">externally synchronized</a></li>
        </ul>
        ...
        <ul>
            <li>If ##VkPipelineBinaryInfoKHR{@code ::binaryCount} is not 0 for any element of {@code pCreateInfos}, {@code pipelineCache} <b>must</b> be #NULL_HANDLE</li>
            <li>If a ##VkPipelineCreateFlags2CreateInfoKHR structure with the #PIPELINE_CREATE_2_CAPTURE_DATA_BIT_KHR flag set is included in the {@code pNext} chain of any element of {@code pCreateInfos}, {@code pipelineCache} <b>must</b> be #NULL_HANDLE</li>
            <li>If ##VkPipelineBinaryInfoKHR{@code ::binaryCount} is not 0 for any element of {@code pCreateInfos}, #PIPELINE_CREATION_FEEDBACK_APPLICATION_PIPELINE_CACHE_HIT_BIT <b>must</b> not be set in the {@code flags} of that element</li>
            <li>If ##VkPipelineBinaryInfoKHR{@code ::binaryCount} is not 0 for any element of {@code pCreateInfos}, #PIPELINE_CREATION_FEEDBACK_BASE_PIPELINE_ACCELERATION_BIT <b>must</b> not be set in the {@code flags} of that element</li>
            <li>If ##VkPipelineBinaryInfoKHR{@code ::binaryCount} is not 0 for any element of {@code pCreateInfos}, #PIPELINE_CREATE_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT_EXT <b>must</b> not be set in the {@code flags} of that element</li>
        ...
        VkDeferredOperationKHR("deferredOperation", "#NULL_HANDLE or the handle of a valid {@code VkDeferredOperationKHR} <a href=\"https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\\#deferred-host-operations-requesting\">request deferral</a> object for this command."),
...
￿    void*                                       pData);</code></pre>
        ...
        <h5>Description</h5>
        On success, an array of {@code groupCount} shader handles will be written to {@code pData}, with each element being of size ##VkPhysicalDeviceRayTracingPipelinePropertiesKHR{@code ::shaderGroupHandleSize}.

        If {@code pipeline} was created with #PIPELINE_CREATE_LIBRARY_BIT_KHR and the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#features-pipelineLibraryGroupHandles">pipelineLibraryGroupHandles</a> feature is enabled applications <b>can</b> query group handles from that pipeline, even if the pipeline is a library and is never bound to a command buffer. These group handles remain bitwise identical for any {@code pipeline} which references the pipeline library. Group indices are assigned as-if the pipeline was created without #PIPELINE_CREATE_LIBRARY_BIT_KHR.
        ...
        <ul>
            ...
            <li>If the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#features-pipelineLibraryGroupHandles">pipelineLibraryGroupHandles</a> feature is not enabled, {@code pipeline} <b>must</b> not have been created with #PIPELINE_CREATE_LIBRARY_BIT_KHR</li>
        </ul>
...
￿    void*                                       pData);</code></pre>
        ...
        <h5>Description</h5>
        On success, an array of {@code groupCount} shader handles will be written to {@code pData}, with each element being of size ##VkPhysicalDeviceRayTracingPipelinePropertiesKHR{@code ::shaderGroupHandleCaptureReplaySize}.
...
￿    VkShaderGroupShaderKHR                      groupShader);</code></pre>
    ...
    void(
        ...
        <h5>C Specification</h5>
        To <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html\#pipelines-dynamic-state">dynamically set</a> the stack size for a ray tracing pipeline, call:
