...
￿    VkPipeline*                                 pPipelines);</code></pre>
        ...
        <ul>
            ...
            <li>If {@code pipelineCache} was created with #PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_BIT, host access to {@code pipelineCache} <b>must</b> be <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#fundamentals-threadingbehavior">externally synchronized</a></li>
        </ul>
        ...
        VkDeferredOperationKHR("deferredOperation", "#NULL_HANDLE or the handle of a valid {@code VkDeferredOperationKHR} <a target=\"_blank\" href=\"https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\\#deferred-host-operations-requesting\">request deferral</a> object for this command."),
...
￿    VkShaderGroupShaderKHR                      groupShader);</code></pre>
    ...
    void(
        ...
        <h5>C Specification</h5>
        To <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#pipelines-dynamic-state">dynamically set</a> the stack size for a ray tracing pipeline, call:
