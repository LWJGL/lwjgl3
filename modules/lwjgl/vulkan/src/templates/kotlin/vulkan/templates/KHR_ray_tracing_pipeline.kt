...
￿    uint32_t                                    depth);</code></pre>
        ...
        <ul>
            ...
            <li>If the currently bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR, {@code pHitShaderBindingTable}-&gt;deviceAddress <b>must</b> not be zero</li>
            <li>If the currently bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR, {@code pHitShaderBindingTable}-&gt;deviceAddress <b>must</b> not be zero</li>
            <li>If the currently bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR, the shader group handle identified by {@code pMissShaderBindingTable}-&gt;deviceAddress <b>must</b> not be zero</li>
