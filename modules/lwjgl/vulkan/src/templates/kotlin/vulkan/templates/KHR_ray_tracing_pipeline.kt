...
￿    uint32_t                                    depth);</code></pre>
        ...
        <ul>
            ...
            <li>If the currently bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR, the shader group handle identified by {@code pMissShaderBindingTable}-&gt;deviceAddress <b>must</b> not be set to zero</li>
            <li>If the currently bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR, entries in the table identified by {@code pHitShaderBindingTable}-&gt;deviceAddress accessed as a result of this command in order to execute an any-hit shader <b>must</b> not be set to zero</li>
            ...
            <li>If the currently bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR, entries in the table identified by {@code pHitShaderBindingTable}-&gt;deviceAddress accessed as a result of this command in order to execute an intersection shader <b>must</b> not be set to zero</li>
...
￿    VkPipeline*                                 pPipelines);</code></pre>
        ...
        Pipelines are created and returned as described for <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#pipelines-multiple">Multiple Pipeline Creation</a>.
        ...
        VkDeferredOperationKHR("deferredOperation", "#NULL_HANDLE or the handle of a valid {@code VkDeferredOperationKHR} <a href=\"https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\\#deferred-host-operations-requesting\">request deferral</a> object for this command."),
...
￿    void*                                       pData);</code></pre>
        ...
        <ul>
            ...
            <li>If the <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#features-pipelineLibraryGroupHandles">pipelineLibraryGroupHandles</a> feature is not enabled, {@code pipeline} <b>must</b> not have been created with #PIPELINE_CREATE_LIBRARY_BIT_KHR</li>
        </ul>
...
￿    VkShaderGroupShaderKHR                      groupShader);</code></pre>
    ...
    void(
        ...
        <h5>C Specification</h5>
        To <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html\#pipelines-dynamic-state">dynamically set</a> the stack size for a ray tracing pipeline, call:
