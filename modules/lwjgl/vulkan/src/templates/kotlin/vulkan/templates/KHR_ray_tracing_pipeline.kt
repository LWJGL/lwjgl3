...
￿}</code></pre>
        ...
        <dl>
            ...
            <dd><ul>
                ...
                <li>This extension interacts with <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#VK_KHR_pipeline_library">VK_KHR_pipeline_library</a>, enabling pipeline libraries to be used with ray tracing pipelines and enabling usage of ##VkRayTracingPipelineInterfaceCreateInfoKHR.</li>
            </ul></dd>
...
￿    uint32_t                                    depth);</code></pre>
        ...
        <ul>
            ...
            <li>If the currently bound ray tracing pipeline was created with {@code flags} that included #PIPELINE_CREATE_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR, the shader group handle identified by {@code pMissShaderBindingTable} <b>must</b> contain a valid miss shader</li>
            ...
            <li>Any non-zero hit group entries in {@code pHitShaderBindingTable} accessed by this call from a geometry with a {@code geometryType} of #GEOMETRY_TYPE_TRIANGLES_KHR <b>must</b> have been created with #RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_KHR</li>
            <li>Any non-zero hit group entries in {@code pHitShaderBindingTable} accessed by this call from a geometry with a {@code geometryType} of #GEOMETRY_TYPE_AABBS_KHR <b>must</b> have been created with #RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_KHR</li>
        </ul>
...
￿    VkPipeline*                                 pPipelines);</code></pre>
        ...
        <ul>
            ...
            <li>If {@code deferredOperation} is not #NULL_HANDLE, the {@code flags} member of elements of {@code pCreateInfos} <b>must</b> not include #PIPELINE_CREATE_EARLY_RETURN_ON_FAILURE_BIT_EXT</li>
        </ul>
...
￿    VkDeviceAddress                             indirectDeviceAddress);</code></pre>
        ...
        <ul>
            ...
            <li>the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#features-rayTracingPipelineTraceRaysIndirect">##VkPhysicalDeviceRayTracingPipelineFeaturesKHR{@code ::rayTracingPipelineTraceRaysIndirect}</a> feature <b>must</b> be enabled</li>
        </ul>
        ...
        VkStridedDeviceAddressRegionKHR.const.p("pHitShaderBindingTable", "a ##VkStridedDeviceAddressRegionKHR that holds the shader binding table data for the hit shader stage."),
        VkStridedDeviceAddressRegionKHR.const.p("pCallableShaderBindingTable", "a ##VkStridedDeviceAddressRegionKHR that holds the shader binding table data for the callable shader stage."),
        VkDeviceAddress("indirectDeviceAddress", "a buffer device address which points to a ##VkTraceRaysIndirectCommandKHR structure which contains the trace ray parameters.")
    )
...
￿    uint32_t                                    pipelineStackSize);</code></pre>
        ...
        <h5>Description</h5>
        See <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#ray-tracing-pipeline-stack">Ray Tracing Pipeline Stack</a> for more on computing {@code pipelineStackSize}.
