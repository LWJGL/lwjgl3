...
￿    VkPipeline*                                 pPipelines);</code></pre>
        ...
        VkDeferredOperationKHR("deferredOperation", "#NULL_HANDLE or the handle of a valid {@code VkDeferredOperationKHR} <a target=\"_blank\" href=\"https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\\#deferred-host-operations-requesting\">request deferral</a> object for this command."),
...
￿    VkShaderGroupShaderKHR                      groupShader);</code></pre>
    ...
    void(
        ...
        <h5>C Specification</h5>
        To <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html\#pipelines-dynamic-state">dynamically set</a> the stack size for a ray tracing pipeline, call:
