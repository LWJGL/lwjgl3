...
￿    VkFence                                     fence);</code></pre>
        ...
        <ul>
            ...
            <li>All elements of the {@code pWaitSemaphores} of all elements of {@code pBindInfo} created with a {@code VkSemaphoreTypeKHR} of #SEMAPHORE_TYPE_BINARY_KHR <b>must</b> reference a semaphore signal operation that has been submitted for execution and any semaphore signal operations on which it depends (if any) <b>must</b> have also been submitted for execution.</li>
        </ul>
