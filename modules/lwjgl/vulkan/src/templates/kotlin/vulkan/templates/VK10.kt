...
￿    VkDeviceSize                                memoryOffset);</code></pre>
        ...
        <ul>
            ...
            <li>If {@code memory} was allocated with ##VkExportMemoryAllocateInfo{@code ::handleTypes} not equal to 0, at least one handle type it contained must also have been set in ##VkExternalMemoryBufferCreateInfo{@code ::handleTypes} when {@code buffer} was created.</li>
            <li>If {@code memory} was created by a memory import operation, the external handle type of the imported memory must also have been set in ##VkExternalMemoryBufferCreateInfo{@code ::handleTypes} when {@code buffer} was created.</li>
        </ul>
...
￿    VkDeviceSize                                memoryOffset);</code></pre>
        ...
        <ul>
            ...
            <li>If {@code memory} was allocated with ##VkExportMemoryAllocateInfo{@code ::handleTypes} not equal to 0, at least one handle type it contained must also have been set in ##VkExternalMemoryImageCreateInfo{@code ::handleTypes} when {@code image} was created.</li>
