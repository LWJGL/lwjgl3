...
val VK10 = "VK10".nativeClass(Module.VULKAN, "VK10", prefix = "VK", binding = VK_BINDING_INSTANCE) {
    ...
    EnumConstant(
        ...
        <ul>
            ...
            <li>#ERROR_OUT_OF_POOL_MEMORY A pool memory allocation has failed. This <b>must</b> only be returned if no attempt to allocate host or device memory was made to accomodate the new allocation. If the failure was definitely due to fragmentation of the pool, #ERROR_FRAGMENTED_POOL <b>should</b> be returned instead.</li>
    ...
    EnumConstant(
        ...
        <ul>
            ...
            <li>#PIPELINE_STAGE_RAYTRACING_BIT_NVX specifies the execution of the ray tracing stages.</li>
            <li>
    ...
    EnumConstant(
        ...
        <h5>See Also</h5>
        ##VkQueryPoolCreateInfo, #CmdWriteAccelerationStructurePropertiesNVX()
        """,
    ...
    EnumConstant(
        ...
        <ul>
            ...
            <li>#SHADER_STAGE_RAYGEN_BIT_NVX specifies the ray generation stage.</li>
            <li>#SHADER_STAGE_ANY_HIT_BIT_NVX specifies the any hit stage.</li>
            <li>#SHADER_STAGE_CLOSEST_HIT_BIT_NVX specifies the closest hit stage.</li>
            <li>#SHADER_STAGE_MISS_BIT_NVX specifies the miss stage.</li>
            <li>#SHADER_STAGE_INTERSECTION_BIT_NVX specifies the intersection stage.</li>
            <li>#SHADER_STAGE_CALLABLE_BIT_NVX specifies the callable stage.</li>
        </ul>
    ...
    EnumConstant(
        ...
        When updating descriptors with a {@code descriptorType} of #DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT, none of the {@code pImageInfo}, {@code pBufferInfo}, or {@code pTexelBufferView} members are accessed, instead the source data of the descriptor update operation is taken from the instance of ##VkWriteDescriptorSetInlineUniformBlockEXT in the {@code pNext} chain of ##VkWriteDescriptorSet.
    ...
    EnumConstant(
        ...
        <h5>See Also</h5>
        ##VkGeometryTrianglesNVX, ##VkObjectTableIndexBufferEntryNVX, #CmdBindIndexBuffer()
        """,
...
￿    VkShaderModule*                             pShaderModule);</code></pre>
        ...
        VkShaderModuleCreateInfo.const.p.IN("pCreateInfo", "a pointer to an instance of the ##VkShaderModuleCreateInfo structure."),
        nullable..VkAllocationCallbacks.const.p.IN("pAllocator", "controls host memory allocation as described in the <a target=\"_blank\" href=\"https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html\\#memory-allocation\">Memory Allocation</a> chapter."),
...
￿    VkCommandPool*                              pCommandPool);</code></pre>
        ...
        VkCommandPoolCreateInfo.const.p.IN("pCreateInfo", "a pointer to an instance of the ##VkCommandPoolCreateInfo structure specifying the state of the command pool object."),
        nullable..VkAllocationCallbacks.const.p.IN("pAllocator", "controls host memory allocation as described in the <a target=\"_blank\" href=\"https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html\\#memory-allocation\">Memory Allocation</a> chapter."),
...
￿    VkSubpassContents                           contents);</code></pre>
        ...
        VkRenderPassBeginInfo.const.p.IN("pRenderPassBegin", "a pointer to a ##VkRenderPassBeginInfo structure (defined below) which specifies the render pass to begin an instance of, and the framebuffer the instance uses."),
