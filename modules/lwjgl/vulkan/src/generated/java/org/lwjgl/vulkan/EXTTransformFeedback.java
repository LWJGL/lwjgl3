...
public class EXTTransformFeedback {
     ...
     * <li>If the bound graphics pipeline state was created with the {@link EXTExtendedDynamicState3#VK_DYNAMIC_STATE_SAMPLE_MASK_EXT DYNAMIC_STATE_SAMPLE_MASK_EXT} dynamic state enabled then {@link EXTExtendedDynamicState3#vkCmdSetSampleMaskEXT CmdSetSampleMaskEXT} must have been called in the current command buffer prior to this drawing command</li>
     ...
     * <li>If the bound graphics pipeline state was created with the {@link EXTExtendedDynamicState3#VK_DYNAMIC_STATE_ALPHA_TO_ONE_ENABLE_EXT DYNAMIC_STATE_ALPHA_TO_ONE_ENABLE_EXT} dynamic state enabled then {@link EXTExtendedDynamicState3#vkCmdSetAlphaToOneEnableEXT CmdSetAlphaToOneEnableEXT} must have been called in the current command buffer prior to this drawing command</li>
     ...
     * <li>If the bound graphics pipeline state was created with the {@link EXTExtendedDynamicState3#VK_DYNAMIC_STATE_EXTRA_PRIMITIVE_OVERESTIMATION_SIZE_EXT DYNAMIC_STATE_EXTRA_PRIMITIVE_OVERESTIMATION_SIZE_EXT} dynamic state enabled then {@link EXTExtendedDynamicState3#vkCmdSetExtraPrimitiveOverestimationSizeEXT CmdSetExtraPrimitiveOverestimationSizeEXT} must have been called in the current command buffer prior to this drawing command</li>
     ...
     * <li>If the bound graphics pipeline state was created with the {@link EXTExtendedDynamicState3#VK_DYNAMIC_STATE_PROVOKING_VERTEX_MODE_EXT DYNAMIC_STATE_PROVOKING_VERTEX_MODE_EXT} dynamic state enabled then {@link EXTExtendedDynamicState3#vkCmdSetProvokingVertexModeEXT CmdSetProvokingVertexModeEXT} must have been called in the current command buffer prior to this drawing command</li>
     ...
     * <li>If the bound graphics pipeline state was created with the {@link EXTExtendedDynamicState3#VK_DYNAMIC_STATE_LINE_STIPPLE_ENABLE_EXT DYNAMIC_STATE_LINE_STIPPLE_ENABLE_EXT} dynamic state enabled then {@link EXTExtendedDynamicState3#vkCmdSetLineStippleEnableEXT CmdSetLineStippleEnableEXT} must have been called in the current command buffer prior to this drawing command</li>
     ...
     * <li>If the bound graphics pipeline state was created with the {@link EXTExtendedDynamicState3#VK_DYNAMIC_STATE_COVERAGE_MODULATION_TABLE_ENABLE_NV DYNAMIC_STATE_COVERAGE_MODULATION_TABLE_ENABLE_NV} dynamic state enabled then {@link EXTExtendedDynamicState3#vkCmdSetCoverageModulationTableEnableNV CmdSetCoverageModulationTableEnableNV} must have been called in the current command buffer prior to this drawing command</li>
