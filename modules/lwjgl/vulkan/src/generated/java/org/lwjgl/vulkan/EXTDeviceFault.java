...
public class EXTDeviceFault {
     ...
     * 
     * <p>If {@code pFaultCounts}-&gt;vendorBinarySize is less than what is necessary to store the <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#vendor-binary-crash-dumps">binary crash dump header</a>, nothing will be written to {@code pFaultInfo}-&gt;pVendorBinaryData and zero will be written to {@code pFaultCounts}-&gt;vendorBinarySize.</p>
     * 
     * <h5>Valid Usage</h5>
     * 
     * <ul>
