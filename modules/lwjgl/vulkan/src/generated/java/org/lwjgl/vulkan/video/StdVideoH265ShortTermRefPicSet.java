...
public class StdVideoH265ShortTermRefPicSet extends Struct implements NativeResource {
    ...
    public static StdVideoH265ShortTermRefPicSet malloc() {
        return wrap(StdVideoH265ShortTermRefPicSet.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static StdVideoH265ShortTermRefPicSet calloc() {
        return wrap(StdVideoH265ShortTermRefPicSet.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static StdVideoH265ShortTermRefPicSet create() {
        ...
        return wrap(StdVideoH265ShortTermRefPicSet.class, memAddress(container), container);
    }
    ...
    public static StdVideoH265ShortTermRefPicSet create(long address) {
        return wrap(StdVideoH265ShortTermRefPicSet.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static StdVideoH265ShortTermRefPicSet createSafe(long address) {
        return address == NULL ? null : wrap(StdVideoH265ShortTermRefPicSet.class, address);
    }
    ...
    public static StdVideoH265ShortTermRefPicSet malloc(MemoryStack stack) {
        return wrap(StdVideoH265ShortTermRefPicSet.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static StdVideoH265ShortTermRefPicSet calloc(MemoryStack stack) {
        return wrap(StdVideoH265ShortTermRefPicSet.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<StdVideoH265ShortTermRefPicSet, Buffer> implements NativeResource {
         ...
         * by {@link StdVideoH265ShortTermRefPicSet#SIZEOF}, and its mark will be undefined.
         *
