...
public class VkSubpassBeginInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkSubpassBeginInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSubpassBeginInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSubpassBeginInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    ...
    /**
     * Returns a new {@link VkSubpassBeginInfo.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkSubpassBeginInfo.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkSubpassBeginInfo.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkSubpassBeginInfo.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSubpassBeginInfo.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSubpassBeginInfo.Buffer callocStack(int capacity, MemoryStack stack) {
