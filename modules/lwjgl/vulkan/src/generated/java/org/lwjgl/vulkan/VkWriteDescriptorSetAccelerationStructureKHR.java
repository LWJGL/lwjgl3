...
public class VkWriteDescriptorSetAccelerationStructureKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkWriteDescriptorSetAccelerationStructureKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkWriteDescriptorSetAccelerationStructureKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkWriteDescriptorSetAccelerationStructureKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkWriteDescriptorSetAccelerationStructureKHR callocStack() {
     ...
     */
    public static VkWriteDescriptorSetAccelerationStructureKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkWriteDescriptorSetAccelerationStructureKHR callocStack(MemoryStack stack) {
        return wrap(VkWriteDescriptorSetAccelerationStructureKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkWriteDescriptorSetAccelerationStructureKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkWriteDescriptorSetAccelerationStructureKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkWriteDescriptorSetAccelerationStructureKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkWriteDescriptorSetAccelerationStructureKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkWriteDescriptorSetAccelerationStructureKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkWriteDescriptorSetAccelerationStructureKHR.Buffer callocStack(int capacity, MemoryStack stack) {
