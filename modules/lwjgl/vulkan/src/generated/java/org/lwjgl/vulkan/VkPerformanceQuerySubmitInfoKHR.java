...
public class VkPerformanceQuerySubmitInfoKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPerformanceQuerySubmitInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPerformanceQuerySubmitInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPerformanceQuerySubmitInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPerformanceQuerySubmitInfoKHR callocStack() {
     ...
     */
    public static VkPerformanceQuerySubmitInfoKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPerformanceQuerySubmitInfoKHR callocStack(MemoryStack stack) {
        return wrap(VkPerformanceQuerySubmitInfoKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPerformanceQuerySubmitInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPerformanceQuerySubmitInfoKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPerformanceQuerySubmitInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPerformanceQuerySubmitInfoKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPerformanceQuerySubmitInfoKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPerformanceQuerySubmitInfoKHR.Buffer callocStack(int capacity, MemoryStack stack) {
