...
public class VkVideoBindMemoryKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkVideoBindMemoryKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoBindMemoryKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoBindMemoryKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoBindMemoryKHR callocStack() {
     ...
     */
    public static VkVideoBindMemoryKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoBindMemoryKHR callocStack(MemoryStack stack) {
        return wrap(VkVideoBindMemoryKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoBindMemoryKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoBindMemoryKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoBindMemoryKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoBindMemoryKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoBindMemoryKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoBindMemoryKHR.Buffer callocStack(int capacity, MemoryStack stack) {
