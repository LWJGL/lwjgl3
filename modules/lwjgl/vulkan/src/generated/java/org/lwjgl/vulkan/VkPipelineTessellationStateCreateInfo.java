...
public class VkPipelineTessellationStateCreateInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPipelineTessellationStateCreateInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPipelineTessellationStateCreateInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPipelineTessellationStateCreateInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     * @param capacity the buffer capacity
     */
    public static VkPipelineTessellationStateCreateInfo.Buffer mallocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPipelineTessellationStateCreateInfo.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPipelineTessellationStateCreateInfo.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPipelineTessellationStateCreateInfo.Buffer callocStack(int capacity, MemoryStack stack) {
