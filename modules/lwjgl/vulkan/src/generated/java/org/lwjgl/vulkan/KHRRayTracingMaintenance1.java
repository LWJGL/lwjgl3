 ...
 * 
 * <ul>
 * <li>{@link #VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_COPY_BIT_KHR PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_COPY_BIT_KHR} to specify execution of <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#acceleration-structure-copying">acceleration structure copy commands</a></li>
 * <li>{@link #VK_ACCESS_2_SHADER_BINDING_TABLE_READ_BIT_KHR ACCESS_2_SHADER_BINDING_TABLE_READ_BIT_KHR} to specify read access to a <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#shader-binding-table">shader binding table</a> in any shader pipeline stage</li>
 * </ul>
 * </li>
 ...
 * </ul>
 * </li>
 * <li>Adds an optional new indirect ray tracing dispatch command, {@link #vkCmdTraceRaysIndirect2KHR CmdTraceRaysIndirect2KHR}, which sources the shader binding table parameters as well as the dispatch dimensions from the device. The <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#features-rayTracingPipelineTraceRaysIndirect2">{@code rayTracingPipelineTraceRaysIndirect2}</a> feature indicates whether this functionality is supported.</li>
 * </ul>
 * 
 ...
 * <dt><b>Contact</b></dt>
 * <dd><ul>
 * <li>Daniel Koch <a target="_blank" href="https://github.com/KhronosGroup/Vulkan-Docs/issues/new?body=[VK_KHR_ray_tracing_maintenance1]%20@dgkoch%250A%3C%3CHere%20describe%20the%20issue%20or%20question%20you%20have%20about%20the%20VK_KHR_ray_tracing_maintenance1%20extension%3E%3E">dgkoch</a></li>
 * </ul></dd>
 * </dl>
 * 
 ...
 * <dd><ul>
 * <li>This extension requires <a target="_blank" href="https://htmlpreview.github.io/?https://github.com/KhronosGroup/SPIRV-Registry/blob/master/extensions/KHR/SPV_KHR_ray_cull_mask.html">{@code SPV_KHR_ray_cull_mask}</a></li>
 * <li>This extension provides API support for <a target="_blank" href="https://github.com/KhronosGroup/GLSL/blob/master/extensions/ext/GLSL_EXT_ray_cull_mask.txt">{@code GLSL_EXT_ray_cull_mask}</a></li>
...
public class KHRRayTracingMaintenance1 {
     ...
     * <li>The <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#features-rayTracingPipelineTraceRaysIndirect2">{@code rayTracingPipelineTraceRaysIndirect2}</a> feature <b>must</b> be enabled</li>
