...
public class VkImageViewUsageCreateInfoKHR extends VkImageViewUsageCreateInfo {
    ...
    /** Returns a new {@code VkImageViewUsageCreateInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkImageViewUsageCreateInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkImageViewUsageCreateInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
