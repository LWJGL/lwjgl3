...
public class VkDisplayModeProperties2KHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkDisplayModeProperties2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkDisplayModeProperties2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkDisplayModeProperties2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
