...
public class VkAccelerationStructureVersionInfoKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkAccelerationStructureVersionInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkAccelerationStructureVersionInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkAccelerationStructureVersionInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkAccelerationStructureVersionInfoKHR callocStack() {
     ...
     */
    public static VkAccelerationStructureVersionInfoKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkAccelerationStructureVersionInfoKHR callocStack(MemoryStack stack) {
        return wrap(VkAccelerationStructureVersionInfoKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkAccelerationStructureVersionInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureVersionInfoKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkAccelerationStructureVersionInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureVersionInfoKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureVersionInfoKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureVersionInfoKHR.Buffer callocStack(int capacity, MemoryStack stack) {
