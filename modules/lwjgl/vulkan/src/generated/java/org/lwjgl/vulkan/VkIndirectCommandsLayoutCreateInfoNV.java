 ...
 * <li>{@code flags} &ndash; a bitmask of {@code VkIndirectCommandsLayoutUsageFlagBitsNV} specifying usage hints of this layout.</li>
 * <li>{@code pipelineBindPoint} &ndash; the {@code VkPipelineBindPoint} that this layout targets.</li>
 * <li>{@code tokenCount} &ndash; the length of the individual command sequence.</li>
 * <li>{@code pTokens} &ndash; an array describing each command token in detail. See {@code VkIndirectCommandsTokenTypeNV} and {@link VkIndirectCommandsLayoutTokenNV} below for details.</li>
 * <li>{@code streamCount} &ndash; the number of streams used to provide the token inputs.</li>
 * <li>{@code pStreamStrides} &ndash; an array defining the byte stride for each input stream.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkIndirectCommandsLayoutCreateInfoNV extends Struct implements NativeResource {
    ...
    /** Returns a {@link VkIndirectCommandsLayoutTokenNV.Buffer} view of the struct array pointed to by the {@code pTokens} field. */
    ...
    /** Returns a {@link IntBuffer} view of the data pointed to by the {@code pStreamStrides} field. */
    ...
    /** Returns a new {@code VkIndirectCommandsLayoutCreateInfoNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkIndirectCommandsLayoutCreateInfoNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkIndirectCommandsLayoutCreateInfoNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkIndirectCommandsLayoutCreateInfoNV callocStack() {
     ...
     */
    public static VkIndirectCommandsLayoutCreateInfoNV mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkIndirectCommandsLayoutCreateInfoNV callocStack(MemoryStack stack) {
        return wrap(VkIndirectCommandsLayoutCreateInfoNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkIndirectCommandsLayoutCreateInfoNV.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkIndirectCommandsLayoutCreateInfoNV.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkIndirectCommandsLayoutCreateInfoNV.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkIndirectCommandsLayoutCreateInfoNV.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkIndirectCommandsLayoutCreateInfoNV.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkIndirectCommandsLayoutCreateInfoNV.Buffer callocStack(int capacity, MemoryStack stack) {
