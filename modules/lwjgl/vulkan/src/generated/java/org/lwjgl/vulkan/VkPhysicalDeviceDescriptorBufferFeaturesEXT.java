 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceDescriptorBufferFeaturesEXT extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceDescriptorBufferFeaturesEXT malloc() {
        return wrap(VkPhysicalDeviceDescriptorBufferFeaturesEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceDescriptorBufferFeaturesEXT calloc() {
        return wrap(VkPhysicalDeviceDescriptorBufferFeaturesEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceDescriptorBufferFeaturesEXT create() {
        ...
        return wrap(VkPhysicalDeviceDescriptorBufferFeaturesEXT.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceDescriptorBufferFeaturesEXT create(long address) {
        return wrap(VkPhysicalDeviceDescriptorBufferFeaturesEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceDescriptorBufferFeaturesEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceDescriptorBufferFeaturesEXT.class, address);
    }
    ...
    public static VkPhysicalDeviceDescriptorBufferFeaturesEXT malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceDescriptorBufferFeaturesEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceDescriptorBufferFeaturesEXT calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceDescriptorBufferFeaturesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceDescriptorBufferFeaturesEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceDescriptorBufferFeaturesEXT#SIZEOF}, and its mark will be undefined.
         *
