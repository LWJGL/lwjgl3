...
public class VkSurfaceFormat2KHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkSurfaceFormat2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSurfaceFormat2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSurfaceFormat2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     * @param capacity the buffer capacity
     */
    public static VkSurfaceFormat2KHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSurfaceFormat2KHR.Buffer callocStack(int capacity, MemoryStack stack) {
