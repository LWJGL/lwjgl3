...
public class AMDXShaderEnqueue {
     ...
     * <h5>Description</h5>
     * 
     * <p>The implementation will create a pipeline in each element of {@code pPipelines} from the corresponding element of {@code pCreateInfos}. If creation of any pipeline fails, that pipeline will be set to {@link VK10#VK_NULL_HANDLE NULL_HANDLE}.</p>
     * 
     * <p>If creation fails for a pipeline create info with a {@link VkExecutionGraphPipelineCreateInfoAMDX}{@code ::flags} value that included {@link VK13#VK_PIPELINE_CREATE_EARLY_RETURN_ON_FAILURE_BIT PIPELINE_CREATE_EARLY_RETURN_ON_FAILURE_BIT}, all pipelines at a greater index all automatically fail.</p>
     * 
     * <h5>Valid Usage</h5>
     * 
     * <ul>
