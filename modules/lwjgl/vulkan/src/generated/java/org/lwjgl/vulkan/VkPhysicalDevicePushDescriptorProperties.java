 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDevicePushDescriptorProperties} structure is included in the {@code pNext} chain of the {@link VkPhysicalDeviceProperties2} structure passed to {@link VK11#vkGetPhysicalDeviceProperties2 GetPhysicalDeviceProperties2}, it is filled in with each corresponding implementation-dependent property.</p>
 * 
 * <h5>Valid Usage (Implicit)</h5>
 * 
 * <ul>
 * <li>{@code sType} <b>must</b> be {@link VK14#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES}</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkPhysicalDevicePushDescriptorProperties extends Struct<VkPhysicalDevicePushDescriptorProperties> implements NativeResource {
    ...
    /** Sets the {@link VK14#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES} value to the {@link #sType} field. */
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDevicePushDescriptorProperties, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@link VkPhysicalDevicePushDescriptorProperties#sType} field. */
        @NativeType("VkStructureType")
        public int sType() { return VkPhysicalDevicePushDescriptorProperties.nsType(address()); }
        /** @return the value of the {@link VkPhysicalDevicePushDescriptorProperties#pNext} field. */
        @NativeType("void *")
        public long pNext() { return VkPhysicalDevicePushDescriptorProperties.npNext(address()); }
        /** @return the value of the {@link VkPhysicalDevicePushDescriptorProperties#maxPushDescriptors} field. */
        @NativeType("uint32_t")
        public int maxPushDescriptors() { return VkPhysicalDevicePushDescriptorProperties.nmaxPushDescriptors(address()); }

        /** Sets the specified value to the {@link VkPhysicalDevicePushDescriptorProperties#sType} field. */
        ...
        /** Sets the {@link VK14#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES} value to the {@link VkPhysicalDevicePushDescriptorProperties#sType} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDevicePushDescriptorProperties#pNext} field. */
