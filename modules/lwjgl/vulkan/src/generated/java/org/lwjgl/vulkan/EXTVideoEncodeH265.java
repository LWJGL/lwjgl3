...
public final class EXTVideoEncodeH265 {
     ...
     * <li>{@link #VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_PICTURE_INFO_EXT STRUCTURE_TYPE_VIDEO_ENCODE_H265_PICTURE_INFO_EXT}</li>
     ...
     * <li>{@link #VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_GOP_REMAINING_FRAME_INFO_EXT STRUCTURE_TYPE_VIDEO_ENCODE_H265_GOP_REMAINING_FRAME_INFO_EXT}</li>
     ...
     * <li>{@link #VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_QUALITY_LEVEL_PROPERTIES_EXT STRUCTURE_TYPE_VIDEO_ENCODE_H265_QUALITY_LEVEL_PROPERTIES_EXT}</li>
     * <li>{@link #VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_GET_INFO_EXT STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_GET_INFO_EXT}</li>
     * <li>{@link #VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_FEEDBACK_INFO_EXT STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_FEEDBACK_INFO_EXT}</li>
     * </ul>
     */
     ...
     * 
     * <ul>
     * <li>{@link #VK_VIDEO_ENCODE_H265_CAPABILITY_HRD_COMPLIANCE_BIT_EXT VIDEO_ENCODE_H265_CAPABILITY_HRD_COMPLIANCE_BIT_EXT} indicates if the implementation guarantees generating a HRD compliant bitstream if {@code nal_hrd_parameters_present_flag}, {@code vcl_hrd_parameters_present_flag}, or {@code sub_pic_hrd_params_present_flag} are enabled in {@code StdVideoH265HrdFlags}, or {@code vui_hrd_parameters_present_flag} is enabled in {@code StdVideoH265SpsVuiFlags}.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_CAPABILITY_PREDICTION_WEIGHT_TABLE_GENERATED_BIT_EXT VIDEO_ENCODE_H265_CAPABILITY_PREDICTION_WEIGHT_TABLE_GENERATED_BIT_EXT} indicates that when {@code weighted_pred_flag} or {@code weighted_bipred_flag} in {@code StdVideoH265PpsFlags} are enabled, the implementation is able to internally decide syntax for {@code pred_weight_table}.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_CAPABILITY_ROW_UNALIGNED_SLICE_SEGMENT_BIT_EXT VIDEO_ENCODE_H265_CAPABILITY_ROW_UNALIGNED_SLICE_SEGMENT_BIT_EXT} indicates that each slice segment in a frame with a single or multiple tiles per slice may begin or finish at any offset in a CTB row. If not supported, all slice segments in such a frame <b>must</b> begin at the start of a CTB row (and hence each slice segment <b>must</b> finish at the end of a CTB row). Also indicates that each slice segment in a frame with multiple slices per tile may begin or finish at any offset within the enclosing tile’s CTB row. If not supported, slice segments in such a frame <b>must</b> begin at the start of the enclosing tile’s CTB row (and hence each slice segment <b>must</b> finish at the end of the enclosing tile’s CTB row).</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_CAPABILITY_DIFFERENT_SLICE_SEGMENT_TYPE_BIT_EXT VIDEO_ENCODE_H265_CAPABILITY_DIFFERENT_SLICE_SEGMENT_TYPE_BIT_EXT} indicates that when a frame is encoded with multiple slice segments, the implementation allows encoding each slice segment with a different {@code StdVideoEncodeH265SliceSegmentHeader}{@code ::slice_type}. If not supported, all slice segments of the frame <b>must</b> be encoded with the same {@code slice_type} which corresponds to the picture type of the frame. For example, all slice segments of a P-frame would be encoded as P-slices.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_CAPABILITY_B_FRAME_IN_L0_LIST_BIT_EXT VIDEO_ENCODE_H265_CAPABILITY_B_FRAME_IN_L0_LIST_BIT_EXT} indicates support for using a B frame as L0 reference.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_CAPABILITY_B_FRAME_IN_L1_LIST_BIT_EXT VIDEO_ENCODE_H265_CAPABILITY_B_FRAME_IN_L1_LIST_BIT_EXT} indicates support for using a B frame as L1 reference.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_CAPABILITY_PER_PICTURE_TYPE_MIN_MAX_QP_BIT_EXT VIDEO_ENCODE_H265_CAPABILITY_PER_PICTURE_TYPE_MIN_MAX_QP_BIT_EXT} indicates support for specifying different QP values in the members of {@link VkVideoEncodeH265QpEXT}.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_CAPABILITY_PER_SLICE_SEGMENT_CONSTANT_QP_BIT_EXT VIDEO_ENCODE_H265_CAPABILITY_PER_SLICE_SEGMENT_CONSTANT_QP_BIT_EXT} indicates support for specifying different constant QP values for each slice segment.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_TILES_PER_SLICE_SEGMENT_BIT_EXT VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_TILES_PER_SLICE_SEGMENT_BIT_EXT} indicates if encoding multiple tiles per slice segment is supported. If not set, the implementation is only able to encode a single tile for each slice segment.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_SLICE_SEGMENTS_PER_TILE_BIT_EXT VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_SLICE_SEGMENTS_PER_TILE_BIT_EXT} indicates if encoding multiple slice segments per tile is supported. If not set, the implementation is only able to encode a single slice segment for each tile.</li>
     * </ul>
     */
    public static final int
     ...
     * 
     * <ul>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_SEPARATE_COLOR_PLANE_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_SEPARATE_COLOR_PLANE_FLAG_SET_BIT_EXT} indicates if enabling {@code separate_colour_plane_flag} in {@code StdVideoH265SpsFlags} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_SAMPLE_ADAPTIVE_OFFSET_ENABLED_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_SAMPLE_ADAPTIVE_OFFSET_ENABLED_FLAG_SET_BIT_EXT} indicates if enabling {@code sample_adaptive_offset_enabled_flag} in {@code StdVideoH265SpsFlags} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_SCALING_LIST_DATA_PRESENT_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_SCALING_LIST_DATA_PRESENT_FLAG_SET_BIT_EXT} indicates if enabling {@code scaling_list_enabled_flag} and {@code sps_scaling_list_data_present_flag} in {@code StdVideoH265SpsFlags}, or enabling {@code pps_scaling_list_data_present_flag} in {@code StdVideoH265PpsFlags} are supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_PCM_ENABLED_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_PCM_ENABLED_FLAG_SET_BIT_EXT} indicates if enabling {@code pcm_enable_flag} in {@code StdVideoH265SpsFlags} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_SPS_TEMPORAL_MVP_ENABLED_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_SPS_TEMPORAL_MVP_ENABLED_FLAG_SET_BIT_EXT} indicates if enabling {@code sps_temporal_mvp_enabled_flag} in {@code StdVideoH265SpsFlags} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_INIT_QP_MINUS26_BIT_EXT VIDEO_ENCODE_H265_STD_INIT_QP_MINUS26_BIT_EXT} indicates if setting non-zero {@code init_qp_minus26} in {@code StdVideoH265PictureParameterSet} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_WEIGHTED_PRED_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_WEIGHTED_PRED_FLAG_SET_BIT_EXT} indicates if enabling {@code weighted_pred_flag} in {@code StdVideoH265PpsFlags} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_WEIGHTED_BIPRED_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_WEIGHTED_BIPRED_FLAG_SET_BIT_EXT} indicates if enabling {@code weighted_bipred_flag} in {@code StdVideoH265PpsFlags} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_LOG2_PARALLEL_MERGE_LEVEL_MINUS2_BIT_EXT VIDEO_ENCODE_H265_STD_LOG2_PARALLEL_MERGE_LEVEL_MINUS2_BIT_EXT} indicates if setting non-zero value for {@code log2_parallel_merge_level_minus2} in {@code StdVideoH265PictureParameterSet} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_SIGN_DATA_HIDING_ENABLED_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_SIGN_DATA_HIDING_ENABLED_FLAG_SET_BIT_EXT} indicates if enabling {@code sign_data_hiding_enabled_flag} in {@code StdVideoH265PpsFlags} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_SET_BIT_EXT} indicates if enabling {@code transform_skip_enabled_flag} in {@code StdVideoH265PpsFlags} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_UNSET_BIT_EXT VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_UNSET_BIT_EXT} indicates if disabling {@code transform_skip_enabled_flag} in {@code StdVideoH265PpsFlags} is supported. Implementations <b>must</b> report at least one of {@link #VK_VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_SET_BIT_EXT} and {@link #VK_VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_UNSET_BIT_EXT VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_UNSET_BIT_EXT} as supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_PPS_SLICE_CHROMA_QP_OFFSETS_PRESENT_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_PPS_SLICE_CHROMA_QP_OFFSETS_PRESENT_FLAG_SET_BIT_EXT} indicates if enabling {@code pps_slice_chroma_qp_offsets_present_flag} in {@code StdVideoH265PpsFlags} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_TRANSQUANT_BYPASS_ENABLED_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_TRANSQUANT_BYPASS_ENABLED_FLAG_SET_BIT_EXT} indicates if enabling {@code transquant_bypass_enabled_flag} in {@code StdVideoH265PpsFlags} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_CONSTRAINED_INTRA_PRED_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_CONSTRAINED_INTRA_PRED_FLAG_SET_BIT_EXT} indicates if enabling {@code constrained_intra_pred_flag} in {@code StdVideoH265PpsFlags} is supported.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_STD_ENTROPY_CODING_SYNC_ENABLED_FLAG_SET_BIT_EXT VIDEO_ENCODE_H265_STD_ENTROPY_CODING_SYNC_ENABLED_FLAG_SET_BIT_EXT} indicates if enabling {@code entropy_coding_sync_enabled_flag} in {@code StdVideoH265PpsFlags} is supported.</li>
     ...
     * 
     * <ul>
     * <li>{@link #VK_VIDEO_ENCODE_H265_RATE_CONTROL_ATTEMPT_HRD_COMPLIANCE_BIT_EXT VIDEO_ENCODE_H265_RATE_CONTROL_ATTEMPT_HRD_COMPLIANCE_BIT_EXT} specifies that rate control <b>should</b> attempt to produce an HRD compliant bitstream.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_RATE_CONTROL_REGULAR_GOP_BIT_EXT VIDEO_ENCODE_H265_RATE_CONTROL_REGULAR_GOP_BIT_EXT} specifies that the application intends to use a regular GOP structure according to the parameters specified in the {@code gopFrameCount}, {@code idrPeriod}, and {@code consecutiveBFrameCount} members of the {@link VkVideoEncodeH265RateControlInfoEXT} structure.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_RATE_CONTROL_REFERENCE_PATTERN_FLAT_BIT_EXT VIDEO_ENCODE_H265_RATE_CONTROL_REFERENCE_PATTERN_FLAT_BIT_EXT} specifies that the application intends to follow a flat reference pattern.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_RATE_CONTROL_REFERENCE_PATTERN_DYADIC_BIT_EXT VIDEO_ENCODE_H265_RATE_CONTROL_REFERENCE_PATTERN_DYADIC_BIT_EXT} specifies that the application intends to follow a dyadic reference pattern.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H265_RATE_CONTROL_TEMPORAL_SUB_LAYER_PATTERN_DYADIC_BIT_EXT VIDEO_ENCODE_H265_RATE_CONTROL_TEMPORAL_SUB_LAYER_PATTERN_DYADIC_BIT_EXT} specifies that the application intends to follow a dyadic temporal sub-layer pattern.</li>
     * </ul>
     */
    public static final int
