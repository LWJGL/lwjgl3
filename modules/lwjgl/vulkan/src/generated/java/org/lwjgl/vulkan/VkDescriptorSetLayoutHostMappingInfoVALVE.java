 ...
 * }</code></pre>
 */
public class VkDescriptorSetLayoutHostMappingInfoVALVE extends Struct implements NativeResource {
    ...
    public static VkDescriptorSetLayoutHostMappingInfoVALVE malloc() {
        return wrap(VkDescriptorSetLayoutHostMappingInfoVALVE.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkDescriptorSetLayoutHostMappingInfoVALVE calloc() {
        return wrap(VkDescriptorSetLayoutHostMappingInfoVALVE.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkDescriptorSetLayoutHostMappingInfoVALVE create() {
        ...
        return wrap(VkDescriptorSetLayoutHostMappingInfoVALVE.class, memAddress(container), container);
    }
    ...
    public static VkDescriptorSetLayoutHostMappingInfoVALVE create(long address) {
        return wrap(VkDescriptorSetLayoutHostMappingInfoVALVE.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkDescriptorSetLayoutHostMappingInfoVALVE createSafe(long address) {
        return address == NULL ? null : wrap(VkDescriptorSetLayoutHostMappingInfoVALVE.class, address);
    }
    ...
    public static VkDescriptorSetLayoutHostMappingInfoVALVE malloc(MemoryStack stack) {
        return wrap(VkDescriptorSetLayoutHostMappingInfoVALVE.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkDescriptorSetLayoutHostMappingInfoVALVE calloc(MemoryStack stack) {
        return wrap(VkDescriptorSetLayoutHostMappingInfoVALVE.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkDescriptorSetLayoutHostMappingInfoVALVE, Buffer> implements NativeResource {
         ...
         * by {@link VkDescriptorSetLayoutHostMappingInfoVALVE#SIZEOF}, and its mark will be undefined.
         *
