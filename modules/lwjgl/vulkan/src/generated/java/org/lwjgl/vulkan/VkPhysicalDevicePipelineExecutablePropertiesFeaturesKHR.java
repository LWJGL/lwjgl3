...
public class VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code pipelineExecutableInfo} field. */
    @NativeType("VkBool32")
    ...
    /** Returns a new {@code VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR callocStack() {
     ...
     */
    public static VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.Buffer callocStack(int capacity, MemoryStack stack) {
