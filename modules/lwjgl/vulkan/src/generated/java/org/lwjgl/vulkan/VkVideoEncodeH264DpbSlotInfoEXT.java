...
public class VkVideoEncodeH264DpbSlotInfoEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkVideoEncodeH264DpbSlotInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoEncodeH264DpbSlotInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoEncodeH264DpbSlotInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoEncodeH264DpbSlotInfoEXT callocStack() {
     ...
     */
    public static VkVideoEncodeH264DpbSlotInfoEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoEncodeH264DpbSlotInfoEXT callocStack(MemoryStack stack) {
        return wrap(VkVideoEncodeH264DpbSlotInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoEncodeH264DpbSlotInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264DpbSlotInfoEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoEncodeH264DpbSlotInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264DpbSlotInfoEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264DpbSlotInfoEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264DpbSlotInfoEXT.Buffer callocStack(int capacity, MemoryStack stack) {
