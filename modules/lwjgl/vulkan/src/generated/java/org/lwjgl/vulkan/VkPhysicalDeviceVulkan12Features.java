 ...
 * 
 * <ul>
 * <li>{@code samplerMirrorClampToEdge} &ndash; indicates whether the implementation supports the {@link VK12#VK_SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE} sampler address mode. If this feature is not enabled, the {@link VK12#VK_SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE} sampler address mode <b>must</b> not be used.</li>
 * <li>{@code drawIndirectCount} &ndash; indicates whether the implementation supports the {@link VK12#vkCmdDrawIndirectCount CmdDrawIndirectCount} and {@link VK12#vkCmdDrawIndexedIndirectCount CmdDrawIndexedIndirectCount} functions. If this feature is not enabled, these functions <b>must</b> not be used.</li>
 * <li>{@code storageBuffer8BitAccess} &ndash; indicates whether objects in the {@code StorageBuffer}, {@code ShaderRecordBufferKHR}, or {@code PhysicalStorageBuffer} storage class with the {@code Block} decoration <b>can</b> have 8-bit integer members. If this feature is not enabled, 8-bit integer members <b>must</b> not be used in such objects. This also indicates whether shader modules <b>can</b> declare the {@code StorageBuffer8BitAccess} capability.</li>
 * <li>{@code uniformAndStorageBuffer8BitAccess} &ndash; indicates whether objects in the {@code Uniform} storage class with the {@code Block} decoration <b>can</b> have 8-bit integer members. If this feature is not enabled, 8-bit integer members <b>must</b> not be used in such objects. This also indicates whether shader modules <b>can</b> declare the {@code UniformAndStorageBuffer8BitAccess} capability.</li>
 ...
 * <li>{@code shaderFloat16} &ndash; indicates whether 16-bit floats (halfs) are supported in shader code. This also indicates whether shader modules <b>can</b> declare the {@code Float16} capability. However, this only enables a subset of the storage classes that SPIR-V allows for the {@code Float16} SPIR-V capability: Declaring and using 16-bit floats in the {@code Private}, {@code Workgroup} (for non-Block variables), and {@code Function} storage classes is enabled, while declaring them in the interface storage classes (e.g., {@code UniformConstant}, {@code Uniform}, {@code StorageBuffer}, {@code Input}, {@code Output}, and {@code PushConstant}) is not enabled.</li>
 * <li>{@code shaderInt8} &ndash; indicates whether 8-bit integers (signed and unsigned) are supported in shader code. This also indicates whether shader modules <b>can</b> declare the {@code Int8} capability. However, this only enables a subset of the storage classes that SPIR-V allows for the {@code Int8} SPIR-V capability: Declaring and using 8-bit integers in the {@code Private}, {@code Workgroup} (for non-Block variables), and {@code Function} storage classes is enabled, while declaring them in the interface storage classes (e.g., {@code UniformConstant}, {@code Uniform}, {@code StorageBuffer}, {@code Input}, {@code Output}, and {@code PushConstant}) is not enabled.</li>
 * <li>{@code descriptorIndexing} &ndash; indicates whether the implementation supports the minimum set of descriptor indexing features as described in the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-requirements">Feature Requirements</a> section. Enabling the {@code descriptorIndexing} member when {@link VK10#vkCreateDevice CreateDevice} is called does not imply the other minimum descriptor indexing features are also enabled. Those other descriptor indexing features <b>must</b> be enabled individually as needed by the application.</li>
 ...
 * <li>{@code samplerFilterMinmax} &ndash; indicates whether the implementation supports a minimum set of required formats supporting min/max filtering as defined by the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#limits-filterMinmaxSingleComponentFormats-minimum-requirements">{@code filterMinmaxSingleComponentFormats}</a> property minimum requirements. If this feature is not enabled, then no {@link VkSamplerCreateInfo} {@code pNext} chain can include a {@link VkSamplerReductionModeCreateInfo} structure.</li>
 ...
 * <li>{@code shaderSubgroupExtendedTypes} &ndash; a boolean that specifies whether subgroup operations can use 8-bit integer, 16-bit integer, 64-bit integer, 16-bit floating-point, and vectors of these types in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#shaders-group-operations">group operations</a> with <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#shaders-scope-subgroup">subgroup scope</a>if the implementation supports the types.</li>
 ...
 * <li>{@code timelineSemaphore} &ndash; indicates whether semaphores created with a {@code VkSemaphoreType} of {@link VK12#VK_SEMAPHORE_TYPE_TIMELINE SEMAPHORE_TYPE_TIMELINE} are supported.</li>
 ...
 * <li>{@code shaderOutputViewportIndex} &ndash; indicates whether the implementation supports the {@code ShaderViewportIndex} SPIR-V capability enabling variables decorated with the {@code ViewportIndex} built-in to be exported from vertex or tessellation evaluation shaders. If this feature is not enabled, the {@code ViewportIndex} built-in decoration <b>must</b> not be used on outputs in vertex or tessellation evaluation shaders.</li>
 * <li>{@code shaderOutputLayer} &ndash; indicates whether the implementation supports the {@code ShaderLayer} SPIR-V capability enabling variables decorated with the {@code Layer} built-in to be exported from vertex or tessellation evaluation shaders. If this feature is not enabled, the {@code Layer} built-in decoration <b>must</b> not be used on outputs in vertex or tessellation evaluation shaders.</li>
 * <li>{@code subgroupBroadcastDynamicId} &ndash; if {@link VK10#VK_TRUE TRUE}, the “Id” operand of {@code OpGroupNonUniformBroadcast} <b>can</b> be dynamically uniform within a subgroup, and the “Index” operand of {@code OpGroupNonUniformQuadBroadcast} <b>can</b> be dynamically uniform within the derivative group. If it is {@link VK10#VK_FALSE FALSE}, these operands <b>must</b> be constants.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkPhysicalDeviceVulkan12Features extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code samplerMirrorClampToEdge} field. */
    @NativeType("VkBool32")
    public boolean samplerMirrorClampToEdge() { return nsamplerMirrorClampToEdge(address()) != 0; }
    /** Returns the value of the {@code drawIndirectCount} field. */
    @NativeType("VkBool32")
    ...
    /** Returns the value of the {@code descriptorIndexing} field. */
    @NativeType("VkBool32")
    ...
    /** Returns the value of the {@code samplerFilterMinmax} field. */
    @NativeType("VkBool32")
    ...
    /** Returns the value of the {@code shaderOutputViewportIndex} field. */
    @NativeType("VkBool32")
    public boolean shaderOutputViewportIndex() { return nshaderOutputViewportIndex(address()) != 0; }
    /** Returns the value of the {@code shaderOutputLayer} field. */
    @NativeType("VkBool32")
    public boolean shaderOutputLayer() { return nshaderOutputLayer(address()) != 0; }
    /** Returns the value of the {@code subgroupBroadcastDynamicId} field. */
    @NativeType("VkBool32")
    ...
    /** Returns a new {@code VkPhysicalDeviceVulkan12Features} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceVulkan12Features mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceVulkan12Features} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDeviceVulkan12Features callocStack() {
     ...
     */
    public static VkPhysicalDeviceVulkan12Features mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceVulkan12Features callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceVulkan12Features.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceVulkan12Features.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceVulkan12Features.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceVulkan12Features.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceVulkan12Features.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceVulkan12Features.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceVulkan12Features.Buffer callocStack(int capacity, MemoryStack stack) {
