...
public class VkPhysicalDeviceImageDrmFormatModifierInfoEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPhysicalDeviceImageDrmFormatModifierInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceImageDrmFormatModifierInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceImageDrmFormatModifierInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
