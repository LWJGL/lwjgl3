...
public class VkPhysicalDeviceImageDrmFormatModifierInfoEXT extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    ...
    /** Returns a new {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    ...
    /** Returns a new {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT} instance for the specified memory address. */
    ...
    /** Returns a new {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceImageDrmFormatModifierInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDeviceImageDrmFormatModifierInfoEXT callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceImageDrmFormatModifierInfoEXT mallocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceImageDrmFormatModifierInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceImageDrmFormatModifierInfoEXT callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceImageDrmFormatModifierInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceImageDrmFormatModifierInfoEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceImageDrmFormatModifierInfoEXT.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceImageDrmFormatModifierInfoEXT, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT.Buffer} instance backed by the specified container.
         *
