 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceRobustness2PropertiesEXT} structure is included in the {@code pNext} chain of {@link VkPhysicalDeviceProperties2}, it is filled with the implementation-dependent limits.</p>
 * 
 ...
 * <li>{@code robustStorageBufferAccessSizeAlignment} &ndash; the number of bytes that the range of a storage buffer descriptor is rounded up to when used for bounds-checking when <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-robustBufferAccess2">{@code robustBufferAccess2}</a> is enabled. This value is either 1 or 4.</li>
 * <li>{@code robustUniformBufferAccessSizeAlignment} &ndash; the number of bytes that the range of a uniform buffer descriptor is rounded up to when used for bounds-checking when <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-robustBufferAccess2">{@code robustBufferAccess2}</a> is enabled. This value is a power of two in the range [1, 256].</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkPhysicalDeviceRobustness2PropertiesEXT extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code robustStorageBufferAccessSizeAlignment} field. */
    @NativeType("VkDeviceSize")
    public long robustStorageBufferAccessSizeAlignment() { return nrobustStorageBufferAccessSizeAlignment(address()); }
    /** Returns the value of the {@code robustUniformBufferAccessSizeAlignment} field. */
    @NativeType("VkDeviceSize")
    ...
    /** Returns a new {@code VkPhysicalDeviceRobustness2PropertiesEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceRobustness2PropertiesEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceRobustness2PropertiesEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDeviceRobustness2PropertiesEXT callocStack() {
     ...
     */
    public static VkPhysicalDeviceRobustness2PropertiesEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceRobustness2PropertiesEXT callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceRobustness2PropertiesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceRobustness2PropertiesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceRobustness2PropertiesEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceRobustness2PropertiesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceRobustness2PropertiesEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceRobustness2PropertiesEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceRobustness2PropertiesEXT.Buffer callocStack(int capacity, MemoryStack stack) {
