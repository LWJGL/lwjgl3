...
public class VkPhysicalDeviceSubpassShadingFeaturesHUAWEI extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPhysicalDeviceSubpassShadingFeaturesHUAWEI} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceSubpassShadingFeaturesHUAWEI mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceSubpassShadingFeaturesHUAWEI} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDeviceSubpassShadingFeaturesHUAWEI callocStack() {
     ...
     */
    public static VkPhysicalDeviceSubpassShadingFeaturesHUAWEI mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceSubpassShadingFeaturesHUAWEI callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceSubpassShadingFeaturesHUAWEI.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceSubpassShadingFeaturesHUAWEI.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceSubpassShadingFeaturesHUAWEI.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceSubpassShadingFeaturesHUAWEI.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceSubpassShadingFeaturesHUAWEI.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceSubpassShadingFeaturesHUAWEI.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceSubpassShadingFeaturesHUAWEI.Buffer callocStack(int capacity, MemoryStack stack) {
