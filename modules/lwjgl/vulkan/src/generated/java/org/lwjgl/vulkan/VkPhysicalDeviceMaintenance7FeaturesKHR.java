 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceMaintenance7FeaturesKHR} structure is included in the {@code pNext} chain of the {@link VkPhysicalDeviceFeatures2} structure passed to {@link VK11#vkGetPhysicalDeviceFeatures2 GetPhysicalDeviceFeatures2}, it is filled in to indicate whether each corresponding feature is supported. {@link VkPhysicalDeviceMaintenance7FeaturesKHR} <b>can</b> also be used in the {@code pNext} chain of {@link VkDeviceCreateInfo} to selectively enable these features.</p>
 * 
 * <h5>Valid Usage (Implicit)</h5>
 * 
 * <ul>
 * <li>{@code sType} <b>must</b> be {@link KHRMaintenance7#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_7_FEATURES_KHR STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_7_FEATURES_KHR}</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkPhysicalDeviceMaintenance7FeaturesKHR extends Struct<VkPhysicalDeviceMaintenance7FeaturesKHR> implements NativeResource {
     ...
     * 
     * <ul>
     * <li>The {@link KHRMaintenance7#VK_RENDERING_CONTENTS_INLINE_BIT_KHR RENDERING_CONTENTS_INLINE_BIT_KHR} and {@link KHRMaintenance7#VK_SUBPASS_CONTENTS_INLINE_AND_SECONDARY_COMMAND_BUFFERS_KHR SUBPASS_CONTENTS_INLINE_AND_SECONDARY_COMMAND_BUFFERS_KHR} flags <b>can</b> be used to record commands in render pass instances both inline and in secondary command buffers executed with {@link VK10#vkCmdExecuteCommands CmdExecuteCommands} for dynamic rendering and legacy render passes respectively.</li>
     * <li>Querying information regarding the underlying devices in environments where the Vulkan implementation is provided through layered implementations. This is done by chaining {@link VkPhysicalDeviceLayeredApiPropertiesListKHR} to {@link VkPhysicalDeviceProperties2}.</li>
    ...
    /** Sets the {@link KHRMaintenance7#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_7_FEATURES_KHR STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_7_FEATURES_KHR} value to the {@link #sType} field. */
    ...
    /** Sets the specified value to the {@link #maintenance7} field. */
    ...
    @Nullable
    public static VkPhysicalDeviceMaintenance7FeaturesKHR createSafe(long address) {
    ...
    @Nullable
    public static VkPhysicalDeviceMaintenance7FeaturesKHR.Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceMaintenance7FeaturesKHR, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@link VkPhysicalDeviceMaintenance7FeaturesKHR#sType} field. */
        @NativeType("VkStructureType")
        public int sType() { return VkPhysicalDeviceMaintenance7FeaturesKHR.nsType(address()); }
        /** @return the value of the {@link VkPhysicalDeviceMaintenance7FeaturesKHR#pNext} field. */
        @NativeType("void *")
        public long pNext() { return VkPhysicalDeviceMaintenance7FeaturesKHR.npNext(address()); }
        /** @return the value of the {@link VkPhysicalDeviceMaintenance7FeaturesKHR#maintenance7} field. */
        @NativeType("VkBool32")
        public boolean maintenance7() { return VkPhysicalDeviceMaintenance7FeaturesKHR.nmaintenance7(address()) != 0; }

        /** Sets the specified value to the {@link VkPhysicalDeviceMaintenance7FeaturesKHR#sType} field. */
        ...
        /** Sets the {@link KHRMaintenance7#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_7_FEATURES_KHR STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_7_FEATURES_KHR} value to the {@link VkPhysicalDeviceMaintenance7FeaturesKHR#sType} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceMaintenance7FeaturesKHR#pNext} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceMaintenance7FeaturesKHR#maintenance7} field. */
