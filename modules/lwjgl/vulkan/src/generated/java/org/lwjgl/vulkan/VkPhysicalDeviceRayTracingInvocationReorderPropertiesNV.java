 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV malloc() {
        return wrap(VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV calloc() {
        return wrap(VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV create() {
        ...
        return wrap(VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV create(long address) {
        return wrap(VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV.class, address);
    }
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV#SIZEOF}, and its mark will be undefined.
         *
