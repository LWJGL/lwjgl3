 ...
 * }</code></pre>
 */
public class VkBufferCaptureDescriptorDataInfoEXT extends Struct implements NativeResource {
    ...
    public static VkBufferCaptureDescriptorDataInfoEXT malloc() {
        return wrap(VkBufferCaptureDescriptorDataInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkBufferCaptureDescriptorDataInfoEXT calloc() {
        return wrap(VkBufferCaptureDescriptorDataInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkBufferCaptureDescriptorDataInfoEXT create() {
        ...
        return wrap(VkBufferCaptureDescriptorDataInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkBufferCaptureDescriptorDataInfoEXT create(long address) {
        return wrap(VkBufferCaptureDescriptorDataInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkBufferCaptureDescriptorDataInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkBufferCaptureDescriptorDataInfoEXT.class, address);
    }
    ...
    public static VkBufferCaptureDescriptorDataInfoEXT malloc(MemoryStack stack) {
        return wrap(VkBufferCaptureDescriptorDataInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkBufferCaptureDescriptorDataInfoEXT calloc(MemoryStack stack) {
        return wrap(VkBufferCaptureDescriptorDataInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkBufferCaptureDescriptorDataInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkBufferCaptureDescriptorDataInfoEXT#SIZEOF}, and its mark will be undefined.
         *
