...
public class VK13 extends VK12 {
     ...
     * <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
     * 
     * <p>Unlike the static state to set the same, {@code pStrides} must be between 0 and the maximum extent of the attributes in the binding. {@link EXTVertexInputDynamicState#vkCmdSetVertexInputEXT CmdSetVertexInputEXT} does not have this restriction so can be used if other stride values are desired.</p>
     * </div>
     * 
     * <h5>Valid Usage</h5>
     * 
