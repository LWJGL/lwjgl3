 ...
 * }</code></pre>
 */
public class VkOpticalFlowExecuteInfoNV extends Struct implements NativeResource {
    ...
    public static VkOpticalFlowExecuteInfoNV malloc() {
        return wrap(VkOpticalFlowExecuteInfoNV.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkOpticalFlowExecuteInfoNV calloc() {
        return wrap(VkOpticalFlowExecuteInfoNV.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkOpticalFlowExecuteInfoNV create() {
        ...
        return wrap(VkOpticalFlowExecuteInfoNV.class, memAddress(container), container);
    }
    ...
    public static VkOpticalFlowExecuteInfoNV create(long address) {
        return wrap(VkOpticalFlowExecuteInfoNV.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkOpticalFlowExecuteInfoNV createSafe(long address) {
        return address == NULL ? null : wrap(VkOpticalFlowExecuteInfoNV.class, address);
    }
    ...
    public static VkOpticalFlowExecuteInfoNV malloc(MemoryStack stack) {
        return wrap(VkOpticalFlowExecuteInfoNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkOpticalFlowExecuteInfoNV calloc(MemoryStack stack) {
        return wrap(VkOpticalFlowExecuteInfoNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkOpticalFlowExecuteInfoNV, Buffer> implements NativeResource {
         ...
         * by {@link VkOpticalFlowExecuteInfoNV#SIZEOF}, and its mark will be undefined.
         *
