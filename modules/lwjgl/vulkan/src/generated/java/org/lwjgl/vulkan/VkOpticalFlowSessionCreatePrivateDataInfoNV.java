 ...
 * }</code></pre>
 */
public class VkOpticalFlowSessionCreatePrivateDataInfoNV extends Struct implements NativeResource {
    ...
    public static VkOpticalFlowSessionCreatePrivateDataInfoNV malloc() {
        return wrap(VkOpticalFlowSessionCreatePrivateDataInfoNV.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkOpticalFlowSessionCreatePrivateDataInfoNV calloc() {
        return wrap(VkOpticalFlowSessionCreatePrivateDataInfoNV.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkOpticalFlowSessionCreatePrivateDataInfoNV create() {
        ...
        return wrap(VkOpticalFlowSessionCreatePrivateDataInfoNV.class, memAddress(container), container);
    }
    ...
    public static VkOpticalFlowSessionCreatePrivateDataInfoNV create(long address) {
        return wrap(VkOpticalFlowSessionCreatePrivateDataInfoNV.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkOpticalFlowSessionCreatePrivateDataInfoNV createSafe(long address) {
        return address == NULL ? null : wrap(VkOpticalFlowSessionCreatePrivateDataInfoNV.class, address);
    }
    ...
    public static VkOpticalFlowSessionCreatePrivateDataInfoNV malloc(MemoryStack stack) {
        return wrap(VkOpticalFlowSessionCreatePrivateDataInfoNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkOpticalFlowSessionCreatePrivateDataInfoNV calloc(MemoryStack stack) {
        return wrap(VkOpticalFlowSessionCreatePrivateDataInfoNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkOpticalFlowSessionCreatePrivateDataInfoNV, Buffer> implements NativeResource {
         ...
         * by {@link VkOpticalFlowSessionCreatePrivateDataInfoNV#SIZEOF}, and its mark will be undefined.
         *
