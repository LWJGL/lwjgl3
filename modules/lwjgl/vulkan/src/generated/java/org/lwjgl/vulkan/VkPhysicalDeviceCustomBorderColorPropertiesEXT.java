 ...
 * 
 * <ul>
 * <li>{@code maxCustomBorderColorSamplers} &ndash; indicates the maximum number of samplers with custom border colors which <b>can</b> simultaneously exist on a device.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkPhysicalDeviceCustomBorderColorPropertiesEXT extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code maxCustomBorderColorSamplers} field. */
    @NativeType("uint32_t")
    ...
    /** Returns a new {@code VkPhysicalDeviceCustomBorderColorPropertiesEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceCustomBorderColorPropertiesEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceCustomBorderColorPropertiesEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDeviceCustomBorderColorPropertiesEXT callocStack() {
     ...
     */
    public static VkPhysicalDeviceCustomBorderColorPropertiesEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceCustomBorderColorPropertiesEXT callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceCustomBorderColorPropertiesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceCustomBorderColorPropertiesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceCustomBorderColorPropertiesEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceCustomBorderColorPropertiesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceCustomBorderColorPropertiesEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceCustomBorderColorPropertiesEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceCustomBorderColorPropertiesEXT.Buffer callocStack(int capacity, MemoryStack stack) {
