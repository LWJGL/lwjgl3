...
public class VkGeometryDataNV extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link VkGeometryDataNV} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link VkGeometryDataNV} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static VkGeometryDataNV malloc() {
        return wrap(VkGeometryDataNV.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link VkGeometryDataNV} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static VkGeometryDataNV calloc() {
        return wrap(VkGeometryDataNV.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link VkGeometryDataNV} instance allocated with {@link BufferUtils}. */
    public static VkGeometryDataNV create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(VkGeometryDataNV.class, memAddress(container), container);
    }

    /** Returns a new {@link VkGeometryDataNV} instance for the specified memory address. */
    ...
    /** Returns a new {@link VkGeometryDataNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkGeometryDataNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link VkGeometryDataNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkGeometryDataNV callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link VkGeometryDataNV} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link VkGeometryDataNV} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<VkGeometryDataNV, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link VkGeometryDataNV.Buffer} instance backed by the specified container.
         *
