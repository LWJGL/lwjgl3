 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceImageProcessingPropertiesQCOM extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceImageProcessingPropertiesQCOM malloc() {
        return wrap(VkPhysicalDeviceImageProcessingPropertiesQCOM.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceImageProcessingPropertiesQCOM calloc() {
        return wrap(VkPhysicalDeviceImageProcessingPropertiesQCOM.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceImageProcessingPropertiesQCOM create() {
        ...
        return wrap(VkPhysicalDeviceImageProcessingPropertiesQCOM.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceImageProcessingPropertiesQCOM create(long address) {
        return wrap(VkPhysicalDeviceImageProcessingPropertiesQCOM.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceImageProcessingPropertiesQCOM createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceImageProcessingPropertiesQCOM.class, address);
    }
    ...
    public static VkPhysicalDeviceImageProcessingPropertiesQCOM malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceImageProcessingPropertiesQCOM.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceImageProcessingPropertiesQCOM calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceImageProcessingPropertiesQCOM.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceImageProcessingPropertiesQCOM, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceImageProcessingPropertiesQCOM#SIZEOF}, and its mark will be undefined.
         *
