...
public class VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR callocStack() {
     ...
     */
    public static VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR.Buffer callocStack(int capacity, MemoryStack stack) {
