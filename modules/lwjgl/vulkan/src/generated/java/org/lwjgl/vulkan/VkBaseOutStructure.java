...
public class VkBaseOutStructure extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkBaseOutStructure} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkBaseOutStructure mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkBaseOutStructure} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
