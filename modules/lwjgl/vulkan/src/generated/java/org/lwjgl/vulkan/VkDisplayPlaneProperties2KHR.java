...
public class VkDisplayPlaneProperties2KHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkDisplayPlaneProperties2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkDisplayPlaneProperties2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkDisplayPlaneProperties2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
