 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR} structure is included in the {@code pNext} chain of the {@link VkPhysicalDeviceFeatures2} structure passed to {@link VK11#vkGetPhysicalDeviceFeatures2 GetPhysicalDeviceFeatures2}, it is filled in to indicate whether each corresponding feature is supported. {@link VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR} <b>can</b> also be used in the {@code pNext} chain of {@link VkDeviceCreateInfo} to selectively enable these features.</p>
 * 
 * <h5>Valid Usage (Implicit)</h5>
 * 
 * <ul>
 * <li>{@code sType} <b>must</b> be {@link KHRVertexAttributeDivisor#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_KHR STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_KHR}</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR extends Struct<VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR> implements NativeResource {
    ...
    /** Sets the {@link KHRVertexAttributeDivisor#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_KHR STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_KHR} value to the {@link #sType} field. */
    public VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR sType$Default() { return sType(KHRVertexAttributeDivisor.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_KHR); }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@link VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR#sType} field. */
        @NativeType("VkStructureType")
        public int sType() { return VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR.nsType(address()); }
        /** @return the value of the {@link VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR#pNext} field. */
        @NativeType("void *")
        public long pNext() { return VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR.npNext(address()); }
        /** @return the value of the {@link VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR#vertexAttributeInstanceRateDivisor} field. */
        @NativeType("VkBool32")
        public boolean vertexAttributeInstanceRateDivisor() { return VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR.nvertexAttributeInstanceRateDivisor(address()) != 0; }
        /** @return the value of the {@link VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR#vertexAttributeInstanceRateZeroDivisor} field. */
        @NativeType("VkBool32")
        public boolean vertexAttributeInstanceRateZeroDivisor() { return VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR.nvertexAttributeInstanceRateZeroDivisor(address()) != 0; }

        /** Sets the specified value to the {@link VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR#sType} field. */
        ...
        /** Sets the {@link KHRVertexAttributeDivisor#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_KHR STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_KHR} value to the {@link VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR#sType} field. */
        public VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR.Buffer sType$Default() { return sType(KHRVertexAttributeDivisor.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_KHR); }
        /** Sets the specified value to the {@link VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR#pNext} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR#vertexAttributeInstanceRateDivisor} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR#vertexAttributeInstanceRateZeroDivisor} field. */
