 ...
 * <li>This extension interacts with <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#versions-1.2">Vulkan 1.2</a> and {@link KHRVulkanMemoryModel VK_KHR_vulkan_memory_model}, adding the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#shader-call-related">shader-call-related</a> relation of invocations, <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#shader-call-order">shader-call-order</a> partial order of dynamic instances of instructions, and the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#shaders-scope-shadercall">{@code ShaderCallKHR}</a> scope.</li>
...
public class KHRRayTracingPipeline {
     ...
     * 
     * <ul>
     * <li>{@link #VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_KHR RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_KHR} specifies that a shader group with a single {@link #VK_SHADER_STAGE_RAYGEN_BIT_KHR SHADER_STAGE_RAYGEN_BIT_KHR}, {@link #VK_SHADER_STAGE_MISS_BIT_KHR SHADER_STAGE_MISS_BIT_KHR}, or {@link #VK_SHADER_STAGE_CALLABLE_BIT_KHR SHADER_STAGE_CALLABLE_BIT_KHR} shader in it.</li>
     * <li>{@link #VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_KHR RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_KHR} specifies that a shader group that only hits triangles and <b>must</b> not contain an intersection shader, only closest hit and any-hit shaders.</li>
     * <li>{@link #VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_KHR RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_KHR} specifies that a shader group that only intersects with custom geometry and <b>must</b> contain an intersection shader and <b>may</b> contain closest hit and any-hit shaders.</li>
     * </ul>
     * 
     ...
     * 
     * <ul>
     * <li>This command <b>must</b> not cause a shader call instruction to be executed from a shader invocation with a <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#ray-tracing-recursion-depth">recursion depth</a> greater than the value of {@code maxPipelineRayRecursionDepth} used to create the bound ray tracing pipeline</li>
     ...
     * <li>If the bound ray tracing pipeline was created with {@code flags} that included {@link #VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR}, {@code pHitShaderBindingTable}-&gt;deviceAddress <b>must</b> not be zero</li>
     * <li>If the bound ray tracing pipeline was created with {@code flags} that included {@link #VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR}, {@code pHitShaderBindingTable}-&gt;deviceAddress <b>must</b> not be zero</li>
     * <li>If the bound ray tracing pipeline was created with {@code flags} that included {@link #VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR PIPELINE_CREATE_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR}, the shader group handle identified by {@code pMissShaderBindingTable}-&gt;deviceAddress <b>must</b> not be zero</li>
     * <li>If the bound ray tracing pipeline was created with {@code flags} that included {@link #VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR PIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR}, entries in the table identified by {@code pHitShaderBindingTable}-&gt;deviceAddress accessed as a result of this command in order to execute an any-hit shader <b>must</b> not be zero</li>
     * <li>If the bound ray tracing pipeline was created with {@code flags} that included {@link #VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR}, entries in the table identified by {@code pHitShaderBindingTable}-&gt;deviceAddress accessed as a result of this command in order to execute a closest hit shader <b>must</b> not be zero</li>
     * <li>If the bound ray tracing pipeline was created with {@code flags} that included {@link #VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR}, entries in the table identified by {@code pHitShaderBindingTable}-&gt;deviceAddress accessed as a result of this command in order to execute an intersection shader <b>must</b> not be zero</li>
     ...
     * <li>The <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#features-rayTracingPipeline">{@code rayTracingPipeline}</a> feature <b>must</b> be enabled</li>
     ...
     * @param deferredOperation {@link VK10#VK_NULL_HANDLE NULL_HANDLE} or the handle of a valid {@code VkDeferredOperationKHR} <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#deferred-host-operations-requesting">request deferral</a> object for this command.
     ...
     * <li>The <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#features-rayTracingPipelineTraceRaysIndirect">{@code rayTracingPipelineTraceRaysIndirect}</a> feature <b>must</b> be enabled</li>
     ...
     * <h5>C Specification</h5>
     * 
     * <p>To <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#pipelines-dynamic-state">dynamically set</a> the stack size for a ray tracing pipeline, call:</p>
     * 
     * <pre><code>
