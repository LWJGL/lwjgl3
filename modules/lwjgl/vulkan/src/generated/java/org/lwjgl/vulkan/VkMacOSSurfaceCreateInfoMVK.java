 ...
 * <li>{@code pView} &ndash; a reference to either a {@code CAMetalLayer} object or an {@code NSView} object.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkMacOSSurfaceCreateInfoMVK extends Struct implements NativeResource {
     ...
     * @param capacity the buffer capacity
     */
    public static VkMacOSSurfaceCreateInfoMVK.Buffer mallocStack(int capacity) {
