 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR} structure is included in the {@code pNext} chain of the {@link VkPhysicalDeviceFeatures2} structure passed to {@link VK11#vkGetPhysicalDeviceFeatures2 GetPhysicalDeviceFeatures2}, it is filled in to indicate whether each corresponding feature is supported. {@link VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR} <b>can</b> also be used in the {@code pNext} chain of {@link VkDeviceCreateInfo} to selectively enable these features.</p>
 * 
 * <h5>Valid Usage (Implicit)</h5>
 * 
 * <ul>
 * <li>{@code sType} <b>must</b> be {@link KHRDynamicRenderingLocalRead#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES_KHR STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES_KHR}</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR extends Struct<VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR> implements NativeResource {
    ...
    /** Sets the {@link KHRDynamicRenderingLocalRead#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES_KHR STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES_KHR} value to the {@link #sType} field. */
    public VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR sType$Default() { return sType(KHRDynamicRenderingLocalRead.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES_KHR); }
    ...
    @Nullable
    public static VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR createSafe(long address) {
    ...
    @Nullable
    public static VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR.Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@link VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR#sType} field. */
        @NativeType("VkStructureType")
        public int sType() { return VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR.nsType(address()); }
        /** @return the value of the {@link VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR#pNext} field. */
        @NativeType("void *")
        public long pNext() { return VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR.npNext(address()); }
        /** @return the value of the {@link VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR#dynamicRenderingLocalRead} field. */
        @NativeType("VkBool32")
        public boolean dynamicRenderingLocalRead() { return VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR.ndynamicRenderingLocalRead(address()) != 0; }

        /** Sets the specified value to the {@link VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR#sType} field. */
        ...
        /** Sets the {@link KHRDynamicRenderingLocalRead#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES_KHR STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES_KHR} value to the {@link VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR#sType} field. */
        public VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR.Buffer sType$Default() { return sType(KHRDynamicRenderingLocalRead.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES_KHR); }
        /** Sets the specified value to the {@link VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR#pNext} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR#dynamicRenderingLocalRead} field. */
