...
public class StdVideoH265VideoParameterSet extends Struct implements NativeResource {
    ...
    static {
        ...
        HRD_PARAMETERS = layout.offsetof(6);
    ...
    public StdVideoH265VideoParameterSet hrd_parameters(@NativeType("StdVideoH265HrdParameters *") StdVideoH265HrdParameters value) { nhrd_parameters(address(), value); return this; }
    ...
    /** Returns a new {@code StdVideoH265VideoParameterSet} instance allocated on the thread-local {@link MemoryStack}. */
    public static StdVideoH265VideoParameterSet mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code StdVideoH265VideoParameterSet} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static StdVideoH265VideoParameterSet callocStack() {
     ...
     */
    public static StdVideoH265VideoParameterSet mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static StdVideoH265VideoParameterSet callocStack(MemoryStack stack) {
        return wrap(StdVideoH265VideoParameterSet.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link StdVideoH265VideoParameterSet.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoH265VideoParameterSet.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link StdVideoH265VideoParameterSet.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoH265VideoParameterSet.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoH265VideoParameterSet.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoH265VideoParameterSet.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static StdVideoH265HrdParameters nhrd_parameters(long struct) { return StdVideoH265HrdParameters.create(memGetAddress(struct + StdVideoH265VideoParameterSet.HRD_PARAMETERS)); }
    ...
    public static void nhrd_parameters(long struct, StdVideoH265HrdParameters value) { memPutAddress(struct + StdVideoH265VideoParameterSet.HRD_PARAMETERS, value.address()); }
    ...
    public static void validate(long struct) {
        ...
        long hrd_parameters = memGetAddress(struct + StdVideoH265VideoParameterSet.HRD_PARAMETERS);
    ...
    public static class Buffer extends StructBuffer<StdVideoH265VideoParameterSet, Buffer> implements NativeResource {
        ...
        /** @return a {@link StdVideoH265HrdParameters} view of the struct pointed to by the {@code hrd_parameters} field. */
        @NativeType("StdVideoH265HrdParameters *")
        public StdVideoH265HrdParameters hrd_parameters() { return StdVideoH265VideoParameterSet.nhrd_parameters(address()); }
        /** @return a {@link StdVideoH265VpsFlags} view of the {@code flags} field. */
        ...
        /** Sets the address of the specified {@link StdVideoH265HrdParameters} to the {@code hrd_parameters} field. */
        public StdVideoH265VideoParameterSet.Buffer hrd_parameters(@NativeType("StdVideoH265HrdParameters *") StdVideoH265HrdParameters value) { StdVideoH265VideoParameterSet.nhrd_parameters(address(), value); return this; }
        /** Copies the specified {@link StdVideoH265VpsFlags} to the {@code flags} field. */
