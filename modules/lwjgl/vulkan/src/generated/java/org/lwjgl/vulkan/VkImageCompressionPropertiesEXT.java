 ...
 * }</code></pre>
 */
public class VkImageCompressionPropertiesEXT extends Struct implements NativeResource {
    ...
    public static VkImageCompressionPropertiesEXT malloc() {
        return wrap(VkImageCompressionPropertiesEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkImageCompressionPropertiesEXT calloc() {
        return wrap(VkImageCompressionPropertiesEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkImageCompressionPropertiesEXT create() {
        ...
        return wrap(VkImageCompressionPropertiesEXT.class, memAddress(container), container);
    }
    ...
    public static VkImageCompressionPropertiesEXT create(long address) {
        return wrap(VkImageCompressionPropertiesEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkImageCompressionPropertiesEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkImageCompressionPropertiesEXT.class, address);
    }
    ...
    public static VkImageCompressionPropertiesEXT malloc(MemoryStack stack) {
        return wrap(VkImageCompressionPropertiesEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkImageCompressionPropertiesEXT calloc(MemoryStack stack) {
        return wrap(VkImageCompressionPropertiesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkImageCompressionPropertiesEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkImageCompressionPropertiesEXT#SIZEOF}, and its mark will be undefined.
         *
