 ...
 * }</code></pre>
 */
public class VkExportMetalCommandQueueInfoEXT extends Struct implements NativeResource {
    ...
    public static VkExportMetalCommandQueueInfoEXT malloc() {
        return wrap(VkExportMetalCommandQueueInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkExportMetalCommandQueueInfoEXT calloc() {
        return wrap(VkExportMetalCommandQueueInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkExportMetalCommandQueueInfoEXT create() {
        ...
        return wrap(VkExportMetalCommandQueueInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkExportMetalCommandQueueInfoEXT create(long address) {
        return wrap(VkExportMetalCommandQueueInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkExportMetalCommandQueueInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkExportMetalCommandQueueInfoEXT.class, address);
    }
    ...
    public static VkExportMetalCommandQueueInfoEXT malloc(MemoryStack stack) {
        return wrap(VkExportMetalCommandQueueInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkExportMetalCommandQueueInfoEXT calloc(MemoryStack stack) {
        return wrap(VkExportMetalCommandQueueInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkExportMetalCommandQueueInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkExportMetalCommandQueueInfoEXT#SIZEOF}, and its mark will be undefined.
         *
