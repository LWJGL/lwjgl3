 ...
 * }</code></pre>
 */
public class VkMicromapVersionInfoEXT extends Struct implements NativeResource {
    ...
    public static VkMicromapVersionInfoEXT malloc() {
        return wrap(VkMicromapVersionInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkMicromapVersionInfoEXT calloc() {
        return wrap(VkMicromapVersionInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkMicromapVersionInfoEXT create() {
        ...
        return wrap(VkMicromapVersionInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkMicromapVersionInfoEXT create(long address) {
        return wrap(VkMicromapVersionInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkMicromapVersionInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkMicromapVersionInfoEXT.class, address);
    }
    ...
    public static VkMicromapVersionInfoEXT malloc(MemoryStack stack) {
        return wrap(VkMicromapVersionInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkMicromapVersionInfoEXT calloc(MemoryStack stack) {
        return wrap(VkMicromapVersionInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkMicromapVersionInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkMicromapVersionInfoEXT#SIZEOF}, and its mark will be undefined.
         *
