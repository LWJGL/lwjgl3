 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceRawAccessChainsFeaturesNV} structure is included in the {@code pNext} chain of the {@link VkPhysicalDeviceFeatures2} structure passed to {@link VK11#vkGetPhysicalDeviceFeatures2 GetPhysicalDeviceFeatures2}, it is filled in to indicate whether each corresponding feature is supported. {@link VkPhysicalDeviceRawAccessChainsFeaturesNV} <b>can</b> also be used in the {@code pNext} chain of {@link VkDeviceCreateInfo} to selectively enable these features.</p>
 * 
 * <h5>Valid Usage (Implicit)</h5>
 * 
 * <ul>
 * <li>{@code sType} <b>must</b> be {@link NVRawAccessChains#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAW_ACCESS_CHAINS_FEATURES_NV STRUCTURE_TYPE_PHYSICAL_DEVICE_RAW_ACCESS_CHAINS_FEATURES_NV}</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
 ...
 *     void * {@link #pNext};
 *     VkBool32 {@link #shaderRawAccessChains};
 * }</code></pre>
 */
public class VkPhysicalDeviceRawAccessChainsFeaturesNV extends Struct<VkPhysicalDeviceRawAccessChainsFeaturesNV> implements NativeResource {
    ...
    /** specifies whether shader modules <b>can</b> declare the {@code RawAccessChainsNV} capability. */
    @NativeType("VkBool32")
    ...
    /** Sets the {@link NVRawAccessChains#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAW_ACCESS_CHAINS_FEATURES_NV STRUCTURE_TYPE_PHYSICAL_DEVICE_RAW_ACCESS_CHAINS_FEATURES_NV} value to the {@link #sType} field. */
    ...
    /** Sets the specified value to the {@link #shaderRawAccessChains} field. */
    ...
    @Nullable
    public static VkPhysicalDeviceRawAccessChainsFeaturesNV createSafe(long address) {
    ...
    @Nullable
    public static VkPhysicalDeviceRawAccessChainsFeaturesNV.Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceRawAccessChainsFeaturesNV, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@link VkPhysicalDeviceRawAccessChainsFeaturesNV#sType} field. */
        @NativeType("VkStructureType")
        public int sType() { return VkPhysicalDeviceRawAccessChainsFeaturesNV.nsType(address()); }
        /** @return the value of the {@link VkPhysicalDeviceRawAccessChainsFeaturesNV#pNext} field. */
        @NativeType("void *")
        public long pNext() { return VkPhysicalDeviceRawAccessChainsFeaturesNV.npNext(address()); }
        /** @return the value of the {@link VkPhysicalDeviceRawAccessChainsFeaturesNV#shaderRawAccessChains} field. */
        @NativeType("VkBool32")
        public boolean shaderRawAccessChains() { return VkPhysicalDeviceRawAccessChainsFeaturesNV.nshaderRawAccessChains(address()) != 0; }

        /** Sets the specified value to the {@link VkPhysicalDeviceRawAccessChainsFeaturesNV#sType} field. */
        ...
        /** Sets the {@link NVRawAccessChains#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAW_ACCESS_CHAINS_FEATURES_NV STRUCTURE_TYPE_PHYSICAL_DEVICE_RAW_ACCESS_CHAINS_FEATURES_NV} value to the {@link VkPhysicalDeviceRawAccessChainsFeaturesNV#sType} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceRawAccessChainsFeaturesNV#pNext} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceRawAccessChainsFeaturesNV#shaderRawAccessChains} field. */
