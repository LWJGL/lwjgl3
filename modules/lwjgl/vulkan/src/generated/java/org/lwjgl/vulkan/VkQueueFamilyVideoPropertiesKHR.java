 ...
 * }</code></pre>
 */
public class VkQueueFamilyVideoPropertiesKHR extends Struct implements NativeResource {
    ...
    public VkQueueFamilyVideoPropertiesKHR videoCodecOperations(@NativeType("VkVideoCodecOperationFlagsKHR") int value) { nvideoCodecOperations(address(), value); return this; }
    ...
    public static VkQueueFamilyVideoPropertiesKHR malloc() {
        return wrap(VkQueueFamilyVideoPropertiesKHR.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkQueueFamilyVideoPropertiesKHR calloc() {
        return wrap(VkQueueFamilyVideoPropertiesKHR.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkQueueFamilyVideoPropertiesKHR create() {
        ...
        return wrap(VkQueueFamilyVideoPropertiesKHR.class, memAddress(container), container);
    }
    ...
    public static VkQueueFamilyVideoPropertiesKHR create(long address) {
        return wrap(VkQueueFamilyVideoPropertiesKHR.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkQueueFamilyVideoPropertiesKHR createSafe(long address) {
        return address == NULL ? null : wrap(VkQueueFamilyVideoPropertiesKHR.class, address);
    }
    ...
    public static VkQueueFamilyVideoPropertiesKHR malloc(MemoryStack stack) {
        return wrap(VkQueueFamilyVideoPropertiesKHR.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkQueueFamilyVideoPropertiesKHR calloc(MemoryStack stack) {
        return wrap(VkQueueFamilyVideoPropertiesKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static void nvideoCodecOperations(long struct, int value) { UNSAFE.putInt(null, struct + VkQueueFamilyVideoPropertiesKHR.VIDEOCODECOPERATIONS, value); }
    ...
    public static class Buffer extends StructBuffer<VkQueueFamilyVideoPropertiesKHR, Buffer> implements NativeResource {
         ...
         * by {@link VkQueueFamilyVideoPropertiesKHR#SIZEOF}, and its mark will be undefined.
         *
        ...
        /** Sets the specified value to the {@link VkQueueFamilyVideoPropertiesKHR#videoCodecOperations} field. */
        public VkQueueFamilyVideoPropertiesKHR.Buffer videoCodecOperations(@NativeType("VkVideoCodecOperationFlagsKHR") int value) { VkQueueFamilyVideoPropertiesKHR.nvideoCodecOperations(address(), value); return this; }
