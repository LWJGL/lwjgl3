 ...
 * <li>{@code src} &ndash; the device or host address to memory containing the source data for the copy.</li>
...
public class VkCopyMemoryToAccelerationStructureInfoKHR extends Struct implements NativeResource {
    ...
    /** Returns a {@link VkDeviceOrHostAddressConstKHR} view of the {@code src} field. */
    ...
    /** Returns a new {@code VkCopyMemoryToAccelerationStructureInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkCopyMemoryToAccelerationStructureInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkCopyMemoryToAccelerationStructureInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkCopyMemoryToAccelerationStructureInfoKHR callocStack() {
     ...
     */
    public static VkCopyMemoryToAccelerationStructureInfoKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkCopyMemoryToAccelerationStructureInfoKHR callocStack(MemoryStack stack) {
        return wrap(VkCopyMemoryToAccelerationStructureInfoKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkCopyMemoryToAccelerationStructureInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkCopyMemoryToAccelerationStructureInfoKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkCopyMemoryToAccelerationStructureInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkCopyMemoryToAccelerationStructureInfoKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkCopyMemoryToAccelerationStructureInfoKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkCopyMemoryToAccelerationStructureInfoKHR.Buffer callocStack(int capacity, MemoryStack stack) {
