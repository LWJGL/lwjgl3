 ...
 * }</code></pre>
 */
public class VkVideoProfileListInfoKHR extends Struct implements NativeResource {
    ...
    public static VkVideoProfileListInfoKHR malloc() {
        return wrap(VkVideoProfileListInfoKHR.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkVideoProfileListInfoKHR calloc() {
        return wrap(VkVideoProfileListInfoKHR.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkVideoProfileListInfoKHR create() {
        ...
        return wrap(VkVideoProfileListInfoKHR.class, memAddress(container), container);
    }
    ...
    public static VkVideoProfileListInfoKHR create(long address) {
        return wrap(VkVideoProfileListInfoKHR.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkVideoProfileListInfoKHR createSafe(long address) {
        return address == NULL ? null : wrap(VkVideoProfileListInfoKHR.class, address);
    }
    ...
    public static VkVideoProfileListInfoKHR malloc(MemoryStack stack) {
        return wrap(VkVideoProfileListInfoKHR.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkVideoProfileListInfoKHR calloc(MemoryStack stack) {
        return wrap(VkVideoProfileListInfoKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkVideoProfileListInfoKHR, Buffer> implements NativeResource {
         ...
         * by {@link VkVideoProfileListInfoKHR#SIZEOF}, and its mark will be undefined.
         *
