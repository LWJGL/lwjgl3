...
public class VkBindVertexBufferIndirectCommandNV extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkBindVertexBufferIndirectCommandNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkBindVertexBufferIndirectCommandNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkBindVertexBufferIndirectCommandNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkBindVertexBufferIndirectCommandNV callocStack() {
     ...
     */
    public static VkBindVertexBufferIndirectCommandNV mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkBindVertexBufferIndirectCommandNV callocStack(MemoryStack stack) {
        return wrap(VkBindVertexBufferIndirectCommandNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkBindVertexBufferIndirectCommandNV.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkBindVertexBufferIndirectCommandNV.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkBindVertexBufferIndirectCommandNV.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkBindVertexBufferIndirectCommandNV.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkBindVertexBufferIndirectCommandNV.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkBindVertexBufferIndirectCommandNV.Buffer callocStack(int capacity, MemoryStack stack) {
