...
public class StdVideoDecodeH265PictureInfoFlags extends Struct<StdVideoDecodeH265PictureInfoFlags> implements NativeResource {
    ...
    public static @Nullable StdVideoDecodeH265PictureInfoFlags createSafe(long address) {
    ...
    public static StdVideoDecodeH265PictureInfoFlags.@Nullable Buffer createSafe(long address, int capacity) {
