...
public class VkFormatProperties2KHR extends VkFormatProperties2 {
    ...
    /** Returns a new {@code VkFormatProperties2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkFormatProperties2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkFormatProperties2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
