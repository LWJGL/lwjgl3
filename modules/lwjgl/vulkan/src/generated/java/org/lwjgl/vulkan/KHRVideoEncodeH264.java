...
public final class KHRVideoEncodeH264 {
     ...
     * <li>{@link #VK_VIDEO_ENCODE_H264_STD_SCALING_MATRIX_PRESENT_FLAG_SET_BIT_KHR VIDEO_ENCODE_H264_STD_SCALING_MATRIX_PRESENT_FLAG_SET_BIT_KHR} specifies whether the implementation supports using the application-provided values for {@code StdVideoH264SpsFlags}{@code ::seq_scaling_matrix_present_flag} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-h264-sps">SPS</a> and {@code StdVideoH264PpsFlags}{@code ::pic_scaling_matrix_present_flag} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-h264-pps">PPS</a> when any of those values are 1.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H264_STD_CHROMA_QP_INDEX_OFFSET_BIT_KHR VIDEO_ENCODE_H264_STD_CHROMA_QP_INDEX_OFFSET_BIT_KHR} specifies whether the implementation supports using the application-provided value for {@code StdVideoH264PictureParameterSet}{@code ::chroma_qp_index_offset} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-h264-pps">PPS</a> when that value is non-zero.</li>
     ...
     * <li>{@link #VK_VIDEO_ENCODE_H264_STD_PIC_INIT_QP_MINUS26_BIT_KHR VIDEO_ENCODE_H264_STD_PIC_INIT_QP_MINUS26_BIT_KHR} specifies whether the implementation supports using the application-provided value for {@code StdVideoH264PictureParameterSet}{@code ::pic_init_qp_minus26} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-h264-pps">PPS</a> when that value is non-zero.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H264_STD_WEIGHTED_PRED_FLAG_SET_BIT_KHR VIDEO_ENCODE_H264_STD_WEIGHTED_PRED_FLAG_SET_BIT_KHR} specifies whether the implementation supports using the application-provided value for {@code StdVideoH264PpsFlags}{@code ::weighted_pred_flag} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-h264-pps">PPS</a> when that value is 1.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H264_STD_WEIGHTED_BIPRED_IDC_EXPLICIT_BIT_KHR VIDEO_ENCODE_H264_STD_WEIGHTED_BIPRED_IDC_EXPLICIT_BIT_KHR} specifies whether the implementation supports using the application-provided value for {@code StdVideoH264PictureParameterSet}{@code ::weighted_bipred_idc} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-h264-pps">PPS</a> when that value is {@code STD_VIDEO_H264_WEIGHTED_BIPRED_IDC_EXPLICIT}.</li>
     ...
     * <li>{@link #VK_VIDEO_ENCODE_H264_STD_ENTROPY_CODING_MODE_FLAG_UNSET_BIT_KHR VIDEO_ENCODE_H264_STD_ENTROPY_CODING_MODE_FLAG_UNSET_BIT_KHR} specifies whether the implementation supports CAVLC entropy coding, as defined in section 9.2 of the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#itu-t-h264">ITU-T H.264 Specification</a>, and thus supports using the application-provided value for {@code StdVideoH264PpsFlags}{@code ::entropy_coding_mode_flag} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-h264-pps">PPS</a> when that value is 0.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H264_STD_ENTROPY_CODING_MODE_FLAG_SET_BIT_KHR VIDEO_ENCODE_H264_STD_ENTROPY_CODING_MODE_FLAG_SET_BIT_KHR} specifies whether the implementation supports CABAC entropy coding, as defined in section 9.3 of the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#itu-t-h264">ITU-T H.264 Specification</a>, and thus supports using the application-provided value for {@code StdVideoH264PpsFlags}{@code ::entropy_coding_mode_flag} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-h264-pps">PPS</a> when that value is 1.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H264_STD_DIRECT_8X8_INFERENCE_FLAG_UNSET_BIT_KHR VIDEO_ENCODE_H264_STD_DIRECT_8X8_INFERENCE_FLAG_UNSET_BIT_KHR} specifies whether the implementation supports using the application-provided value for {@code StdVideoH264SpsFlags}{@code ::direct_8x8_inference_flag} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-h264-sps">SPS</a> when that value is 0.</li>
     ...
     * <li>{@link #VK_VIDEO_ENCODE_H264_STD_DEBLOCKING_FILTER_PARTIAL_BIT_KHR VIDEO_ENCODE_H264_STD_DEBLOCKING_FILTER_PARTIAL_BIT_KHR} specifies whether the implementation supports using the application-provided value for {@code StdVideoEncodeH264SliceHeader}{@code ::disable_deblocking_filter_idc} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-h264-slice-header-params">H.264 slice header parameters</a> when that value is {@code STD_VIDEO_H264_DISABLE_DEBLOCKING_FILTER_IDC_PARTIAL}.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H264_STD_SLICE_QP_DELTA_BIT_KHR VIDEO_ENCODE_H264_STD_SLICE_QP_DELTA_BIT_KHR} specifies whether the implementation supports using the application-provided value for {@code StdVideoEncodeH264SliceHeader}{@code ::slice_qp_delta} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-h264-slice-header-params">H.264 slice header parameters</a> when that value is identical across the slices of the encoded frame.</li>
     * <li>{@link #VK_VIDEO_ENCODE_H264_STD_DIFFERENT_SLICE_QP_DELTA_BIT_KHR VIDEO_ENCODE_H264_STD_DIFFERENT_SLICE_QP_DELTA_BIT_KHR} specifies whether the implementation supports using the application-provided value for {@code StdVideoEncodeH264SliceHeader}{@code ::slice_qp_delta} in the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-h264-slice-header-params">H.264 slice header parameters</a> when that value is different across the slices of the encoded frame.</li>
     * </ul>
     * 
