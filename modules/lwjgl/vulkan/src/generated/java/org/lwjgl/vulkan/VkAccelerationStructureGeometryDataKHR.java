 ...
 * 
 * <ul>
 * <li>{@code triangles} &ndash; a {@link VkAccelerationStructureGeometryTrianglesDataKHR} structure.</li>
 * <li>{@code aabbs} &ndash; a {@link VkAccelerationStructureGeometryAabbsDataKHR} struture.</li>
 * <li>{@code instances} &ndash; a {@link VkAccelerationStructureGeometryInstancesDataKHR} structure.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkAccelerationStructureGeometryDataKHR extends Struct implements NativeResource {
    ...
    /** Returns a {@link VkAccelerationStructureGeometryTrianglesDataKHR} view of the {@code triangles} field. */
    public VkAccelerationStructureGeometryTrianglesDataKHR triangles() { return ntriangles(address()); }
    /** Returns a {@link VkAccelerationStructureGeometryAabbsDataKHR} view of the {@code aabbs} field. */
    public VkAccelerationStructureGeometryAabbsDataKHR aabbs() { return naabbs(address()); }
    /** Returns a {@link VkAccelerationStructureGeometryInstancesDataKHR} view of the {@code instances} field. */
    ...
    /** Returns a new {@code VkAccelerationStructureGeometryDataKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkAccelerationStructureGeometryDataKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkAccelerationStructureGeometryDataKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkAccelerationStructureGeometryDataKHR callocStack() {
     ...
     */
    public static VkAccelerationStructureGeometryDataKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkAccelerationStructureGeometryDataKHR callocStack(MemoryStack stack) {
        return wrap(VkAccelerationStructureGeometryDataKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkAccelerationStructureGeometryDataKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureGeometryDataKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkAccelerationStructureGeometryDataKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureGeometryDataKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureGeometryDataKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureGeometryDataKHR.Buffer callocStack(int capacity, MemoryStack stack) {
