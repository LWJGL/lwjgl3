 ...
 * }</code></pre>
 */
public class VkQueryLowLatencySupportNV extends Struct implements NativeResource {
    ...
    public static VkQueryLowLatencySupportNV malloc() {
        return wrap(VkQueryLowLatencySupportNV.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkQueryLowLatencySupportNV calloc() {
        return wrap(VkQueryLowLatencySupportNV.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkQueryLowLatencySupportNV create() {
        ...
        return wrap(VkQueryLowLatencySupportNV.class, memAddress(container), container);
    }
    ...
    public static VkQueryLowLatencySupportNV create(long address) {
        return wrap(VkQueryLowLatencySupportNV.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkQueryLowLatencySupportNV createSafe(long address) {
        return address == NULL ? null : wrap(VkQueryLowLatencySupportNV.class, address);
    }
    ...
    public static VkQueryLowLatencySupportNV malloc(MemoryStack stack) {
        return wrap(VkQueryLowLatencySupportNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkQueryLowLatencySupportNV calloc(MemoryStack stack) {
        return wrap(VkQueryLowLatencySupportNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkQueryLowLatencySupportNV, Buffer> implements NativeResource {
         ...
         * by {@link VkQueryLowLatencySupportNV#SIZEOF}, and its mark will be undefined.
         *
