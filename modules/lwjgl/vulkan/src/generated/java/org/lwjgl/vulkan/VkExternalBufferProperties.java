 ...
 * }</code></pre>
 */
public class VkExternalBufferProperties extends Struct<VkExternalBufferProperties> implements NativeResource {
    ...
    public static VkExternalBufferProperties malloc() {
        return new VkExternalBufferProperties(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkExternalBufferProperties calloc() {
        return new VkExternalBufferProperties(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkExternalBufferProperties create() {
        ...
        return new VkExternalBufferProperties(memAddress(container), container);
    }
    ...
    public static @Nullable VkExternalBufferProperties createSafe(long address) {
        return address == NULL ? null : new VkExternalBufferProperties(address, null);
    }
    ...
    public static VkExternalBufferProperties.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static VkExternalBufferProperties malloc(MemoryStack stack) {
        return new VkExternalBufferProperties(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkExternalBufferProperties calloc(MemoryStack stack) {
        return new VkExternalBufferProperties(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<VkExternalBufferProperties, Buffer> implements NativeResource {
         ...
         * by {@link VkExternalBufferProperties#SIZEOF}, and its mark will be undefined.</p>
         *
