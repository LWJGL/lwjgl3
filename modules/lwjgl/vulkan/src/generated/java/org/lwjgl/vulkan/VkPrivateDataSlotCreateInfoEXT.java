...
public class VkPrivateDataSlotCreateInfoEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPrivateDataSlotCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPrivateDataSlotCreateInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPrivateDataSlotCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPrivateDataSlotCreateInfoEXT callocStack() {
     ...
     */
    public static VkPrivateDataSlotCreateInfoEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPrivateDataSlotCreateInfoEXT callocStack(MemoryStack stack) {
        return wrap(VkPrivateDataSlotCreateInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPrivateDataSlotCreateInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPrivateDataSlotCreateInfoEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPrivateDataSlotCreateInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPrivateDataSlotCreateInfoEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPrivateDataSlotCreateInfoEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPrivateDataSlotCreateInfoEXT.Buffer callocStack(int capacity, MemoryStack stack) {
