 ...
 * 
 * <ul>
 * <li>{@code handleType} <b>must</b> be a value included in the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#synchronization-fence-handletypes-win32">Handle Types Supported by {@link VkImportFenceWin32HandleInfoKHR}</a> table</li>
...
public class VkImportFenceWin32HandleInfoKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkImportFenceWin32HandleInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkImportFenceWin32HandleInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkImportFenceWin32HandleInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     * @param capacity the buffer capacity
     */
    public static VkImportFenceWin32HandleInfoKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImportFenceWin32HandleInfoKHR.Buffer callocStack(int capacity, MemoryStack stack) {
