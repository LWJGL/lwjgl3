...
public class VkImageSparseMemoryRequirementsInfo2KHR extends VkImageSparseMemoryRequirementsInfo2 {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageSparseMemoryRequirementsInfo2KHR.Buffer mallocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageSparseMemoryRequirementsInfo2KHR.Buffer callocStack(int capacity) {
