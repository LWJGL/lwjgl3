...
public class VkVideoDecodeH265SessionCreateInfoEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkVideoDecodeH265SessionCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoDecodeH265SessionCreateInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoDecodeH265SessionCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoDecodeH265SessionCreateInfoEXT callocStack() {
     ...
     */
    public static VkVideoDecodeH265SessionCreateInfoEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoDecodeH265SessionCreateInfoEXT callocStack(MemoryStack stack) {
        return wrap(VkVideoDecodeH265SessionCreateInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoDecodeH265SessionCreateInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH265SessionCreateInfoEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoDecodeH265SessionCreateInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH265SessionCreateInfoEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH265SessionCreateInfoEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH265SessionCreateInfoEXT.Buffer callocStack(int capacity, MemoryStack stack) {
