...
public class VkGeometryAABBNV extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link VkGeometryAABBNV} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link VkGeometryAABBNV} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static VkGeometryAABBNV malloc() {
        return wrap(VkGeometryAABBNV.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link VkGeometryAABBNV} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static VkGeometryAABBNV calloc() {
        return wrap(VkGeometryAABBNV.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link VkGeometryAABBNV} instance allocated with {@link BufferUtils}. */
    public static VkGeometryAABBNV create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(VkGeometryAABBNV.class, memAddress(container), container);
    }

    /** Returns a new {@link VkGeometryAABBNV} instance for the specified memory address. */
    ...
    /** Returns a new {@link VkGeometryAABBNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkGeometryAABBNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link VkGeometryAABBNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkGeometryAABBNV callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link VkGeometryAABBNV} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack the stack from which to allocate
     */
    public static VkGeometryAABBNV mallocStack(MemoryStack stack) {
        return wrap(VkGeometryAABBNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }

    /**
     * Returns a new {@link VkGeometryAABBNV} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    public static VkGeometryAABBNV callocStack(MemoryStack stack) {
        return wrap(VkGeometryAABBNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkGeometryAABBNV.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkGeometryAABBNV.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static VkGeometryAABBNV.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkGeometryAABBNV.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkGeometryAABBNV, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link VkGeometryAABBNV.Buffer} instance backed by the specified container.
         *
