...
public class VkDeviceEventInfoEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkDeviceEventInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkDeviceEventInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkDeviceEventInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
