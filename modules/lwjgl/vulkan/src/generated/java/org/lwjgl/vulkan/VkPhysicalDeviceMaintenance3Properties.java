...
public class VkPhysicalDeviceMaintenance3Properties extends Struct<VkPhysicalDeviceMaintenance3Properties> implements NativeResource {
    ...
    public static VkPhysicalDeviceMaintenance3Properties malloc() {
        return new VkPhysicalDeviceMaintenance3Properties(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceMaintenance3Properties calloc() {
        return new VkPhysicalDeviceMaintenance3Properties(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceMaintenance3Properties create() {
        ...
        return new VkPhysicalDeviceMaintenance3Properties(memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceMaintenance3Properties malloc(MemoryStack stack) {
        return new VkPhysicalDeviceMaintenance3Properties(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceMaintenance3Properties calloc(MemoryStack stack) {
        return new VkPhysicalDeviceMaintenance3Properties(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceMaintenance3Properties, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceMaintenance3Properties#SIZEOF}, and its mark will be undefined.</p>
         *
