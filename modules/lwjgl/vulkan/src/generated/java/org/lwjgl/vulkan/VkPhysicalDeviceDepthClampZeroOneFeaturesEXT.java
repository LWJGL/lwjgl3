 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceDepthClampZeroOneFeaturesEXT extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceDepthClampZeroOneFeaturesEXT malloc() {
        return wrap(VkPhysicalDeviceDepthClampZeroOneFeaturesEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceDepthClampZeroOneFeaturesEXT calloc() {
        return wrap(VkPhysicalDeviceDepthClampZeroOneFeaturesEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceDepthClampZeroOneFeaturesEXT create() {
        ...
        return wrap(VkPhysicalDeviceDepthClampZeroOneFeaturesEXT.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceDepthClampZeroOneFeaturesEXT create(long address) {
        return wrap(VkPhysicalDeviceDepthClampZeroOneFeaturesEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceDepthClampZeroOneFeaturesEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceDepthClampZeroOneFeaturesEXT.class, address);
    }
    ...
    public static VkPhysicalDeviceDepthClampZeroOneFeaturesEXT malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceDepthClampZeroOneFeaturesEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceDepthClampZeroOneFeaturesEXT calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceDepthClampZeroOneFeaturesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceDepthClampZeroOneFeaturesEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceDepthClampZeroOneFeaturesEXT#SIZEOF}, and its mark will be undefined.
         *
