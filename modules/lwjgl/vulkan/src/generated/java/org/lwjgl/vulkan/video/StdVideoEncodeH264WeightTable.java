...
public class StdVideoEncodeH264WeightTable extends Struct implements NativeResource {
    ...
    public static StdVideoEncodeH264WeightTable malloc() {
        return wrap(StdVideoEncodeH264WeightTable.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static StdVideoEncodeH264WeightTable calloc() {
        return wrap(StdVideoEncodeH264WeightTable.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static StdVideoEncodeH264WeightTable create() {
        ...
        return wrap(StdVideoEncodeH264WeightTable.class, memAddress(container), container);
    }
    ...
    public static StdVideoEncodeH264WeightTable create(long address) {
        return wrap(StdVideoEncodeH264WeightTable.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static StdVideoEncodeH264WeightTable createSafe(long address) {
        return address == NULL ? null : wrap(StdVideoEncodeH264WeightTable.class, address);
    }
    ...
    public static StdVideoEncodeH264WeightTable malloc(MemoryStack stack) {
        return wrap(StdVideoEncodeH264WeightTable.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static StdVideoEncodeH264WeightTable calloc(MemoryStack stack) {
        return wrap(StdVideoEncodeH264WeightTable.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<StdVideoEncodeH264WeightTable, Buffer> implements NativeResource {
         ...
         * by {@link StdVideoEncodeH264WeightTable#SIZEOF}, and its mark will be undefined.
         *
