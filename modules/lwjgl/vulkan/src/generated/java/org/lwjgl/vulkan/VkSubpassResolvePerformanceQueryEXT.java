 ...
 * }</code></pre>
 */
public class VkSubpassResolvePerformanceQueryEXT extends Struct implements NativeResource {
    ...
    public static VkSubpassResolvePerformanceQueryEXT malloc() {
        return wrap(VkSubpassResolvePerformanceQueryEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkSubpassResolvePerformanceQueryEXT calloc() {
        return wrap(VkSubpassResolvePerformanceQueryEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkSubpassResolvePerformanceQueryEXT create() {
        ...
        return wrap(VkSubpassResolvePerformanceQueryEXT.class, memAddress(container), container);
    }
    ...
    public static VkSubpassResolvePerformanceQueryEXT create(long address) {
        return wrap(VkSubpassResolvePerformanceQueryEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkSubpassResolvePerformanceQueryEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkSubpassResolvePerformanceQueryEXT.class, address);
    }
    ...
    public static VkSubpassResolvePerformanceQueryEXT malloc(MemoryStack stack) {
        return wrap(VkSubpassResolvePerformanceQueryEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkSubpassResolvePerformanceQueryEXT calloc(MemoryStack stack) {
        return wrap(VkSubpassResolvePerformanceQueryEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkSubpassResolvePerformanceQueryEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkSubpassResolvePerformanceQueryEXT#SIZEOF}, and its mark will be undefined.
         *
