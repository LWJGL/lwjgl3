...
public class VkCopyMemoryIndirectCommandNV extends Struct implements NativeResource {
    ...
    public static VkCopyMemoryIndirectCommandNV malloc() {
        return wrap(VkCopyMemoryIndirectCommandNV.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkCopyMemoryIndirectCommandNV calloc() {
        return wrap(VkCopyMemoryIndirectCommandNV.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkCopyMemoryIndirectCommandNV create() {
        ...
        return wrap(VkCopyMemoryIndirectCommandNV.class, memAddress(container), container);
    }
    ...
    public static VkCopyMemoryIndirectCommandNV create(long address) {
        return wrap(VkCopyMemoryIndirectCommandNV.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkCopyMemoryIndirectCommandNV createSafe(long address) {
        return address == NULL ? null : wrap(VkCopyMemoryIndirectCommandNV.class, address);
    }
    ...
    public static VkCopyMemoryIndirectCommandNV malloc(MemoryStack stack) {
        return wrap(VkCopyMemoryIndirectCommandNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkCopyMemoryIndirectCommandNV calloc(MemoryStack stack) {
        return wrap(VkCopyMemoryIndirectCommandNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkCopyMemoryIndirectCommandNV, Buffer> implements NativeResource {
         ...
         * by {@link VkCopyMemoryIndirectCommandNV#SIZEOF}, and its mark will be undefined.
         *
