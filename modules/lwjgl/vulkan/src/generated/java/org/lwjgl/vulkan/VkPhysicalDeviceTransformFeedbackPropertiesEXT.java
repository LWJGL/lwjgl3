...
public class VkPhysicalDeviceTransformFeedbackPropertiesEXT extends Struct implements NativeResource {
    ...
    /** the maximum number of transform feedback buffers that can be bound for capturing shader outputs from the last <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#pipelines-graphics-subsets-pre-rasterization">pre-rasterization shader stage</a>. */
    @NativeType("uint32_t")
