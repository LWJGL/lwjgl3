...
public class VkPhysicalDeviceMemoryProperties2KHR extends VkPhysicalDeviceMemoryProperties2 {
    ...
    /** Returns a new {@code VkPhysicalDeviceMemoryProperties2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceMemoryProperties2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceMemoryProperties2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
