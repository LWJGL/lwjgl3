...
public class VkInputAttachmentAspectReferenceKHR extends VkInputAttachmentAspectReference {
    ...
    /** Returns a new {@code VkInputAttachmentAspectReferenceKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkInputAttachmentAspectReferenceKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkInputAttachmentAspectReferenceKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
