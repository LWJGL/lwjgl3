...
public class VkBindBufferMemoryInfoKHR extends VkBindBufferMemoryInfo {
    ...
    /** Returns a new {@code VkBindBufferMemoryInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkBindBufferMemoryInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkBindBufferMemoryInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
