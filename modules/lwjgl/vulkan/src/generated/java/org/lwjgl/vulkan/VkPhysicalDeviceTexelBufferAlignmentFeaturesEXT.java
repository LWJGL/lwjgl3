 ...
 * }}</pre>
 */
public class VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT extends Struct<VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT> implements NativeResource {
    ...
    /** @return the value of the {@code texelBufferAlignment} field. */
    @NativeType("VkBool32")
    ...
    /** Sets the {@link EXTTexelBufferAlignment#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_FEATURES_EXT STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_FEATURES_EXT} value to the {@code sType} field. */
    ...
    public static VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT malloc() {
        return new VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT calloc() {
        return new VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT create() {
        ...
        return new VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT(memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT create(long address) {
        return new VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT(address, null);
    }
    ...
    public static VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT malloc(MemoryStack stack) {
        return new VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT calloc(MemoryStack stack) {
        return new VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT#SIZEOF}, and its mark will be undefined.</p>
         *
