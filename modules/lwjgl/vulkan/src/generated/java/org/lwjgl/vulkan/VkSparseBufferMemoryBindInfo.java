...
public class VkSparseBufferMemoryBindInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkSparseBufferMemoryBindInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSparseBufferMemoryBindInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSparseBufferMemoryBindInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
