 ...
 * <h5>Description</h5>
 * 
 * <p>The {@code filterCenter} specifies the origin or center of the filter kernel, as described in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#textures-weightimage-filteroperation">Weight Sampling Operation</a>. The {@code numPhases} describes the number of sub-pixel filter phases as described in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#textures-weightimage-filterphases">Weight Sampling Phases</a>.</p>
 * 
 * <h5>Valid Usage</h5>
 * 
 * <ul>
 * <li>{@code filterSize.width} <b>must</b> be less than or equal to <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#limits-weightfilter-maxdimension">{@link VkPhysicalDeviceImageProcessingPropertiesQCOM}{@code ::maxWeightFilterDimension.width}</a></li>
 * <li>{@code filterSize.height} <b>must</b> be less than or equal to <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#limits-weightfilter-maxdimension">{@link VkPhysicalDeviceImageProcessingPropertiesQCOM}{@code ::maxWeightFilterDimension.height}</a></li>
 ...
 * <li>{@code numPhases} <b>must</b> be less than or equal to <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#limits-weightfilter-phases">{@link VkPhysicalDeviceImageProcessingPropertiesQCOM}{@code ::maxWeightFilterPhases}</a></li>
 * </ul>
 * 
...
public class VkImageViewSampleWeightCreateInfoQCOM extends Struct implements NativeResource {
    ...
    public static VkImageViewSampleWeightCreateInfoQCOM malloc() {
        return wrap(VkImageViewSampleWeightCreateInfoQCOM.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkImageViewSampleWeightCreateInfoQCOM calloc() {
        return wrap(VkImageViewSampleWeightCreateInfoQCOM.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkImageViewSampleWeightCreateInfoQCOM create() {
        ...
        return wrap(VkImageViewSampleWeightCreateInfoQCOM.class, memAddress(container), container);
    }
    ...
    public static VkImageViewSampleWeightCreateInfoQCOM create(long address) {
        return wrap(VkImageViewSampleWeightCreateInfoQCOM.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkImageViewSampleWeightCreateInfoQCOM createSafe(long address) {
        return address == NULL ? null : wrap(VkImageViewSampleWeightCreateInfoQCOM.class, address);
    }
    ...
    public static VkImageViewSampleWeightCreateInfoQCOM malloc(MemoryStack stack) {
        return wrap(VkImageViewSampleWeightCreateInfoQCOM.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkImageViewSampleWeightCreateInfoQCOM calloc(MemoryStack stack) {
        return wrap(VkImageViewSampleWeightCreateInfoQCOM.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkImageViewSampleWeightCreateInfoQCOM, Buffer> implements NativeResource {
         ...
         * by {@link VkImageViewSampleWeightCreateInfoQCOM#SIZEOF}, and its mark will be undefined.
         *
