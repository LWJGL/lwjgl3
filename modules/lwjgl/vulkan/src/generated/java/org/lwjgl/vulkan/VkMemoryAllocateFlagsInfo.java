...
public class VkMemoryAllocateFlagsInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkMemoryAllocateFlagsInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkMemoryAllocateFlagsInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkMemoryAllocateFlagsInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
