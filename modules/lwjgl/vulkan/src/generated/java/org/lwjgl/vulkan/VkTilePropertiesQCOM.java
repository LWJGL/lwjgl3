 ...
 * }</code></pre>
 */
public class VkTilePropertiesQCOM extends Struct implements NativeResource {
    ...
    public static VkTilePropertiesQCOM malloc() {
        return wrap(VkTilePropertiesQCOM.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkTilePropertiesQCOM calloc() {
        return wrap(VkTilePropertiesQCOM.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkTilePropertiesQCOM create() {
        ...
        return wrap(VkTilePropertiesQCOM.class, memAddress(container), container);
    }
    ...
    public static VkTilePropertiesQCOM create(long address) {
        return wrap(VkTilePropertiesQCOM.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkTilePropertiesQCOM createSafe(long address) {
        return address == NULL ? null : wrap(VkTilePropertiesQCOM.class, address);
    }
    ...
    public static VkTilePropertiesQCOM malloc(MemoryStack stack) {
        return wrap(VkTilePropertiesQCOM.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkTilePropertiesQCOM calloc(MemoryStack stack) {
        return wrap(VkTilePropertiesQCOM.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkTilePropertiesQCOM, Buffer> implements NativeResource {
         ...
         * by {@link VkTilePropertiesQCOM#SIZEOF}, and its mark will be undefined.
         *
