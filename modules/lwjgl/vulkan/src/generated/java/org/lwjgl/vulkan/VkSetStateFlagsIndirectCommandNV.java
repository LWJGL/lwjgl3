...
public class VkSetStateFlagsIndirectCommandNV extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkSetStateFlagsIndirectCommandNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSetStateFlagsIndirectCommandNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSetStateFlagsIndirectCommandNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkSetStateFlagsIndirectCommandNV callocStack() {
     ...
     */
    public static VkSetStateFlagsIndirectCommandNV mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkSetStateFlagsIndirectCommandNV callocStack(MemoryStack stack) {
        return wrap(VkSetStateFlagsIndirectCommandNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkSetStateFlagsIndirectCommandNV.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkSetStateFlagsIndirectCommandNV.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkSetStateFlagsIndirectCommandNV.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkSetStateFlagsIndirectCommandNV.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSetStateFlagsIndirectCommandNV.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSetStateFlagsIndirectCommandNV.Buffer callocStack(int capacity, MemoryStack stack) {
