...
public class StdVideoH264HrdParameters extends Struct implements NativeResource {
    ...
    /** Returns a new {@code StdVideoH264HrdParameters} instance allocated on the thread-local {@link MemoryStack}. */
    public static StdVideoH264HrdParameters mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code StdVideoH264HrdParameters} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static StdVideoH264HrdParameters callocStack() {
     ...
     */
    public static StdVideoH264HrdParameters mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static StdVideoH264HrdParameters callocStack(MemoryStack stack) {
        return wrap(StdVideoH264HrdParameters.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link StdVideoH264HrdParameters.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoH264HrdParameters.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link StdVideoH264HrdParameters.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoH264HrdParameters.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoH264HrdParameters.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoH264HrdParameters.Buffer callocStack(int capacity, MemoryStack stack) {
