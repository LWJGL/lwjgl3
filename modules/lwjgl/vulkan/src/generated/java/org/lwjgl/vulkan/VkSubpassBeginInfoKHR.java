...
public class VkSubpassBeginInfoKHR extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link VkSubpassBeginInfoKHR} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link VkSubpassBeginInfoKHR} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static VkSubpassBeginInfoKHR malloc() {
        return create(nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link VkSubpassBeginInfoKHR} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static VkSubpassBeginInfoKHR calloc() {
        return create(nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link VkSubpassBeginInfoKHR} instance allocated with {@link BufferUtils}. */
    public static VkSubpassBeginInfoKHR create() {
        return new VkSubpassBeginInfoKHR(BufferUtils.createByteBuffer(SIZEOF));
    }

    /** Returns a new {@link VkSubpassBeginInfoKHR} instance for the specified memory address. */
    ...
    /** Returns a new {@link VkSubpassBeginInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSubpassBeginInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link VkSubpassBeginInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkSubpassBeginInfoKHR callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link VkSubpassBeginInfoKHR} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link VkSubpassBeginInfoKHR} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static int nsType(long struct) { return memGetInt(struct + VkSubpassBeginInfoKHR.STYPE); }
    ...
    public static int ncontents(long struct) { return memGetInt(struct + VkSubpassBeginInfoKHR.CONTENTS); }

    /** Unsafe version of {@link #sType(int) sType}. */
    public static void nsType(long struct, int value) { memPutInt(struct + VkSubpassBeginInfoKHR.STYPE, value); }
    ...
    public static void ncontents(long struct, int value) { memPutInt(struct + VkSubpassBeginInfoKHR.CONTENTS, value); }
    ...
    public static class Buffer extends StructBuffer<VkSubpassBeginInfoKHR, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link VkSubpassBeginInfoKHR.Buffer} instance backed by the specified container.
         *
