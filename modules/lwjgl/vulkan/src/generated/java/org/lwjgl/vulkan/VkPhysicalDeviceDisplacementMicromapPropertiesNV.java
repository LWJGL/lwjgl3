 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceDisplacementMicromapPropertiesNV extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceDisplacementMicromapPropertiesNV malloc() {
        return wrap(VkPhysicalDeviceDisplacementMicromapPropertiesNV.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceDisplacementMicromapPropertiesNV calloc() {
        return wrap(VkPhysicalDeviceDisplacementMicromapPropertiesNV.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceDisplacementMicromapPropertiesNV create() {
        ...
        return wrap(VkPhysicalDeviceDisplacementMicromapPropertiesNV.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceDisplacementMicromapPropertiesNV create(long address) {
        return wrap(VkPhysicalDeviceDisplacementMicromapPropertiesNV.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceDisplacementMicromapPropertiesNV createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceDisplacementMicromapPropertiesNV.class, address);
    }
    ...
    @Nullable
    public static VkPhysicalDeviceDisplacementMicromapPropertiesNV.Buffer createSafe(long address, int capacity) {
    ...
    public static VkPhysicalDeviceDisplacementMicromapPropertiesNV malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceDisplacementMicromapPropertiesNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceDisplacementMicromapPropertiesNV calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceDisplacementMicromapPropertiesNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceDisplacementMicromapPropertiesNV, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceDisplacementMicromapPropertiesNV#SIZEOF}, and its mark will be undefined.
         *
