...
public class VkPhysicalDeviceRayTracingValidationFeaturesNV extends Struct<VkPhysicalDeviceRayTracingValidationFeaturesNV> implements NativeResource {
    ...
    public static int nsType(long struct) { return UNSAFE.getInt(null, struct + VkPhysicalDeviceRayTracingValidationFeaturesNV.STYPE); }
    ...
    public static int nrayTracingValidation(long struct) { return UNSAFE.getInt(null, struct + VkPhysicalDeviceRayTracingValidationFeaturesNV.RAYTRACINGVALIDATION); }

    /** Unsafe version of {@link #sType(int) sType}. */
    public static void nsType(long struct, int value) { UNSAFE.putInt(null, struct + VkPhysicalDeviceRayTracingValidationFeaturesNV.STYPE, value); }
    ...
    public static void nrayTracingValidation(long struct, int value) { UNSAFE.putInt(null, struct + VkPhysicalDeviceRayTracingValidationFeaturesNV.RAYTRACINGVALIDATION, value); }
