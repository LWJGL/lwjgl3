...
public class VkDescriptorPoolInlineUniformBlockCreateInfoEXT extends Struct implements NativeResource {
    ...
    VkDescriptorPoolInlineUniformBlockCreateInfoEXT(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    /**
     * Creates a {@link VkDescriptorPoolInlineUniformBlockCreateInfoEXT} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link VkDescriptorPoolInlineUniformBlockCreateInfoEXT} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static VkDescriptorPoolInlineUniformBlockCreateInfoEXT malloc() {
        return create(nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link VkDescriptorPoolInlineUniformBlockCreateInfoEXT} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static VkDescriptorPoolInlineUniformBlockCreateInfoEXT calloc() {
        return create(nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link VkDescriptorPoolInlineUniformBlockCreateInfoEXT} instance allocated with {@link BufferUtils}. */
    public static VkDescriptorPoolInlineUniformBlockCreateInfoEXT create() {
        return new VkDescriptorPoolInlineUniformBlockCreateInfoEXT(BufferUtils.createByteBuffer(SIZEOF));
    }

    /** Returns a new {@link VkDescriptorPoolInlineUniformBlockCreateInfoEXT} instance for the specified memory address. */
    public static VkDescriptorPoolInlineUniformBlockCreateInfoEXT create(long address) {
        return new VkDescriptorPoolInlineUniformBlockCreateInfoEXT(address, null);
    }
    ...
    /** Returns a new {@link VkDescriptorPoolInlineUniformBlockCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkDescriptorPoolInlineUniformBlockCreateInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link VkDescriptorPoolInlineUniformBlockCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkDescriptorPoolInlineUniformBlockCreateInfoEXT callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link VkDescriptorPoolInlineUniformBlockCreateInfoEXT} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link VkDescriptorPoolInlineUniformBlockCreateInfoEXT} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static int nsType(long struct) { return memGetInt(struct + VkDescriptorPoolInlineUniformBlockCreateInfoEXT.STYPE); }
    ...
    public static int nmaxInlineUniformBlockBindings(long struct) { return memGetInt(struct + VkDescriptorPoolInlineUniformBlockCreateInfoEXT.MAXINLINEUNIFORMBLOCKBINDINGS); }

    /** Unsafe version of {@link #sType(int) sType}. */
    public static void nsType(long struct, int value) { memPutInt(struct + VkDescriptorPoolInlineUniformBlockCreateInfoEXT.STYPE, value); }
    ...
    public static void nmaxInlineUniformBlockBindings(long struct, int value) { memPutInt(struct + VkDescriptorPoolInlineUniformBlockCreateInfoEXT.MAXINLINEUNIFORMBLOCKBINDINGS, value); }
    ...
    public static class Buffer extends StructBuffer<VkDescriptorPoolInlineUniformBlockCreateInfoEXT, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link VkDescriptorPoolInlineUniformBlockCreateInfoEXT.Buffer} instance backed by the specified container.
         *
        ...
        @Override
        protected VkDescriptorPoolInlineUniformBlockCreateInfoEXT newInstance(long address) {
