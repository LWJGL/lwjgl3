...
public class HUAWEIInvocationMask {
    ...
    public static final int VK_ACCESS_2_INVOCATION_MASK_READ_BIT_HUAWEI = 0x80;
    ...
    public static final int VK_PIPELINE_STAGE_2_INVOCATION_MASK_BIT_HUAWEI = 0x100;
     ...
     * @param imageView     an image view handle that specifies the invocation mask image {@code imageView} <b>may</b> be set to {@link VK10#VK_NULL_HANDLE NULL_HANDLE}, which is equivalent to specifying a view of an image filled with ones value.
