...
public class VkRenderPassAttachmentBeginInfoKHR extends VkRenderPassAttachmentBeginInfo {
    ...
    /** Returns a new {@code VkRenderPassAttachmentBeginInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkRenderPassAttachmentBeginInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkRenderPassAttachmentBeginInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    ...
    /**
     * Returns a new {@link VkRenderPassAttachmentBeginInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkRenderPassAttachmentBeginInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static VkRenderPassAttachmentBeginInfoKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkRenderPassAttachmentBeginInfoKHR.Buffer callocStack(int capacity, MemoryStack stack) {
