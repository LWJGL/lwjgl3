 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceAmigoProfilingFeaturesSEC extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceAmigoProfilingFeaturesSEC malloc() {
        return wrap(VkPhysicalDeviceAmigoProfilingFeaturesSEC.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceAmigoProfilingFeaturesSEC calloc() {
        return wrap(VkPhysicalDeviceAmigoProfilingFeaturesSEC.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceAmigoProfilingFeaturesSEC create() {
        ...
        return wrap(VkPhysicalDeviceAmigoProfilingFeaturesSEC.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceAmigoProfilingFeaturesSEC create(long address) {
        return wrap(VkPhysicalDeviceAmigoProfilingFeaturesSEC.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceAmigoProfilingFeaturesSEC createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceAmigoProfilingFeaturesSEC.class, address);
    }
    ...
    public static VkPhysicalDeviceAmigoProfilingFeaturesSEC malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceAmigoProfilingFeaturesSEC.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceAmigoProfilingFeaturesSEC calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceAmigoProfilingFeaturesSEC.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceAmigoProfilingFeaturesSEC, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceAmigoProfilingFeaturesSEC#SIZEOF}, and its mark will be undefined.
         *
