...
public class VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT extends Struct implements NativeResource {
    ...
    /** indicates that the implementation supports <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#pipeline-library">graphics pipeline libraries</a>. */
    @NativeType("VkBool32")
