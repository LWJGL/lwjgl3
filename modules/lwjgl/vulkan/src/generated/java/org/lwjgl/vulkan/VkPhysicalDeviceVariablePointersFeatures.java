...
public class VkPhysicalDeviceVariablePointersFeatures extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPhysicalDeviceVariablePointersFeatures} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceVariablePointersFeatures mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceVariablePointersFeatures} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     */
    public static VkPhysicalDeviceVariablePointersFeatures mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceVariablePointersFeatures callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceVariablePointersFeatures.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceVariablePointersFeatures.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkPhysicalDeviceVariablePointersFeatures.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceVariablePointersFeatures.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceVariablePointersFeatures.Buffer callocStack(int capacity, MemoryStack stack) {
