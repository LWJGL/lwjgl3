 ...
 * <li>If both aspects are included in {@code aspectMask}, the implicit {@code usage} is equal to the intersection of {@link VkImageCreateInfo}{@code ::usage} and {@link VkImageStencilUsageCreateInfoEXT}{@code ::stencilUsage}. The implicit {@code usage} <b>can</b> be overriden by including an instance of {@link VkImageViewUsageCreateInfo} structure in the {@code pNext} chain.</li>
 * </ul>
 * 
