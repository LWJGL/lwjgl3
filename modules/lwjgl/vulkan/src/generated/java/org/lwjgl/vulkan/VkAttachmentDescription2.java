...
public class VkAttachmentDescription2 extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkAttachmentDescription2} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkAttachmentDescription2 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkAttachmentDescription2} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkAttachmentDescription2 callocStack() {
     ...
     */
    public static VkAttachmentDescription2 mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkAttachmentDescription2 callocStack(MemoryStack stack) {
        return wrap(VkAttachmentDescription2.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkAttachmentDescription2.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkAttachmentDescription2.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkAttachmentDescription2.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkAttachmentDescription2.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAttachmentDescription2.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAttachmentDescription2.Buffer callocStack(int capacity, MemoryStack stack) {
