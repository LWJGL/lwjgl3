 ...
 * <li>{@code flags} &ndash; a bitmask of {@code VkEventCreateFlagBits} defining additional creation parameters.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkEventCreateInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkEventCreateInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkEventCreateInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkEventCreateInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
