 ...
 * <li>{@code independentResolve} &ndash; {@link VK10#VK_TRUE TRUE} if the implementation supports all combinations of the supported depth and stencil resolve modes, including setting either depth or stencil resolve mode to {@link KHRDepthStencilResolve#VK_RESOLVE_MODE_NONE_KHR RESOLVE_MODE_NONE_KHR}. An implementation that supports {@code independentResolve} <b>must</b> also support {@code independentResolveNone}.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
