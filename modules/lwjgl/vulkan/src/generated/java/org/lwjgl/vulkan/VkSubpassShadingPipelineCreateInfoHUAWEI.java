...
public class VkSubpassShadingPipelineCreateInfoHUAWEI extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkSubpassShadingPipelineCreateInfoHUAWEI} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSubpassShadingPipelineCreateInfoHUAWEI mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSubpassShadingPipelineCreateInfoHUAWEI} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkSubpassShadingPipelineCreateInfoHUAWEI callocStack() {
     ...
     */
    public static VkSubpassShadingPipelineCreateInfoHUAWEI mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkSubpassShadingPipelineCreateInfoHUAWEI callocStack(MemoryStack stack) {
        return wrap(VkSubpassShadingPipelineCreateInfoHUAWEI.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkSubpassShadingPipelineCreateInfoHUAWEI.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkSubpassShadingPipelineCreateInfoHUAWEI.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkSubpassShadingPipelineCreateInfoHUAWEI.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkSubpassShadingPipelineCreateInfoHUAWEI.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSubpassShadingPipelineCreateInfoHUAWEI.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSubpassShadingPipelineCreateInfoHUAWEI.Buffer callocStack(int capacity, MemoryStack stack) {
