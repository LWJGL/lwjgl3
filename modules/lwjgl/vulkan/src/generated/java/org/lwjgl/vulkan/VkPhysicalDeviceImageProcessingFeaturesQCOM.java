 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceImageProcessingFeaturesQCOM extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceImageProcessingFeaturesQCOM malloc() {
        return wrap(VkPhysicalDeviceImageProcessingFeaturesQCOM.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceImageProcessingFeaturesQCOM calloc() {
        return wrap(VkPhysicalDeviceImageProcessingFeaturesQCOM.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceImageProcessingFeaturesQCOM create() {
        ...
        return wrap(VkPhysicalDeviceImageProcessingFeaturesQCOM.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceImageProcessingFeaturesQCOM create(long address) {
        return wrap(VkPhysicalDeviceImageProcessingFeaturesQCOM.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceImageProcessingFeaturesQCOM createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceImageProcessingFeaturesQCOM.class, address);
    }
    ...
    public static VkPhysicalDeviceImageProcessingFeaturesQCOM malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceImageProcessingFeaturesQCOM.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceImageProcessingFeaturesQCOM calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceImageProcessingFeaturesQCOM.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceImageProcessingFeaturesQCOM, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceImageProcessingFeaturesQCOM#SIZEOF}, and its mark will be undefined.
         *
