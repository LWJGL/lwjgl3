 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDevicePrivateDataFeaturesEXT} structure is included in the {@code pNext} chain of {@link VkPhysicalDeviceFeatures2}, it is filled with values indicating whether the feature is supported. {@link VkPhysicalDevicePrivateDataFeaturesEXT} <b>can</b> also be used in the {@code pNext} chain of {@link VkDeviceCreateInfo} to enable the features.</p>
 * 
 ...
 * 
 * <ul>
 * <li>{@code privateData} &ndash; indicates whether the implementation supports private data. See <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#private-data">Private Data</a>.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkPhysicalDevicePrivateDataFeaturesEXT extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code privateData} field. */
    @NativeType("VkBool32")
    ...
    /** Returns a new {@code VkPhysicalDevicePrivateDataFeaturesEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDevicePrivateDataFeaturesEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDevicePrivateDataFeaturesEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDevicePrivateDataFeaturesEXT callocStack() {
     ...
     */
    public static VkPhysicalDevicePrivateDataFeaturesEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDevicePrivateDataFeaturesEXT callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDevicePrivateDataFeaturesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDevicePrivateDataFeaturesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevicePrivateDataFeaturesEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDevicePrivateDataFeaturesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevicePrivateDataFeaturesEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevicePrivateDataFeaturesEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevicePrivateDataFeaturesEXT.Buffer callocStack(int capacity, MemoryStack stack) {
