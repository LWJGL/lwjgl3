...
public class StdVideoH265HrdFlags extends Struct implements NativeResource {
    ...
    /** Returns a new {@code StdVideoH265HrdFlags} instance allocated on the thread-local {@link MemoryStack}. */
    public static StdVideoH265HrdFlags mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code StdVideoH265HrdFlags} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static StdVideoH265HrdFlags callocStack() {
     ...
     */
    public static StdVideoH265HrdFlags mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static StdVideoH265HrdFlags callocStack(MemoryStack stack) {
        return wrap(StdVideoH265HrdFlags.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link StdVideoH265HrdFlags.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoH265HrdFlags.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link StdVideoH265HrdFlags.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoH265HrdFlags.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoH265HrdFlags.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoH265HrdFlags.Buffer callocStack(int capacity, MemoryStack stack) {
