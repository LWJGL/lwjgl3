...
public class VkVideoDecodeH264SessionCreateInfoEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkVideoDecodeH264SessionCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoDecodeH264SessionCreateInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoDecodeH264SessionCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoDecodeH264SessionCreateInfoEXT callocStack() {
     ...
     */
    public static VkVideoDecodeH264SessionCreateInfoEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoDecodeH264SessionCreateInfoEXT callocStack(MemoryStack stack) {
        return wrap(VkVideoDecodeH264SessionCreateInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoDecodeH264SessionCreateInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH264SessionCreateInfoEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoDecodeH264SessionCreateInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH264SessionCreateInfoEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH264SessionCreateInfoEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH264SessionCreateInfoEXT.Buffer callocStack(int capacity, MemoryStack stack) {
