...
public class VkPresentTimesInfoGOOGLE extends Struct implements NativeResource {
    ...
    VkPresentTimesInfoGOOGLE(long address, @Nullable ByteBuffer container) {
    ...
    /** Returns a new {@link VkPresentTimesInfoGOOGLE} instance for the specified memory address. */
