...
public class VkPresentTimesInfoGOOGLE extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPresentTimesInfoGOOGLE} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPresentTimesInfoGOOGLE mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPresentTimesInfoGOOGLE} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     * @param capacity the buffer capacity
     */
    public static VkPresentTimesInfoGOOGLE.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPresentTimesInfoGOOGLE.Buffer callocStack(int capacity, MemoryStack stack) {
