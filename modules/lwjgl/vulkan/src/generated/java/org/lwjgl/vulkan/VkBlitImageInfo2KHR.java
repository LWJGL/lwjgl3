 ...
 * <li>{@code srcImage} <b>must</b> not use a format listed in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#formats-requiring-sampler-ycbcr-conversion">Formats requiring sampler Y'C<sub>B</sub>C<sub>R</sub> conversion for {@link VK10#VK_IMAGE_ASPECT_COLOR_BIT IMAGE_ASPECT_COLOR_BIT} image views</a></li>
 ...
 * <li>{@code dstImage} <b>must</b> not use a format listed in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#formats-requiring-sampler-ycbcr-conversion">Formats requiring sampler Y'C<sub>B</sub>C<sub>R</sub> conversion for {@link VK10#VK_IMAGE_ASPECT_COLOR_BIT IMAGE_ASPECT_COLOR_BIT} image views</a></li>
 ...
 * <li>If {@code srcImage} is of type {@link VK10#VK_IMAGE_TYPE_1D IMAGE_TYPE_1D}, then for each element of {@code pRegions}, {@code srcOffset}[0].y <b>must</b> be 0 and {@code srcOffset}[1].y <b>must</b> be 1</li>
 ...
 * <li>If {@code srcImage} is of type {@link VK10#VK_IMAGE_TYPE_1D IMAGE_TYPE_1D} or {@link VK10#VK_IMAGE_TYPE_2D IMAGE_TYPE_2D}, then for each element of {@code pRegions}, {@code srcOffset}[0].z <b>must</b> be 0 and {@code srcOffset}[1].z <b>must</b> be 1</li>
 ...
 * <li>If {@code dstImage} is of type {@link VK10#VK_IMAGE_TYPE_1D IMAGE_TYPE_1D}, then for each element of {@code pRegions}, {@code dstOffset}[0].y <b>must</b> be 0 and {@code dstOffset}[1].y <b>must</b> be 1</li>
 ...
 * <li>If {@code dstImage} is of type {@link VK10#VK_IMAGE_TYPE_1D IMAGE_TYPE_1D} or {@link VK10#VK_IMAGE_TYPE_2D IMAGE_TYPE_2D}, then for each element of {@code pRegions}, {@code dstOffset}[0].z <b>must</b> be 0 and {@code dstOffset}[1].z <b>must</b> be 1</li>
 * <li>If any element of {@code pRegions} contains {@link VkCopyCommandTransformInfoQCOM} in its {@code pNext} chain, then {@code srcImage} and {@code dstImage} <b>must</b> not be a block-compressed image.</li>
 * <li>If any element of {@code pRegions} contains {@link VkCopyCommandTransformInfoQCOM} in its {@code pNext} chain, then the {@code srcImage} <b>must</b> be of type {@link VK10#VK_IMAGE_TYPE_2D IMAGE_TYPE_2D} and <b>must</b> not be a <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#formats-requiring-sampler-ycbcr-conversion">multi-planar format</a>.</li>
 * </ul>
 * 
 ...
 * <li>{@code srcImageLayout} &ndash; the layout of the source image subresources for the blit.</li>
 * <li>{@code dstImage} &ndash; the destination image.</li>
 * <li>{@code dstImageLayout} &ndash; the layout of the destination image subresources for the blit.</li>
 * <li>{@code regionCount} &ndash; the number of regions to blit.</li>
 * <li>{@code pRegions} &ndash; a pointer to an array of {@link VkImageBlit2KHR} structures specifying the regions to blit.</li>
 * <li>{@code filter} &ndash; a {@code VkFilter} specifying the filter to apply if the blits require scaling.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
 ...
 *     {@link VkImageBlit2KHR VkImageBlit2KHR} const * pRegions;
 *     VkFilter filter;
 * }</code></pre>
 */
public class VkBlitImageInfo2KHR extends Struct implements NativeResource {
    ...
    /** Returns a {@link VkImageBlit2KHR.Buffer} view of the struct array pointed to by the {@code pRegions} field. */
    ...
    /** Sets the address of the specified {@link VkImageBlit2KHR.Buffer} to the {@code pRegions} field. */
