 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceCornerSampledImageFeaturesNV} structure is included in the {@code pNext} chain of {@link VkPhysicalDeviceFeatures2KHR}, it is filled with values indicating whether each feature is supported. {@link VkPhysicalDeviceCornerSampledImageFeaturesNV} <b>can</b> also be used in the {@code pNext} chain of {@link VkDeviceCreateInfo} to enable features.</p>
 * 
...
public class VkPhysicalDeviceCornerSampledImageFeaturesNV extends Struct implements NativeResource {
    ...
    /** Returns a new {@link VkPhysicalDeviceCornerSampledImageFeaturesNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceCornerSampledImageFeaturesNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link VkPhysicalDeviceCornerSampledImageFeaturesNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDeviceCornerSampledImageFeaturesNV callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceCornerSampledImageFeaturesNV} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link VkPhysicalDeviceCornerSampledImageFeaturesNV} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link VkPhysicalDeviceCornerSampledImageFeaturesNV.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceCornerSampledImageFeaturesNV.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceCornerSampledImageFeaturesNV.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceCornerSampledImageFeaturesNV.Buffer callocStack(int capacity) {
