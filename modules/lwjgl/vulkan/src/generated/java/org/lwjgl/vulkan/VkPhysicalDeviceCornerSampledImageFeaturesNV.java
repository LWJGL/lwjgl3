 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceCornerSampledImageFeaturesNV} structure is included in the {@code pNext} chain of {@link VkPhysicalDeviceFeatures2}, it is filled with values indicating whether each feature is supported. {@link VkPhysicalDeviceCornerSampledImageFeaturesNV} <b>can</b> also be included in the {@code pNext} chain of {@link VkDeviceCreateInfo} to enable features.</p>
 * 
...
public class VkPhysicalDeviceCornerSampledImageFeaturesNV extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPhysicalDeviceCornerSampledImageFeaturesNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceCornerSampledImageFeaturesNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceCornerSampledImageFeaturesNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
