...
public class VkShaderModuleValidationCacheCreateInfoEXT extends Struct<VkShaderModuleValidationCacheCreateInfoEXT> implements NativeResource {
    ...
    protected VkShaderModuleValidationCacheCreateInfoEXT(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected VkShaderModuleValidationCacheCreateInfoEXT create(long address, @Nullable ByteBuffer container) {
    ...
    public static VkShaderModuleValidationCacheCreateInfoEXT malloc() {
        return new VkShaderModuleValidationCacheCreateInfoEXT(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkShaderModuleValidationCacheCreateInfoEXT calloc() {
        return new VkShaderModuleValidationCacheCreateInfoEXT(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkShaderModuleValidationCacheCreateInfoEXT create() {
        ...
        return new VkShaderModuleValidationCacheCreateInfoEXT(memAddress(container), container);
    }
    ...
    public static VkShaderModuleValidationCacheCreateInfoEXT malloc(MemoryStack stack) {
        return new VkShaderModuleValidationCacheCreateInfoEXT(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkShaderModuleValidationCacheCreateInfoEXT calloc(MemoryStack stack) {
        return new VkShaderModuleValidationCacheCreateInfoEXT(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<VkShaderModuleValidationCacheCreateInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkShaderModuleValidationCacheCreateInfoEXT#SIZEOF}, and its mark will be undefined.</p>
         *
