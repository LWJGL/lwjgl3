 ...
 * }</code></pre>
 */
public class VkAccelerationStructureCaptureDescriptorDataInfoEXT extends Struct implements NativeResource {
    ...
    public static VkAccelerationStructureCaptureDescriptorDataInfoEXT malloc() {
        return wrap(VkAccelerationStructureCaptureDescriptorDataInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkAccelerationStructureCaptureDescriptorDataInfoEXT calloc() {
        return wrap(VkAccelerationStructureCaptureDescriptorDataInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkAccelerationStructureCaptureDescriptorDataInfoEXT create() {
        ...
        return wrap(VkAccelerationStructureCaptureDescriptorDataInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkAccelerationStructureCaptureDescriptorDataInfoEXT create(long address) {
        return wrap(VkAccelerationStructureCaptureDescriptorDataInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkAccelerationStructureCaptureDescriptorDataInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkAccelerationStructureCaptureDescriptorDataInfoEXT.class, address);
    }
    ...
    public static VkAccelerationStructureCaptureDescriptorDataInfoEXT malloc(MemoryStack stack) {
        return wrap(VkAccelerationStructureCaptureDescriptorDataInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkAccelerationStructureCaptureDescriptorDataInfoEXT calloc(MemoryStack stack) {
        return wrap(VkAccelerationStructureCaptureDescriptorDataInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkAccelerationStructureCaptureDescriptorDataInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkAccelerationStructureCaptureDescriptorDataInfoEXT#SIZEOF}, and its mark will be undefined.
         *
