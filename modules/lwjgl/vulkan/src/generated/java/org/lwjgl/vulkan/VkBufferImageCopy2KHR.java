...
public class VkBufferImageCopy2KHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkBufferImageCopy2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkBufferImageCopy2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkBufferImageCopy2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkBufferImageCopy2KHR callocStack() {
     ...
     */
    public static VkBufferImageCopy2KHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkBufferImageCopy2KHR callocStack(MemoryStack stack) {
        return wrap(VkBufferImageCopy2KHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkBufferImageCopy2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkBufferImageCopy2KHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkBufferImageCopy2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkBufferImageCopy2KHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkBufferImageCopy2KHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkBufferImageCopy2KHR.Buffer callocStack(int capacity, MemoryStack stack) {
