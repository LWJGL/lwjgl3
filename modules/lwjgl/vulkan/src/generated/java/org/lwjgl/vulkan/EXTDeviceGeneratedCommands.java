...
public class EXTDeviceGeneratedCommands {
     ...
     * 
     * <ul>
     * <li>{@link #VK_INDIRECT_COMMANDS_INPUT_MODE_VULKAN_INDEX_BUFFER_EXT INDIRECT_COMMANDS_INPUT_MODE_VULKAN_INDEX_BUFFER_EXT} specifies that the indirect buffer contains {@link VkBindIndexBufferIndirectCommandEXT}.</li>
     * <li>{@link #VK_INDIRECT_COMMANDS_INPUT_MODE_DXGI_INDEX_BUFFER_EXT INDIRECT_COMMANDS_INPUT_MODE_DXGI_INDEX_BUFFER_EXT} specifies that the indirect buffer contains {@code D3D12_INDEX_BUFFER_VIEW}.</li>
     * </ul>
     * 
     * <h5>See Also</h5>
     * 
     ...
     * <li>The <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#features-deviceGeneratedCommands">{@link VkPhysicalDeviceDeviceGeneratedCommandsFeaturesEXT}{@code ::deviceGeneratedCommands}</a> feature <b>must</b> be enabled</li>
     * <li>The bound shader stages <b>must</b> be supported by <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#limits-supportedIndirectCommandsShaderStages">{@link VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT}{@code ::supportedIndirectCommandsShaderStages}</a></li>
     * <li>Only stages specified in <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#limits-supportedIndirectCommandsShaderStages">{@link VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT}{@code ::supportedIndirectCommandsShaderStages}</a> <b>can</b> be set in {@code pGeneratedCommandsInfo→shaderStages}</li>
