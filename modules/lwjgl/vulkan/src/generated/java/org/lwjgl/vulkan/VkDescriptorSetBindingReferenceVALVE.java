 ...
 * }</code></pre>
 */
public class VkDescriptorSetBindingReferenceVALVE extends Struct implements NativeResource {
    ...
    public static VkDescriptorSetBindingReferenceVALVE malloc() {
        return wrap(VkDescriptorSetBindingReferenceVALVE.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkDescriptorSetBindingReferenceVALVE calloc() {
        return wrap(VkDescriptorSetBindingReferenceVALVE.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkDescriptorSetBindingReferenceVALVE create() {
        ...
        return wrap(VkDescriptorSetBindingReferenceVALVE.class, memAddress(container), container);
    }
    ...
    public static VkDescriptorSetBindingReferenceVALVE create(long address) {
        return wrap(VkDescriptorSetBindingReferenceVALVE.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkDescriptorSetBindingReferenceVALVE createSafe(long address) {
        return address == NULL ? null : wrap(VkDescriptorSetBindingReferenceVALVE.class, address);
    }
    ...
    public static VkDescriptorSetBindingReferenceVALVE malloc(MemoryStack stack) {
        return wrap(VkDescriptorSetBindingReferenceVALVE.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkDescriptorSetBindingReferenceVALVE calloc(MemoryStack stack) {
        return wrap(VkDescriptorSetBindingReferenceVALVE.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkDescriptorSetBindingReferenceVALVE, Buffer> implements NativeResource {
         ...
         * by {@link VkDescriptorSetBindingReferenceVALVE#SIZEOF}, and its mark will be undefined.
         *
