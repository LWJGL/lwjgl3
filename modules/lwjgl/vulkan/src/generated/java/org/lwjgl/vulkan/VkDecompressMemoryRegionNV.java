 ...
 * }</code></pre>
 */
public class VkDecompressMemoryRegionNV extends Struct implements NativeResource {
    ...
    public static VkDecompressMemoryRegionNV malloc() {
        return wrap(VkDecompressMemoryRegionNV.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkDecompressMemoryRegionNV calloc() {
        return wrap(VkDecompressMemoryRegionNV.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkDecompressMemoryRegionNV create() {
        ...
        return wrap(VkDecompressMemoryRegionNV.class, memAddress(container), container);
    }
    ...
    public static VkDecompressMemoryRegionNV create(long address) {
        return wrap(VkDecompressMemoryRegionNV.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkDecompressMemoryRegionNV createSafe(long address) {
        return address == NULL ? null : wrap(VkDecompressMemoryRegionNV.class, address);
    }
    ...
    public static VkDecompressMemoryRegionNV malloc(MemoryStack stack) {
        return wrap(VkDecompressMemoryRegionNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkDecompressMemoryRegionNV calloc(MemoryStack stack) {
        return wrap(VkDecompressMemoryRegionNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkDecompressMemoryRegionNV, Buffer> implements NativeResource {
         ...
         * by {@link VkDecompressMemoryRegionNV#SIZEOF}, and its mark will be undefined.
         *
