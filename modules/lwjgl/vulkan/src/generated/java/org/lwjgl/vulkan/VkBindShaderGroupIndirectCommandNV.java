...
public class VkBindShaderGroupIndirectCommandNV extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkBindShaderGroupIndirectCommandNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkBindShaderGroupIndirectCommandNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkBindShaderGroupIndirectCommandNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkBindShaderGroupIndirectCommandNV callocStack() {
     ...
     */
    public static VkBindShaderGroupIndirectCommandNV mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkBindShaderGroupIndirectCommandNV callocStack(MemoryStack stack) {
        return wrap(VkBindShaderGroupIndirectCommandNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkBindShaderGroupIndirectCommandNV.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkBindShaderGroupIndirectCommandNV.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkBindShaderGroupIndirectCommandNV.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkBindShaderGroupIndirectCommandNV.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkBindShaderGroupIndirectCommandNV.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkBindShaderGroupIndirectCommandNV.Buffer callocStack(int capacity, MemoryStack stack) {
