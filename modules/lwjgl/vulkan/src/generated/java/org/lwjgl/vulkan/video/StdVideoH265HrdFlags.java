...
public class StdVideoH265HrdFlags extends Struct<StdVideoH265HrdFlags> implements NativeResource {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoH265HrdFlags.BITFIELD0); }
    ...
    static int nbitfield1(long struct) { return memGetInt(struct + StdVideoH265HrdFlags.BITFIELD1); }
    ...
    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoH265HrdFlags.BITFIELD0, value); }
    ...
    static void nbitfield1(long struct, int value) { memPutInt(struct + StdVideoH265HrdFlags.BITFIELD1, value); }
