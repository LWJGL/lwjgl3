 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM malloc() {
        return wrap(VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM calloc() {
        return wrap(VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM create() {
        ...
        return wrap(VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM create(long address) {
        return wrap(VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM.class, address);
    }
    ...
    public static VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM#SIZEOF}, and its mark will be undefined.
         *
