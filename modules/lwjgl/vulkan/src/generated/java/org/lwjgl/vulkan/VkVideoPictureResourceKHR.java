...
public class VkVideoPictureResourceKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkVideoPictureResourceKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoPictureResourceKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoPictureResourceKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoPictureResourceKHR callocStack() {
     ...
     */
    public static VkVideoPictureResourceKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoPictureResourceKHR callocStack(MemoryStack stack) {
        return wrap(VkVideoPictureResourceKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoPictureResourceKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoPictureResourceKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoPictureResourceKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoPictureResourceKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoPictureResourceKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoPictureResourceKHR.Buffer callocStack(int capacity, MemoryStack stack) {
