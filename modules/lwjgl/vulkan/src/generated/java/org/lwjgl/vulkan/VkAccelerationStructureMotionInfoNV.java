 ...
 * }</code></pre>
 */
public class VkAccelerationStructureMotionInfoNV extends Struct implements NativeResource {
    ...
    public static VkAccelerationStructureMotionInfoNV malloc() {
        return wrap(VkAccelerationStructureMotionInfoNV.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkAccelerationStructureMotionInfoNV calloc() {
        return wrap(VkAccelerationStructureMotionInfoNV.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkAccelerationStructureMotionInfoNV create() {
        ...
        return wrap(VkAccelerationStructureMotionInfoNV.class, memAddress(container), container);
    }
    ...
    public static VkAccelerationStructureMotionInfoNV create(long address) {
        return wrap(VkAccelerationStructureMotionInfoNV.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkAccelerationStructureMotionInfoNV createSafe(long address) {
        return address == NULL ? null : wrap(VkAccelerationStructureMotionInfoNV.class, address);
    }
    ...
    /** Returns a new {@code VkAccelerationStructureMotionInfoNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkAccelerationStructureMotionInfoNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkAccelerationStructureMotionInfoNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkAccelerationStructureMotionInfoNV callocStack() {
     ...
     */
    public static VkAccelerationStructureMotionInfoNV mallocStack(MemoryStack stack) {
        return wrap(VkAccelerationStructureMotionInfoNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
     ...
     * @param stack the stack from which to allocate
     */
    public static VkAccelerationStructureMotionInfoNV callocStack(MemoryStack stack) {
        return wrap(VkAccelerationStructureMotionInfoNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkAccelerationStructureMotionInfoNV.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureMotionInfoNV.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkAccelerationStructureMotionInfoNV.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureMotionInfoNV.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureMotionInfoNV.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureMotionInfoNV.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkAccelerationStructureMotionInfoNV, Buffer> implements NativeResource {
         ...
         * by {@link VkAccelerationStructureMotionInfoNV#SIZEOF}, and its mark will be undefined.
         *
