 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceShaderClockFeaturesKHR} structure is included in the {@code pNext} chain of {@link VkPhysicalDeviceFeatures2}, it is filled with values indicating whether each feature is supported. {@link VkPhysicalDeviceShaderClockFeaturesKHR} can also be used in {@code pNext} chain of {@link VkDeviceCreateInfo} to enable the features.</p>
 * 
