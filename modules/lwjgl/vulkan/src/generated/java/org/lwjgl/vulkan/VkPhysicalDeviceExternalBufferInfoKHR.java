...
public class VkPhysicalDeviceExternalBufferInfoKHR extends VkPhysicalDeviceExternalBufferInfo {
    ...
    protected VkPhysicalDeviceExternalBufferInfoKHR(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected VkPhysicalDeviceExternalBufferInfoKHR create(long address, @Nullable ByteBuffer container) {
