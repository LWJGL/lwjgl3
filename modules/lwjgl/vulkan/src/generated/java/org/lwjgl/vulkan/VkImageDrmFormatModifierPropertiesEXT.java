...
public class VkImageDrmFormatModifierPropertiesEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkImageDrmFormatModifierPropertiesEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkImageDrmFormatModifierPropertiesEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkImageDrmFormatModifierPropertiesEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
