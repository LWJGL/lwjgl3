...
public class VkImageDrmFormatModifierPropertiesEXT extends Struct implements NativeResource {
    ...
    /** returns the image’s <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#glossary-drm-format-modifier">Linux DRM format modifier</a>. */
    @NativeType("uint64_t")
