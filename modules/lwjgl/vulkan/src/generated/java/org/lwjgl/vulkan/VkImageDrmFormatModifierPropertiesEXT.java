...
public class VkImageDrmFormatModifierPropertiesEXT extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link VkImageDrmFormatModifierPropertiesEXT} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link VkImageDrmFormatModifierPropertiesEXT} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    ...
    /** Returns a new {@link VkImageDrmFormatModifierPropertiesEXT} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    ...
    /** Returns a new {@link VkImageDrmFormatModifierPropertiesEXT} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link VkImageDrmFormatModifierPropertiesEXT} instance for the specified memory address. */
    ...
    /** Returns a new {@link VkImageDrmFormatModifierPropertiesEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkImageDrmFormatModifierPropertiesEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link VkImageDrmFormatModifierPropertiesEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkImageDrmFormatModifierPropertiesEXT callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link VkImageDrmFormatModifierPropertiesEXT} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack the stack from which to allocate
     */
    public static VkImageDrmFormatModifierPropertiesEXT mallocStack(MemoryStack stack) {
        return wrap(VkImageDrmFormatModifierPropertiesEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }

    /**
     * Returns a new {@link VkImageDrmFormatModifierPropertiesEXT} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    public static VkImageDrmFormatModifierPropertiesEXT callocStack(MemoryStack stack) {
        return wrap(VkImageDrmFormatModifierPropertiesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkImageDrmFormatModifierPropertiesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkImageDrmFormatModifierPropertiesEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkImageDrmFormatModifierPropertiesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkImageDrmFormatModifierPropertiesEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageDrmFormatModifierPropertiesEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageDrmFormatModifierPropertiesEXT.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkImageDrmFormatModifierPropertiesEXT, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link VkImageDrmFormatModifierPropertiesEXT.Buffer} instance backed by the specified container.
         *
