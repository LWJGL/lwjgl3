...
public class VkPhysicalDeviceExternalMemoryRDMAFeaturesNV extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPhysicalDeviceExternalMemoryRDMAFeaturesNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceExternalMemoryRDMAFeaturesNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceExternalMemoryRDMAFeaturesNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDeviceExternalMemoryRDMAFeaturesNV callocStack() {
     ...
     */
    public static VkPhysicalDeviceExternalMemoryRDMAFeaturesNV mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceExternalMemoryRDMAFeaturesNV callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceExternalMemoryRDMAFeaturesNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceExternalMemoryRDMAFeaturesNV.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceExternalMemoryRDMAFeaturesNV.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceExternalMemoryRDMAFeaturesNV.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceExternalMemoryRDMAFeaturesNV.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceExternalMemoryRDMAFeaturesNV.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceExternalMemoryRDMAFeaturesNV.Buffer callocStack(int capacity, MemoryStack stack) {
