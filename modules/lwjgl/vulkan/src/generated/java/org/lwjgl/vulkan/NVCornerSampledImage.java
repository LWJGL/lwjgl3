 ...
 * <li>Calculation of the next higher LOD size goes according to <code>⌈dim / 2⌉</code> rather than <code>⌊dim / 2⌋</code>. See <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#resources-image-mip-level-sizing">Image Mip Level Sizing</a>.</li>
 * <li>The minimum level size is 2x2 for 2D images and 2x2x2 for 3D images. See <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#resources-image-mip-level-sizing">Image Mip Level Sizing</a>.</li>
 * </ul>
 * 
