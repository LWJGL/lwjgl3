...
public class VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT extends Struct implements NativeResource {
    ...
    /** one greater than the highest color attachment index that <b>can</b> be used in a subpass, for a pipeline that uses an <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#framebuffer-blend-advanced">advanced blend operation</a>. */
    @NativeType("uint32_t")
