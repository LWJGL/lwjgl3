...
public class VkPhysicalDeviceExternalSemaphoreInfoKHR extends VkPhysicalDeviceExternalSemaphoreInfo {
    ...
    /** Returns a new {@code VkPhysicalDeviceExternalSemaphoreInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceExternalSemaphoreInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceExternalSemaphoreInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
