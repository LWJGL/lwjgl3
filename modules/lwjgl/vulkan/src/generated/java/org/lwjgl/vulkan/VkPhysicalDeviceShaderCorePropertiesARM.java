 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceShaderCorePropertiesARM extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceShaderCorePropertiesARM malloc() {
        return wrap(VkPhysicalDeviceShaderCorePropertiesARM.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceShaderCorePropertiesARM calloc() {
        return wrap(VkPhysicalDeviceShaderCorePropertiesARM.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceShaderCorePropertiesARM create() {
        ...
        return wrap(VkPhysicalDeviceShaderCorePropertiesARM.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceShaderCorePropertiesARM create(long address) {
        return wrap(VkPhysicalDeviceShaderCorePropertiesARM.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceShaderCorePropertiesARM createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceShaderCorePropertiesARM.class, address);
    }
    ...
    public static VkPhysicalDeviceShaderCorePropertiesARM malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceShaderCorePropertiesARM.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceShaderCorePropertiesARM calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceShaderCorePropertiesARM.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceShaderCorePropertiesARM, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceShaderCorePropertiesARM#SIZEOF}, and its mark will be undefined.
         *
