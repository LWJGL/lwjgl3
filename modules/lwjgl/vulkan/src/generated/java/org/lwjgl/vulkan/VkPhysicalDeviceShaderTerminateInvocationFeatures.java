 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceShaderTerminateInvocationFeatures extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceShaderTerminateInvocationFeatures malloc() {
        return wrap(VkPhysicalDeviceShaderTerminateInvocationFeatures.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceShaderTerminateInvocationFeatures calloc() {
        return wrap(VkPhysicalDeviceShaderTerminateInvocationFeatures.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceShaderTerminateInvocationFeatures create() {
        ...
        return wrap(VkPhysicalDeviceShaderTerminateInvocationFeatures.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceShaderTerminateInvocationFeatures create(long address) {
        return wrap(VkPhysicalDeviceShaderTerminateInvocationFeatures.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceShaderTerminateInvocationFeatures createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceShaderTerminateInvocationFeatures.class, address);
    }
    ...
    @Nullable
    public static VkPhysicalDeviceShaderTerminateInvocationFeatures.Buffer createSafe(long address, int capacity) {
    ...
    public static VkPhysicalDeviceShaderTerminateInvocationFeatures malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceShaderTerminateInvocationFeatures.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceShaderTerminateInvocationFeatures calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceShaderTerminateInvocationFeatures.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceShaderTerminateInvocationFeatures, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceShaderTerminateInvocationFeatures#SIZEOF}, and its mark will be undefined.
         *
