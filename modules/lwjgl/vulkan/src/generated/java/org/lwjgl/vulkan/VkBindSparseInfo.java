 ...
 * 
 * <ul>
 * <li>If any element of {@code pWaitSemaphores} or {@code pSignalSemaphores} was created with a {@code VkSemaphoreTypeKHR} of {@link KHRTimelineSemaphore#VK_SEMAPHORE_TYPE_TIMELINE_KHR SEMAPHORE_TYPE_TIMELINE_KHR} then the {@code pNext} chain <b>must</b> include a {@link VkTimelineSemaphoreSubmitInfoKHR} structure</li>
 * <li>If the {@code pNext} chain of this structure includes a {@link VkTimelineSemaphoreSubmitInfoKHR} structure and any element of {@code pWaitSemaphores} was created with a {@code VkSemaphoreTypeKHR} of {@link KHRTimelineSemaphore#VK_SEMAPHORE_TYPE_TIMELINE_KHR SEMAPHORE_TYPE_TIMELINE_KHR} then its {@code waitSemaphoreValueCount} member <b>must</b> equal {@code waitSemaphoreCount}</li>
