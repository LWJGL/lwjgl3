 ...
 * 
 * <ul>
 * <li>If {@link VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT}{@code ::maxIndirectShaderObjectCount} is zero or <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#features-shaderObject">{@code shaderObject}</a> is not enabled {@code type} <b>must</b> not be {@link EXTDeviceGeneratedCommands#VK_INDIRECT_EXECUTION_SET_INFO_TYPE_SHADER_OBJECTS_EXT INDIRECT_EXECUTION_SET_INFO_TYPE_SHADER_OBJECTS_EXT}</li>
 * </ul>
 * 
