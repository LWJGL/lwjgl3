 ...
 * }</code></pre>
 */
public class VkSamplerCaptureDescriptorDataInfoEXT extends Struct implements NativeResource {
    ...
    public static VkSamplerCaptureDescriptorDataInfoEXT malloc() {
        return wrap(VkSamplerCaptureDescriptorDataInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkSamplerCaptureDescriptorDataInfoEXT calloc() {
        return wrap(VkSamplerCaptureDescriptorDataInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkSamplerCaptureDescriptorDataInfoEXT create() {
        ...
        return wrap(VkSamplerCaptureDescriptorDataInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkSamplerCaptureDescriptorDataInfoEXT create(long address) {
        return wrap(VkSamplerCaptureDescriptorDataInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkSamplerCaptureDescriptorDataInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkSamplerCaptureDescriptorDataInfoEXT.class, address);
    }
    ...
    public static VkSamplerCaptureDescriptorDataInfoEXT malloc(MemoryStack stack) {
        return wrap(VkSamplerCaptureDescriptorDataInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkSamplerCaptureDescriptorDataInfoEXT calloc(MemoryStack stack) {
        return wrap(VkSamplerCaptureDescriptorDataInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkSamplerCaptureDescriptorDataInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkSamplerCaptureDescriptorDataInfoEXT#SIZEOF}, and its mark will be undefined.
         *
