...
public class KHRMaintenance5 {
     ...
     * <li>{@link #VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_NV PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_NV} specifies that the pipeline can be used in combination with <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#device-generated-commands">Device-Generated Commands</a>.</li>
     ...
     * <li>{@link #VK_PIPELINE_CREATE_2_DESCRIPTOR_BUFFER_BIT_EXT PIPELINE_CREATE_2_DESCRIPTOR_BUFFER_BIT_EXT} specifies that a pipeline will be used with <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#descriptorbuffers">descriptor buffers</a>, rather than <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#descriptorsets">descriptor sets</a>.</li>
     ...
     * 
     * <p>When an implementation is looking up a pipeline in a <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#pipelines-cache">pipeline cache</a>, if that pipeline is being created using linked libraries, implementations <b>should</b> always return an equivalent pipeline created with {@link #VK_PIPELINE_CREATE_2_LINK_TIME_OPTIMIZATION_BIT_EXT PIPELINE_CREATE_2_LINK_TIME_OPTIMIZATION_BIT_EXT} if available, whether or not that bit was specified.</p>
     * 
     ...
     * 
     * <ul>
     * <li>{@link #VK_BUFFER_USAGE_2_TRANSFER_SRC_BIT_KHR BUFFER_USAGE_2_TRANSFER_SRC_BIT_KHR} specifies that the buffer <b>can</b> be used as the source of a <em>transfer command</em> (see the definition of <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#synchronization-pipeline-stages-transfer">{@link VK10#VK_PIPELINE_STAGE_TRANSFER_BIT PIPELINE_STAGE_TRANSFER_BIT}</a>).</li>
     ...
     * <li>{@link #VK_BUFFER_USAGE_2_SHADER_BINDING_TABLE_BIT_KHR BUFFER_USAGE_2_SHADER_BINDING_TABLE_BIT_KHR} specifies that the buffer is suitable for use as a <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#shader-binding-table">Shader Binding Table</a>.</li>
     ...
     * <li>{@link #VK_BUFFER_USAGE_2_VIDEO_DECODE_SRC_BIT_KHR BUFFER_USAGE_2_VIDEO_DECODE_SRC_BIT_KHR} specifies that the buffer <b>can</b> be used as the source video bitstream buffer in a <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#video-decode-operations">video decode operation</a>.</li>
     ...
     * <li>If {@code indexType} is {@link KHRIndexTypeUint8#VK_INDEX_TYPE_UINT8_KHR INDEX_TYPE_UINT8_KHR}, the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#features-indexTypeUint8">{@code indexTypeUint8}</a> feature <b>must</b> be enabled</li>
     * <li>If <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#features-maintenance6">{@code maintenance6}</a> is not enabled, {@code buffer} <b>must</b> not be {@link VK10#VK_NULL_HANDLE NULL_HANDLE}</li>
     ...
     * 
     * <p>It is legal to call {@code vkGetImageSubresourceLayout2KHR} with an {@code image} created with {@code tiling} equal to {@link VK10#VK_IMAGE_TILING_OPTIMAL IMAGE_TILING_OPTIMAL}, but the members of {@link VkSubresourceLayout2KHR}{@code ::subresourceLayout} will have undefined values in this case.</p>
     * 
     * <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
     * 
