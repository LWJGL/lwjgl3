 ...
 * 
 * <ul>
 * <li>If the <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#limits-advancedBlendNonPremultipliedSrcColor">non-premultiplied source color</a> property is not supported, {@code srcPremultiplied} <b>must</b> be {@link VK10#VK_TRUE TRUE}</li>
 * <li>If the <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#limits-advancedBlendNonPremultipliedDstColor">non-premultiplied destination color</a> property is not supported, {@code dstPremultiplied} <b>must</b> be {@link VK10#VK_TRUE TRUE}</li>
 * <li>If the <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#limits-advancedBlendCorrelatedOverlap">correlated overlap</a> property is not supported, {@code blendOverlap} <b>must</b> be {@link EXTBlendOperationAdvanced#VK_BLEND_OVERLAP_UNCORRELATED_EXT BLEND_OVERLAP_UNCORRELATED_EXT}</li>
 * </ul>
 * 
 ...
 * }</code></pre>
 */
public class VkColorBlendAdvancedEXT extends Struct implements NativeResource {
    ...
    public static VkColorBlendAdvancedEXT malloc() {
        return wrap(VkColorBlendAdvancedEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkColorBlendAdvancedEXT calloc() {
        return wrap(VkColorBlendAdvancedEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkColorBlendAdvancedEXT create() {
        ...
        return wrap(VkColorBlendAdvancedEXT.class, memAddress(container), container);
    }
    ...
    public static VkColorBlendAdvancedEXT create(long address) {
        return wrap(VkColorBlendAdvancedEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkColorBlendAdvancedEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkColorBlendAdvancedEXT.class, address);
    }
    ...
    public static VkColorBlendAdvancedEXT malloc(MemoryStack stack) {
        return wrap(VkColorBlendAdvancedEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkColorBlendAdvancedEXT calloc(MemoryStack stack) {
        return wrap(VkColorBlendAdvancedEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkColorBlendAdvancedEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkColorBlendAdvancedEXT#SIZEOF}, and its mark will be undefined.
         *
