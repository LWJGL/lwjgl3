...
public class StdVideoH264PpsFlags extends Struct implements NativeResource {
    ...
    /** Returns a new {@code StdVideoH264PpsFlags} instance allocated on the thread-local {@link MemoryStack}. */
    public static StdVideoH264PpsFlags mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code StdVideoH264PpsFlags} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static StdVideoH264PpsFlags callocStack() {
     ...
     */
    public static StdVideoH264PpsFlags mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static StdVideoH264PpsFlags callocStack(MemoryStack stack) {
        return wrap(StdVideoH264PpsFlags.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link StdVideoH264PpsFlags.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoH264PpsFlags.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link StdVideoH264PpsFlags.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoH264PpsFlags.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoH264PpsFlags.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoH264PpsFlags.Buffer callocStack(int capacity, MemoryStack stack) {
