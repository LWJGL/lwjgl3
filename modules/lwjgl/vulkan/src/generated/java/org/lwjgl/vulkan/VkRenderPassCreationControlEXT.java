 ...
 * }</code></pre>
 */
public class VkRenderPassCreationControlEXT extends Struct implements NativeResource {
    ...
    public VkRenderPassCreationControlEXT pNext(VkRenderPassCreationFeedbackInfoEXT value) { return this.pNext(value.pNext(this.pNext()).address()); }
    /** Prepends the specified {@link VkRenderPassSubpassFeedbackInfoEXT} value to the {@code pNext} chain. */
    public VkRenderPassCreationControlEXT pNext(VkRenderPassSubpassFeedbackInfoEXT value) { return this.pNext(value.pNext(this.pNext()).address()); }
    ...
    public static VkRenderPassCreationControlEXT malloc() {
        return wrap(VkRenderPassCreationControlEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkRenderPassCreationControlEXT calloc() {
        return wrap(VkRenderPassCreationControlEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkRenderPassCreationControlEXT create() {
        ...
        return wrap(VkRenderPassCreationControlEXT.class, memAddress(container), container);
    }
    ...
    public static VkRenderPassCreationControlEXT create(long address) {
        return wrap(VkRenderPassCreationControlEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkRenderPassCreationControlEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkRenderPassCreationControlEXT.class, address);
    }
    ...
    public static VkRenderPassCreationControlEXT malloc(MemoryStack stack) {
        return wrap(VkRenderPassCreationControlEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkRenderPassCreationControlEXT calloc(MemoryStack stack) {
        return wrap(VkRenderPassCreationControlEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkRenderPassCreationControlEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkRenderPassCreationControlEXT#SIZEOF}, and its mark will be undefined.
         *
        ...
        /** Prepends the specified {@link VkRenderPassCreationFeedbackInfoEXT} value to the {@code pNext} chain. */
        public VkRenderPassCreationControlEXT.Buffer pNext(VkRenderPassCreationFeedbackInfoEXT value) { return this.pNext(value.pNext(this.pNext()).address()); }
        /** Prepends the specified {@link VkRenderPassSubpassFeedbackInfoEXT} value to the {@code pNext} chain. */
        public VkRenderPassCreationControlEXT.Buffer pNext(VkRenderPassSubpassFeedbackInfoEXT value) { return this.pNext(value.pNext(this.pNext()).address()); }
