 ...
 * }</code></pre>
 */
public class VkPhysicalDevicePipelinePropertiesFeaturesEXT extends Struct implements NativeResource {
    ...
    public static VkPhysicalDevicePipelinePropertiesFeaturesEXT malloc() {
        return wrap(VkPhysicalDevicePipelinePropertiesFeaturesEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDevicePipelinePropertiesFeaturesEXT calloc() {
        return wrap(VkPhysicalDevicePipelinePropertiesFeaturesEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDevicePipelinePropertiesFeaturesEXT create() {
        ...
        return wrap(VkPhysicalDevicePipelinePropertiesFeaturesEXT.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDevicePipelinePropertiesFeaturesEXT create(long address) {
        return wrap(VkPhysicalDevicePipelinePropertiesFeaturesEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDevicePipelinePropertiesFeaturesEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDevicePipelinePropertiesFeaturesEXT.class, address);
    }
    ...
    public static VkPhysicalDevicePipelinePropertiesFeaturesEXT malloc(MemoryStack stack) {
        return wrap(VkPhysicalDevicePipelinePropertiesFeaturesEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDevicePipelinePropertiesFeaturesEXT calloc(MemoryStack stack) {
        return wrap(VkPhysicalDevicePipelinePropertiesFeaturesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDevicePipelinePropertiesFeaturesEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDevicePipelinePropertiesFeaturesEXT#SIZEOF}, and its mark will be undefined.
         *
