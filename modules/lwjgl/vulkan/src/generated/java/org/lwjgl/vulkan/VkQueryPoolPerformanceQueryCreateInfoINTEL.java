...
public class VkQueryPoolPerformanceQueryCreateInfoINTEL extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkQueryPoolPerformanceQueryCreateInfoINTEL} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkQueryPoolPerformanceQueryCreateInfoINTEL mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkQueryPoolPerformanceQueryCreateInfoINTEL} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkQueryPoolPerformanceQueryCreateInfoINTEL callocStack() {
     ...
     */
    public static VkQueryPoolPerformanceQueryCreateInfoINTEL mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkQueryPoolPerformanceQueryCreateInfoINTEL callocStack(MemoryStack stack) {
        return wrap(VkQueryPoolPerformanceQueryCreateInfoINTEL.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkQueryPoolPerformanceQueryCreateInfoINTEL.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkQueryPoolPerformanceQueryCreateInfoINTEL.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkQueryPoolPerformanceQueryCreateInfoINTEL.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkQueryPoolPerformanceQueryCreateInfoINTEL.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkQueryPoolPerformanceQueryCreateInfoINTEL.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkQueryPoolPerformanceQueryCreateInfoINTEL.Buffer callocStack(int capacity, MemoryStack stack) {
