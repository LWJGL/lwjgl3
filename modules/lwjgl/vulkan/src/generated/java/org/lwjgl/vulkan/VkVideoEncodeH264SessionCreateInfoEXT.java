...
public class VkVideoEncodeH264SessionCreateInfoEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkVideoEncodeH264SessionCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoEncodeH264SessionCreateInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoEncodeH264SessionCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoEncodeH264SessionCreateInfoEXT callocStack() {
     ...
     */
    public static VkVideoEncodeH264SessionCreateInfoEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoEncodeH264SessionCreateInfoEXT callocStack(MemoryStack stack) {
        return wrap(VkVideoEncodeH264SessionCreateInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoEncodeH264SessionCreateInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264SessionCreateInfoEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoEncodeH264SessionCreateInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264SessionCreateInfoEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264SessionCreateInfoEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264SessionCreateInfoEXT.Buffer callocStack(int capacity, MemoryStack stack) {
