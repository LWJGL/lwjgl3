 ...
 * }</code></pre>
 */
public class VkImportMetalIOSurfaceInfoEXT extends Struct implements NativeResource {
    ...
    public static VkImportMetalIOSurfaceInfoEXT malloc() {
        return wrap(VkImportMetalIOSurfaceInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkImportMetalIOSurfaceInfoEXT calloc() {
        return wrap(VkImportMetalIOSurfaceInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkImportMetalIOSurfaceInfoEXT create() {
        ...
        return wrap(VkImportMetalIOSurfaceInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkImportMetalIOSurfaceInfoEXT create(long address) {
        return wrap(VkImportMetalIOSurfaceInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkImportMetalIOSurfaceInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkImportMetalIOSurfaceInfoEXT.class, address);
    }
    ...
    public static VkImportMetalIOSurfaceInfoEXT malloc(MemoryStack stack) {
        return wrap(VkImportMetalIOSurfaceInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkImportMetalIOSurfaceInfoEXT calloc(MemoryStack stack) {
        return wrap(VkImportMetalIOSurfaceInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkImportMetalIOSurfaceInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkImportMetalIOSurfaceInfoEXT#SIZEOF}, and its mark will be undefined.
         *
