...
public class StdVideoEncodeH265ReferenceInfoFlags extends Struct<StdVideoEncodeH265ReferenceInfoFlags> implements NativeResource {
    ...
    public static @Nullable StdVideoEncodeH265ReferenceInfoFlags createSafe(long address) {
    ...
    public static StdVideoEncodeH265ReferenceInfoFlags.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoEncodeH265ReferenceInfoFlags.BITFIELD0); }
    ...
    static int nbitfield1(long struct) { return memGetInt(struct + StdVideoEncodeH265ReferenceInfoFlags.BITFIELD1); }
    static int nreserved(long struct) { return nbitfield1(struct) & 0x3F_FF_FF_FF; }

    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoEncodeH265ReferenceInfoFlags.BITFIELD0, value); }
    ...
    static void nbitfield1(long struct, int value) { memPutInt(struct + StdVideoEncodeH265ReferenceInfoFlags.BITFIELD1, value); }
    static void nreserved(long struct, int value) { nbitfield1(struct, (nbitfield1(struct) & 0xC0_00_00_00) | (value & 0x3F_FF_FF_FF)); }
