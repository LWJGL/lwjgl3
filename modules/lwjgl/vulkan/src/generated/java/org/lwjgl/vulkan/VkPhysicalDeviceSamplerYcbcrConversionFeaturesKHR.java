...
public class VkPhysicalDeviceSamplerYcbcrConversionFeaturesKHR extends VkPhysicalDeviceSamplerYcbcrConversionFeatures {
    ...
    /** Returns a new {@code VkPhysicalDeviceSamplerYcbcrConversionFeaturesKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceSamplerYcbcrConversionFeaturesKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceSamplerYcbcrConversionFeaturesKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
