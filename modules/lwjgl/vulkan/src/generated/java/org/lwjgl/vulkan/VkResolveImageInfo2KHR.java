 ...
 * <li>{@code srcImageLayout} &ndash; the layout of the source image subresources for the resolve.</li>
 * <li>{@code dstImage} &ndash; the destination image.</li>
 * <li>{@code dstImageLayout} &ndash; the layout of the destination image subresources for the resolve.</li>
 * <li>{@code regionCount} &ndash; the number of regions to resolve.</li>
 * <li>{@code pRegions} &ndash; a pointer to an array of {@link VkImageResolve2KHR} structures specifying the regions to resolve.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
 ...
 *     {@link VkImageResolve2KHR VkImageResolve2KHR} const * pRegions;
 * }</code></pre>
 */
public class VkResolveImageInfo2KHR extends Struct implements NativeResource {
    ...
    /** Returns a {@link VkImageResolve2KHR.Buffer} view of the struct array pointed to by the {@code pRegions} field. */
    ...
    /** Sets the address of the specified {@link VkImageResolve2KHR.Buffer} to the {@code pRegions} field. */
    ...
    /** Returns a new {@code VkResolveImageInfo2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkResolveImageInfo2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkResolveImageInfo2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkResolveImageInfo2KHR callocStack() {
     ...
     */
    public static VkResolveImageInfo2KHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkResolveImageInfo2KHR callocStack(MemoryStack stack) {
        return wrap(VkResolveImageInfo2KHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkResolveImageInfo2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkResolveImageInfo2KHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkResolveImageInfo2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkResolveImageInfo2KHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkResolveImageInfo2KHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkResolveImageInfo2KHR.Buffer callocStack(int capacity, MemoryStack stack) {
