...
public class VkAcquireNextImageInfoKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkAcquireNextImageInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkAcquireNextImageInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkAcquireNextImageInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
