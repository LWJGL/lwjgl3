...
public class VkAcquireNextImageInfoKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@link VkAcquireNextImageInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkAcquireNextImageInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link VkAcquireNextImageInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkAcquireNextImageInfoKHR callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link VkAcquireNextImageInfoKHR} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link VkAcquireNextImageInfoKHR} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link VkAcquireNextImageInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkAcquireNextImageInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
