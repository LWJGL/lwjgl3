...
public class VkPhysicalDevicePortabilitySubsetFeaturesKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPhysicalDevicePortabilitySubsetFeaturesKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDevicePortabilitySubsetFeaturesKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDevicePortabilitySubsetFeaturesKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDevicePortabilitySubsetFeaturesKHR callocStack() {
     ...
     */
    public static VkPhysicalDevicePortabilitySubsetFeaturesKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDevicePortabilitySubsetFeaturesKHR callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDevicePortabilitySubsetFeaturesKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDevicePortabilitySubsetFeaturesKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevicePortabilitySubsetFeaturesKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDevicePortabilitySubsetFeaturesKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevicePortabilitySubsetFeaturesKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevicePortabilitySubsetFeaturesKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevicePortabilitySubsetFeaturesKHR.Buffer callocStack(int capacity, MemoryStack stack) {
