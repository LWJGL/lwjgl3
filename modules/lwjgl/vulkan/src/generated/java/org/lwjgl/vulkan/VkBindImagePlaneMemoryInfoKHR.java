...
public class VkBindImagePlaneMemoryInfoKHR extends VkBindImagePlaneMemoryInfo {
    ...
    public static VkBindImagePlaneMemoryInfoKHR malloc() {
        return new VkBindImagePlaneMemoryInfoKHR(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkBindImagePlaneMemoryInfoKHR calloc() {
        return new VkBindImagePlaneMemoryInfoKHR(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkBindImagePlaneMemoryInfoKHR create() {
        ...
        return new VkBindImagePlaneMemoryInfoKHR(memAddress(container), container);
    }
    ...
    public static @Nullable VkBindImagePlaneMemoryInfoKHR createSafe(long address) {
        return address == NULL ? null : new VkBindImagePlaneMemoryInfoKHR(address, null);
    }
    ...
    public static VkBindImagePlaneMemoryInfoKHR.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends VkBindImagePlaneMemoryInfo.Buffer {
         ...
         * by {@link VkBindImagePlaneMemoryInfoKHR#SIZEOF}, and its mark will be undefined.</p>
         *
