...
public class VkVideoBeginCodingInfoKHR extends Struct implements NativeResource {
    ...
    public VkVideoBeginCodingInfoKHR pReferenceSlots(@NativeType("VkVideoReferenceSlotKHR const *") VkVideoReferenceSlotKHR.Buffer value) { npReferenceSlots(address(), value); return this; }
    ...
    /** Returns a new {@code VkVideoBeginCodingInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoBeginCodingInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoBeginCodingInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoBeginCodingInfoKHR callocStack() {
     ...
     */
    public static VkVideoBeginCodingInfoKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoBeginCodingInfoKHR callocStack(MemoryStack stack) {
        return wrap(VkVideoBeginCodingInfoKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoBeginCodingInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoBeginCodingInfoKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoBeginCodingInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoBeginCodingInfoKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoBeginCodingInfoKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoBeginCodingInfoKHR.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static VkVideoReferenceSlotKHR.Buffer npReferenceSlots(long struct) { return VkVideoReferenceSlotKHR.create(memGetAddress(struct + VkVideoBeginCodingInfoKHR.PREFERENCESLOTS), nreferenceSlotCount(struct)); }
    ...
    public static void npReferenceSlots(long struct, VkVideoReferenceSlotKHR.Buffer value) { memPutAddress(struct + VkVideoBeginCodingInfoKHR.PREFERENCESLOTS, value.address()); nreferenceSlotCount(struct, value.remaining()); }
    ...
    public static class Buffer extends StructBuffer<VkVideoBeginCodingInfoKHR, Buffer> implements NativeResource {
        ...
        public VkVideoBeginCodingInfoKHR.Buffer pReferenceSlots(@NativeType("VkVideoReferenceSlotKHR const *") VkVideoReferenceSlotKHR.Buffer value) { VkVideoBeginCodingInfoKHR.npReferenceSlots(address(), value); return this; }
