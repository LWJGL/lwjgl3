 ...
 * }</code></pre>
 */
public class VkSurfacePresentModeEXT extends Struct implements NativeResource {
    ...
    public static VkSurfacePresentModeEXT malloc() {
        return wrap(VkSurfacePresentModeEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkSurfacePresentModeEXT calloc() {
        return wrap(VkSurfacePresentModeEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkSurfacePresentModeEXT create() {
        ...
        return wrap(VkSurfacePresentModeEXT.class, memAddress(container), container);
    }
    ...
    public static VkSurfacePresentModeEXT create(long address) {
        return wrap(VkSurfacePresentModeEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkSurfacePresentModeEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkSurfacePresentModeEXT.class, address);
    }
    ...
    public static VkSurfacePresentModeEXT malloc(MemoryStack stack) {
        return wrap(VkSurfacePresentModeEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkSurfacePresentModeEXT calloc(MemoryStack stack) {
        return wrap(VkSurfacePresentModeEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkSurfacePresentModeEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkSurfacePresentModeEXT#SIZEOF}, and its mark will be undefined.
         *
