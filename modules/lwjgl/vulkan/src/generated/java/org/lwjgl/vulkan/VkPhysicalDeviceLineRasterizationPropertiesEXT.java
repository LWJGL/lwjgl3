...
public class VkPhysicalDeviceLineRasterizationPropertiesEXT extends Struct implements NativeResource {
    ...
    /** the number of bits of subpixel precision in framebuffer coordinates <code>x<sub>f</sub></code> and <code>y<sub>f</sub></code> when rasterizing <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#primsrast-lines">line segments</a>. */
    @NativeType("uint32_t")
