 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceLineRasterizationPropertiesEXT} structure is included in the {@code pNext} chain of {@link VkPhysicalDeviceProperties2}, it is filled with the implementation-dependent limits.</p>
 * 
 ...
 * <li>{@code lineSubPixelPrecisionBits} &ndash; the number of bits of subpixel precision in framebuffer coordinates <code>x<sub>f</sub></code> and <code>y<sub>f</sub></code> when rasterizing <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#primsrast-lines">line segments</a>.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceLineRasterizationPropertiesEXT extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code lineSubPixelPrecisionBits} field. */
    @NativeType("uint32_t")
    ...
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT malloc() {
        return wrap(VkPhysicalDeviceLineRasterizationPropertiesEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT calloc() {
        return wrap(VkPhysicalDeviceLineRasterizationPropertiesEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT create() {
        ...
        return wrap(VkPhysicalDeviceLineRasterizationPropertiesEXT.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT create(long address) {
        return wrap(VkPhysicalDeviceLineRasterizationPropertiesEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceLineRasterizationPropertiesEXT.class, address);
    }
    ...
    /** Returns a new {@code VkPhysicalDeviceLineRasterizationPropertiesEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceLineRasterizationPropertiesEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT callocStack() {
     ...
     */
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT mallocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceLineRasterizationPropertiesEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceLineRasterizationPropertiesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceLineRasterizationPropertiesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceLineRasterizationPropertiesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceLineRasterizationPropertiesEXT.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceLineRasterizationPropertiesEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceLineRasterizationPropertiesEXT#SIZEOF}, and its mark will be undefined.
         *
