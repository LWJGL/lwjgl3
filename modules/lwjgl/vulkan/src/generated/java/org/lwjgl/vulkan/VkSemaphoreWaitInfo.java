...
public class VkSemaphoreWaitInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkSemaphoreWaitInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSemaphoreWaitInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSemaphoreWaitInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkSemaphoreWaitInfo callocStack() {
     ...
     */
    public static VkSemaphoreWaitInfo mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkSemaphoreWaitInfo callocStack(MemoryStack stack) {
        return wrap(VkSemaphoreWaitInfo.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkSemaphoreWaitInfo.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkSemaphoreWaitInfo.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkSemaphoreWaitInfo.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkSemaphoreWaitInfo.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSemaphoreWaitInfo.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSemaphoreWaitInfo.Buffer callocStack(int capacity, MemoryStack stack) {
