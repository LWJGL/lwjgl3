...
public class VkDeviceGroupCommandBufferBeginInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkDeviceGroupCommandBufferBeginInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkDeviceGroupCommandBufferBeginInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkDeviceGroupCommandBufferBeginInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
