...
public class VkVideoEncodeH264ProfileEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkVideoEncodeH264ProfileEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoEncodeH264ProfileEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoEncodeH264ProfileEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoEncodeH264ProfileEXT callocStack() {
     ...
     */
    public static VkVideoEncodeH264ProfileEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoEncodeH264ProfileEXT callocStack(MemoryStack stack) {
        return wrap(VkVideoEncodeH264ProfileEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoEncodeH264ProfileEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264ProfileEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoEncodeH264ProfileEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264ProfileEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264ProfileEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264ProfileEXT.Buffer callocStack(int capacity, MemoryStack stack) {
