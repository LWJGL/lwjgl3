...
public class VkSubmitInfo2 extends Struct implements NativeResource {
    ...
    /** a pointer to an array of {@link VkSemaphoreSubmitInfo} structures defining <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#synchronization-semaphores-waiting">semaphore wait operations</a>. */
    @Nullable
    ...
    /** a pointer to an array of {@link VkSemaphoreSubmitInfo} describing <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#synchronization-semaphores-signaling">semaphore signal operations</a>. */
    @Nullable
    @NativeType("VkSemaphoreSubmitInfo const *")
