...
public class VkDisplayPlaneCapabilities2KHR extends Struct<VkDisplayPlaneCapabilities2KHR> implements NativeResource {
    ...
    public static VkDisplayPlaneCapabilities2KHR malloc() {
        return new VkDisplayPlaneCapabilities2KHR(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkDisplayPlaneCapabilities2KHR calloc() {
        return new VkDisplayPlaneCapabilities2KHR(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkDisplayPlaneCapabilities2KHR create() {
        ...
        return new VkDisplayPlaneCapabilities2KHR(memAddress(container), container);
    }
    ...
    public static VkDisplayPlaneCapabilities2KHR create(long address) {
        return new VkDisplayPlaneCapabilities2KHR(address, null);
    }
    ...
    @Deprecated public static VkDisplayPlaneCapabilities2KHR mallocStack() { return malloc(stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(MemoryStack)} instead. */
    @Deprecated public static VkDisplayPlaneCapabilities2KHR callocStack() { return calloc(stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(MemoryStack)} instead. */
    @Deprecated public static VkDisplayPlaneCapabilities2KHR mallocStack(MemoryStack stack) { return malloc(stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(MemoryStack)} instead. */
    @Deprecated public static VkDisplayPlaneCapabilities2KHR callocStack(MemoryStack stack) { return calloc(stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(int, MemoryStack)} instead. */
    @Deprecated public static VkDisplayPlaneCapabilities2KHR.Buffer mallocStack(int capacity) { return malloc(capacity, stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(int, MemoryStack)} instead. */
    @Deprecated public static VkDisplayPlaneCapabilities2KHR.Buffer callocStack(int capacity) { return calloc(capacity, stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(int, MemoryStack)} instead. */
    @Deprecated public static VkDisplayPlaneCapabilities2KHR.Buffer mallocStack(int capacity, MemoryStack stack) { return malloc(capacity, stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(int, MemoryStack)} instead. */
    @Deprecated public static VkDisplayPlaneCapabilities2KHR.Buffer callocStack(int capacity, MemoryStack stack) { return calloc(capacity, stack); }
     ...
     */
    public static VkDisplayPlaneCapabilities2KHR malloc(MemoryStack stack) {
        return new VkDisplayPlaneCapabilities2KHR(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
     ...
     * @param stack the stack from which to allocate
     */
    public static VkDisplayPlaneCapabilities2KHR calloc(MemoryStack stack) {
        return new VkDisplayPlaneCapabilities2KHR(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
     ...
     * @param capacity the buffer capacity
     */
    public static VkDisplayPlaneCapabilities2KHR.Buffer malloc(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDisplayPlaneCapabilities2KHR.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkDisplayPlaneCapabilities2KHR, Buffer> implements NativeResource {
         ...
         * by {@link VkDisplayPlaneCapabilities2KHR#SIZEOF}, and its mark will be undefined.</p>
         *
