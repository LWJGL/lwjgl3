 ...
 * }</code></pre>
 */
public class StdVideoEncodeH264WeightTableFlags extends Struct implements NativeResource {
    ...
    public static StdVideoEncodeH264WeightTableFlags malloc() {
        return wrap(StdVideoEncodeH264WeightTableFlags.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static StdVideoEncodeH264WeightTableFlags calloc() {
        return wrap(StdVideoEncodeH264WeightTableFlags.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static StdVideoEncodeH264WeightTableFlags create() {
        ...
        return wrap(StdVideoEncodeH264WeightTableFlags.class, memAddress(container), container);
    }
    ...
    public static StdVideoEncodeH264WeightTableFlags create(long address) {
        return wrap(StdVideoEncodeH264WeightTableFlags.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static StdVideoEncodeH264WeightTableFlags createSafe(long address) {
        return address == NULL ? null : wrap(StdVideoEncodeH264WeightTableFlags.class, address);
    }
    ...
    public static StdVideoEncodeH264WeightTableFlags malloc(MemoryStack stack) {
        return wrap(StdVideoEncodeH264WeightTableFlags.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static StdVideoEncodeH264WeightTableFlags calloc(MemoryStack stack) {
        return wrap(StdVideoEncodeH264WeightTableFlags.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<StdVideoEncodeH264WeightTableFlags, Buffer> implements NativeResource {
         ...
         * by {@link StdVideoEncodeH264WeightTableFlags#SIZEOF}, and its mark will be undefined.
         *
