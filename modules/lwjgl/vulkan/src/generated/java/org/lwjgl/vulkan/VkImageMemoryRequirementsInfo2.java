...
public class VkImageMemoryRequirementsInfo2 extends Struct<VkImageMemoryRequirementsInfo2> implements NativeResource {
    ...
    public static VkImageMemoryRequirementsInfo2 malloc() {
        return new VkImageMemoryRequirementsInfo2(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkImageMemoryRequirementsInfo2 calloc() {
        return new VkImageMemoryRequirementsInfo2(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkImageMemoryRequirementsInfo2 create() {
        ...
        return new VkImageMemoryRequirementsInfo2(memAddress(container), container);
    }
    ...
    public static @Nullable VkImageMemoryRequirementsInfo2 createSafe(long address) {
        return address == NULL ? null : new VkImageMemoryRequirementsInfo2(address, null);
    }
    ...
    public static VkImageMemoryRequirementsInfo2.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends StructBuffer<VkImageMemoryRequirementsInfo2, Buffer> implements NativeResource {
         ...
         * by {@link VkImageMemoryRequirementsInfo2#SIZEOF}, and its mark will be undefined.</p>
         *
