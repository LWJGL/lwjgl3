 ...
 * }</code></pre>
 */
public class VkMicromapUsageEXT extends Struct implements NativeResource {
    ...
    public static VkMicromapUsageEXT malloc() {
        return wrap(VkMicromapUsageEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkMicromapUsageEXT calloc() {
        return wrap(VkMicromapUsageEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkMicromapUsageEXT create() {
        ...
        return wrap(VkMicromapUsageEXT.class, memAddress(container), container);
    }
    ...
    public static VkMicromapUsageEXT create(long address) {
        return wrap(VkMicromapUsageEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkMicromapUsageEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkMicromapUsageEXT.class, address);
    }
    ...
    public static VkMicromapUsageEXT malloc(MemoryStack stack) {
        return wrap(VkMicromapUsageEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkMicromapUsageEXT calloc(MemoryStack stack) {
        return wrap(VkMicromapUsageEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkMicromapUsageEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkMicromapUsageEXT#SIZEOF}, and its mark will be undefined.
         *
