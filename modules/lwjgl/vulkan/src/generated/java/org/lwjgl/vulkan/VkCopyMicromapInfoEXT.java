 ...
 * }</code></pre>
 */
public class VkCopyMicromapInfoEXT extends Struct implements NativeResource {
    ...
    public static VkCopyMicromapInfoEXT malloc() {
        return wrap(VkCopyMicromapInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkCopyMicromapInfoEXT calloc() {
        return wrap(VkCopyMicromapInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkCopyMicromapInfoEXT create() {
        ...
        return wrap(VkCopyMicromapInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkCopyMicromapInfoEXT create(long address) {
        return wrap(VkCopyMicromapInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkCopyMicromapInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkCopyMicromapInfoEXT.class, address);
    }
    ...
    public static VkCopyMicromapInfoEXT malloc(MemoryStack stack) {
        return wrap(VkCopyMicromapInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkCopyMicromapInfoEXT calloc(MemoryStack stack) {
        return wrap(VkCopyMicromapInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkCopyMicromapInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkCopyMicromapInfoEXT#SIZEOF}, and its mark will be undefined.
         *
