 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceConditionalRenderingFeaturesEXT} structure is included in the {@code pNext} chain of flink:VkPhysicalDeviceFeatures2, it is filled with values indicating the implementation-dependent behavior. {@link VkPhysicalDeviceConditionalRenderingFeaturesEXT} <b>can</b> also be used in {@code pNext} chain of {@link VkDeviceCreateInfo} to enable the features.</p>
 * 
...
public class VkPhysicalDeviceConditionalRenderingFeaturesEXT extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code conditionalRendering} field. */
    @NativeType("VkBool32")
    public boolean conditionalRendering() { return nconditionalRendering(address()) != 0; }
    /** Returns the value of the {@code inheritedConditionalRendering} field. */
    @NativeType("VkBool32")
    ...
    /**
     * Returns a new {@link VkPhysicalDeviceConditionalRenderingFeaturesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceConditionalRenderingFeaturesEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceConditionalRenderingFeaturesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceConditionalRenderingFeaturesEXT.Buffer callocStack(int capacity) {
