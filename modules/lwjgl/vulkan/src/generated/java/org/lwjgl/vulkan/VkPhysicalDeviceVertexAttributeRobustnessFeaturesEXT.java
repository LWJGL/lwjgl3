...
/**
 * Structure describing whether the vertex attribute robustness feature is supported by an implementation.
 * 
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT} structure is included in the {@code pNext} chain of the {@link VkPhysicalDeviceFeatures2} structure passed to {@link VK11#vkGetPhysicalDeviceFeatures2 GetPhysicalDeviceFeatures2}, it is filled in to indicate whether each corresponding feature is supported. {@link VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT} <b>can</b> also be used in the {@code pNext} chain of {@link VkDeviceCreateInfo} to selectively enable these features.</p>
 * 
 * <h5>Valid Usage (Implicit)</h5>
 * 
 * <ul>
 * <li>{@code sType} <b>must</b> be {@link EXTVertexAttributeRobustness#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT}</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
 ...
 *     void * {@link #pNext};
 *     VkBool32 {@link #vertexAttributeRobustness};
 * }</code></pre>
 */
public class VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT extends Struct<VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT> implements NativeResource {
    ...
    /** indicates that vertex shaders <b>can</b> read vertex attribute locations that have no vertex attribute description and the value returned is (0,0,0,0) or (0,0,0,1). */
    @NativeType("VkBool32")
    ...
    /** Sets the {@link EXTVertexAttributeRobustness#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT} value to the {@link #sType} field. */
    ...
    /** Sets the specified value to the {@link #vertexAttributeRobustness} field. */
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@link VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT#sType} field. */
        @NativeType("VkStructureType")
        public int sType() { return VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT.nsType(address()); }
        /** @return the value of the {@link VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT#pNext} field. */
        @NativeType("void *")
        public long pNext() { return VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT.npNext(address()); }
        /** @return the value of the {@link VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT#vertexAttributeRobustness} field. */
        @NativeType("VkBool32")
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT#sType} field. */
        ...
        /** Sets the {@link EXTVertexAttributeRobustness#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT} value to the {@link VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT#sType} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT#pNext} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT#vertexAttributeRobustness} field. */
