 ...
 * <h5>Description</h5>
 * 
 * <p>If {@code presentScaling} is 0, the result of presenting a swapchain image with dimensions that do not match the surface dimensions is implementation and platform-dependent. If {@code presentGravityX} or {@code presentGravityY} are 0, the presentation gravity <b>must</b> match that defined by the native platform surface on platforms which define surface gravity.</p>
 * 
 * <h5>Valid Usage</h5>
 * 
 * <ul>
 ...
 * <li>{@code presentScaling} <b>must</b> be a valid scaling method for the surface as returned in {@link VkSurfacePresentScalingCapabilitiesEXT}{@code ::supportedPresentScaling}, given {@link VkSwapchainCreateInfoKHR}{@code ::presentMode} in {@link VkSurfacePresentModeEXT}</li>
 * <li>If the swapchain is created with {@link VkSwapchainPresentModesCreateInfoEXT}, {@code presentScaling} <b>must</b> be a valid scaling method for the surface as returned in {@link VkSurfacePresentScalingCapabilitiesEXT}{@code ::supportedPresentScaling}, given each present mode in {@link VkSwapchainPresentModesCreateInfoEXT}{@code ::pPresentModes} in {@link VkSurfacePresentModeEXT}</li>
 ...
 * }</code></pre>
 */
public class VkSwapchainPresentScalingCreateInfoEXT extends Struct implements NativeResource {
    ...
    public static VkSwapchainPresentScalingCreateInfoEXT malloc() {
        return wrap(VkSwapchainPresentScalingCreateInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkSwapchainPresentScalingCreateInfoEXT calloc() {
        return wrap(VkSwapchainPresentScalingCreateInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkSwapchainPresentScalingCreateInfoEXT create() {
        ...
        return wrap(VkSwapchainPresentScalingCreateInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkSwapchainPresentScalingCreateInfoEXT create(long address) {
        return wrap(VkSwapchainPresentScalingCreateInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkSwapchainPresentScalingCreateInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkSwapchainPresentScalingCreateInfoEXT.class, address);
    }
    ...
    public static VkSwapchainPresentScalingCreateInfoEXT malloc(MemoryStack stack) {
        return wrap(VkSwapchainPresentScalingCreateInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkSwapchainPresentScalingCreateInfoEXT calloc(MemoryStack stack) {
        return wrap(VkSwapchainPresentScalingCreateInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkSwapchainPresentScalingCreateInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkSwapchainPresentScalingCreateInfoEXT#SIZEOF}, and its mark will be undefined.
         *
