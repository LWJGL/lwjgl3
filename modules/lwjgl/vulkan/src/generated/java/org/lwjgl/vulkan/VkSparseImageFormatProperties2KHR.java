...
public class VkSparseImageFormatProperties2KHR extends VkSparseImageFormatProperties2 {
    ...
    /** Returns a new {@code VkSparseImageFormatProperties2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSparseImageFormatProperties2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSparseImageFormatProperties2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
