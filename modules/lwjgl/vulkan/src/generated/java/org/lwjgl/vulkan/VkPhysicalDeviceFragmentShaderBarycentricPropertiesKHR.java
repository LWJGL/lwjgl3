 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR extends Struct implements NativeResource {
    ...
    /** indicates that the implementation does not change its vertex numbering for triangle strip primitives when the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#vertexpostproc-flatshading">provoking vertex mode</a> is {@link EXTProvokingVertex#VK_PROVOKING_VERTEX_MODE_LAST_VERTEX_EXT PROVOKING_VERTEX_MODE_LAST_VERTEX_EXT}, as shown in the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#primsrast-barycentric-order-table-last-vertex">last vertex table</a>. */
    @NativeType("VkBool32")
    ...
    public static VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR malloc() {
        return wrap(VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR calloc() {
        return wrap(VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR create() {
        ...
        return wrap(VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR create(long address) {
        return wrap(VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.class, address);
    }
    ...
    public static VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR#SIZEOF}, and its mark will be undefined.
         *
