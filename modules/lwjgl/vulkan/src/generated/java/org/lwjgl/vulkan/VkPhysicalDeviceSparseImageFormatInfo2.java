...
public class VkPhysicalDeviceSparseImageFormatInfo2 extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPhysicalDeviceSparseImageFormatInfo2} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceSparseImageFormatInfo2 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceSparseImageFormatInfo2} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
