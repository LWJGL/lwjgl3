 ...
 * <li>{@code colorSamples} &ndash; specifies the number of color samples in a color attachment in the supported combination. A value of 0 indicates the combination does not have a color attachment.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkFramebufferMixedSamplesCombinationNV extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code depthStencilSamples} field. */
    @NativeType("VkSampleCountFlags")
    public int depthStencilSamples() { return ndepthStencilSamples(address()); }
    /** Returns the value of the {@code colorSamples} field. */
    @NativeType("VkSampleCountFlags")
    ...
    /** Returns a new {@code VkFramebufferMixedSamplesCombinationNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkFramebufferMixedSamplesCombinationNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkFramebufferMixedSamplesCombinationNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     */
    public static VkFramebufferMixedSamplesCombinationNV mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkFramebufferMixedSamplesCombinationNV callocStack(MemoryStack stack) {
        return wrap(VkFramebufferMixedSamplesCombinationNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkFramebufferMixedSamplesCombinationNV.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkFramebufferMixedSamplesCombinationNV.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static VkFramebufferMixedSamplesCombinationNV.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkFramebufferMixedSamplesCombinationNV.Buffer callocStack(int capacity, MemoryStack stack) {
