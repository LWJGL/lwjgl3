...
public class VkSubpassEndInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkSubpassEndInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSubpassEndInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSubpassEndInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    ...
    /**
     * Returns a new {@link VkSubpassEndInfo.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkSubpassEndInfo.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkSubpassEndInfo.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkSubpassEndInfo.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSubpassEndInfo.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSubpassEndInfo.Buffer callocStack(int capacity, MemoryStack stack) {
