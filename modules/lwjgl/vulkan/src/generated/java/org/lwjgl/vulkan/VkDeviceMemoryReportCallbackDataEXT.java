...
public class VkDeviceMemoryReportCallbackDataEXT extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code memoryObjectId} field. */
    @NativeType("uint64_t")
    ...
    /** Returns a new {@code VkDeviceMemoryReportCallbackDataEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkDeviceMemoryReportCallbackDataEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkDeviceMemoryReportCallbackDataEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkDeviceMemoryReportCallbackDataEXT callocStack() {
     ...
     */
    public static VkDeviceMemoryReportCallbackDataEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkDeviceMemoryReportCallbackDataEXT callocStack(MemoryStack stack) {
        return wrap(VkDeviceMemoryReportCallbackDataEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkDeviceMemoryReportCallbackDataEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkDeviceMemoryReportCallbackDataEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkDeviceMemoryReportCallbackDataEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkDeviceMemoryReportCallbackDataEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceMemoryReportCallbackDataEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceMemoryReportCallbackDataEXT.Buffer callocStack(int capacity, MemoryStack stack) {
