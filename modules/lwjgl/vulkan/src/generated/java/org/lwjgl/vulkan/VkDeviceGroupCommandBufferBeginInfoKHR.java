...
public class VkDeviceGroupCommandBufferBeginInfoKHR extends VkDeviceGroupCommandBufferBeginInfo {
    ...
    VkDeviceGroupCommandBufferBeginInfoKHR(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    /**
     * Creates a {@link VkDeviceGroupCommandBufferBeginInfoKHR} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link VkDeviceGroupCommandBufferBeginInfoKHR} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static VkDeviceGroupCommandBufferBeginInfoKHR malloc() {
        return create(nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link VkDeviceGroupCommandBufferBeginInfoKHR} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static VkDeviceGroupCommandBufferBeginInfoKHR calloc() {
        return create(nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link VkDeviceGroupCommandBufferBeginInfoKHR} instance allocated with {@link BufferUtils}. */
    public static VkDeviceGroupCommandBufferBeginInfoKHR create() {
        return new VkDeviceGroupCommandBufferBeginInfoKHR(BufferUtils.createByteBuffer(SIZEOF));
    }

    /** Returns a new {@link VkDeviceGroupCommandBufferBeginInfoKHR} instance for the specified memory address. */
    ...
    /** Returns a new {@link VkDeviceGroupCommandBufferBeginInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkDeviceGroupCommandBufferBeginInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link VkDeviceGroupCommandBufferBeginInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkDeviceGroupCommandBufferBeginInfoKHR callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link VkDeviceGroupCommandBufferBeginInfoKHR} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack the stack from which to allocate
     */
    public static VkDeviceGroupCommandBufferBeginInfoKHR mallocStack(MemoryStack stack) {
        return create(stack.nmalloc(ALIGNOF, SIZEOF));
    }

    /**
     * Returns a new {@link VkDeviceGroupCommandBufferBeginInfoKHR} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    public static VkDeviceGroupCommandBufferBeginInfoKHR callocStack(MemoryStack stack) {
        return create(stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkDeviceGroupCommandBufferBeginInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkDeviceGroupCommandBufferBeginInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupCommandBufferBeginInfoKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupCommandBufferBeginInfoKHR.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends VkDeviceGroupCommandBufferBeginInfo.Buffer {
        ...
        /**
         * Creates a new {@link VkDeviceGroupCommandBufferBeginInfoKHR.Buffer} instance backed by the specified container.
         *
        ...
        @Override
        protected VkDeviceGroupCommandBufferBeginInfoKHR newInstance(long address) {
            return new VkDeviceGroupCommandBufferBeginInfoKHR(address, container);
        }
