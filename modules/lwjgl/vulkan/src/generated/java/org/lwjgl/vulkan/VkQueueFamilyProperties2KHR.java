...
public class VkQueueFamilyProperties2KHR extends VkQueueFamilyProperties2 {
    ...
    /** Returns a new {@code VkQueueFamilyProperties2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkQueueFamilyProperties2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkQueueFamilyProperties2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
