...
public class StdVideoEncodeH264PictureInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code StdVideoEncodeH264PictureInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static StdVideoEncodeH264PictureInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code StdVideoEncodeH264PictureInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static StdVideoEncodeH264PictureInfo callocStack() {
     ...
     */
    public static StdVideoEncodeH264PictureInfo mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static StdVideoEncodeH264PictureInfo callocStack(MemoryStack stack) {
        return wrap(StdVideoEncodeH264PictureInfo.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link StdVideoEncodeH264PictureInfo.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoEncodeH264PictureInfo.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link StdVideoEncodeH264PictureInfo.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoEncodeH264PictureInfo.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoEncodeH264PictureInfo.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoEncodeH264PictureInfo.Buffer callocStack(int capacity, MemoryStack stack) {
