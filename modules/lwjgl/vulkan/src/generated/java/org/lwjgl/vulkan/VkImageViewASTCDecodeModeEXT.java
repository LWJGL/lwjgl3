 ...
 * <li>If the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#features-features-astc-decodeModeSharedExponent">{@code decodeModeSharedExponent}</a> feature is not enabled, {@code decodeMode} <b>must</b> not be {@link VK10#VK_FORMAT_E5B9G9R9_UFLOAT_PACK32 FORMAT_E5B9G9R9_UFLOAT_PACK32}</li>
...
public class VkImageViewASTCDecodeModeEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkImageViewASTCDecodeModeEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkImageViewASTCDecodeModeEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkImageViewASTCDecodeModeEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
