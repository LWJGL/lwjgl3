 ...
 * }</code></pre>
 */
public class VkExportMetalObjectsInfoEXT extends Struct implements NativeResource {
    ...
    public static VkExportMetalObjectsInfoEXT malloc() {
        return wrap(VkExportMetalObjectsInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkExportMetalObjectsInfoEXT calloc() {
        return wrap(VkExportMetalObjectsInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkExportMetalObjectsInfoEXT create() {
        ...
        return wrap(VkExportMetalObjectsInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkExportMetalObjectsInfoEXT create(long address) {
        return wrap(VkExportMetalObjectsInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkExportMetalObjectsInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkExportMetalObjectsInfoEXT.class, address);
    }
    ...
    public static VkExportMetalObjectsInfoEXT malloc(MemoryStack stack) {
        return wrap(VkExportMetalObjectsInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkExportMetalObjectsInfoEXT calloc(MemoryStack stack) {
        return wrap(VkExportMetalObjectsInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkExportMetalObjectsInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkExportMetalObjectsInfoEXT#SIZEOF}, and its mark will be undefined.
         *
