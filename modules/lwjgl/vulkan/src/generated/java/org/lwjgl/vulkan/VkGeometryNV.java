...
public class VkGeometryNV extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link VkGeometryNV} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link VkGeometryNV} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static VkGeometryNV malloc() {
        return wrap(VkGeometryNV.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link VkGeometryNV} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static VkGeometryNV calloc() {
        return wrap(VkGeometryNV.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link VkGeometryNV} instance allocated with {@link BufferUtils}. */
    public static VkGeometryNV create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(VkGeometryNV.class, memAddress(container), container);
    }

    /** Returns a new {@link VkGeometryNV} instance for the specified memory address. */
    ...
    /** Returns a new {@link VkGeometryNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkGeometryNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link VkGeometryNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkGeometryNV callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link VkGeometryNV} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link VkGeometryNV} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<VkGeometryNV, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link VkGeometryNV.Buffer} instance backed by the specified container.
         *
