 ...
 * </ul>
 * 
 * <p>Note that the stages at which a checkpoint marker <b>can</b> be executed are implementation-defined and <b>can</b> be queried by calling {@code vkGetPhysicalDeviceQueueFamilyProperties2}.</p>
 * 
 * <h5>See Also</h5>
 * 
...
public class VkCheckpointDataNV extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code pCheckpointMarker} field. */
    @NativeType("void *")
    ...
    /**
     * Returns a new {@link VkCheckpointDataNV.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkCheckpointDataNV.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
