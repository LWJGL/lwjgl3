...
public class VkPhysicalDeviceFeatures extends Struct implements NativeResource {
    ...
    /** specifies whether storage images require a format qualifier to be specified when reading. {@code shaderStorageImageReadWithoutFormat} applies only to formats listed in the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#formats-without-shader-storage-format">storage without format</a> list. */
    @NativeType("VkBool32")
