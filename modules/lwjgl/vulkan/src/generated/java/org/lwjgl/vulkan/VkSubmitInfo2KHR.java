...
public class VkSubmitInfo2KHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkSubmitInfo2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSubmitInfo2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSubmitInfo2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkSubmitInfo2KHR callocStack() {
     ...
     */
    public static VkSubmitInfo2KHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkSubmitInfo2KHR callocStack(MemoryStack stack) {
        return wrap(VkSubmitInfo2KHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkSubmitInfo2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkSubmitInfo2KHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkSubmitInfo2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkSubmitInfo2KHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSubmitInfo2KHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSubmitInfo2KHR.Buffer callocStack(int capacity, MemoryStack stack) {
