...
public class VkPhysicalDeviceVulkanMemoryModelFeatures extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPhysicalDeviceVulkanMemoryModelFeatures} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceVulkanMemoryModelFeatures mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceVulkanMemoryModelFeatures} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDeviceVulkanMemoryModelFeatures callocStack() {
     ...
     */
    public static VkPhysicalDeviceVulkanMemoryModelFeatures mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceVulkanMemoryModelFeatures callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceVulkanMemoryModelFeatures.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceVulkanMemoryModelFeatures.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceVulkanMemoryModelFeatures.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceVulkanMemoryModelFeatures.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceVulkanMemoryModelFeatures.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceVulkanMemoryModelFeatures.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceVulkanMemoryModelFeatures.Buffer callocStack(int capacity, MemoryStack stack) {
