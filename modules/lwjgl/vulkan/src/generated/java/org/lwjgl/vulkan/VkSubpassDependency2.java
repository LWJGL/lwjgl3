...
public class VkSubpassDependency2 extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkSubpassDependency2} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSubpassDependency2 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSubpassDependency2} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkSubpassDependency2 callocStack() {
     ...
     */
    public static VkSubpassDependency2 mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkSubpassDependency2 callocStack(MemoryStack stack) {
        return wrap(VkSubpassDependency2.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkSubpassDependency2.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkSubpassDependency2.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkSubpassDependency2.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkSubpassDependency2.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSubpassDependency2.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSubpassDependency2.Buffer callocStack(int capacity, MemoryStack stack) {
