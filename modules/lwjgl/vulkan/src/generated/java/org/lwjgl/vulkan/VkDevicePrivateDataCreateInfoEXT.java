 ...
 * <li>{@code privateDataSlotRequestCount} &ndash; the amount of slots to reserve.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkDevicePrivateDataCreateInfoEXT extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code privateDataSlotRequestCount} field. */
    @NativeType("uint32_t")
    ...
    /** Returns a new {@code VkDevicePrivateDataCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkDevicePrivateDataCreateInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkDevicePrivateDataCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkDevicePrivateDataCreateInfoEXT callocStack() {
     ...
     */
    public static VkDevicePrivateDataCreateInfoEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkDevicePrivateDataCreateInfoEXT callocStack(MemoryStack stack) {
        return wrap(VkDevicePrivateDataCreateInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkDevicePrivateDataCreateInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkDevicePrivateDataCreateInfoEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkDevicePrivateDataCreateInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkDevicePrivateDataCreateInfoEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDevicePrivateDataCreateInfoEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDevicePrivateDataCreateInfoEXT.Buffer callocStack(int capacity, MemoryStack stack) {
