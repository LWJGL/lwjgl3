...
public class StdVideoDecodeAV1PictureInfoFlags extends Struct<StdVideoDecodeAV1PictureInfoFlags> implements NativeResource {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoDecodeAV1PictureInfoFlags.BITFIELD0); }
    ...
    static int nbitfield1(long struct) { return memGetInt(struct + StdVideoDecodeAV1PictureInfoFlags.BITFIELD1); }
    static int nreserved(long struct) { return nbitfield1(struct) & 0x00_00_00_07; }

    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoDecodeAV1PictureInfoFlags.BITFIELD0, value); }
    ...
    static void nbitfield1(long struct, int value) { memPutInt(struct + StdVideoDecodeAV1PictureInfoFlags.BITFIELD1, value); }
