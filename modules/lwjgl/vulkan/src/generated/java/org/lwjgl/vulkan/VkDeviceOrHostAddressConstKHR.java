 ...
 * <li>{@code hostAddress} &ndash; a const host memory address.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkDeviceOrHostAddressConstKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkDeviceOrHostAddressConstKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkDeviceOrHostAddressConstKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkDeviceOrHostAddressConstKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkDeviceOrHostAddressConstKHR callocStack() {
     ...
     */
    public static VkDeviceOrHostAddressConstKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkDeviceOrHostAddressConstKHR callocStack(MemoryStack stack) {
        return wrap(VkDeviceOrHostAddressConstKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkDeviceOrHostAddressConstKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkDeviceOrHostAddressConstKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkDeviceOrHostAddressConstKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkDeviceOrHostAddressConstKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceOrHostAddressConstKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceOrHostAddressConstKHR.Buffer callocStack(int capacity, MemoryStack stack) {
