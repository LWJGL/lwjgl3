...
public class VkMemoryHostPointerPropertiesEXT extends Struct implements NativeResource {
     ...
     * @param capacity the buffer capacity
     */
    public static VkMemoryHostPointerPropertiesEXT.Buffer mallocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkMemoryHostPointerPropertiesEXT.Buffer callocStack(int capacity) {
