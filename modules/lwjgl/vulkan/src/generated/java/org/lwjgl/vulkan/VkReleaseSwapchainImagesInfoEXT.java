 ...
 * }</code></pre>
 */
public class VkReleaseSwapchainImagesInfoEXT extends Struct implements NativeResource {
    ...
    public static VkReleaseSwapchainImagesInfoEXT malloc() {
        return wrap(VkReleaseSwapchainImagesInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkReleaseSwapchainImagesInfoEXT calloc() {
        return wrap(VkReleaseSwapchainImagesInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkReleaseSwapchainImagesInfoEXT create() {
        ...
        return wrap(VkReleaseSwapchainImagesInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkReleaseSwapchainImagesInfoEXT create(long address) {
        return wrap(VkReleaseSwapchainImagesInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkReleaseSwapchainImagesInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkReleaseSwapchainImagesInfoEXT.class, address);
    }
    ...
    public static VkReleaseSwapchainImagesInfoEXT malloc(MemoryStack stack) {
        return wrap(VkReleaseSwapchainImagesInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkReleaseSwapchainImagesInfoEXT calloc(MemoryStack stack) {
        return wrap(VkReleaseSwapchainImagesInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkReleaseSwapchainImagesInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkReleaseSwapchainImagesInfoEXT#SIZEOF}, and its mark will be undefined.
         *
