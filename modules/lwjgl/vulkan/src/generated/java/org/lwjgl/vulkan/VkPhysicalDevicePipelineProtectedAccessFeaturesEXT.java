 ...
 * }</code></pre>
 */
public class VkPhysicalDevicePipelineProtectedAccessFeaturesEXT extends Struct implements NativeResource {
    ...
    public static VkPhysicalDevicePipelineProtectedAccessFeaturesEXT malloc() {
        return wrap(VkPhysicalDevicePipelineProtectedAccessFeaturesEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDevicePipelineProtectedAccessFeaturesEXT calloc() {
        return wrap(VkPhysicalDevicePipelineProtectedAccessFeaturesEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDevicePipelineProtectedAccessFeaturesEXT create() {
        ...
        return wrap(VkPhysicalDevicePipelineProtectedAccessFeaturesEXT.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDevicePipelineProtectedAccessFeaturesEXT create(long address) {
        return wrap(VkPhysicalDevicePipelineProtectedAccessFeaturesEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDevicePipelineProtectedAccessFeaturesEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDevicePipelineProtectedAccessFeaturesEXT.class, address);
    }
    ...
    @Nullable
    public static VkPhysicalDevicePipelineProtectedAccessFeaturesEXT.Buffer createSafe(long address, int capacity) {
    ...
    public static VkPhysicalDevicePipelineProtectedAccessFeaturesEXT malloc(MemoryStack stack) {
        return wrap(VkPhysicalDevicePipelineProtectedAccessFeaturesEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDevicePipelineProtectedAccessFeaturesEXT calloc(MemoryStack stack) {
        return wrap(VkPhysicalDevicePipelineProtectedAccessFeaturesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDevicePipelineProtectedAccessFeaturesEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDevicePipelineProtectedAccessFeaturesEXT#SIZEOF}, and its mark will be undefined.
         *
