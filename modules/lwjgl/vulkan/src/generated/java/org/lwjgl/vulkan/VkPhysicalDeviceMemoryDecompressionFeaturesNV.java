 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceMemoryDecompressionFeaturesNV extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceMemoryDecompressionFeaturesNV malloc() {
        return wrap(VkPhysicalDeviceMemoryDecompressionFeaturesNV.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceMemoryDecompressionFeaturesNV calloc() {
        return wrap(VkPhysicalDeviceMemoryDecompressionFeaturesNV.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceMemoryDecompressionFeaturesNV create() {
        ...
        return wrap(VkPhysicalDeviceMemoryDecompressionFeaturesNV.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceMemoryDecompressionFeaturesNV create(long address) {
        return wrap(VkPhysicalDeviceMemoryDecompressionFeaturesNV.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceMemoryDecompressionFeaturesNV createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceMemoryDecompressionFeaturesNV.class, address);
    }
    ...
    public static VkPhysicalDeviceMemoryDecompressionFeaturesNV malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceMemoryDecompressionFeaturesNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceMemoryDecompressionFeaturesNV calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceMemoryDecompressionFeaturesNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceMemoryDecompressionFeaturesNV, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceMemoryDecompressionFeaturesNV#SIZEOF}, and its mark will be undefined.
         *
