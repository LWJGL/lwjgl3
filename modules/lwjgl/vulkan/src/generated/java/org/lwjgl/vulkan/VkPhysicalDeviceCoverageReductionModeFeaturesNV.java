...
public class VkPhysicalDeviceCoverageReductionModeFeaturesNV extends Struct implements NativeResource {
    ...
    /** indicates whether the implementation supports coverage reduction modes. See <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#fragops-coverage-reduction">Coverage Reduction</a>. */
    @NativeType("VkBool32")
