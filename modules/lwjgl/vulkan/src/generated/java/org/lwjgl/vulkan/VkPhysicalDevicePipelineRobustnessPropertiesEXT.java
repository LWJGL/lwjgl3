...
public class VkPhysicalDevicePipelineRobustnessPropertiesEXT extends Struct<VkPhysicalDevicePipelineRobustnessPropertiesEXT> implements NativeResource {
    ...
    public static VkPhysicalDevicePipelineRobustnessPropertiesEXT malloc() {
        return new VkPhysicalDevicePipelineRobustnessPropertiesEXT(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkPhysicalDevicePipelineRobustnessPropertiesEXT calloc() {
        return new VkPhysicalDevicePipelineRobustnessPropertiesEXT(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkPhysicalDevicePipelineRobustnessPropertiesEXT create() {
        ...
        return new VkPhysicalDevicePipelineRobustnessPropertiesEXT(memAddress(container), container);
    }
    ...
    public static VkPhysicalDevicePipelineRobustnessPropertiesEXT create(long address) {
        return new VkPhysicalDevicePipelineRobustnessPropertiesEXT(address, null);
    }
    ...
    public static VkPhysicalDevicePipelineRobustnessPropertiesEXT malloc(MemoryStack stack) {
        return new VkPhysicalDevicePipelineRobustnessPropertiesEXT(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkPhysicalDevicePipelineRobustnessPropertiesEXT calloc(MemoryStack stack) {
        return new VkPhysicalDevicePipelineRobustnessPropertiesEXT(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDevicePipelineRobustnessPropertiesEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDevicePipelineRobustnessPropertiesEXT#SIZEOF}, and its mark will be undefined.</p>
         *
