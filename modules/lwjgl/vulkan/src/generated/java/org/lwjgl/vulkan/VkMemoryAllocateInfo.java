 ...
 * <h5>Description</h5>
 * 
 * <p>A {@link VkMemoryAllocateInfo} structure defines a memory import operation if its {@code pNext} chain includes one of the following structures:</p>
 * 
 * <ul>
 ...
 * <li>If {@link VkMemoryOpaqueCaptureAddressAllocateInfoKHR}{@code ::opaqueCaptureAddress} is not zero, {@link VkMemoryAllocateFlagsInfo}{@code ::flags} <b>must</b> include {@link KHRBufferDeviceAddress#VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR}</li>
 * <li>If {@link VkMemoryAllocateFlagsInfo}{@code ::flags} includes {@link KHRBufferDeviceAddress#VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR}, the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#features-bufferDeviceAddressCaptureReplay">bufferDeviceAddressCaptureReplay</a> feature <b>must</b> be enabled</li>
 * <li>If {@link VkMemoryAllocateFlagsInfo}{@code ::flags} includes {@link KHRBufferDeviceAddress#VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT_KHR MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT_KHR}, the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#features-bufferDeviceAddress">bufferDeviceAddress</a> feature <b>must</b> be enabled</li>
 * <li>If the {@code pNext} chain includes a {@link VkImportMemoryHostPointerInfoEXT} structure, {@link VkMemoryOpaqueCaptureAddressAllocateInfoKHR}{@code ::opaqueCaptureAddress} <b>must</b> be zero</li>
 * <li>If the parameters define an import operation, {@link VkMemoryOpaqueCaptureAddressAllocateInfoKHR}{@code ::opaqueCaptureAddress} <b>must</b> be zero</li>
 * </ul>
 * 
...
public class VkMemoryAllocateInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkMemoryAllocateInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkMemoryAllocateInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkMemoryAllocateInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
