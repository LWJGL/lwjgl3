...
public class VkSurfaceCapabilitiesFullScreenExclusiveEXT extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code fullScreenExclusiveSupported} field. */
    @NativeType("VkBool32")
    ...
    /** Returns a new {@code VkSurfaceCapabilitiesFullScreenExclusiveEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSurfaceCapabilitiesFullScreenExclusiveEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSurfaceCapabilitiesFullScreenExclusiveEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     */
    public static VkSurfaceCapabilitiesFullScreenExclusiveEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkSurfaceCapabilitiesFullScreenExclusiveEXT callocStack(MemoryStack stack) {
        return wrap(VkSurfaceCapabilitiesFullScreenExclusiveEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkSurfaceCapabilitiesFullScreenExclusiveEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkSurfaceCapabilitiesFullScreenExclusiveEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static VkSurfaceCapabilitiesFullScreenExclusiveEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSurfaceCapabilitiesFullScreenExclusiveEXT.Buffer callocStack(int capacity, MemoryStack stack) {
