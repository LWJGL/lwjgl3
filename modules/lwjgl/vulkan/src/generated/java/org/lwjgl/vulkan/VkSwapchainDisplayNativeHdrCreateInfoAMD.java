...
public class VkSwapchainDisplayNativeHdrCreateInfoAMD extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code localDimmingEnable} field. */
    @NativeType("VkBool32")
    ...
    /** Returns a new {@code VkSwapchainDisplayNativeHdrCreateInfoAMD} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSwapchainDisplayNativeHdrCreateInfoAMD mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSwapchainDisplayNativeHdrCreateInfoAMD} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkSwapchainDisplayNativeHdrCreateInfoAMD callocStack() {
     ...
     */
    public static VkSwapchainDisplayNativeHdrCreateInfoAMD mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkSwapchainDisplayNativeHdrCreateInfoAMD callocStack(MemoryStack stack) {
        return wrap(VkSwapchainDisplayNativeHdrCreateInfoAMD.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkSwapchainDisplayNativeHdrCreateInfoAMD.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkSwapchainDisplayNativeHdrCreateInfoAMD.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkSwapchainDisplayNativeHdrCreateInfoAMD.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkSwapchainDisplayNativeHdrCreateInfoAMD.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSwapchainDisplayNativeHdrCreateInfoAMD.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSwapchainDisplayNativeHdrCreateInfoAMD.Buffer callocStack(int capacity, MemoryStack stack) {
