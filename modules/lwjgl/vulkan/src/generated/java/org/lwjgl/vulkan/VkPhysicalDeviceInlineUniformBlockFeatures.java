 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceInlineUniformBlockFeatures extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceInlineUniformBlockFeatures malloc() {
        return wrap(VkPhysicalDeviceInlineUniformBlockFeatures.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceInlineUniformBlockFeatures calloc() {
        return wrap(VkPhysicalDeviceInlineUniformBlockFeatures.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceInlineUniformBlockFeatures create() {
        ...
        return wrap(VkPhysicalDeviceInlineUniformBlockFeatures.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceInlineUniformBlockFeatures create(long address) {
        return wrap(VkPhysicalDeviceInlineUniformBlockFeatures.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceInlineUniformBlockFeatures createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceInlineUniformBlockFeatures.class, address);
    }
    ...
    public static VkPhysicalDeviceInlineUniformBlockFeatures malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceInlineUniformBlockFeatures.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceInlineUniformBlockFeatures calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceInlineUniformBlockFeatures.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceInlineUniformBlockFeatures, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceInlineUniformBlockFeatures#SIZEOF}, and its mark will be undefined.
         *
