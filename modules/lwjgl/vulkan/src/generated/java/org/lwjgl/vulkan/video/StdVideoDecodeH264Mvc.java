...
public class StdVideoDecodeH264Mvc extends Struct implements NativeResource {
    ...
    /** Returns a new {@code StdVideoDecodeH264Mvc} instance allocated on the thread-local {@link MemoryStack}. */
    public static StdVideoDecodeH264Mvc mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code StdVideoDecodeH264Mvc} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static StdVideoDecodeH264Mvc callocStack() {
     ...
     */
    public static StdVideoDecodeH264Mvc mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static StdVideoDecodeH264Mvc callocStack(MemoryStack stack) {
        return wrap(StdVideoDecodeH264Mvc.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link StdVideoDecodeH264Mvc.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoDecodeH264Mvc.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link StdVideoDecodeH264Mvc.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoDecodeH264Mvc.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoDecodeH264Mvc.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoDecodeH264Mvc.Buffer callocStack(int capacity, MemoryStack stack) {
