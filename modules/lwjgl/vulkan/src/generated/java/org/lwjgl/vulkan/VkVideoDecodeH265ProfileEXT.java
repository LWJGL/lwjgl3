...
public class VkVideoDecodeH265ProfileEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkVideoDecodeH265ProfileEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoDecodeH265ProfileEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoDecodeH265ProfileEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoDecodeH265ProfileEXT callocStack() {
     ...
     */
    public static VkVideoDecodeH265ProfileEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoDecodeH265ProfileEXT callocStack(MemoryStack stack) {
        return wrap(VkVideoDecodeH265ProfileEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoDecodeH265ProfileEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH265ProfileEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoDecodeH265ProfileEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH265ProfileEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH265ProfileEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH265ProfileEXT.Buffer callocStack(int capacity, MemoryStack stack) {
