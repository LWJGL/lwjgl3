...
public class VkImageFormatProperties2KHR extends VkImageFormatProperties2 {
    ...
    public static VkImageFormatProperties2KHR malloc() {
        return wrap(VkImageFormatProperties2KHR.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkImageFormatProperties2KHR calloc() {
        return wrap(VkImageFormatProperties2KHR.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkImageFormatProperties2KHR create() {
        ...
        return wrap(VkImageFormatProperties2KHR.class, memAddress(container), container);
    }
    ...
    public static VkImageFormatProperties2KHR create(long address) {
        return wrap(VkImageFormatProperties2KHR.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkImageFormatProperties2KHR createSafe(long address) {
        return address == NULL ? null : wrap(VkImageFormatProperties2KHR.class, address);
    }
    ...
    public static VkImageFormatProperties2KHR malloc(MemoryStack stack) {
        return wrap(VkImageFormatProperties2KHR.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkImageFormatProperties2KHR calloc(MemoryStack stack) {
        return wrap(VkImageFormatProperties2KHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
