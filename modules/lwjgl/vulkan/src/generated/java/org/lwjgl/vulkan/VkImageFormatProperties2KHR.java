...
public class VkImageFormatProperties2KHR extends VkImageFormatProperties2 {
    ...
    protected VkImageFormatProperties2KHR(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected VkImageFormatProperties2KHR create(long address, @Nullable ByteBuffer container) {
        return new VkImageFormatProperties2KHR(address, container);
    }

    /**
     * Creates a {@code VkImageFormatProperties2KHR} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@code VkImageFormatProperties2KHR} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static VkImageFormatProperties2KHR malloc() {
        return new VkImageFormatProperties2KHR(nmemAllocChecked(SIZEOF), null);
    }

    /** Returns a new {@code VkImageFormatProperties2KHR} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static VkImageFormatProperties2KHR calloc() {
        return new VkImageFormatProperties2KHR(nmemCallocChecked(1, SIZEOF), null);
    }

    /** Returns a new {@code VkImageFormatProperties2KHR} instance allocated with {@link BufferUtils}. */
    public static VkImageFormatProperties2KHR create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return new VkImageFormatProperties2KHR(memAddress(container), container);
    }

    /** Returns a new {@code VkImageFormatProperties2KHR} instance for the specified memory address. */
    ...
    public static @Nullable VkImageFormatProperties2KHR createSafe(long address) {
    ...
    public static VkImageFormatProperties2KHR.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    @Deprecated public static VkImageFormatProperties2KHR mallocStack() { return malloc(stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(MemoryStack)} instead. */
    @Deprecated public static VkImageFormatProperties2KHR callocStack() { return calloc(stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(MemoryStack)} instead. */
    @Deprecated public static VkImageFormatProperties2KHR mallocStack(MemoryStack stack) { return malloc(stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(MemoryStack)} instead. */
    @Deprecated public static VkImageFormatProperties2KHR callocStack(MemoryStack stack) { return calloc(stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(int, MemoryStack)} instead. */
    @Deprecated public static VkImageFormatProperties2KHR.Buffer mallocStack(int capacity) { return malloc(capacity, stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(int, MemoryStack)} instead. */
    @Deprecated public static VkImageFormatProperties2KHR.Buffer callocStack(int capacity) { return calloc(capacity, stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(int, MemoryStack)} instead. */
    @Deprecated public static VkImageFormatProperties2KHR.Buffer mallocStack(int capacity, MemoryStack stack) { return malloc(capacity, stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(int, MemoryStack)} instead. */
    @Deprecated public static VkImageFormatProperties2KHR.Buffer callocStack(int capacity, MemoryStack stack) { return calloc(capacity, stack); }

    /**
     * Returns a new {@code VkImageFormatProperties2KHR} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack the stack from which to allocate
     */
    public static VkImageFormatProperties2KHR malloc(MemoryStack stack) {
        return new VkImageFormatProperties2KHR(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }

    /**
     * Returns a new {@code VkImageFormatProperties2KHR} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    public static VkImageFormatProperties2KHR calloc(MemoryStack stack) {
        return new VkImageFormatProperties2KHR(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageFormatProperties2KHR.Buffer malloc(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageFormatProperties2KHR.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends VkImageFormatProperties2.Buffer {
         ...
         * by {@link VkImageFormatProperties2KHR#SIZEOF}, and its mark will be undefined.</p>
         *
