...
public class VkImageStencilUsageCreateInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkImageStencilUsageCreateInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkImageStencilUsageCreateInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkImageStencilUsageCreateInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkImageStencilUsageCreateInfo callocStack() {
     ...
     */
    public static VkImageStencilUsageCreateInfo mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkImageStencilUsageCreateInfo callocStack(MemoryStack stack) {
        return wrap(VkImageStencilUsageCreateInfo.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkImageStencilUsageCreateInfo.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkImageStencilUsageCreateInfo.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkImageStencilUsageCreateInfo.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkImageStencilUsageCreateInfo.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageStencilUsageCreateInfo.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageStencilUsageCreateInfo.Buffer callocStack(int capacity, MemoryStack stack) {
