 ...
 * 
 * <ul>
 * <li>{@code matrix[3 * 4]} &ndash; a 3x4 row-major affine transformation matrix.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkTransformMatrixKHR extends Struct implements NativeResource {
    ...
    /** Returns a {@link FloatBuffer} view of the {@code matrix} field. */
    @NativeType("float[3][4]")
    public FloatBuffer matrix() { return nmatrix(address()); }
    /** Returns the value at the specified index of the {@code matrix} field. */
    ...
    /** Returns a new {@code VkTransformMatrixKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkTransformMatrixKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkTransformMatrixKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkTransformMatrixKHR callocStack() {
     ...
     */
    public static VkTransformMatrixKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkTransformMatrixKHR callocStack(MemoryStack stack) {
        return wrap(VkTransformMatrixKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkTransformMatrixKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkTransformMatrixKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkTransformMatrixKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkTransformMatrixKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkTransformMatrixKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkTransformMatrixKHR.Buffer callocStack(int capacity, MemoryStack stack) {
