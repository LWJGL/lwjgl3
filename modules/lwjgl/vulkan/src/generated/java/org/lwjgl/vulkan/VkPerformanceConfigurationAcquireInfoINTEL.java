...
public class VkPerformanceConfigurationAcquireInfoINTEL extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPerformanceConfigurationAcquireInfoINTEL} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPerformanceConfigurationAcquireInfoINTEL mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPerformanceConfigurationAcquireInfoINTEL} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPerformanceConfigurationAcquireInfoINTEL callocStack() {
     ...
     */
    public static VkPerformanceConfigurationAcquireInfoINTEL mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPerformanceConfigurationAcquireInfoINTEL callocStack(MemoryStack stack) {
        return wrap(VkPerformanceConfigurationAcquireInfoINTEL.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPerformanceConfigurationAcquireInfoINTEL.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPerformanceConfigurationAcquireInfoINTEL.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPerformanceConfigurationAcquireInfoINTEL.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPerformanceConfigurationAcquireInfoINTEL.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPerformanceConfigurationAcquireInfoINTEL.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPerformanceConfigurationAcquireInfoINTEL.Buffer callocStack(int capacity, MemoryStack stack) {
