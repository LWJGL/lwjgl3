...
public class VkCopyImageToBufferInfo2KHR extends VkCopyImageToBufferInfo2 {
    ...
    public static @Nullable VkCopyImageToBufferInfo2KHR createSafe(long address) {
    ...
    public static VkCopyImageToBufferInfo2KHR.@Nullable Buffer createSafe(long address, int capacity) {
