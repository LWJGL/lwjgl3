 ...
 * <li>If any element of {@code pRegions} contains {@link VkCopyCommandTransformInfoQCOM} in its {@code pNext} chain, then the {@code srcImage} <b>must</b> not be a <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#blocked-image">blocked image</a></li>
 ...
 * <li>For each element of {@code pRegions} not containing {@link VkCopyCommandTransformInfoQCOM} in its {@code pNext} chain, , {@code imageOffset.y} and <code>(imageExtent.height imageOffset.y)</code> <b>must</b> both be greater than or equal to 0 and less than or equal to the height of the specified {@code imageSubresource} of {@code srcImage} where this refers to the height of the <em>plane</em> of the image involved in the copy in the case of a <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#formats-requiring-sampler-ycbcr-conversion">multi-planar format</a></li>
 * </ul>
 * 
 * <ul>
 ...
 * <li>{@code srcImageLayout} &ndash; the layout of the source image subresources for the copy.</li>
 * <li>{@code dstBuffer} &ndash; the destination buffer.</li>
 * <li>{@code regionCount} &ndash; the number of regions to copy.</li>
 * <li>{@code pRegions} &ndash; a pointer to an array of {@link VkBufferImageCopy2KHR} structures specifying the regions to copy.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
 ...
 *     {@link VkBufferImageCopy2KHR VkBufferImageCopy2KHR} const * pRegions;
 * }</code></pre>
 */
public class VkCopyImageToBufferInfo2KHR extends Struct implements NativeResource {
    ...
    /** Returns a {@link VkBufferImageCopy2KHR.Buffer} view of the struct array pointed to by the {@code pRegions} field. */
    ...
    /** Sets the address of the specified {@link VkBufferImageCopy2KHR.Buffer} to the {@code pRegions} field. */
    ...
    /** Returns a new {@code VkCopyImageToBufferInfo2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkCopyImageToBufferInfo2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkCopyImageToBufferInfo2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkCopyImageToBufferInfo2KHR callocStack() {
     ...
     */
    public static VkCopyImageToBufferInfo2KHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkCopyImageToBufferInfo2KHR callocStack(MemoryStack stack) {
        return wrap(VkCopyImageToBufferInfo2KHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkCopyImageToBufferInfo2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkCopyImageToBufferInfo2KHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkCopyImageToBufferInfo2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkCopyImageToBufferInfo2KHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkCopyImageToBufferInfo2KHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkCopyImageToBufferInfo2KHR.Buffer callocStack(int capacity, MemoryStack stack) {
