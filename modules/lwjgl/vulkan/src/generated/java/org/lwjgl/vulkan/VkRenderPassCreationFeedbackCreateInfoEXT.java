 ...
 * }</code></pre>
 */
public class VkRenderPassCreationFeedbackCreateInfoEXT extends Struct implements NativeResource {
    ...
    public static VkRenderPassCreationFeedbackCreateInfoEXT malloc() {
        return wrap(VkRenderPassCreationFeedbackCreateInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkRenderPassCreationFeedbackCreateInfoEXT calloc() {
        return wrap(VkRenderPassCreationFeedbackCreateInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkRenderPassCreationFeedbackCreateInfoEXT create() {
        ...
        return wrap(VkRenderPassCreationFeedbackCreateInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkRenderPassCreationFeedbackCreateInfoEXT create(long address) {
        return wrap(VkRenderPassCreationFeedbackCreateInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkRenderPassCreationFeedbackCreateInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkRenderPassCreationFeedbackCreateInfoEXT.class, address);
    }
    ...
    public static VkRenderPassCreationFeedbackCreateInfoEXT malloc(MemoryStack stack) {
        return wrap(VkRenderPassCreationFeedbackCreateInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkRenderPassCreationFeedbackCreateInfoEXT calloc(MemoryStack stack) {
        return wrap(VkRenderPassCreationFeedbackCreateInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkRenderPassCreationFeedbackCreateInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkRenderPassCreationFeedbackCreateInfoEXT#SIZEOF}, and its mark will be undefined.
         *
