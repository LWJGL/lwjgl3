...
public class VKCapabilitiesDevice {
    ...
    VKCapabilitiesDevice(FunctionProvider provider, VKCapabilitiesInstance capsInstance, int apiVersion, Set<String> ext) {
        ...
        vkCmdSetCullModeEXT = caps[177];
        vkCmdSetFrontFaceEXT = caps[178];
        vkCmdSetPrimitiveTopologyEXT = caps[179];
        vkCmdSetViewportWithCountEXT = caps[180];
        vkCmdSetScissorWithCountEXT = caps[181];
        vkCmdBindVertexBuffers2EXT = caps[182];
        vkCmdSetDepthTestEnableEXT = caps[183];
        vkCmdSetDepthWriteEnableEXT = caps[184];
        vkCmdSetDepthCompareOpEXT = caps[185];
        vkCmdSetDepthBoundsTestEnableEXT = caps[186];
        vkCmdSetStencilTestEnableEXT = caps[187];
        vkCmdSetStencilOpEXT = caps[188];
        vkGetMemoryHostPointerPropertiesEXT = caps[189];
        vkAcquireFullScreenExclusiveModeEXT = caps[190];
        vkReleaseFullScreenExclusiveModeEXT = caps[191];
        vkGetDeviceGroupSurfacePresentModes2EXT = caps[192];
        vkSetHdrMetadataEXT = caps[193];
        vkResetQueryPoolEXT = caps[194];
        vkGetImageDrmFormatModifierPropertiesEXT = caps[195];
        vkCmdSetLineStippleEXT = caps[196];
        vkCreatePrivateDataSlotEXT = caps[197];
        vkDestroyPrivateDataSlotEXT = caps[198];
        vkSetPrivateDataEXT = caps[199];
        vkGetPrivateDataEXT = caps[200];
        vkCmdSetSampleLocationsEXT = caps[201];
        vkCmdBindTransformFeedbackBuffersEXT = caps[202];
        vkCmdBeginTransformFeedbackEXT = caps[203];
        vkCmdEndTransformFeedbackEXT = caps[204];
        vkCmdBeginQueryIndexedEXT = caps[205];
        vkCmdEndQueryIndexedEXT = caps[206];
        vkCmdDrawIndirectByteCountEXT = caps[207];
        vkCreateValidationCacheEXT = caps[208];
        vkDestroyValidationCacheEXT = caps[209];
        vkMergeValidationCachesEXT = caps[210];
        vkGetValidationCacheDataEXT = caps[211];
        vkGetRefreshCycleDurationGOOGLE = caps[212];
        vkGetPastPresentationTimingGOOGLE = caps[213];
        vkInitializePerformanceApiINTEL = caps[214];
        vkUninitializePerformanceApiINTEL = caps[215];
        vkCmdSetPerformanceMarkerINTEL = caps[216];
        vkCmdSetPerformanceStreamMarkerINTEL = caps[217];
        vkCmdSetPerformanceOverrideINTEL = caps[218];
        vkAcquirePerformanceConfigurationINTEL = caps[219];
        vkReleasePerformanceConfigurationINTEL = caps[220];
        vkQueueSetPerformanceConfigurationINTEL = caps[221];
        vkGetPerformanceParameterINTEL = caps[222];
        vkCreateAccelerationStructureKHR = caps[223];
        vkDestroyAccelerationStructureKHR = caps[224];
        vkCmdBuildAccelerationStructuresKHR = caps[225];
        vkCmdBuildAccelerationStructuresIndirectKHR = caps[226];
        vkBuildAccelerationStructuresKHR = caps[227];
        vkCopyAccelerationStructureKHR = caps[228];
        vkCopyAccelerationStructureToMemoryKHR = caps[229];
        vkCopyMemoryToAccelerationStructureKHR = caps[230];
        vkWriteAccelerationStructuresPropertiesKHR = caps[231];
        vkCmdCopyAccelerationStructureKHR = caps[232];
        vkCmdCopyAccelerationStructureToMemoryKHR = caps[233];
        vkCmdCopyMemoryToAccelerationStructureKHR = caps[234];
        vkGetAccelerationStructureDeviceAddressKHR = caps[235];
        vkCmdWriteAccelerationStructuresPropertiesKHR = caps[236];
        vkGetDeviceAccelerationStructureCompatibilityKHR = caps[237];
        vkGetAccelerationStructureBuildSizesKHR = caps[238];
        vkBindBufferMemory2KHR = caps[239];
        vkBindImageMemory2KHR = caps[240];
        vkGetBufferDeviceAddressKHR = caps[241];
        vkGetBufferOpaqueCaptureAddressKHR = caps[242];
        vkGetDeviceMemoryOpaqueCaptureAddressKHR = caps[243];
        vkCmdCopyBuffer2KHR = caps[244];
        vkCmdCopyImage2KHR = caps[245];
        vkCmdCopyBufferToImage2KHR = caps[246];
        vkCmdCopyImageToBuffer2KHR = caps[247];
        vkCmdBlitImage2KHR = caps[248];
        vkCmdResolveImage2KHR = caps[249];
        vkCreateRenderPass2KHR = caps[250];
        vkCmdBeginRenderPass2KHR = caps[251];
        vkCmdNextSubpass2KHR = caps[252];
        vkCmdEndRenderPass2KHR = caps[253];
        vkCreateDeferredOperationKHR = caps[254];
        vkDestroyDeferredOperationKHR = caps[255];
        vkGetDeferredOperationMaxConcurrencyKHR = caps[256];
        vkGetDeferredOperationResultKHR = caps[257];
        vkDeferredOperationJoinKHR = caps[258];
        vkCreateDescriptorUpdateTemplateKHR = caps[259];
        vkDestroyDescriptorUpdateTemplateKHR = caps[260];
        vkUpdateDescriptorSetWithTemplateKHR = caps[261];
        vkCmdPushDescriptorSetWithTemplateKHR = caps[262];
        vkGetDeviceGroupPeerMemoryFeaturesKHR = caps[263];
        vkCmdSetDeviceMaskKHR = caps[264];
        vkCmdDispatchBaseKHR = caps[265];
        vkGetDeviceGroupPresentCapabilitiesKHR = caps[266];
        vkGetDeviceGroupSurfacePresentModesKHR = caps[267];
        vkAcquireNextImage2KHR = caps[268];
        vkCreateSharedSwapchainsKHR = caps[269];
        vkCmdDrawIndirectCountKHR = caps[270];
        vkCmdDrawIndexedIndirectCountKHR = caps[271];
        vkImportFenceFdKHR = caps[272];
        vkGetFenceFdKHR = caps[273];
        vkImportFenceWin32HandleKHR = caps[274];
        vkGetFenceWin32HandleKHR = caps[275];
        vkGetMemoryFdKHR = caps[276];
        vkGetMemoryFdPropertiesKHR = caps[277];
        vkGetMemoryWin32HandleKHR = caps[278];
        vkGetMemoryWin32HandlePropertiesKHR = caps[279];
        vkImportSemaphoreFdKHR = caps[280];
        vkGetSemaphoreFdKHR = caps[281];
        vkImportSemaphoreWin32HandleKHR = caps[282];
        vkGetSemaphoreWin32HandleKHR = caps[283];
        vkCmdSetFragmentShadingRateKHR = caps[284];
        vkGetImageMemoryRequirements2KHR = caps[285];
        vkGetBufferMemoryRequirements2KHR = caps[286];
        vkGetImageSparseMemoryRequirements2KHR = caps[287];
        vkTrimCommandPoolKHR = caps[288];
        vkGetDescriptorSetLayoutSupportKHR = caps[289];
        vkAcquireProfilingLockKHR = caps[290];
        vkReleaseProfilingLockKHR = caps[291];
        vkGetPipelineExecutablePropertiesKHR = caps[292];
        vkGetPipelineExecutableStatisticsKHR = caps[293];
        vkGetPipelineExecutableInternalRepresentationsKHR = caps[294];
        vkCmdPushDescriptorSetKHR = caps[295];
        vkCmdTraceRaysKHR = caps[296];
        vkCreateRayTracingPipelinesKHR = caps[297];
        vkGetRayTracingShaderGroupHandlesKHR = caps[298];
        vkGetRayTracingCaptureReplayShaderGroupHandlesKHR = caps[299];
        vkCmdTraceRaysIndirectKHR = caps[300];
        vkGetRayTracingShaderGroupStackSizeKHR = caps[301];
        vkCmdSetRayTracingPipelineStackSizeKHR = caps[302];
        vkCreateSamplerYcbcrConversionKHR = caps[303];
        vkDestroySamplerYcbcrConversionKHR = caps[304];
        vkGetSwapchainStatusKHR = caps[305];
        vkCreateSwapchainKHR = caps[306];
        vkDestroySwapchainKHR = caps[307];
        vkGetSwapchainImagesKHR = caps[308];
        vkAcquireNextImageKHR = caps[309];
        vkQueuePresentKHR = caps[310];
        vkCmdSetEvent2KHR = caps[311];
        vkCmdResetEvent2KHR = caps[312];
        vkCmdWaitEvents2KHR = caps[313];
        vkCmdPipelineBarrier2KHR = caps[314];
        vkCmdWriteTimestamp2KHR = caps[315];
        vkQueueSubmit2KHR = caps[316];
        vkCmdWriteBufferMarker2AMD = caps[317];
        vkGetQueueCheckpointData2NV = caps[318];
        vkGetSemaphoreCounterValueKHR = caps[319];
        vkWaitSemaphoresKHR = caps[320];
        vkSignalSemaphoreKHR = caps[321];
        vkCmdSetViewportWScalingNV = caps[322];
        vkCmdSetCheckpointNV = caps[323];
        vkGetQueueCheckpointDataNV = caps[324];
        vkGetGeneratedCommandsMemoryRequirementsNV = caps[325];
        vkCmdPreprocessGeneratedCommandsNV = caps[326];
        vkCmdExecuteGeneratedCommandsNV = caps[327];
        vkCmdBindPipelineShaderGroupNV = caps[328];
        vkCreateIndirectCommandsLayoutNV = caps[329];
        vkDestroyIndirectCommandsLayoutNV = caps[330];
        vkGetMemoryWin32HandleNV = caps[331];
        vkCmdSetFragmentShadingRateEnumNV = caps[332];
        vkCmdDrawMeshTasksNV = caps[333];
        vkCmdDrawMeshTasksIndirectNV = caps[334];
        vkCmdDrawMeshTasksIndirectCountNV = caps[335];
        vkCreateAccelerationStructureNV = caps[336];
        vkDestroyAccelerationStructureNV = caps[337];
        vkGetAccelerationStructureMemoryRequirementsNV = caps[338];
        vkBindAccelerationStructureMemoryNV = caps[339];
        vkCmdBuildAccelerationStructureNV = caps[340];
        vkCmdCopyAccelerationStructureNV = caps[341];
        vkCmdTraceRaysNV = caps[342];
        vkCreateRayTracingPipelinesNV = caps[343];
        vkGetRayTracingShaderGroupHandlesNV = caps[344];
        vkGetAccelerationStructureHandleNV = caps[345];
        vkCmdWriteAccelerationStructuresPropertiesNV = caps[346];
        vkCompileDeferredNV = caps[347];
        vkCmdSetExclusiveScissorNV = caps[348];
        vkCmdBindShadingRateImageNV = caps[349];
        vkCmdSetViewportShadingRatePaletteNV = caps[350];
        vkCmdSetCoarseSampleOrderNV = caps[351];
        vkGetImageViewHandleNVX = caps[352];
        vkGetImageViewAddressNVX = caps[353];
    }
    ...
    private static boolean check_KHR_swapchain(FunctionProvider provider, long[] caps, Set<String> ext) {
        ...
        return checkFunctions(provider, caps, new int[] {
            306, 307, 308, 309, 310, flag0 + 266, flag0 + 267, flag0 + 268
        },
    ...
    private static boolean check_KHR_synchronization2(FunctionProvider provider, long[] caps, Set<String> ext) {
        ...
        return checkFunctions(provider, caps, new int[] {
            311, 312, 313, 314, 315, 316, flag0 + 317, flag1 + 318
        },
