 ...
 * }</code></pre>
 */
public class VkDeviceFaultAddressInfoEXT extends Struct implements NativeResource {
    ...
    public static VkDeviceFaultAddressInfoEXT malloc() {
        return wrap(VkDeviceFaultAddressInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkDeviceFaultAddressInfoEXT calloc() {
        return wrap(VkDeviceFaultAddressInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkDeviceFaultAddressInfoEXT create() {
        ...
        return wrap(VkDeviceFaultAddressInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkDeviceFaultAddressInfoEXT create(long address) {
        return wrap(VkDeviceFaultAddressInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkDeviceFaultAddressInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkDeviceFaultAddressInfoEXT.class, address);
    }
    ...
    public static VkDeviceFaultAddressInfoEXT malloc(MemoryStack stack) {
        return wrap(VkDeviceFaultAddressInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkDeviceFaultAddressInfoEXT calloc(MemoryStack stack) {
        return wrap(VkDeviceFaultAddressInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkDeviceFaultAddressInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkDeviceFaultAddressInfoEXT#SIZEOF}, and its mark will be undefined.
         *
