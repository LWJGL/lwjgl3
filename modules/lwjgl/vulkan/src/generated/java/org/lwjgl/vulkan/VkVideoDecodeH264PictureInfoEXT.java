...
public class VkVideoDecodeH264PictureInfoEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkVideoDecodeH264PictureInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoDecodeH264PictureInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoDecodeH264PictureInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoDecodeH264PictureInfoEXT callocStack() {
     ...
     */
    public static VkVideoDecodeH264PictureInfoEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoDecodeH264PictureInfoEXT callocStack(MemoryStack stack) {
        return wrap(VkVideoDecodeH264PictureInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoDecodeH264PictureInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH264PictureInfoEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoDecodeH264PictureInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH264PictureInfoEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH264PictureInfoEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoDecodeH264PictureInfoEXT.Buffer callocStack(int capacity, MemoryStack stack) {
