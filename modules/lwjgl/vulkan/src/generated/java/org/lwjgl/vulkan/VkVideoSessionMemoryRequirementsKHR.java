 ...
 * }</code></pre>
 */
public class VkVideoSessionMemoryRequirementsKHR extends Struct implements NativeResource {
    ...
    public static VkVideoSessionMemoryRequirementsKHR malloc() {
        return wrap(VkVideoSessionMemoryRequirementsKHR.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkVideoSessionMemoryRequirementsKHR calloc() {
        return wrap(VkVideoSessionMemoryRequirementsKHR.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkVideoSessionMemoryRequirementsKHR create() {
        ...
        return wrap(VkVideoSessionMemoryRequirementsKHR.class, memAddress(container), container);
    }
    ...
    public static VkVideoSessionMemoryRequirementsKHR create(long address) {
        return wrap(VkVideoSessionMemoryRequirementsKHR.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkVideoSessionMemoryRequirementsKHR createSafe(long address) {
        return address == NULL ? null : wrap(VkVideoSessionMemoryRequirementsKHR.class, address);
    }
    ...
    public static VkVideoSessionMemoryRequirementsKHR malloc(MemoryStack stack) {
        return wrap(VkVideoSessionMemoryRequirementsKHR.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkVideoSessionMemoryRequirementsKHR calloc(MemoryStack stack) {
        return wrap(VkVideoSessionMemoryRequirementsKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkVideoSessionMemoryRequirementsKHR, Buffer> implements NativeResource {
         ...
         * by {@link VkVideoSessionMemoryRequirementsKHR#SIZEOF}, and its mark will be undefined.
         *
