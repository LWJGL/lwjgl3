...
public class VkCopyCommandTransformInfoQCOM extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkCopyCommandTransformInfoQCOM} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkCopyCommandTransformInfoQCOM mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkCopyCommandTransformInfoQCOM} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkCopyCommandTransformInfoQCOM callocStack() {
     ...
     */
    public static VkCopyCommandTransformInfoQCOM mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkCopyCommandTransformInfoQCOM callocStack(MemoryStack stack) {
        return wrap(VkCopyCommandTransformInfoQCOM.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkCopyCommandTransformInfoQCOM.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkCopyCommandTransformInfoQCOM.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkCopyCommandTransformInfoQCOM.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkCopyCommandTransformInfoQCOM.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkCopyCommandTransformInfoQCOM.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkCopyCommandTransformInfoQCOM.Buffer callocStack(int capacity, MemoryStack stack) {
