 ...
 * 
 * <p>This extension also allows each of the new descriptor binding functions from VK_KHR_maintenance6 to have their {@code VkPipelineLayout} member be optionally set to {@link VK10#VK_NULL_HANDLE NULL_HANDLE}, in which case the pipeline layout information is taken from a {@link VkPipelineLayoutCreateInfo} structure in the {@code pNext} chain. This enables descriptors to be directly bound using descriptor set layouts without applications needing to create and manage {@code VkPipelineLayout} objects at command recording time.</p>
 * 
 * <dl>
...
public final class NVPerStageDescriptorSet {
    ...
    public static final int VK_DESCRIPTOR_SET_LAYOUT_CREATE_PER_STAGE_BIT_NV = 0x40;
