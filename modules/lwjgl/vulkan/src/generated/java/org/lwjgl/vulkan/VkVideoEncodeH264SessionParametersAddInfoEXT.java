 ...
 *     {@link StdVideoH264SequenceParameterSet StdVideoH264SequenceParameterSet} const * pSpsStd;
 *     uint32_t ppsStdCount;
 *     {@link StdVideoH264PictureParameterSet StdVideoH264PictureParameterSet} const * pPpsStd;
 * }</code></pre>
 */
public class VkVideoEncodeH264SessionParametersAddInfoEXT extends Struct implements NativeResource {
    ...
    /** @return the value of the {@code spsStdCount} field. */
    @NativeType("uint32_t")
    public int spsStdCount() { return nspsStdCount(address()); }
    /** @return a {@link StdVideoH264SequenceParameterSet.Buffer} view of the struct array pointed to by the {@code pSpsStd} field. */
    @Nullable
    ...
    /** @return the value of the {@code ppsStdCount} field. */
    @NativeType("uint32_t")
    public int ppsStdCount() { return nppsStdCount(address()); }
    /** @return a {@link StdVideoH264PictureParameterSet.Buffer} view of the struct array pointed to by the {@code pPpsStd} field. */
    @Nullable
    ...
    /** Sets the address of the specified {@link StdVideoH264SequenceParameterSet.Buffer} to the {@code pSpsStd} field. */
    ...
    /** Sets the specified value to the {@code ppsStdCount} field. */
    ...
    /** Sets the address of the specified {@link StdVideoH264PictureParameterSet.Buffer} to the {@code pPpsStd} field. */
    ...
    /** Returns a new {@code VkVideoEncodeH264SessionParametersAddInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoEncodeH264SessionParametersAddInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoEncodeH264SessionParametersAddInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoEncodeH264SessionParametersAddInfoEXT callocStack() {
     ...
     */
    public static VkVideoEncodeH264SessionParametersAddInfoEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoEncodeH264SessionParametersAddInfoEXT callocStack(MemoryStack stack) {
        return wrap(VkVideoEncodeH264SessionParametersAddInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoEncodeH264SessionParametersAddInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264SessionParametersAddInfoEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoEncodeH264SessionParametersAddInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264SessionParametersAddInfoEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264SessionParametersAddInfoEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoEncodeH264SessionParametersAddInfoEXT.Buffer callocStack(int capacity, MemoryStack stack) {
