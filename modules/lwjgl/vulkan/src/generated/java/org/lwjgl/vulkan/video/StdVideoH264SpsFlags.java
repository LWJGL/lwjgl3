...
public class StdVideoH264SpsFlags extends Struct implements NativeResource {
    ...
    /** Returns a new {@code StdVideoH264SpsFlags} instance allocated on the thread-local {@link MemoryStack}. */
    public static StdVideoH264SpsFlags mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code StdVideoH264SpsFlags} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static StdVideoH264SpsFlags callocStack() {
     ...
     */
    public static StdVideoH264SpsFlags mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static StdVideoH264SpsFlags callocStack(MemoryStack stack) {
        return wrap(StdVideoH264SpsFlags.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link StdVideoH264SpsFlags.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoH264SpsFlags.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link StdVideoH264SpsFlags.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoH264SpsFlags.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoH264SpsFlags.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoH264SpsFlags.Buffer callocStack(int capacity, MemoryStack stack) {
