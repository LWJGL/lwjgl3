...
public class StdVideoAV1FilmGrainFlags extends Struct<StdVideoAV1FilmGrainFlags> implements NativeResource {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoAV1FilmGrainFlags.BITFIELD0); }
    ...
    static int nbitfield1(long struct) { return memGetInt(struct + StdVideoAV1FilmGrainFlags.BITFIELD1); }
    static int nreserved(long struct) { return nbitfield1(struct) & 0x0F_FF_FF_FF; }

    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoAV1FilmGrainFlags.BITFIELD0, value); }
    ...
    static void nbitfield1(long struct, int value) { memPutInt(struct + StdVideoAV1FilmGrainFlags.BITFIELD1, value); }
