 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceShaderTileImageFeaturesEXT extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceShaderTileImageFeaturesEXT malloc() {
        return wrap(VkPhysicalDeviceShaderTileImageFeaturesEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceShaderTileImageFeaturesEXT calloc() {
        return wrap(VkPhysicalDeviceShaderTileImageFeaturesEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceShaderTileImageFeaturesEXT create() {
        ...
        return wrap(VkPhysicalDeviceShaderTileImageFeaturesEXT.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceShaderTileImageFeaturesEXT create(long address) {
        return wrap(VkPhysicalDeviceShaderTileImageFeaturesEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceShaderTileImageFeaturesEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceShaderTileImageFeaturesEXT.class, address);
    }
    ...
    public static VkPhysicalDeviceShaderTileImageFeaturesEXT malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceShaderTileImageFeaturesEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceShaderTileImageFeaturesEXT calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceShaderTileImageFeaturesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceShaderTileImageFeaturesEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceShaderTileImageFeaturesEXT#SIZEOF}, and its mark will be undefined.
         *
