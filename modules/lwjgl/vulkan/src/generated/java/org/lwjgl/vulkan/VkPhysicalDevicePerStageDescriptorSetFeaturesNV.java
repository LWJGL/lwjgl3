 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV} structure is included in the {@code pNext} chain of the {@link VkPhysicalDeviceFeatures2} structure passed to {@link VK11#vkGetPhysicalDeviceFeatures2 GetPhysicalDeviceFeatures2}, it is filled in to indicate whether each corresponding feature is supported. {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV} <b>can</b> also be used in the {@code pNext} chain of {@link VkDeviceCreateInfo} to selectively enable these features.</p>
 * 
 * <h5>Valid Usage (Implicit)</h5>
 * 
 * <ul>
 * <li>{@code sType} <b>must</b> be {@link NVPerStageDescriptorSet#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PER_STAGE_DESCRIPTOR_SET_FEATURES_NV STRUCTURE_TYPE_PHYSICAL_DEVICE_PER_STAGE_DESCRIPTOR_SET_FEATURES_NV}</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
 ...
 *     void * {@link #pNext};
 *     VkBool32 {@link #perStageDescriptorSet};
 *     VkBool32 {@link #dynamicPipelineLayout};
 * }</code></pre>
 */
public class VkPhysicalDevicePerStageDescriptorSetFeaturesNV extends Struct<VkPhysicalDevicePerStageDescriptorSetFeaturesNV> implements NativeResource {
    ...
    /** Sets the {@link NVPerStageDescriptorSet#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PER_STAGE_DESCRIPTOR_SET_FEATURES_NV STRUCTURE_TYPE_PHYSICAL_DEVICE_PER_STAGE_DESCRIPTOR_SET_FEATURES_NV} value to the {@link #sType} field. */
    ...
    /** Sets the specified value to the {@link #perStageDescriptorSet} field. */
    ...
    /** Sets the specified value to the {@link #dynamicPipelineLayout} field. */
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDevicePerStageDescriptorSetFeaturesNV, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#sType} field. */
        @NativeType("VkStructureType")
        public int sType() { return VkPhysicalDevicePerStageDescriptorSetFeaturesNV.nsType(address()); }
        /** @return the value of the {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#pNext} field. */
        @NativeType("void *")
        public long pNext() { return VkPhysicalDevicePerStageDescriptorSetFeaturesNV.npNext(address()); }
        /** @return the value of the {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#perStageDescriptorSet} field. */
        @NativeType("VkBool32")
        ...
        /** @return the value of the {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#dynamicPipelineLayout} field. */
        @NativeType("VkBool32")
        ...
        /** Sets the specified value to the {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#sType} field. */
        ...
        /** Sets the {@link NVPerStageDescriptorSet#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PER_STAGE_DESCRIPTOR_SET_FEATURES_NV STRUCTURE_TYPE_PHYSICAL_DEVICE_PER_STAGE_DESCRIPTOR_SET_FEATURES_NV} value to the {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#sType} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#pNext} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#perStageDescriptorSet} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#dynamicPipelineLayout} field. */
