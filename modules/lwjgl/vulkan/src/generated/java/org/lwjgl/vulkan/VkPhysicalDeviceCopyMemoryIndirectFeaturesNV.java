 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceCopyMemoryIndirectFeaturesNV extends Struct implements NativeResource {
    ...
    /** indicates whether <a target="_blank" href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#indirect-copies">indirect copies</a> are supported. */
    @NativeType("VkBool32")
    ...
    public static VkPhysicalDeviceCopyMemoryIndirectFeaturesNV malloc() {
        return wrap(VkPhysicalDeviceCopyMemoryIndirectFeaturesNV.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceCopyMemoryIndirectFeaturesNV calloc() {
        return wrap(VkPhysicalDeviceCopyMemoryIndirectFeaturesNV.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceCopyMemoryIndirectFeaturesNV create() {
        ...
        return wrap(VkPhysicalDeviceCopyMemoryIndirectFeaturesNV.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceCopyMemoryIndirectFeaturesNV create(long address) {
        return wrap(VkPhysicalDeviceCopyMemoryIndirectFeaturesNV.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceCopyMemoryIndirectFeaturesNV createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceCopyMemoryIndirectFeaturesNV.class, address);
    }
    ...
    public static VkPhysicalDeviceCopyMemoryIndirectFeaturesNV malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceCopyMemoryIndirectFeaturesNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceCopyMemoryIndirectFeaturesNV calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceCopyMemoryIndirectFeaturesNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceCopyMemoryIndirectFeaturesNV, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceCopyMemoryIndirectFeaturesNV#SIZEOF}, and its mark will be undefined.
         *
