...
public class VkMemoryWin32HandlePropertiesKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkMemoryWin32HandlePropertiesKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkMemoryWin32HandlePropertiesKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkMemoryWin32HandlePropertiesKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
