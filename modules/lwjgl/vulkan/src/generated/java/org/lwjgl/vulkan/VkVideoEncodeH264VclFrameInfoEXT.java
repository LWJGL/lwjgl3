 ...
 * }</code></pre>
 */
public class VkVideoEncodeH264VclFrameInfoEXT extends Struct<VkVideoEncodeH264VclFrameInfoEXT> implements NativeResource {
    ...
    protected VkVideoEncodeH264VclFrameInfoEXT(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected VkVideoEncodeH264VclFrameInfoEXT create(long address, @Nullable ByteBuffer container) {
        return new VkVideoEncodeH264VclFrameInfoEXT(address, container);
    }
    ...
    public static VkVideoEncodeH264VclFrameInfoEXT malloc() {
        return new VkVideoEncodeH264VclFrameInfoEXT(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkVideoEncodeH264VclFrameInfoEXT calloc() {
        return new VkVideoEncodeH264VclFrameInfoEXT(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkVideoEncodeH264VclFrameInfoEXT create() {
        ...
        return new VkVideoEncodeH264VclFrameInfoEXT(memAddress(container), container);
    }
    ...
    public static VkVideoEncodeH264VclFrameInfoEXT create(long address) {
        return new VkVideoEncodeH264VclFrameInfoEXT(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkVideoEncodeH264VclFrameInfoEXT createSafe(long address) {
        return address == NULL ? null : new VkVideoEncodeH264VclFrameInfoEXT(address, null);
    }
    ...
    public static VkVideoEncodeH264VclFrameInfoEXT malloc(MemoryStack stack) {
        return new VkVideoEncodeH264VclFrameInfoEXT(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkVideoEncodeH264VclFrameInfoEXT calloc(MemoryStack stack) {
        return new VkVideoEncodeH264VclFrameInfoEXT(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<VkVideoEncodeH264VclFrameInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkVideoEncodeH264VclFrameInfoEXT#SIZEOF}, and its mark will be undefined.</p>
         *
