 ...
 * }</code></pre>
 */
public class VkCopyMicromapToMemoryInfoEXT extends Struct implements NativeResource {
    ...
    public static VkCopyMicromapToMemoryInfoEXT malloc() {
        return wrap(VkCopyMicromapToMemoryInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkCopyMicromapToMemoryInfoEXT calloc() {
        return wrap(VkCopyMicromapToMemoryInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkCopyMicromapToMemoryInfoEXT create() {
        ...
        return wrap(VkCopyMicromapToMemoryInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkCopyMicromapToMemoryInfoEXT create(long address) {
        return wrap(VkCopyMicromapToMemoryInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkCopyMicromapToMemoryInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkCopyMicromapToMemoryInfoEXT.class, address);
    }
    ...
    public static VkCopyMicromapToMemoryInfoEXT malloc(MemoryStack stack) {
        return wrap(VkCopyMicromapToMemoryInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkCopyMicromapToMemoryInfoEXT calloc(MemoryStack stack) {
        return wrap(VkCopyMicromapToMemoryInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkCopyMicromapToMemoryInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkCopyMicromapToMemoryInfoEXT#SIZEOF}, and its mark will be undefined.
         *
