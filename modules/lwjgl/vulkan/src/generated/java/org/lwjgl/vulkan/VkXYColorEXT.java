...
public class VkXYColorEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkXYColorEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkXYColorEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkXYColorEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     * @param capacity the buffer capacity
     */
    public static VkXYColorEXT.Buffer mallocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkXYColorEXT.Buffer callocStack(int capacity) {
