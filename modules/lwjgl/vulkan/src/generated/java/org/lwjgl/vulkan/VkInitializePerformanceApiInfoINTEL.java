...
public class VkInitializePerformanceApiInfoINTEL extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkInitializePerformanceApiInfoINTEL} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkInitializePerformanceApiInfoINTEL mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkInitializePerformanceApiInfoINTEL} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkInitializePerformanceApiInfoINTEL callocStack() {
     ...
     */
    public static VkInitializePerformanceApiInfoINTEL mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkInitializePerformanceApiInfoINTEL callocStack(MemoryStack stack) {
        return wrap(VkInitializePerformanceApiInfoINTEL.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkInitializePerformanceApiInfoINTEL.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkInitializePerformanceApiInfoINTEL.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkInitializePerformanceApiInfoINTEL.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkInitializePerformanceApiInfoINTEL.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkInitializePerformanceApiInfoINTEL.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkInitializePerformanceApiInfoINTEL.Buffer callocStack(int capacity, MemoryStack stack) {
