 ...
 * }</code></pre>
 */
public class VkVideoEncodeH264ProfileInfoEXT extends Struct implements NativeResource {
    ...
    public static VkVideoEncodeH264ProfileInfoEXT malloc() {
        return wrap(VkVideoEncodeH264ProfileInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkVideoEncodeH264ProfileInfoEXT calloc() {
        return wrap(VkVideoEncodeH264ProfileInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkVideoEncodeH264ProfileInfoEXT create() {
        ...
        return wrap(VkVideoEncodeH264ProfileInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkVideoEncodeH264ProfileInfoEXT create(long address) {
        return wrap(VkVideoEncodeH264ProfileInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkVideoEncodeH264ProfileInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkVideoEncodeH264ProfileInfoEXT.class, address);
    }
    ...
    public static VkVideoEncodeH264ProfileInfoEXT malloc(MemoryStack stack) {
        return wrap(VkVideoEncodeH264ProfileInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkVideoEncodeH264ProfileInfoEXT calloc(MemoryStack stack) {
        return wrap(VkVideoEncodeH264ProfileInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkVideoEncodeH264ProfileInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkVideoEncodeH264ProfileInfoEXT#SIZEOF}, and its mark will be undefined.
         *
