 ...
 * }}</pre>
 */
public class VkDisplayEventInfoEXT extends Struct<VkDisplayEventInfoEXT> implements NativeResource {
    ...
    /** @return the value of the {@code displayEvent} field. */
    ...
    /** Sets the {@link EXTDisplayControl#VK_STRUCTURE_TYPE_DISPLAY_EVENT_INFO_EXT STRUCTURE_TYPE_DISPLAY_EVENT_INFO_EXT} value to the {@code sType} field. */
    ...
    public static VkDisplayEventInfoEXT malloc() {
        return new VkDisplayEventInfoEXT(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkDisplayEventInfoEXT calloc() {
        return new VkDisplayEventInfoEXT(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkDisplayEventInfoEXT create() {
        ...
        return new VkDisplayEventInfoEXT(memAddress(container), container);
    }
    ...
    public static @Nullable VkDisplayEventInfoEXT createSafe(long address) {
    ...
    public static VkDisplayEventInfoEXT.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static VkDisplayEventInfoEXT malloc(MemoryStack stack) {
        return new VkDisplayEventInfoEXT(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkDisplayEventInfoEXT calloc(MemoryStack stack) {
        return new VkDisplayEventInfoEXT(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<VkDisplayEventInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkDisplayEventInfoEXT#SIZEOF}, and its mark will be undefined.</p>
         *
