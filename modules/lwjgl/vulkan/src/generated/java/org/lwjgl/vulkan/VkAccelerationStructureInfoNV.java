...
public class VkAccelerationStructureInfoNV extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link VkAccelerationStructureInfoNV} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link VkAccelerationStructureInfoNV} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    ...
    /** Returns a new {@link VkAccelerationStructureInfoNV} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    ...
    /** Returns a new {@link VkAccelerationStructureInfoNV} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link VkAccelerationStructureInfoNV} instance for the specified memory address. */
    ...
    /** Returns a new {@link VkAccelerationStructureInfoNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkAccelerationStructureInfoNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link VkAccelerationStructureInfoNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkAccelerationStructureInfoNV callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link VkAccelerationStructureInfoNV} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link VkAccelerationStructureInfoNV} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<VkAccelerationStructureInfoNV, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link VkAccelerationStructureInfoNV.Buffer} instance backed by the specified container.
         *
