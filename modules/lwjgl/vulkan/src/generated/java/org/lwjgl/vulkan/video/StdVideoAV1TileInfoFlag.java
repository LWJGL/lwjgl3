...
public class StdVideoAV1TileInfoFlag extends Struct<StdVideoAV1TileInfoFlag> implements NativeResource {
    ...
    @Nullable
    public static StdVideoAV1TileInfoFlag createSafe(long address) {
    ...
    @Nullable
    public static StdVideoAV1TileInfoFlag.Buffer createSafe(long address, int capacity) {
    ...
    public static int nbitfield0(long struct) { return UNSAFE.getInt(null, struct + StdVideoAV1TileInfoFlag.BITFIELD0); }
    ...
    public static int nbitfield1(long struct) { return UNSAFE.getInt(null, struct + StdVideoAV1TileInfoFlag.BITFIELD1); }
    public static int nreserved(long struct) { return nbitfield1(struct) & 0x7F_FF_FF_FF; }

    public static void nbitfield0(long struct, int value) { UNSAFE.putInt(null, struct + StdVideoAV1TileInfoFlag.BITFIELD0, value); }
    ...
    public static void nbitfield1(long struct, int value) { UNSAFE.putInt(null, struct + StdVideoAV1TileInfoFlag.BITFIELD1, value); }
