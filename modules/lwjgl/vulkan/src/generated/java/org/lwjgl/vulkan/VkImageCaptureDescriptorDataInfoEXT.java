 ...
 * }</code></pre>
 */
public class VkImageCaptureDescriptorDataInfoEXT extends Struct implements NativeResource {
    ...
    public static VkImageCaptureDescriptorDataInfoEXT malloc() {
        return wrap(VkImageCaptureDescriptorDataInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkImageCaptureDescriptorDataInfoEXT calloc() {
        return wrap(VkImageCaptureDescriptorDataInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkImageCaptureDescriptorDataInfoEXT create() {
        ...
        return wrap(VkImageCaptureDescriptorDataInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkImageCaptureDescriptorDataInfoEXT create(long address) {
        return wrap(VkImageCaptureDescriptorDataInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkImageCaptureDescriptorDataInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkImageCaptureDescriptorDataInfoEXT.class, address);
    }
    ...
    public static VkImageCaptureDescriptorDataInfoEXT malloc(MemoryStack stack) {
        return wrap(VkImageCaptureDescriptorDataInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkImageCaptureDescriptorDataInfoEXT calloc(MemoryStack stack) {
        return wrap(VkImageCaptureDescriptorDataInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkImageCaptureDescriptorDataInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkImageCaptureDescriptorDataInfoEXT#SIZEOF}, and its mark will be undefined.
         *
