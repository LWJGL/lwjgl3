 ...
 * 
 * <ul>
 * <li>If this structure is included in a {@code pNext} chain and {@code identifierSize} is not equal to 0, the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#features-shaderModuleIdentifier">{@code shaderModuleIdentifier}</a> feature <b>must</b> be enabled</li>
 ...
 * }</code></pre>
 */
public class VkPipelineShaderStageModuleIdentifierCreateInfoEXT extends Struct implements NativeResource {
    ...
    public static VkPipelineShaderStageModuleIdentifierCreateInfoEXT malloc() {
        return wrap(VkPipelineShaderStageModuleIdentifierCreateInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPipelineShaderStageModuleIdentifierCreateInfoEXT calloc() {
        return wrap(VkPipelineShaderStageModuleIdentifierCreateInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPipelineShaderStageModuleIdentifierCreateInfoEXT create() {
        ...
        return wrap(VkPipelineShaderStageModuleIdentifierCreateInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkPipelineShaderStageModuleIdentifierCreateInfoEXT create(long address) {
        return wrap(VkPipelineShaderStageModuleIdentifierCreateInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPipelineShaderStageModuleIdentifierCreateInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkPipelineShaderStageModuleIdentifierCreateInfoEXT.class, address);
    }
    ...
    public static VkPipelineShaderStageModuleIdentifierCreateInfoEXT malloc(MemoryStack stack) {
        return wrap(VkPipelineShaderStageModuleIdentifierCreateInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPipelineShaderStageModuleIdentifierCreateInfoEXT calloc(MemoryStack stack) {
        return wrap(VkPipelineShaderStageModuleIdentifierCreateInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPipelineShaderStageModuleIdentifierCreateInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkPipelineShaderStageModuleIdentifierCreateInfoEXT#SIZEOF}, and its mark will be undefined.
         *
