 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceShaderCoreProperties2AMD} structure is included in the {@code pNext} chain of the {@link VkPhysicalDeviceProperties2} structure passed to {@link VK11#vkGetPhysicalDeviceProperties2 GetPhysicalDeviceProperties2}, it is filled in with each corresponding implementation-dependent property.</p>
 * 
 ...
 *     void * {@link #pNext};
 *     VkShaderCorePropertiesFlagsAMD {@link #shaderCoreFeatures};
 *     uint32_t {@link #activeComputeUnitCount};
 * }</code></pre>
 */
public class VkPhysicalDeviceShaderCoreProperties2AMD extends Struct implements NativeResource {
    ...
    /** a bitmask of {@code VkShaderCorePropertiesFlagBitsAMD} indicating the set of features supported by the shader core. */
    ...
    @Deprecated public static VkPhysicalDeviceShaderCoreProperties2AMD mallocStack() { return malloc(stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(MemoryStack)} instead. */
    @Deprecated public static VkPhysicalDeviceShaderCoreProperties2AMD callocStack() { return calloc(stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(MemoryStack)} instead. */
    @Deprecated public static VkPhysicalDeviceShaderCoreProperties2AMD mallocStack(MemoryStack stack) { return malloc(stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(MemoryStack)} instead. */
    @Deprecated public static VkPhysicalDeviceShaderCoreProperties2AMD callocStack(MemoryStack stack) { return calloc(stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(int, MemoryStack)} instead. */
    @Deprecated public static VkPhysicalDeviceShaderCoreProperties2AMD.Buffer mallocStack(int capacity) { return malloc(capacity, stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(int, MemoryStack)} instead. */
    @Deprecated public static VkPhysicalDeviceShaderCoreProperties2AMD.Buffer callocStack(int capacity) { return calloc(capacity, stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(int, MemoryStack)} instead. */
    @Deprecated public static VkPhysicalDeviceShaderCoreProperties2AMD.Buffer mallocStack(int capacity, MemoryStack stack) { return malloc(capacity, stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(int, MemoryStack)} instead. */
    @Deprecated public static VkPhysicalDeviceShaderCoreProperties2AMD.Buffer callocStack(int capacity, MemoryStack stack) { return calloc(capacity, stack); }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceShaderCoreProperties2AMD, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@link VkPhysicalDeviceShaderCoreProperties2AMD#sType} field. */
        @NativeType("VkStructureType")
        public int sType() { return VkPhysicalDeviceShaderCoreProperties2AMD.nsType(address()); }
        /** @return the value of the {@link VkPhysicalDeviceShaderCoreProperties2AMD#pNext} field. */
        @NativeType("void *")
        public long pNext() { return VkPhysicalDeviceShaderCoreProperties2AMD.npNext(address()); }
        /** @return the value of the {@link VkPhysicalDeviceShaderCoreProperties2AMD#shaderCoreFeatures} field. */
        @NativeType("VkShaderCorePropertiesFlagsAMD")
        public int shaderCoreFeatures() { return VkPhysicalDeviceShaderCoreProperties2AMD.nshaderCoreFeatures(address()); }
        /** @return the value of the {@link VkPhysicalDeviceShaderCoreProperties2AMD#activeComputeUnitCount} field. */
        @NativeType("uint32_t")
