 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT} structure is included in the {@code pNext} chain of the {@link VkPhysicalDeviceFeatures2} structure passed to {@link VK11#vkGetPhysicalDeviceFeatures2 GetPhysicalDeviceFeatures2}, it is filled in to indicate whether each corresponding feature is supported. {@link VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT} <b>can</b> also be used in the {@code pNext} chain of {@link VkDeviceCreateInfo} to selectively enable these features.</p>
 * 
 * <h5>Valid Usage (Implicit)</h5>
 * 
 * <ul>
 * <li>{@code sType} <b>must</b> be {@link EXTLegacyVertexAttributes#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_PROPERTIES_EXT STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_PROPERTIES_EXT}</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
 ...
 *     void * {@link #pNext};
 *     VkBool32 {@link #nativeUnalignedPerformance};
 * }</code></pre>
 */
public class VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT extends Struct<VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT> implements NativeResource {
    ...
    /** specifies whether unaligned vertex fetches do not incur significant performance penalties as compared to aligned fetches. */
    @NativeType("VkBool32")
    ...
    /** Sets the {@link EXTLegacyVertexAttributes#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_PROPERTIES_EXT STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_PROPERTIES_EXT} value to the {@link #sType} field. */
    ...
    /** Sets the specified value to the {@link #nativeUnalignedPerformance} field. */
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@link VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT#sType} field. */
        @NativeType("VkStructureType")
        public int sType() { return VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT.nsType(address()); }
        /** @return the value of the {@link VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT#pNext} field. */
        @NativeType("void *")
        public long pNext() { return VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT.npNext(address()); }
        /** @return the value of the {@link VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT#nativeUnalignedPerformance} field. */
        @NativeType("VkBool32")
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT#sType} field. */
        ...
        /** Sets the {@link EXTLegacyVertexAttributes#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_PROPERTIES_EXT STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_PROPERTIES_EXT} value to the {@link VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT#sType} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT#pNext} field. */
        ...
        /** Sets the specified value to the {@link VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT#nativeUnalignedPerformance} field. */
