 ...
 * 
 * <ul>
 * <li>{@code formatA4R4G4B4} &ndash; indicates that the implementation <b>must</b> support using a {@code VkFormat} of {@link EXT4444Formats#VK_FORMAT_A4R4G4B4_UNORM_PACK16_EXT FORMAT_A4R4G4B4_UNORM_PACK16_EXT} with at least the following {@code VkFormatFeatureFlagBits}:
 * 
 * <ul>
 ...
 * </ul></li>
 * <li>{@code formatA4B4G4R4} &ndash; indicates that the implementation <b>must</b> support using a {@code VkFormat} of {@link EXT4444Formats#VK_FORMAT_A4B4G4R4_UNORM_PACK16_EXT FORMAT_A4B4G4R4_UNORM_PACK16_EXT} with at least the following {@code VkFormatFeatureFlagBits}:
 * 
 * <ul>
 * <li>{@link VK10#VK_FORMAT_FEATURE_SAMPLED_IMAGE_BIT FORMAT_FEATURE_SAMPLED_IMAGE_BIT}</li>
 * <li>{@link VK10#VK_FORMAT_FEATURE_BLIT_SRC_BIT FORMAT_FEATURE_BLIT_SRC_BIT}</li>
...
public class VkPhysicalDevice4444FormatsFeaturesEXT extends Struct implements NativeResource {
    ...
    /** Returns the value of the {@code formatA4R4G4B4} field. */
    @NativeType("VkBool32")
    public boolean formatA4R4G4B4() { return nformatA4R4G4B4(address()) != 0; }
    /** Returns the value of the {@code formatA4B4G4R4} field. */
    @NativeType("VkBool32")
    ...
    /** Returns a new {@code VkPhysicalDevice4444FormatsFeaturesEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDevice4444FormatsFeaturesEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDevice4444FormatsFeaturesEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDevice4444FormatsFeaturesEXT callocStack() {
     ...
     */
    public static VkPhysicalDevice4444FormatsFeaturesEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDevice4444FormatsFeaturesEXT callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDevice4444FormatsFeaturesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDevice4444FormatsFeaturesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevice4444FormatsFeaturesEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDevice4444FormatsFeaturesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevice4444FormatsFeaturesEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevice4444FormatsFeaturesEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDevice4444FormatsFeaturesEXT.Buffer callocStack(int capacity, MemoryStack stack) {
