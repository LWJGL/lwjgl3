 ...
 * }</code></pre>
 */
public class VkExportMetalSharedEventInfoEXT extends Struct implements NativeResource {
    ...
    public static VkExportMetalSharedEventInfoEXT malloc() {
        return wrap(VkExportMetalSharedEventInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkExportMetalSharedEventInfoEXT calloc() {
        return wrap(VkExportMetalSharedEventInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkExportMetalSharedEventInfoEXT create() {
        ...
        return wrap(VkExportMetalSharedEventInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkExportMetalSharedEventInfoEXT create(long address) {
        return wrap(VkExportMetalSharedEventInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkExportMetalSharedEventInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkExportMetalSharedEventInfoEXT.class, address);
    }
    ...
    public static VkExportMetalSharedEventInfoEXT malloc(MemoryStack stack) {
        return wrap(VkExportMetalSharedEventInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkExportMetalSharedEventInfoEXT calloc(MemoryStack stack) {
        return wrap(VkExportMetalSharedEventInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkExportMetalSharedEventInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkExportMetalSharedEventInfoEXT#SIZEOF}, and its mark will be undefined.
         *
