 ...
 * 
 * <ul>
 * <li>{@code sType} <b>must</b> be {@link VK12#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES}</li>
 * </ul>
 * 
 * <h3>Member documentation</h3>
 * 
 * <ul>
 * <li>{@code imagelessFramebuffer} &ndash; indicates that the implementation supports specifying the image view for attachments at render pass begin time via {@link VkRenderPassAttachmentBeginInfo}.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceImagelessFramebufferFeatures extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceImagelessFramebufferFeatures malloc() {
        return wrap(VkPhysicalDeviceImagelessFramebufferFeatures.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceImagelessFramebufferFeatures calloc() {
        return wrap(VkPhysicalDeviceImagelessFramebufferFeatures.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceImagelessFramebufferFeatures create() {
        ...
        return wrap(VkPhysicalDeviceImagelessFramebufferFeatures.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceImagelessFramebufferFeatures create(long address) {
        return wrap(VkPhysicalDeviceImagelessFramebufferFeatures.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceImagelessFramebufferFeatures createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceImagelessFramebufferFeatures.class, address);
    }
    ...
    /** Returns a new {@code VkPhysicalDeviceImagelessFramebufferFeatures} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceImagelessFramebufferFeatures mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceImagelessFramebufferFeatures} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDeviceImagelessFramebufferFeatures callocStack() {
     ...
     */
    public static VkPhysicalDeviceImagelessFramebufferFeatures mallocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceImagelessFramebufferFeatures.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceImagelessFramebufferFeatures callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceImagelessFramebufferFeatures.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceImagelessFramebufferFeatures.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceImagelessFramebufferFeatures.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceImagelessFramebufferFeatures.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceImagelessFramebufferFeatures.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceImagelessFramebufferFeatures.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceImagelessFramebufferFeatures.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceImagelessFramebufferFeatures, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceImagelessFramebufferFeatures#SIZEOF}, and its mark will be undefined.
         *
