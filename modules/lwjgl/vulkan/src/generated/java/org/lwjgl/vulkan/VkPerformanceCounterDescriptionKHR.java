 ...
 * <li>{@code description[VK_MAX_DESCRIPTION_SIZE]} &ndash; an array of size {@link VK10#VK_MAX_DESCRIPTION_SIZE MAX_DESCRIPTION_SIZE}, containing a null-terminated UTF-8 string specifying the description of the counter.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkPerformanceCounterDescriptionKHR extends Struct implements NativeResource {
    ...
    /** Returns a {@link ByteBuffer} view of the {@code category} field. */
    @NativeType("char[VK_MAX_DESCRIPTION_SIZE]")
    public ByteBuffer category() { return ncategory(address()); }
    /** Decodes the null-terminated string stored in the {@code category} field. */
    @NativeType("char[VK_MAX_DESCRIPTION_SIZE]")
    ...
    /** Returns a new {@code VkPerformanceCounterDescriptionKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPerformanceCounterDescriptionKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPerformanceCounterDescriptionKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPerformanceCounterDescriptionKHR callocStack() {
     ...
     */
    public static VkPerformanceCounterDescriptionKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPerformanceCounterDescriptionKHR callocStack(MemoryStack stack) {
        return wrap(VkPerformanceCounterDescriptionKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPerformanceCounterDescriptionKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPerformanceCounterDescriptionKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPerformanceCounterDescriptionKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPerformanceCounterDescriptionKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPerformanceCounterDescriptionKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPerformanceCounterDescriptionKHR.Buffer callocStack(int capacity, MemoryStack stack) {
