...
public class VkVideoQueueFamilyProperties2KHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkVideoQueueFamilyProperties2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoQueueFamilyProperties2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoQueueFamilyProperties2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoQueueFamilyProperties2KHR callocStack() {
     ...
     */
    public static VkVideoQueueFamilyProperties2KHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoQueueFamilyProperties2KHR callocStack(MemoryStack stack) {
        return wrap(VkVideoQueueFamilyProperties2KHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoQueueFamilyProperties2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoQueueFamilyProperties2KHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoQueueFamilyProperties2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoQueueFamilyProperties2KHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoQueueFamilyProperties2KHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoQueueFamilyProperties2KHR.Buffer callocStack(int capacity, MemoryStack stack) {
