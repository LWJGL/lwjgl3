...
public class StdVideoH265PredictorPaletteEntries extends Struct implements NativeResource {
    ...
    public StdVideoH265PredictorPaletteEntries PredictorPaletteEntries(@NativeType("uint16_t[3][128]") ShortBuffer value) { nPredictorPaletteEntries(address(), value); return this; }
    ...
    public static ShortBuffer nPredictorPaletteEntries(long struct) { return memShortBuffer(struct + StdVideoH265PredictorPaletteEntries.PREDICTORPALETTEENTRIES, 3 * 128); }
    ...
    public static short nPredictorPaletteEntries(long struct, int index) {
        return UNSAFE.getShort(null, struct + StdVideoH265PredictorPaletteEntries.PREDICTORPALETTEENTRIES + check(index, 3 * 128) * 2);
    }
    ...
    public static void nPredictorPaletteEntries(long struct, int index, short value) {
        UNSAFE.putShort(null, struct + StdVideoH265PredictorPaletteEntries.PREDICTORPALETTEENTRIES + check(index, 3 * 128) * 2, value);
    }
    ...
    public static class Buffer extends StructBuffer<StdVideoH265PredictorPaletteEntries, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link ShortBuffer} to the {@code PredictorPaletteEntries} field. */
        public StdVideoH265PredictorPaletteEntries.Buffer PredictorPaletteEntries(@NativeType("uint16_t[3][128]") ShortBuffer value) { StdVideoH265PredictorPaletteEntries.nPredictorPaletteEntries(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code PredictorPaletteEntries} field. */
