...
public class VkAccelerationStructureGeometryTrianglesDataKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkAccelerationStructureGeometryTrianglesDataKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkAccelerationStructureGeometryTrianglesDataKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkAccelerationStructureGeometryTrianglesDataKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkAccelerationStructureGeometryTrianglesDataKHR callocStack() {
     ...
     */
    public static VkAccelerationStructureGeometryTrianglesDataKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkAccelerationStructureGeometryTrianglesDataKHR callocStack(MemoryStack stack) {
        return wrap(VkAccelerationStructureGeometryTrianglesDataKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkAccelerationStructureGeometryTrianglesDataKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureGeometryTrianglesDataKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkAccelerationStructureGeometryTrianglesDataKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureGeometryTrianglesDataKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureGeometryTrianglesDataKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureGeometryTrianglesDataKHR.Buffer callocStack(int capacity, MemoryStack stack) {
