 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR malloc() {
        return wrap(VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR calloc() {
        return wrap(VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR create() {
        ...
        return wrap(VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR create(long address) {
        return wrap(VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR.class, address);
    }
    ...
    public static VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR#SIZEOF}, and its mark will be undefined.
         *
