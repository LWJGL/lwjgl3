 ...
 * <li>If {@link VkBufferDeviceAddressCreateInfoEXT}{@code ::deviceAddress} is not zero, {@code flags} <b>must</b> include {@link KHRBufferDeviceAddress#VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR}</li>
 * <li>If {@link VkBufferOpaqueCaptureAddressCreateInfoKHR}{@code ::opaqueCaptureAddress} is not zero, {@code flags} <b>must</b> include {@link KHRBufferDeviceAddress#VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR}</li>
 * <li>If {@code flags} includes {@link KHRBufferDeviceAddress#VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR}, the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#features-bufferDeviceAddressCaptureReplay">bufferDeviceAddressCaptureReplay</a> or <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#features-bufferDeviceAddressCaptureReplayEXT">{@link VkPhysicalDeviceBufferDeviceAddressFeaturesEXT}{@code ::bufferDeviceAddressCaptureReplay}</a> feature <b>must</b> be enabled</li>
 * </ul>
 * 
 ...
 * <li>Each {@code pNext} member of any structure (including this one) in the {@code pNext} chain <b>must</b> be either {@code NULL} or a pointer to a valid instance of {@link VkBufferDeviceAddressCreateInfoEXT}, {@link VkBufferOpaqueCaptureAddressCreateInfoKHR}, {@link VkDedicatedAllocationBufferCreateInfoNV}, or {@link VkExternalMemoryBufferCreateInfo}</li>
...
public class VkBufferCreateInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkBufferCreateInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkBufferCreateInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkBufferCreateInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
