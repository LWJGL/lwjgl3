...
public class VkExternalMemoryBufferCreateInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkExternalMemoryBufferCreateInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkExternalMemoryBufferCreateInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkExternalMemoryBufferCreateInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
