 ...
 * }</code></pre>
 */
public class VkMutableDescriptorTypeListEXT extends Struct implements NativeResource {
    ...
    public static VkMutableDescriptorTypeListEXT malloc() {
        return wrap(VkMutableDescriptorTypeListEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkMutableDescriptorTypeListEXT calloc() {
        return wrap(VkMutableDescriptorTypeListEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkMutableDescriptorTypeListEXT create() {
        ...
        return wrap(VkMutableDescriptorTypeListEXT.class, memAddress(container), container);
    }
    ...
    public static VkMutableDescriptorTypeListEXT create(long address) {
        return wrap(VkMutableDescriptorTypeListEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkMutableDescriptorTypeListEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkMutableDescriptorTypeListEXT.class, address);
    }
    ...
    public static VkMutableDescriptorTypeListEXT malloc(MemoryStack stack) {
        return wrap(VkMutableDescriptorTypeListEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkMutableDescriptorTypeListEXT calloc(MemoryStack stack) {
        return wrap(VkMutableDescriptorTypeListEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkMutableDescriptorTypeListEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkMutableDescriptorTypeListEXT#SIZEOF}, and its mark will be undefined.
         *
