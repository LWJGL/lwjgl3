...
public class VkDeviceGroupSubmitInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkDeviceGroupSubmitInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkDeviceGroupSubmitInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkDeviceGroupSubmitInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
