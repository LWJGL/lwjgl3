 ...
 * <li>{@code handleTypes} &ndash; zero, or a bitmask of {@code VkExternalMemoryHandleTypeFlagBitsNV} specifying one or more external memory handle types.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkExternalMemoryImageCreateInfoNV extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkExternalMemoryImageCreateInfoNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkExternalMemoryImageCreateInfoNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkExternalMemoryImageCreateInfoNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
