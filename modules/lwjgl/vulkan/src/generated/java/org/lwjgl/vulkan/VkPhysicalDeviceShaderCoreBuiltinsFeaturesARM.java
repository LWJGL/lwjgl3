 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM malloc() {
        return wrap(VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM calloc() {
        return wrap(VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM create() {
        ...
        return wrap(VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM create(long address) {
        return wrap(VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM.class, address);
    }
    ...
    public static VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM#SIZEOF}, and its mark will be undefined.
         *
