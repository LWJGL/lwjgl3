...
public class VkOffset2D extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkOffset2D} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkOffset2D mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkOffset2D} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     * @param capacity the buffer capacity
     */
    public static VkOffset2D.Buffer mallocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkOffset2D.Buffer callocStack(int capacity) {
