...
public class StdVideoEncodeH265PictureInfoFlags extends Struct<StdVideoEncodeH265PictureInfoFlags> implements NativeResource {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoEncodeH265PictureInfoFlags.BITFIELD0); }
    ...
    static int nbitfield1(long struct) { return memGetInt(struct + StdVideoEncodeH265PictureInfoFlags.BITFIELD1); }
    static int nreserved(long struct) { return nbitfield1(struct) & 0x00_7F_FF_FF; }

    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoEncodeH265PictureInfoFlags.BITFIELD0, value); }
    ...
    static void nbitfield1(long struct, int value) { memPutInt(struct + StdVideoEncodeH265PictureInfoFlags.BITFIELD1, value); }
    static void nreserved(long struct, int value) { nbitfield1(struct, (nbitfield1(struct) & 0xFF_80_00_00) | (value & 0x00_7F_FF_FF)); }
