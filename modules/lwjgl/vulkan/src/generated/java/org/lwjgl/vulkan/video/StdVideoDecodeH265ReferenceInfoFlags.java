...
public class StdVideoDecodeH265ReferenceInfoFlags extends Struct implements NativeResource {
    ...
    /** Returns a new {@code StdVideoDecodeH265ReferenceInfoFlags} instance allocated on the thread-local {@link MemoryStack}. */
    public static StdVideoDecodeH265ReferenceInfoFlags mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code StdVideoDecodeH265ReferenceInfoFlags} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static StdVideoDecodeH265ReferenceInfoFlags callocStack() {
     ...
     */
    public static StdVideoDecodeH265ReferenceInfoFlags mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static StdVideoDecodeH265ReferenceInfoFlags callocStack(MemoryStack stack) {
        return wrap(StdVideoDecodeH265ReferenceInfoFlags.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link StdVideoDecodeH265ReferenceInfoFlags.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoDecodeH265ReferenceInfoFlags.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link StdVideoDecodeH265ReferenceInfoFlags.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoDecodeH265ReferenceInfoFlags.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoDecodeH265ReferenceInfoFlags.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoDecodeH265ReferenceInfoFlags.Buffer callocStack(int capacity, MemoryStack stack) {
