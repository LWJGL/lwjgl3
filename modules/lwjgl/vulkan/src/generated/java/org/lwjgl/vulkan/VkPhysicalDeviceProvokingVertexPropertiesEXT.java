 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceProvokingVertexPropertiesEXT} structure is included in the {@code pNext} chain of the {@link VkPhysicalDeviceProperties2} structure passed to {@link VK11#vkGetPhysicalDeviceProperties2 GetPhysicalDeviceProperties2}, it is filled in with each corresponding implementation-dependent property.</p>
 * 
 * <h5>Valid Usage (Implicit)</h5>
 * 
 * <ul>
 * <li>{@code sType} <b>must</b> be {@link EXTProvokingVertex#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_PROPERTIES_EXT STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_PROPERTIES_EXT}</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
 ...
 *     void * {@link #pNext};
 *     VkBool32 {@link #provokingVertexModePerPipeline};
 *     VkBool32 {@link #transformFeedbackPreservesTriangleFanProvokingVertex};
 * }</code></pre>
 */
public class VkPhysicalDeviceProvokingVertexPropertiesEXT extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT malloc() {
        return wrap(VkPhysicalDeviceProvokingVertexPropertiesEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT calloc() {
        return wrap(VkPhysicalDeviceProvokingVertexPropertiesEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT create() {
        ...
        return wrap(VkPhysicalDeviceProvokingVertexPropertiesEXT.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT create(long address) {
        return wrap(VkPhysicalDeviceProvokingVertexPropertiesEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceProvokingVertexPropertiesEXT.class, address);
    }
    ...
    @Nullable
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT.Buffer createSafe(long address, int capacity) {
        return address == NULL ? null : wrap(Buffer.class, address, capacity);
    }

    // -----------------------------------

    /** Returns a new {@code VkPhysicalDeviceProvokingVertexPropertiesEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceProvokingVertexPropertiesEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT callocStack() {
     ...
     */
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT mallocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceProvokingVertexPropertiesEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceProvokingVertexPropertiesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceProvokingVertexPropertiesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPhysicalDeviceProvokingVertexPropertiesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceProvokingVertexPropertiesEXT.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceProvokingVertexPropertiesEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceProvokingVertexPropertiesEXT#SIZEOF}, and its mark will be undefined.
         *
        ...
        /** @return the value of the {@link VkPhysicalDeviceProvokingVertexPropertiesEXT#sType} field. */
        @NativeType("VkStructureType")
        public int sType() { return VkPhysicalDeviceProvokingVertexPropertiesEXT.nsType(address()); }
        /** @return the value of the {@link VkPhysicalDeviceProvokingVertexPropertiesEXT#pNext} field. */
        @NativeType("void *")
        public long pNext() { return VkPhysicalDeviceProvokingVertexPropertiesEXT.npNext(address()); }
        /** @return the value of the {@link VkPhysicalDeviceProvokingVertexPropertiesEXT#provokingVertexModePerPipeline} field. */
        @NativeType("VkBool32")
        ...
        /** @return the value of the {@link VkPhysicalDeviceProvokingVertexPropertiesEXT#transformFeedbackPreservesTriangleFanProvokingVertex} field. */
        @NativeType("VkBool32")
