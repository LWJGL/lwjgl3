...
public class VkImageResolve2KHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkImageResolve2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkImageResolve2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkImageResolve2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkImageResolve2KHR callocStack() {
     ...
     */
    public static VkImageResolve2KHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkImageResolve2KHR callocStack(MemoryStack stack) {
        return wrap(VkImageResolve2KHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkImageResolve2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkImageResolve2KHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkImageResolve2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkImageResolve2KHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageResolve2KHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageResolve2KHR.Buffer callocStack(int capacity, MemoryStack stack) {
