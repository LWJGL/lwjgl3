...
public class VkExternalFenceProperties extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkExternalFenceProperties} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkExternalFenceProperties mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkExternalFenceProperties} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
