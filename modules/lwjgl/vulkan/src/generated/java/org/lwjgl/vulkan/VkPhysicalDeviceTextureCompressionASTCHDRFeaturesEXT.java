 ...
 * <h5>Description</h5>
 * 
 * <p>If the {@link VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT} structure is included in the {@code pNext} chain of {@link VkPhysicalDeviceFeatures2}, it is filled with values indicating whether each feature is supported. {@link VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT} <b>can</b> also be used in the {@code pNext} chain of {@link VK10#vkCreateDevice CreateDevice} to enable features.</p>
 * 
...
public class VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT extends Struct implements NativeResource {
    ...
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT pNext(@NativeType("void const *") long value) { npNext(address(), value); return this; }
    ...
    /** Returns a new {@code VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     */
    public static VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT callocStack(MemoryStack stack) {
        return wrap(VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code pNext} field. */
        public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT.Buffer pNext(@NativeType("void const *") long value) { VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT.npNext(address(), value); return this; }
        /** Sets the specified value to the {@code textureCompressionASTC_HDR} field. */
