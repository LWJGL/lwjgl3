...
public class VkProtectedSubmitInfo extends Struct implements NativeResource {
    ...
    VkProtectedSubmitInfo(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    /**
     * Creates a {@link VkProtectedSubmitInfo} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link VkProtectedSubmitInfo} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static VkProtectedSubmitInfo malloc() {
        return create(nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link VkProtectedSubmitInfo} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static VkProtectedSubmitInfo calloc() {
        return create(nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link VkProtectedSubmitInfo} instance allocated with {@link BufferUtils}. */
    public static VkProtectedSubmitInfo create() {
        return new VkProtectedSubmitInfo(BufferUtils.createByteBuffer(SIZEOF));
    }

    /** Returns a new {@link VkProtectedSubmitInfo} instance for the specified memory address. */
    ...
    /** Returns a new {@link VkProtectedSubmitInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkProtectedSubmitInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link VkProtectedSubmitInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkProtectedSubmitInfo callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link VkProtectedSubmitInfo} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link VkProtectedSubmitInfo} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<VkProtectedSubmitInfo, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link VkProtectedSubmitInfo.Buffer} instance backed by the specified container.
         *
        ...
        @Override
        protected VkProtectedSubmitInfo newInstance(long address) {
