...
public class AMDBufferMarker {
     ...
     * <li>If the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#features-synchronization2">{@code synchronization2}</a> feature is not enabled, {@code pipelineStage} <b>must</b> not be {@link KHRSynchronization2#VK_PIPELINE_STAGE_NONE_KHR PIPELINE_STAGE_NONE_KHR}</li>
