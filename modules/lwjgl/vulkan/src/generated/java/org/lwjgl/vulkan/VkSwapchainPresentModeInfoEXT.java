 ...
 * }</code></pre>
 */
public class VkSwapchainPresentModeInfoEXT extends Struct implements NativeResource {
    ...
    public VkSwapchainPresentModeInfoEXT pNext(@NativeType("void *") long value) { npNext(address(), value); return this; }
    ...
    public static VkSwapchainPresentModeInfoEXT malloc() {
        return wrap(VkSwapchainPresentModeInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkSwapchainPresentModeInfoEXT calloc() {
        return wrap(VkSwapchainPresentModeInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkSwapchainPresentModeInfoEXT create() {
        ...
        return wrap(VkSwapchainPresentModeInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkSwapchainPresentModeInfoEXT create(long address) {
        return wrap(VkSwapchainPresentModeInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkSwapchainPresentModeInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkSwapchainPresentModeInfoEXT.class, address);
    }
    ...
    public static VkSwapchainPresentModeInfoEXT malloc(MemoryStack stack) {
        return wrap(VkSwapchainPresentModeInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkSwapchainPresentModeInfoEXT calloc(MemoryStack stack) {
        return wrap(VkSwapchainPresentModeInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkSwapchainPresentModeInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkSwapchainPresentModeInfoEXT#SIZEOF}, and its mark will be undefined.
         *
        ...
        public VkSwapchainPresentModeInfoEXT.Buffer pNext(@NativeType("void *") long value) { VkSwapchainPresentModeInfoEXT.npNext(address(), value); return this; }
