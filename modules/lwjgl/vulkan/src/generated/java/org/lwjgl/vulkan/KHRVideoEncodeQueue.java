...
public class KHRVideoEncodeQueue {
     ...
     * 
     * <ul>
     * <li>{@link #VK_VIDEO_ENCODE_CAPABILITY_PRECEDING_EXTERNALLY_ENCODED_BYTES_BIT_KHR VIDEO_ENCODE_CAPABILITY_PRECEDING_EXTERNALLY_ENCODED_BYTES_BIT_KHR} specifies that the implementation supports the use of {@link VkVideoEncodeInfoKHR}{@code ::precedingExternallyEncodedBytes}.</li>
     ...
     * <li>When using an <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-av1-profile">AV1 encode profile</a>, implementations will use the quantizer index value specified in {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::constantQIndex} to control the quality of the encoded picture.</li>
     * </ul>
     * </li>
     ...
     * <li>If {@code pQualityLevelInfo→pVideoProfile→videoCodecOperation} is {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR}, then the {@code pNext} chain of {@code pQualityLevelProperties} <b>must</b> include a {@link VkVideoEncodeAV1QualityLevelPropertiesKHR} structure</li>
     * </ul>
     * 
     ...
     * </ul>
     * </li>
     * <li>If there is a bound video session parameters object created with {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR}, then let {@code VkExtent2D quantizationMapTexelSize} be the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-quantization-map-texel-size">quantization map texel size</a> the bound video session parameters object was created with.</li>
     ...
     * </ul>
     * </li>
     * <li>If the bound video session object was created with an <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-av1-profile">AV1 encode profile</a>, then:
     * 
     * <ul>
     * <li>If the {@code primaryReferenceCdfOnly} member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pEncodeInfo→pNext} chain is set to {@link VK10#VK_TRUE TRUE}, then let {@code int32_t cdfOnlyReferenceIndex} be the value of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo→primary_ref_frame}.</li>
     ...
     * <li>If {@code pEncodeInfo→flags} includes {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_ENCODE_WITH_QUANTIZATION_DELTA_MAP_BIT_KHR VIDEO_ENCODE_WITH_QUANTIZATION_DELTA_MAP_BIT_KHR}, then the bound video session <b>must</b> have been created with {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR VIDEO_SESSION_CREATE_ALLOW_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR}</li>
     * <li>If {@code pEncodeInfo→flags} includes {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_ENCODE_WITH_EMPHASIS_MAP_BIT_KHR VIDEO_ENCODE_WITH_EMPHASIS_MAP_BIT_KHR}, then the bound video session <b>must</b> have been created with {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_EMPHASIS_MAP_BIT_KHR VIDEO_SESSION_CREATE_ALLOW_ENCODE_EMPHASIS_MAP_BIT_KHR}</li>
     * <li>If the current <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-rate-control-modes">rate control mode</a> is {@link #VK_VIDEO_ENCODE_RATE_CONTROL_MODE_DEFAULT_KHR VIDEO_ENCODE_RATE_CONTROL_MODE_DEFAULT_KHR} or {@link #VK_VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR}, then {@code pEncodeInfo→flags} <b>must</b> not include {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_ENCODE_WITH_EMPHASIS_MAP_BIT_KHR VIDEO_ENCODE_WITH_EMPHASIS_MAP_BIT_KHR}</li>
     * <li>If {@code pEncodeInfo→flags} includes {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_ENCODE_WITH_QUANTIZATION_DELTA_MAP_BIT_KHR VIDEO_ENCODE_WITH_QUANTIZATION_DELTA_MAP_BIT_KHR} or {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_ENCODE_WITH_EMPHASIS_MAP_BIT_KHR VIDEO_ENCODE_WITH_EMPHASIS_MAP_BIT_KHR}, then the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> include a {@link VkVideoEncodeQuantizationMapInfoKHR} structure with its {@code quantizationMap} member specifying a valid {@code VkImageView} handle</li>
     * <li>If {@code pEncodeInfo→flags} includes {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_ENCODE_WITH_QUANTIZATION_DELTA_MAP_BIT_KHR VIDEO_ENCODE_WITH_QUANTIZATION_DELTA_MAP_BIT_KHR} or {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_ENCODE_WITH_EMPHASIS_MAP_BIT_KHR VIDEO_ENCODE_WITH_EMPHASIS_MAP_BIT_KHR}, then the {@code VkImageView} specified by the {@code quantizationMap} member of the {@link VkVideoEncodeQuantizationMapInfoKHR} structure included in the {@code pNext} chain <b>must</b> be <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#video-profile-compatibility">compatible</a> with the video profile the bound video session was created with</li>
     * <li>If {@code pEncodeInfo→flags} includes {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_ENCODE_WITH_QUANTIZATION_DELTA_MAP_BIT_KHR VIDEO_ENCODE_WITH_QUANTIZATION_DELTA_MAP_BIT_KHR}, then the {@code VkImageView} specified by the {@code quantizationMap} member of the {@link VkVideoEncodeQuantizationMapInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> have been created with {@link KHRVideoEncodeQuantizationMap#VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR}</li>
     * <li>If {@code pEncodeInfo→flags} includes {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_ENCODE_WITH_EMPHASIS_MAP_BIT_KHR VIDEO_ENCODE_WITH_EMPHASIS_MAP_BIT_KHR}, then the {@code VkImageView} specified by the {@code quantizationMap} member of the {@link VkVideoEncodeQuantizationMapInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> have been created with {@link KHRVideoEncodeQuantizationMap#VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR}</li>
     * <li>If an instance of the {@link VkVideoEncodeQuantizationMapInfoKHR} structure is included in the {@code pNext} chain of {@code pEncodeInfo}, its {@code quantizationMap} member is not {@link VK10#VK_NULL_HANDLE NULL_HANDLE}, {@code commandBuffer} is an unprotected command buffer, and <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#limits-protectedNoFault">{@code protectedNoFault}</a> is not supported, then {@link VkVideoEncodeQuantizationMapInfoKHR}{@code ::quantizationMap} <b>must</b> not have been created from a protected image</li>
     * <li>If an instance of the {@link VkVideoEncodeQuantizationMapInfoKHR} structure is included in the {@code pNext} chain of {@code pEncodeInfo} and its {@code quantizationMap} member is not {@link VK10#VK_NULL_HANDLE NULL_HANDLE}, then the image subresource range referenced by {@code quantizationMap} <b>must</b> be in the {@link KHRVideoEncodeQuantizationMap#VK_IMAGE_LAYOUT_VIDEO_ENCODE_QUANTIZATION_MAP_KHR IMAGE_LAYOUT_VIDEO_ENCODE_QUANTIZATION_MAP_KHR} layout at the time the video encode operation is executed on the device</li>
     * <li>If an instance of the {@link VkVideoEncodeQuantizationMapInfoKHR} structure is included in the {@code pNext} chain of {@code pEncodeInfo} and its {@code quantizationMap} member is not {@link VK10#VK_NULL_HANDLE NULL_HANDLE}, and there is a bound video session parameters object, then the bound video session parameters object <b>must</b> have been created with {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR}</li>
     * <li>If an instance of the {@link VkVideoEncodeQuantizationMapInfoKHR} structure is included in the {@code pNext} chain of {@code pEncodeInfo}, its {@code quantizationMap} member is not {@link VK10#VK_NULL_HANDLE NULL_HANDLE}, and there is a bound video session parameters object created with {@link KHRVideoEncodeQuantizationMap#VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR}, then {@code quantizationMapExtent} <b>must</b> equal <code>⌈pEncodeInfo→srcPictureResource.codedExtent / quantizationMapTexelSize⌉</code></li>
     ...
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR}, then the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> include a {@link VkVideoEncodeAV1PictureInfoKHR} structure</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and {@code pEncodeInfo→pSetupReferenceSlot} is not {@code NULL}, then the {@code pNext} chain of {@code pEncodeInfo→pSetupReferenceSlot} <b>must</b> include a {@link VkVideoEncodeAV1DpbSlotInfoKHR} structure</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR}, then the {@code pNext} chain of each element of {@code pEncodeInfo→pReferenceSlots} <b>must</b> include a {@link VkVideoEncodeAV1DpbSlotInfoKHR} structure</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the current <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-rate-control-modes">rate control mode</a> is not {@link #VK_VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR}, then the {@code constantQIndex} member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> be zero</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the current <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-rate-control-modes">rate control mode</a> is {@link #VK_VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR}, then the {@code constantQIndex} member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> be between {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::minQIndex} and {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::maxQIndex}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::flags} does not include {@link KHRVideoEncodeAV1#VK_VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE_BIT_KHR VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE_BIT_KHR}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with, then {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo→flags.frame_size_override_flag} <b>must</b> be zero for the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::flags} does not include {@link KHRVideoEncodeAV1#VK_VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE_BIT_KHR VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE_BIT_KHR}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with, then {@code pEncodeInfo→srcPictureResource.codedExtent.width} <b>must</b> equal <code>StdVideoAV1SequenceHeader::max_frame_width_minus_1 + 1</code> of the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-av1-active-sequence-header">active AV1 sequence header</a></li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::flags} does not include {@link KHRVideoEncodeAV1#VK_VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE_BIT_KHR VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE_BIT_KHR}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with, then {@code pEncodeInfo→srcPictureResource.codedExtent.height} <b>must</b> equal <code>StdVideoAV1SequenceHeader::max_frame_height_minus_1 + 1</code> of the <a href="https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#encode-av1-active-sequence-header">active AV1 sequence header</a></li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::flags} does not include {@link KHRVideoEncodeAV1#VK_VIDEO_ENCODE_AV1_CAPABILITY_MOTION_VECTOR_SCALING_BIT_KHR VIDEO_ENCODE_AV1_CAPABILITY_MOTION_VECTOR_SCALING_BIT_KHR}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with, then for each element <code>i</code> of {@code pEncodeInfo→pReferenceSlots} {@code pEncodeInfo→pReferenceSlots}[i].{@code pPictureResource→codedExtent} <b>must</b> match {@code pEncodeInfo→srcPictureResource.codedExtent}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code predictionMode} member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is {@link KHRVideoEncodeAV1#VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_INTRA_ONLY_KHR VIDEO_ENCODE_AV1_PREDICTION_MODE_INTRA_ONLY_KHR}, then {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo→frame_type} <b>must</b> be {@code STD_VIDEO_AV1_FRAME_TYPE_KEY} or {@code STD_VIDEO_AV1_FRAME_TYPE_INTRA_ONLY}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and {@code pStdPictureInfo→frame_type} for the {@code pStdPictureInfo} member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is {@code STD_VIDEO_AV1_FRAME_TYPE_KEY} or {@code STD_VIDEO_AV1_FRAME_TYPE_INTRA_ONLY}, then {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::predictionMode} <b>must</b> be {@link KHRVideoEncodeAV1#VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_INTRA_ONLY_KHR VIDEO_ENCODE_AV1_PREDICTION_MODE_INTRA_ONLY_KHR}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::maxSingleReferenceCount} is zero, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with, then the {@code predictionMode} member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> not be {@link KHRVideoEncodeAV1#VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_SINGLE_REFERENCE_KHR VIDEO_ENCODE_AV1_PREDICTION_MODE_SINGLE_REFERENCE_KHR}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code predictionMode} member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is {@link KHRVideoEncodeAV1#VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_SINGLE_REFERENCE_KHR VIDEO_ENCODE_AV1_PREDICTION_MODE_SINGLE_REFERENCE_KHR}, then there <b>must</b> be at least one non-negative element of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::referenceNameSlotIndices} with element index <code>i</code> that does not equal {@code cdfOnlyReferenceIndex} and for which bit index <code>i</code> is set in {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::singleReferenceNameMask}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::maxUnidirectionalCompoundReferenceCount} is zero, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with, then the {@code predictionMode} member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> not be {@link KHRVideoEncodeAV1#VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_UNIDIRECTIONAL_COMPOUND_KHR VIDEO_ENCODE_AV1_PREDICTION_MODE_UNIDIRECTIONAL_COMPOUND_KHR}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code predictionMode} member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is {@link KHRVideoEncodeAV1#VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_UNIDIRECTIONAL_COMPOUND_KHR VIDEO_ENCODE_AV1_PREDICTION_MODE_UNIDIRECTIONAL_COMPOUND_KHR}, then there <b>must</b> be at least two non-negative elements of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::referenceNameSlotIndices} with element indices <code>i</code> and <code>j</code> where <code>(i,j) ∈ {(0,1),(0,2),(0,3),(4,6)}</code>, such that neither element equals {@code cdfOnlyReferenceIndex} and for which bit indices <code>i</code> and <code>j</code> are set in {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::unidirectionalCompoundReferenceNameMask}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::maxBidirectionalCompoundReferenceCount} is zero, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with, then the {@code predictionMode} member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> not be {@link KHRVideoEncodeAV1#VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_BIDIRECTIONAL_COMPOUND_KHR VIDEO_ENCODE_AV1_PREDICTION_MODE_BIDIRECTIONAL_COMPOUND_KHR}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code predictionMode} member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is {@link KHRVideoEncodeAV1#VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_BIDIRECTIONAL_COMPOUND_KHR VIDEO_ENCODE_AV1_PREDICTION_MODE_BIDIRECTIONAL_COMPOUND_KHR}, then there <b>must</b> be at least two non-negative elements of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::referenceNameSlotIndices} with element indices <code>i ∈ {0,1,2,3}</code> and <code>j ∈ {4,5,6}</code>, respectively, such that neither element equals {@code cdfOnlyReferenceIndex}, and for which bit indices <code>i</code> and <code>j</code> are set in {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::bidirectionalCompoundReferenceNameMask}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR}, then each element of the {@code referenceNameSlotIndices} array member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> either be negative or <b>must</b> equal the {@code slotIndex} member of one of the elements of {@code pEncodeInfo→pReferenceSlots}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR}, then the {@code slotIndex} member of each element of {@code pEncodeInfo→pReferenceSlots} <b>must</b> equal one of the elements of the {@code referenceNameSlotIndices} array member of the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code pExtensionHeader} member of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo} for the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is not {@code NULL}, then {@code pExtensionHeader→temporal_id} <b>must</b> be less than {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::maxTemporalLayerCount}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code pExtensionHeader} member of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo} for the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is not {@code NULL}, then {@code pExtensionHeader→spatial_id} <b>must</b> be less than {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::maxSpatialLayerCount}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and {@code pEncodeInfo→pSetupReferenceSlot} is not {@code NULL}, then the {@code pExtensionHeader} member of {@link VkVideoEncodeAV1DpbSlotInfoKHR}{@code ::pStdReferenceInfo} for the {@link VkVideoEncodeAV1DpbSlotInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo→pSetupReferenceSlot} and the {@code pExtensionHeader} member of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo} for the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> both be {@code NULL} or not {@code NULL}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR}, {@code pEncodeInfo→pSetupReferenceSlot} is not {@code NULL}, and the {@code pExtensionHeader} member of {@link VkVideoEncodeAV1DpbSlotInfoKHR}{@code ::pStdReferenceInfo} for the {@link VkVideoEncodeAV1DpbSlotInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo→pSetupReferenceSlot} is not {@code NULL}, then {@code pExtensionHeader→temporal_id} <b>must</b> equal {@code pStdPictureInfo→pExtensionHeader→temporal_id} in the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR}, {@code pEncodeInfo→pSetupReferenceSlot} is not {@code NULL}, and the {@code pExtensionHeader} member of {@link VkVideoEncodeAV1DpbSlotInfoKHR}{@code ::pStdReferenceInfo} for the {@link VkVideoEncodeAV1DpbSlotInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo→pSetupReferenceSlot} is not {@code NULL}, then {@code pExtensionHeader→spatial_id} <b>must</b> equal {@code pStdPictureInfo→pExtensionHeader→spatial_id} in the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code pExtensionHeader} member of {@link VkVideoEncodeAV1DpbSlotInfoKHR}{@code ::pStdReferenceInfo} for any of the {@link VkVideoEncodeAV1DpbSlotInfoKHR} structures included in the {@code pNext} chain of any element of {@code pEncodeInfo→pReferenceSlots} is not {@code NULL}, then {@code pExtensionHeader→temporal_id} <b>must</b> be less than {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::maxTemporalLayerCount}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code pExtensionHeader} member of {@link VkVideoEncodeAV1DpbSlotInfoKHR}{@code ::pStdReferenceInfo} for any of the {@link VkVideoEncodeAV1DpbSlotInfoKHR} structures included in the {@code pNext} chain of any element of {@code pEncodeInfo→pReferenceSlots} is not {@code NULL}, then {@code pExtensionHeader→spatial_id} <b>must</b> be less than {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::maxSpatialLayerCount}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code pTileInfo} member of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo} for the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is not {@code NULL}, then {@code pTileInfo→TileCols} <b>must</b> be greater than 0</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code pTileInfo} member of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo} for the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is not {@code NULL}, then {@code pTileInfo→TileRows} <b>must</b> be greater than 0</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code pTileInfo} member of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo} for the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is not {@code NULL}, then {@code pTileInfo→TileCols} <b>must</b> be less than or equal to {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::maxTiles.width}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code pTileInfo} member of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo} for the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is not {@code NULL}, then {@code pTileInfo→TileRows} <b>must</b> be less than or equal to {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::maxTiles.height}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code pTileInfo} member of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo} for the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is not {@code NULL}, then <code>⌈pEncodeInfo→srcPictureResource.codedExtent.width / pTileInfo→TileCols⌉</code> <b>must</b> be between {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::minTileSize.width} and {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::maxTileSize.width}, inclusive, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR} and the {@code pTileInfo} member of {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo} for the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} is not {@code NULL}, then <code>⌈pEncodeInfo→srcPictureResource.codedExtent.height / pTileInfo→TileRows⌉</code> <b>must</b> be between {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::minTileSize.height} and {@link VkVideoEncodeAV1CapabilitiesKHR}{@code ::maxTileSize.height}, inclusive, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR}, then {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo→flags.segmentation_enabled} for the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> be zero</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeAV1#VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR}, then {@link VkVideoEncodeAV1PictureInfoKHR}{@code ::pStdPictureInfo→pSegmentation} for the {@link VkVideoEncodeAV1PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo} <b>must</b> be {@code NULL}</li>
     * </ul>
     * 
     * <h5>Valid Usage (Implicit)</h5>
     * 
