...
public class KHRVideoEncodeQueue {
     ...
     * 
     * <ul>
     * <li>When using an <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-h264-profile">H.264 encode profile</a>, implementations will use the QP value specified in {@link VkVideoEncodeH264NaluSliceInfoKHR}{@code ::constantQp} to control the quality of the encoded picture.</li>
     * <li>When using an <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-h265-profile">H.265 encode profile</a>, implementations will use the QP value specified in {@link VkVideoEncodeH265NaluSliceSegmentInfoKHR}{@code ::constantQp} to control the quality of the encoded picture.</li>
     * </ul>
     * </li>
     ...
     * <li>{@link #VK_VIDEO_ENCODE_FEEDBACK_BITSTREAM_HAS_OVERRIDES_BIT_KHR VIDEO_ENCODE_FEEDBACK_BITSTREAM_HAS_OVERRIDES_BIT_KHR} specifies that queries managed by the pool will capture a boolean value indicating that the data written to the bitstream buffer specified in {@link VkVideoEncodeInfoKHR}{@code ::dstBuffer} contains <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-overrides">overridden parameters</a>.</li>
     * </ul>
     * 
     ...
     * <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
     * 
     * <p>Thus it is recommended that applications always specify {@link KHRVideoQueue#VK_QUERY_RESULT_WITH_STATUS_BIT_KHR QUERY_RESULT_WITH_STATUS_BIT_KHR} when retrieving the results of video encode feedback queries and ignore such undefined video encode feedback values for any <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-unsuccessful">unsuccessfully</a> completed video encode operations.</p>
     * </div>
     */
    public static final int
     ...
     * <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
     * 
     * <p>This includes the cases when {@code pData} is {@code NULL} or when {@link VK10#VK_INCOMPLETE INCOMPLETE} is returned by the command, and enables the application to determine whether the implementation <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-overrides">overrode</a> any of the requested video session parameters without actually needing to retrieve the encoded parameter data itself.</p>
     * </div>
     * 
     * <h5>Valid Usage</h5>
     * 
     ...
     * </dl>
     * 
     * <p>Specifying a valid {@link VkVideoReferenceSlotInfoKHR} structure in {@code pEncodeInfo→pSetupReferenceSlot} is always required, unless the video session was created with {@link VkVideoSessionCreateInfoKHR}{@code ::maxDpbSlot} equal to zero. However, the DPB slot identified by {@code pEncodeInfo→pSetupReferenceSlot→slotIndex} is only <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#dpb-slot-states">activated</a> with the <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#reconstructed-picture">reconstructed picture</a> specified in {@code pEncodeInfo→pSetupReferenceSlot→pPictureResource} if reference picture setup is requested according to the <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-codec-specific-semantics">codec-specific semantics</a>.</p>
     * 
     * <p>If reconstructed picture information is specified, but reference picture setup is not requested, according to the codec-specific semantics, the contents of the <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#video-picture-resources">video picture resource</a> corresponding to the reconstructed picture will be undefined after the video encode operation.</p>
     * 
     * <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
     * 
     ...
     * 
     * <ul>
     * <li>If the bound video session object was created with an <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-h264-profile">H.264 encode profile</a>, then let {@code maxCodingBlockSize} be equal to the size of an H.264 macroblock, i.e. {@code {16,16}}.</li>
     * <li>If the bound video session object was created with an <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-h265-profile">H.265 encode profile</a>, then let {@code maxCodingBlockSize} be equal to the maximum H.265 coding block size that <b>may</b> be used by the video encode operation derived as the maximum of the CTB sizes corresponding to the {@code VkVideoEncodeH265CtbSizeFlagBitsKHR} bits set in {@link VkVideoEncodeH265CapabilitiesKHR}{@code ::ctbSizes}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with.</li>
     * <li>Otherwise, {@code maxCodingBlockSize} is undefined.</li>
     * </ul>
     * </li>
     * <li>If {@code maxCodingBlockSize} is defined, then let {@code VkExtent2D minCodingBlockExtent} be the coded extent of the <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-input-picture">encode input picture</a> expressed in terms of codec-specific coding blocks, assuming the maximum size of such coding blocks, as defined by {@code maxCodingBlockSize}, calculated from the value of the {@code codedExtent} member of {@code pEncodeInfo→srcPictureResource} as follows:
     * 
     * <ul>
     ...
     * </ul>
     * </li>
     * <li>If the bound video session object was created with an <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-h264-profile">H.264 encode profile</a>, then:
     * 
     * <ul>
     ...
     * </ul>
     * </li>
     * <li>If the bound video session object was created with an <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-h264-profile">H.265 encode profile</a>, then:
     * 
     * <ul>
     ...
     * <li>The bound video session parameters object <b>must</b> have been created with the currently set <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-quality-level">video encode quality level</a> for the bound video session at the time the command is executed on the device</li>
     ...
     * <li>{@code pEncodeInfo→dstBuffer} <b>must</b> be <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#video-profile-compatibility">compatible</a> with the video profile the bound video session was created with</li>
     * <li>If {@code commandBuffer} is an unprotected command buffer and <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#limits-protectedNoFault">{@code protectedNoFault}</a> is not supported, then {@code pEncodeInfo→dstBuffer} <b>must</b> not be a protected buffer</li>
     * <li>If {@code commandBuffer} is a protected command buffer and <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#limits-protectedNoFault">{@code protectedNoFault}</a> is not supported, then {@code pEncodeInfo→dstBuffer} <b>must</b> be a protected buffer</li>
     ...
     * <li>{@code pEncodeInfo→srcPictureResource.imageViewBinding} <b>must</b> be <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#video-profile-compatibility">compatible</a> with the video profile the bound video session was created with</li>
     ...
     * <li>If {@code pEncodeInfo→pSetupReferenceSlot} is not {@code NULL}, then {@code pEncodeInfo→pSetupReferenceSlot→pPictureResource} <b>must</b> <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#video-picture-resource-matching">match</a> one of the <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#bound-reference-picture-resources">bound reference picture resource</a></li>
     ...
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeH264#VK_VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_KHR} and the current <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-rate-control-modes">rate control mode</a> is not {@link #VK_VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR}, then {@link VkVideoEncodeH264NaluSliceInfoKHR}{@code ::constantQp} <b>must</b> be zero for each element of the {@code pNaluSliceEntries} member of the {@link VkVideoEncodeH264PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeH264#VK_VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_KHR} and the current <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-rate-control-modes">rate control mode</a> is {@link #VK_VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR}, then {@link VkVideoEncodeH264NaluSliceInfoKHR}{@code ::constantQp} <b>must</b> be between {@link VkVideoEncodeH264CapabilitiesKHR}{@code ::minQp} and {@link VkVideoEncodeH264CapabilitiesKHR}{@code ::maxQp}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with, for each element of the {@code pNaluSliceEntries} member of the {@link VkVideoEncodeH264PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo}</li>
     ...
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeH265#VK_VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_KHR} and the current <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-rate-control-modes">rate control mode</a> is not {@link #VK_VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR}, then {@link VkVideoEncodeH265NaluSliceSegmentInfoKHR}{@code ::constantQp} <b>must</b> be zero for each element of the {@code pNaluSliceSegmentEntries} member of the {@link VkVideoEncodeH265PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo}</li>
     * <li>If the bound video session was created with the video codec operation {@link KHRVideoEncodeH265#VK_VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_KHR VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_KHR} and the current <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-rate-control-modes">rate control mode</a> is {@link #VK_VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR}, then {@link VkVideoEncodeH265NaluSliceSegmentInfoKHR}{@code ::constantQp} <b>must</b> be between {@link VkVideoEncodeH265CapabilitiesKHR}{@code ::minQp} and {@link VkVideoEncodeH265CapabilitiesKHR}{@code ::maxQp}, as returned by {@link KHRVideoQueue#vkGetPhysicalDeviceVideoCapabilitiesKHR GetPhysicalDeviceVideoCapabilitiesKHR} for the video profile the bound video session was created with, for each element of the {@code pNaluSliceSegmentEntries} member of the {@link VkVideoEncodeH265PictureInfoKHR} structure included in the {@code pNext} chain of {@code pEncodeInfo}</li>
