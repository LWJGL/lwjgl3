 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV malloc() {
        return wrap(VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV calloc() {
        return wrap(VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV create() {
        ...
        return wrap(VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV create(long address) {
        return wrap(VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV.class, address);
    }
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV#SIZEOF}, and its mark will be undefined.
         *
