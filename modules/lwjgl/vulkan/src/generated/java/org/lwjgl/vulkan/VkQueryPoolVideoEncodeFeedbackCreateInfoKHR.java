 ...
 * }</code></pre>
 */
public class VkQueryPoolVideoEncodeFeedbackCreateInfoKHR extends Struct implements NativeResource {
    ...
    public static VkQueryPoolVideoEncodeFeedbackCreateInfoKHR malloc() {
        return wrap(VkQueryPoolVideoEncodeFeedbackCreateInfoKHR.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkQueryPoolVideoEncodeFeedbackCreateInfoKHR calloc() {
        return wrap(VkQueryPoolVideoEncodeFeedbackCreateInfoKHR.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkQueryPoolVideoEncodeFeedbackCreateInfoKHR create() {
        ...
        return wrap(VkQueryPoolVideoEncodeFeedbackCreateInfoKHR.class, memAddress(container), container);
    }
    ...
    public static VkQueryPoolVideoEncodeFeedbackCreateInfoKHR create(long address) {
        return wrap(VkQueryPoolVideoEncodeFeedbackCreateInfoKHR.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkQueryPoolVideoEncodeFeedbackCreateInfoKHR createSafe(long address) {
        return address == NULL ? null : wrap(VkQueryPoolVideoEncodeFeedbackCreateInfoKHR.class, address);
    }
    ...
    public static VkQueryPoolVideoEncodeFeedbackCreateInfoKHR malloc(MemoryStack stack) {
        return wrap(VkQueryPoolVideoEncodeFeedbackCreateInfoKHR.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkQueryPoolVideoEncodeFeedbackCreateInfoKHR calloc(MemoryStack stack) {
        return wrap(VkQueryPoolVideoEncodeFeedbackCreateInfoKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkQueryPoolVideoEncodeFeedbackCreateInfoKHR, Buffer> implements NativeResource {
         ...
         * by {@link VkQueryPoolVideoEncodeFeedbackCreateInfoKHR#SIZEOF}, and its mark will be undefined.
         *
