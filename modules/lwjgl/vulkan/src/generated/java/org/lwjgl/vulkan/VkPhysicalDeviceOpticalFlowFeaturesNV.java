 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceOpticalFlowFeaturesNV extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceOpticalFlowFeaturesNV malloc() {
        return wrap(VkPhysicalDeviceOpticalFlowFeaturesNV.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceOpticalFlowFeaturesNV calloc() {
        return wrap(VkPhysicalDeviceOpticalFlowFeaturesNV.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceOpticalFlowFeaturesNV create() {
        ...
        return wrap(VkPhysicalDeviceOpticalFlowFeaturesNV.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceOpticalFlowFeaturesNV create(long address) {
        return wrap(VkPhysicalDeviceOpticalFlowFeaturesNV.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceOpticalFlowFeaturesNV createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceOpticalFlowFeaturesNV.class, address);
    }
    ...
    public static VkPhysicalDeviceOpticalFlowFeaturesNV malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceOpticalFlowFeaturesNV.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceOpticalFlowFeaturesNV calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceOpticalFlowFeaturesNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceOpticalFlowFeaturesNV, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceOpticalFlowFeaturesNV#SIZEOF}, and its mark will be undefined.
         *
