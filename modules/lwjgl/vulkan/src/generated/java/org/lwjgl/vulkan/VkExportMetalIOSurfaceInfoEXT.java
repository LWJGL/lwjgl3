 ...
 * }</code></pre>
 */
public class VkExportMetalIOSurfaceInfoEXT extends Struct implements NativeResource {
    ...
    public static VkExportMetalIOSurfaceInfoEXT malloc() {
        return wrap(VkExportMetalIOSurfaceInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkExportMetalIOSurfaceInfoEXT calloc() {
        return wrap(VkExportMetalIOSurfaceInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkExportMetalIOSurfaceInfoEXT create() {
        ...
        return wrap(VkExportMetalIOSurfaceInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkExportMetalIOSurfaceInfoEXT create(long address) {
        return wrap(VkExportMetalIOSurfaceInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkExportMetalIOSurfaceInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkExportMetalIOSurfaceInfoEXT.class, address);
    }
    ...
    public static VkExportMetalIOSurfaceInfoEXT malloc(MemoryStack stack) {
        return wrap(VkExportMetalIOSurfaceInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkExportMetalIOSurfaceInfoEXT calloc(MemoryStack stack) {
        return wrap(VkExportMetalIOSurfaceInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkExportMetalIOSurfaceInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkExportMetalIOSurfaceInfoEXT#SIZEOF}, and its mark will be undefined.
         *
