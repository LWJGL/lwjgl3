 ...
 * }</code></pre>
 */
public class VkVideoDecodeUsageInfoKHR extends Struct implements NativeResource {
    ...
    public static VkVideoDecodeUsageInfoKHR malloc() {
        return wrap(VkVideoDecodeUsageInfoKHR.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkVideoDecodeUsageInfoKHR calloc() {
        return wrap(VkVideoDecodeUsageInfoKHR.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkVideoDecodeUsageInfoKHR create() {
        ...
        return wrap(VkVideoDecodeUsageInfoKHR.class, memAddress(container), container);
    }
    ...
    public static VkVideoDecodeUsageInfoKHR create(long address) {
        return wrap(VkVideoDecodeUsageInfoKHR.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkVideoDecodeUsageInfoKHR createSafe(long address) {
        return address == NULL ? null : wrap(VkVideoDecodeUsageInfoKHR.class, address);
    }
    ...
    public static VkVideoDecodeUsageInfoKHR malloc(MemoryStack stack) {
        return wrap(VkVideoDecodeUsageInfoKHR.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkVideoDecodeUsageInfoKHR calloc(MemoryStack stack) {
        return wrap(VkVideoDecodeUsageInfoKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkVideoDecodeUsageInfoKHR, Buffer> implements NativeResource {
         ...
         * by {@link VkVideoDecodeUsageInfoKHR#SIZEOF}, and its mark will be undefined.
         *
