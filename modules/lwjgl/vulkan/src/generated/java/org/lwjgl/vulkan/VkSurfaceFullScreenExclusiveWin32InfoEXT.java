...
public class VkSurfaceFullScreenExclusiveWin32InfoEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkSurfaceFullScreenExclusiveWin32InfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSurfaceFullScreenExclusiveWin32InfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSurfaceFullScreenExclusiveWin32InfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     */
    public static VkSurfaceFullScreenExclusiveWin32InfoEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkSurfaceFullScreenExclusiveWin32InfoEXT callocStack(MemoryStack stack) {
        return wrap(VkSurfaceFullScreenExclusiveWin32InfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkSurfaceFullScreenExclusiveWin32InfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkSurfaceFullScreenExclusiveWin32InfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static VkSurfaceFullScreenExclusiveWin32InfoEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkSurfaceFullScreenExclusiveWin32InfoEXT.Buffer callocStack(int capacity, MemoryStack stack) {
