 ...
 * <li>{@code memoryRequirements} &ndash; a {@link VkSparseImageMemoryRequirements} structure describing the memory requirements of the sparse image.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkSparseImageMemoryRequirements2 extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkSparseImageMemoryRequirements2} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkSparseImageMemoryRequirements2 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkSparseImageMemoryRequirements2} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
