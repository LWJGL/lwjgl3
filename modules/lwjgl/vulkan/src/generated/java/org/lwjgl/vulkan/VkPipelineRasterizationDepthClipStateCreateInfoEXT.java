 ...
 * <li>{@code depthClipEnable} &ndash; controls whether depth clipping is enabled as described in <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#vertexpostproc-clipping">Primitive Clipping</a>.</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class VkPipelineRasterizationDepthClipStateCreateInfoEXT extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPipelineRasterizationDepthClipStateCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPipelineRasterizationDepthClipStateCreateInfoEXT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPipelineRasterizationDepthClipStateCreateInfoEXT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkPipelineRasterizationDepthClipStateCreateInfoEXT callocStack() {
     ...
     */
    public static VkPipelineRasterizationDepthClipStateCreateInfoEXT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPipelineRasterizationDepthClipStateCreateInfoEXT callocStack(MemoryStack stack) {
        return wrap(VkPipelineRasterizationDepthClipStateCreateInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkPipelineRasterizationDepthClipStateCreateInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkPipelineRasterizationDepthClipStateCreateInfoEXT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkPipelineRasterizationDepthClipStateCreateInfoEXT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkPipelineRasterizationDepthClipStateCreateInfoEXT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPipelineRasterizationDepthClipStateCreateInfoEXT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPipelineRasterizationDepthClipStateCreateInfoEXT.Buffer callocStack(int capacity, MemoryStack stack) {
