 ...
 * }</code></pre>
 */
public class VkOpaqueCaptureDescriptorDataCreateInfoEXT extends Struct implements NativeResource {
    ...
    public static VkOpaqueCaptureDescriptorDataCreateInfoEXT malloc() {
        return wrap(VkOpaqueCaptureDescriptorDataCreateInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkOpaqueCaptureDescriptorDataCreateInfoEXT calloc() {
        return wrap(VkOpaqueCaptureDescriptorDataCreateInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkOpaqueCaptureDescriptorDataCreateInfoEXT create() {
        ...
        return wrap(VkOpaqueCaptureDescriptorDataCreateInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkOpaqueCaptureDescriptorDataCreateInfoEXT create(long address) {
        return wrap(VkOpaqueCaptureDescriptorDataCreateInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkOpaqueCaptureDescriptorDataCreateInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkOpaqueCaptureDescriptorDataCreateInfoEXT.class, address);
    }
    ...
    public static VkOpaqueCaptureDescriptorDataCreateInfoEXT malloc(MemoryStack stack) {
        return wrap(VkOpaqueCaptureDescriptorDataCreateInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkOpaqueCaptureDescriptorDataCreateInfoEXT calloc(MemoryStack stack) {
        return wrap(VkOpaqueCaptureDescriptorDataCreateInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkOpaqueCaptureDescriptorDataCreateInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkOpaqueCaptureDescriptorDataCreateInfoEXT#SIZEOF}, and its mark will be undefined.
         *
