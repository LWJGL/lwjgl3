...
public class VkPhysicalDeviceExternalImageFormatInfoKHR extends VkPhysicalDeviceExternalImageFormatInfo {
    ...
    public static @Nullable VkPhysicalDeviceExternalImageFormatInfoKHR createSafe(long address) {
    ...
    public static VkPhysicalDeviceExternalImageFormatInfoKHR.@Nullable Buffer createSafe(long address, int capacity) {
