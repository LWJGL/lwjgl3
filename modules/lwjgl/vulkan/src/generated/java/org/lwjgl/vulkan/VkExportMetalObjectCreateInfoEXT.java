 ...
 * }</code></pre>
 */
public class VkExportMetalObjectCreateInfoEXT extends Struct implements NativeResource {
    ...
    public static VkExportMetalObjectCreateInfoEXT malloc() {
        return wrap(VkExportMetalObjectCreateInfoEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkExportMetalObjectCreateInfoEXT calloc() {
        return wrap(VkExportMetalObjectCreateInfoEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkExportMetalObjectCreateInfoEXT create() {
        ...
        return wrap(VkExportMetalObjectCreateInfoEXT.class, memAddress(container), container);
    }
    ...
    public static VkExportMetalObjectCreateInfoEXT create(long address) {
        return wrap(VkExportMetalObjectCreateInfoEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkExportMetalObjectCreateInfoEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkExportMetalObjectCreateInfoEXT.class, address);
    }
    ...
    public static VkExportMetalObjectCreateInfoEXT malloc(MemoryStack stack) {
        return wrap(VkExportMetalObjectCreateInfoEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkExportMetalObjectCreateInfoEXT calloc(MemoryStack stack) {
        return wrap(VkExportMetalObjectCreateInfoEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkExportMetalObjectCreateInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkExportMetalObjectCreateInfoEXT#SIZEOF}, and its mark will be undefined.
         *
