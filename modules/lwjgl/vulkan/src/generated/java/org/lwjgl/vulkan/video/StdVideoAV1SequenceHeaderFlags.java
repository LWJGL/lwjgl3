...
public class StdVideoAV1SequenceHeaderFlags extends Struct<StdVideoAV1SequenceHeaderFlags> implements NativeResource {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoAV1SequenceHeaderFlags.BITFIELD0); }
    ...
    static int nbitfield1(long struct) { return memGetInt(struct + StdVideoAV1SequenceHeaderFlags.BITFIELD1); }
    static int nreserved(long struct) { return nbitfield1(struct) & 0x00_00_1F_FF; }

    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoAV1SequenceHeaderFlags.BITFIELD0, value); }
    ...
    static void nbitfield1(long struct, int value) { memPutInt(struct + StdVideoAV1SequenceHeaderFlags.BITFIELD1, value); }
    static void nreserved(long struct, int value) { nbitfield1(struct, (nbitfield1(struct) & 0xFF_FF_E0_00) | (value & 0x00_00_1F_FF)); }
