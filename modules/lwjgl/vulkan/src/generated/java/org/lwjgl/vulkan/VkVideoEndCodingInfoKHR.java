...
public class VkVideoEndCodingInfoKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkVideoEndCodingInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkVideoEndCodingInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkVideoEndCodingInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkVideoEndCodingInfoKHR callocStack() {
     ...
     */
    public static VkVideoEndCodingInfoKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkVideoEndCodingInfoKHR callocStack(MemoryStack stack) {
        return wrap(VkVideoEndCodingInfoKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkVideoEndCodingInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoEndCodingInfoKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkVideoEndCodingInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkVideoEndCodingInfoKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoEndCodingInfoKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkVideoEndCodingInfoKHR.Buffer callocStack(int capacity, MemoryStack stack) {
