 ...
 * <li>{@code pNext} <b>must</b> be {@code NULL} or a pointer to a valid instance of {@link VkSemaphoreTypeCreateInfoKHR}</li>
...
public class VkPhysicalDeviceExternalSemaphoreInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkPhysicalDeviceExternalSemaphoreInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkPhysicalDeviceExternalSemaphoreInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkPhysicalDeviceExternalSemaphoreInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
