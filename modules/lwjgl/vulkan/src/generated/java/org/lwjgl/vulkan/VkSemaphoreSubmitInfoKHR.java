...
public class VkSemaphoreSubmitInfoKHR extends VkSemaphoreSubmitInfo {
    ...
    public static @Nullable VkSemaphoreSubmitInfoKHR createSafe(long address) {
    ...
    public static VkSemaphoreSubmitInfoKHR.@Nullable Buffer createSafe(long address, int capacity) {
