 ...
 * <h5>Description</h5>
 * 
 * <p>The C language spec does not define the ordering of bit-fields, but in practice, this struct produces the correct layout with existing compilers. The intended bit pattern is for the following:</p>
 * 
 * <ul>
 * <li>{@code instanceCustomIndex} and {@code mask} occupy the same memory as if a single {@code int32_t} was specified in their place
 * 
 * <ul>
 ...
 * </ul>
 * </li>
 * <li>{@code instanceShaderBindingTableRecordOffset} and {@code flags} occupy the same memory as if a single {@code int32_t} was specified in their place
 * 
 * <ul>
 ...
 * <h5>See Also</h5>
 * 
 * <p>{@link VkTransformMatrixKHR}</p>
 * 
 * <h3>Member documentation</h3>
 * 
 * <ul>
 * <li>{@code transform} &ndash; a {@link VkTransformMatrixKHR} structure describing a transformation to be applied to the acceleration structure.</li>
 * <li>{@code instanceCustomIndex} &ndash; a 24-bit user-specified index value accessible to ray shaders in the {@code InstanceCustomIndexKHR} built-in.</li>
 * <li>{@code mask} &ndash; an 8-bit visibility mask for the geometry. The instance <b>may</b> only be hit if {@code rayMask &amp; instance.mask != 0}</li>
 * <li>{@code instanceShaderBindingTableRecordOffset} &ndash; a 24-bit offset used in calculating the hit shader binding table index.</li>
 * <li>{@code flags} &ndash; an 8-bit mask of {@code VkGeometryInstanceFlagBitsKHR} values to apply to this instance.</li>
 * <li>{@code accelerationStructureReference} &ndash; either:
 * 
 * <ul>
...
public class VkAccelerationStructureInstanceKHR extends Struct implements NativeResource {
    ...
    /** Returns a {@link VkTransformMatrixKHR} view of the {@code transform} field. */
    public VkTransformMatrixKHR transform() { return ntransform(address()); }
    /** Returns the value of the {@code instanceCustomIndex} field. */
    @NativeType("uint32_t")
    public int instanceCustomIndex() { return ninstanceCustomIndex(address()); }
    /** Returns the value of the {@code mask} field. */
    @NativeType("uint32_t")
    public int mask() { return nmask(address()); }
    /** Returns the value of the {@code instanceShaderBindingTableRecordOffset} field. */
    @NativeType("uint32_t")
    ...
    /** Returns the value of the {@code accelerationStructureReference} field. */
    @NativeType("uint64_t")
    ...
    /** Returns a new {@code VkAccelerationStructureInstanceKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkAccelerationStructureInstanceKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkAccelerationStructureInstanceKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkAccelerationStructureInstanceKHR callocStack() {
     ...
     */
    public static VkAccelerationStructureInstanceKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkAccelerationStructureInstanceKHR callocStack(MemoryStack stack) {
        return wrap(VkAccelerationStructureInstanceKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkAccelerationStructureInstanceKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureInstanceKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkAccelerationStructureInstanceKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureInstanceKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureInstanceKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureInstanceKHR.Buffer callocStack(int capacity, MemoryStack stack) {
