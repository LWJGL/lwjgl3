...
public class VkAccelerationStructureMatrixMotionInstanceNV extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VkAccelerationStructureMatrixMotionInstanceNV} instance allocated on the thread-local {@link MemoryStack}. */
    public static VkAccelerationStructureMatrixMotionInstanceNV mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VkAccelerationStructureMatrixMotionInstanceNV} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VkAccelerationStructureMatrixMotionInstanceNV callocStack() {
     ...
     */
    public static VkAccelerationStructureMatrixMotionInstanceNV mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VkAccelerationStructureMatrixMotionInstanceNV callocStack(MemoryStack stack) {
        return wrap(VkAccelerationStructureMatrixMotionInstanceNV.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VkAccelerationStructureMatrixMotionInstanceNV.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureMatrixMotionInstanceNV.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VkAccelerationStructureMatrixMotionInstanceNV.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureMatrixMotionInstanceNV.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureMatrixMotionInstanceNV.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureMatrixMotionInstanceNV.Buffer callocStack(int capacity, MemoryStack stack) {
