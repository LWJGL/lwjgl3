 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT extends Struct implements NativeResource {
    ...
    public static VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT malloc() {
        return wrap(VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT calloc() {
        return wrap(VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT create() {
        ...
        return wrap(VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT.class, memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT create(long address) {
        return wrap(VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT createSafe(long address) {
        return address == NULL ? null : wrap(VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT.class, address);
    }
    ...
    public static VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT malloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT calloc(MemoryStack stack) {
        return wrap(VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT#SIZEOF}, and its mark will be undefined.
         *
