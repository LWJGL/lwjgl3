...
public class StdVideoEncodeH264SliceHeaderFlags extends Struct implements NativeResource {
    ...
    /** Returns a new {@code StdVideoEncodeH264SliceHeaderFlags} instance allocated on the thread-local {@link MemoryStack}. */
    public static StdVideoEncodeH264SliceHeaderFlags mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code StdVideoEncodeH264SliceHeaderFlags} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static StdVideoEncodeH264SliceHeaderFlags callocStack() {
     ...
     */
    public static StdVideoEncodeH264SliceHeaderFlags mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static StdVideoEncodeH264SliceHeaderFlags callocStack(MemoryStack stack) {
        return wrap(StdVideoEncodeH264SliceHeaderFlags.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link StdVideoEncodeH264SliceHeaderFlags.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoEncodeH264SliceHeaderFlags.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link StdVideoEncodeH264SliceHeaderFlags.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static StdVideoEncodeH264SliceHeaderFlags.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoEncodeH264SliceHeaderFlags.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static StdVideoEncodeH264SliceHeaderFlags.Buffer callocStack(int capacity, MemoryStack stack) {
