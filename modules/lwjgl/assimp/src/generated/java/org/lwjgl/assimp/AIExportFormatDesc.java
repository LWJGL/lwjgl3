...
public class AIExportFormatDesc extends Struct<AIExportFormatDesc> implements NativeResource {
    ...
    /** @return a {@link ByteBuffer} view of the null-terminated string pointed to by the {@code id} field. */
    @NativeType("char const *")
    public ByteBuffer id() { return nid(address()); }
    /** @return the null-terminated string pointed to by the {@code id} field. */
    @NativeType("char const *")
    ...
    /** @return a {@link ByteBuffer} view of the null-terminated string pointed to by the {@code fileExtension} field. */
    @NativeType("char const *")
    public ByteBuffer fileExtension() { return nfileExtension(address()); }
    /** @return the null-terminated string pointed to by the {@code fileExtension} field. */
    @NativeType("char const *")
    ...
    public static AIExportFormatDesc malloc() {
        return new AIExportFormatDesc(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static AIExportFormatDesc calloc() {
        return new AIExportFormatDesc(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static AIExportFormatDesc create() {
        ...
        return new AIExportFormatDesc(memAddress(container), container);
    }
    ...
    public static AIExportFormatDesc malloc(MemoryStack stack) {
        return new AIExportFormatDesc(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static AIExportFormatDesc calloc(MemoryStack stack) {
        return new AIExportFormatDesc(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<AIExportFormatDesc, Buffer> implements NativeResource {
         ...
         * by {@link AIExportFormatDesc#SIZEOF}, and its mark will be undefined.</p>
         *
