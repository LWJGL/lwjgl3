...
public class AIVector3D extends Struct<AIVector3D> implements NativeResource {
    ...
    public static AIVector3D malloc() {
        return new AIVector3D(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static AIVector3D malloc(MemoryStack stack) {
        return new AIVector3D(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static AIVector3D calloc(MemoryStack stack) {
        return new AIVector3D(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<AIVector3D, Buffer> implements NativeResource {
         ...
         * by {@link AIVector3D#SIZEOF}, and its mark will be undefined.</p>
         *
