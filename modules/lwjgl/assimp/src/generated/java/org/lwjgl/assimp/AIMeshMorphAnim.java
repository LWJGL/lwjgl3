...
public class AIMeshMorphAnim extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link AIMeshMorphAnim} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link AIMeshMorphAnim} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static AIMeshMorphAnim malloc() {
        return wrap(AIMeshMorphAnim.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link AIMeshMorphAnim} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static AIMeshMorphAnim calloc() {
        return wrap(AIMeshMorphAnim.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link AIMeshMorphAnim} instance allocated with {@link BufferUtils}. */
    public static AIMeshMorphAnim create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(AIMeshMorphAnim.class, memAddress(container), container);
    }

    /** Returns a new {@link AIMeshMorphAnim} instance for the specified memory address. */
    ...
    /** Returns a new {@link AIMeshMorphAnim} instance allocated on the thread-local {@link MemoryStack}. */
    public static AIMeshMorphAnim mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link AIMeshMorphAnim} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static AIMeshMorphAnim callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link AIMeshMorphAnim} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link AIMeshMorphAnim} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<AIMeshMorphAnim, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link AIMeshMorphAnim.Buffer} instance backed by the specified container.
         *
