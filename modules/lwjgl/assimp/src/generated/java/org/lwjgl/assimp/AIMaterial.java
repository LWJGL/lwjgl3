 ...
 * <li>{@code mNumAllocated} &ndash; Storage allocated</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class AIMaterial extends Struct implements NativeResource {
    ...
    /** Returns a new {@code AIMaterial} instance allocated on the thread-local {@link MemoryStack}. */
    public static AIMaterial mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code AIMaterial} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
