...
public class Assimp {
     ...
     * 
     * <p>This is used by {@code aiMatrix4x4t<TReal>::IsIdentity(const TReal epsilon)}. The default value is 10e-3f for backward compatibility of legacy code.</p>
     * 
     * <p>Property type: Float.</p>
     */
    public static final String AI_CONFIG_CHECK_IDENTITY_MATRIX_EPSILON = "CHECK_IDENTITY_MATRIX_EPSILON";
     ...
     * 
     * <p>If this property is set to true, the axis directions provided in the FBX file will be ignored and the file will be loaded as is.</p>
     * 
     * <p>Set to true for Assimp 5.3.x and earlier behavior. Equivalent to {@link #AI_CONFIG_IMPORT_COLLADA_IGNORE_UP_DIRECTION}</p>
     * 
     * <p>Property type: {@code Bool}. Default value: {@code false}.</p>
     */
    public static final String AI_CONFIG_IMPORT_FBX_IGNORE_UP_DIRECTION = "AI_CONFIG_IMPORT_FBX_IGNORE_UP_DIRECTION";
     ...
     * 
     * <p>Property type: bool. The default value is {@code true} (S1).</p>
     */
    public static final String AI_CONFIG_IMPORT_MDL_HL1_TRANSFORM_COORD_SYSTEM = "TRANSFORM COORDSYSTEM FOR HS! MODELS";
     ...
     * 
     * <p>When this flag is not defined, the {@code TransparencyFactor} value of each meterial is 1.0. By enabling this flag, the value is {@code 1.0 - opacity}.</p>
     * 
     * <p>Property type: Bool. Default value: false.</p>
     */
    public static final String AI_CONFIG_EXPORT_FBX_TRANSPARENCY_FACTOR_REFER_TO_OPACITY = "EXPORT_FBX_TRANSPARENCY_FACTOR_REFER_TO_OPACITY VERTEX";
     ...
     * 
     * <ul>
     * <li>{@link #aiAnimInterpolation_Step AnimInterpolation_Step}</li>
     * <li>{@link #aiAnimInterpolation_Linear AnimInterpolation_Linear}</li>
     * <li>{@link #aiAnimInterpolation_Spherical_Linear AnimInterpolation_Spherical_Linear}</li>
     * <li>{@link #aiAnimInterpolation_Cubic_Spline AnimInterpolation_Cubic_Spline}</li>
     * </ul>
     */
    public static final int
     ...
     * Unknown texture.
     * 
     * <p>A texture reference that does not match any of the definitions above is considered to be 'unknown'. It is still imported, but is excluded from any
     * further post-processing.</p>
     * </li>
     ...
     * </li>
     * <li>{@link #aiTextureType_MAYA_BASE TextureType_MAYA_BASE}</li>
     * <li>{@link #aiTextureType_MAYA_SPECULAR TextureType_MAYA_SPECULAR}</li>
     * <li>{@link #aiTextureType_MAYA_SPECULAR_COLOR TextureType_MAYA_SPECULAR_COLOR}</li>
     * <li>{@link #aiTextureType_MAYA_SPECULAR_ROUGHNESS TextureType_MAYA_SPECULAR_ROUGHNESS}</li>
     * </ul>
     */
    public static final int
    ...
    /** Unsafe version of: {@link #aiGetEmbeddedTexture GetEmbeddedTexture} */
     ...
     *
     * @param pIn      Input asset.
     * @param filename Texture path extracted from {@link #aiGetMaterialString GetMaterialString}.
     */
     ...
     */
    @NativeType("aiReturn")
    public static int aiGetMaterialFloatArray(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("char const *") ByteBuffer pKey, @NativeType("unsigned int") int type, @NativeType("unsigned int") int index, @NativeType("float *") FloatBuffer pOut, @NativeType("unsigned int *") @Nullable IntBuffer pMax) {
        if (CHECKS) {
            checkNT1(pKey);
            checkSafe(pMax, 1);
     ...
     */
    @NativeType("aiReturn")
    public static int aiGetMaterialFloatArray(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("char const *") CharSequence pKey, @NativeType("unsigned int") int type, @NativeType("unsigned int") int index, @NativeType("float *") FloatBuffer pOut, @NativeType("unsigned int *") @Nullable IntBuffer pMax) {
        if (CHECKS) {
            checkSafe(pMax, 1);
            if (pMax != null) { check(pOut, pMax.get(pMax.position())); }
        }
    ...
    @NativeType("aiReturn")
    public static int aiGetMaterialFloatArray(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("char const *") ByteBuffer pKey, @NativeType("unsigned int") int type, @NativeType("unsigned int") int index, @NativeType("float *") float[] pOut, @NativeType("unsigned int *") int @Nullable [] pMax) {
        long __functionAddress = Functions.GetMaterialFloatArray;
        if (CHECKS) {
            checkNT1(pKey);
            checkSafe(pMax, 1);
    ...
    /** Array version of: {@link #aiGetMaterialFloatArray GetMaterialFloatArray} */
    @NativeType("aiReturn")
    public static int aiGetMaterialFloatArray(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("char const *") CharSequence pKey, @NativeType("unsigned int") int type, @NativeType("unsigned int") int index, @NativeType("float *") float[] pOut, @NativeType("unsigned int *") int @Nullable [] pMax) {
        long __functionAddress = Functions.GetMaterialFloatArray;
        if (CHECKS) {
            checkSafe(pMax, 1);
            if (pMax != null) { check(pOut, pMax[0]); }
