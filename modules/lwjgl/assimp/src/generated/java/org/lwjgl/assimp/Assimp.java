...
public class Assimp {
    ...
    public static final String
        ...
        aiAI_MATKEY_GLTF_MATERIAL_SHEEN                          = "$mat.gltf.materialSheen",
        aiAI_MATKEY_GLTF_MATERIAL_SHEEN_COLOR_FACTOR             = "$mat.gltf.materialSheen.sheenColorFactor",
        aiAI_MATKEY_GLTF_MATERIAL_SHEEN_ROUGHNESS_FACTOR         = "$mat.gltf.materialSheen.sheenRoughnessFactor",
        aiAI_MATKEY_GLTF_MATERIAL_CLEARCOAT                      = "$mat.gltf.materialClearcoat",
        aiAI_MATKEY_GLTF_MATERIAL_CLEARCOAT_FACTOR               = "$mat.gltf.materialClearcoat.clearcoatFactor",
        aiAI_MATKEY_GLTF_MATERIAL_CLEARCOAT_ROUGHNESS_FACTOR     = "$mat.gltf.materialClearcoat.clearcoatRoughnessFactor",
        aiAI_MATKEY_GLTF_MATERIAL_TRANSMISSION                   = "$mat.gltf.materialTransmission",
        aiAI_MATKEY_GLTF_MATERIAL_TRANSMISSION_FACTOR            = "$mat.gltf.materialTransmission.transmissionFactor",
