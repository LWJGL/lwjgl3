 ...
 * <li>{@code mValues} &ndash; the values at the time of this key</li>
 * <li>{@code mWeights} &ndash; the weights at the time of this key</li>
 * <li>{@code mNumValuesAndWeights} &ndash; the number of values and weights</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class AIMeshMorphKey extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link AIMeshMorphKey} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a {@link IntBuffer} view of the data pointed to by the {@code mValues} field. */
    ...
    /** Returns the value of the {@code mNumValuesAndWeights} field. */
    @NativeType("unsigned int")
    ...
    /** Returns a new {@link AIMeshMorphKey} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static AIMeshMorphKey malloc() {
        return wrap(AIMeshMorphKey.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link AIMeshMorphKey} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static AIMeshMorphKey calloc() {
        return wrap(AIMeshMorphKey.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link AIMeshMorphKey} instance allocated with {@link BufferUtils}. */
    public static AIMeshMorphKey create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(AIMeshMorphKey.class, memAddress(container), container);
    }

    /** Returns a new {@link AIMeshMorphKey} instance for the specified memory address. */
    ...
    /** Returns a new {@link AIMeshMorphKey} instance allocated on the thread-local {@link MemoryStack}. */
    public static AIMeshMorphKey mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link AIMeshMorphKey} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static AIMeshMorphKey callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link AIMeshMorphKey} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link AIMeshMorphKey} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link AIMeshMorphKey.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link AIMeshMorphKey.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static AIMeshMorphKey.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static AIMeshMorphKey.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<AIMeshMorphKey, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link AIMeshMorphKey.Buffer} instance backed by the specified container.
         *
