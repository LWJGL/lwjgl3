...
val EXT_texture_swizzle = "EXTTextureSwizzle".nativeClassGL("EXT_texture_swizzle", postfix = EXT) {
    documentation =
        ...
        The existing texture formats provide an almost orthogonal set of data types, sizes, and number of components, but the mappings of this storage into
        ...
        formats, but the problem has not been solved once and for all.
