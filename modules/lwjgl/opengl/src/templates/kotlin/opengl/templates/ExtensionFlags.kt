...
val EXT_fragment_shading_rate_attachment = EXT_FLAG.nativeClassGL("EXT_fragment_shading_rate_attachment", postfix = EXT)
val EXT_fragment_shading_rate_primitive = EXT_FLAG.nativeClassGL("EXT_fragment_shading_rate_primitive", postfix = EXT)
...
val EXT_shader_realtime_clock = EXT_FLAG.nativeClassGL("EXT_shader_realtime_clock", postfix = EXT)
val EXT_shader_samples_identical = EXT_FLAG.nativeClassGL("EXT_shader_samples_identical", postfix = EXT)
val EXT_shader_texture_samples = EXT_FLAG.nativeClassGL("EXT_shader_texture_samples", postfix = EXT)
