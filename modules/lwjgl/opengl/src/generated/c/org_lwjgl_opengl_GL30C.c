...
typedef void (APIENTRY *glVertexAttribI1ivPROC) (jint, uintptr_t);
typedef void (APIENTRY *glVertexAttribI2ivPROC) (jint, uintptr_t);
typedef void (APIENTRY *glVertexAttribI3ivPROC) (jint, uintptr_t);
typedef void (APIENTRY *glVertexAttribI4ivPROC) (jint, uintptr_t);
typedef void (APIENTRY *glVertexAttribI1uivPROC) (jint, uintptr_t);
typedef void (APIENTRY *glVertexAttribI2uivPROC) (jint, uintptr_t);
typedef void (APIENTRY *glVertexAttribI3uivPROC) (jint, uintptr_t);
typedef void (APIENTRY *glVertexAttribI4uivPROC) (jint, uintptr_t);
typedef void (APIENTRY *glVertexAttribI4bvPROC) (jint, uintptr_t);
typedef void (APIENTRY *glVertexAttribI4svPROC) (jint, uintptr_t);
typedef void (APIENTRY *glVertexAttribI4ubvPROC) (jint, uintptr_t);
typedef void (APIENTRY *glVertexAttribI4usvPROC) (jint, uintptr_t);
...
typedef void (APIENTRY *glBindFragDataLocationPROC) (jint, jint, uintptr_t);
