...
typedef void (APIENTRY *glUniform1dvPROC) (jint, jint, uintptr_t);
typedef void (APIENTRY *glUniform2dvPROC) (jint, jint, uintptr_t);
typedef void (APIENTRY *glUniform3dvPROC) (jint, jint, uintptr_t);
typedef void (APIENTRY *glUniform4dvPROC) (jint, jint, uintptr_t);
typedef void (APIENTRY *glUniformMatrix2dvPROC) (jint, jint, jboolean, uintptr_t);
typedef void (APIENTRY *glUniformMatrix3dvPROC) (jint, jint, jboolean, uintptr_t);
typedef void (APIENTRY *glUniformMatrix4dvPROC) (jint, jint, jboolean, uintptr_t);
typedef void (APIENTRY *glUniformMatrix2x3dvPROC) (jint, jint, jboolean, uintptr_t);
typedef void (APIENTRY *glUniformMatrix2x4dvPROC) (jint, jint, jboolean, uintptr_t);
typedef void (APIENTRY *glUniformMatrix3x2dvPROC) (jint, jint, jboolean, uintptr_t);
typedef void (APIENTRY *glUniformMatrix3x4dvPROC) (jint, jint, jboolean, uintptr_t);
typedef void (APIENTRY *glUniformMatrix4x2dvPROC) (jint, jint, jboolean, uintptr_t);
typedef void (APIENTRY *glUniformMatrix4x3dvPROC) (jint, jint, jboolean, uintptr_t);
typedef void (APIENTRY *glGetUniformdvPROC) (jint, jint, uintptr_t);
typedef void (APIENTRY *glMinSampleShadingPROC) (jfloat);
typedef jint (APIENTRY *glGetSubroutineUniformLocationPROC) (jint, jint, uintptr_t);
typedef jint (APIENTRY *glGetSubroutineIndexPROC) (jint, jint, uintptr_t);
typedef void (APIENTRY *glGetActiveSubroutineUniformivPROC) (jint, jint, jint, jint, uintptr_t);
typedef void (APIENTRY *glGetActiveSubroutineUniformNamePROC) (jint, jint, jint, jint, uintptr_t, uintptr_t);
typedef void (APIENTRY *glGetActiveSubroutineNamePROC) (jint, jint, jint, jint, uintptr_t, uintptr_t);
typedef void (APIENTRY *glUniformSubroutinesuivPROC) (jint, jint, uintptr_t);
typedef void (APIENTRY *glGetUniformSubroutineuivPROC) (jint, jint, uintptr_t);
typedef void (APIENTRY *glGetProgramStageivPROC) (jint, jint, jint, uintptr_t);
typedef void (APIENTRY *glPatchParameteriPROC) (jint, jint);
typedef void (APIENTRY *glPatchParameterfvPROC) (jint, uintptr_t);
...
typedef void (APIENTRY *glGetQueryIndexedivPROC) (jint, jint, jint, uintptr_t);
