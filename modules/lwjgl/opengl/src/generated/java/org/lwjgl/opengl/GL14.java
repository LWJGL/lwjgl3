...
public class GL14 extends GL13 {
    ...
    /** Accepted by {@link GL11#glGetFloat*} to get the constant color used in blending, which can be set using {@link GL14#glBlendColor}. */
    ...
    /** Accepted by {@link GL11#glGetInteger*} to get the current blend equation, which can be set using {@link GL14#glBlendEquation}. */
