...
public class BNDnodeTheme extends Struct<BNDnodeTheme> implements NativeResource {
    ...
    /** @return a {@link NVGColor} view of the {@code nodeSelectedColor} field. */
    @NativeType("NVGcolor")
    public NVGColor nodeSelectedColor() { return nnodeSelectedColor(address()); }
    /** @return a {@link NVGColor} view of the {@code wiresColor} field. */
    @NativeType("NVGcolor")
    ...
    /** @return a {@link NVGColor} view of the {@code activeNodeColor} field. */
    @NativeType("NVGcolor")
    public NVGColor activeNodeColor() { return nactiveNodeColor(address()); }
    /** @return a {@link NVGColor} view of the {@code wireSelectColor} field. */
    @NativeType("NVGcolor")
    public NVGColor wireSelectColor() { return nwireSelectColor(address()); }
    /** @return a {@link NVGColor} view of the {@code nodeBackdropColor} field. */
    @NativeType("NVGcolor")
    public NVGColor nodeBackdropColor() { return nnodeBackdropColor(address()); }
    /** @return the value of the {@code noodleCurving} field. */
