...
JNIEXPORT jint JNICALL JavaCritical_org_lwjgl_nanovg_NanoVGGLES3_nnvglCreateImageFromHandle(jlong ctxAddress, jint textureId, jint w, jint h, jint flags) {
...
JNIEXPORT jint JNICALL Java_org_lwjgl_nanovg_NanoVGGLES3_nnvglCreateImageFromHandle(JNIEnv *__env, jclass clazz, jlong ctxAddress, jint textureId, jint w, jint h, jint flags) {
    ...
    return JavaCritical_org_lwjgl_nanovg_NanoVGGLES3_nnvglCreateImageFromHandle(ctxAddress, textureId, w, h, flags);
}

JNIEXPORT jint JNICALL JavaCritical_org_lwjgl_nanovg_NanoVGGLES3_nnvglImageHandle(jlong ctxAddress, jint image) {
    NVGcontext *ctx = (NVGcontext *)(intptr_t)ctxAddress;
...
JNIEXPORT jint JNICALL Java_org_lwjgl_nanovg_NanoVGGLES3_nnvglImageHandle(JNIEnv *__env, jclass clazz, jlong ctxAddress, jint image) {
    UNUSED_PARAMS(__env, clazz)
    return JavaCritical_org_lwjgl_nanovg_NanoVGGLES3_nnvglImageHandle(ctxAddress, image);
}
...
JNIEXPORT void JNICALL JavaCritical_org_lwjgl_nanovg_NanoVGGLES3_nnvgDelete(jlong ctxAddress) {
    NVGcontext *ctx = (NVGcontext *)(intptr_t)ctxAddress;
    nvgDeleteGLES3(ctx);
}
JNIEXPORT void JNICALL Java_org_lwjgl_nanovg_NanoVGGLES3_nnvgDelete(JNIEnv *__env, jclass clazz, jlong ctxAddress) {
    UNUSED_PARAMS(__env, clazz)
    JavaCritical_org_lwjgl_nanovg_NanoVGGLES3_nnvgDelete(ctxAddress);
}

JNIEXPORT jlong JNICALL JavaCritical_org_lwjgl_nanovg_NanoVGGLES3_nnvgluCreateFramebuffer(jlong ctxAddress, jint w, jint h, jint imageFlags) {
    NVGcontext *ctx = (NVGcontext *)(intptr_t)ctxAddress;
...
JNIEXPORT jlong JNICALL Java_org_lwjgl_nanovg_NanoVGGLES3_nnvgluCreateFramebuffer(JNIEnv *__env, jclass clazz, jlong ctxAddress, jint w, jint h, jint imageFlags) {
    UNUSED_PARAMS(__env, clazz)
    return JavaCritical_org_lwjgl_nanovg_NanoVGGLES3_nnvgluCreateFramebuffer(ctxAddress, w, h, imageFlags);
}

JNIEXPORT void JNICALL JavaCritical_org_lwjgl_nanovg_NanoVGGLES3_nnvgluBindFramebuffer(jlong ctxAddress, jlong fbAddress) {
    NVGcontext *ctx = (NVGcontext *)(intptr_t)ctxAddress;
...
JNIEXPORT void JNICALL Java_org_lwjgl_nanovg_NanoVGGLES3_nnvgluBindFramebuffer(JNIEnv *__env, jclass clazz, jlong ctxAddress, jlong fbAddress) {
    UNUSED_PARAMS(__env, clazz)
    JavaCritical_org_lwjgl_nanovg_NanoVGGLES3_nnvgluBindFramebuffer(ctxAddress, fbAddress);
}

JNIEXPORT void JNICALL JavaCritical_org_lwjgl_nanovg_NanoVGGLES3_nnvgluDeleteFramebuffer(jlong ctxAddress, jlong fbAddress) {
    NVGcontext *ctx = (NVGcontext *)(intptr_t)ctxAddress;
    NVGLUframebuffer *fb = (NVGLUframebuffer *)(intptr_t)fbAddress;
...
JNIEXPORT void JNICALL Java_org_lwjgl_nanovg_NanoVGGLES3_nnvgluDeleteFramebuffer(JNIEnv *__env, jclass clazz, jlong ctxAddress, jlong fbAddress) {
    UNUSED_PARAMS(__env, clazz)
    JavaCritical_org_lwjgl_nanovg_NanoVGGLES3_nnvgluDeleteFramebuffer(ctxAddress, fbAddress);
}
