...
/** Callback function: {@link #invoke hb_unicode_general_category_func_t} */
public abstract class hb_unicode_general_category_func_t extends Callback implements hb_unicode_general_category_func_tI {
     ...
     */
    public static hb_unicode_general_category_func_t create(long functionPointer) { return create(Callback.get(functionPointer), functionPointer); }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code functionPointer} is {@code NULL}. */
    public static @Nullable hb_unicode_general_category_func_t createSafe(long functionPointer) { return functionPointer == NULL ? null : create(functionPointer); }
    ...
    public static hb_unicode_general_category_func_t create(hb_unicode_general_category_func_tI instance) { return create(instance, instance.address()); }

    private static hb_unicode_general_category_func_t create(hb_unicode_general_category_func_tI instance, long functionPointer) {
        return instance instanceof hb_unicode_general_category_func_t
            ? (hb_unicode_general_category_func_t)instance
            : new hb_unicode_general_category_func_t(functionPointer) {
