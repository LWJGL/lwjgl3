...
public abstract class hb_unicode_combining_class_func_t extends Callback implements hb_unicode_combining_class_func_tI {
    ...
    /**
     * Creates a {@code hb_unicode_combining_class_func_t} instance from the specified function pointer.
     *
    ...
    @Nullable
    public static hb_unicode_combining_class_func_t createSafe(long functionPointer) {
