...
public abstract class hb_paint_push_clip_path_end_func_t extends Callback implements hb_paint_push_clip_path_end_func_tI {
     ...
     */
    public static hb_paint_push_clip_path_end_func_t create(long functionPointer) {
        hb_paint_push_clip_path_end_func_tI instance = Callback.get(functionPointer);
    ...
    public static @Nullable hb_paint_push_clip_path_end_func_t createSafe(long functionPointer) {
    ...
    public static hb_paint_push_clip_path_end_func_t create(hb_paint_push_clip_path_end_func_tI instance) {
        return instance instanceof hb_paint_push_clip_path_end_func_t
            ? (hb_paint_push_clip_path_end_func_t)instance
    ...
    private static final class Container extends hb_paint_push_clip_path_end_func_t {

        private final hb_paint_push_clip_path_end_func_tI delegate;

        Container(long functionPointer, hb_paint_push_clip_path_end_func_tI delegate) {
            super(functionPointer);
