 ...
 * }</code></pre>
 */
public class hb_font_extents_t extends Struct implements NativeResource {
    ...
    public static hb_font_extents_t malloc() {
        return wrap(hb_font_extents_t.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static hb_font_extents_t calloc() {
        return wrap(hb_font_extents_t.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static hb_font_extents_t create() {
        ...
        return wrap(hb_font_extents_t.class, memAddress(container), container);
    }
    ...
    public static hb_font_extents_t create(long address) {
        return wrap(hb_font_extents_t.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static hb_font_extents_t createSafe(long address) {
        return address == NULL ? null : wrap(hb_font_extents_t.class, address);
    }
    ...
    public static hb_font_extents_t malloc(MemoryStack stack) {
        return wrap(hb_font_extents_t.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static hb_font_extents_t calloc(MemoryStack stack) {
        return wrap(hb_font_extents_t.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<hb_font_extents_t, Buffer> implements NativeResource {
         ...
         * by {@link hb_font_extents_t#SIZEOF}, and its mark will be undefined.
         *
