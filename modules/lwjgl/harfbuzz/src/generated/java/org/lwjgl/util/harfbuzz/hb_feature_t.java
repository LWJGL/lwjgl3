...
public class hb_feature_t extends Struct implements NativeResource {
    ...
    public static hb_feature_t malloc() {
        return wrap(hb_feature_t.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static hb_feature_t malloc(MemoryStack stack) {
        return wrap(hb_feature_t.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static hb_feature_t calloc(MemoryStack stack) {
        return wrap(hb_feature_t.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<hb_feature_t, Buffer> implements NativeResource {
         ...
         * by {@link hb_feature_t#SIZEOF}, and its mark will be undefined.
         *
