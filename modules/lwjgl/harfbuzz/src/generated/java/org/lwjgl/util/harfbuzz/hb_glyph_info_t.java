...
public class hb_glyph_info_t extends Struct<hb_glyph_info_t> implements NativeResource {
    ...
    static hb_var_int_t nvar1(long struct) { return hb_var_int_t.create(struct + hb_glyph_info_t.VAR1); }
    static hb_var_int_t nvar2(long struct) { return hb_var_int_t.create(struct + hb_glyph_info_t.VAR2); }
    ...
    static void nvar1(long struct, hb_var_int_t value) { memCopy(value.address(), struct + hb_glyph_info_t.VAR1, hb_var_int_t.SIZEOF); }
    static void nvar2(long struct, hb_var_int_t value) { memCopy(value.address(), struct + hb_glyph_info_t.VAR2, hb_var_int_t.SIZEOF); }
