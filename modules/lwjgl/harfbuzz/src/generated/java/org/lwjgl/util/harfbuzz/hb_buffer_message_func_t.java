...
public abstract class hb_buffer_message_func_t extends Callback implements hb_buffer_message_func_tI {
    ...
    public static hb_buffer_message_func_t create(long functionPointer) {
        hb_buffer_message_func_tI instance = Callback.get(functionPointer);
    ...
    @Nullable
    public static hb_buffer_message_func_t createSafe(long functionPointer) {
    ...
    private static final class Container extends hb_buffer_message_func_t {

        private final hb_buffer_message_func_tI delegate;

        Container(long functionPointer, hb_buffer_message_func_tI delegate) {
            super(functionPointer);
            this.delegate = delegate;
        }

        @Override
        public int invoke(long buffer, long font, long message, long user_data) {
            return delegate.invoke(buffer, font, message, user_data);
        }
