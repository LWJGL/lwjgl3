 ...
 * }</code></pre>
 */
public class hb_var_num_t extends Struct implements NativeResource {
    ...
    public static hb_var_num_t malloc() {
        return wrap(hb_var_num_t.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static hb_var_num_t malloc(MemoryStack stack) {
        return wrap(hb_var_num_t.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static hb_var_num_t calloc(MemoryStack stack) {
        return wrap(hb_var_num_t.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<hb_var_num_t, Buffer> implements NativeResource {
         ...
         * by {@link hb_var_num_t#SIZEOF}, and its mark will be undefined.
         *
