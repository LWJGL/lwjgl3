 ...
 * }</code></pre>
 */
public class hb_ot_color_layer_t extends Struct implements NativeResource {
    ...
    public static hb_ot_color_layer_t malloc() {
        return wrap(hb_ot_color_layer_t.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static hb_ot_color_layer_t calloc() {
        return wrap(hb_ot_color_layer_t.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static hb_ot_color_layer_t create() {
        ...
        return wrap(hb_ot_color_layer_t.class, memAddress(container), container);
    }
    ...
    public static hb_ot_color_layer_t create(long address) {
        return wrap(hb_ot_color_layer_t.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static hb_ot_color_layer_t createSafe(long address) {
        return address == NULL ? null : wrap(hb_ot_color_layer_t.class, address);
    }
    ...
    public static hb_ot_color_layer_t malloc(MemoryStack stack) {
        return wrap(hb_ot_color_layer_t.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static hb_ot_color_layer_t calloc(MemoryStack stack) {
        return wrap(hb_ot_color_layer_t.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<hb_ot_color_layer_t, Buffer> implements NativeResource {
         ...
         * by {@link hb_ot_color_layer_t#SIZEOF}, and its mark will be undefined.
         *
