...
public class AAT {
    ...
    public static final class Functions {
        ...
        public static final long
            layout_get_feature_types               = apiGetFunctionAddress(HarfBuzz.getLibrary(), "hb_aat_layout_get_feature_types"),
            layout_feature_type_get_name_id        = apiGetFunctionAddress(HarfBuzz.getLibrary(), "hb_aat_layout_feature_type_get_name_id"),
            layout_feature_type_get_selector_infos = apiGetFunctionAddress(HarfBuzz.getLibrary(), "hb_aat_layout_feature_type_get_selector_infos"),
            layout_has_substitution                = apiGetFunctionAddress(HarfBuzz.getLibrary(), "hb_aat_layout_has_substitution"),
            layout_has_positioning                 = apiGetFunctionAddress(HarfBuzz.getLibrary(), "hb_aat_layout_has_positioning"),
            layout_has_tracking                    = apiGetFunctionAddress(HarfBuzz.getLibrary(), "hb_aat_layout_has_tracking");
    ...
    public static final int HB_AAT_LAYOUT_NO_SELECTOR_INDEX = 0xFFFF;
    ...
    /** {@code unsigned int hb_aat_layout_get_feature_types(hb_face_t * face, unsigned int start_offset, unsigned int * feature_count, hb_aat_layout_feature_type_t * features)} */
    public static int nhb_aat_layout_get_feature_types(long face, int start_offset, long feature_count, long features) {
    ...
    public static int hb_aat_layout_get_feature_types(@NativeType("hb_face_t *") long face, @NativeType("unsigned int") int start_offset, @NativeType("unsigned int *") @Nullable IntBuffer feature_count, @NativeType("hb_aat_layout_feature_type_t *") @Nullable IntBuffer features) {
        if (CHECKS) {
            checkSafe(feature_count, 1);
            if (feature_count != null) { checkSafe(features, feature_count.get(feature_count.position())); }
        }
        return nhb_aat_layout_get_feature_types(face, start_offset, memAddressSafe(feature_count), memAddressSafe(features));
    }

    // --- [ hb_aat_layout_feature_type_get_name_id ] ---

    /** {@code hb_ot_name_id_t hb_aat_layout_feature_type_get_name_id(hb_face_t * face, hb_aat_layout_feature_type_t feature_type)} */
    @NativeType("hb_ot_name_id_t")
    public static int hb_aat_layout_feature_type_get_name_id(@NativeType("hb_face_t *") long face, @NativeType("hb_aat_layout_feature_type_t") int feature_type) {
    ...
    /** {@code unsigned int hb_aat_layout_feature_type_get_selector_infos(hb_face_t * face, hb_aat_layout_feature_type_t feature_type, unsigned int start_offset, unsigned int * selector_count, hb_aat_layout_feature_selector_info_t * selectors, unsigned int * default_index)} */
    public static int nhb_aat_layout_feature_type_get_selector_infos(long face, int feature_type, int start_offset, long selector_count, long selectors, long default_index) {
    ...
    public static int hb_aat_layout_feature_type_get_selector_infos(@NativeType("hb_face_t *") long face, @NativeType("hb_aat_layout_feature_type_t") int feature_type, @NativeType("unsigned int") int start_offset, @NativeType("unsigned int *") @Nullable IntBuffer selector_count, @NativeType("hb_aat_layout_feature_selector_info_t *") hb_aat_layout_feature_selector_info_t.@Nullable Buffer selectors, @NativeType("unsigned int *") @Nullable IntBuffer default_index) {
        ...
        return nhb_aat_layout_feature_type_get_selector_infos(face, feature_type, start_offset, memAddressSafe(selector_count), memAddressSafe(selectors), memAddressSafe(default_index));
    }

    // --- [ hb_aat_layout_has_substitution ] ---

    /** {@code hb_bool_t hb_aat_layout_has_substitution(hb_face_t * face)} */
    @NativeType("hb_bool_t")
    public static boolean hb_aat_layout_has_substitution(@NativeType("hb_face_t *") long face) {
    ...
    /** {@code hb_bool_t hb_aat_layout_has_positioning(hb_face_t * face)} */
    @NativeType("hb_bool_t")
    public static boolean hb_aat_layout_has_positioning(@NativeType("hb_face_t *") long face) {
    ...
    /** {@code hb_bool_t hb_aat_layout_has_tracking(hb_face_t * face)} */
    @NativeType("hb_bool_t")
    public static boolean hb_aat_layout_has_tracking(@NativeType("hb_face_t *") long face) {
