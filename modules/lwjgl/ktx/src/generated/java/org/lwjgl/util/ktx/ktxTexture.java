 ...
 * }</code></pre>
 */
public class ktxTexture extends Struct implements NativeResource {
    ...
    public static ktxTexture malloc() {
        return wrap(ktxTexture.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static ktxTexture malloc(MemoryStack stack) {
        return wrap(ktxTexture.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static ktxTexture calloc(MemoryStack stack) {
        return wrap(ktxTexture.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<ktxTexture, Buffer> implements NativeResource {
         ...
         * by {@link ktxTexture#SIZEOF}, and its mark will be undefined.
         *
