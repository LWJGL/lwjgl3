...
public class ktxVulkanDeviceInfo extends Struct implements NativeResource {
    ...
    public static ktxVulkanDeviceInfo malloc() {
        return wrap(ktxVulkanDeviceInfo.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static ktxVulkanDeviceInfo calloc() {
        return wrap(ktxVulkanDeviceInfo.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static ktxVulkanDeviceInfo create() {
        ...
        return wrap(ktxVulkanDeviceInfo.class, memAddress(container), container);
    }
    ...
    public static ktxVulkanDeviceInfo create(long address) {
        return wrap(ktxVulkanDeviceInfo.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static ktxVulkanDeviceInfo createSafe(long address) {
        return address == NULL ? null : wrap(ktxVulkanDeviceInfo.class, address);
    }
    ...
    public static ktxVulkanDeviceInfo malloc(MemoryStack stack) {
        return wrap(ktxVulkanDeviceInfo.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static ktxVulkanDeviceInfo calloc(MemoryStack stack) {
        return wrap(ktxVulkanDeviceInfo.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<ktxVulkanDeviceInfo, Buffer> implements NativeResource {
         ...
         * by {@link ktxVulkanDeviceInfo#SIZEOF}, and its mark will be undefined.
         *
