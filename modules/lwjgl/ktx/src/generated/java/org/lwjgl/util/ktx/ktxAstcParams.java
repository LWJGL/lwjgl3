...
public class ktxAstcParams extends Struct implements NativeResource {
    ...
    public static ktxAstcParams malloc() {
        return wrap(ktxAstcParams.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static ktxAstcParams calloc() {
        return wrap(ktxAstcParams.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@code ktxAstcParams} instance allocated with {@link BufferUtils}. */
    public static ktxAstcParams create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(ktxAstcParams.class, memAddress(container), container);
    }
    ...
    public static ktxAstcParams create(long address) {
        return wrap(ktxAstcParams.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static ktxAstcParams createSafe(long address) {
        return address == NULL ? null : wrap(ktxAstcParams.class, address);
    }
    ...
    public static ktxAstcParams malloc(MemoryStack stack) {
        return wrap(ktxAstcParams.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static ktxAstcParams calloc(MemoryStack stack) {
        return wrap(ktxAstcParams.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<ktxAstcParams, Buffer> implements NativeResource {
         ...
         * by {@link ktxAstcParams#SIZEOF}, and its mark will be undefined.
         *
