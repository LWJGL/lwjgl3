...
public class EXRChannelInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code EXRChannelInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static EXRChannelInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code EXRChannelInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
