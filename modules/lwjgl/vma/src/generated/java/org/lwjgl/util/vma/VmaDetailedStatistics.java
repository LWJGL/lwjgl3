 ...
 */
public class VmaDetailedStatistics extends Struct implements NativeResource {
    ...
    public static VmaDetailedStatistics malloc() {
        return wrap(VmaDetailedStatistics.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VmaDetailedStatistics calloc() {
        return wrap(VmaDetailedStatistics.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static VmaDetailedStatistics create() {
        ...
        return wrap(VmaDetailedStatistics.class, memAddress(container), container);
    }
    ...
    public static VmaDetailedStatistics create(long address) {
        return wrap(VmaDetailedStatistics.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VmaDetailedStatistics createSafe(long address) {
        return address == NULL ? null : wrap(VmaDetailedStatistics.class, address);
    }
    ...
    public static VmaDetailedStatistics malloc(MemoryStack stack) {
        return wrap(VmaDetailedStatistics.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VmaDetailedStatistics calloc(MemoryStack stack) {
        return wrap(VmaDetailedStatistics.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VmaDetailedStatistics, Buffer> implements NativeResource {
         ...
         * by {@link VmaDetailedStatistics#SIZEOF}, and its mark will be undefined.
         *
