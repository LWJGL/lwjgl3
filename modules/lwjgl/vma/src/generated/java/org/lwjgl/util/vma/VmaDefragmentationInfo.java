...
public class VmaDefragmentationInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VmaDefragmentationInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static VmaDefragmentationInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VmaDefragmentationInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
