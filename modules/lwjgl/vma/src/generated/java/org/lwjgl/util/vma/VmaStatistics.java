 ...
 */
public class VmaStatistics extends Struct implements NativeResource {
    ...
    public static VmaStatistics malloc() {
        return wrap(VmaStatistics.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static VmaStatistics calloc() {
        return wrap(VmaStatistics.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@code VmaStatistics} instance allocated with {@link BufferUtils}. */
    public static VmaStatistics create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(VmaStatistics.class, memAddress(container), container);
    }
    ...
    public static VmaStatistics create(long address) {
        return wrap(VmaStatistics.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VmaStatistics createSafe(long address) {
        return address == NULL ? null : wrap(VmaStatistics.class, address);
    }
    ...
    public static VmaStatistics malloc(MemoryStack stack) {
        return wrap(VmaStatistics.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static VmaStatistics calloc(MemoryStack stack) {
        return wrap(VmaStatistics.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<VmaStatistics, Buffer> implements NativeResource {
         ...
         * by {@link VmaStatistics#SIZEOF}, and its mark will be undefined.
         *
