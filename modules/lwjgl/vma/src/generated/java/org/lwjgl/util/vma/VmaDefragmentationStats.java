...
public class VmaDefragmentationStats extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VmaDefragmentationStats} instance allocated on the thread-local {@link MemoryStack}. */
    public static VmaDefragmentationStats mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VmaDefragmentationStats} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
