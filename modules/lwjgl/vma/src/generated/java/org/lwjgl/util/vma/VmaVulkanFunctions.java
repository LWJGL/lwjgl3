...
public class VmaVulkanFunctions extends Struct implements NativeResource {
    ...
    /**
     * Returns a new {@link VmaVulkanFunctions.Buffer} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static VmaVulkanFunctions.Buffer malloc(int capacity) {
        return create(__malloc(capacity, SIZEOF), capacity);
    }

    /**
     * Returns a new {@link VmaVulkanFunctions.Buffer} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static VmaVulkanFunctions.Buffer calloc(int capacity) {
        return create(nmemCallocChecked(capacity, SIZEOF), capacity);
    }

    /**
     * Returns a new {@link VmaVulkanFunctions.Buffer} instance allocated with {@link BufferUtils}.
     *
     * @param capacity the buffer capacity
     */
    public static VmaVulkanFunctions.Buffer create(int capacity) {
        return new Buffer(__create(capacity, SIZEOF));
    }

    /**
     * Create a {@link VmaVulkanFunctions.Buffer} instance at the specified memory.
     *
     * @param address  the memory address
     * @param capacity the buffer capacity
     */
    public static VmaVulkanFunctions.Buffer create(long address, int capacity) {
        return new Buffer(address, capacity);
    }

    /** Like {@link #create(long, int) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VmaVulkanFunctions.Buffer createSafe(long address, int capacity) {
    ...
    /**
     * Returns a new {@link VmaVulkanFunctions.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VmaVulkanFunctions.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VmaVulkanFunctions.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VmaVulkanFunctions.Buffer callocStack(int capacity) {
        return callocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VmaVulkanFunctions.Buffer} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static VmaVulkanFunctions.Buffer mallocStack(int capacity, MemoryStack stack) {
        return create(stack.nmalloc(ALIGNOF, capacity * SIZEOF), capacity);
    }

    /**
     * Returns a new {@link VmaVulkanFunctions.Buffer} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static VmaVulkanFunctions.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    /** An array of {@link VmaVulkanFunctions} structs. */
    public static class Buffer extends StructBuffer<VmaVulkanFunctions, Buffer> implements NativeResource {

        /**
         * Creates a new {@link VmaVulkanFunctions.Buffer} instance backed by the specified container.
         *
         * Changes to the container's content will be visible to the struct buffer instance and vice versa. The two buffers' position, limit, and mark values
         * will be independent. The new buffer's position will be zero, its capacity and its limit will be the number of bytes remaining in this buffer divided
         * by {@link VmaVulkanFunctions#SIZEOF}, and its mark will be undefined.
         *
        ...
        @Override
        protected VmaVulkanFunctions newInstance(long address) {
        ...
        /** Returns the value of the {@code vkGetPhysicalDeviceProperties} field. */
        @NativeType("PFN_vkGetPhysicalDeviceProperties")
        public long vkGetPhysicalDeviceProperties() { return VmaVulkanFunctions.nvkGetPhysicalDeviceProperties(address()); }
        /** Returns the value of the {@code vkGetPhysicalDeviceMemoryProperties} field. */
        @NativeType("PFN_vkGetPhysicalDeviceMemoryProperties")
        public long vkGetPhysicalDeviceMemoryProperties() { return VmaVulkanFunctions.nvkGetPhysicalDeviceMemoryProperties(address()); }
        /** Returns the value of the {@code vkAllocateMemory} field. */
        @NativeType("PFN_vkAllocateMemory")
        public long vkAllocateMemory() { return VmaVulkanFunctions.nvkAllocateMemory(address()); }
        /** Returns the value of the {@code vkFreeMemory} field. */
        @NativeType("PFN_vkFreeMemory")
        public long vkFreeMemory() { return VmaVulkanFunctions.nvkFreeMemory(address()); }
        /** Returns the value of the {@code vkMapMemory} field. */
        @NativeType("PFN_vkMapMemory")
        public long vkMapMemory() { return VmaVulkanFunctions.nvkMapMemory(address()); }
        /** Returns the value of the {@code vkUnmapMemory} field. */
        @NativeType("PFN_vkUnmapMemory")
        public long vkUnmapMemory() { return VmaVulkanFunctions.nvkUnmapMemory(address()); }
        /** Returns the value of the {@code vkBindBufferMemory} field. */
        @NativeType("PFN_vkBindBufferMemory")
        public long vkBindBufferMemory() { return VmaVulkanFunctions.nvkBindBufferMemory(address()); }
        /** Returns the value of the {@code vkBindImageMemory} field. */
        @NativeType("PFN_vkBindImageMemory")
        public long vkBindImageMemory() { return VmaVulkanFunctions.nvkBindImageMemory(address()); }
        /** Returns the value of the {@code vkGetBufferMemoryRequirements} field. */
        @NativeType("PFN_vkGetBufferMemoryRequirements")
        public long vkGetBufferMemoryRequirements() { return VmaVulkanFunctions.nvkGetBufferMemoryRequirements(address()); }
        /** Returns the value of the {@code vkGetImageMemoryRequirements} field. */
        @NativeType("PFN_vkGetImageMemoryRequirements")
        public long vkGetImageMemoryRequirements() { return VmaVulkanFunctions.nvkGetImageMemoryRequirements(address()); }
        /** Returns the value of the {@code vkCreateBuffer} field. */
        @NativeType("PFN_vkCreateBuffer")
        public long vkCreateBuffer() { return VmaVulkanFunctions.nvkCreateBuffer(address()); }
        /** Returns the value of the {@code vkDestroyBuffer} field. */
        @NativeType("PFN_vkDestroyBuffer")
        public long vkDestroyBuffer() { return VmaVulkanFunctions.nvkDestroyBuffer(address()); }
        /** Returns the value of the {@code vkCreateImage} field. */
        @NativeType("PFN_vkCreateImage")
        public long vkCreateImage() { return VmaVulkanFunctions.nvkCreateImage(address()); }
        /** Returns the value of the {@code vkDestroyImage} field. */
        @NativeType("PFN_vkDestroyImage")
        public long vkDestroyImage() { return VmaVulkanFunctions.nvkDestroyImage(address()); }
        /** Returns the value of the {@code vkGetBufferMemoryRequirements2KHR} field. */
        @NativeType("PFN_vkGetBufferMemoryRequirements2KHR")
        public long vkGetBufferMemoryRequirements2KHR() { return VmaVulkanFunctions.nvkGetBufferMemoryRequirements2KHR(address()); }
        /** Returns the value of the {@code vkGetImageMemoryRequirements2KHR} field. */
        @NativeType("PFN_vkGetImageMemoryRequirements2KHR")
        public long vkGetImageMemoryRequirements2KHR() { return VmaVulkanFunctions.nvkGetImageMemoryRequirements2KHR(address()); }

        /** Sets the specified value to the {@code vkGetPhysicalDeviceProperties} field. */
        public VmaVulkanFunctions.Buffer vkGetPhysicalDeviceProperties(@NativeType("PFN_vkGetPhysicalDeviceProperties") long value) { VmaVulkanFunctions.nvkGetPhysicalDeviceProperties(address(), value); return this; }
        /** Sets the specified value to the {@code vkGetPhysicalDeviceMemoryProperties} field. */
        public VmaVulkanFunctions.Buffer vkGetPhysicalDeviceMemoryProperties(@NativeType("PFN_vkGetPhysicalDeviceMemoryProperties") long value) { VmaVulkanFunctions.nvkGetPhysicalDeviceMemoryProperties(address(), value); return this; }
        /** Sets the specified value to the {@code vkAllocateMemory} field. */
        public VmaVulkanFunctions.Buffer vkAllocateMemory(@NativeType("PFN_vkAllocateMemory") long value) { VmaVulkanFunctions.nvkAllocateMemory(address(), value); return this; }
        /** Sets the specified value to the {@code vkFreeMemory} field. */
        public VmaVulkanFunctions.Buffer vkFreeMemory(@NativeType("PFN_vkFreeMemory") long value) { VmaVulkanFunctions.nvkFreeMemory(address(), value); return this; }
        /** Sets the specified value to the {@code vkMapMemory} field. */
        public VmaVulkanFunctions.Buffer vkMapMemory(@NativeType("PFN_vkMapMemory") long value) { VmaVulkanFunctions.nvkMapMemory(address(), value); return this; }
        /** Sets the specified value to the {@code vkUnmapMemory} field. */
        public VmaVulkanFunctions.Buffer vkUnmapMemory(@NativeType("PFN_vkUnmapMemory") long value) { VmaVulkanFunctions.nvkUnmapMemory(address(), value); return this; }
        /** Sets the specified value to the {@code vkBindBufferMemory} field. */
        public VmaVulkanFunctions.Buffer vkBindBufferMemory(@NativeType("PFN_vkBindBufferMemory") long value) { VmaVulkanFunctions.nvkBindBufferMemory(address(), value); return this; }
        /** Sets the specified value to the {@code vkBindImageMemory} field. */
        public VmaVulkanFunctions.Buffer vkBindImageMemory(@NativeType("PFN_vkBindImageMemory") long value) { VmaVulkanFunctions.nvkBindImageMemory(address(), value); return this; }
        /** Sets the specified value to the {@code vkGetBufferMemoryRequirements} field. */
        public VmaVulkanFunctions.Buffer vkGetBufferMemoryRequirements(@NativeType("PFN_vkGetBufferMemoryRequirements") long value) { VmaVulkanFunctions.nvkGetBufferMemoryRequirements(address(), value); return this; }
        /** Sets the specified value to the {@code vkGetImageMemoryRequirements} field. */
        public VmaVulkanFunctions.Buffer vkGetImageMemoryRequirements(@NativeType("PFN_vkGetImageMemoryRequirements") long value) { VmaVulkanFunctions.nvkGetImageMemoryRequirements(address(), value); return this; }
        /** Sets the specified value to the {@code vkCreateBuffer} field. */
        public VmaVulkanFunctions.Buffer vkCreateBuffer(@NativeType("PFN_vkCreateBuffer") long value) { VmaVulkanFunctions.nvkCreateBuffer(address(), value); return this; }
        /** Sets the specified value to the {@code vkDestroyBuffer} field. */
        public VmaVulkanFunctions.Buffer vkDestroyBuffer(@NativeType("PFN_vkDestroyBuffer") long value) { VmaVulkanFunctions.nvkDestroyBuffer(address(), value); return this; }
        /** Sets the specified value to the {@code vkCreateImage} field. */
        public VmaVulkanFunctions.Buffer vkCreateImage(@NativeType("PFN_vkCreateImage") long value) { VmaVulkanFunctions.nvkCreateImage(address(), value); return this; }
        /** Sets the specified value to the {@code vkDestroyImage} field. */
        public VmaVulkanFunctions.Buffer vkDestroyImage(@NativeType("PFN_vkDestroyImage") long value) { VmaVulkanFunctions.nvkDestroyImage(address(), value); return this; }
        /** Sets the specified value to the {@code vkGetBufferMemoryRequirements2KHR} field. */
        public VmaVulkanFunctions.Buffer vkGetBufferMemoryRequirements2KHR(@NativeType("PFN_vkGetBufferMemoryRequirements2KHR") long value) { VmaVulkanFunctions.nvkGetBufferMemoryRequirements2KHR(address(), value); return this; }
        /** Sets the specified value to the {@code vkGetImageMemoryRequirements2KHR} field. */
        public VmaVulkanFunctions.Buffer vkGetImageMemoryRequirements2KHR(@NativeType("PFN_vkGetImageMemoryRequirements2KHR") long value) { VmaVulkanFunctions.nvkGetImageMemoryRequirements2KHR(address(), value); return this; }
