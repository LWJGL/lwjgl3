...
public class XCreateWindowEvent extends Struct implements NativeResource {
    ...
    /** Returns a new {@code XCreateWindowEvent} instance allocated on the thread-local {@link MemoryStack}. */
    ...
    /**
     * Returns a new {@link XCreateWindowEvent.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link XCreateWindowEvent.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
