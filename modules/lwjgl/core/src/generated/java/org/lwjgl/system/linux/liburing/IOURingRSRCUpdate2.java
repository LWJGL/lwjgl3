...
public class IOURingRSRCUpdate2 extends Struct<IOURingRSRCUpdate2> implements NativeResource {
    ...
    static int nresv(long struct) { return memGetInt(struct + IOURingRSRCUpdate2.RESV); }
    ...
    static int nresv2(long struct) { return memGetInt(struct + IOURingRSRCUpdate2.RESV2); }

    /** Unsafe version of {@link #offset(int) offset}. */
    public static void noffset(long struct, int value) { memPutInt(struct + IOURingRSRCUpdate2.OFFSET, value); }
    static void nresv(long struct, int value) { memPutInt(struct + IOURingRSRCUpdate2.RESV, value); }
    ...
    static void nresv2(long struct, int value) { memPutInt(struct + IOURingRSRCUpdate2.RESV2, value); }
