 ...
 * 
 * <ul>
 * <li>{@code Width} &ndash; Width of array</li>
 * <li>{@code Height} &ndash; Height of array</li>
...
public class CUDA_ARRAY_DESCRIPTOR extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link CUDA_ARRAY_DESCRIPTOR} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CUDA_ARRAY_DESCRIPTOR} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static CUDA_ARRAY_DESCRIPTOR malloc() {
        return wrap(CUDA_ARRAY_DESCRIPTOR.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link CUDA_ARRAY_DESCRIPTOR} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static CUDA_ARRAY_DESCRIPTOR calloc() {
        return wrap(CUDA_ARRAY_DESCRIPTOR.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link CUDA_ARRAY_DESCRIPTOR} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link CUDA_ARRAY_DESCRIPTOR} instance for the specified memory address. */
    ...
    /** Returns a new {@link CUDA_ARRAY_DESCRIPTOR} instance allocated on the thread-local {@link MemoryStack}. */
    public static CUDA_ARRAY_DESCRIPTOR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link CUDA_ARRAY_DESCRIPTOR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CUDA_ARRAY_DESCRIPTOR callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link CUDA_ARRAY_DESCRIPTOR} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link CUDA_ARRAY_DESCRIPTOR} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link CUDA_ARRAY_DESCRIPTOR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static CUDA_ARRAY_DESCRIPTOR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link CUDA_ARRAY_DESCRIPTOR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static CUDA_ARRAY_DESCRIPTOR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static CUDA_ARRAY_DESCRIPTOR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static CUDA_ARRAY_DESCRIPTOR.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<CUDA_ARRAY_DESCRIPTOR, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link CUDA_ARRAY_DESCRIPTOR.Buffer} instance backed by the specified container.
         *
