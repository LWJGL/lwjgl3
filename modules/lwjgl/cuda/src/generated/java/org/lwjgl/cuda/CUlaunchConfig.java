 ...
 * }</code></pre>
 */
public class CUlaunchConfig extends Struct implements NativeResource {
    ...
    public static CUlaunchConfig malloc() {
        return wrap(CUlaunchConfig.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static CUlaunchConfig calloc() {
        return wrap(CUlaunchConfig.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@code CUlaunchConfig} instance allocated with {@link BufferUtils}. */
    public static CUlaunchConfig create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(CUlaunchConfig.class, memAddress(container), container);
    }
    ...
    public static CUlaunchConfig create(long address) {
        return wrap(CUlaunchConfig.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static CUlaunchConfig createSafe(long address) {
        return address == NULL ? null : wrap(CUlaunchConfig.class, address);
    }
    ...
    public static CUlaunchConfig malloc(MemoryStack stack) {
        return wrap(CUlaunchConfig.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static CUlaunchConfig calloc(MemoryStack stack) {
        return wrap(CUlaunchConfig.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<CUlaunchConfig, Buffer> implements NativeResource {
         ...
         * by {@link CUlaunchConfig#SIZEOF}, and its mark will be undefined.
         *
