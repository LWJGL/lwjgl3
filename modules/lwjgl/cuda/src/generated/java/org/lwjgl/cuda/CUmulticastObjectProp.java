 ...
 * }</code></pre>
 */
public class CUmulticastObjectProp extends Struct implements NativeResource {
    ...
    public static CUmulticastObjectProp malloc() {
        return wrap(CUmulticastObjectProp.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static CUmulticastObjectProp calloc() {
        return wrap(CUmulticastObjectProp.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static CUmulticastObjectProp create() {
        ...
        return wrap(CUmulticastObjectProp.class, memAddress(container), container);
    }
    ...
    public static CUmulticastObjectProp create(long address) {
        return wrap(CUmulticastObjectProp.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static CUmulticastObjectProp createSafe(long address) {
        return address == NULL ? null : wrap(CUmulticastObjectProp.class, address);
    }
    ...
    public static CUmulticastObjectProp malloc(MemoryStack stack) {
        return wrap(CUmulticastObjectProp.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static CUmulticastObjectProp calloc(MemoryStack stack) {
        return wrap(CUmulticastObjectProp.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<CUmulticastObjectProp, Buffer> implements NativeResource {
         ...
         * by {@link CUmulticastObjectProp#SIZEOF}, and its mark will be undefined.
         *
