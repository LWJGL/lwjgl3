 ...
 * }</code></pre>
 */
public class CUlaunchAttribute extends Struct implements NativeResource {
    ...
    public static CUlaunchAttribute malloc() {
        return wrap(CUlaunchAttribute.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static CUlaunchAttribute calloc() {
        return wrap(CUlaunchAttribute.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static CUlaunchAttribute create() {
        ...
        return wrap(CUlaunchAttribute.class, memAddress(container), container);
    }
    ...
    public static CUlaunchAttribute create(long address) {
        return wrap(CUlaunchAttribute.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static CUlaunchAttribute createSafe(long address) {
        return address == NULL ? null : wrap(CUlaunchAttribute.class, address);
    }
    ...
    public static CUlaunchAttribute malloc(MemoryStack stack) {
        return wrap(CUlaunchAttribute.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static CUlaunchAttribute calloc(MemoryStack stack) {
        return wrap(CUlaunchAttribute.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<CUlaunchAttribute, Buffer> implements NativeResource {
         ...
         * by {@link CUlaunchAttribute#SIZEOF}, and its mark will be undefined.
         *
