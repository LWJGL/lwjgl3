...
public class CUDA_EXT_SEM_SIGNAL_NODE_PARAMS_v2 extends Struct<CUDA_EXT_SEM_SIGNAL_NODE_PARAMS_v2> implements NativeResource {
    ...
    @Nullable
    public static CUDA_EXT_SEM_SIGNAL_NODE_PARAMS_v2 createSafe(long address) {
    ...
    @Nullable
    public static CUDA_EXT_SEM_SIGNAL_NODE_PARAMS_v2.Buffer createSafe(long address, int capacity) {
    ...
    public static int nnumExtSems(long struct) { return UNSAFE.getInt(null, struct + CUDA_EXT_SEM_SIGNAL_NODE_PARAMS_v2.NUMEXTSEMS); }
    ...
    public static void nnumExtSems(long struct, int value) { UNSAFE.putInt(null, struct + CUDA_EXT_SEM_SIGNAL_NODE_PARAMS_v2.NUMEXTSEMS, value); }
