...
public class CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    ...
    /** Returns a new {@link CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    ...
    /** Returns a new {@link CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC} instance for the specified memory address. */
    ...
    /** Returns a new {@link CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC} instance allocated on the thread-local {@link MemoryStack}. */
    public static CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC.Buffer} instance backed by the specified container.
         *
