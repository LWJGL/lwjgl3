...
public class CUIPCEventHandle extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link CUIPCEventHandle} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CUIPCEventHandle} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static CUIPCEventHandle malloc() {
        return wrap(CUIPCEventHandle.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link CUIPCEventHandle} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static CUIPCEventHandle calloc() {
        return wrap(CUIPCEventHandle.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link CUIPCEventHandle} instance allocated with {@link BufferUtils}. */
    public static CUIPCEventHandle create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(CUIPCEventHandle.class, memAddress(container), container);
    }

    /** Returns a new {@link CUIPCEventHandle} instance for the specified memory address. */
    ...
    /** Returns a new {@link CUIPCEventHandle} instance allocated on the thread-local {@link MemoryStack}. */
    public static CUIPCEventHandle mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link CUIPCEventHandle} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CUIPCEventHandle callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link CUIPCEventHandle} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link CUIPCEventHandle} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<CUIPCEventHandle, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link CUIPCEventHandle.Buffer} instance backed by the specified container.
         *
