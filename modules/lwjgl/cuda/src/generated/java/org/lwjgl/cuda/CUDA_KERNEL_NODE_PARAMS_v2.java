...
public class CUDA_KERNEL_NODE_PARAMS_v2 extends Struct<CUDA_KERNEL_NODE_PARAMS_v2> implements NativeResource {
    ...
    public static CUDA_KERNEL_NODE_PARAMS_v2 malloc() {
        return new CUDA_KERNEL_NODE_PARAMS_v2(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static CUDA_KERNEL_NODE_PARAMS_v2 calloc() {
        return new CUDA_KERNEL_NODE_PARAMS_v2(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static CUDA_KERNEL_NODE_PARAMS_v2 create() {
        ...
        return new CUDA_KERNEL_NODE_PARAMS_v2(memAddress(container), container);
    }
    ...
    public static class Buffer extends StructBuffer<CUDA_KERNEL_NODE_PARAMS_v2, Buffer> implements NativeResource {
         ...
         * by {@link CUDA_KERNEL_NODE_PARAMS_v2#SIZEOF}, and its mark will be undefined.</p>
         *
