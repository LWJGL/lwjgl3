...
public class CUDA_EVENT_WAIT_NODE_PARAMS extends Struct<CUDA_EVENT_WAIT_NODE_PARAMS> implements NativeResource {
    ...
    @Nullable
    public static CUDA_EVENT_WAIT_NODE_PARAMS createSafe(long address) {
    ...
    @Nullable
    public static CUDA_EVENT_WAIT_NODE_PARAMS.Buffer createSafe(long address, int capacity) {
