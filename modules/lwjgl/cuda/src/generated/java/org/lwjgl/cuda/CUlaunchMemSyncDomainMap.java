 ...
 * }</code></pre>
 */
public class CUlaunchMemSyncDomainMap extends Struct implements NativeResource {
    ...
    public static CUlaunchMemSyncDomainMap malloc() {
        return wrap(CUlaunchMemSyncDomainMap.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static CUlaunchMemSyncDomainMap calloc() {
        return wrap(CUlaunchMemSyncDomainMap.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static CUlaunchMemSyncDomainMap create() {
        ...
        return wrap(CUlaunchMemSyncDomainMap.class, memAddress(container), container);
    }
    ...
    public static CUlaunchMemSyncDomainMap create(long address) {
        return wrap(CUlaunchMemSyncDomainMap.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static CUlaunchMemSyncDomainMap createSafe(long address) {
        return address == NULL ? null : wrap(CUlaunchMemSyncDomainMap.class, address);
    }
    ...
    public static CUlaunchMemSyncDomainMap malloc(MemoryStack stack) {
        return wrap(CUlaunchMemSyncDomainMap.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static CUlaunchMemSyncDomainMap calloc(MemoryStack stack) {
        return wrap(CUlaunchMemSyncDomainMap.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<CUlaunchMemSyncDomainMap, Buffer> implements NativeResource {
         ...
         * by {@link CUlaunchMemSyncDomainMap#SIZEOF}, and its mark will be undefined.
         *
