...
public class CUDA_ARRAY3D_DESCRIPTOR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code CUDA_ARRAY3D_DESCRIPTOR} instance allocated on the thread-local {@link MemoryStack}. */
    public static CUDA_ARRAY3D_DESCRIPTOR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code CUDA_ARRAY3D_DESCRIPTOR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
