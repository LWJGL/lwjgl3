...
public class CUstreamBatchMemOpParams extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link CUstreamBatchMemOpParams} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CUstreamBatchMemOpParams} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static CUstreamBatchMemOpParams malloc() {
        return wrap(CUstreamBatchMemOpParams.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link CUstreamBatchMemOpParams} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static CUstreamBatchMemOpParams calloc() {
        return wrap(CUstreamBatchMemOpParams.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link CUstreamBatchMemOpParams} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link CUstreamBatchMemOpParams} instance for the specified memory address. */
    ...
    /** Returns a new {@link CUstreamBatchMemOpParams} instance allocated on the thread-local {@link MemoryStack}. */
    public static CUstreamBatchMemOpParams mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link CUstreamBatchMemOpParams} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CUstreamBatchMemOpParams callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link CUstreamBatchMemOpParams} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link CUstreamBatchMemOpParams} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<CUstreamBatchMemOpParams, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link CUstreamBatchMemOpParams.Buffer} instance backed by the specified container.
         *
