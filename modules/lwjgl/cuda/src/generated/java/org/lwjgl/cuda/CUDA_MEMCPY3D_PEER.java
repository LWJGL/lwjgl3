...
public class CUDA_MEMCPY3D_PEER extends Struct implements NativeResource {
    ...
    /** Returns a new {@code CUDA_MEMCPY3D_PEER} instance allocated on the thread-local {@link MemoryStack}. */
    public static CUDA_MEMCPY3D_PEER mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code CUDA_MEMCPY3D_PEER} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
