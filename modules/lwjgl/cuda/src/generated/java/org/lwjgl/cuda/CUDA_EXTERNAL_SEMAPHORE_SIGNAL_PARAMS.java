...
public class CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS extends Struct implements NativeResource {
    ...
    /** Returns a new {@code CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS} instance allocated on the thread-local {@link MemoryStack}. */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS callocStack() {
     ...
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS callocStack(MemoryStack stack) {
        return wrap(CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer callocStack(int capacity, MemoryStack stack) {
