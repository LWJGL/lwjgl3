 ...
 * }</code></pre>
 */
public class CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS extends Struct<CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS> implements NativeResource {
    ...
    static {
        ...
        PARAMS = layout.offsetof(0);
            ...
            PARAMS_RESERVED = layout.offsetof(8);
        FLAGS = layout.offsetof(9);
        RESERVED = layout.offsetof(10);
    }

    protected CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS create(long address, @Nullable ByteBuffer container) {
        return new CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS(address, container);
    }

    /**
     * Creates a {@code CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
     * visible to the struct instance and vice versa.
     *
     * <p>The created instance holds a strong reference to the container object.</p>
     */
    public CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS(ByteBuffer container) {
    ...
    public CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS params_reserved(@NativeType("unsigned int[12]") IntBuffer value) { nparams_reserved(address(), value); return this; }
     ...
     * @return this struct
     */
    public CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS set(CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS src) {
    ...
    /** Returns a new {@code CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS malloc() {
        return new CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS(nmemAllocChecked(SIZEOF), null);
    }

    /** Returns a new {@code CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS calloc() {
        return new CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS(nmemCallocChecked(1, SIZEOF), null);
    }

    /** Returns a new {@code CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS} instance allocated with {@link BufferUtils}. */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return new CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS(memAddress(container), container);
    }

    /** Returns a new {@code CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS} instance for the specified memory address. */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS create(long address) {
        return new CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static @Nullable CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS createSafe(long address) {
        return address == NULL ? null : new CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS(address, null);
    }

    /**
     * Returns a new {@link CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer malloc(int capacity) {
        return new Buffer(nmemAllocChecked(__checkMalloc(capacity, SIZEOF)), capacity);
    }

    /**
     * Returns a new {@link CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer calloc(int capacity) {
        return new Buffer(nmemCallocChecked(capacity, SIZEOF), capacity);
    }

    /**
     * Returns a new {@link CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer} instance allocated with {@link BufferUtils}.
     *
     * @param capacity the buffer capacity
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer create(int capacity) {
        ByteBuffer container = __create(capacity, SIZEOF);
        return new Buffer(memAddress(container), container, -1, 0, capacity, capacity);
    }

    /**
     * Create a {@link CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer} instance at the specified memory.
     *
     * @param address  the memory address
     * @param capacity the buffer capacity
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer create(long address, int capacity) {
        return new Buffer(address, capacity);
    }

    /** Like {@link #create(long, int) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    @Deprecated public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS mallocStack() { return malloc(stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(MemoryStack)} instead. */
    @Deprecated public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS callocStack() { return calloc(stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(MemoryStack)} instead. */
    @Deprecated public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS mallocStack(MemoryStack stack) { return malloc(stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(MemoryStack)} instead. */
    @Deprecated public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS callocStack(MemoryStack stack) { return calloc(stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(int, MemoryStack)} instead. */
    @Deprecated public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer mallocStack(int capacity) { return malloc(capacity, stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(int, MemoryStack)} instead. */
    @Deprecated public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer callocStack(int capacity) { return calloc(capacity, stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(int, MemoryStack)} instead. */
    @Deprecated public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer mallocStack(int capacity, MemoryStack stack) { return malloc(capacity, stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(int, MemoryStack)} instead. */
    @Deprecated public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer callocStack(int capacity, MemoryStack stack) { return calloc(capacity, stack); }

    /**
     * Returns a new {@code CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack the stack from which to allocate
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS malloc(MemoryStack stack) {
        return new CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }

    /**
     * Returns a new {@code CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS calloc(MemoryStack stack) {
        return new CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }

    /**
     * Returns a new {@link CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer malloc(int capacity, MemoryStack stack) {
        return new Buffer(stack.nmalloc(ALIGNOF, capacity * SIZEOF), capacity);
    }

    /**
     * Returns a new {@link CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static void nreserved(long struct, IntBuffer value) {
        ...
        memCopy(memAddress(value), struct + CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.RESERVED, value.remaining() * 4);
    }
    ...
    /** An array of {@link CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS} structs. */
    public static class Buffer extends StructBuffer<CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS, Buffer> implements NativeResource {

        private static final CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS ELEMENT_FACTORY = CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.create(-1L);

        /**
         * Creates a new {@code CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer} instance backed by the specified container.
         *
         * <p>Changes to the container's content will be visible to the struct buffer instance and vice versa. The two buffers' position, limit, and mark values
         * will be independent. The new buffer's position will be zero, its capacity and its limit will be the number of bytes remaining in this buffer divided
         * by {@link CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        /** Copies the specified {@link IntBuffer} to the {@code reserved} field. */
        public CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer params_reserved(@NativeType("unsigned int[12]") IntBuffer value) { CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.nparams_reserved(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code reserved} field. */
        ...
        /** Sets the specified value at the specified index of the {@code reserved} field. */
        public CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.Buffer reserved(int index, @NativeType("unsigned int") int value) { CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS.nreserved(address(), index, value); return this; }
