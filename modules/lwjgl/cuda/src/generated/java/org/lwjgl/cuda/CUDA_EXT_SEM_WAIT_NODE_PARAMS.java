...
public class CUDA_EXT_SEM_WAIT_NODE_PARAMS extends Struct<CUDA_EXT_SEM_WAIT_NODE_PARAMS> implements NativeResource {
    ...
    public static @Nullable CUDA_EXT_SEM_WAIT_NODE_PARAMS createSafe(long address) {
    ...
    public static CUDA_EXT_SEM_WAIT_NODE_PARAMS.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static int nnumExtSems(long struct) { return memGetInt(struct + CUDA_EXT_SEM_WAIT_NODE_PARAMS.NUMEXTSEMS); }
    ...
    public static void nnumExtSems(long struct, int value) { memPutInt(struct + CUDA_EXT_SEM_WAIT_NODE_PARAMS.NUMEXTSEMS, value); }
