...
public class Zdict {
     ...
     * <li>If {@code d} is non-zero then we don't check multiple values of {@code }d, otherwise we check {@code d = {6, 8, 10, 12, 14, 16}}.</li>
     * <li>If {@code steps} is zero it defaults to its default value.</li>
     * <li>If {@code k} is non-zero then we don't check multiple values of {@code k}, otherwise we check steps values in {@code [16, 2048]}.</li>
     * </ul>
     * 
