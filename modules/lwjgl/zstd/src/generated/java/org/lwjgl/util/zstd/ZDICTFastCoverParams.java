...
public class ZDICTFastCoverParams extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link ZDICTFastCoverParams} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link ZDICTFastCoverParams} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static ZDICTFastCoverParams malloc() {
        return wrap(ZDICTFastCoverParams.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link ZDICTFastCoverParams} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static ZDICTFastCoverParams calloc() {
        return wrap(ZDICTFastCoverParams.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link ZDICTFastCoverParams} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link ZDICTFastCoverParams} instance for the specified memory address. */
    ...
    /** Returns a new {@link ZDICTFastCoverParams} instance allocated on the thread-local {@link MemoryStack}. */
    public static ZDICTFastCoverParams mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link ZDICTFastCoverParams} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static ZDICTFastCoverParams callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link ZDICTFastCoverParams} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link ZDICTFastCoverParams} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<ZDICTFastCoverParams, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link ZDICTFastCoverParams.Buffer} instance backed by the specified container.
         *
