...
public class NkRect extends Struct implements NativeResource {
    ...
    /** Returns a new {@code NkRect} instance allocated on the thread-local {@link MemoryStack}. */
    public static NkRect mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code NkRect} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
