...
public class NkFontGlyph extends Struct implements NativeResource {
    ...
    public static NkFontGlyph malloc() {
        return wrap(NkFontGlyph.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static NkFontGlyph malloc(MemoryStack stack) {
        return wrap(NkFontGlyph.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static NkFontGlyph calloc(MemoryStack stack) {
        return wrap(NkFontGlyph.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<NkFontGlyph, Buffer> implements NativeResource {
         ...
         * by {@link NkFontGlyph#SIZEOF}, and its mark will be undefined.
         *
