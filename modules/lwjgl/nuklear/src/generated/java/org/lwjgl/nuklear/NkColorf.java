...
public class NkColorf extends Struct implements NativeResource {
    ...
    /** Returns a new {@code NkColorf} instance allocated on the thread-local {@link MemoryStack}. */
    public static NkColorf mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code NkColorf} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
