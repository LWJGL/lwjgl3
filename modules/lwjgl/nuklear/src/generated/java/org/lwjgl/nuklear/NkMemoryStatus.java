...
public class NkMemoryStatus extends Struct implements NativeResource {
    ...
    /** Returns a new {@code NkMemoryStatus} instance allocated on the thread-local {@link MemoryStack}. */
    public static NkMemoryStatus mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code NkMemoryStatus} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
