...
public class NkBakedFont extends Struct implements NativeResource {
    ...
    public static NkBakedFont malloc() {
        return wrap(NkBakedFont.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static NkBakedFont malloc(MemoryStack stack) {
        return wrap(NkBakedFont.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static NkBakedFont calloc(MemoryStack stack) {
        return wrap(NkBakedFont.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<NkBakedFont, Buffer> implements NativeResource {
         ...
         * by {@link NkBakedFont#SIZEOF}, and its mark will be undefined.
         *
