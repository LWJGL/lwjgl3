...
public class NkFont extends Struct implements NativeResource {
    ...
    public static NkFont malloc() {
        return wrap(NkFont.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static NkFont malloc(MemoryStack stack) {
        return wrap(NkFont.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static NkFont calloc(MemoryStack stack) {
        return wrap(NkFont.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<NkFont, Buffer> implements NativeResource {
         ...
         * by {@link NkFont#SIZEOF}, and its mark will be undefined.
         *
