...
public class NkContext extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<NkContext, Buffer> implements NativeResource {
        ...
        /** Passes the {@code style} field to the specified {@link java.util.function.Consumer Consumer}. */
        public NkContext.Buffer style(java.util.function.Consumer<NkStyle> consumer) { consumer.accept(style()); return this; }
        /** Returns a {@link NkBuffer} view of the {@code memory} field. */
        @NativeType("struct nk_buffer")
        ...
        /** Passes the {@code clip} field to the specified {@link java.util.function.Consumer Consumer}. */
        public NkContext.Buffer clip(java.util.function.Consumer<NkClipboard> consumer) { consumer.accept(clip()); return this; }
        /** Returns the value of the {@code last_widget_state} field. */
        @NativeType("nk_flags")
