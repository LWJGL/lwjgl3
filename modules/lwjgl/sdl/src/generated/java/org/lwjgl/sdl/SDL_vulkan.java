...
public class SDL_vulkan {
    ...
    /** {@code void SDL_Vulkan_DestroySurface(VkInstance instance, VkSurfaceKHR surface, VkAllocationCallbacks const * allocator)} */
    public static void SDL_Vulkan_DestroySurface(VkInstance instance, @NativeType("VkSurfaceKHR") long surface, @NativeType("VkAllocationCallbacks const *") VkAllocationCallbacks.@Nullable Buffer allocator) {
        if (CHECKS) {
            checkSafe(allocator, 1);
        }
