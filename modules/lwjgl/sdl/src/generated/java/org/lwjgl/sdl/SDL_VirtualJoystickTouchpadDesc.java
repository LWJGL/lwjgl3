...
public class SDL_VirtualJoystickTouchpadDesc extends Struct<SDL_VirtualJoystickTouchpadDesc> implements NativeResource {
    ...
    /** @return a {@link ShortBuffer} view of the {@code padding} field. */
    @NativeType("Uint16[3]")
    public ShortBuffer padding() { return npadding(address()); }
    /** @return the value at the specified index of the {@code padding} field. */
    @NativeType("Uint16")
    public short padding(int index) { return npadding(address(), index); }
    ...
    /** Copies the specified {@link ShortBuffer} to the {@code padding} field. */
    public SDL_VirtualJoystickTouchpadDesc padding(@NativeType("Uint16[3]") ShortBuffer value) { npadding(address(), value); return this; }
    /** Sets the specified value at the specified index of the {@code padding} field. */
    public SDL_VirtualJoystickTouchpadDesc padding(int index, @NativeType("Uint16") short value) { npadding(address(), index, value); return this; }

    /** Initializes this struct with the specified values. */
    public SDL_VirtualJoystickTouchpadDesc set(
        short nfingers,
        ShortBuffer padding
    ) {
        nfingers(nfingers);
    ...
    /** Unsafe version of {@link #padding(ShortBuffer) padding}. */
    ...
    /** Unsafe version of {@link #padding(int, short) padding}. */
    ...
    public static class Buffer extends StructBuffer<SDL_VirtualJoystickTouchpadDesc, Buffer> implements NativeResource {
        ...
        /** @return a {@link ShortBuffer} view of the {@code padding} field. */
        @NativeType("Uint16[3]")
        public ShortBuffer padding() { return SDL_VirtualJoystickTouchpadDesc.npadding(address()); }
        /** @return the value at the specified index of the {@code padding} field. */
        @NativeType("Uint16")
        public short padding(int index) { return SDL_VirtualJoystickTouchpadDesc.npadding(address(), index); }
        ...
        /** Copies the specified {@link ShortBuffer} to the {@code padding} field. */
        public SDL_VirtualJoystickTouchpadDesc.Buffer padding(@NativeType("Uint16[3]") ShortBuffer value) { SDL_VirtualJoystickTouchpadDesc.npadding(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code padding} field. */
        public SDL_VirtualJoystickTouchpadDesc.Buffer padding(int index, @NativeType("Uint16") short value) { SDL_VirtualJoystickTouchpadDesc.npadding(address(), index, value); return this; }
