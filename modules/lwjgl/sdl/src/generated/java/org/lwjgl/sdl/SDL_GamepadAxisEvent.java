...
public class SDL_GamepadAxisEvent extends Struct<SDL_GamepadAxisEvent> implements NativeResource {
    ...
    /** @return the value of the {@code padding4} field. */
    @NativeType("Uint16")
    public short padding4() { return npadding4(address()); }
    ...
    public SDL_GamepadAxisEvent padding1(@NativeType("Uint8") byte value) { npadding1(address(), value); return this; }
    /** Sets the specified value to the {@code padding2} field. */
    public SDL_GamepadAxisEvent padding2(@NativeType("Uint8") byte value) { npadding2(address(), value); return this; }
    /** Sets the specified value to the {@code padding3} field. */
    public SDL_GamepadAxisEvent padding3(@NativeType("Uint8") byte value) { npadding3(address(), value); return this; }
    ...
    /** Sets the specified value to the {@code padding4} field. */
    public SDL_GamepadAxisEvent padding4(@NativeType("Uint16") short value) { npadding4(address(), value); return this; }
    ...
    /** Unsafe version of {@link #padding4}. */
    ...
    /** Unsafe version of {@link #padding4(short) padding4}. */
    ...
    public static class Buffer extends StructBuffer<SDL_GamepadAxisEvent, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@code padding1} field. */
        @NativeType("Uint8")
        public byte padding1() { return SDL_GamepadAxisEvent.npadding1(address()); }
        /** @return the value of the {@code padding2} field. */
        @NativeType("Uint8")
        public byte padding2() { return SDL_GamepadAxisEvent.npadding2(address()); }
        /** @return the value of the {@code padding3} field. */
        @NativeType("Uint8")
        public byte padding3() { return SDL_GamepadAxisEvent.npadding3(address()); }
        /** @return the value of the {@code value} field. */
        @NativeType("Sint16")
        public short value() { return SDL_GamepadAxisEvent.nvalue(address()); }
        /** @return the value of the {@code padding4} field. */
        @NativeType("Uint16")
        public short padding4() { return SDL_GamepadAxisEvent.npadding4(address()); }
        ...
        /** Sets the specified value to the {@code padding1} field. */
        public SDL_GamepadAxisEvent.Buffer padding1(@NativeType("Uint8") byte value) { SDL_GamepadAxisEvent.npadding1(address(), value); return this; }
        /** Sets the specified value to the {@code padding2} field. */
        public SDL_GamepadAxisEvent.Buffer padding2(@NativeType("Uint8") byte value) { SDL_GamepadAxisEvent.npadding2(address(), value); return this; }
        /** Sets the specified value to the {@code padding3} field. */
        public SDL_GamepadAxisEvent.Buffer padding3(@NativeType("Uint8") byte value) { SDL_GamepadAxisEvent.npadding3(address(), value); return this; }
        /** Sets the specified value to the {@code value} field. */
        ...
        /** Sets the specified value to the {@code padding4} field. */
        public SDL_GamepadAxisEvent.Buffer padding4(@NativeType("Uint16") short value) { SDL_GamepadAxisEvent.npadding4(address(), value); return this; }
