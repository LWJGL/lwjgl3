...
public class SDL_HapticCustom extends Struct<SDL_HapticCustom> implements NativeResource {
    ...
    @NativeType("Uint16 *")
    public ShortBuffer data(int capacity) { return ndata(address(), capacity); }
    ...
    public static ShortBuffer ndata(long struct, int capacity) { return memShortBuffer(memGetAddress(struct + SDL_HapticCustom.DATA), capacity); }
    ...
    public static class Buffer extends StructBuffer<SDL_HapticCustom, Buffer> implements NativeResource {
        ...
        /** @return a {@link ShortBuffer} view of the data pointed to by the {@code data} field. */
        @NativeType("Uint16 *")
        public ShortBuffer data(int capacity) { return SDL_HapticCustom.ndata(address(), capacity); }
        /** @return the value of the {@code attack_length} field. */
        @NativeType("Uint16")
