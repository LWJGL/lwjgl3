...
public class SDL_Locale extends Struct<SDL_Locale> implements NativeResource {
    ...
    /** @return a {@link ByteBuffer} view of the data pointed to by the {@code language} field. */
    @NativeType("char const *")
    public ByteBuffer language(int capacity) { return nlanguage(address(), capacity); }
    /** @return a {@link ByteBuffer} view of the data pointed to by the {@code country} field. */
    @NativeType("char const *")
    public @Nullable ByteBuffer country(int capacity) { return ncountry(address(), capacity); }

    /** Sets the address of the specified {@link ByteBuffer} to the {@code language} field. */
    public SDL_Locale language(@NativeType("char const *") ByteBuffer value) { nlanguage(address(), value); return this; }
    /** Sets the address of the specified {@link ByteBuffer} to the {@code country} field. */
    ...
    public static ByteBuffer nlanguage(long struct, int capacity) { return memByteBuffer(memGetAddress(struct + SDL_Locale.LANGUAGE), capacity); }
    /** Unsafe version of {@link #country(int) country}. */
    public static @Nullable ByteBuffer ncountry(long struct, int capacity) { return memByteBufferSafe(memGetAddress(struct + SDL_Locale.COUNTRY), capacity); }

    /** Unsafe version of {@link #language(ByteBuffer) language}. */
    public static void nlanguage(long struct, ByteBuffer value) { memPutAddress(struct + SDL_Locale.LANGUAGE, memAddress(value)); }
    /** Unsafe version of {@link #country(ByteBuffer) country}. */
    public static void ncountry(long struct, @Nullable ByteBuffer value) { memPutAddress(struct + SDL_Locale.COUNTRY, memAddressSafe(value)); }
    ...
    public static class Buffer extends StructBuffer<SDL_Locale, Buffer> implements NativeResource {
        ...
        /** @return a {@link ByteBuffer} view of the data pointed to by the {@code language} field. */
        @NativeType("char const *")
        public ByteBuffer language(int capacity) { return SDL_Locale.nlanguage(address(), capacity); }
        /** @return a {@link ByteBuffer} view of the data pointed to by the {@code country} field. */
        @NativeType("char const *")
        public @Nullable ByteBuffer country(int capacity) { return SDL_Locale.ncountry(address(), capacity); }
