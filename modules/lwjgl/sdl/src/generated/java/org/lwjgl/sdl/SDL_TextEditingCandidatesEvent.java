...
public class SDL_TextEditingCandidatesEvent extends Struct<SDL_TextEditingCandidatesEvent> implements NativeResource {
    ...
    public SDL_TextEditingCandidatesEvent padding2(@NativeType("Uint8") byte value) { npadding2(address(), value); return this; }
    /** Sets the specified value to the {@code padding3} field. */
    public SDL_TextEditingCandidatesEvent padding3(@NativeType("Uint8") byte value) { npadding3(address(), value); return this; }
    ...
    public static class Buffer extends StructBuffer<SDL_TextEditingCandidatesEvent, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@code padding1} field. */
        @NativeType("Uint8")
        public byte padding1() { return SDL_TextEditingCandidatesEvent.npadding1(address()); }
        /** @return the value of the {@code padding2} field. */
        @NativeType("Uint8")
        public byte padding2() { return SDL_TextEditingCandidatesEvent.npadding2(address()); }
        /** @return the value of the {@code padding3} field. */
        @NativeType("Uint8")
        public byte padding3() { return SDL_TextEditingCandidatesEvent.npadding3(address()); }
        ...
        /** Sets the specified value to the {@code padding2} field. */
        public SDL_TextEditingCandidatesEvent.Buffer padding2(@NativeType("Uint8") byte value) { SDL_TextEditingCandidatesEvent.npadding2(address(), value); return this; }
        /** Sets the specified value to the {@code padding3} field. */
        public SDL_TextEditingCandidatesEvent.Buffer padding3(@NativeType("Uint8") byte value) { SDL_TextEditingCandidatesEvent.npadding3(address(), value); return this; }
