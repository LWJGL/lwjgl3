...
public class SDL_JoyHatEvent extends Struct<SDL_JoyHatEvent> implements NativeResource {
    ...
    public SDL_JoyHatEvent padding1(@NativeType("Uint8") byte value) { npadding1(address(), value); return this; }
    /** Sets the specified value to the {@code padding2} field. */
    public SDL_JoyHatEvent padding2(@NativeType("Uint8") byte value) { npadding2(address(), value); return this; }
    ...
    public static class Buffer extends StructBuffer<SDL_JoyHatEvent, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@code padding1} field. */
        @NativeType("Uint8")
        public byte padding1() { return SDL_JoyHatEvent.npadding1(address()); }
        /** @return the value of the {@code padding2} field. */
        @NativeType("Uint8")
        public byte padding2() { return SDL_JoyHatEvent.npadding2(address()); }
        ...
        /** Sets the specified value to the {@code padding1} field. */
        public SDL_JoyHatEvent.Buffer padding1(@NativeType("Uint8") byte value) { SDL_JoyHatEvent.npadding1(address(), value); return this; }
        /** Sets the specified value to the {@code padding2} field. */
        public SDL_JoyHatEvent.Buffer padding2(@NativeType("Uint8") byte value) { SDL_JoyHatEvent.npadding2(address(), value); return this; }
