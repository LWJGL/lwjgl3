...
public class SDL_GamepadDeviceEvent extends Struct<SDL_GamepadDeviceEvent> implements NativeResource {
    ...
    public SDL_GamepadDeviceEvent reserved(@NativeType("Uint32") int value) { nreserved(address(), value); return this; }
    ...
    public static class Buffer extends StructBuffer<SDL_GamepadDeviceEvent, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@code reserved} field. */
        @NativeType("Uint32")
        public int reserved() { return SDL_GamepadDeviceEvent.nreserved(address()); }
        /** @return the value of the {@code timestamp} field. */
        @NativeType("Uint64")
        ...
        /** Sets the specified value to the {@code reserved} field. */
        public SDL_GamepadDeviceEvent.Buffer reserved(@NativeType("Uint32") int value) { SDL_GamepadDeviceEvent.nreserved(address(), value); return this; }
        /** Sets the specified value to the {@code timestamp} field. */
