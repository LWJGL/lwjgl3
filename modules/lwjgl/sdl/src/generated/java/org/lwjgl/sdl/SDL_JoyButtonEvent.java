...
public class SDL_JoyButtonEvent extends Struct<SDL_JoyButtonEvent> implements NativeResource {
    ...
    public SDL_JoyButtonEvent padding2(@NativeType("Uint8") byte value) { npadding2(address(), value); return this; }
    ...
    public static class Buffer extends StructBuffer<SDL_JoyButtonEvent, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@code padding1} field. */
        @NativeType("Uint8")
        public byte padding1() { return SDL_JoyButtonEvent.npadding1(address()); }
        /** @return the value of the {@code padding2} field. */
        @NativeType("Uint8")
        public byte padding2() { return SDL_JoyButtonEvent.npadding2(address()); }
        ...
        /** Sets the specified value to the {@code padding2} field. */
        public SDL_JoyButtonEvent.Buffer padding2(@NativeType("Uint8") byte value) { SDL_JoyButtonEvent.npadding2(address(), value); return this; }
