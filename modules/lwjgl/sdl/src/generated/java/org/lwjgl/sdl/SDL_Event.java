...
public class SDL_Event extends Struct<SDL_Event> implements NativeResource {
    ...
    public SDL_Event padding(@NativeType("Uint8[128]") ByteBuffer value) { npadding(address(), value); return this; }
    /** Sets the specified value at the specified index of the {@code padding} field. */
    public SDL_Event padding(int index, @NativeType("Uint8") byte value) { npadding(address(), index, value); return this; }
    ...
    public static class Buffer extends StructBuffer<SDL_Event, Buffer> implements NativeResource {
        ...
        /** @return a {@link ByteBuffer} view of the {@code padding} field. */
        @NativeType("Uint8[128]")
        public ByteBuffer padding() { return SDL_Event.npadding(address()); }
        /** @return the value at the specified index of the {@code padding} field. */
        @NativeType("Uint8")
        public byte padding(int index) { return SDL_Event.npadding(address(), index); }
        ...
        /** Copies the specified {@link ByteBuffer} to the {@code padding} field. */
        public SDL_Event.Buffer padding(@NativeType("Uint8[128]") ByteBuffer value) { SDL_Event.npadding(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code padding} field. */
        public SDL_Event.Buffer padding(int index, @NativeType("Uint8") byte value) { SDL_Event.npadding(address(), index, value); return this; }
