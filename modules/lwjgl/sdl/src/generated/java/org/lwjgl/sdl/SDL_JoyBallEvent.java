...
public class SDL_JoyBallEvent extends Struct<SDL_JoyBallEvent> implements NativeResource {
    ...
    public SDL_JoyBallEvent padding1(@NativeType("Uint8") byte value) { npadding1(address(), value); return this; }
    /** Sets the specified value to the {@code padding2} field. */
    public SDL_JoyBallEvent padding2(@NativeType("Uint8") byte value) { npadding2(address(), value); return this; }
    /** Sets the specified value to the {@code padding3} field. */
    public SDL_JoyBallEvent padding3(@NativeType("Uint8") byte value) { npadding3(address(), value); return this; }
    ...
    public static class Buffer extends StructBuffer<SDL_JoyBallEvent, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@code padding1} field. */
        @NativeType("Uint8")
        public byte padding1() { return SDL_JoyBallEvent.npadding1(address()); }
        /** @return the value of the {@code padding2} field. */
        @NativeType("Uint8")
        public byte padding2() { return SDL_JoyBallEvent.npadding2(address()); }
        /** @return the value of the {@code padding3} field. */
        @NativeType("Uint8")
        public byte padding3() { return SDL_JoyBallEvent.npadding3(address()); }
        /** @return the value of the {@code xrel} field. */
        @NativeType("Sint16")
        ...
        /** Sets the specified value to the {@code padding1} field. */
        public SDL_JoyBallEvent.Buffer padding1(@NativeType("Uint8") byte value) { SDL_JoyBallEvent.npadding1(address(), value); return this; }
        /** Sets the specified value to the {@code padding2} field. */
        public SDL_JoyBallEvent.Buffer padding2(@NativeType("Uint8") byte value) { SDL_JoyBallEvent.npadding2(address(), value); return this; }
        /** Sets the specified value to the {@code padding3} field. */
        public SDL_JoyBallEvent.Buffer padding3(@NativeType("Uint8") byte value) { SDL_JoyBallEvent.npadding3(address(), value); return this; }
        /** Sets the specified value to the {@code xrel} field. */
