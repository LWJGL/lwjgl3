...
public class SDL_StorageInterface extends Struct<SDL_StorageInterface> implements NativeResource {
    ...
    public SDL_StorageInterfaceSpaceRemainingCallback space_remaining() { return nspace_remaining(address()); }
    ...
    public static SDL_StorageInterfaceCloseCallback nclose$(long struct) { return SDL_StorageInterfaceCloseCallback.create(memGetAddress(struct + SDL_StorageInterface.CLOSE)); }
    /** Unsafe version of {@link #ready}. */
    public static SDL_StorageInterfaceReadyCallback nready(long struct) { return SDL_StorageInterfaceReadyCallback.create(memGetAddress(struct + SDL_StorageInterface.READY)); }
    /** Unsafe version of {@link #enumerate}. */
    public static SDL_StorageInterfaceEnumerateCallback nenumerate(long struct) { return SDL_StorageInterfaceEnumerateCallback.create(memGetAddress(struct + SDL_StorageInterface.ENUMERATE)); }
    /** Unsafe version of {@link #info}. */
    public static SDL_StorageInterfaceInfoCallback ninfo(long struct) { return SDL_StorageInterfaceInfoCallback.create(memGetAddress(struct + SDL_StorageInterface.INFO)); }
    /** Unsafe version of {@link #read_file}. */
    public static SDL_StorageInterfaceReadFileCallback nread_file(long struct) { return SDL_StorageInterfaceReadFileCallback.create(memGetAddress(struct + SDL_StorageInterface.READ_FILE)); }
    /** Unsafe version of {@link #write_file}. */
    public static SDL_StorageInterfaceWriteFileCallback nwrite_file(long struct) { return SDL_StorageInterfaceWriteFileCallback.create(memGetAddress(struct + SDL_StorageInterface.WRITE_FILE)); }
    /** Unsafe version of {@link #mkdir}. */
    public static SDL_StorageInterfaceMkdirCallback nmkdir(long struct) { return SDL_StorageInterfaceMkdirCallback.create(memGetAddress(struct + SDL_StorageInterface.MKDIR)); }
    /** Unsafe version of {@link #remove}. */
    public static SDL_StorageInterfaceRemoveCallback nremove(long struct) { return SDL_StorageInterfaceRemoveCallback.create(memGetAddress(struct + SDL_StorageInterface.REMOVE)); }
    /** Unsafe version of {@link #rename}. */
    public static SDL_StorageInterfaceRenameCallback nrename(long struct) { return SDL_StorageInterfaceRenameCallback.create(memGetAddress(struct + SDL_StorageInterface.RENAME)); }
    /** Unsafe version of {@link #copy}. */
    public static SDL_StorageInterfaceCopyCallback ncopy(long struct) { return SDL_StorageInterfaceCopyCallback.create(memGetAddress(struct + SDL_StorageInterface.COPY)); }
    /** Unsafe version of {@link #space_remaining}. */
    public static SDL_StorageInterfaceSpaceRemainingCallback nspace_remaining(long struct) { return SDL_StorageInterfaceSpaceRemainingCallback.create(memGetAddress(struct + SDL_StorageInterface.SPACE_REMAINING)); }
    ...
    public static void nclose$(long struct, SDL_StorageInterfaceCloseCallbackI value) { memPutAddress(struct + SDL_StorageInterface.CLOSE, value.address()); }
    /** Unsafe version of {@link #ready(SDL_StorageInterfaceReadyCallbackI) ready}. */
    public static void nready(long struct, SDL_StorageInterfaceReadyCallbackI value) { memPutAddress(struct + SDL_StorageInterface.READY, value.address()); }
    /** Unsafe version of {@link #enumerate(SDL_StorageInterfaceEnumerateCallbackI) enumerate}. */
    public static void nenumerate(long struct, SDL_StorageInterfaceEnumerateCallbackI value) { memPutAddress(struct + SDL_StorageInterface.ENUMERATE, value.address()); }
    /** Unsafe version of {@link #info(SDL_StorageInterfaceInfoCallbackI) info}. */
    public static void ninfo(long struct, SDL_StorageInterfaceInfoCallbackI value) { memPutAddress(struct + SDL_StorageInterface.INFO, value.address()); }
    /** Unsafe version of {@link #read_file(SDL_StorageInterfaceReadFileCallbackI) read_file}. */
    public static void nread_file(long struct, SDL_StorageInterfaceReadFileCallbackI value) { memPutAddress(struct + SDL_StorageInterface.READ_FILE, value.address()); }
    /** Unsafe version of {@link #write_file(SDL_StorageInterfaceWriteFileCallbackI) write_file}. */
    public static void nwrite_file(long struct, SDL_StorageInterfaceWriteFileCallbackI value) { memPutAddress(struct + SDL_StorageInterface.WRITE_FILE, value.address()); }
    /** Unsafe version of {@link #mkdir(SDL_StorageInterfaceMkdirCallbackI) mkdir}. */
    public static void nmkdir(long struct, SDL_StorageInterfaceMkdirCallbackI value) { memPutAddress(struct + SDL_StorageInterface.MKDIR, value.address()); }
    /** Unsafe version of {@link #remove(SDL_StorageInterfaceRemoveCallbackI) remove}. */
    public static void nremove(long struct, SDL_StorageInterfaceRemoveCallbackI value) { memPutAddress(struct + SDL_StorageInterface.REMOVE, value.address()); }
    /** Unsafe version of {@link #rename(SDL_StorageInterfaceRenameCallbackI) rename}. */
    public static void nrename(long struct, SDL_StorageInterfaceRenameCallbackI value) { memPutAddress(struct + SDL_StorageInterface.RENAME, value.address()); }
    /** Unsafe version of {@link #copy(SDL_StorageInterfaceCopyCallbackI) copy}. */
    public static void ncopy(long struct, SDL_StorageInterfaceCopyCallbackI value) { memPutAddress(struct + SDL_StorageInterface.COPY, value.address()); }
    /** Unsafe version of {@link #space_remaining(SDL_StorageInterfaceSpaceRemainingCallbackI) space_remaining}. */
    public static void nspace_remaining(long struct, SDL_StorageInterfaceSpaceRemainingCallbackI value) { memPutAddress(struct + SDL_StorageInterface.SPACE_REMAINING, value.address()); }
    ...
    public static void validate(long struct) {
        check(memGetAddress(struct + SDL_StorageInterface.CLOSE));
        check(memGetAddress(struct + SDL_StorageInterface.READY));
        check(memGetAddress(struct + SDL_StorageInterface.ENUMERATE));
        check(memGetAddress(struct + SDL_StorageInterface.INFO));
        check(memGetAddress(struct + SDL_StorageInterface.READ_FILE));
        check(memGetAddress(struct + SDL_StorageInterface.WRITE_FILE));
        check(memGetAddress(struct + SDL_StorageInterface.MKDIR));
        check(memGetAddress(struct + SDL_StorageInterface.REMOVE));
        check(memGetAddress(struct + SDL_StorageInterface.RENAME));
        check(memGetAddress(struct + SDL_StorageInterface.COPY));
        check(memGetAddress(struct + SDL_StorageInterface.SPACE_REMAINING));
    }

    /** Clears the structure and initializes the version field like the native macro {@code SDL_INIT_INTERFACE} */
    public SDL_StorageInterface SDL_INIT_INTERFACE() {
        clear();
        version(sizeof());
        return this;
    }
    ...
    public static class Buffer extends StructBuffer<SDL_StorageInterface, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@code space_remaining} field. */
        @NativeType("Uint64 (*) (void *)")
        public SDL_StorageInterfaceSpaceRemainingCallback space_remaining() { return SDL_StorageInterface.nspace_remaining(address()); }
