...
public class SDL_MouseButtonEvent extends Struct<SDL_MouseButtonEvent> implements NativeResource {
    ...
    @NativeType("Uint8")
    public byte padding() { return npadding(address()); }
    ...
    public SDL_MouseButtonEvent padding(@NativeType("Uint8") byte value) { npadding(address(), value); return this; }
    ...
    /** Unsafe version of {@link #padding(byte) padding}. */
    ...
    public static class Buffer extends StructBuffer<SDL_MouseButtonEvent, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@code padding} field. */
        @NativeType("Uint8")
        public byte padding() { return SDL_MouseButtonEvent.npadding(address()); }
        /** @return the value of the {@code x} field. */
        ...
        /** Sets the specified value to the {@code padding} field. */
        public SDL_MouseButtonEvent.Buffer padding(@NativeType("Uint8") byte value) { SDL_MouseButtonEvent.npadding(address(), value); return this; }
        /** Sets the specified value to the {@code x} field. */
