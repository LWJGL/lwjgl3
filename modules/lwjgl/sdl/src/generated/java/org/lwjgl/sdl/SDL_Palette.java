...
public class SDL_Palette extends Struct<SDL_Palette> implements NativeResource {
    ...
    /** Sets the address of the specified {@link SDL_Color.Buffer} to the {@code colors} field. */
    public SDL_Palette colors(@NativeType("SDL_Color *") SDL_Color.Buffer value) { ncolors(address(), value); return this; }
    /** Sets the specified value to the {@code version} field. */
    public SDL_Palette version(@NativeType("Uint32") int value) { nversion(address(), value); return this; }
    /** Sets the specified value to the {@code refcount} field. */
    public SDL_Palette refcount(int value) { nrefcount(address(), value); return this; }

    /** Initializes this struct with the specified values. */
    public SDL_Palette set(
        SDL_Color.Buffer colors,
        int version,
        int refcount
    ) {
        colors(colors);
     ...
     * @return this struct
     */
    public SDL_Palette set(SDL_Palette src) {
    ...
    /** Sets the specified value to the {@code ncolors} field of the specified {@code struct}. */
    public static void nncolors(long struct, int value) { memPutInt(struct + SDL_Palette.NCOLORS, value); }
    /** Unsafe version of {@link #colors(SDL_Color.Buffer) colors}. */
    public static void ncolors(long struct, SDL_Color.Buffer value) { memPutAddress(struct + SDL_Palette.COLORS, value.address()); nncolors(struct, value.remaining()); }
    /** Unsafe version of {@link #version(int) version}. */
    public static void nversion(long struct, int value) { memPutInt(struct + SDL_Palette.VERSION, value); }
    /** Unsafe version of {@link #refcount(int) refcount}. */
    public static void nrefcount(long struct, int value) { memPutInt(struct + SDL_Palette.REFCOUNT, value); }
    ...
    public static void validate(long struct) {
        check(memGetAddress(struct + SDL_Palette.COLORS));
    }
    ...
    public static class Buffer extends StructBuffer<SDL_Palette, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@code version} field. */
        @NativeType("Uint32")
        public int version() { return SDL_Palette.nversion(address()); }
        /** @return the value of the {@code refcount} field. */
        public int refcount() { return SDL_Palette.nrefcount(address()); }

        /** Sets the address of the specified {@link SDL_Color.Buffer} to the {@code colors} field. */
        public SDL_Palette.Buffer colors(@NativeType("SDL_Color *") SDL_Color.Buffer value) { SDL_Palette.ncolors(address(), value); return this; }
        /** Sets the specified value to the {@code version} field. */
        public SDL_Palette.Buffer version(@NativeType("Uint32") int value) { SDL_Palette.nversion(address(), value); return this; }
        /** Sets the specified value to the {@code refcount} field. */
        public SDL_Palette.Buffer refcount(int value) { SDL_Palette.nrefcount(address(), value); return this; }
