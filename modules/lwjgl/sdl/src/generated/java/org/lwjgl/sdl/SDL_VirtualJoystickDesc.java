...
public class SDL_VirtualJoystickDesc extends Struct<SDL_VirtualJoystickDesc> implements NativeResource {
    ...
    /** @return a {@link ShortBuffer} view of the {@code padding2} field. */
    @NativeType("Uint16[2]")
    public ShortBuffer padding2() { return npadding2(address()); }
    /** @return the value at the specified index of the {@code padding2} field. */
    @NativeType("Uint16")
    public short padding2(int index) { return npadding2(address(), index); }
    ...
    public SDL_VirtualJoystickTouchpadDesc.Buffer touchpads() { return ntouchpads(address()); }
    ...
    public SDL_VirtualJoystickSensorDesc.Buffer sensors() { return nsensors(address()); }
    /** @return the value of the {@code userdata} field. */
    @NativeType("void *")
    public long userdata() { return nuserdata(address()); }
    /** @return the value of the {@code Update} field. */
    @NativeType("void (*) (void *)")
    public SDL_VirtualJoystickDescUpdateCallback Update() { return nUpdate(address()); }
    ...
    @NativeType("void (*) (void *)")
    public SDL_VirtualJoystickDescCleanupCallback Cleanup() { return nCleanup(address()); }
    ...
    public SDL_VirtualJoystickDesc padding(@NativeType("Uint16") short value) { npadding(address(), value); return this; }
    ...
    /** Copies the specified {@link ShortBuffer} to the {@code padding2} field. */
    public SDL_VirtualJoystickDesc padding2(@NativeType("Uint16[2]") ShortBuffer value) { npadding2(address(), value); return this; }
    /** Sets the specified value at the specified index of the {@code padding2} field. */
    public SDL_VirtualJoystickDesc padding2(int index, @NativeType("Uint16") short value) { npadding2(address(), index, value); return this; }
    ...
    public SDL_VirtualJoystickDesc touchpads(@NativeType("SDL_VirtualJoystickTouchpadDesc const *") SDL_VirtualJoystickTouchpadDesc.Buffer value) { ntouchpads(address(), value); return this; }
    /** Sets the address of the specified {@link SDL_VirtualJoystickSensorDesc.Buffer} to the {@code sensors} field. */
    public SDL_VirtualJoystickDesc sensors(@NativeType("SDL_VirtualJoystickSensorDesc const *") SDL_VirtualJoystickSensorDesc.Buffer value) { nsensors(address(), value); return this; }
    ...
    public SDL_VirtualJoystickDesc Update(@NativeType("void (*) (void *)") SDL_VirtualJoystickDescUpdateCallbackI value) { nUpdate(address(), value); return this; }
    ...
    public SDL_VirtualJoystickDesc set(
        ...
        short nballs,
        short nhats,
        ShortBuffer padding2,
        int button_mask,
        int axis_mask,
        ByteBuffer name,
        SDL_VirtualJoystickTouchpadDesc.Buffer touchpads,
        SDL_VirtualJoystickSensorDesc.Buffer sensors,
        long userdata,
        SDL_VirtualJoystickDescUpdateCallbackI Update,
        SDL_VirtualJoystickDescSetPlayerIndexCallbackI SetPlayerIndex,
        SDL_VirtualJoystickDescRumbleCallbackI Rumble,
        SDL_VirtualJoystickDescRumbleTriggersCallbackI RumbleTriggers,
        SDL_VirtualJoystickDescSetLEDCallbackI SetLED,
        SDL_VirtualJoystickDescSendEffectCallbackI SendEffect,
        SDL_VirtualJoystickDescSetSensorsEnabledCallbackI SetSensorsEnabled,
        SDL_VirtualJoystickDescCleanupCallbackI Cleanup
    ) {
        version(version);
        type(type);
        padding(padding);
    ...
    /** Unsafe version of {@link #padding2(int) padding2}. */
    ...
    public static SDL_VirtualJoystickTouchpadDesc.Buffer ntouchpads(long struct) { return SDL_VirtualJoystickTouchpadDesc.create(memGetAddress(struct + SDL_VirtualJoystickDesc.TOUCHPADS), Short.toUnsignedInt(nntouchpads(struct))); }
    /** Unsafe version of {@link #sensors}. */
    public static SDL_VirtualJoystickSensorDesc.Buffer nsensors(long struct) { return SDL_VirtualJoystickSensorDesc.create(memGetAddress(struct + SDL_VirtualJoystickDesc.SENSORS), Short.toUnsignedInt(nnsensors(struct))); }
    ...
    public static SDL_VirtualJoystickDescUpdateCallback nUpdate(long struct) { return SDL_VirtualJoystickDescUpdateCallback.create(memGetAddress(struct + SDL_VirtualJoystickDesc.UPDATE)); }
    /** Unsafe version of {@link #SetPlayerIndex}. */
    public static SDL_VirtualJoystickDescSetPlayerIndexCallback nSetPlayerIndex(long struct) { return SDL_VirtualJoystickDescSetPlayerIndexCallback.create(memGetAddress(struct + SDL_VirtualJoystickDesc.SETPLAYERINDEX)); }
    /** Unsafe version of {@link #Rumble}. */
    public static SDL_VirtualJoystickDescRumbleCallback nRumble(long struct) { return SDL_VirtualJoystickDescRumbleCallback.create(memGetAddress(struct + SDL_VirtualJoystickDesc.RUMBLE)); }
    /** Unsafe version of {@link #RumbleTriggers}. */
    public static SDL_VirtualJoystickDescRumbleTriggersCallback nRumbleTriggers(long struct) { return SDL_VirtualJoystickDescRumbleTriggersCallback.create(memGetAddress(struct + SDL_VirtualJoystickDesc.RUMBLETRIGGERS)); }
    /** Unsafe version of {@link #SetLED}. */
    public static SDL_VirtualJoystickDescSetLEDCallback nSetLED(long struct) { return SDL_VirtualJoystickDescSetLEDCallback.create(memGetAddress(struct + SDL_VirtualJoystickDesc.SETLED)); }
    /** Unsafe version of {@link #SendEffect}. */
    public static SDL_VirtualJoystickDescSendEffectCallback nSendEffect(long struct) { return SDL_VirtualJoystickDescSendEffectCallback.create(memGetAddress(struct + SDL_VirtualJoystickDesc.SENDEFFECT)); }
    /** Unsafe version of {@link #SetSensorsEnabled}. */
    public static SDL_VirtualJoystickDescSetSensorsEnabledCallback nSetSensorsEnabled(long struct) { return SDL_VirtualJoystickDescSetSensorsEnabledCallback.create(memGetAddress(struct + SDL_VirtualJoystickDesc.SETSENSORSENABLED)); }
    /** Unsafe version of {@link #Cleanup}. */
    public static SDL_VirtualJoystickDescCleanupCallback nCleanup(long struct) { return SDL_VirtualJoystickDescCleanupCallback.create(memGetAddress(struct + SDL_VirtualJoystickDesc.CLEANUP)); }
    ...
    /** Unsafe version of {@link #padding(short) padding}. */
    ...
    /** Unsafe version of {@link #padding2(ShortBuffer) padding2}. */
    ...
    /** Unsafe version of {@link #padding2(int, short) padding2}. */
    ...
    public static void ntouchpads(long struct, SDL_VirtualJoystickTouchpadDesc.Buffer value) { memPutAddress(struct + SDL_VirtualJoystickDesc.TOUCHPADS, value.address()); nntouchpads(struct, (short)value.remaining()); }
    /** Unsafe version of {@link #sensors(SDL_VirtualJoystickSensorDesc.Buffer) sensors}. */
    public static void nsensors(long struct, SDL_VirtualJoystickSensorDesc.Buffer value) { memPutAddress(struct + SDL_VirtualJoystickDesc.SENSORS, value.address()); nnsensors(struct, (short)value.remaining()); }
    ...
    public static void nUpdate(long struct, SDL_VirtualJoystickDescUpdateCallbackI value) { memPutAddress(struct + SDL_VirtualJoystickDesc.UPDATE, value.address()); }
    /** Unsafe version of {@link #SetPlayerIndex(SDL_VirtualJoystickDescSetPlayerIndexCallbackI) SetPlayerIndex}. */
    public static void nSetPlayerIndex(long struct, SDL_VirtualJoystickDescSetPlayerIndexCallbackI value) { memPutAddress(struct + SDL_VirtualJoystickDesc.SETPLAYERINDEX, value.address()); }
    /** Unsafe version of {@link #Rumble(SDL_VirtualJoystickDescRumbleCallbackI) Rumble}. */
    public static void nRumble(long struct, SDL_VirtualJoystickDescRumbleCallbackI value) { memPutAddress(struct + SDL_VirtualJoystickDesc.RUMBLE, value.address()); }
    /** Unsafe version of {@link #RumbleTriggers(SDL_VirtualJoystickDescRumbleTriggersCallbackI) RumbleTriggers}. */
    public static void nRumbleTriggers(long struct, SDL_VirtualJoystickDescRumbleTriggersCallbackI value) { memPutAddress(struct + SDL_VirtualJoystickDesc.RUMBLETRIGGERS, value.address()); }
    /** Unsafe version of {@link #SetLED(SDL_VirtualJoystickDescSetLEDCallbackI) SetLED}. */
    public static void nSetLED(long struct, SDL_VirtualJoystickDescSetLEDCallbackI value) { memPutAddress(struct + SDL_VirtualJoystickDesc.SETLED, value.address()); }
    /** Unsafe version of {@link #SendEffect(SDL_VirtualJoystickDescSendEffectCallbackI) SendEffect}. */
    public static void nSendEffect(long struct, SDL_VirtualJoystickDescSendEffectCallbackI value) { memPutAddress(struct + SDL_VirtualJoystickDesc.SENDEFFECT, value.address()); }
    /** Unsafe version of {@link #SetSensorsEnabled(SDL_VirtualJoystickDescSetSensorsEnabledCallbackI) SetSensorsEnabled}. */
    public static void nSetSensorsEnabled(long struct, SDL_VirtualJoystickDescSetSensorsEnabledCallbackI value) { memPutAddress(struct + SDL_VirtualJoystickDesc.SETSENSORSENABLED, value.address()); }
    /** Unsafe version of {@link #Cleanup(SDL_VirtualJoystickDescCleanupCallbackI) Cleanup}. */
    public static void nCleanup(long struct, SDL_VirtualJoystickDescCleanupCallbackI value) { memPutAddress(struct + SDL_VirtualJoystickDesc.CLEANUP, value.address()); }
    ...
    public static void validate(long struct) {
        ...
        check(memGetAddress(struct + SDL_VirtualJoystickDesc.TOUCHPADS));
        check(memGetAddress(struct + SDL_VirtualJoystickDesc.SENSORS));
        check(memGetAddress(struct + SDL_VirtualJoystickDesc.UPDATE));
        check(memGetAddress(struct + SDL_VirtualJoystickDesc.SETPLAYERINDEX));
        check(memGetAddress(struct + SDL_VirtualJoystickDesc.RUMBLE));
        check(memGetAddress(struct + SDL_VirtualJoystickDesc.RUMBLETRIGGERS));
        check(memGetAddress(struct + SDL_VirtualJoystickDesc.SETLED));
        check(memGetAddress(struct + SDL_VirtualJoystickDesc.SENDEFFECT));
        check(memGetAddress(struct + SDL_VirtualJoystickDesc.SETSENSORSENABLED));
        check(memGetAddress(struct + SDL_VirtualJoystickDesc.CLEANUP));
    }

    /** Clears the structure and initializes the version field like the native macro {@code SDL_INIT_INTERFACE} */
    public SDL_VirtualJoystickDesc SDL_INIT_INTERFACE() {
        clear();
        version(sizeof());
        return this;
    }
    ...
    public static class Buffer extends StructBuffer<SDL_VirtualJoystickDesc, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@code padding} field. */
        @NativeType("Uint16")
        public short padding() { return SDL_VirtualJoystickDesc.npadding(address()); }
        /** @return the value of the {@code vendor_id} field. */
        @NativeType("Uint16")
        ...
        /** @return a {@link ShortBuffer} view of the {@code padding2} field. */
        @NativeType("Uint16[2]")
        public ShortBuffer padding2() { return SDL_VirtualJoystickDesc.npadding2(address()); }
        /** @return the value at the specified index of the {@code padding2} field. */
        @NativeType("Uint16")
        public short padding2(int index) { return SDL_VirtualJoystickDesc.npadding2(address(), index); }
        /** @return the value of the {@code button_mask} field. */
        @NativeType("Uint32")
        ...
        /** @return a {@link SDL_VirtualJoystickTouchpadDesc.Buffer} view of the struct array pointed to by the {@code touchpads} field. */
        @NativeType("SDL_VirtualJoystickTouchpadDesc const *")
        public SDL_VirtualJoystickTouchpadDesc.Buffer touchpads() { return SDL_VirtualJoystickDesc.ntouchpads(address()); }
        /** @return a {@link SDL_VirtualJoystickSensorDesc.Buffer} view of the struct array pointed to by the {@code sensors} field. */
        @NativeType("SDL_VirtualJoystickSensorDesc const *")
        public SDL_VirtualJoystickSensorDesc.Buffer sensors() { return SDL_VirtualJoystickDesc.nsensors(address()); }
        /** @return the value of the {@code userdata} field. */
        @NativeType("void *")
        public long userdata() { return SDL_VirtualJoystickDesc.nuserdata(address()); }
        /** @return the value of the {@code Update} field. */
        @NativeType("void (*) (void *)")
        public SDL_VirtualJoystickDescUpdateCallback Update() { return SDL_VirtualJoystickDesc.nUpdate(address()); }
        /** @return the value of the {@code SetPlayerIndex} field. */
        @NativeType("void (*) (void *, int)")
        ...
        /** @return the value of the {@code Cleanup} field. */
        @NativeType("void (*) (void *)")
        public SDL_VirtualJoystickDescCleanupCallback Cleanup() { return SDL_VirtualJoystickDesc.nCleanup(address()); }
        ...
        /** Sets the specified value to the {@code padding} field. */
        public SDL_VirtualJoystickDesc.Buffer padding(@NativeType("Uint16") short value) { SDL_VirtualJoystickDesc.npadding(address(), value); return this; }
        /** Sets the specified value to the {@code vendor_id} field. */
        ...
        /** Copies the specified {@link ShortBuffer} to the {@code padding2} field. */
        public SDL_VirtualJoystickDesc.Buffer padding2(@NativeType("Uint16[2]") ShortBuffer value) { SDL_VirtualJoystickDesc.npadding2(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code padding2} field. */
        public SDL_VirtualJoystickDesc.Buffer padding2(int index, @NativeType("Uint16") short value) { SDL_VirtualJoystickDesc.npadding2(address(), index, value); return this; }
        /** Sets the specified value to the {@code button_mask} field. */
        ...
        /** Sets the address of the specified {@link SDL_VirtualJoystickTouchpadDesc.Buffer} to the {@code touchpads} field. */
        public SDL_VirtualJoystickDesc.Buffer touchpads(@NativeType("SDL_VirtualJoystickTouchpadDesc const *") SDL_VirtualJoystickTouchpadDesc.Buffer value) { SDL_VirtualJoystickDesc.ntouchpads(address(), value); return this; }
        /** Sets the address of the specified {@link SDL_VirtualJoystickSensorDesc.Buffer} to the {@code sensors} field. */
        public SDL_VirtualJoystickDesc.Buffer sensors(@NativeType("SDL_VirtualJoystickSensorDesc const *") SDL_VirtualJoystickSensorDesc.Buffer value) { SDL_VirtualJoystickDesc.nsensors(address(), value); return this; }
        /** Sets the specified value to the {@code userdata} field. */
        ...
        /** Sets the specified value to the {@code Update} field. */
        public SDL_VirtualJoystickDesc.Buffer Update(@NativeType("void (*) (void *)") SDL_VirtualJoystickDescUpdateCallbackI value) { SDL_VirtualJoystickDesc.nUpdate(address(), value); return this; }
        /** Sets the specified value to the {@code SetPlayerIndex} field. */
