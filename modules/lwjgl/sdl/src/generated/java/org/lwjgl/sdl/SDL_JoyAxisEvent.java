...
public class SDL_JoyAxisEvent extends Struct<SDL_JoyAxisEvent> implements NativeResource {
    ...
    public SDL_JoyAxisEvent padding1(@NativeType("Uint8") byte value) { npadding1(address(), value); return this; }
    /** Sets the specified value to the {@code padding2} field. */
    public SDL_JoyAxisEvent padding2(@NativeType("Uint8") byte value) { npadding2(address(), value); return this; }
    /** Sets the specified value to the {@code padding3} field. */
    public SDL_JoyAxisEvent padding3(@NativeType("Uint8") byte value) { npadding3(address(), value); return this; }
    ...
    public SDL_JoyAxisEvent padding4(@NativeType("Uint16") short value) { npadding4(address(), value); return this; }
    ...
    public static class Buffer extends StructBuffer<SDL_JoyAxisEvent, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@code padding1} field. */
        @NativeType("Uint8")
        public byte padding1() { return SDL_JoyAxisEvent.npadding1(address()); }
        /** @return the value of the {@code padding2} field. */
        @NativeType("Uint8")
        public byte padding2() { return SDL_JoyAxisEvent.npadding2(address()); }
        /** @return the value of the {@code padding3} field. */
        @NativeType("Uint8")
        public byte padding3() { return SDL_JoyAxisEvent.npadding3(address()); }
        /** @return the value of the {@code value} field. */
        @NativeType("Sint16")
        public short value() { return SDL_JoyAxisEvent.nvalue(address()); }
        /** @return the value of the {@code padding4} field. */
        @NativeType("Uint16")
        public short padding4() { return SDL_JoyAxisEvent.npadding4(address()); }
        ...
        /** Sets the specified value to the {@code padding1} field. */
        public SDL_JoyAxisEvent.Buffer padding1(@NativeType("Uint8") byte value) { SDL_JoyAxisEvent.npadding1(address(), value); return this; }
        /** Sets the specified value to the {@code padding2} field. */
        public SDL_JoyAxisEvent.Buffer padding2(@NativeType("Uint8") byte value) { SDL_JoyAxisEvent.npadding2(address(), value); return this; }
        /** Sets the specified value to the {@code padding3} field. */
        public SDL_JoyAxisEvent.Buffer padding3(@NativeType("Uint8") byte value) { SDL_JoyAxisEvent.npadding3(address(), value); return this; }
        /** Sets the specified value to the {@code value} field. */
        public SDL_JoyAxisEvent.Buffer value(@NativeType("Sint16") short value) { SDL_JoyAxisEvent.nvalue(address(), value); return this; }
        /** Sets the specified value to the {@code padding4} field. */
        public SDL_JoyAxisEvent.Buffer padding4(@NativeType("Uint16") short value) { SDL_JoyAxisEvent.npadding4(address(), value); return this; }
