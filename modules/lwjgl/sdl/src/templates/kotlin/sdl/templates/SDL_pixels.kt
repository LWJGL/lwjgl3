...
fun SDL_pixels() = SDL.apply {

    IntConstant("ALPHA_OPAQUE".."255")
    FloatConstant("ALPHA_OPAQUE_FLOAT"..1.0f)
    IntConstant("ALPHA_TRANSPARENT".."0")
    FloatConstant("ALPHA_TRANSPARENT_FLOAT"..0.0f)
    ...
    EnumConstant(
        ...
        "PIXELFORMAT_RGBA32".enum("SDL_PIXELFORMAT_ABGR8888"),
        "PIXELFORMAT_ARGB32".enum("SDL_PIXELFORMAT_BGRA8888"),
        "PIXELFORMAT_BGRA32".enum("SDL_PIXELFORMAT_ARGB8888"),
        "PIXELFORMAT_ABGR32".enum("SDL_PIXELFORMAT_RGBA8888"),
        "PIXELFORMAT_RGBX32".enum("SDL_PIXELFORMAT_XBGR8888"),
        "PIXELFORMAT_XRGB32".enum("SDL_PIXELFORMAT_BGRX8888"),
        "PIXELFORMAT_BGRX32".enum("SDL_PIXELFORMAT_XRGB8888"),
        "PIXELFORMAT_XBGR32".enum("SDL_PIXELFORMAT_RGBX8888")
    )
    ...
    Uint32(
        ...
        Check(1)..SDL_PixelFormatDetails.const.p("format"),
        nullable..Check(1)..SDL_Palette.const.p("palette"),
        Uint8("r"),
        Uint8("g"),
        Uint8("b")
    )
    ...
    macro(expression = "((1 << 28) | ((type) << 24) | ((order) << 20) | ((layout) << 16) | ((bits) << 8) | ((bytes) << 0))")..SDL_PixelFormat(
    ...
    macro(expression = "(SDL_ISPIXELFORMAT_FOURCC(format) ? ((((format) == SDL_PIXELFORMAT_YUY2) || ((format) == SDL_PIXELFORMAT_UYVY) || ((format) == SDL_PIXELFORMAT_YVYU) || ((format) == SDL_PIXELFORMAT_P010)) ? 2 : 1) : (((format) >> 0) & 0xFF))")..uint32_t(
        "SDL_BYTESPERPIXEL",
        SDL_PixelFormat("format"),
        noPrefix = true
    )
    ...
    "      (SDL_PIXELTYPE(format) == SDL_PIXELTYPE_INDEX8)))")..bool(
    ...
    "      (SDL_PIXELTYPE(format) == SDL_PIXELTYPE_PACKED32)))")..bool(
    ...
    "      (SDL_PIXELTYPE(format) == SDL_PIXELTYPE_ARRAYF32)))")..bool(
    ...
    "        (SDL_PIXELLAYOUT(format) == SDL_PACKEDLAYOUT_2101010)))")..bool(
    ...
    "       (SDL_PIXELORDER(format) == SDL_ARRAYORDER_BGRA))))")..bool(
    ...
    macro(expression = "(((cspace) >> 28) & 0x0F)")..SDL_ColorType(
        "SDL_COLORSPACETYPE",
        SDL_Colorspace("cspace"),
        noPrefix = true
    )
    macro(expression = "(((cspace) >> 24) & 0x0F)")..SDL_ColorRange(
        "SDL_COLORSPACERANGE",
        SDL_Colorspace("cspace"),
        noPrefix = true
    )
    macro(expression = "(((cspace) >> 20) & 0x0F)")..SDL_ChromaLocation(
        "SDL_COLORSPACECHROMA",
        SDL_Colorspace("cspace"),
        noPrefix = true
    )
    macro(expression = "(((cspace) >> 10) & 0x1F)")..SDL_ColorPrimaries(
        "SDL_COLORSPACEPRIMARIES",
        SDL_Colorspace("cspace"),
        noPrefix = true
    )
    macro(expression = "(((cspace) >> 5) & 0x1F)")..SDL_TransferCharacteristics(
        "SDL_COLORSPACETRANSFER",
        SDL_Colorspace("cspace"),
        noPrefix = true
    )
    macro(expression = "((cspace) & 0x1F)")..SDL_MatrixCoefficients(
