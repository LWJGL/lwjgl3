...
fun SDL_tray() = SDL.apply {

    IntConstant("TRAYENTRY_BUTTON".."0x00000001")
    IntConstant("TRAYENTRY_CHECKBOX".."0x00000002")
    IntConstant("TRAYENTRY_SUBMENU".."0x00000004")
    IntConstant("TRAYENTRY_DISABLED".."0x80000000")
    IntConstant("TRAYENTRY_CHECKED".."0x40000000")

    SDL_Tray.p(
        "CreateTray",

        nullable..Check(1)..SDL_Surface.p("icon"),
        charUTF8.const.p("tooltip")
    )
