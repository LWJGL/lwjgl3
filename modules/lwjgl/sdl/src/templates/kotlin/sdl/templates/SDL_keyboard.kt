...
fun SDL_keyboard() = SDL.apply {

    StringConstant("PROP_TEXTINPUT_TYPE_NUMBER".."SDL.textinput.type")
    StringConstant("PROP_TEXTINPUT_CAPITALIZATION_NUMBER".."SDL.textinput.capitalization")
    StringConstant("PROP_TEXTINPUT_AUTOCORRECT_BOOLEAN".."SDL.textinput.autocorrect")
    StringConstant("PROP_TEXTINPUT_MULTILINE_BOOLEAN".."SDL.textinput.multiline")
    StringConstant("PROP_TEXTINPUT_ANDROID_INPUTTYPE_NUMBER".."SDL.textinput.android.inputtype")
    ...
    bool(
        ...
        SDL_Window.p("window"),
        nullable..Check(1)..SDL_Rect.p("rect"),
