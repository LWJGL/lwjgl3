...
val SDL_DUMMY_ENUM = "SDL_DUMMY_ENUM".enumType
...
val SDL_Palette = struct(Module.SDL, "SDL_Palette") {
...
val SDL_PixelFormatDetails = struct(Module.SDL, "SDL_PixelFormatDetails") {
...
val SDL_IOStreamInterface = struct(Module.SDL, "SDL_IOStreamInterface") {
    ...
    public SDL_IOStreamInterface SDL_INIT_INTERFACE() {
        clear();
        version(sizeof());
        return this;
    }""")
...
val SDL_HintCallback = Module.SDL.callback {
    void(
        ...
        nullable..opaque_p("userdata"),
        charUTF8.const.p("name"),
        charUTF8.const.p("oldValue"),
        charUTF8.const.p("newValue"),
...
val SDL_VirtualJoystickDesc = struct(Module.SDL, "SDL_VirtualJoystickDesc") {
    ...
    Uint32("axis_mask")
    charUTF8.const.p("name")
    SDL_VirtualJoystickTouchpadDesc.const.p("touchpads")
    SDL_VirtualJoystickSensorDesc.const.p("sensors")
    nullable..opaque_p("userdata")
    Module.SDL.callback {
        void(
...
val SDL_Locale = struct(Module.SDL, "SDL_Locale") {
    char.const.p("language")
    nullable..char.const.p("country")
}
...
val SDL_HitTest = Module.SDL.callback {
    SDL_HitTestResult(
        ...
        SDL_Window.p("win"),
        Check(1)..SDL_Point.const.p("area"),
        nullable..opaque_p("data"),
