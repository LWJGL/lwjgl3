...
fun String.nativeClassSDL(templateName: String = this, prefix: String = "SDL_", postfix: String = "", init: (NativeClass.() -> Unit)? = null) =
    nativeClass(Module.SDL, templateName, prefix = prefix, prefixMethod = prefix, prefixTemplate = "SDL_", postfix = postfix, binding = SDL_BINDING_DELEGATE, init = init)
