...
val FB_color_space = "FBColorSpace".nativeClassXR("FB_color_space", type = "instance", postfix = "FB") {
    ...
    EnumConstant(
        ...
        <ul>
            ...
            <li>#COLOR_SPACE_REC2020_FB. Standard Rec. 2020 chromacities. This is the preferred color space for standardized color across all Oculus HMDs with D65 white point.</li>
