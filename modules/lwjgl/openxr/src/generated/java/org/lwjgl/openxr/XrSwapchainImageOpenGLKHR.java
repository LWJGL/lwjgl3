...
public class XrSwapchainImageOpenGLKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code XrSwapchainImageOpenGLKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrSwapchainImageOpenGLKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrSwapchainImageOpenGLKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrSwapchainImageOpenGLKHR callocStack() {
     ...
     */
    public static XrSwapchainImageOpenGLKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrSwapchainImageOpenGLKHR callocStack(MemoryStack stack) {
        return wrap(XrSwapchainImageOpenGLKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link XrSwapchainImageOpenGLKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrSwapchainImageOpenGLKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrSwapchainImageOpenGLKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrSwapchainImageOpenGLKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrSwapchainImageOpenGLKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrSwapchainImageOpenGLKHR.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static void nnext(long struct, long value) { memPutAddress(struct + XrSwapchainImageOpenGLKHR.NEXT, check(value)); }
    ...
    public static void validate(long struct) {
        check(memGetAddress(struct + XrSwapchainImageOpenGLKHR.NEXT));
    }
