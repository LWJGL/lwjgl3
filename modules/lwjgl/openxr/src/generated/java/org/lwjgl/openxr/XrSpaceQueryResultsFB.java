...
public class XrSpaceQueryResultsFB extends Struct implements NativeResource {
    ...
    public static XrSpaceQueryResultsFB malloc() {
        return wrap(XrSpaceQueryResultsFB.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrSpaceQueryResultsFB calloc() {
        return wrap(XrSpaceQueryResultsFB.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrSpaceQueryResultsFB create() {
        ...
        return wrap(XrSpaceQueryResultsFB.class, memAddress(container), container);
    }
    ...
    public static XrSpaceQueryResultsFB create(long address) {
        return wrap(XrSpaceQueryResultsFB.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrSpaceQueryResultsFB createSafe(long address) {
        return address == NULL ? null : wrap(XrSpaceQueryResultsFB.class, address);
    }
    ...
    public static XrSpaceQueryResultsFB malloc(MemoryStack stack) {
        return wrap(XrSpaceQueryResultsFB.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrSpaceQueryResultsFB calloc(MemoryStack stack) {
        return wrap(XrSpaceQueryResultsFB.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
