...
public class XrSwapchainImageVulkan2KHR extends XrSwapchainImageVulkanKHR {
    ...
    /** Returns a new {@code XrSwapchainImageVulkan2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrSwapchainImageVulkan2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrSwapchainImageVulkan2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrSwapchainImageVulkan2KHR callocStack() {
     ...
     */
    public static XrSwapchainImageVulkan2KHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrSwapchainImageVulkan2KHR callocStack(MemoryStack stack) {
        return wrap(XrSwapchainImageVulkan2KHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link XrSwapchainImageVulkan2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrSwapchainImageVulkan2KHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrSwapchainImageVulkan2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrSwapchainImageVulkan2KHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrSwapchainImageVulkan2KHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrSwapchainImageVulkan2KHR.Buffer callocStack(int capacity, MemoryStack stack) {
