...
public class XrPassthroughCreateInfoHTC extends Struct implements NativeResource {
    ...
    public static XrPassthroughCreateInfoHTC malloc() {
        return wrap(XrPassthroughCreateInfoHTC.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrPassthroughCreateInfoHTC calloc() {
        return wrap(XrPassthroughCreateInfoHTC.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrPassthroughCreateInfoHTC create() {
        ...
        return wrap(XrPassthroughCreateInfoHTC.class, memAddress(container), container);
    }
    ...
    public static XrPassthroughCreateInfoHTC create(long address) {
        return wrap(XrPassthroughCreateInfoHTC.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrPassthroughCreateInfoHTC createSafe(long address) {
        return address == NULL ? null : wrap(XrPassthroughCreateInfoHTC.class, address);
    }
    ...
    public static XrPassthroughCreateInfoHTC malloc(MemoryStack stack) {
        return wrap(XrPassthroughCreateInfoHTC.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrPassthroughCreateInfoHTC calloc(MemoryStack stack) {
        return wrap(XrPassthroughCreateInfoHTC.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
