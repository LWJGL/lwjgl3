...
public class XrSpaceUserCreateInfoFB extends Struct implements NativeResource {
    ...
    public static XrSpaceUserCreateInfoFB malloc() {
        return wrap(XrSpaceUserCreateInfoFB.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrSpaceUserCreateInfoFB calloc() {
        return wrap(XrSpaceUserCreateInfoFB.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrSpaceUserCreateInfoFB create() {
        ...
        return wrap(XrSpaceUserCreateInfoFB.class, memAddress(container), container);
    }
    ...
    public static XrSpaceUserCreateInfoFB create(long address) {
        return wrap(XrSpaceUserCreateInfoFB.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrSpaceUserCreateInfoFB createSafe(long address) {
        return address == NULL ? null : wrap(XrSpaceUserCreateInfoFB.class, address);
    }
    ...
    public static XrSpaceUserCreateInfoFB malloc(MemoryStack stack) {
        return wrap(XrSpaceUserCreateInfoFB.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrSpaceUserCreateInfoFB calloc(MemoryStack stack) {
        return wrap(XrSpaceUserCreateInfoFB.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
