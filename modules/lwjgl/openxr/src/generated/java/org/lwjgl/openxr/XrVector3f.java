...
public class XrVector3f extends Struct implements NativeResource {
    ...
    /** Returns a new {@code XrVector3f} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrVector3f mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrVector3f} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrVector3f callocStack() {
     ...
     */
    public static XrVector3f mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrVector3f callocStack(MemoryStack stack) {
        return wrap(XrVector3f.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link XrVector3f.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrVector3f.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrVector3f.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrVector3f.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrVector3f.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrVector3f.Buffer callocStack(int capacity, MemoryStack stack) {
