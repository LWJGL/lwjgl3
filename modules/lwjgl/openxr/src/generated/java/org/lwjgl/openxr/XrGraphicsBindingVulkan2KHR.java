...
public class XrGraphicsBindingVulkan2KHR extends XrGraphicsBindingVulkanKHR {
    ...
    /** Returns a new {@code XrGraphicsBindingVulkan2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrGraphicsBindingVulkan2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrGraphicsBindingVulkan2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrGraphicsBindingVulkan2KHR callocStack() {
     ...
     */
    public static XrGraphicsBindingVulkan2KHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrGraphicsBindingVulkan2KHR callocStack(MemoryStack stack) {
        return wrap(XrGraphicsBindingVulkan2KHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link XrGraphicsBindingVulkan2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrGraphicsBindingVulkan2KHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrGraphicsBindingVulkan2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrGraphicsBindingVulkan2KHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrGraphicsBindingVulkan2KHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrGraphicsBindingVulkan2KHR.Buffer callocStack(int capacity, MemoryStack stack) {
