...
public class XrOffset2Di extends Struct implements NativeResource {
    ...
    /** Returns a new {@code XrOffset2Di} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrOffset2Di mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrOffset2Di} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrOffset2Di callocStack() {
     ...
     */
    public static XrOffset2Di mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrOffset2Di callocStack(MemoryStack stack) {
        return wrap(XrOffset2Di.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link XrOffset2Di.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrOffset2Di.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrOffset2Di.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrOffset2Di.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrOffset2Di.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrOffset2Di.Buffer callocStack(int capacity, MemoryStack stack) {
