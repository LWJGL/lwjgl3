...
public class XrVector2f extends Struct implements NativeResource {
    ...
    /**
     * Returns a new {@link XrVector2f.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrVector2f.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrVector2f.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrVector2f.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrVector2f.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrVector2f.Buffer callocStack(int capacity, MemoryStack stack) {
