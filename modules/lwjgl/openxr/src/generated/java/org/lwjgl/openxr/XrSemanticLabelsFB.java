...
public class XrSemanticLabelsFB extends Struct implements NativeResource {
    ...
    public static XrSemanticLabelsFB malloc() {
        return wrap(XrSemanticLabelsFB.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrSemanticLabelsFB calloc() {
        return wrap(XrSemanticLabelsFB.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrSemanticLabelsFB create() {
        ...
        return wrap(XrSemanticLabelsFB.class, memAddress(container), container);
    }
    ...
    public static XrSemanticLabelsFB create(long address) {
        return wrap(XrSemanticLabelsFB.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrSemanticLabelsFB createSafe(long address) {
        return address == NULL ? null : wrap(XrSemanticLabelsFB.class, address);
    }
    ...
    public static XrSemanticLabelsFB malloc(MemoryStack stack) {
        return wrap(XrSemanticLabelsFB.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrSemanticLabelsFB calloc(MemoryStack stack) {
        return wrap(XrSemanticLabelsFB.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
