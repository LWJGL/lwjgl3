...
/** Wraps an {@code XrPassthroughFB} handle. */
public class XrPassthroughFB extends DispatchableHandle {

    private final XrSession session;

    /**
     * Creates an {@code XrPassthroughFB} using the specified native handle and {@code XrSession}.
     *
     * @param handle  the native {@code XrPassthroughFB} handle
     * @param session the {@code XrSession} from which {@code handle} was created
     */
    public XrPassthroughFB(long handle, XrSession session) {
