...
/** Wraps an {@code XrSceneObserverMSFT} handle. */
public class XrSceneObserverMSFT extends DispatchableHandle {

    private final XrSession session;

    /**
     * Creates an {@code XrSceneObserverMSFT} using the specified native handle and {@code XrSession}.
     *
     * @param handle  the native {@code XrSceneObserverMSFT} handle
