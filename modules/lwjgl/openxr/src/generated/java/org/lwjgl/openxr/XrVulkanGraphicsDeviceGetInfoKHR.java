...
public class XrVulkanGraphicsDeviceGetInfoKHR extends Struct implements NativeResource {
    ...
    /** Returns a new {@code XrVulkanGraphicsDeviceGetInfoKHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrVulkanGraphicsDeviceGetInfoKHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrVulkanGraphicsDeviceGetInfoKHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrVulkanGraphicsDeviceGetInfoKHR callocStack() {
     ...
     */
    public static XrVulkanGraphicsDeviceGetInfoKHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrVulkanGraphicsDeviceGetInfoKHR callocStack(MemoryStack stack) {
        return wrap(XrVulkanGraphicsDeviceGetInfoKHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link XrVulkanGraphicsDeviceGetInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrVulkanGraphicsDeviceGetInfoKHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrVulkanGraphicsDeviceGetInfoKHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrVulkanGraphicsDeviceGetInfoKHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrVulkanGraphicsDeviceGetInfoKHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrVulkanGraphicsDeviceGetInfoKHR.Buffer callocStack(int capacity, MemoryStack stack) {
