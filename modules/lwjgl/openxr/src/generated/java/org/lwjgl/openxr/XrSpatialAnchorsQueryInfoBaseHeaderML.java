...
public class XrSpatialAnchorsQueryInfoBaseHeaderML extends Struct<XrSpatialAnchorsQueryInfoBaseHeaderML> implements NativeResource {
    ...
    @Nullable
    public static XrSpatialAnchorsQueryInfoBaseHeaderML createSafe(long address) {
    ...
    @Nullable
    public static XrSpatialAnchorsQueryInfoBaseHeaderML.Buffer createSafe(long address, int capacity) {
    ...
    public static int ntype(long struct) { return UNSAFE.getInt(null, struct + XrSpatialAnchorsQueryInfoBaseHeaderML.TYPE); }
    /** Unsafe version of {@link #next}. */
    public static long nnext(long struct) { return memGetAddress(struct + XrSpatialAnchorsQueryInfoBaseHeaderML.NEXT); }

    /** Unsafe version of {@link #type(int) type}. */
    public static void ntype(long struct, int value) { UNSAFE.putInt(null, struct + XrSpatialAnchorsQueryInfoBaseHeaderML.TYPE, value); }
