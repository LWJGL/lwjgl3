...
/** Wraps an {@code XrSwapchain} handle. */
public class XrSwapchain extends DispatchableHandle {

    private final XrSession session;

    /**
     * Creates an {@code XrSwapchain} using the specified native handle and {@code XrSession}.
     *
     * @param handle  the native {@code XrSwapchain} handle
