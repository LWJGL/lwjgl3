...
public class XrEyeGazesFB extends Struct implements NativeResource {
    ...
    public static XrEyeGazesFB malloc() {
        return wrap(XrEyeGazesFB.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrEyeGazesFB malloc(MemoryStack stack) {
        return wrap(XrEyeGazesFB.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrEyeGazesFB calloc(MemoryStack stack) {
        return wrap(XrEyeGazesFB.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
