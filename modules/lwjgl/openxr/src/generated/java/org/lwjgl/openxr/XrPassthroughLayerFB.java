...
/** Wraps an {@code XrPassthroughLayerFB} handle. */
public class XrPassthroughLayerFB extends DispatchableHandle {

    private final XrSession session;

    /**
     * Creates an {@code XrPassthroughLayerFB} using the specified native handle and {@code XrSession}.
     *
     * @param handle  the native {@code XrPassthroughLayerFB} handle
     * @param session the {@code XrSession} from which {@code handle} was created
     */
    public XrPassthroughLayerFB(long handle, XrSession session) {
