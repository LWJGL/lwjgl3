...
public class XrSpatialGraphNodeBindingPropertiesGetInfoMSFT extends Struct implements NativeResource {
    ...
    public static XrSpatialGraphNodeBindingPropertiesGetInfoMSFT malloc() {
        return wrap(XrSpatialGraphNodeBindingPropertiesGetInfoMSFT.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrSpatialGraphNodeBindingPropertiesGetInfoMSFT calloc() {
        return wrap(XrSpatialGraphNodeBindingPropertiesGetInfoMSFT.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrSpatialGraphNodeBindingPropertiesGetInfoMSFT create() {
        ...
        return wrap(XrSpatialGraphNodeBindingPropertiesGetInfoMSFT.class, memAddress(container), container);
    }
    ...
    public static XrSpatialGraphNodeBindingPropertiesGetInfoMSFT create(long address) {
        return wrap(XrSpatialGraphNodeBindingPropertiesGetInfoMSFT.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrSpatialGraphNodeBindingPropertiesGetInfoMSFT createSafe(long address) {
        return address == NULL ? null : wrap(XrSpatialGraphNodeBindingPropertiesGetInfoMSFT.class, address);
    }
    ...
    public static XrSpatialGraphNodeBindingPropertiesGetInfoMSFT malloc(MemoryStack stack) {
        return wrap(XrSpatialGraphNodeBindingPropertiesGetInfoMSFT.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrSpatialGraphNodeBindingPropertiesGetInfoMSFT calloc(MemoryStack stack) {
        return wrap(XrSpatialGraphNodeBindingPropertiesGetInfoMSFT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
