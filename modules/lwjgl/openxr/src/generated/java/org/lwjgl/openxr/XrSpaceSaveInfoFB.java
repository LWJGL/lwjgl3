...
public class XrSpaceSaveInfoFB extends Struct implements NativeResource {
    ...
    public static XrSpaceSaveInfoFB malloc() {
        return wrap(XrSpaceSaveInfoFB.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrSpaceSaveInfoFB calloc() {
        return wrap(XrSpaceSaveInfoFB.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrSpaceSaveInfoFB create() {
        ...
        return wrap(XrSpaceSaveInfoFB.class, memAddress(container), container);
    }
    ...
    public static XrSpaceSaveInfoFB create(long address) {
        return wrap(XrSpaceSaveInfoFB.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrSpaceSaveInfoFB createSafe(long address) {
        return address == NULL ? null : wrap(XrSpaceSaveInfoFB.class, address);
    }
    ...
    public static XrSpaceSaveInfoFB malloc(MemoryStack stack) {
        return wrap(XrSpaceSaveInfoFB.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrSpaceSaveInfoFB calloc(MemoryStack stack) {
        return wrap(XrSpaceSaveInfoFB.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
