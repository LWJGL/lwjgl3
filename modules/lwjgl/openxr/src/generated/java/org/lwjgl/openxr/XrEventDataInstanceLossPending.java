...
public class XrEventDataInstanceLossPending extends Struct implements NativeResource {
    ...
    public static void nnext(long struct, long value) { memPutAddress(struct + XrEventDataInstanceLossPending.NEXT, check(value)); }
    ...
    public static void validate(long struct) {
        check(memGetAddress(struct + XrEventDataInstanceLossPending.NEXT));
    }
