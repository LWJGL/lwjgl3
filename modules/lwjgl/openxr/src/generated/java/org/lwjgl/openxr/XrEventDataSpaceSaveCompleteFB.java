 ...
 * }</code></pre>
 */
public class XrEventDataSpaceSaveCompleteFB extends Struct implements NativeResource {
    ...
    public static XrEventDataSpaceSaveCompleteFB malloc() {
        return wrap(XrEventDataSpaceSaveCompleteFB.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrEventDataSpaceSaveCompleteFB calloc() {
        return wrap(XrEventDataSpaceSaveCompleteFB.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrEventDataSpaceSaveCompleteFB create() {
        ...
        return wrap(XrEventDataSpaceSaveCompleteFB.class, memAddress(container), container);
    }
    ...
    public static XrEventDataSpaceSaveCompleteFB create(long address) {
        return wrap(XrEventDataSpaceSaveCompleteFB.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrEventDataSpaceSaveCompleteFB createSafe(long address) {
        return address == NULL ? null : wrap(XrEventDataSpaceSaveCompleteFB.class, address);
    }
    ...
    public static XrEventDataSpaceSaveCompleteFB create(XrEventDataBaseHeader value) {
        return wrap(XrEventDataSpaceSaveCompleteFB.class, value);
    }
    ...
    public static XrEventDataSpaceSaveCompleteFB malloc(MemoryStack stack) {
        return wrap(XrEventDataSpaceSaveCompleteFB.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrEventDataSpaceSaveCompleteFB calloc(MemoryStack stack) {
        return wrap(XrEventDataSpaceSaveCompleteFB.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
