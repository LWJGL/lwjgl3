...
public class XR10 {
     ...
     * 
     * <p>The following are common suffixes shared across many of the return codes:</p>
     * 
     * <ul>
     ...
     * <tr><td>{@link METAEnvironmentDepth#XR_ENVIRONMENT_DEPTH_NOT_AVAILABLE_META ENVIRONMENT_DEPTH_NOT_AVAILABLE_META}</td><td>Warning: The requested depth image is not yet available.  (Added by the {@link METAEnvironmentDepth XR_META_environment_depth} extension)</td></tr>
     * <tr><td>{@link MLFacialExpression#XR_ERROR_FACIAL_EXPRESSION_PERMISSION_DENIED_ML ERROR_FACIAL_EXPRESSION_PERMISSION_DENIED_ML}</td><td>Permission to track facial expressions was not granted  (Added by the {@link MLFacialExpression XR_ML_facial_expression} extension)</td></tr>
     * <tr><td>{@link METAColocationDiscovery#XR_COLOCATION_DISCOVERY_ALREADY_ADVERTISING_META COLOCATION_DISCOVERY_ALREADY_ADVERTISING_META}</td><td>Colocation advertisement has already been enabled  (Added by the {@link METAColocationDiscovery XR_META_colocation_discovery} extension)</td></tr>
     * <tr><td>{@link METAColocationDiscovery#XR_COLOCATION_DISCOVERY_ALREADY_DISCOVERING_META COLOCATION_DISCOVERY_ALREADY_DISCOVERING_META}</td><td>Colocation discovery has already been enabled  (Added by the {@link METAColocationDiscovery XR_META_colocation_discovery} extension)</td></tr>
     * </tbody>
     * </table>
     * 
     * <h5>Error Codes</h5>
     ...
     * <tr><td>{@link #XR_ERROR_SESSION_RUNNING ERROR_SESSION_RUNNING}</td><td>The session <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-running">is already running</a>.</td></tr>
     * <tr><td>{@link #XR_ERROR_SESSION_NOT_RUNNING ERROR_SESSION_NOT_RUNNING}</td><td>The session <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-not-running">is not yet running</a>.</td></tr>
     ...
     * <tr><td>{@link XR11#XR_ERROR_EXTENSION_DEPENDENCY_NOT_ENABLED ERROR_EXTENSION_DEPENDENCY_NOT_ENABLED}</td><td>One or more of the extensions being enabled has dependency on extensions that are not enabled.</td></tr>
     * <tr><td>{@link XR11#XR_ERROR_PERMISSION_INSUFFICIENT ERROR_PERMISSION_INSUFFICIENT}</td><td>Insufficient permissions. This error is included for use by vendor extensions. The precise definition of {@code XR_ERROR_PERMISSION_INSUFFICIENT} and actions possible by the developer or user to resolve it can vary by platform, extension or function. The developer should refer to the documentation of the function that returned the error code and extension it was defined.</td></tr>
     ...
     * <tr><td>{@link FBPassthrough#XR_ERROR_INSUFFICIENT_RESOURCES_PASSTHROUGH_FB ERROR_INSUFFICIENT_RESOURCES_PASSTHROUGH_FB}</td><td>There were insufficient resources available to perform an operation.  (Added by the {@link FBPassthrough XR_FB_passthrough} extension)</td></tr>
     ...
     * <tr><td>{@link MLSpatialAnchors#XR_ERROR_SPATIAL_ANCHORS_PERMISSION_DENIED_ML ERROR_SPATIAL_ANCHORS_PERMISSION_DENIED_ML}</td><td>The com.magicleap.permission.SPATIAL_ANCHOR permission was not granted.  (Added by the {@link MLSpatialAnchors XR_ML_spatial_anchors} extension)</td></tr>
     * <tr><td>{@link MLSpatialAnchors#XR_ERROR_SPATIAL_ANCHORS_NOT_LOCALIZED_ML ERROR_SPATIAL_ANCHORS_NOT_LOCALIZED_ML}</td><td>Operation failed because the system is not localized into a localization map.  (Added by the {@link MLSpatialAnchors XR_ML_spatial_anchors} extension)</td></tr>
     * <tr><td>{@link MLSpatialAnchors#XR_ERROR_SPATIAL_ANCHORS_OUT_OF_MAP_BOUNDS_ML ERROR_SPATIAL_ANCHORS_OUT_OF_MAP_BOUNDS_ML}</td><td>Operation failed because it is performed outside of the localization map.  (Added by the {@link MLSpatialAnchors XR_ML_spatial_anchors} extension)</td></tr>
     * <tr><td>{@link MLSpatialAnchors#XR_ERROR_SPATIAL_ANCHORS_SPACE_NOT_LOCATABLE_ML ERROR_SPATIAL_ANCHORS_SPACE_NOT_LOCATABLE_ML}</td><td>Operation failed because the space referenced cannot be located.  (Added by the {@link MLSpatialAnchors XR_ML_spatial_anchors} extension)</td></tr>
     * <tr><td>{@link MLSpatialAnchorsStorage#XR_ERROR_SPATIAL_ANCHORS_ANCHOR_NOT_FOUND_ML ERROR_SPATIAL_ANCHORS_ANCHOR_NOT_FOUND_ML}</td><td>The anchor references was not found.  (Added by the {@link MLSpatialAnchorsStorage XR_ML_spatial_anchors_storage} extension)</td></tr>
     ...
     * <tr><td>{@link EXTFuture#XR_ERROR_FUTURE_PENDING_EXT ERROR_FUTURE_PENDING_EXT}</td><td>Returned by completion function to indicate future is not ready.  (Added by the {@link EXTFuture XR_EXT_future} extension)</td></tr>
     * <tr><td>{@link EXTFuture#XR_ERROR_FUTURE_INVALID_EXT ERROR_FUTURE_INVALID_EXT}</td><td>Returned by completion function to indicate future is not valid.  (Added by the {@link EXTFuture XR_EXT_future} extension)</td></tr>
     * <tr><td>{@link MLSystemNotifications#XR_ERROR_SYSTEM_NOTIFICATION_PERMISSION_DENIED_ML ERROR_SYSTEM_NOTIFICATION_PERMISSION_DENIED_ML}</td><td>The com.magicleap.permission.SYSTEM_NOTIFICATION permission was not granted.  (Added by the {@link MLSystemNotifications XR_ML_system_notifications} extension)</td></tr>
     ...
     * <tr><td>{@link METAColocationDiscovery#XR_ERROR_COLOCATION_DISCOVERY_NETWORK_FAILED_META ERROR_COLOCATION_DISCOVERY_NETWORK_FAILED_META}</td><td>The network request failed.  (Added by the {@link METAColocationDiscovery XR_META_colocation_discovery} extension)</td></tr>
     * <tr><td>{@link METAColocationDiscovery#XR_ERROR_COLOCATION_DISCOVERY_NO_DISCOVERY_METHOD_META ERROR_COLOCATION_DISCOVERY_NO_DISCOVERY_METHOD_META}</td><td>The runtime does not have any methods available to perform discovery.  (Added by the {@link METAColocationDiscovery XR_META_colocation_discovery} extension)</td></tr>
     * <tr><td>{@link METASpatialEntityGroupSharing#XR_ERROR_SPACE_GROUP_NOT_FOUND_META ERROR_SPACE_GROUP_NOT_FOUND_META}</td><td>The group UUID was not be found within the runtime  (Added by the {@link METASpatialEntityGroupSharing XR_META_spatial_entity_group_sharing} extension)</td></tr>
     ...
     * <h5>Description</h5>
     * 
     * <p>Most structures containing {@code type} members have a value of {@code type} matching the type of the structure, as described more fully in <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fundamentals-valid-usage-for-structure-types">Valid Usage for Structure Types</a>.</p>
     * 
     ...
     * <h5>Description</h5>
     * 
     * <p>Brief introductions to core reference space types follow. Each has full requirements in a subsequent section, linked from these descriptions.</p>
     * 
     * <h5>Enumerant Descriptions</h5>
     * 
     * <ul>
     ...
     * </ul>
     * 
     * <p>An {@code XrSpace} handle for a reference space is created using {@link #xrCreateReferenceSpace CreateReferenceSpace}, by specifying the chosen reference space type and a pose within the natural reference frame defined for that reference space type.</p>
     * 
     * <p>Runtimes implement well-known reference spaces from {@code XrReferenceSpaceType} if they support tracking of that kind. Available reference space types are indicated by {@link #xrEnumerateReferenceSpaces EnumerateReferenceSpaces}. Note that other spaces can be created as well, such as pose action spaces created by {@link #xrCreateActionSpace CreateActionSpace}, which are not enumerated by that API.</p>
     * 
     * <h5>See Also</h5>
     * 
     ...
     * <li>{@link #XR_SESSION_STATE_READY SESSION_STATE_READY}. The application is ready to call {@link #xrBeginSession BeginSession} and <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-sync-frame-loop">sync its frame loop with the runtime.</a></li>
     ...
     * <li>{@link #XR_SESSION_STATE_VISIBLE SESSION_STATE_VISIBLE}. The application has <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-sync-frame-loop">synced its frame loop with the runtime</a> and is visible to the user but cannot receive XR input.</li>
     * <li>{@link #XR_SESSION_STATE_FOCUSED SESSION_STATE_FOCUSED}. The application has <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-sync-frame-loop">synced its frame loop with the runtime</a>, is visible to the user and can receive XR input.</li>
     ...
     * 
     * <p>The following table defines {@code XrObjectType} and OpenXR Handle relationships in the core specification:</p>
     * 
     * <table class="lwjgl">
     ...
     * 
     * <p>The "major" and "minor" components are always 1.0, while the "patch" component matches {@link #XR_CURRENT_API_VERSION CURRENT_API_VERSION}.</p>
     */
     ...
     * <li>{@link XR11#XR_ERROR_EXTENSION_DEPENDENCY_NOT_ENABLED ERROR_EXTENSION_DEPENDENCY_NOT_ENABLED}</li>
     ...
     * <h5>C Specification</h5>
     * 
     * <p>The {@link #xrPollEvent PollEvent} function is defined as:</p>
     * 
     * <pre><code>
     ...
     * <h5>Description</h5>
     * 
     * <p>{@link #xrPollEvent PollEvent} polls for the next event and returns an event if one is available. {@link #xrPollEvent PollEvent} returns immediately regardless of whether an event was available. The event (if present) is unilaterally removed from the queue if a valid {@code XrInstance} is provided. On return, the {@code eventData} parameter is filled with the event’s data and the type field is changed to the event’s type. Runtimes <b>may</b> create valid {@code next} chains depending on enabled extensions, but they <b>must</b> guarantee that any such chains point only to objects which fit completely within the original {@link XrEventDataBuffer} pointed to by {@code eventData}.</p>
     * 
     * <p>The runtime <b>must</b> discard queued events which contain destroyed or otherwise invalid handles. The runtime <b>must</b> not return events containing handles that have been destroyed or are otherwise invalid at the time of the call to {@link #xrPollEvent PollEvent}.</p>
     * 
     * <h5>Valid Usage (Implicit)</h5>
     * 
     * <ul>
     ...
     * <tr><td>{@link XrEventDataInteractionProfileChanged}</td><td>current interaction profile for one or more top level user paths has changed</td></tr>
     * <tr><td>{@link XrEventDataReferenceSpaceChangePending}</td><td>runtime will begin operating with updated definitions or bounds for a reference space</td></tr>
     * <tr><td>{@link XrEventDataSessionStateChanged}</td><td>the application’s session has changed lifecycle state</td></tr>
     * </tbody>
     * </table>
     * 
     * <h5>See Also</h5>
     ...
     * <h5>Description</h5>
     * 
     * <p>To get an {@code XrSystemId}, an application specifies its desired <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#system-form-factor-description">form factor</a> to {@link #xrGetSystem GetSystem} and gets the runtime’s {@code XrSystemId} associated with that configuration.</p>
     * 
     ...
     * <h5>C Specification</h5>
     * 
     * <p>The {@link #xrGetReferenceSpaceBoundsRect GetReferenceSpaceBoundsRect} function is defined as:</p>
     * 
     * <pre><code>
     ...
     * 
     * <p>Multiple {@code XrSpace} handles may exist simultaneously, up to some limit imposed by the runtime. The {@code XrSpace} handle must be eventually freed via the {@link #xrDestroySpace DestroySpace} function or by destroying the parent {@code XrSession} handle. See <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#spaces-action-spaces-lifetime">spaces-action-spaces-lifetime</a> for details.</p>
     * 
     ...
     * 
     * <p>After this function successfully returns, the session <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-running">is considered to be running</a>. The application <b>should</b> then start its frame loop consisting of some sequence of {@link #xrWaitFrame WaitFrame}/{@link #xrBeginFrame BeginFrame}/{@link #xrEndFrame EndFrame} calls.</p>
     * 
     * <p>If the session <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-running">is already running</a> when the application calls {@link #xrBeginSession BeginSession}, the runtime <b>must</b> return error {@link #XR_ERROR_SESSION_RUNNING ERROR_SESSION_RUNNING}. If the session <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-not-running">is not running</a> when the application calls {@link #xrBeginSession BeginSession}, but the session is not yet in the {@link #XR_SESSION_STATE_READY SESSION_STATE_READY} state, the runtime <b>must</b> return error {@link #XR_ERROR_SESSION_NOT_READY ERROR_SESSION_NOT_READY}.</p>
     * 
     ...
     * 
     * <p>Runtime session frame state <b>must</b> start in a reset state when a session transitions to <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-running">running</a> so that no state is carried over from when the same session was previously running. Frame state in this context includes {@link #xrWaitFrame WaitFrame}, {@link #xrBeginFrame BeginFrame}, and {@link #xrEndFrame EndFrame} call order enforcement.</p>
     * 
     ...
     *
     * @param session a handle to a <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-running">running</a> {@code XrSession}.
     */
    @NativeType("XrResult")
     ...
     * <h5>Description</h5>
     * 
     * <p>If {@code session} <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-not-running">is not running</a> when {@link #xrRequestExitSession RequestExitSession} is called, {@link #XR_ERROR_SESSION_NOT_RUNNING ERROR_SESSION_NOT_RUNNING} <b>must</b> be returned.</p>
     * 
     * <h5>Valid Usage (Implicit)</h5>
     * 
     * <ul>
     ...
     * 
     * <p>The runtime <b>must</b> return {@link #XR_ERROR_SESSION_NOT_RUNNING ERROR_SESSION_NOT_RUNNING} if the {@code session} <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-not-running">is not running</a>.</p>
     * 
     * <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
     * 
     ...
     * 
     * <p>{@link #XR_ERROR_SESSION_NOT_RUNNING ERROR_SESSION_NOT_RUNNING} <b>must</b> be returned if the {@code session} <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#session-not-running">is not running</a>.</p>
     * 
     * <div style="margin-left: 26px; border-left: 1px solid gray; padding-left: 14px;"><h5>Note</h5>
     * 
     ...
     * 
     * <p>The implementation <b>must</b> not free underlying resources for the action set while there are other valid handles that refer to those resources. The implementation <b>may</b> release resources for an action set when all of the action spaces for actions in that action set have been destroyed. See <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#spaces-action-spaces-lifetime">Action Spaces Lifetime</a> for details.</p>
     * 
     ...
     * <h5>Description</h5>
     * 
     * <p>The {@link #xrSuggestInteractionProfileBindings SuggestInteractionProfileBindings} function provides action bindings for a single interaction profile. The application <b>can</b> call {@link #xrSuggestInteractionProfileBindings SuggestInteractionProfileBindings} once per interaction profile that it supports.</p>
     * 
     ...
     * 
     * <p>If the interaction profile path does not follow the structure defined in <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#semantic-paths-interaction-profiles">Interaction Profiles</a> or suggested bindings contain paths that do not follow the format defined in <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#semantic-paths-input">Input subpaths</a> (further described in {@link XrActionSuggestedBinding}), the runtime <b>must</b> return {@link #XR_ERROR_PATH_UNSUPPORTED ERROR_PATH_UNSUPPORTED}. If the interaction profile or input source for any of the suggested bindings does not exist in the allowlist defined in <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#semantic-paths-interaction-profiles">Interaction Profile Paths</a>, the runtime <b>must</b> return {@link #XR_ERROR_PATH_UNSUPPORTED ERROR_PATH_UNSUPPORTED}. A runtime <b>must</b> accept every valid binding in the allowlist though it is free to ignore any of them.</p>
     * 
     ...
     * <h5>Description</h5>
     * 
     * <p>{@link #xrGetCurrentInteractionProfile GetCurrentInteractionProfile} retrieves the current interaction profile for a top level user path.</p>
     * 
     * <p>The runtime <b>must</b> return only interaction profiles for which the application has provided suggested bindings with {@link #xrSuggestInteractionProfileBindings SuggestInteractionProfileBindings} or {@link #XR_NULL_PATH NULL_PATH}. The runtime <b>may</b> return interaction profiles that do not represent physically present hardware, for example if the runtime is using a known interaction profile to bind to hardware that the application is not aware of. The runtime <b>may</b> return the last-known interaction profile in the event that no controllers are active.</p>
     * 
     * <p>If {@link #xrAttachSessionActionSets AttachSessionActionSets} has not yet been called for the {@code session}, the runtime <b>must</b> return {@link #XR_ERROR_ACTIONSET_NOT_ATTACHED ERROR_ACTIONSET_NOT_ATTACHED}. If {@code topLevelUserPath} is not one of the top level user paths described in <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#semantic-paths-user">/user paths</a>, the runtime <b>must</b> return {@link #XR_ERROR_PATH_UNSUPPORTED ERROR_PATH_UNSUPPORTED}.</p>
     * 
     * <h5>Valid Usage (Implicit)</h5>
     * 
     * <ul>
