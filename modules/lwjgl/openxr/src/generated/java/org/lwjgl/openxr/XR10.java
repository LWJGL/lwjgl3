...
public class XR10 {
     ...
     * <h5>Description</h5>
     * 
     * <p>Most structures containing {@code type} members have a value of {@code type} matching the type of the structure, as described more fully in <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fundamentals-valid-usage-for-structure-types">fundamentals-valid-usage-for-structure-types</a>.</p>
     * 
    ...
    public static final long XR_CURRENT_API_VERSION = XR_MAKE_VERSION(1, 1, 40);
     ...
     * 
     * <p>If {@link #xrAttachSessionActionSets AttachSessionActionSets} has not yet been called for the {@code session}, the runtime <b>must</b> return {@link #XR_ERROR_ACTIONSET_NOT_ATTACHED ERROR_ACTIONSET_NOT_ATTACHED}. If {@code topLevelUserPath} is not one of the top level user paths described in <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#semantic-paths-user">semantic-paths-user</a>, the runtime <b>must</b> return {@link #XR_ERROR_PATH_UNSUPPORTED ERROR_PATH_UNSUPPORTED}.</p>
     * 
     * <h5>Valid Usage (Implicit)</h5>
     * 
     * <ul>
