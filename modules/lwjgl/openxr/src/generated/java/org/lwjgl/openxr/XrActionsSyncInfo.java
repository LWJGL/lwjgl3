...
public class XrActionsSyncInfo extends Struct implements NativeResource {
    ...
    /**
     * Returns a new {@link XrActionsSyncInfo.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrActionsSyncInfo.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrActionsSyncInfo.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrActionsSyncInfo.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrActionsSyncInfo.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrActionsSyncInfo.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static void nnext(long struct, long value) { memPutAddress(struct + XrActionsSyncInfo.NEXT, check(value)); }
