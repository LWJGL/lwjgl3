...
public class XrRenderModelCapabilitiesRequestFB extends Struct implements NativeResource {
    ...
    public static XrRenderModelCapabilitiesRequestFB malloc() {
        return wrap(XrRenderModelCapabilitiesRequestFB.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrRenderModelCapabilitiesRequestFB calloc() {
        return wrap(XrRenderModelCapabilitiesRequestFB.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrRenderModelCapabilitiesRequestFB create() {
        ...
        return wrap(XrRenderModelCapabilitiesRequestFB.class, memAddress(container), container);
    }
    ...
    public static XrRenderModelCapabilitiesRequestFB create(long address) {
        return wrap(XrRenderModelCapabilitiesRequestFB.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrRenderModelCapabilitiesRequestFB createSafe(long address) {
        return address == NULL ? null : wrap(XrRenderModelCapabilitiesRequestFB.class, address);
    }
    ...
    public static XrRenderModelCapabilitiesRequestFB malloc(MemoryStack stack) {
        return wrap(XrRenderModelCapabilitiesRequestFB.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrRenderModelCapabilitiesRequestFB calloc(MemoryStack stack) {
        return wrap(XrRenderModelCapabilitiesRequestFB.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
