 ...
 * }</code></pre>
 */
public class XrFoveationEyeTrackedProfileCreateInfoMETA extends Struct implements NativeResource {
    ...
    public static XrFoveationEyeTrackedProfileCreateInfoMETA malloc() {
        return wrap(XrFoveationEyeTrackedProfileCreateInfoMETA.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrFoveationEyeTrackedProfileCreateInfoMETA calloc() {
        return wrap(XrFoveationEyeTrackedProfileCreateInfoMETA.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrFoveationEyeTrackedProfileCreateInfoMETA create() {
        ...
        return wrap(XrFoveationEyeTrackedProfileCreateInfoMETA.class, memAddress(container), container);
    }
    ...
    public static XrFoveationEyeTrackedProfileCreateInfoMETA create(long address) {
        return wrap(XrFoveationEyeTrackedProfileCreateInfoMETA.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrFoveationEyeTrackedProfileCreateInfoMETA createSafe(long address) {
        return address == NULL ? null : wrap(XrFoveationEyeTrackedProfileCreateInfoMETA.class, address);
    }
    ...
    public static XrFoveationEyeTrackedProfileCreateInfoMETA malloc(MemoryStack stack) {
        return wrap(XrFoveationEyeTrackedProfileCreateInfoMETA.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrFoveationEyeTrackedProfileCreateInfoMETA calloc(MemoryStack stack) {
        return wrap(XrFoveationEyeTrackedProfileCreateInfoMETA.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
