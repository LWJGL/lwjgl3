...
/** Wraps an {@code XrEyeTrackerFB} handle. */
public class XrEyeTrackerFB extends DispatchableHandle {

    private final XrSession session;

    /**
     * Creates an {@code XrEyeTrackerFB} using the specified native handle and {@code XrSession}.
     *
     * @param handle  the native {@code XrEyeTrackerFB} handle
