...
public class XrControllerModelPropertiesMSFT extends Struct implements NativeResource {
    ...
    /** Returns a {@link XrControllerModelNodePropertiesMSFT.Buffer} view of the struct array pointed to by the {@code nodeProperties} field. */
    @Nullable
    ...
    /** Returns a new {@code XrControllerModelPropertiesMSFT} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrControllerModelPropertiesMSFT mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrControllerModelPropertiesMSFT} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrControllerModelPropertiesMSFT callocStack() {
     ...
     */
    public static XrControllerModelPropertiesMSFT mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrControllerModelPropertiesMSFT callocStack(MemoryStack stack) {
        return wrap(XrControllerModelPropertiesMSFT.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link XrControllerModelPropertiesMSFT.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrControllerModelPropertiesMSFT.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrControllerModelPropertiesMSFT.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrControllerModelPropertiesMSFT.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrControllerModelPropertiesMSFT.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrControllerModelPropertiesMSFT.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static void nnext(long struct, long value) { memPutAddress(struct + XrControllerModelPropertiesMSFT.NEXT, check(value)); }
    ...
    public static void validate(long struct) {
        check(memGetAddress(struct + XrControllerModelPropertiesMSFT.NEXT));
    }
