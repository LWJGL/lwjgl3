...
public class XrHapticBaseHeader extends Struct implements NativeResource {
    ...
    /** Returns a new {@code XrHapticBaseHeader} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrHapticBaseHeader mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrHapticBaseHeader} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrHapticBaseHeader callocStack() {
     ...
     */
    public static XrHapticBaseHeader mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrHapticBaseHeader callocStack(MemoryStack stack) {
        return wrap(XrHapticBaseHeader.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link XrHapticBaseHeader.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrHapticBaseHeader.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrHapticBaseHeader.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrHapticBaseHeader.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrHapticBaseHeader.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrHapticBaseHeader.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static void nnext(long struct, long value) { memPutAddress(struct + XrHapticBaseHeader.NEXT, check(value)); }
    ...
    public static void validate(long struct) {
        check(memGetAddress(struct + XrHapticBaseHeader.NEXT));
    }
