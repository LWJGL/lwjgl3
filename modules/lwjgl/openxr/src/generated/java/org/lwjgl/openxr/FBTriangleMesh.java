...
public class FBTriangleMesh {
     ...
     * 
     * <p>When the mesh is mutable (the {@link #XR_TRIANGLE_MESH_MUTABLE_BIT_FB TRIANGLE_MESH_MUTABLE_BIT_FB} bit is set in {@link XrTriangleMeshCreateInfoFB}{@code ::flags}), the created triangle mesh starts in the <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_undefined_topology">Undefined Topology</a> state.</p>
     * 
     * <p>Immutable meshes have no state machine; they may be considered to be in state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_ready">Ready</a> with no valid edges leaving that state.</p>
     * 
     ...
     * 
     * <ul>
     * <li>A mutable triangle mesh <b>must</b> be in state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_defining_topology">Defining Topology</a>, <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_updating_mesh">Updating Mesh</a>, or <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_updating_vertices">Updating Vertices</a> to modify the <b>contents</b> of the vertex buffer retrieved by this function.</li>
     * <li>A mutable triangle mesh <b>must</b> be in state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_defining_topology">Defining Topology</a> or <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_updating_mesh">Updating Mesh</a> to modify the <b>count</b> of elements in the vertex buffer retrieved by this function. The new count is passed as a parameter to {@link #xrTriangleMeshEndUpdateFB TriangleMeshEndUpdateFB}.</li>
     * </ul>
     * 
     * <h5>Valid Usage (Implicit)</h5>
     * 
     ...
     * 
     * <p>A triangle mesh <b>must</b> be mutable and in state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_defining_topology">Defining Topology</a> or <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_updating_mesh">Updating Mesh</a> for the application to <b>modify</b> the contents and/or triangle count in the index buffer retrieved by this function.</p>
     * 
     * <h5>Valid Usage (Implicit)</h5>
     * 
     * <ul>
     ...
     * 
     * <p>The triangle mesh {@code mesh} <b>must</b> be in state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_undefined_topology">Undefined Topology</a> or <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_ready">Ready</a>.</p>
     * 
     * <ul>
     * <li>If the triangle mesh is in state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_undefined_topology">Undefined Topology</a> before this call, a successful call moves it to state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_defining_topology">Defining Topology</a>.</li>
     * <li>If the triangle mesh is in state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_ready">Ready</a> before this call, a successful call moves it to state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_updating_mesh">Updating Mesh</a>.</li>
     * </ul>
     * 
     * <h5>Valid Usage (Implicit)</h5>
     * 
     ...
     * <p>The triangle mesh {@code mesh} <b>must</b> be mutable. The runtime <b>must</b> return {@link XR10#XR_ERROR_VALIDATION_FAILURE ERROR_VALIDATION_FAILURE} if the mesh is immutable.</p>
     * 
     * <p>The triangle mesh {@code mesh} <b>must</b> be in state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_defining_topology">Defining Topology</a> or <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_updating_mesh">Updating Mesh</a>.</p>
     * 
     * <p>A successful call moves {@code mesh} to state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_ready">Ready</a>.</p>
     * 
     * <h5>Valid Usage (Implicit)</h5>
     * 
     * <ul>
     ...
     * <h5>Description</h5>
     * 
     * <p>Begins an update of the vertex positions of a mutable triangle mesh. The vertex count returned through {@code outVertexCount} is defined by the last call to {@link #xrTriangleMeshEndUpdateFB TriangleMeshEndUpdateFB}. Once the modification is done, call {@link #xrTriangleMeshEndVertexBufferUpdateFB TriangleMeshEndVertexBufferUpdateFB} to commit the changes and move to state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_ready">Ready</a>.</p>
     * 
     * <p>The triangle mesh {@code mesh} <b>must</b> be mutable. The runtime <b>must</b> return {@link XR10#XR_ERROR_VALIDATION_FAILURE ERROR_VALIDATION_FAILURE} if the mesh is immutable.</p>
     * 
     * <p>The triangle mesh {@code mesh} <b>must</b> be in state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_ready">Ready</a>.</p>
     * 
     * <p>A successful call moves {@code mesh} to state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_updating_vertices">Updating Vertices</a>.</p>
     * 
     * <h5>Valid Usage (Implicit)</h5>
     * 
     * <ul>
     ...
     * <p>The triangle mesh {@code mesh} <b>must</b> be mutable. The runtime <b>must</b> return {@link XR10#XR_ERROR_VALIDATION_FAILURE ERROR_VALIDATION_FAILURE} if the mesh is immutable.</p>
     * 
     * <p>The triangle mesh {@code mesh} <b>must</b> be in state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_updating_vertices">Updating Vertices</a>.</p>
     * 
     * <p>A successful call moves {@code mesh} to state <a href="https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#fb_triangle_mesh_state_ready">Ready</a>.</p>
     * 
     * <h5>Valid Usage (Implicit)</h5>
