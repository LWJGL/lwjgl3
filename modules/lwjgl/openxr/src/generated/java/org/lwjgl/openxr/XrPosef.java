...
public class XrPosef extends Struct implements NativeResource {
    ...
    /**
     * Returns a new {@link XrPosef.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrPosef.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrPosef.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrPosef.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrPosef.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrPosef.Buffer callocStack(int capacity, MemoryStack stack) {
