...
public class XrExternalCameraIntrinsicsOCULUS extends Struct implements NativeResource {
    ...
    public static XrExternalCameraIntrinsicsOCULUS malloc() {
        return wrap(XrExternalCameraIntrinsicsOCULUS.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrExternalCameraIntrinsicsOCULUS calloc() {
        return wrap(XrExternalCameraIntrinsicsOCULUS.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrExternalCameraIntrinsicsOCULUS create() {
        ...
        return wrap(XrExternalCameraIntrinsicsOCULUS.class, memAddress(container), container);
    }
    ...
    public static XrExternalCameraIntrinsicsOCULUS create(long address) {
        return wrap(XrExternalCameraIntrinsicsOCULUS.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrExternalCameraIntrinsicsOCULUS createSafe(long address) {
        return address == NULL ? null : wrap(XrExternalCameraIntrinsicsOCULUS.class, address);
    }
    ...
    public static XrExternalCameraIntrinsicsOCULUS malloc(MemoryStack stack) {
        return wrap(XrExternalCameraIntrinsicsOCULUS.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrExternalCameraIntrinsicsOCULUS calloc(MemoryStack stack) {
        return wrap(XrExternalCameraIntrinsicsOCULUS.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
