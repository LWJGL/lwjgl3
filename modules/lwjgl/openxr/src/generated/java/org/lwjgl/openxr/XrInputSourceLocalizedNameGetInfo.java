...
public class XrInputSourceLocalizedNameGetInfo extends Struct implements NativeResource {
    ...
    /** Returns a new {@code XrInputSourceLocalizedNameGetInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrInputSourceLocalizedNameGetInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrInputSourceLocalizedNameGetInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrInputSourceLocalizedNameGetInfo callocStack() {
     ...
     */
    public static XrInputSourceLocalizedNameGetInfo mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrInputSourceLocalizedNameGetInfo callocStack(MemoryStack stack) {
        return wrap(XrInputSourceLocalizedNameGetInfo.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link XrInputSourceLocalizedNameGetInfo.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrInputSourceLocalizedNameGetInfo.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrInputSourceLocalizedNameGetInfo.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrInputSourceLocalizedNameGetInfo.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrInputSourceLocalizedNameGetInfo.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrInputSourceLocalizedNameGetInfo.Buffer callocStack(int capacity, MemoryStack stack) {
