...
public class XrGraphicsRequirementsVulkan2KHR extends XrGraphicsRequirementsVulkanKHR {
    ...
    /** Returns a new {@code XrGraphicsRequirementsVulkan2KHR} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrGraphicsRequirementsVulkan2KHR mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrGraphicsRequirementsVulkan2KHR} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrGraphicsRequirementsVulkan2KHR callocStack() {
     ...
     */
    public static XrGraphicsRequirementsVulkan2KHR mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrGraphicsRequirementsVulkan2KHR callocStack(MemoryStack stack) {
        return wrap(XrGraphicsRequirementsVulkan2KHR.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link XrGraphicsRequirementsVulkan2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XrGraphicsRequirementsVulkan2KHR.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XrGraphicsRequirementsVulkan2KHR.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XrGraphicsRequirementsVulkan2KHR.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrGraphicsRequirementsVulkan2KHR.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XrGraphicsRequirementsVulkan2KHR.Buffer callocStack(int capacity, MemoryStack stack) {
