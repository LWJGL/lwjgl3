...
public class XrRoomLayoutFB extends Struct implements NativeResource {
    ...
    public static XrRoomLayoutFB malloc() {
        return wrap(XrRoomLayoutFB.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrRoomLayoutFB calloc() {
        return wrap(XrRoomLayoutFB.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@code XrRoomLayoutFB} instance allocated with {@link BufferUtils}. */
    public static XrRoomLayoutFB create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(XrRoomLayoutFB.class, memAddress(container), container);
    }
    ...
    public static XrRoomLayoutFB create(long address) {
        return wrap(XrRoomLayoutFB.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrRoomLayoutFB createSafe(long address) {
        return address == NULL ? null : wrap(XrRoomLayoutFB.class, address);
    }
    ...
    public static XrRoomLayoutFB malloc(MemoryStack stack) {
        return wrap(XrRoomLayoutFB.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrRoomLayoutFB calloc(MemoryStack stack) {
        return wrap(XrRoomLayoutFB.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<XrRoomLayoutFB, Buffer> implements NativeResource {
         ...
         * by {@link XrRoomLayoutFB#SIZEOF}, and its mark will be undefined.
         *
