 ...
 * 
 * <ul>
 * <li>The {@link MLSpatialAnchorsStorage XR_ML_spatial_anchors_storage} extension <b>must</b> be enabled prior to using {@link XrSpatialAnchorsPublishCompletionDetailsML}</li>
 * <li>{@code type} <b>must</b> be {@link MLSpatialAnchorsStorage#XR_TYPE_SPATIAL_ANCHORS_PUBLISH_COMPLETION_DETAILS_ML TYPE_SPATIAL_ANCHORS_PUBLISH_COMPLETION_DETAILS_ML}</li>
 ...
 * <h5>See Also</h5>
 * 
 * <p>{@link XrSpatialAnchorCompletionResultML}, {@link XrSpatialAnchorsPublishCompletionML}, {@link MLSpatialAnchorsStorage#xrPublishSpatialAnchorsCompleteML PublishSpatialAnchorsCompleteML}</p>
 * 
 * <h3>Layout</h3>
 * 
 * <pre><code>
...
public class XrSpatialAnchorsPublishCompletionDetailsML extends Struct<XrSpatialAnchorsPublishCompletionDetailsML> implements NativeResource {
    ...
    /** the capacity of the {@code results} array and <b>must</b> match the number of anchors passed to {@link MLSpatialAnchorsStorage#xrPublishSpatialAnchorsAsyncML PublishSpatialAnchorsAsyncML}. */
    @NativeType("uint32_t")
    public int resultCount() { return nresultCount(address()); }
    /** the per UUID status of the publish operation. The order of results in this array correspond to the async request order. */
    ...
    /** Sets the {@link MLSpatialAnchorsStorage#XR_TYPE_SPATIAL_ANCHORS_PUBLISH_COMPLETION_DETAILS_ML TYPE_SPATIAL_ANCHORS_PUBLISH_COMPLETION_DETAILS_ML} value to the {@link #type} field. */
    ...
    @Nullable
    public static XrSpatialAnchorsPublishCompletionDetailsML createSafe(long address) {
    ...
    @Nullable
    public static XrSpatialAnchorsPublishCompletionDetailsML.Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends StructBuffer<XrSpatialAnchorsPublishCompletionDetailsML, Buffer> implements NativeResource {
        ...
        /** @return the value of the {@link XrSpatialAnchorsPublishCompletionDetailsML#type} field. */
        @NativeType("XrStructureType")
        public int type() { return XrSpatialAnchorsPublishCompletionDetailsML.ntype(address()); }
        /** @return the value of the {@link XrSpatialAnchorsPublishCompletionDetailsML#next} field. */
        @NativeType("void *")
        public long next() { return XrSpatialAnchorsPublishCompletionDetailsML.nnext(address()); }
        /** @return the value of the {@link XrSpatialAnchorsPublishCompletionDetailsML#resultCount} field. */
        @NativeType("uint32_t")
        public int resultCount() { return XrSpatialAnchorsPublishCompletionDetailsML.nresultCount(address()); }
        /** @return a {@link XrSpatialAnchorCompletionResultML.Buffer} view of the struct array pointed to by the {@link XrSpatialAnchorsPublishCompletionDetailsML#results} field. */
        @NativeType("XrSpatialAnchorCompletionResultML *")
        ...
        /** Sets the specified value to the {@link XrSpatialAnchorsPublishCompletionDetailsML#type} field. */
        ...
        /** Sets the {@link MLSpatialAnchorsStorage#XR_TYPE_SPATIAL_ANCHORS_PUBLISH_COMPLETION_DETAILS_ML TYPE_SPATIAL_ANCHORS_PUBLISH_COMPLETION_DETAILS_ML} value to the {@link XrSpatialAnchorsPublishCompletionDetailsML#type} field. */
        ...
        /** Sets the specified value to the {@link XrSpatialAnchorsPublishCompletionDetailsML#next} field. */
        ...
        /** Sets the address of the specified {@link XrSpatialAnchorCompletionResultML.Buffer} to the {@link XrSpatialAnchorsPublishCompletionDetailsML#results} field. */
