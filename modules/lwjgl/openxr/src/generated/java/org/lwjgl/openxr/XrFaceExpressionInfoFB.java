...
public class XrFaceExpressionInfoFB extends Struct implements NativeResource {
    ...
    public static XrFaceExpressionInfoFB malloc() {
        return wrap(XrFaceExpressionInfoFB.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrFaceExpressionInfoFB calloc() {
        return wrap(XrFaceExpressionInfoFB.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrFaceExpressionInfoFB create() {
        ...
        return wrap(XrFaceExpressionInfoFB.class, memAddress(container), container);
    }
    ...
    public static XrFaceExpressionInfoFB create(long address) {
        return wrap(XrFaceExpressionInfoFB.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrFaceExpressionInfoFB createSafe(long address) {
        return address == NULL ? null : wrap(XrFaceExpressionInfoFB.class, address);
    }
    ...
    public static XrFaceExpressionInfoFB malloc(MemoryStack stack) {
        return wrap(XrFaceExpressionInfoFB.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrFaceExpressionInfoFB calloc(MemoryStack stack) {
        return wrap(XrFaceExpressionInfoFB.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
