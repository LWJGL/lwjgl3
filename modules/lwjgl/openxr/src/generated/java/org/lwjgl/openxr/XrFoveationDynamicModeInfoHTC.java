...
public class XrFoveationDynamicModeInfoHTC extends Struct implements NativeResource {
    ...
    public static XrFoveationDynamicModeInfoHTC malloc() {
        return wrap(XrFoveationDynamicModeInfoHTC.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrFoveationDynamicModeInfoHTC calloc() {
        return wrap(XrFoveationDynamicModeInfoHTC.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrFoveationDynamicModeInfoHTC create() {
        ...
        return wrap(XrFoveationDynamicModeInfoHTC.class, memAddress(container), container);
    }
    ...
    public static XrFoveationDynamicModeInfoHTC create(long address) {
        return wrap(XrFoveationDynamicModeInfoHTC.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrFoveationDynamicModeInfoHTC createSafe(long address) {
        return address == NULL ? null : wrap(XrFoveationDynamicModeInfoHTC.class, address);
    }
    ...
    public static XrFoveationDynamicModeInfoHTC malloc(MemoryStack stack) {
        return wrap(XrFoveationDynamicModeInfoHTC.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrFoveationDynamicModeInfoHTC calloc(MemoryStack stack) {
        return wrap(XrFoveationDynamicModeInfoHTC.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
