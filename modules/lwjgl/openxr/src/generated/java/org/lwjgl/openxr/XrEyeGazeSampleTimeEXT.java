...
public class XrEyeGazeSampleTimeEXT extends Struct implements NativeResource {
    ...
    public static void nnext(long struct, long value) { memPutAddress(struct + XrEyeGazeSampleTimeEXT.NEXT, check(value)); }
    ...
    public static void validate(long struct) {
        check(memGetAddress(struct + XrEyeGazeSampleTimeEXT.NEXT));
    }
