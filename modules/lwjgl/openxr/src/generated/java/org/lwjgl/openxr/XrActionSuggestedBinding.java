...
public class XrActionSuggestedBinding extends Struct<XrActionSuggestedBinding> implements NativeResource {
    ...
    /** the {@code XrPath} of a binding for the action specified in {@code action}. This path is any top level user path plus input source path, for example pathname:/user/hand/right/input/trigger/click. See <a href="https://registry.khronos.org/OpenXR/specs/1.0/html/xrspec.html#input-suggested-bindings">suggested bindings</a> for more details. */
    @NativeType("XrPath")
    ...
    public static class Buffer extends StructBuffer<XrActionSuggestedBinding, Buffer> implements NativeResource {
         ...
         * by {@link XrActionSuggestedBinding#SIZEOF}, and its mark will be undefined.</p>
         *
