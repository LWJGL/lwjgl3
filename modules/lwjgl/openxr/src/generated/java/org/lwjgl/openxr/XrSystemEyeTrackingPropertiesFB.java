 ...
 * }</code></pre>
 */
public class XrSystemEyeTrackingPropertiesFB extends Struct implements NativeResource {
    ...
    public static XrSystemEyeTrackingPropertiesFB malloc() {
        return wrap(XrSystemEyeTrackingPropertiesFB.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrSystemEyeTrackingPropertiesFB calloc() {
        return wrap(XrSystemEyeTrackingPropertiesFB.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrSystemEyeTrackingPropertiesFB create() {
        ...
        return wrap(XrSystemEyeTrackingPropertiesFB.class, memAddress(container), container);
    }
    ...
    public static XrSystemEyeTrackingPropertiesFB create(long address) {
        return wrap(XrSystemEyeTrackingPropertiesFB.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrSystemEyeTrackingPropertiesFB createSafe(long address) {
        return address == NULL ? null : wrap(XrSystemEyeTrackingPropertiesFB.class, address);
    }
    ...
    public static XrSystemEyeTrackingPropertiesFB malloc(MemoryStack stack) {
        return wrap(XrSystemEyeTrackingPropertiesFB.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrSystemEyeTrackingPropertiesFB calloc(MemoryStack stack) {
        return wrap(XrSystemEyeTrackingPropertiesFB.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
