...
public class XrHandMeshSpaceCreateInfoMSFT extends Struct implements NativeResource {
    ...
    public static void nnext(long struct, long value) { memPutAddress(struct + XrHandMeshSpaceCreateInfoMSFT.NEXT, check(value)); }
    ...
    public static void validate(long struct) {
        check(memGetAddress(struct + XrHandMeshSpaceCreateInfoMSFT.NEXT));
    }
