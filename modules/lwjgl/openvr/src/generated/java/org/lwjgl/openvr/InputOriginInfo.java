...
public class InputOriginInfo extends Struct<InputOriginInfo> implements NativeResource {
    ...
    public static InputOriginInfo malloc() {
        return new InputOriginInfo(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static InputOriginInfo calloc() {
        return new InputOriginInfo(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static InputOriginInfo create() {
        ...
        return new InputOriginInfo(memAddress(container), container);
    }
    ...
    public static class Buffer extends StructBuffer<InputOriginInfo, Buffer> implements NativeResource {
         ...
         * by {@link InputOriginInfo#SIZEOF}, and its mark will be undefined.</p>
         *
