...
public class VRActiveActionSet extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VRActiveActionSet} instance allocated on the thread-local {@link MemoryStack}. */
    public static VRActiveActionSet mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VRActiveActionSet} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
