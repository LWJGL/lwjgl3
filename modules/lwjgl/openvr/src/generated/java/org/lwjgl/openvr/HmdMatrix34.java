...
public class HmdMatrix34 extends Struct implements NativeResource {
    ...
    /** Returns a new {@code HmdMatrix34} instance allocated on the thread-local {@link MemoryStack}. */
    public static HmdMatrix34 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code HmdMatrix34} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
