...
public class SpatialAnchorPose extends Struct implements NativeResource {
    ...
    /** Returns a new {@code SpatialAnchorPose} instance allocated on the thread-local {@link MemoryStack}. */
    public static SpatialAnchorPose mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code SpatialAnchorPose} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
