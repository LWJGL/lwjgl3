...
public class VRVulkanDevice extends Struct implements NativeResource {
    ...
    /** Returns a new {@code VRVulkanDevice} instance allocated on the thread-local {@link MemoryStack}. */
    public static VRVulkanDevice mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code VRVulkanDevice} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static VRVulkanDevice callocStack() {
     ...
     */
    public static VRVulkanDevice mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static VRVulkanDevice callocStack(MemoryStack stack) {
        return wrap(VRVulkanDevice.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link VRVulkanDevice.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static VRVulkanDevice.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link VRVulkanDevice.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static VRVulkanDevice.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VRVulkanDevice.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VRVulkanDevice.Buffer callocStack(int capacity, MemoryStack stack) {
