...
public class VREventShowDevTools extends Struct<VREventShowDevTools> {
    ...
    public static @Nullable VREventShowDevTools createSafe(long address) {
    ...
    public static VREventShowDevTools.@Nullable Buffer createSafe(long address, int capacity) {
