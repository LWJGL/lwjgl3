...
public class VRTextureWithPoseAndDepth extends Struct<VRTextureWithPoseAndDepth> implements NativeResource {
    ...
    public static VRTextureWithPoseAndDepth malloc() {
        return new VRTextureWithPoseAndDepth(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VRTextureWithPoseAndDepth calloc() {
        return new VRTextureWithPoseAndDepth(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VRTextureWithPoseAndDepth create() {
        ...
        return new VRTextureWithPoseAndDepth(memAddress(container), container);
    }
    ...
    @Deprecated public static VRTextureWithPoseAndDepth mallocStack() { return malloc(stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(MemoryStack)} instead. */
    @Deprecated public static VRTextureWithPoseAndDepth callocStack() { return calloc(stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(MemoryStack)} instead. */
    @Deprecated public static VRTextureWithPoseAndDepth mallocStack(MemoryStack stack) { return malloc(stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(MemoryStack)} instead. */
    @Deprecated public static VRTextureWithPoseAndDepth callocStack(MemoryStack stack) { return calloc(stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(int, MemoryStack)} instead. */
    @Deprecated public static VRTextureWithPoseAndDepth.Buffer mallocStack(int capacity) { return malloc(capacity, stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(int, MemoryStack)} instead. */
    @Deprecated public static VRTextureWithPoseAndDepth.Buffer callocStack(int capacity) { return calloc(capacity, stackGet()); }
    /** Deprecated for removal in 3.4.0. Use {@link #malloc(int, MemoryStack)} instead. */
    @Deprecated public static VRTextureWithPoseAndDepth.Buffer mallocStack(int capacity, MemoryStack stack) { return malloc(capacity, stack); }
    /** Deprecated for removal in 3.4.0. Use {@link #calloc(int, MemoryStack)} instead. */
    @Deprecated public static VRTextureWithPoseAndDepth.Buffer callocStack(int capacity, MemoryStack stack) { return calloc(capacity, stack); }
     ...
     * @param capacity the buffer capacity
     */
    public static VRTextureWithPoseAndDepth.Buffer malloc(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VRTextureWithPoseAndDepth.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VRTextureWithPoseAndDepth, Buffer> implements NativeResource {
         ...
         * by {@link VRTextureWithPoseAndDepth#SIZEOF}, and its mark will be undefined.</p>
         *
