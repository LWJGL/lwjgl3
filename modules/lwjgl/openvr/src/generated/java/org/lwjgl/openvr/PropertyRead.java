...
public class PropertyRead extends Struct implements NativeResource {
    ...
    public static PropertyRead malloc() {
        return wrap(PropertyRead.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static PropertyRead malloc(MemoryStack stack) {
        return wrap(PropertyRead.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static PropertyRead calloc(MemoryStack stack) {
        return wrap(PropertyRead.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<PropertyRead, Buffer> implements NativeResource {
         ...
         * by {@link PropertyRead#SIZEOF}, and its mark will be undefined.
         *
