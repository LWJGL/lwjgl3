...
public class HmdVector3 extends Struct implements NativeResource {
    ...
    HmdVector3(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    /**
     * Creates a {@link HmdVector3} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link HmdVector3} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static HmdVector3 malloc() {
        return create(nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link HmdVector3} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static HmdVector3 calloc() {
        return create(nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link HmdVector3} instance allocated with {@link BufferUtils}. */
    public static HmdVector3 create() {
        return new HmdVector3(BufferUtils.createByteBuffer(SIZEOF));
    }

    /** Returns a new {@link HmdVector3} instance for the specified memory address. */
    ...
    /** Returns a new {@link HmdVector3} instance allocated on the thread-local {@link MemoryStack}. */
    public static HmdVector3 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link HmdVector3} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static HmdVector3 callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link HmdVector3} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link HmdVector3} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link HmdVector3.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link HmdVector3.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static HmdVector3.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static HmdVector3.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<HmdVector3, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link HmdVector3.Buffer} instance backed by the specified container.
         *
