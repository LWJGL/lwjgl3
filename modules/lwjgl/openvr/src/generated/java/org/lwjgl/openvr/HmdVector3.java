...
public class HmdVector3 extends Struct implements NativeResource {
    ...
    /** Returns a new {@code HmdVector3} instance allocated on the thread-local {@link MemoryStack}. */
    public static HmdVector3 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code HmdVector3} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
