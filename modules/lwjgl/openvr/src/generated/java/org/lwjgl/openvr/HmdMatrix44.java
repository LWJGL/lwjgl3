...
public class HmdMatrix44 extends Struct implements NativeResource {
    ...
    /** Returns a new {@code HmdMatrix44} instance allocated on the thread-local {@link MemoryStack}. */
    public static HmdMatrix44 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code HmdMatrix44} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
     ...
     * @param capacity the buffer capacity
     */
    public static HmdMatrix44.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static HmdMatrix44.Buffer callocStack(int capacity, MemoryStack stack) {
