...
public class HmdMatrix33 extends Struct implements NativeResource {
    ...
    /** Returns a new {@code HmdMatrix33} instance allocated on the thread-local {@link MemoryStack}. */
    public static HmdMatrix33 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code HmdMatrix33} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
