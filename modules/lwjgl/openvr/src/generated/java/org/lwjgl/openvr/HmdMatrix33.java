...
public class HmdMatrix33 extends Struct<HmdMatrix33> implements NativeResource {
    ...
    protected HmdMatrix33(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected HmdMatrix33 create(long address, @Nullable ByteBuffer container) {
    ...
    public static HmdMatrix33 malloc() {
        return new HmdMatrix33(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static @Nullable HmdMatrix33 createSafe(long address) {
        return address == NULL ? null : new HmdMatrix33(address, null);
    }
    ...
    public static HmdMatrix33.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static HmdMatrix33 malloc(MemoryStack stack) {
        return new HmdMatrix33(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static HmdMatrix33 calloc(MemoryStack stack) {
        return new HmdMatrix33(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<HmdMatrix33, Buffer> implements NativeResource {
         ...
         * by {@link HmdMatrix33#SIZEOF}, and its mark will be undefined.</p>
         *
