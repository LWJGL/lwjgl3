...
public class VRChaperone {
     ...
     * 
     * <p>The corners form a rectangle. Corners are in counter-clockwise order, starting at the front-right. The positions are given relative to the standing
     ...
     * with 2 sides parallel to the X-axis and two sides parallel to the Z-axis of the user's calibrated Play Area.</p>
     */
    @NativeType("bool")
