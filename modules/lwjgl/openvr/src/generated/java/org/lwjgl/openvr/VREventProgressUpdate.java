...
public class VREventProgressUpdate extends Struct {
    ...
    /**
     * Creates a {@link VREventProgressUpdate} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link VREventProgressUpdate} instance for the specified memory address. */
    ...
    public static class Buffer extends StructBuffer<VREventProgressUpdate, Buffer> {
        ...
        /**
         * Creates a new {@link VREventProgressUpdate.Buffer} instance backed by the specified container.
         *
