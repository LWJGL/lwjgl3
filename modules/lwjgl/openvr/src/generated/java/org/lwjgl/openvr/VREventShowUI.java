...
public class VREventShowUI extends Struct {
    ...
    /**
     * Creates a {@link VREventShowUI} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link VREventShowUI} instance for the specified memory address. */
    ...
    public static class Buffer extends StructBuffer<VREventShowUI, Buffer> {
        ...
        /**
         * Creates a new {@link VREventShowUI.Buffer} instance backed by the specified container.
         *
