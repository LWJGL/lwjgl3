...
JNIEXPORT jint JNICALL Java_org_lwjgl_util_msdfgen_MSDFGen_nmsdf_1ft_1set_1load_1callback(JNIEnv *__env, jclass clazz, jlong callbackAddress) {
    void * (*callback) (char const *) = (void * (*) (char const *))(uintptr_t)callbackAddress;
    UNUSED_PARAMS(__env, clazz)
    return (jint)msdf_ft_set_load_callback(callback);
}

JNIEXPORT jlong JNICALL Java_org_lwjgl_util_msdfgen_MSDFGen_nmsdf_1ft_1get_1load_1callback(JNIEnv *__env, jclass clazz) {
    UNUSED_PARAMS(__env, clazz)
    return (jlong)(uintptr_t)msdf_ft_get_load_callback();
}

JNIEXPORT jint JNICALL Java_org_lwjgl_util_msdfgen_MSDFGen_nmsdf_1ft_1init(JNIEnv *__env, jclass clazz, jlong handleAddress) {
    msdf_ft_handle *handle = (msdf_ft_handle *)(uintptr_t)handleAddress;
    UNUSED_PARAMS(__env, clazz)
    return (jint)msdf_ft_init(handle);
}

JNIEXPORT jint JNICALL Java_org_lwjgl_util_msdfgen_MSDFGen_nmsdf_1ft_1load_1font(JNIEnv *__env, jclass clazz, jlong handleAddress, jlong fileNameAddress, jlong fontAddress) {
    msdf_ft_handle handle = (msdf_ft_handle)(uintptr_t)handleAddress;
...
JNIEXPORT jint JNICALL Java_org_lwjgl_util_msdfgen_MSDFGen_nmsdf_1ft_1adopt_1font(JNIEnv *__env, jclass clazz, jlong faceAddress, jlong fontAddress) {
...
JNIEXPORT jint JNICALL Java_org_lwjgl_util_msdfgen_MSDFGen_nmsdf_1ft_1load_1font_1data(JNIEnv *__env, jclass clazz, jlong handleAddress, jlong dataAddress, jlong size, jlong fontAddress) {
    msdf_ft_handle handle = (msdf_ft_handle)(uintptr_t)handleAddress;
...
JNIEXPORT jint JNICALL Java_org_lwjgl_util_msdfgen_MSDFGen_nmsdf_1ft_1font_1load_1glyph(JNIEnv *__env, jclass clazz, jlong fontAddress, jint cp, jlong shapeAddress) {
    msdf_ft_font_handle font = (msdf_ft_font_handle)(uintptr_t)fontAddress;
    msdf_shape_handle *shape = (msdf_shape_handle *)(uintptr_t)shapeAddress;
    UNUSED_PARAMS(__env, clazz)
    return (jint)msdf_ft_font_load_glyph(font, (unsigned)cp, shape);
}

JNIEXPORT void JNICALL Java_org_lwjgl_util_msdfgen_MSDFGen_nmsdf_1ft_1font_1destroy(JNIEnv *__env, jclass clazz, jlong fontAddress) {
    msdf_ft_font_handle font = (msdf_ft_font_handle)(uintptr_t)fontAddress;
    UNUSED_PARAMS(__env, clazz)
    msdf_ft_font_destroy(font);
}

JNIEXPORT void JNICALL Java_org_lwjgl_util_msdfgen_MSDFGen_nmsdf_1ft_1deinit(JNIEnv *__env, jclass clazz, jlong handleAddress) {
    msdf_ft_handle handle = (msdf_ft_handle)(uintptr_t)handleAddress;
    UNUSED_PARAMS(__env, clazz)
