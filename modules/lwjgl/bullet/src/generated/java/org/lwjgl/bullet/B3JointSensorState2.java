...
public class B3JointSensorState2 extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link B3JointSensorState2} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link B3JointSensorState2} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static B3JointSensorState2 malloc() {
        return wrap(B3JointSensorState2.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link B3JointSensorState2} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static B3JointSensorState2 calloc() {
        return wrap(B3JointSensorState2.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link B3JointSensorState2} instance allocated with {@link BufferUtils}. */
    public static B3JointSensorState2 create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(B3JointSensorState2.class, memAddress(container), container);
    }

    /** Returns a new {@link B3JointSensorState2} instance for the specified memory address. */
    ...
    /** Returns a new {@link B3JointSensorState2} instance allocated on the thread-local {@link MemoryStack}. */
    public static B3JointSensorState2 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link B3JointSensorState2} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static B3JointSensorState2 callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link B3JointSensorState2} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link B3JointSensorState2} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<B3JointSensorState2, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link B3JointSensorState2.Buffer} instance backed by the specified container.
         *
