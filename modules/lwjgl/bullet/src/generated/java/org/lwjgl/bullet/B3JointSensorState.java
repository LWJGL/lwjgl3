...
public class B3JointSensorState extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link B3JointSensorState} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link B3JointSensorState} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static B3JointSensorState malloc() {
        return wrap(B3JointSensorState.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link B3JointSensorState} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static B3JointSensorState calloc() {
        return wrap(B3JointSensorState.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link B3JointSensorState} instance allocated with {@link BufferUtils}. */
    public static B3JointSensorState create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(B3JointSensorState.class, memAddress(container), container);
    }

    /** Returns a new {@link B3JointSensorState} instance for the specified memory address. */
    ...
    /** Returns a new {@link B3JointSensorState} instance allocated on the thread-local {@link MemoryStack}. */
    public static B3JointSensorState mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link B3JointSensorState} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static B3JointSensorState callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link B3JointSensorState} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link B3JointSensorState} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<B3JointSensorState, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link B3JointSensorState.Buffer} instance backed by the specified container.
         *
