...
public class B3ContactInformation extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link B3ContactInformation} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link B3ContactInformation} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static B3ContactInformation malloc() {
        return wrap(B3ContactInformation.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link B3ContactInformation} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static B3ContactInformation calloc() {
        return wrap(B3ContactInformation.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link B3ContactInformation} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link B3ContactInformation} instance for the specified memory address. */
    ...
    /** Returns a new {@link B3ContactInformation} instance allocated on the thread-local {@link MemoryStack}. */
    public static B3ContactInformation mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link B3ContactInformation} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static B3ContactInformation callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link B3ContactInformation} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link B3ContactInformation} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<B3ContactInformation, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link B3ContactInformation.Buffer} instance backed by the specified container.
         *
