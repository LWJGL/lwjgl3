...
public class B3UserConstraintState extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link B3UserConstraintState} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link B3UserConstraintState} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static B3UserConstraintState malloc() {
        return wrap(B3UserConstraintState.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link B3UserConstraintState} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static B3UserConstraintState calloc() {
        return wrap(B3UserConstraintState.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link B3UserConstraintState} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link B3UserConstraintState} instance for the specified memory address. */
    ...
    /** Returns a new {@link B3UserConstraintState} instance allocated on the thread-local {@link MemoryStack}. */
    public static B3UserConstraintState mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link B3UserConstraintState} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static B3UserConstraintState callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link B3UserConstraintState} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link B3UserConstraintState} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<B3UserConstraintState, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link B3UserConstraintState.Buffer} instance backed by the specified container.
         *
