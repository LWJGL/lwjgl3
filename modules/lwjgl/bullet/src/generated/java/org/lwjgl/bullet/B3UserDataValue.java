...
public class B3UserDataValue extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link B3UserDataValue} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link B3UserDataValue} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static B3UserDataValue malloc() {
        return wrap(B3UserDataValue.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link B3UserDataValue} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static B3UserDataValue calloc() {
        return wrap(B3UserDataValue.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link B3UserDataValue} instance allocated with {@link BufferUtils}. */
    public static B3UserDataValue create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(B3UserDataValue.class, memAddress(container), container);
    }

    /** Returns a new {@link B3UserDataValue} instance for the specified memory address. */
    ...
    /** Returns a new {@link B3UserDataValue} instance allocated on the thread-local {@link MemoryStack}. */
    public static B3UserDataValue mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link B3UserDataValue} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static B3UserDataValue callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link B3UserDataValue} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link B3UserDataValue} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<B3UserDataValue, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link B3UserDataValue.Buffer} instance backed by the specified container.
         *
