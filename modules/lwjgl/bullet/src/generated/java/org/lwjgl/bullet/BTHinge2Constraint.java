...
public class BTHinge2Constraint {
    ...
    @NativeType("void *")
    public static long btHinge2Constraint_new(@NativeType("void *") long rbA, @NativeType("void *") long rbB, @NativeType("btVector3 *") ΒΤVector3 anchor, @NativeType("btVector3 *") ΒΤVector3 axis1, @NativeType("btVector3 *") ΒΤVector3 axis2) {
    ...
    public static void btHinge2Constraint_getAnchor(@NativeType("void *") long obj, @NativeType("btVector3 *") ΒΤVector3 value) {
    ...
    public static void btHinge2Constraint_getAnchor2(@NativeType("void *") long obj, @NativeType("btVector3 *") ΒΤVector3 value) {
    ...
    public static void btHinge2Constraint_getAxis1(@NativeType("void *") long obj, @NativeType("btVector3 *") ΒΤVector3 value) {
    ...
    public static void btHinge2Constraint_getAxis2(@NativeType("void *") long obj, @NativeType("btVector3 *") ΒΤVector3 value) {
