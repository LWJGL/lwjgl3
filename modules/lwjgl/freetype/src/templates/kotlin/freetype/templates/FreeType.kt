...
val freetype = "FreeType".nativeClass(Module.FREETYPE, prefix = "FT", prefixMethod = "FT_", binding = FREETYPE_BINDING) {
    ...
    EnumConstant(
        ...
        "ENCODING_GB2312".enum("FT_ENCODING_PRC"),
        "ENCODING_MS_SJIS".enum("FT_ENCODING_SJIS"),
        "ENCODING_MS_GB2312".enum("FT_ENCODING_PRC"),
        "ENCODING_MS_BIG5".enum("FT_ENCODING_BIG5"),
        "ENCODING_MS_WANSUNG".enum("FT_ENCODING_WANSUNG"),
        "ENCODING_MS_JOHAB".enum("FT_ENCODING_JOHAB"),
    ...
    IntConstant("FREETYPE_PATCH".."3").noPrefix()
