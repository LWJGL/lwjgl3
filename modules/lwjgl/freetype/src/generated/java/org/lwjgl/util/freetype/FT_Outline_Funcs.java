...
public class FT_Outline_Funcs extends Struct implements NativeResource {
    ...
    public static FT_Outline_Funcs malloc() {
        return wrap(FT_Outline_Funcs.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Outline_Funcs calloc() {
        return wrap(FT_Outline_Funcs.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FT_Outline_Funcs create() {
        ...
        return wrap(FT_Outline_Funcs.class, memAddress(container), container);
    }
    ...
    public static FT_Outline_Funcs create(long address) {
        return wrap(FT_Outline_Funcs.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FT_Outline_Funcs createSafe(long address) {
        return address == NULL ? null : wrap(FT_Outline_Funcs.class, address);
    }
    ...
    public static FT_Outline_Funcs malloc(MemoryStack stack) {
        return wrap(FT_Outline_Funcs.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Outline_Funcs calloc(MemoryStack stack) {
        return wrap(FT_Outline_Funcs.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Outline_Funcs, Buffer> implements NativeResource {
         ...
         * by {@link FT_Outline_Funcs#SIZEOF}, and its mark will be undefined.
         *
