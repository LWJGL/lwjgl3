...
public class FT_Bitmap extends Struct implements NativeResource {
    ...
    public static FT_Bitmap malloc() {
        return wrap(FT_Bitmap.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Bitmap malloc(MemoryStack stack) {
        return wrap(FT_Bitmap.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Bitmap calloc(MemoryStack stack) {
        return wrap(FT_Bitmap.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Bitmap, Buffer> implements NativeResource {
         ...
         * by {@link FT_Bitmap#SIZEOF}, and its mark will be undefined.
         *
