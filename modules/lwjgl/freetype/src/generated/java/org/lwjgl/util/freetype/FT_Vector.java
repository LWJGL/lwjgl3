...
public class FT_Vector extends Struct implements NativeResource {
    ...
    public static FT_Vector malloc() {
        return wrap(FT_Vector.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Vector malloc(MemoryStack stack) {
        return wrap(FT_Vector.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Vector calloc(MemoryStack stack) {
        return wrap(FT_Vector.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Vector, Buffer> implements NativeResource {
         ...
         * by {@link FT_Vector#SIZEOF}, and its mark will be undefined.
         *
