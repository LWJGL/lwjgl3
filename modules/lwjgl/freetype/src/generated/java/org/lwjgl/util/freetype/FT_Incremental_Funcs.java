...
public class FT_Incremental_Funcs extends Struct implements NativeResource {
    ...
    public static FT_Incremental_Funcs malloc() {
        return wrap(FT_Incremental_Funcs.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Incremental_Funcs calloc() {
        return wrap(FT_Incremental_Funcs.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FT_Incremental_Funcs create() {
        ...
        return wrap(FT_Incremental_Funcs.class, memAddress(container), container);
    }
    ...
    public static FT_Incremental_Funcs create(long address) {
        return wrap(FT_Incremental_Funcs.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FT_Incremental_Funcs createSafe(long address) {
        return address == NULL ? null : wrap(FT_Incremental_Funcs.class, address);
    }
    ...
    public static FT_Incremental_Funcs malloc(MemoryStack stack) {
        return wrap(FT_Incremental_Funcs.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Incremental_Funcs calloc(MemoryStack stack) {
        return wrap(FT_Incremental_Funcs.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Incremental_Funcs, Buffer> implements NativeResource {
         ...
         * by {@link FT_Incremental_Funcs#SIZEOF}, and its mark will be undefined.
         *
