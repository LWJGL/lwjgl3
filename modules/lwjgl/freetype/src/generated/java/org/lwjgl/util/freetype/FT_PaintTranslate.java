 ...
 * }</code></pre>
 */
public class FT_PaintTranslate extends Struct {
    ...
    public static FT_PaintTranslate create(long address) {
        return wrap(FT_PaintTranslate.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FT_PaintTranslate createSafe(long address) {
        return address == NULL ? null : wrap(FT_PaintTranslate.class, address);
    }
    ...
    public static class Buffer extends StructBuffer<FT_PaintTranslate, Buffer> {
         ...
         * by {@link FT_PaintTranslate#SIZEOF}, and its mark will be undefined.
         *
