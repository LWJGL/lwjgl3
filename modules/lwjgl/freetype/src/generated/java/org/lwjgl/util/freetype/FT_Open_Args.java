...
public class FT_Open_Args extends Struct implements NativeResource {
    ...
    public static FT_Open_Args malloc() {
        return wrap(FT_Open_Args.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Open_Args malloc(MemoryStack stack) {
        return wrap(FT_Open_Args.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Open_Args calloc(MemoryStack stack) {
        return wrap(FT_Open_Args.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Open_Args, Buffer> implements NativeResource {
         ...
         * by {@link FT_Open_Args#SIZEOF}, and its mark will be undefined.
         *
