 ...
 * }</code></pre>
 */
public class FT_Matrix extends Struct implements NativeResource {
    ...
    public static FT_Matrix malloc() {
        return wrap(FT_Matrix.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Matrix malloc(MemoryStack stack) {
        return wrap(FT_Matrix.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Matrix calloc(MemoryStack stack) {
        return wrap(FT_Matrix.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Matrix, Buffer> implements NativeResource {
         ...
         * by {@link FT_Matrix#SIZEOF}, and its mark will be undefined.
         *
