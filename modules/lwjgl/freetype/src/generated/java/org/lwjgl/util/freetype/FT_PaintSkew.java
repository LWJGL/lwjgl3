 ...
 * }</code></pre>
 */
public class FT_PaintSkew extends Struct {
    ...
    public static FT_PaintSkew create(long address) {
        return wrap(FT_PaintSkew.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FT_PaintSkew createSafe(long address) {
        return address == NULL ? null : wrap(FT_PaintSkew.class, address);
    }
    ...
    public static class Buffer extends StructBuffer<FT_PaintSkew, Buffer> {
         ...
         * by {@link FT_PaintSkew#SIZEOF}, and its mark will be undefined.
         *
