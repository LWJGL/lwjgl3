...
public class BDF_Property extends Struct implements NativeResource {
    ...
    public static BDF_Property malloc() {
        return wrap(BDF_Property.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static BDF_Property malloc(MemoryStack stack) {
        return wrap(BDF_Property.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static BDF_Property calloc(MemoryStack stack) {
        return wrap(BDF_Property.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<BDF_Property, Buffer> implements NativeResource {
         ...
         * by {@link BDF_Property#SIZEOF}, and its mark will be undefined.
         *
