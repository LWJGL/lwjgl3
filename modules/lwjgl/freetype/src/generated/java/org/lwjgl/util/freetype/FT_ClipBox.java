...
public class FT_ClipBox extends Struct implements NativeResource {
    ...
    public static FT_ClipBox malloc() {
        return wrap(FT_ClipBox.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_ClipBox malloc(MemoryStack stack) {
        return wrap(FT_ClipBox.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_ClipBox calloc(MemoryStack stack) {
        return wrap(FT_ClipBox.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_ClipBox, Buffer> implements NativeResource {
         ...
         * by {@link FT_ClipBox#SIZEOF}, and its mark will be undefined.
         *
