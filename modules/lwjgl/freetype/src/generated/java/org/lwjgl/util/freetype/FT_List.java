...
public class FT_List extends Struct {
    ...
    public static FT_List create(long address) {
        return wrap(FT_List.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FT_List createSafe(long address) {
        return address == NULL ? null : wrap(FT_List.class, address);
    }
    ...
    public static class Buffer extends StructBuffer<FT_List, Buffer> {
         ...
         * by {@link FT_List#SIZEOF}, and its mark will be undefined.
         *
