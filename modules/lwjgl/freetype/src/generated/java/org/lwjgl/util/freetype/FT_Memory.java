...
public class FT_Memory extends Struct implements NativeResource {
    ...
    public static FT_Memory malloc() {
        return wrap(FT_Memory.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Memory malloc(MemoryStack stack) {
        return wrap(FT_Memory.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Memory calloc(MemoryStack stack) {
        return wrap(FT_Memory.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Memory, Buffer> implements NativeResource {
         ...
         * by {@link FT_Memory#SIZEOF}, and its mark will be undefined.
         *
