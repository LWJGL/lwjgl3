...
public class FT_COLR_Paint extends Struct implements NativeResource {
    ...
    public static FT_COLR_Paint malloc() {
        return wrap(FT_COLR_Paint.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_COLR_Paint calloc() {
        return wrap(FT_COLR_Paint.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@code FT_COLR_Paint} instance allocated with {@link BufferUtils}. */
    public static FT_COLR_Paint create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(FT_COLR_Paint.class, memAddress(container), container);
    }
    ...
    public static FT_COLR_Paint create(long address) {
        return wrap(FT_COLR_Paint.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FT_COLR_Paint createSafe(long address) {
        return address == NULL ? null : wrap(FT_COLR_Paint.class, address);
    }
    ...
    public static FT_COLR_Paint malloc(MemoryStack stack) {
        return wrap(FT_COLR_Paint.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_COLR_Paint calloc(MemoryStack stack) {
        return wrap(FT_COLR_Paint.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_COLR_Paint, Buffer> implements NativeResource {
         ...
         * by {@link FT_COLR_Paint#SIZEOF}, and its mark will be undefined.
         *
