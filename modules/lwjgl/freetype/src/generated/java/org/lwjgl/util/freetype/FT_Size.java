...
public class FT_Size extends Struct implements NativeResource {
    ...
    public static FT_Size malloc() {
        return wrap(FT_Size.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Size malloc(MemoryStack stack) {
        return wrap(FT_Size.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Size calloc(MemoryStack stack) {
        return wrap(FT_Size.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Size, Buffer> implements NativeResource {
         ...
         * by {@link FT_Size#SIZEOF}, and its mark will be undefined.
         *
