...
public class FT_Stream extends Struct implements NativeResource {
    ...
    public static FT_Stream malloc() {
        return wrap(FT_Stream.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Stream malloc(MemoryStack stack) {
        return wrap(FT_Stream.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Stream calloc(MemoryStack stack) {
        return wrap(FT_Stream.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Stream, Buffer> implements NativeResource {
         ...
         * by {@link FT_Stream#SIZEOF}, and its mark will be undefined.
         *
