 ...
 * }</code></pre>
 */
public class FT_PaintGlyph extends Struct {
    ...
    public static FT_PaintGlyph create(long address) {
        return wrap(FT_PaintGlyph.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FT_PaintGlyph createSafe(long address) {
        return address == NULL ? null : wrap(FT_PaintGlyph.class, address);
    }
    ...
    public static class Buffer extends StructBuffer<FT_PaintGlyph, Buffer> {
         ...
         * by {@link FT_PaintGlyph#SIZEOF}, and its mark will be undefined.
         *
