 ...
 * }</code></pre>
 */
public class FT_MM_Var extends Struct implements NativeResource {
    ...
    public static FT_MM_Var malloc() {
        return wrap(FT_MM_Var.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_MM_Var malloc(MemoryStack stack) {
        return wrap(FT_MM_Var.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_MM_Var calloc(MemoryStack stack) {
        return wrap(FT_MM_Var.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_MM_Var, Buffer> implements NativeResource {
         ...
         * by {@link FT_MM_Var#SIZEOF}, and its mark will be undefined.
         *
