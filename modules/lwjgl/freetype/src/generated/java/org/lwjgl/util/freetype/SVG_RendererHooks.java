...
public class SVG_RendererHooks extends Struct implements NativeResource {
    ...
    public static SVG_RendererHooks malloc() {
        return wrap(SVG_RendererHooks.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static SVG_RendererHooks calloc() {
        return wrap(SVG_RendererHooks.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static SVG_RendererHooks create() {
        ...
        return wrap(SVG_RendererHooks.class, memAddress(container), container);
    }
    ...
    public static SVG_RendererHooks create(long address) {
        return wrap(SVG_RendererHooks.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static SVG_RendererHooks createSafe(long address) {
        return address == NULL ? null : wrap(SVG_RendererHooks.class, address);
    }
    ...
    public static SVG_RendererHooks malloc(MemoryStack stack) {
        return wrap(SVG_RendererHooks.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static SVG_RendererHooks calloc(MemoryStack stack) {
        return wrap(SVG_RendererHooks.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<SVG_RendererHooks, Buffer> implements NativeResource {
         ...
         * by {@link SVG_RendererHooks#SIZEOF}, and its mark will be undefined.
         *
