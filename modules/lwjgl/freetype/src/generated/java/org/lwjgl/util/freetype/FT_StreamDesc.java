...
public class FT_StreamDesc extends Struct implements NativeResource {
    ...
    public static FT_StreamDesc malloc() {
        return wrap(FT_StreamDesc.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_StreamDesc calloc() {
        return wrap(FT_StreamDesc.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@code FT_StreamDesc} instance allocated with {@link BufferUtils}. */
    public static FT_StreamDesc create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(FT_StreamDesc.class, memAddress(container), container);
    }
    ...
    public static FT_StreamDesc create(long address) {
        return wrap(FT_StreamDesc.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FT_StreamDesc createSafe(long address) {
        return address == NULL ? null : wrap(FT_StreamDesc.class, address);
    }
    ...
    public static FT_StreamDesc malloc(MemoryStack stack) {
        return wrap(FT_StreamDesc.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_StreamDesc calloc(MemoryStack stack) {
        return wrap(FT_StreamDesc.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_StreamDesc, Buffer> implements NativeResource {
         ...
         * by {@link FT_StreamDesc#SIZEOF}, and its mark will be undefined.
         *
