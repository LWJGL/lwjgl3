...
public class FT_Incremental_Interface extends Struct implements NativeResource {
    ...
    public static FT_Incremental_Interface malloc() {
        return wrap(FT_Incremental_Interface.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Incremental_Interface calloc() {
        return wrap(FT_Incremental_Interface.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FT_Incremental_Interface create() {
        ...
        return wrap(FT_Incremental_Interface.class, memAddress(container), container);
    }
    ...
    public static FT_Incremental_Interface create(long address) {
        return wrap(FT_Incremental_Interface.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FT_Incremental_Interface createSafe(long address) {
        return address == NULL ? null : wrap(FT_Incremental_Interface.class, address);
    }
    ...
    public static FT_Incremental_Interface malloc(MemoryStack stack) {
        return wrap(FT_Incremental_Interface.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Incremental_Interface calloc(MemoryStack stack) {
        return wrap(FT_Incremental_Interface.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Incremental_Interface, Buffer> implements NativeResource {
         ...
         * by {@link FT_Incremental_Interface#SIZEOF}, and its mark will be undefined.
         *
