...
public class FT_Data extends Struct implements NativeResource {
    ...
    public static FT_Data malloc() {
        return wrap(FT_Data.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Data malloc(MemoryStack stack) {
        return wrap(FT_Data.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Data calloc(MemoryStack stack) {
        return wrap(FT_Data.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Data, Buffer> implements NativeResource {
         ...
         * by {@link FT_Data#SIZEOF}, and its mark will be undefined.
         *
