 ...
 * }</code></pre>
 */
public class FT_Generic extends Struct implements NativeResource {
    ...
    public static FT_Generic malloc() {
        return wrap(FT_Generic.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Generic malloc(MemoryStack stack) {
        return wrap(FT_Generic.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Generic calloc(MemoryStack stack) {
        return wrap(FT_Generic.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Generic, Buffer> implements NativeResource {
         ...
         * by {@link FT_Generic#SIZEOF}, and its mark will be undefined.
         *
