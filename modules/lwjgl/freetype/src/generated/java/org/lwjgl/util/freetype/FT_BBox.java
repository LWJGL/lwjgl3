...
public class FT_BBox extends Struct implements NativeResource {
    ...
    public static FT_BBox malloc() {
        return wrap(FT_BBox.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_BBox malloc(MemoryStack stack) {
        return wrap(FT_BBox.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_BBox calloc(MemoryStack stack) {
        return wrap(FT_BBox.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_BBox, Buffer> implements NativeResource {
         ...
         * by {@link FT_BBox#SIZEOF}, and its mark will be undefined.
         *
