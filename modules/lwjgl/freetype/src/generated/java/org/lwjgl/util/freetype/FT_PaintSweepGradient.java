 ...
 * }</code></pre>
 */
public class FT_PaintSweepGradient extends Struct {
    ...
    public static FT_PaintSweepGradient create(long address) {
        return wrap(FT_PaintSweepGradient.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FT_PaintSweepGradient createSafe(long address) {
        return address == NULL ? null : wrap(FT_PaintSweepGradient.class, address);
    }
    ...
    public static class Buffer extends StructBuffer<FT_PaintSweepGradient, Buffer> {
         ...
         * by {@link FT_PaintSweepGradient#SIZEOF}, and its mark will be undefined.
         *
