...
public class FT_Raster_Params extends Struct implements NativeResource {
    ...
    public static FT_Raster_Params malloc() {
        return wrap(FT_Raster_Params.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static FT_Raster_Params calloc() {
        return wrap(FT_Raster_Params.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static FT_Raster_Params create() {
        ...
        return wrap(FT_Raster_Params.class, memAddress(container), container);
    }
    ...
    public static FT_Raster_Params create(long address) {
        return wrap(FT_Raster_Params.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FT_Raster_Params createSafe(long address) {
        return address == NULL ? null : wrap(FT_Raster_Params.class, address);
    }
    ...
    public static FT_Raster_Params malloc(MemoryStack stack) {
        return wrap(FT_Raster_Params.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static FT_Raster_Params calloc(MemoryStack stack) {
        return wrap(FT_Raster_Params.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<FT_Raster_Params, Buffer> implements NativeResource {
         ...
         * by {@link FT_Raster_Params#SIZEOF}, and its mark will be undefined.
         *
