...
public class FT_GlyphSlot extends Struct {
    ...
    public static FT_GlyphSlot create(long address) {
        return wrap(FT_GlyphSlot.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static FT_GlyphSlot createSafe(long address) {
        return address == NULL ? null : wrap(FT_GlyphSlot.class, address);
    }
    ...
    public static class Buffer extends StructBuffer<FT_GlyphSlot, Buffer> {
         ...
         * by {@link FT_GlyphSlot#SIZEOF}, and its mark will be undefined.
         *
