...
/**
 * Marks a {@code long} parameter or return value as a raw pointer.
 *
 * <p>Such values will be treated as 64-bit values on 64-bit platforms ({@link ValueLayout#JAVA_LONG}) and 32-bit values on 32-bit platforms
