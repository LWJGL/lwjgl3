...
val NV_memory_attachment = "NVMemoryAttachment".nativeClassGLES("NV_memory_attachment", postfix = NV) {
    documentation =
        """
        ...
        Requires ${EXT_memory_object.link} and ${EXT_texture_storage.link} or a version of OpenGL ES that incorporates it.
        """
