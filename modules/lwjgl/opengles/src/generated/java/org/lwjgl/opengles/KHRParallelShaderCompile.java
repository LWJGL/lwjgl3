...
public class KHRParallelShaderCompile {
     ...
     * 
     * <p>An application can query the current {@code MaxShaderCompilerThreadsKHR} {@code count} by calling {@link GLES20#glGetIntegerv GetIntegerv} with {@code pname} set to
