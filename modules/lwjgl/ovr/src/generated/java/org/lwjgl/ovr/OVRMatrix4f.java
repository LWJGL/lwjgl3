...
public class OVRMatrix4f extends Struct implements NativeResource {
    ...
    /** Returns a new {@code OVRMatrix4f} instance allocated on the thread-local {@link MemoryStack}. */
    public static OVRMatrix4f mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code OVRMatrix4f} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
