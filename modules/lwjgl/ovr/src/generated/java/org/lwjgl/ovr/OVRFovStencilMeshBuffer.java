...
public class OVRFovStencilMeshBuffer extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link OVRFovStencilMeshBuffer} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link OVRFovStencilMeshBuffer} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static OVRFovStencilMeshBuffer malloc() {
        return wrap(OVRFovStencilMeshBuffer.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link OVRFovStencilMeshBuffer} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static OVRFovStencilMeshBuffer calloc() {
        return wrap(OVRFovStencilMeshBuffer.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link OVRFovStencilMeshBuffer} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link OVRFovStencilMeshBuffer} instance for the specified memory address. */
    ...
    /** Returns a new {@link OVRFovStencilMeshBuffer} instance allocated on the thread-local {@link MemoryStack}. */
    public static OVRFovStencilMeshBuffer mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link OVRFovStencilMeshBuffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static OVRFovStencilMeshBuffer callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link OVRFovStencilMeshBuffer} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link OVRFovStencilMeshBuffer} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<OVRFovStencilMeshBuffer, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link OVRFovStencilMeshBuffer.Buffer} instance backed by the specified container.
         *
