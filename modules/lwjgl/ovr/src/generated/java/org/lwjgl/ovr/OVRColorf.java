...
public class OVRColorf extends Struct<OVRColorf> implements NativeResource {
    ...
    public static OVRColorf malloc() {
        return new OVRColorf(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<OVRColorf, Buffer> implements NativeResource {
         ...
         * by {@link OVRColorf#SIZEOF}, and its mark will be undefined.</p>
         *
