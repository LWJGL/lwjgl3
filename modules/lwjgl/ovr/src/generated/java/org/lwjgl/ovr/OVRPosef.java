...
public class OVRPosef extends Struct<OVRPosef> implements NativeResource {
    ...
    protected OVRPosef(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected OVRPosef create(long address, @Nullable ByteBuffer container) {
    ...
    /** @return a {@link OVRVector3f} view of the {@code Position} field. */
    ...
    public static OVRPosef malloc() {
        return new OVRPosef(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static OVRPosef.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static OVRPosef malloc(MemoryStack stack) {
        return new OVRPosef(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static OVRPosef calloc(MemoryStack stack) {
        return new OVRPosef(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<OVRPosef, Buffer> implements NativeResource {
         ...
         * by {@link OVRPosef#SIZEOF}, and its mark will be undefined.</p>
         *
