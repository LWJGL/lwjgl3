...
public class OVRQuatf extends Struct<OVRQuatf> implements NativeResource {
    ...
    protected OVRQuatf(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected OVRQuatf create(long address, @Nullable ByteBuffer container) {
    ...
    public static OVRQuatf malloc() {
        return new OVRQuatf(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static OVRQuatf malloc(MemoryStack stack) {
        return new OVRQuatf(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static OVRQuatf calloc(MemoryStack stack) {
        return new OVRQuatf(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<OVRQuatf, Buffer> implements NativeResource {
         ...
         * by {@link OVRQuatf#SIZEOF}, and its mark will be undefined.</p>
         *
