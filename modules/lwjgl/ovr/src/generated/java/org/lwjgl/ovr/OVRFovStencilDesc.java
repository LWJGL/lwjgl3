...
public class OVRFovStencilDesc extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link OVRFovStencilDesc} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link OVRFovStencilDesc} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static OVRFovStencilDesc malloc() {
        return wrap(OVRFovStencilDesc.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link OVRFovStencilDesc} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static OVRFovStencilDesc calloc() {
        return wrap(OVRFovStencilDesc.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link OVRFovStencilDesc} instance allocated with {@link BufferUtils}. */
    public static OVRFovStencilDesc create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(OVRFovStencilDesc.class, memAddress(container), container);
    }

    /** Returns a new {@link OVRFovStencilDesc} instance for the specified memory address. */
    ...
    /** Returns a new {@link OVRFovStencilDesc} instance allocated on the thread-local {@link MemoryStack}. */
    public static OVRFovStencilDesc mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link OVRFovStencilDesc} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static OVRFovStencilDesc callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link OVRFovStencilDesc} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link OVRFovStencilDesc} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<OVRFovStencilDesc, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link OVRFovStencilDesc.Buffer} instance backed by the specified container.
         *
