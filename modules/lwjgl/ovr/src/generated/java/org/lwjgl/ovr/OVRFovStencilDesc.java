...
public class OVRFovStencilDesc extends Struct<OVRFovStencilDesc> implements NativeResource {
    ...
    public static OVRFovStencilDesc malloc() {
        return new OVRFovStencilDesc(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static OVRFovStencilDesc calloc() {
        return new OVRFovStencilDesc(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static OVRFovStencilDesc create() {
        ...
        return new OVRFovStencilDesc(memAddress(container), container);
    }
    ...
    public static class Buffer extends StructBuffer<OVRFovStencilDesc, Buffer> implements NativeResource {
         ...
         * by {@link OVRFovStencilDesc#SIZEOF}, and its mark will be undefined.</p>
         *
