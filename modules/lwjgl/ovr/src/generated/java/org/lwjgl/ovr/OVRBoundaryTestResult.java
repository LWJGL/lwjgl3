...
public class OVRBoundaryTestResult extends Struct<OVRBoundaryTestResult> implements NativeResource {
    ...
    public static OVRBoundaryTestResult malloc() {
        return new OVRBoundaryTestResult(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static OVRBoundaryTestResult calloc() {
        return new OVRBoundaryTestResult(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static OVRBoundaryTestResult create() {
        ...
        return new OVRBoundaryTestResult(memAddress(container), container);
    }
    ...
    public static class Buffer extends StructBuffer<OVRBoundaryTestResult, Buffer> implements NativeResource {
         ...
         * by {@link OVRBoundaryTestResult#SIZEOF}, and its mark will be undefined.</p>
         *
