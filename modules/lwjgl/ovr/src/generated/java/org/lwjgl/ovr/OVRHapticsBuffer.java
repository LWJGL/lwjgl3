...
public class OVRHapticsBuffer extends Struct<OVRHapticsBuffer> implements NativeResource {
    ...
    /** @return the value of the {@code SubmitMode} field. */
    ...
    public static OVRHapticsBuffer malloc() {
        return new OVRHapticsBuffer(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static OVRHapticsBuffer calloc() {
        return new OVRHapticsBuffer(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static OVRHapticsBuffer create() {
        ...
        return new OVRHapticsBuffer(memAddress(container), container);
    }
    ...
    public static class Buffer extends StructBuffer<OVRHapticsBuffer, Buffer> implements NativeResource {
         ...
         * by {@link OVRHapticsBuffer#SIZEOF}, and its mark will be undefined.</p>
         *
