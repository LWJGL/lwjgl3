...
public class OVRLayerEyeFov extends Struct implements NativeResource {
    ...
    /** Returns a new {@code OVRLayerEyeFov} instance allocated on the thread-local {@link MemoryStack}. */
    public static OVRLayerEyeFov mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code OVRLayerEyeFov} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
