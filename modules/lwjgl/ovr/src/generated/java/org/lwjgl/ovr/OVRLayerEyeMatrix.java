 ...
 *     {@link OVRMatrix4f ovrMatrix4f} Matrix;
 * }}</pre>
 */
...
public class OVRLayerEyeMatrix extends Struct<OVRLayerEyeMatrix> implements NativeResource {
    ...
    /** @return a {@link OVRMatrix4f} view of the {@code Matrix} field. */
    @NativeType("ovrMatrix4f")
    public OVRMatrix4f Matrix() { return nMatrix(address()); }
    ...
    /** Copies the specified {@link OVRMatrix4f} to the {@code Matrix} field. */
    public OVRLayerEyeMatrix Matrix(@NativeType("ovrMatrix4f") OVRMatrix4f value) { nMatrix(address(), value); return this; }
    /** Passes the {@code Matrix} field to the specified {@link java.util.function.Consumer Consumer}. */
    public OVRLayerEyeMatrix Matrix(java.util.function.Consumer<OVRMatrix4f> consumer) { consumer.accept(Matrix()); return this; }
    ...
    public static OVRMatrix4f nMatrix(long struct) { return OVRMatrix4f.create(struct + OVRLayerEyeMatrix.MATRIX); }
    ...
    /** Unsafe version of {@link #Matrix(OVRMatrix4f) Matrix}. */
    public static void nMatrix(long struct, OVRMatrix4f value) { memCopy(value.address(), struct + OVRLayerEyeMatrix.MATRIX, OVRMatrix4f.SIZEOF); }
    ...
    public static class Buffer extends StructBuffer<OVRLayerEyeMatrix, Buffer> implements NativeResource {
         ...
         * by {@link OVRLayerEyeMatrix#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        /** @return a {@link OVRMatrix4f} view of the {@code Matrix} field. */
        @NativeType("ovrMatrix4f")
        public OVRMatrix4f Matrix() { return OVRLayerEyeMatrix.nMatrix(address()); }
        ...
        /** Copies the specified {@link OVRMatrix4f} to the {@code Matrix} field. */
        public OVRLayerEyeMatrix.Buffer Matrix(@NativeType("ovrMatrix4f") OVRMatrix4f value) { OVRLayerEyeMatrix.nMatrix(address(), value); return this; }
        /** Passes the {@code Matrix} field to the specified {@link java.util.function.Consumer Consumer}. */
        public OVRLayerEyeMatrix.Buffer Matrix(java.util.function.Consumer<OVRMatrix4f> consumer) { consumer.accept(Matrix()); return this; }
