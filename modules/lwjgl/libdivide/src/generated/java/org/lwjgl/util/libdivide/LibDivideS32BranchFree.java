...
public class LibDivideS32BranchFree extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link LibDivideS32BranchFree} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link LibDivideS32BranchFree} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static LibDivideS32BranchFree malloc() {
        return wrap(LibDivideS32BranchFree.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link LibDivideS32BranchFree} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static LibDivideS32BranchFree calloc() {
        return wrap(LibDivideS32BranchFree.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link LibDivideS32BranchFree} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link LibDivideS32BranchFree} instance for the specified memory address. */
    ...
    /** Returns a new {@link LibDivideS32BranchFree} instance allocated on the thread-local {@link MemoryStack}. */
    public static LibDivideS32BranchFree mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link LibDivideS32BranchFree} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static LibDivideS32BranchFree callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link LibDivideS32BranchFree} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link LibDivideS32BranchFree} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<LibDivideS32BranchFree, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link LibDivideS32BranchFree.Buffer} instance backed by the specified container.
         *
