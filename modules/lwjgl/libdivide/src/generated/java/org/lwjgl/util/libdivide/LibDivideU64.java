...
public class LibDivideU64 extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link LibDivideU64} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link LibDivideU64} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static LibDivideU64 malloc() {
        return wrap(LibDivideU64.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link LibDivideU64} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static LibDivideU64 calloc() {
        return wrap(LibDivideU64.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link LibDivideU64} instance allocated with {@link BufferUtils}. */
    public static LibDivideU64 create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(LibDivideU64.class, memAddress(container), container);
    }

    /** Returns a new {@link LibDivideU64} instance for the specified memory address. */
    ...
    /** Returns a new {@link LibDivideU64} instance allocated on the thread-local {@link MemoryStack}. */
    public static LibDivideU64 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link LibDivideU64} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static LibDivideU64 callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link LibDivideU64} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link LibDivideU64} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static class Buffer extends StructBuffer<LibDivideU64, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link LibDivideU64.Buffer} instance backed by the specified container.
         *
