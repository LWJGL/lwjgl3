...
public class LibDivideU32 extends Struct implements NativeResource {
    ...
    /** Returns a new {@code LibDivideU32} instance allocated on the thread-local {@link MemoryStack}. */
    public static LibDivideU32 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code LibDivideU32} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
