...
public class LibDivideS64 extends Struct implements NativeResource {
    ...
    /** Returns a new {@code LibDivideS64} instance allocated on the thread-local {@link MemoryStack}. */
    public static LibDivideS64 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code LibDivideS64} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
