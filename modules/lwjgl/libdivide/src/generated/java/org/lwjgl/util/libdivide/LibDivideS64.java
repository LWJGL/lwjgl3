...
public class LibDivideS64 extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link LibDivideS64} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link LibDivideS64} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static LibDivideS64 malloc() {
        return wrap(LibDivideS64.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link LibDivideS64} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static LibDivideS64 calloc() {
        return wrap(LibDivideS64.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link LibDivideS64} instance allocated with {@link BufferUtils}. */
    public static LibDivideS64 create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(LibDivideS64.class, memAddress(container), container);
    }

    /** Returns a new {@link LibDivideS64} instance for the specified memory address. */
    ...
    /** Returns a new {@link LibDivideS64} instance allocated on the thread-local {@link MemoryStack}. */
    public static LibDivideS64 mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link LibDivideS64} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static LibDivideS64 callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link LibDivideS64} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link LibDivideS64} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link LibDivideS64.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link LibDivideS64.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static LibDivideS64.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static LibDivideS64.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<LibDivideS64, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link LibDivideS64.Buffer} instance backed by the specified container.
         *
