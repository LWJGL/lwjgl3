...
public class LibDivideU32BranchFree extends Struct implements NativeResource {
    ...
    /** Returns a new {@code LibDivideU32BranchFree} instance allocated on the thread-local {@link MemoryStack}. */
    public static LibDivideU32BranchFree mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code LibDivideU32BranchFree} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
