...
public class LibDivideU32BranchFree extends Struct<LibDivideU32BranchFree> implements NativeResource {
    ...
    protected LibDivideU32BranchFree(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected LibDivideU32BranchFree create(long address, @Nullable ByteBuffer container) {
        return new LibDivideU32BranchFree(address, container);
    }
    ...
    public static LibDivideU32BranchFree malloc() {
        return new LibDivideU32BranchFree(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static LibDivideU32BranchFree calloc() {
        return new LibDivideU32BranchFree(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static LibDivideU32BranchFree create() {
        ...
        return new LibDivideU32BranchFree(memAddress(container), container);
    }
    ...
    public static LibDivideU32BranchFree create(long address) {
        return new LibDivideU32BranchFree(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static @Nullable LibDivideU32BranchFree createSafe(long address) {
        return address == NULL ? null : new LibDivideU32BranchFree(address, null);
    }
    ...
    public static LibDivideU32BranchFree.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static LibDivideU32BranchFree malloc(MemoryStack stack) {
        return new LibDivideU32BranchFree(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static LibDivideU32BranchFree calloc(MemoryStack stack) {
        return new LibDivideU32BranchFree(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<LibDivideU32BranchFree, Buffer> implements NativeResource {
         ...
         * by {@link LibDivideU32BranchFree#SIZEOF}, and its mark will be undefined.</p>
         *
