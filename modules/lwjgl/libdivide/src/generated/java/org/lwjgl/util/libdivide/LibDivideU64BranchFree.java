...
public class LibDivideU64BranchFree extends Struct implements NativeResource {
    ...
    /** Returns a new {@code LibDivideU64BranchFree} instance allocated on the thread-local {@link MemoryStack}. */
    public static LibDivideU64BranchFree mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code LibDivideU64BranchFree} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
