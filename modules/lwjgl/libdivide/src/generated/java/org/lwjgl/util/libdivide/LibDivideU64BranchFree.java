...
public class LibDivideU64BranchFree extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link LibDivideU64BranchFree} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link LibDivideU64BranchFree} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static LibDivideU64BranchFree malloc() {
        return wrap(LibDivideU64BranchFree.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link LibDivideU64BranchFree} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static LibDivideU64BranchFree calloc() {
        return wrap(LibDivideU64BranchFree.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link LibDivideU64BranchFree} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link LibDivideU64BranchFree} instance for the specified memory address. */
    ...
    /** Returns a new {@link LibDivideU64BranchFree} instance allocated on the thread-local {@link MemoryStack}. */
    public static LibDivideU64BranchFree mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link LibDivideU64BranchFree} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static LibDivideU64BranchFree callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link LibDivideU64BranchFree} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack the stack from which to allocate
     */
    public static LibDivideU64BranchFree mallocStack(MemoryStack stack) {
        return wrap(LibDivideU64BranchFree.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }

    /**
     * Returns a new {@link LibDivideU64BranchFree} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    public static LibDivideU64BranchFree callocStack(MemoryStack stack) {
        return wrap(LibDivideU64BranchFree.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    /**
     * Returns a new {@link LibDivideU64BranchFree.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static LibDivideU64BranchFree.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link LibDivideU64BranchFree.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static LibDivideU64BranchFree.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static LibDivideU64BranchFree.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static LibDivideU64BranchFree.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<LibDivideU64BranchFree, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link LibDivideU64BranchFree.Buffer} instance backed by the specified container.
         *
