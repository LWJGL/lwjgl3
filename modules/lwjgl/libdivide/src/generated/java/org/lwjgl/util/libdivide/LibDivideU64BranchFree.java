...
public class LibDivideU64BranchFree extends Struct<LibDivideU64BranchFree> implements NativeResource {
    ...
    protected LibDivideU64BranchFree(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected LibDivideU64BranchFree create(long address, @Nullable ByteBuffer container) {
        return new LibDivideU64BranchFree(address, container);
    }
    ...
    public static LibDivideU64BranchFree malloc() {
        return new LibDivideU64BranchFree(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static LibDivideU64BranchFree calloc() {
        return new LibDivideU64BranchFree(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static LibDivideU64BranchFree create() {
        ...
        return new LibDivideU64BranchFree(memAddress(container), container);
    }
    ...
    public static LibDivideU64BranchFree create(long address) {
        return new LibDivideU64BranchFree(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static @Nullable LibDivideU64BranchFree createSafe(long address) {
        return address == NULL ? null : new LibDivideU64BranchFree(address, null);
    }
    ...
    public static LibDivideU64BranchFree.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static LibDivideU64BranchFree malloc(MemoryStack stack) {
        return new LibDivideU64BranchFree(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static LibDivideU64BranchFree calloc(MemoryStack stack) {
        return new LibDivideU64BranchFree(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static long nmagic(long struct) { return memGetLong(struct + LibDivideU64BranchFree.MAGIC); }
    /** Unsafe version of {@link #more}. */
    public static byte nmore(long struct) { return memGetByte(struct + LibDivideU64BranchFree.MORE); }

    /** Unsafe version of {@link #magic(long) magic}. */
    public static void nmagic(long struct, long value) { memPutLong(struct + LibDivideU64BranchFree.MAGIC, value); }
    /** Unsafe version of {@link #more(byte) more}. */
    public static void nmore(long struct, byte value) { memPutByte(struct + LibDivideU64BranchFree.MORE, value); }
    ...
    public static class Buffer extends StructBuffer<LibDivideU64BranchFree, Buffer> implements NativeResource {
         ...
         * by {@link LibDivideU64BranchFree#SIZEOF}, and its mark will be undefined.</p>
         *
