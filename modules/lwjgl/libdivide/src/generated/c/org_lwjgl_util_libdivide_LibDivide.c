...
JNIEXPORT void JNICALL Java_org_lwjgl_util_libdivide_LibDivide_nlibdivide_1s32_1gen(JNIEnv *__env, jclass clazz, jint y, jlong __result) {
    UNUSED_PARAMS(__env, clazz)
    *((struct libdivide_s32_t*)(intptr_t)__result) = libdivide_s32_gen((int32_t)y);
}

JNIEXPORT void JNICALL Java_org_lwjgl_util_libdivide_LibDivide_nlibdivide_1u32_1gen(JNIEnv *__env, jclass clazz, jint y, jlong __result) {
    UNUSED_PARAMS(__env, clazz)
    *((struct libdivide_u32_t*)(intptr_t)__result) = libdivide_u32_gen((uint32_t)y);
}

JNIEXPORT void JNICALL Java_org_lwjgl_util_libdivide_LibDivide_nlibdivide_1s64_1gen(JNIEnv *__env, jclass clazz, jlong y, jlong __result) {
    UNUSED_PARAMS(__env, clazz)
    *((struct libdivide_s64_t*)(intptr_t)__result) = libdivide_s64_gen((int64_t)y);
}

JNIEXPORT void JNICALL Java_org_lwjgl_util_libdivide_LibDivide_nlibdivide_1u64_1gen(JNIEnv *__env, jclass clazz, jlong y, jlong __result) {
    UNUSED_PARAMS(__env, clazz)
    *((struct libdivide_u64_t*)(intptr_t)__result) = libdivide_u64_gen((uint64_t)y);
}

JNIEXPORT void JNICALL Java_org_lwjgl_util_libdivide_LibDivide_nlibdivide_1s32_1branchfree_1gen(JNIEnv *__env, jclass clazz, jint y, jlong __result) {
    UNUSED_PARAMS(__env, clazz)
    *((struct libdivide_s32_branchfree_t*)(intptr_t)__result) = libdivide_s32_branchfree_gen((int32_t)y);
}

JNIEXPORT void JNICALL Java_org_lwjgl_util_libdivide_LibDivide_nlibdivide_1u32_1branchfree_1gen(JNIEnv *__env, jclass clazz, jint y, jlong __result) {
    UNUSED_PARAMS(__env, clazz)
    *((struct libdivide_u32_branchfree_t*)(intptr_t)__result) = libdivide_u32_branchfree_gen((uint32_t)y);
}

JNIEXPORT void JNICALL Java_org_lwjgl_util_libdivide_LibDivide_nlibdivide_1s64_1branchfree_1gen(JNIEnv *__env, jclass clazz, jlong y, jlong __result) {
    UNUSED_PARAMS(__env, clazz)
    *((struct libdivide_s64_branchfree_t*)(intptr_t)__result) = libdivide_s64_branchfree_gen((int64_t)y);
}

JNIEXPORT void JNICALL Java_org_lwjgl_util_libdivide_LibDivide_nlibdivide_1u64_1branchfree_1gen(JNIEnv *__env, jclass clazz, jlong y, jlong __result) {
    UNUSED_PARAMS(__env, clazz)
    *((struct libdivide_u64_branchfree_t*)(intptr_t)__result) = libdivide_u64_branchfree_gen((uint64_t)y);
}
...
JNIEXPORT jlong JNICALL Java_org_lwjgl_util_libdivide_LibDivide_nlibdivide_1u64_1do_1ref(JNIEnv *__env, jclass clazz, jlong y, jlong denomAddress) {
    struct libdivide_u64_t const *denom = (struct libdivide_u64_t const *)(intptr_t)denomAddress;
    UNUSED_PARAMS(__env, clazz)
    return (jlong)libdivide_u64_do((uint64_t)y, denom);
}
...
JNIEXPORT jlong JNICALL Java_org_lwjgl_util_libdivide_LibDivide_nlibdivide_1u64_1branchfree_1do_1ref(JNIEnv *__env, jclass clazz, jlong y, jlong denomAddress) {
    struct libdivide_u64_branchfree_t const *denom = (struct libdivide_u64_branchfree_t const *)(intptr_t)denomAddress;
    UNUSED_PARAMS(__env, clazz)
    return (jlong)libdivide_u64_branchfree_do((uint64_t)y, denom);
}
