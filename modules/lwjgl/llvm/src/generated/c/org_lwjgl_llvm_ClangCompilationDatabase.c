...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangCompilationDatabase_nclang_1CompileCommand_1getDirectory(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong commandAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangCompilationDatabase_nclang_1CompileCommand_1getFilename(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong commandAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangCompilationDatabase_nclang_1CompileCommand_1getArg(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong commandAddress, jint I, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangCompilationDatabase_nclang_1CompileCommand_1getMappedSourcePath(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong commandAddress, jint I, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangCompilationDatabase_nclang_1CompileCommand_1getMappedSourceContent(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong commandAddress, jint I, jlong __result) {
