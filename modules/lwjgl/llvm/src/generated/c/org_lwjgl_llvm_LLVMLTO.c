...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_LLVMLTO_nthinlto_1module_1get_1object(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong cgAddress, jint index, jlong __result) {
