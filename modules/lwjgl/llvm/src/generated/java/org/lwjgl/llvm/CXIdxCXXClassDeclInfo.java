...
public class CXIdxCXXClassDeclInfo extends Struct {
    ...
    /**
     * Creates a {@link CXIdxCXXClassDeclInfo} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CXIdxCXXClassDeclInfo} instance for the specified memory address. */
    ...
    public static class Buffer extends StructBuffer<CXIdxCXXClassDeclInfo, Buffer> {
        ...
        /**
         * Creates a new {@link CXIdxCXXClassDeclInfo.Buffer} instance backed by the specified container.
         *
