...
public class CXIdxIncludedFileInfo extends Struct {
    ...
    /**
     * Creates a {@link CXIdxIncludedFileInfo} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CXIdxIncludedFileInfo} instance for the specified memory address. */
    ...
    public static class Buffer extends StructBuffer<CXIdxIncludedFileInfo, Buffer> {
        ...
        /**
         * Creates a new {@link CXIdxIncludedFileInfo.Buffer} instance backed by the specified container.
         *
