...
public class CXIdxObjCContainerDeclInfo extends Struct {
    ...
    /**
     * Creates a {@link CXIdxObjCContainerDeclInfo} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CXIdxObjCContainerDeclInfo} instance for the specified memory address. */
    ...
    public static class Buffer extends StructBuffer<CXIdxObjCContainerDeclInfo, Buffer> {
        ...
        /**
         * Creates a new {@link CXIdxObjCContainerDeclInfo.Buffer} instance backed by the specified container.
         *
