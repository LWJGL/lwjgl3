...
public class CXString extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link CXString} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CXString} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static CXString malloc() {
        return wrap(CXString.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link CXString} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static CXString calloc() {
        return wrap(CXString.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link CXString} instance allocated with {@link BufferUtils}. */
    public static CXString create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(CXString.class, memAddress(container), container);
    }

    /** Returns a new {@link CXString} instance for the specified memory address. */
    ...
    /** Returns a new {@link CXString} instance allocated on the thread-local {@link MemoryStack}. */
    public static CXString mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link CXString} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CXString callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link CXString} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link CXString} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link CXString.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link CXString.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static CXString.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static CXString.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<CXString, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link CXString.Buffer} instance backed by the specified container.
         *
