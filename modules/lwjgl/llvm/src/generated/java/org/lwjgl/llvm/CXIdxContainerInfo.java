...
public class CXIdxContainerInfo extends Struct implements NativeResource {
    ...
    /**
     * Returns a new {@link CXIdxContainerInfo.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link CXIdxContainerInfo.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static CXIdxContainerInfo.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static CXIdxContainerInfo.Buffer callocStack(int capacity, MemoryStack stack) {
