...
public class LLVMOptRemarkArg extends Struct {
    ...
    /**
     * Creates a {@link LLVMOptRemarkArg} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link LLVMOptRemarkArg} instance for the specified memory address. */
    ...
    public static class Buffer extends StructBuffer<LLVMOptRemarkArg, Buffer> {
        ...
        /**
         * Creates a new {@link LLVMOptRemarkArg.Buffer} instance backed by the specified container.
         *
