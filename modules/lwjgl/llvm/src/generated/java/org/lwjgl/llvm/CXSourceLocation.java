...
public class CXSourceLocation extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link CXSourceLocation} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CXSourceLocation} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static CXSourceLocation malloc() {
        return wrap(CXSourceLocation.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link CXSourceLocation} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static CXSourceLocation calloc() {
        return wrap(CXSourceLocation.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link CXSourceLocation} instance allocated with {@link BufferUtils}. */
    public static CXSourceLocation create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(CXSourceLocation.class, memAddress(container), container);
    }

    /** Returns a new {@link CXSourceLocation} instance for the specified memory address. */
    ...
    /** Returns a new {@link CXSourceLocation} instance allocated on the thread-local {@link MemoryStack}. */
    public static CXSourceLocation mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link CXSourceLocation} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CXSourceLocation callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link CXSourceLocation} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link CXSourceLocation} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link CXSourceLocation.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link CXSourceLocation.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static CXSourceLocation.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static CXSourceLocation.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<CXSourceLocation, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link CXSourceLocation.Buffer} instance backed by the specified container.
         *
