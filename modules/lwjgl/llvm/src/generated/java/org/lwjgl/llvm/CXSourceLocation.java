...
public class CXSourceLocation extends Struct implements NativeResource {
    ...
    /** Returns a new {@code CXSourceLocation} instance allocated on the thread-local {@link MemoryStack}. */
    public static CXSourceLocation mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code CXSourceLocation} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
