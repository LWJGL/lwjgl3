...
public class CXCursor extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link CXCursor} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CXCursor} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static CXCursor malloc() {
        return wrap(CXCursor.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link CXCursor} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static CXCursor calloc() {
        return wrap(CXCursor.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link CXCursor} instance allocated with {@link BufferUtils}. */
    public static CXCursor create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(CXCursor.class, memAddress(container), container);
    }

    /** Returns a new {@link CXCursor} instance for the specified memory address. */
    ...
    /** Returns a new {@link CXCursor} instance allocated on the thread-local {@link MemoryStack}. */
    public static CXCursor mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link CXCursor} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CXCursor callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link CXCursor} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link CXCursor} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link CXCursor.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link CXCursor.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static CXCursor.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static CXCursor.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<CXCursor, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link CXCursor.Buffer} instance backed by the specified container.
         *
