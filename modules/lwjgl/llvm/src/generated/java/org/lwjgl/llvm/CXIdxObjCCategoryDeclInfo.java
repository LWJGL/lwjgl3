...
public class CXIdxObjCCategoryDeclInfo extends Struct {
    ...
    /**
     * Creates a {@link CXIdxObjCCategoryDeclInfo} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CXIdxObjCCategoryDeclInfo} instance for the specified memory address. */
    ...
    public static class Buffer extends StructBuffer<CXIdxObjCCategoryDeclInfo, Buffer> {
        ...
        /**
         * Creates a new {@link CXIdxObjCCategoryDeclInfo.Buffer} instance backed by the specified container.
         *
