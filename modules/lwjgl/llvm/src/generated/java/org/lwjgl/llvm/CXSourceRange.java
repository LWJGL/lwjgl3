...
public class CXSourceRange extends Struct implements NativeResource {
    ...
    /** Returns a new {@code CXSourceRange} instance allocated on the thread-local {@link MemoryStack}. */
    public static CXSourceRange mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code CXSourceRange} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
