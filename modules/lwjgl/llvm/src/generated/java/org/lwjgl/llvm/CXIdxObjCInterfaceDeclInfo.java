...
public class CXIdxObjCInterfaceDeclInfo extends Struct {
    ...
    /**
     * Creates a {@link CXIdxObjCInterfaceDeclInfo} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CXIdxObjCInterfaceDeclInfo} instance for the specified memory address. */
    ...
    public static class Buffer extends StructBuffer<CXIdxObjCInterfaceDeclInfo, Buffer> {
        ...
        /**
         * Creates a new {@link CXIdxObjCInterfaceDeclInfo.Buffer} instance backed by the specified container.
         *
