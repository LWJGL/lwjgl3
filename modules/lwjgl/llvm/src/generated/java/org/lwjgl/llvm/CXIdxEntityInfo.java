...
public class CXIdxEntityInfo extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link CXIdxEntityInfo} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CXIdxEntityInfo} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static CXIdxEntityInfo malloc() {
        return wrap(CXIdxEntityInfo.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link CXIdxEntityInfo} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static CXIdxEntityInfo calloc() {
        return wrap(CXIdxEntityInfo.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link CXIdxEntityInfo} instance allocated with {@link BufferUtils}. */
    public static CXIdxEntityInfo create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(CXIdxEntityInfo.class, memAddress(container), container);
    }

    /** Returns a new {@link CXIdxEntityInfo} instance for the specified memory address. */
    ...
    /** Returns a new {@link CXIdxEntityInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static CXIdxEntityInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link CXIdxEntityInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CXIdxEntityInfo callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link CXIdxEntityInfo} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link CXIdxEntityInfo} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link CXIdxEntityInfo.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link CXIdxEntityInfo.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static CXIdxEntityInfo.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static CXIdxEntityInfo.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<CXIdxEntityInfo, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link CXIdxEntityInfo.Buffer} instance backed by the specified container.
         *
