 ...
 * }</code></pre>
 */
public class LLVMOrcCSymbolMapPair extends Struct implements NativeResource {
    ...
    public static LLVMOrcCSymbolMapPair malloc() {
        return wrap(LLVMOrcCSymbolMapPair.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static LLVMOrcCSymbolMapPair calloc() {
        return wrap(LLVMOrcCSymbolMapPair.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static LLVMOrcCSymbolMapPair create() {
        ...
        return wrap(LLVMOrcCSymbolMapPair.class, memAddress(container), container);
    }
    ...
    public static LLVMOrcCSymbolMapPair create(long address) {
        return wrap(LLVMOrcCSymbolMapPair.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static LLVMOrcCSymbolMapPair createSafe(long address) {
        return address == NULL ? null : wrap(LLVMOrcCSymbolMapPair.class, address);
    }
    ...
    public static LLVMOrcCSymbolMapPair malloc(MemoryStack stack) {
        return wrap(LLVMOrcCSymbolMapPair.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static LLVMOrcCSymbolMapPair calloc(MemoryStack stack) {
        return wrap(LLVMOrcCSymbolMapPair.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<LLVMOrcCSymbolMapPair, Buffer> implements NativeResource {
         ...
         * by {@link LLVMOrcCSymbolMapPair#SIZEOF}, and its mark will be undefined.
         *
