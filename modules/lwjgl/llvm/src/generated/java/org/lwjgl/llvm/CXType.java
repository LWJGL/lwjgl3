...
public class CXType extends Struct implements NativeResource {
    ...
    /** Returns a new {@code CXType} instance allocated on the thread-local {@link MemoryStack}. */
    public static CXType mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code CXType} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
