...
public class CXType extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link CXType} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CXType} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static CXType malloc() {
        return wrap(CXType.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link CXType} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static CXType calloc() {
        return wrap(CXType.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link CXType} instance allocated with {@link BufferUtils}. */
    public static CXType create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(CXType.class, memAddress(container), container);
    }

    /** Returns a new {@link CXType} instance for the specified memory address. */
    ...
    /** Returns a new {@link CXType} instance allocated on the thread-local {@link MemoryStack}. */
    public static CXType mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link CXType} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CXType callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link CXType} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link CXType} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link CXType.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static CXType.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link CXType.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static CXType.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static CXType.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static CXType.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<CXType, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link CXType.Buffer} instance backed by the specified container.
         *
