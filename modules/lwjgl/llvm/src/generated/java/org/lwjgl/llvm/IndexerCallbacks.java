 ...
 * 
 * <ul>
 * <li>{@code abortQuery} &ndash; called periodically to check whether indexing should be aborted. Should return 0 to continue, and non-zero to abort.</li>
 * <li>{@code diagnostic} &ndash; called at the end of indexing; passes the complete diagnostic set.</li>
 * <li>{@code ppIncludedFile} &ndash; called when a file gets {@code #included/#imported}</li>
 * <li>{@code importedASTFile} &ndash; 
 ...
 * is not already indexed, to initiate a new indexing job specific to the AST file.</p></li>
 * <li>{@code startedTranslationUnit} &ndash; called at the beginning of indexing a translation unit</li>
 * <li>{@code indexEntityReference} &ndash; called to index a reference of an entity</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class IndexerCallbacks extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link IndexerCallbacks} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns the value of the {@code ppIncludedFile} field. */
    ...
    /** Returns the value of the {@code importedASTFile} field. */
    ...
    /** Returns the value of the {@code startedTranslationUnit} field. */
    ...
    /** Returns the value of the {@code indexDeclaration} field. */
    ...
    /** Returns the value of the {@code indexEntityReference} field. */
    ...
    /** Returns a new {@link IndexerCallbacks} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static IndexerCallbacks malloc() {
        return wrap(IndexerCallbacks.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link IndexerCallbacks} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static IndexerCallbacks calloc() {
        return wrap(IndexerCallbacks.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link IndexerCallbacks} instance allocated with {@link BufferUtils}. */
    public static IndexerCallbacks create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(IndexerCallbacks.class, memAddress(container), container);
    }

    /** Returns a new {@link IndexerCallbacks} instance for the specified memory address. */
    ...
    /** Returns a new {@link IndexerCallbacks} instance allocated on the thread-local {@link MemoryStack}. */
    public static IndexerCallbacks mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link IndexerCallbacks} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static IndexerCallbacks callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link IndexerCallbacks} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link IndexerCallbacks} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link IndexerCallbacks.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link IndexerCallbacks.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static IndexerCallbacks.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static IndexerCallbacks.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<IndexerCallbacks, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link IndexerCallbacks.Buffer} instance backed by the specified container.
         *
