...
public class CXIdxAttrInfo extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link CXIdxAttrInfo} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@link CXIdxAttrInfo} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static CXIdxAttrInfo malloc() {
        return wrap(CXIdxAttrInfo.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link CXIdxAttrInfo} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static CXIdxAttrInfo calloc() {
        return wrap(CXIdxAttrInfo.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link CXIdxAttrInfo} instance allocated with {@link BufferUtils}. */
    public static CXIdxAttrInfo create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(CXIdxAttrInfo.class, memAddress(container), container);
    }

    /** Returns a new {@link CXIdxAttrInfo} instance for the specified memory address. */
    ...
    /** Returns a new {@link CXIdxAttrInfo} instance allocated on the thread-local {@link MemoryStack}. */
    public static CXIdxAttrInfo mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link CXIdxAttrInfo} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CXIdxAttrInfo callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link CXIdxAttrInfo} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link CXIdxAttrInfo} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link CXIdxAttrInfo.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static CXIdxAttrInfo.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link CXIdxAttrInfo.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static CXIdxAttrInfo.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static CXIdxAttrInfo.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static CXIdxAttrInfo.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<CXIdxAttrInfo, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link CXIdxAttrInfo.Buffer} instance backed by the specified container.
         *
