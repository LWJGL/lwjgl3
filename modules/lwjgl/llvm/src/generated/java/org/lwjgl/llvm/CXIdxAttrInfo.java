...
public class CXIdxAttrInfo extends Struct<CXIdxAttrInfo> implements NativeResource {
    ...
    public static CXIdxAttrInfo malloc() {
        return new CXIdxAttrInfo(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static CXIdxAttrInfo create(long address) {
        return new CXIdxAttrInfo(address, null);
    }
    ...
    public static CXIdxAttrInfo malloc(MemoryStack stack) {
        return new CXIdxAttrInfo(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static CXIdxAttrInfo calloc(MemoryStack stack) {
        return new CXIdxAttrInfo(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<CXIdxAttrInfo, Buffer> implements NativeResource {
         ...
         * by {@link CXIdxAttrInfo#SIZEOF}, and its mark will be undefined.</p>
         *
