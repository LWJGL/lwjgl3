 ...
 * 
 * <ul>
 * <li>{@code digest[16]} &ndash; the digest in canonical representation</li>
 * </ul>
 * 
 * <h3>Layout</h3>
 * 
...
public class XXH128Canonical extends Struct implements NativeResource {
    ...
    /** Returns a new {@code XXH128Canonical} instance allocated on the thread-local {@link MemoryStack}. */
    public static XXH128Canonical mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XXH128Canonical} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    ...
    /**
     * Returns a new {@link XXH128Canonical.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    public static XXH128Canonical.Buffer mallocStack(int capacity) {
        return mallocStack(capacity, stackGet());
    }

    /**
     * Returns a new {@link XXH128Canonical.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
    public static XXH128Canonical.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static XXH128Canonical.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static XXH128Canonical.Buffer callocStack(int capacity, MemoryStack stack) {
