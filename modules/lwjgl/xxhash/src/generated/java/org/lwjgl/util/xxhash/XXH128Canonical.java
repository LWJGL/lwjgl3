...
public class XXH128Canonical extends Struct<XXH128Canonical> implements NativeResource {
    ...
    public static XXH128Canonical malloc() {
        return new XXH128Canonical(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static XXH128Canonical calloc() {
        return new XXH128Canonical(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static XXH128Canonical create() {
        ...
        return new XXH128Canonical(memAddress(container), container);
    }
    ...
    public static class Buffer extends StructBuffer<XXH128Canonical, Buffer> implements NativeResource {
         ...
         * by {@link XXH128Canonical#SIZEOF}, and its mark will be undefined.</p>
         *
