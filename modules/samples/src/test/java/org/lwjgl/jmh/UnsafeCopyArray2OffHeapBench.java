...
public class UnsafeCopyArray2OffHeapBench {
    ...
    public void t0_byte_baseline() {
        UNSAFE.copyMemory(arrayB, Unsafe.ARRAY_BYTE_BASE_OFFSET, null, dst, length);
    }
    ...
    public void t1_short_baseline() {
        UNSAFE.copyMemory(arrayS, Unsafe.ARRAY_SHORT_BASE_OFFSET, null, dst, length);
    }
    ...
    public void t2_int_baseline() {
        UNSAFE.copyMemory(arrayI, Unsafe.ARRAY_INT_BASE_OFFSET, null, dst, length);
    }
    ...
    public void t3_long_baseline() {
        UNSAFE.copyMemory(arrayL, Unsafe.ARRAY_LONG_BASE_OFFSET, null, dst, length);
    }
    ...
    public void t4_float_baseline() {
        UNSAFE.copyMemory(arrayF, Unsafe.ARRAY_FLOAT_BASE_OFFSET, null, dst, length);
    }
    ...
    public void t5_double_baseline() {
        UNSAFE.copyMemory(arrayD, Unsafe.ARRAY_DOUBLE_BASE_OFFSET, null, dst, length);
    }
