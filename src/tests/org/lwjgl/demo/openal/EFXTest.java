...
public final class EFXTest {
    ...
    private static void silentTests() throws Exception {
        ...
        final IntBuffer contextAttribList = BufferUtils.createIntBuffer(16);
        ...
        final ALContext newContext = new ALContext(deviceContext, contextHandle);

        if (newContext == null) {
            throw new Exception("Failed to create context.");
        }
        final boolean contextCurResult = ALC10.alcMakeContextCurrent(newContext.getHandle());
        if (contextCurResult == false) {
    ...
    private static void playbackTest() throws Exception {
        ...
        // Add reverb effect
        final int effectSlot = EXTEfx.alGenAuxiliaryEffectSlots();
        final int reverbEffect = EXTEfx.alGenEffects();
        ...
        // Echo effect
        final int echoEffect = EXTEfx.alGenEffects();
