...
fun AMD_debug_output() = "AMDDebugOutput".nativeClassGL("AMD_debug_output") {
	nativeImport (
		"OpenGL.h"
	)
	...
	GLvoid.func(
		...
		mods(Callback("DEBUGPROCAMD"), nullable) _ GLDEBUGPROCAMD.IN("callback", "a callback function that will be called when a debug message is generated"),
