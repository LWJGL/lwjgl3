...
val NV_packed_depth_stencil = "NVPackedDepthStencil".nativeClassGL("NV_packed_depth_stencil", postfix = NV) {
	...
	IntConstant.block(
		"""
		Accepted by the {@code format} parameter of DrawPixels, ReadPixels,
    TexImage1D, TexImage2D, TexImage3D, TexSubImage1D, TexSubImage2D,
    TexSubImage3D, and GetTexImage, and by the {@code type} parameter of
    CopyPixels.
		""",
	...
	IntConstant.block(
		"""
		Accepted by the {@code type} parameter of DrawPixels, ReadPixels,
    TexImage1D, TexImage2D, TexImage3D, TexSubImage1D, TexSubImage2D,
