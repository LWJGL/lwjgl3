...
val ARB_vertex_program = "ARBVertexProgram".nativeClassGL("ARB_vertex_program", postfix = ARB) {
	...
	GLvoid.func("VertexAttrib1sARB", "Short version of #VertexAttrib1fARB()", VA_INDEX, GLshort.IN("x", VA_X))
	GLvoid.func(
		"VertexAttrib1fARB",
	...
	GLvoid.func("VertexAttrib1dARB", "Double version of #VertexAttrib1fARB()", VA_INDEX, GLdouble.IN("x", VA_X))

	GLvoid.func("VertexAttrib2sARB", "Short version of #VertexAttrib2fARB()", VA_INDEX, GLshort.IN("x", VA_X), GLshort.IN("y", VA_Y))
	GLvoid.func(
		"VertexAttrib2fARB",
	...
	GLvoid.func("VertexAttrib2dARB", "Double version of #VertexAttrib2fARB()", VA_INDEX, GLdouble.IN("x", VA_X), GLdouble.IN("y", VA_Y))

	GLvoid.func("VertexAttrib3sARB", "Short version of #VertexAttrib3fARB()", VA_INDEX, GLshort.IN("x", VA_X), GLshort.IN("y", VA_Y), GLshort.IN("z", VA_Z))
	GLvoid.func(
		"VertexAttrib3fARB",
	...
	GLvoid.func("VertexAttrib3dARB", "Double version of #VertexAttrib3fARB()", VA_INDEX, GLdouble.IN("x", VA_X), GLdouble.IN("y", VA_Y), GLdouble.IN("z", VA_Z))

	GLvoid.func("VertexAttrib4sARB", "Short version of #VertexAttrib4fARB()", VA_INDEX, GLshort.IN("x", VA_X), GLshort.IN("y", VA_Y), GLshort.IN("z", VA_Z), GLshort.IN("w", VA_W))
	GLvoid.func(
		"VertexAttrib4fARB",
	...
	GLvoid.func("VertexAttrib4dARB", "Double version of #VertexAttrib4fARB()", VA_INDEX, GLdouble.IN("x", VA_X), GLdouble.IN("y", VA_Y), GLdouble.IN("z", VA_Z), GLdouble.IN("w", VA_W))
	GLvoid.func("VertexAttrib4NubARB", "Fixed-point unsigned byte version of #VertexAttrib4fARB()", VA_INDEX, GLubyte.IN("x", VA_X), GLubyte.IN("y", VA_Y), GLubyte.IN("z", VA_Z), GLubyte.IN("w", VA_W))

	val VA_V = "a buffer from which to read the attribute value"

	GLvoid.func("VertexAttrib1svARB", "Pointer version of #VertexAttrib1sARB()", VA_INDEX, mods(const, Check(1)) _ GLshort_p.IN("v", VA_V))
	GLvoid.func("VertexAttrib1fvARB", "Pointer version of #VertexAttrib1fARB()", VA_INDEX, mods(const, Check(1)) _ GLfloat_p.IN("v", VA_V))
	GLvoid.func("VertexAttrib1dvARB", "Pointer version of #VertexAttrib1dARB()", VA_INDEX, mods(const, Check(1)) _ GLdouble_p.IN("v", VA_V))

	GLvoid.func("VertexAttrib2svARB", "Pointer version of #VertexAttrib2sARB()", VA_INDEX, mods(const, Check(2)) _ GLshort_p.IN("v", VA_V))
	GLvoid.func("VertexAttrib2fvARB", "Pointer version of #VertexAttrib2fARB()", VA_INDEX, mods(const, Check(2)) _ GLfloat_p.IN("v", VA_V))
	GLvoid.func("VertexAttrib2dvARB", "Pointer version of #VertexAttrib2dARB()", VA_INDEX, mods(const, Check(2)) _ GLdouble_p.IN("v", VA_V))

	GLvoid.func("VertexAttrib3svARB", "Pointer version of #VertexAttrib3sARB()", VA_INDEX, mods(const, Check(3)) _ GLshort_p.IN("v", VA_V))
	...
	GLvoid.func(
		...
		AutoType("pointer", GL_BYTE, GL_SHORT, GL_INT, GL_FLOAT, GL_DOUBLE) _ GLenum.IN(
			"type",
	...
	GLvoid.func("ProgramEnvParameter4dARB", "Double version of #ProgramEnvParameter4fARB().", TARGET, VP_INDEX, GLdouble.IN("x", VP_X), GLdouble.IN("y", VP_Y), GLdouble.IN("z", VP_Z), GLdouble.IN("w", VP_W))
	...
	GLvoid.func("ProgramEnvParameter4fvARB", "Pointer version of #ProgramEnvParameter4fARB().", TARGET, VP_INDEX, mods(const, Check(4)) _ GLfloat_p.IN("params", VP_V))

	GLvoid.func("ProgramLocalParameter4dARB", "Double version of #ProgramLocalParameter4fARB().", TARGET, VP_INDEX, GLdouble.IN("x", VP_X), GLdouble.IN("y", VP_Y), GLdouble.IN("z", VP_Z), GLdouble.IN("w", VP_W))
