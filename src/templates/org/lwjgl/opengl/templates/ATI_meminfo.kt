...
val ATI_meminfo = "ATIMeminfo".nativeClassGL("ATI_meminfo", postfix = ATI) {
	...
	documentation =
		...
		application may be better served by choosing a different rendering method if there is not sufficient resources to efficiently utilize its preferred method.
