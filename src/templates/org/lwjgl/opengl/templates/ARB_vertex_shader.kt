...
val ARB_vertex_shader = "ARBVertexShader".nativeClassGL("ARB_vertex_shader", postfix = ARB) {
	...
	val VertexAttrib1fARB = GLvoid.func(
		"VertexAttrib1fARB",
	...
	val VertexAttrib1sARB = GLvoid.func("VertexAttrib1sARB", "Short version of $VertexAttrib1fARB.", GLuint.IN("index", vertexAttribIndex), GLshort.IN("v0", vertexAttribX)).javaDocLink
	val VertexAttrib1dARB = GLvoid.func("VertexAttrib1dARB", "Double version of $VertexAttrib1fARB.", GLuint.IN("index", vertexAttribIndex), GLdouble.IN("v0", vertexAttribX)).javaDocLink

	val VertexAttrib2fARB = GLvoid.func(
		"VertexAttrib2fARB",
	...
	val VertexAttrib2sARB = GLvoid.func("VertexAttrib2sARB", "Short version of $VertexAttrib2fARB.", GLuint.IN("index", vertexAttribIndex), GLshort.IN("v0", vertexAttribX), GLshort.IN("v1", vertexAttribY)).javaDocLink
	val VertexAttrib2dARB = GLvoid.func("VertexAttrib2dARB", "Double version of $VertexAttrib2fARB.", GLuint.IN("index", vertexAttribIndex), GLdouble.IN("v0", vertexAttribX), GLdouble.IN("v1", vertexAttribY)).javaDocLink

	val VertexAttrib3fARB = GLvoid.func(
		"VertexAttrib3fARB",
	...
	val VertexAttrib3sARB = GLvoid.func("VertexAttrib3sARB", "Short version of $VertexAttrib3fARB.", GLuint.IN("index", vertexAttribIndex), GLshort.IN("v0", vertexAttribX), GLshort.IN("v1", vertexAttribY), GLshort.IN("v2", vertexAttribZ)).javaDocLink
	val VertexAttrib3dARB = GLvoid.func("VertexAttrib3dARB", "Double version of $VertexAttrib3fARB.", GLuint.IN("index", vertexAttribIndex), GLdouble.IN("v0", vertexAttribX), GLdouble.IN("v1", vertexAttribY), GLdouble.IN("v2", vertexAttribZ)).javaDocLink

	val VertexAttrib4fARB = GLvoid.func(
		"VertexAttrib4fARB",
	...
	val VertexAttrib4sARB = GLvoid.func("VertexAttrib4sARB", "Short version of $VertexAttrib4fARB.", GLuint.IN("index", vertexAttribIndex), GLshort.IN("v0", vertexAttribX), GLshort.IN("v1", vertexAttribY), GLshort.IN("v2", vertexAttribZ), GLshort.IN("v3", vertexAttribW)).javaDocLink
	val VertexAttrib4dARB = GLvoid.func("VertexAttrib4dARB", "Double version of $VertexAttrib4fARB.", GLuint.IN("index", vertexAttribIndex), GLdouble.IN("v0", vertexAttribX), GLdouble.IN("v1", vertexAttribY), GLdouble.IN("v2", vertexAttribZ), GLdouble.IN("v3", vertexAttribW)).javaDocLink
	val VertexAttrib4NubARB = GLvoid.func("VertexAttrib4NubARB", "Normalized unsigned byte version of $VertexAttrib4fARB.", GLuint.IN("index", vertexAttribIndex), GLubyte.IN("x", vertexAttribX), GLubyte.IN("y", vertexAttribY), GLubyte.IN("z", vertexAttribZ), GLubyte.IN("w", vertexAttribW)).javaDocLink
	...
	val GetVertexAttribivARB = GLvoid.func(
