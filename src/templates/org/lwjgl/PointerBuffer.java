...
/**
 * This is a copy of org.lwjgl.PointerBuffer from the Core module, so that we can compile the Generator
 * without a dependency on Core.
 */
public class PointerBuffer implements Comparable {
	...
	public PointerBuffer(int capacity) {
		this(ByteBuffer.allocateDirect(capacity * getPointerSize()).order(ByteOrder.nativeOrder()));
	}
