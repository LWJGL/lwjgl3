...
fun khr_image2d_from_buffer() = "KHRImage2DFromBuffer".nativeClassCL("khr_image2d_from_buffer", KHR) {
	...
	IntConstant.block(
		...
		This query should be used when an image is created from a buffer which was created using ${"CL10#MEM_USE_HOST_PTR".link}. The value returned must be a
		power of 2.

		This query specifies the minimum alignment in pixels of the {@code host_ptr} specified to ${"CL10#CreateBuffer()".link}. If the device does not support
		images, this value should be 0.
		""",
