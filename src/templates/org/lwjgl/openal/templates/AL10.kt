...
fun AL10() = "AL10".nativeClassAL("AL10") {
	nativeImport (
		"OpenAL.h"
	)
	...
	).toJavaDocLinks() + " AL11#AL_LINEAR_DISTANCE AL11#AL_LINEAR_DISTANCE_CLAMPED AL11#AL_EXPONENT_DISTANCE AL11#AL_EXPONENT_DISTANCE_CLAMPED #AL_NONE"
