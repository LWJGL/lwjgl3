...
fun ALC_EXT_EFX() = "EXTEfx".nativeClassAL("EXT_EFX", prefixTemplate = ALC) {
	nativeImport (
		"OpenAL.h"
	)
    ...
    FloatConstant.block(
        ...
        "MIN_AIR_ABSORPTION_FACTOR" _ 0.0.f,
        "MAX_AIR_ABSORPTION_FACTOR" _ 10.0.f,
        "DEFAULT_AIR_ABSORPTION_FACTOR" _ 0.0.f,
        "MIN_ROOM_ROLLOFF_FACTOR" _ 0.0.f,
        "MAX_ROOM_ROLLOFF_FACTOR" _ 10.0.f,
        "DEFAULT_ROOM_ROLLOFF_FACTOR" _ 0.0.f,
        "MIN_CONE_OUTER_GAINHF" _ 0.0.f,
        "MAX_CONE_OUTER_GAINHF" _ 1.0.f,
        "DEFAULT_CONE_OUTER_GAINHF" _ 1.0.f
    )
    ...
    FloatConstant.block(
        ...
        "REVERB_MIN_DENSITY" _ 0.0.f,
        "REVERB_MAX_DENSITY" _ 1.0.f,
        "REVERB_DEFAULT_DENSITY" _ 1.0.f,
        "REVERB_MIN_DIFFUSION" _ 0.0.f,
        "REVERB_MAX_DIFFUSION" _ 1.0.f,
        "REVERB_DEFAULT_DIFFUSION" _ 1.0.f,
        "REVERB_MIN_GAIN" _ 0.0.f,
        "REVERB_MAX_GAIN" _ 1.0.f,
        "REVERB_DEFAULT_GAIN" _ 0.32.f,
        "REVERB_MIN_GAINHF" _ 0.0.f,
        "REVERB_MAX_GAINHF" _ 1.0.f,
        "REVERB_DEFAULT_GAINHF" _ 0.89.f,
        "REVERB_MIN_DECAY_TIME" _ 0.1.f,
        "REVERB_MAX_DECAY_TIME" _ 20.0.f,
        "REVERB_DEFAULT_DECAY_TIME" _ 1.49.f,
        "REVERB_MIN_DECAY_HFRATIO" _ 0.1.f,
        "REVERB_MAX_DECAY_HFRATIO" _ 2.0.f,
        "REVERB_DEFAULT_DECAY_HFRATIO" _ 0.83.f,
        "REVERB_MIN_REFLECTIONS_GAIN" _ 0.0.f,
        "REVERB_MAX_REFLECTIONS_GAIN" _ 3.16.f,
        "REVERB_DEFAULT_REFLECTIONS_GAIN" _ 0.05.f,
        "REVERB_MIN_REFLECTIONS_DELAY" _ 0.0.f,
        "REVERB_MAX_REFLECTIONS_DELAY" _ 0.3.f,
        "REVERB_DEFAULT_REFLECTIONS_DELAY" _ 0.007.f,
        "REVERB_MIN_LATE_REVERB_GAIN" _ 0.0.f,
        "REVERB_MAX_LATE_REVERB_GAIN" _ 10.0.f,
        "REVERB_DEFAULT_LATE_REVERB_GAIN" _ 1.26.f,
        "REVERB_MIN_LATE_REVERB_DELAY" _ 0.0.f,
        "REVERB_MAX_LATE_REVERB_DELAY" _ 0.1.f,
        "REVERB_DEFAULT_LATE_REVERB_DELAY" _ 0.011.f,
        "REVERB_MIN_AIR_ABSORPTION_GAINHF" _ 0.892.f,
        "REVERB_MAX_AIR_ABSORPTION_GAINHF" _ 1.0.f,
        "REVERB_DEFAULT_AIR_ABSORPTION_GAINHF" _ 0.994.f,
        "REVERB_MIN_ROOM_ROLLOFF_FACTOR" _ 0.0.f,
        "REVERB_MAX_ROOM_ROLLOFF_FACTOR" _ 10.0.f,
        "REVERB_DEFAULT_ROOM_ROLLOFF_FACTOR" _ 0.0.f
    )
    ...
    FloatConstant.block(
        ...
        "EAXREVERB_MIN_DENSITY" _ 0.0.f,
        "EAXREVERB_MAX_DENSITY" _ 1.0.f,
        "EAXREVERB_DEFAULT_DENSITY" _ 1.0.f,
        "EAXREVERB_MIN_DIFFUSION" _ 0.0.f,
        "EAXREVERB_MAX_DIFFUSION" _ 1.0.f,
        "EAXREVERB_DEFAULT_DIFFUSION" _ 1.0.f,
        "EAXREVERB_MIN_GAIN" _ 0.0.f,
        "EAXREVERB_MAX_GAIN" _ 1.0.f,
        "EAXREVERB_DEFAULT_GAIN" _ 0.32.f,
        "EAXREVERB_MIN_GAINHF" _ 0.0.f,
        "EAXREVERB_MAX_GAINHF" _ 1.0.f,
        "EAXREVERB_DEFAULT_GAINHF" _ 0.89.f,
        "EAXREVERB_MIN_GAINLF" _ 0.0.f,
        "EAXREVERB_MAX_GAINLF" _ 1.0.f,
        "EAXREVERB_DEFAULT_GAINLF" _ 1.0.f,
        "EAXREVERB_MIN_DECAY_TIME" _ 0.1.f,
        "EAXREVERB_MAX_DECAY_TIME" _ 20.0.f,
        "EAXREVERB_DEFAULT_DECAY_TIME" _ 1.49.f,
        "EAXREVERB_MIN_DECAY_HFRATIO" _ 0.1.f,
        "EAXREVERB_MAX_DECAY_HFRATIO" _ 2.0.f,
        "EAXREVERB_DEFAULT_DECAY_HFRATIO" _ 0.83.f,
        "EAXREVERB_MIN_DECAY_LFRATIO" _ 0.1.f,
        "EAXREVERB_MAX_DECAY_LFRATIO" _ 2.0.f,
        "EAXREVERB_DEFAULT_DECAY_LFRATIO" _ 1.0.f,
        "EAXREVERB_MIN_REFLECTIONS_GAIN" _ 0.0.f,
        "EAXREVERB_MAX_REFLECTIONS_GAIN" _ 3.16.f,
        "EAXREVERB_DEFAULT_REFLECTIONS_GAIN" _ 0.05.f,
        "EAXREVERB_MIN_REFLECTIONS_DELAY" _ 0.0.f,
        "EAXREVERB_MAX_REFLECTIONS_DELAY" _ 0.3.f,
        "EAXREVERB_DEFAULT_REFLECTIONS_DELAY" _ 0.007.f,
        "EAXREVERB_DEFAULT_REFLECTIONS_PAN_XYZ" _ 0.0.f,
        "EAXREVERB_MIN_LATE_REVERB_GAIN" _ 0.0.f,
        "EAXREVERB_MAX_LATE_REVERB_GAIN" _ 10.0.f,
        "EAXREVERB_DEFAULT_LATE_REVERB_GAIN" _ 1.26.f,
        "EAXREVERB_MIN_LATE_REVERB_DELAY" _ 0.0.f,
        "EAXREVERB_MAX_LATE_REVERB_DELAY" _ 0.1.f,
        "EAXREVERB_DEFAULT_LATE_REVERB_DELAY" _ 0.011.f,
        "EAXREVERB_DEFAULT_LATE_REVERB_PAN_XYZ" _ 0.0.f,
        "EAXREVERB_MIN_ECHO_TIME" _ 0.075.f,
        "EAXREVERB_MAX_ECHO_TIME" _ 0.25.f,
        "EAXREVERB_DEFAULT_ECHO_TIME" _ 0.25.f,
        "EAXREVERB_MIN_ECHO_DEPTH" _ 0.0.f,
        "EAXREVERB_MAX_ECHO_DEPTH" _ 1.0.f,
        "EAXREVERB_DEFAULT_ECHO_DEPTH" _ 0.0.f,
        "EAXREVERB_MIN_MODULATION_TIME" _ 0.04.f,
        "EAXREVERB_MAX_MODULATION_TIME" _ 4.0.f,
        "EAXREVERB_DEFAULT_MODULATION_TIME" _ 0.25.f,
        "EAXREVERB_MIN_MODULATION_DEPTH" _ 0.0.f,
        "EAXREVERB_MAX_MODULATION_DEPTH" _ 1.0.f,
        "EAXREVERB_DEFAULT_MODULATION_DEPTH" _ 0.0.f,
        "EAXREVERB_MIN_AIR_ABSORPTION_GAINHF" _ 0.892.f,
        "EAXREVERB_MAX_AIR_ABSORPTION_GAINHF" _ 1.0.f,
        "EAXREVERB_DEFAULT_AIR_ABSORPTION_GAINHF" _ 0.994.f,
        "EAXREVERB_MIN_HFREFERENCE" _ 1000.0.f,
        "EAXREVERB_MAX_HFREFERENCE" _ 20000.0.f,
        "EAXREVERB_DEFAULT_HFREFERENCE" _ 5000.0.f,
        "EAXREVERB_MIN_LFREFERENCE" _ 20.0.f,
        "EAXREVERB_MAX_LFREFERENCE" _ 1000.0.f,
        "EAXREVERB_DEFAULT_LFREFERENCE" _ 250.0.f,
        "EAXREVERB_MIN_ROOM_ROLLOFF_FACTOR" _ 0.0.f,
        "EAXREVERB_MAX_ROOM_ROLLOFF_FACTOR" _ 10.0.f,
        "EAXREVERB_DEFAULT_ROOM_ROLLOFF_FACTOR" _ 0.0.f
    )
    ...
    FloatConstant.block(
        ...
        "CHORUS_MIN_RATE" _ 0.0.f,
        "CHORUS_MAX_RATE" _ 10.0.f,
        "CHORUS_DEFAULT_RATE" _ 1.1.f,
        "CHORUS_MIN_DEPTH" _ 0.0.f,
        "CHORUS_MAX_DEPTH" _ 1.0.f,
        "CHORUS_DEFAULT_DEPTH" _ 0.1.f,
        "CHORUS_MIN_FEEDBACK" _ -1.0.f,
        "CHORUS_MAX_FEEDBACK" _ 1.0.f,
        "CHORUS_DEFAULT_FEEDBACK" _ 0.25.f,
        "CHORUS_MIN_DELAY" _ 0.0.f,
        "CHORUS_MAX_DELAY" _ 0.016.f,
        "CHORUS_DEFAULT_DELAY" _ 0.016.f
    )

    FloatConstant.block(
        "Distortion effect parameter ranges and defaults",

        "DISTORTION_MIN_EDGE" _ 0.0.f,
        "DISTORTION_MAX_EDGE" _ 1.0.f,
        "DISTORTION_DEFAULT_EDGE" _ 0.2.f,
        "DISTORTION_MIN_GAIN" _ 0.01.f,
        "DISTORTION_MAX_GAIN" _ 1.0.f,
        "DISTORTION_DEFAULT_GAIN" _ 0.05.f,
        "DISTORTION_MIN_LOWPASS_CUTOFF" _ 80.0.f,
        "DISTORTION_MAX_LOWPASS_CUTOFF" _ 24000.0.f,
        "DISTORTION_DEFAULT_LOWPASS_CUTOFF" _ 8000.0.f,
        "DISTORTION_MIN_EQCENTER" _ 80.0.f,
        "DISTORTION_MAX_EQCENTER" _ 24000.0.f,
        "DISTORTION_DEFAULT_EQCENTER" _ 3600.0.f,
        "DISTORTION_MIN_EQBANDWIDTH" _ 80.0.f,
        "DISTORTION_MAX_EQBANDWIDTH" _ 24000.0.f,
        "DISTORTION_DEFAULT_EQBANDWIDTH" _ 3600.0.f
    )

    FloatConstant.block(
        "Echo effect parameter ranges and defaults",

        "ECHO_MIN_DELAY" _ 0.0.f,
        "ECHO_MAX_DELAY" _ 0.207.f,
        "ECHO_DEFAULT_DELAY" _ 0.1.f,
        "ECHO_MIN_LRDELAY" _ 0.0.f,
        "ECHO_MAX_LRDELAY" _ 0.404.f,
        "ECHO_DEFAULT_LRDELAY" _ 0.1.f,
        "ECHO_MIN_DAMPING" _ 0.0.f,
        "ECHO_MAX_DAMPING" _ 0.99.f,
        "ECHO_DEFAULT_DAMPING" _ 0.5.f,
        "ECHO_MIN_FEEDBACK" _ 0.0.f,
        "ECHO_MAX_FEEDBACK" _ 1.0.f,
        "ECHO_DEFAULT_FEEDBACK" _ 0.5.f,
        "ECHO_MIN_SPREAD" _ -1.0.f,
        "ECHO_MAX_SPREAD" _ 1.0.f,
        "ECHO_DEFAULT_SPREAD" _ -1.0.f
    )
    ...
    FloatConstant.block(
        ...
        "FLANGER_MIN_RATE" _ 0.0.f,
        "FLANGER_MAX_RATE" _ 10.0.f,
        "FLANGER_DEFAULT_RATE" _ 0.27.f,
        "FLANGER_MIN_DEPTH" _ 0.0.f,
        "FLANGER_MAX_DEPTH" _ 1.0.f,
        "FLANGER_DEFAULT_DEPTH" _ 1.0.f,
        "FLANGER_MIN_FEEDBACK" _ -1.0.f,
        "FLANGER_MAX_FEEDBACK" _ 1.0.f,
        "FLANGER_DEFAULT_FEEDBACK" _ -0.5.f,
        "FLANGER_MIN_DELAY" _ 0.0.f,
        "FLANGER_MAX_DELAY" _ 0.004.f,
        "FLANGER_DEFAULT_DELAY" _ 0.002.f
    )

    FloatConstant.block(
        "Frequency shifter effect parameter ranges and defaults",

        "FREQUENCY_SHIFTER_MIN_FREQUENCY" _ 0.0.f,
        "FREQUENCY_SHIFTER_MAX_FREQUENCY" _ 24000.0.f,
        "FREQUENCY_SHIFTER_DEFAULT_FREQUENCY" _ 0.0.f
    )
	...
	FloatConstant.block(
		...
		"VOCAL_MORPHER_MIN_RATE" _ 0.0.f,
		"VOCAL_MORPHER_MAX_RATE" _ 10.0.f,
		"VOCAL_MORPHER_DEFAULT_RATE" _ 1.41.f
		)
	...
	FloatConstant.block(
		...
		"RING_MODULATOR_MIN_FREQUENCY" _ 0.0.f,
		"RING_MODULATOR_MAX_FREQUENCY" _ 8000.0.f,
		"RING_MODULATOR_DEFAULT_FREQUENCY" _ 440.0.f,
		"RING_MODULATOR_MIN_HIGHPASS_CUTOFF" _ 0.0.f,
		"RING_MODULATOR_MAX_HIGHPASS_CUTOFF" _ 24000.0.f,
		"RING_MODULATOR_DEFAULT_HIGHPASS_CUTOFF" _ 800.0.f
		)
	...
	FloatConstant.block(
		...
		"AUTOWAH_MIN_ATTACK_TIME" _ 0.0001.f,
		"AUTOWAH_MAX_ATTACK_TIME" _ 1.0.f,
		"AUTOWAH_DEFAULT_ATTACK_TIME" _ 0.06.f,
		"AUTOWAH_MIN_RELEASE_TIME" _ 0.0001.f,
		"AUTOWAH_MAX_RELEASE_TIME" _ 1.0.f,
		"AUTOWAH_DEFAULT_RELEASE_TIME" _ 0.06.f,
		"AUTOWAH_MIN_RESONANCE" _ 2.0.f,
		"AUTOWAH_MAX_RESONANCE" _ 1000.0.f,
		"AUTOWAH_DEFAULT_RESONANCE" _ 1000.0.f,
		"AUTOWAH_MIN_PEAK_GAIN" _ 0.00003.f,
		"AUTOWAH_MAX_PEAK_GAIN" _ 31621.0.f,
		"AUTOWAH_DEFAULT_PEAK_GAIN" _ 11.22.f
		)
	...
	FloatConstant.block(
		...
		"EQUALIZER_MIN_LOW_GAIN" _ 0.126.f,
		"EQUALIZER_MAX_LOW_GAIN" _ 7.943.f,
		"EQUALIZER_DEFAULT_LOW_GAIN" _ 1.0.f,
		"EQUALIZER_MIN_LOW_CUTOFF" _ 50.0.f,
		"EQUALIZER_MAX_LOW_CUTOFF" _ 800.0.f,
		"EQUALIZER_DEFAULT_LOW_CUTOFF" _ 200.0.f,
		"EQUALIZER_MIN_MID1_GAIN" _ 0.126.f,
		"EQUALIZER_MAX_MID1_GAIN" _ 7.943.f,
		"EQUALIZER_DEFAULT_MID1_GAIN" _ 1.0.f,
		"EQUALIZER_MIN_MID1_CENTER" _ 200.0.f,
		"EQUALIZER_MAX_MID1_CENTER" _ 3000.0.f,
		"EQUALIZER_DEFAULT_MID1_CENTER" _ 500.0.f,
		"EQUALIZER_MIN_MID1_WIDTH" _ 0.01.f,
		"EQUALIZER_MAX_MID1_WIDTH" _ 1.0.f,
		"EQUALIZER_DEFAULT_MID1_WIDTH" _ 1.0.f,
		"EQUALIZER_MIN_MID2_GAIN" _ 0.126.f,
		"EQUALIZER_MAX_MID2_GAIN" _ 7.943.f,
		"EQUALIZER_DEFAULT_MID2_GAIN" _ 1.0.f,
		"EQUALIZER_MIN_MID2_CENTER" _ 1000.0.f,
		"EQUALIZER_MAX_MID2_CENTER" _ 8000.0.f,
		"EQUALIZER_DEFAULT_MID2_CENTER" _ 3000.0.f,
		"EQUALIZER_MIN_MID2_WIDTH" _ 0.01.f,
		"EQUALIZER_MAX_MID2_WIDTH" _ 1.0.f,
		"EQUALIZER_DEFAULT_MID2_WIDTH" _ 1.0.f,
		"EQUALIZER_MIN_HIGH_GAIN" _ 0.126.f,
		"EQUALIZER_MAX_HIGH_GAIN" _ 7.943.f,
		"EQUALIZER_DEFAULT_HIGH_GAIN" _ 1.0.f,
		"EQUALIZER_MIN_HIGH_CUTOFF" _ 4000.0.f,
		"EQUALIZER_MAX_HIGH_CUTOFF" _ 16000.0.f,
		"EQUALIZER_DEFAULT_HIGH_CUTOFF" _ 6000.0.f
	)

	FloatConstant.block(
		"Lowpass filter parameter ranges and defaults",

		"LOWPASS_MIN_GAIN" _ 0.0.f,
		"LOWPASS_MAX_GAIN" _ 1.0.f,
		"LOWPASS_DEFAULT_GAIN" _ 1.0.f,
		"LOWPASS_MIN_GAINHF" _ 0.0.f,
		"LOWPASS_MAX_GAINHF" _ 1.0.f,
		"LOWPASS_DEFAULT_GAINHF" _ 1.0.f
	)

	FloatConstant.block(
		"Highpass filter parameter ranges and defaults",

		"HIGHPASS_MIN_GAIN" _ 0.0.f,
		"HIGHPASS_MAX_GAIN" _ 1.0.f,
		"HIGHPASS_DEFAULT_GAIN" _ 1.0.f,
		"HIGHPASS_MIN_GAINLF" _ 0.0.f,
		"HIGHPASS_MAX_GAINLF" _ 1.0.f,
		"HIGHPASS_DEFAULT_GAINLF" _ 1.0.f
	)

	FloatConstant.block(
		"Bandpass filter parameter ranges and defaults",

		"BANDPASS_MIN_GAIN" _ 0.0.f,
		"BANDPASS_MAX_GAIN" _ 1.0.f,
		"BANDPASS_DEFAULT_GAIN" _ 1.0.f,
		"BANDPASS_MIN_GAINHF" _ 0.0.f,
		"BANDPASS_MAX_GAINHF" _ 1.0.f,
		"BANDPASS_DEFAULT_GAINHF" _ 1.0.f,
		"BANDPASS_MIN_GAINLF" _ 0.0.f,
		"BANDPASS_MAX_GAINLF" _ 1.0.f,
		"BANDPASS_DEFAULT_GAINLF" _ 1.0.f
	)
