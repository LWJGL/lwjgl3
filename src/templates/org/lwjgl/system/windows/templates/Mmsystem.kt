...
fun Mmsystem() = "Mmsystem".nativeClass(WINDOWS_PACKAGE) {
	...
	IntConstant.block(
		...
		"MMSYSERR_ERROR".expr<Int>("$MMSYSERR_BASE + 1"),
		"MMSYSERR_BADDEVICEID".expr<Int>("$MMSYSERR_BASE + 2"),
		"MMSYSERR_NOTENABLED".expr<Int>("$MMSYSERR_BASE + 3"),
		"MMSYSERR_ALLOCATED".expr<Int>("$MMSYSERR_BASE + 4"),
		"MMSYSERR_INVALHANDLE".expr<Int>("$MMSYSERR_BASE + 5"),
		"MMSYSERR_NODRIVER".expr<Int>("$MMSYSERR_BASE + 6"),
		"MMSYSERR_NOMEM".expr<Int>("$MMSYSERR_BASE + 7"),
		"MMSYSERR_NOTSUPPORTED".expr<Int>("$MMSYSERR_BASE + 8"),
		"MMSYSERR_BADERRNUM".expr<Int>("$MMSYSERR_BASE + 9"),
		"MMSYSERR_INVALFLAG".expr<Int>("$MMSYSERR_BASE + 10"),
		"MMSYSERR_INVALPARAM".expr<Int>("$MMSYSERR_BASE + 11"),
		"MMSYSERR_HANDLEBUSY".expr<Int>("$MMSYSERR_BASE + 12"),
		"MMSYSERR_INVALIDALIAS".expr<Int>("$MMSYSERR_BASE + 13"),
		"MMSYSERR_BADDB".expr<Int>("$MMSYSERR_BASE + 14"),
		"MMSYSERR_KEYNOTFOUND".expr<Int>("$MMSYSERR_BASE + 15"),
		"MMSYSERR_READERROR".expr<Int>("$MMSYSERR_BASE + 16"),
		"MMSYSERR_WRITEERROR".expr<Int>("$MMSYSERR_BASE + 17"),
		"MMSYSERR_DELETEERROR".expr<Int>("$MMSYSERR_BASE + 18"),
		"MMSYSERR_VALNOTFOUND".expr<Int>("$MMSYSERR_BASE + 19"),
		"MMSYSERR_NODRIVERCB".expr<Int>("$MMSYSERR_BASE + 20"),
		"MMSYSERR_MOREDATA".expr<Int>("$MMSYSERR_BASE + 21"),
		"MMSYSERR_LASTERROR".expr<Int>("$MMSYSERR_BASE + 21")
	)
	...
	IntConstant.block(
		...
		"JOY_RETURNALL".expr<Int>("(JOY_RETURNX | JOY_RETURNY | JOY_RETURNZ | JOY_RETURNR | JOY_RETURNU | JOY_RETURNV | JOY_RETURNPOV | JOY_RETURNBUTTONS)"),
